---
description: >-
  Job steps in MariaDB ColumnStore: ExeMgr translates the CSEP into
...
For additional information, see "[MariaDB ColumnStore Query Evaluation](../../../architecture/mariadb-enterprise-columnstore-query-evaluation.md).".
