---
description: >-
  COMMIT for MariaDB ColumnStore makes table changes permanent; once
  committed, changes cannot be undone with ROLLBACK and the database must be
  restored from backups to revert.
---
