---
description: >-
  MCS backup and restore CLI for MariaDB ColumnStore: full and
...
This page documents how to create and restore MariaDB ColumnStore backups using the `mcs` CLI.
