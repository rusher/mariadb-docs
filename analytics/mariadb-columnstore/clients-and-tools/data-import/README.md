---
description: >-
  Data import methods for MariaDB ColumnStore: cpimport, INSERT
...
MariaDB ColumnStore supports very efficient bulk data loads.
...
* If the statement is executed outside of a transaction, ColumnStore loads the data using cpimport, which is a command-line utility that is designed to efficiently load data in bulk. It executes cpimport using a wrapper called `cpimport.bin`.
