...
* #1: Don't use [PARTITIONing](/en/managing-mariadb-partitioning/) until you know how and why it will help.
...
* [MyISAM](../../clients-and-utilities/myisam-clients-and-utilities/myisamchk-table-information.md), before version 5.6.6, would lock all partitions before pruning!
...
* 8192 partitions is a hard limit (1024 before [MariaDB 10.0.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-100-series/mariadb-1004-release-notes)).
