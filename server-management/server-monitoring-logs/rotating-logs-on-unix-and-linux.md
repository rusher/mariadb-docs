...
Unix and Linux distributions offer the `[logrotate](https://linux.die.net/man/8/logrotate)` utility, which makes it very easy to rotate log files. This page will describe how to configure log rotation for the [error log](error-log.md), [general query log](general-query-log.md), and the [slow query log](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/statistics-for-optimizing-queries/slow-query-log-extended-statistics.md).
...
* The [slow query log](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/statistics-for-optimizing-queries/slow-query-log-extended-statistics.md) location and file name is configured with the `[slow_query_log_file](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#slow_query_log_file)` system variable.

If you want to enable the [general query log](general-query-log.md) and [slow query log](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/statistics-for-optimizing-queries/slow-query-log-extended-statistics.md) immediately, then you will also have to configure the following:
...
* The [slow query log](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/statistics-for-optimizing-queries/slow-query-log-extended-statistics.md) is enabled with the `[slow_query_log](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#slow_query_log)` system variable.
...
After MariaDB is [restarted](/en/starting-and-stopping-mariadb-starting-and-stopping-mariadb/), it will use the new log locations and file names.
...
For more information on how to use Ansible to automate MariaDB configuration, see [Ansible and MariaDB](/en/ansible-and-mariadb/).