...
If you upgrade to [MariaDB 5.1](/en/what-is-mariadb-51/) from MySQL 5.1 you [don't have to do anything](/en/how-can-i-upgrade-from-mysql-to-mariadb/) with your data or MySQL clients. Things should "just work".
...
"mysql_upgrade" reads the [my.cnf](/en/mysqld-configuration-files-and-groups/) sections [mysql_upgrade] and [client] for default values.
 ...
 * [ARCHIVE](/en/archive/) changed storage format between 5.0 and 5.1
...
The following differences exists between "mysql_upgrade" in MariaDB and MySQL (as of [MariaDB 5.1.50](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-51-series/mariadb-5150-release-notes)):

* MariaDB will convert long table names properly.
* MariaDB will convert [InnoDB](/en/xtradb-and-innodb/) tables (no need to do a dump/restore or `[ALTER TABLE](../../../../../reference/sql-statements-and-structure/sql-statements/data-definition/alter/alter-table.md)`).
