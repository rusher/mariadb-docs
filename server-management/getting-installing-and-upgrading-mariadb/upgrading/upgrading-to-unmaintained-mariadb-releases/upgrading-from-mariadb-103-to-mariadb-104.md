...
For MariaDB Galera Cluster, see [Upgrading from MariaDB 10.3 to MariaDB 10.4 with Galera Cluster](/kb/en/upgrading-from-mariadb-103-to-mariadb-104-with-galera-cluster/) instead.
...
1. Modify the repository configuration, so the system's package manager installs [MariaDB 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-104). For example,
...
* See [Authentication from MariaDB 10.4](/kb/en/authentication-from-mariadb-104/) for an overview of the changes.
...
* TLSv1.0 is disabled by default in [MariaDB 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-104). See [tls_version](../../../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md#tls_version) and [TLS Protocol Versions](../../../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/secure-connections-overview.md#tls-protocol-versions).

#

## Major New Features To Consider

You might consider using the following major new features in [MariaDB 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-104):
...
* See also [System Variables Added in MariaDB 10.4](/kb/en/system-variables-added-in-mariadb-104/).

#

## See Also

* [The features in MariaDB 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-104)
* [Upgrading from MariaDB 10.3 to MariaDB 10.4 with Galera Cluster](/kb/en/upgrading-from-mariadb-103-to-mariadb-104-with-galera-cluster/)
