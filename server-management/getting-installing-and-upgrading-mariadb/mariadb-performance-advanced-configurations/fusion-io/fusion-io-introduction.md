...
1. In some cases, Fusion-io devices allow for atomic writes, which allows the server to safely disable the [doublewrite buffer](/en/xtradbinnodb-doublewrite-buffer/).
...
![GE-Fusionio-MariaDB](/en/fusion-io-introduction/+image/GE-Fusionio-MariaDB "GE-Fusionio-MariaDB")
