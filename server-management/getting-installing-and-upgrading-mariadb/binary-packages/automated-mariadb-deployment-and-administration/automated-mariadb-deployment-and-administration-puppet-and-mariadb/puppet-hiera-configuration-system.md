...
hiera is part of [Puppet](/en/automated-mariadb-deployment-and-administration-puppet-and-mariadb/). It is a hierarchical configuration system that allows us to:
