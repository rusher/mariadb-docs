...
For documentation about the `mariadb-tzinfo-to-sql` utility, see [mysql_tzinfo_to_sql](../../../../../clients-and-utilities/legacy-clients-and-utilities/mysql_tzinfo_to_sql.md). This page is about running it using Ansible.
