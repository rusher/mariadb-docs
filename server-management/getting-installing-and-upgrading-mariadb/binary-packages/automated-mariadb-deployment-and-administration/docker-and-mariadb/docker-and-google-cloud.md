...
![gcp-e2](/en/docker-and-google-cloud/+image/gcp-e2 "gcp-e2")
![gcp-e2-micro](/en/docker-and-google-cloud/+image/gcp-e2-micro "gcp-e2-micro")
6. Boot Disk > Change

Switch the operating system to a modern Ubuntu release x86/64 CPU architecture, or similar free tier offering.
![gcp-ubuntu](/en/docker-and-google-cloud/+image/gcp-ubuntu "gcp-ubuntu")
...
![gcp-firewall](/en/docker-and-google-cloud/+image/gcp-firewall "gcp-firewall")
8. Connect using Google Cloud’s built in browser SSH. Accept all prompts for authorization.
![gcp-verify-ssh](/en/docker-and-google-cloud/+image/gcp-verify-ssh "gcp-verify-ssh")
