...
plugin-load-add` can be used as a configuration option to load plugins. The example below loads the [FederatedX Storage Engine](/en/federatedx-storage-engine/).
...
In the following, the [CONNECT Storage Engine](../../../../../security/user-account-management/catalogs/connecting-to-a-server-configured-for-catalogs.md) is installed:
