...
[mysqld_safe](/kb/en/mysqld_safe/) and possibly [mariadb (the
command-line client utility)](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/c/mariadb-client-library-for-c-200-release-notes) to **only** use this one with the option
...
To test connection, modify your $PATH so you can invoke client such as [mariadb](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/c/mariadb-client-library-for-c-200-release-notes), [mariadb-dump](../../../clients-and-utilities/mariadb-dumpslow.md), etc.
...
Also consider using the [mysql.server](/kb/en/mysqlserver/) to
