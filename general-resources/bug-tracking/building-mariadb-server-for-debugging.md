...
(A more detailed explanation can be found [here](../training-and-tutorials/advanced-mariadb-articles/development-articles/debugging-mariadb/how-to-produce-a-full-stack-trace-for-mariadbd.md).)
...
* Get the latest [MariaDB code from GitHub](../company-and-community/contributing-participating/contributing-code.md).
* Compile MariaDB with the -g compiler flag (Unix).
* Optionally: with more checking [Compile MariaDB for debugging](../training-and-tutorials/advanced-mariadb-articles/development-articles/debugging-mariadb/compiling-mariadb-for-debugging.md) - will cause slowdown.
...
ftp> quit
```
* To be able to follow the progress, create a bug report in [JIRA](../training-and-tutorials/advanced-mariadb-articles/development-articles/tools/jira.md) about this. This should be easy to do based on the information you have in your README file.
