...
*Usage example: testing of MERGE view extension in [MariaDB 10.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-0-series/changes-improvements-in-mariadb-10-0) ([MDEV-3862](https://jira.mariadb.org/browse/MDEV-3862))*
