...
If you want to be part of developing any of these features, get[an account](https://kb.askmonty.org/v/about) and add your name after the\
...
* FB request: EXPLAIN the _actual_ plan on a _running_ statement; no progress indicators and numbers are needed; [MWL#182](https://askmonty.org/worklog/?tid=182) (In Progress) (spetrunia)
...
* U/C at Oracle: OPTIMIZER tracing\
  ...
  including why an index was _not_ picked, etc.
