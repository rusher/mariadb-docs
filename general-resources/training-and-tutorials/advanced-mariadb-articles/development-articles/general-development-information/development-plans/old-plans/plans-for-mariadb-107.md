...
[MariaDB 10.7](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-7-series/what-is-mariadb-107) is stable, so no new features will be added. See [Plans for MariaDB 10.8](plans-for-mariadb-108.md) instead.
