...
[MariaDB 10.11](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/release-notes-mariadb-10-11-series/what-is-mariadb-1011) is stable, so no new features will be added. See [Plans for MariaDB 11.1](plans-for-mariadb-11-1.md) instead.
