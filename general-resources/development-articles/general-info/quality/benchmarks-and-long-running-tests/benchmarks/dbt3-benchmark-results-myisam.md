...
* [MariaDB 5.3.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-5-3-series/mariadb-532-release-notes) + MyISAM
* [MariaDB 5.5.18](../../../../../../kb/en/mariadb-5518-release-notes/) + MyISAM
* MySQL 5.5.19 + MyISAM
* MySQL 5.6.4 + MyISAM
...
#### Case 1: [MariaDB 5.3.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-5-3-series/mariadb-532-release-notes) + MyISAM
...
#### Case 2: [MariaDB 5.5.18](../../../../../../kb/en/mariadb-5518-release-notes/) + MyISAM

Uses the same configuration file as [MariaDB 5.3.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-5-3-series/mariadb-532-release-notes) in Case 1.
...
![dbt3-myisam-s30-hdd](../../../../../.gitbook/assets/dbt3-benchmark-results-myisam/+image/dbt3-myisam-s30-hdd.png)
...
| ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----- | -------------------------------------------------------------------------------------------- | ----- | -------------------------------------------------------------------------------------------------- | ----- | --------------------------------------------------------------------------------------------- | ----- | ----- | ----- | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ------ | ----------- | ----------- | ------ | ---------- | ------ | ----------- | ----------- | ------ | ------ | ------ | ------- | ------------------------- |
| Configuration             | [MariaDB 5.3.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-5-3-series/mariadb-532-release-notes) + MyISAM | Ratio | [MariaDB 5.5.18](../../../../../../kb/en/mariadb-5518-release-notes/) + MyISAM               | Ratio | MySQL 5.5.19 + MyISAM                                                                              | Ratio | MySQL 5.6.4 + MyISAM                                                                          | Ratio |       |       |        |        |        |        |        |        |        |        |             |             |        |            |        |             |             |        |        |        |         |                           |
...
5.3.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-5-3-series/mariadb-532-release-notes) (the first column) handles a query for 100 seconds and MySQL 5.6.4 (the last\
...
Queries 2-opt.sql and 18-opt.sql are tested only for [MariaDB 5.3.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-5-3-series/mariadb-532-release-notes) and [MariaDB\
5.5.18](../../../../../../kb/en/mariadb-5518-release-notes/)
...
![dbt3-q20-myisam-s30-hdd](../../../../../.gitbook/assets/dbt3-benchmark-results-myisam/+image/dbt3-q20-myisam-s30-hdd.png)
...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ----------- | ----------- | ----------- | ------------------ | ------------------------------------------------------------------------------------------------ |
| Configuration                                                                                                                                                     | 20.sql | 20-opt0.sql | 20-opt1.sql | 20-opt2.sql | Version            | Query and explain details                                                                        |
| [MariaDB 5.3.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-5-3-series/mariadb-532-release-notes) + MyISAM | 20070  | -           | 5560        | 5615        | 5.3.2-MariaDB-beta | [Explain details](https://askmonty.org/w/images/9/9a/DBT3_MyISAM_HDD_s30_q20_mariadb_5_3_2.txt)  |
| [MariaDB 5.5.18](../../../../../../kb/en/mariadb-5518-release-notes/) + MyISAM                                                                                    | 19922  | -           | 5529        | 5572        | 5.5.18-MariaDB     | [Explain details](https://askmonty.org/w/images/e/e8/DBT3_MyISAM_HDD_s30_q20_mariadb_5_5_18.txt) |
