...
* The [stored procedure](https://github.com/mariadb-corporation/docs-server/blob/test/general-resources/server-usage/stored-routines/stored-procedures/README.md) or [stored function](https://github.com/mariadb-corporation/docs-server/blob/test/general-resources/server-usage/stored-routines/stored-functions/README.md) has not yet been created. See [CREATE PROCEDURE](https://github.com/mariadb-corporation/docs-server/blob/test/general-resources/server-usage/stored-routines/stored-procedures/create-procedure.md) or [CREATE FUNCTION](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-definition/create/create-function). For example:
...
* There was a typo in the name. Check also that the case is correct. See [Identifier Case-sensitivity](https://github.com/mariadb-corporation/docs-server/blob/test/general-resources/community/sql-structure/sql-language-structure/identifier-case-sensitivity.md). For example:
