...
To fix this, you have to either increase the value of [max\_statement\_time](../../../../../ha-and-performance/optimization-and-tuning/system-variables/server-system-variables.md#max_statement_time) or find out [why the query is slow](../../../../../ha-and-performance/optimization-and-tuning/query-optimizations/). Start by doing an [EXPLAIN](../../../../../community/sql-statements/administrative-sql-statements/analyze-and-explain-statements/explain.md) or [ANALYZE](../../../../../community/sql-statements/administrative-sql-statements/analyze-and-explain-statements/analyze-statement.md) on the query to find out how the query is executed.
