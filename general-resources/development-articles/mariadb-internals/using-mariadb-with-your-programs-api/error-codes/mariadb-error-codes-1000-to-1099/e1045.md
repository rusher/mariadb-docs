...
The user/password combination does not exist or the user does not have privileges to the given database. See [Troubleshooting Connection Issues](../../../../../../kb/en/troubleshooting-connection-issues/) for more, as well as [GRANT](../../../../../community/sql-statements/account-management-sql-statements/grant.md) for details on setting permissions.
