...
For example, the [VEC\_ToText](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/vectors/vector-functions/vec_totext) function expects a binary vector. If not given one, this error will result:
