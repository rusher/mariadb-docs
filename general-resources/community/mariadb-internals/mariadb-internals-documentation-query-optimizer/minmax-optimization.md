...
The above optimization also works for [subqueries](../../sql-statements/data-manipulation/selecting-data/joins-subqueries/subqueries/):
...
Loose scan will apply for your query if [EXPLAIN](../../sql-statements/administrative-sql-statements/analyze-and-explain-statements/explain.md) shows `Using index for group-by` in the `Extra` column.\
