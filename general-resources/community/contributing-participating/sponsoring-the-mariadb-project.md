...
* Fund the development of a specific feature. You can find a list of suggested features to sponsor [here](https://github.com/mariadb-corporation/docs-server/blob/test/general-resources/community/contributing-participating/broken-reference/README.md) or in [JIRA](../../development-articles/general-info/tools/jira.md). Feel free to sign in and add more projects to either place!
