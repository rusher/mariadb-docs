...
"Monty" Widenius, the founder of MySQL®, Monty Program Ab (now[MariaDB Corporation](https://mariadb.com)), and a founding member of the[MariaDB Foundation](https://mariadb.org).
...
There is an active[community](resources.md) around MariaDB\
that you can be part of. Their developer contributions can be found on the[log of MariaDB contributors](../../contributing-participating/log-of-mariadb-contributions.md).
