...
* To be able to follow the progress, create a bug report in [JIRA](../../training-and-tutorials/advanced-mariadb-articles/development-articles/general-development-information/tools/jira.md) about this. This should be easy to do based on the information you have in your README file.
