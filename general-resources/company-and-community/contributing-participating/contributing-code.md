...
[Contributing to the MariaDB Project](contributing-to-the-mariadb-project.md)
page.
...
* If this is your first project, check out the
 [Suggested Development](project-suggestions.md) page. It lists 
...
* Jira issue number and summary ex:
[MDEV-23839](https://jira.mariadb.org/browse/MDEV-23839) innodb_fast_shutdown=0 hang on change buffer merge
* An empty line
...
* Code shared with the MariaDB Foundation under the [MCA](../../legal-and-policies/legal-documents/mca.md).
...
1. Signing the MariaDB Contributor Agreement
 ([MCA](../../legal-and-policies/legal-documents/mca.md)) and then scanning and sending it to the foundation.
1. Sending an email to
 [maria-developers](https://launchpad.net/~maria-developers) where you say
 that your patch and all fixes to it are provided to the MariaDB Foundation under
 the [MCA](../../legal-and-policies/legal-documents/mca.md).
1. Licensing your code using the
...
1. to defend the copyright or GPL if someone breaks it (this is the same reason
 ...
 [requires copyright assignment](https://www.gnu.org/licenses/why-assign.html)
 for its code)
1. to be able to donate code to MySQL (for example to fix security bugs or new
 features)
1. to allow people who have a non-free license to the MySQL code to also use
...
[MCA FAQ](../../legal-and-policies/legal-documents/mariadb-contributor-agreement-faq.md) page.
