...
The two tables below relate to each other through the _product\_code_ field. Any two tables can relate to each other simply by creating a field they have in common.
