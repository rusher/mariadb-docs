...
_Instructions for contributing to documentation._

* _Decide which spaces people can contribute to_
* _Server has CC/FDL license_
* _MariaDB plc will have the IP in any case, contributors would have to agree to that_
* _Contributions = suggestions_
...
Before you start, make yourself familiar with [the basics of technical writing](https://developers.google.com/style/highlights) (a 1-minute read). This is about using proper tone and content, language and grammar, as well as formatting, punctuation, and organization.
