...
[MariaDB 11.7](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/release-notes-mariadb-11-7-rolling-releases/what-is-mariadb-117) is an upcoming major development release.


## JIRA


We manage our development plans in JIRA, so the definitive list will be there. [This search](https://jira.mariadb.org/issues/?jql=project+%3D+MDEV+AND+issuetype+%3D+Task+AND+fixVersion+in+%2811.7%29+ORDER+BY+priority+DESC) shows what we **currently** plan for 11.7. It shows all tasks with the **Fix-Version** being 11.7. Not all these tasks will really end up in 11.7 but tasks with the "red" priorities have a much higher chance of being done in time for 11.7. Practically, you can think of these tasks as "features that **will** be in 11.7". Tasks with the "green" priorities probably won't be in 11.7. Think of them as "bonus features that would be **nice to have** in 11.7".
