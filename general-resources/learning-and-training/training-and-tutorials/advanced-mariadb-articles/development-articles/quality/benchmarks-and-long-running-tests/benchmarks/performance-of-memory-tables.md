...
Between [MariaDB 5.5.21](../../../../../../../../release-notes/mariadb-community-server/old-releases/release-notes-mariadb-5-5-series/mariadb-5521-release-notes.md) and 5.5.22 some work was done on how the hash index for a [MEMORY](../../../../../../../../server/reference/storage-engines/memory-storage-engine.md) table is created. This results in better performance when inserting rows into a memory table.
