...
The list of automatic tests is located in the `<code>buildbot.conf</code>` file in the
`<code>[mariadb.org-tools](benchmarks-and-long-running-tests/benchmarks/mariadb-tools.md)</code>` repository.
