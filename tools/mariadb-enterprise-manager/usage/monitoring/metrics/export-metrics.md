...
{% hint style="warning" %}
This page contains unverified information. Please disregard if not a reviewer. If you’re a reviewer, please see the comment on Method 1.
{% endhint %}

## Documentation: Export metrics
...
Tip: For a full list of all available flags and their descriptions, run `mema-agent help setup` on the host where the agent is installed.
{% endstep %}
{% endstepper %}
