...
* Vault is unsealed and you've logged in to it with `vault login $AUTH_TOKEN`, where $AUTH\_TOKEN is an authentication token given to you by an administrator
