...
| versions string array                                                             | Versions specifies the supported TLS versions for this MariaDB instance.By default, the MariaDB's default supported versions are used. See: [ssltls-system-variables.md#tls\_version](https://github.com/mariadb-corporation/docs-server/blob/test/security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md#tls_version).                                                                                                                                                                             |         |                                                        |
...
TLSRequirements specifies TLS requirements for the user to connect. See: [securing-connections-for-client-and-server.md#requiring-tls](https://github.com/mariadb-corporation/docs-server/blob/test/security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/securing-connections-for-client-and-server.md#requiring-tls).
...
| require [TLSRequirements](api-reference.md#tlsrequirements)                                                       | Require specifies TLS requirements for the user to connect. See: [securing-connections-for-client-and-server.md#requiring-tls](https://github.com/mariadb-corporation/docs-server/blob/test/security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/securing-connections-for-client-and-server.md#requiring-tls). |         |                      |
