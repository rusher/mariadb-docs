...
| ----------------------- | ----------------------------- | ------------------------------------------ |
| Connection timeout      | Database not accessible       | Check DB\_HOST and DB\_PORT settings       |
| Authentication failed   | Invalid credentials           | Verify JWT\_SECRET and user credentials    |
| Document ingestion slow | Large files, small batch size | Increase EMBEDDING\_BATCH\_SIZE            |
...
4. Consult the [API Reference](../api-reference/) for endpoint-specific issues
