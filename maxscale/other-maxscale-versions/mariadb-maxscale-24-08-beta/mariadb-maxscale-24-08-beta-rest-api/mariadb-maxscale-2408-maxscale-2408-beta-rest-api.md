# MaxScale 24.08 Beta REST API

This document describes the version 1 of the MaxScale REST API.

* [REST API](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#rest-api)
  * [Note About Syntax](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#note-about-syntax)
  * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#configuration)
  * [Authentication](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#authentication)
    * [JSON Web Tokens](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#json-web-tokens)
      * [/auth Request Parameters](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#auth-request-parameters)
  * [Resources](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#resources)
  * [API Versioning](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#api-versioning)
    * [Resource Relationships](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#resource-relationships)
  * [Common Request Parameters](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#common-request-parameters)
    * [Filter Expressions](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#filter-expressions)
      * [Filter Expression Examples](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#filter-expression-examples)
  * [HTTP Headers](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#http-headers)
    * [Request Headers](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#request-headers)
      * [Authorization](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#authorization)
      * [Content-Type](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#content-type)
      * [Host](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#host)
      * [If-Match](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#if-match)
      * [If-Modified-Since](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#if-modified-since)
      * [If-None-Match](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#if-none-match)
      * [If-Unmodified-Since](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#if-unmodified-since)
      * [X-HTTP-Method-Override](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#x-http-method-override)
    * [Response Headers](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#response-headers)
      * [Allow](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#allow)
      * [Accept-Patch](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#accept-patch)
      * [Date](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#date)
      * [ETag](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#etag)
      * [Last-Modified](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#last-modified)
      * [Location](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#location)
      * [WWW-Authenticate](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#www-authenticate)
      * [Mxs-Warning](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#mxs-warning)
  * [Response Codes](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#response-codes)
    * [2xx Success](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#2xx-success)
    * [3xx Redirection](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#3xx-redirection)
    * [4xx Client Error](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#4xx-client-error)
    * [5xx Server Error](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#5xx-server-error)
    * [Response Headers Reserved for Future Use](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#response-headers-reserved-for-future-use)
...
Read the [REST API](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)\
...
can be intercepted from the network traffic. Refer to the[Configuration Guide](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) for more\
...
refer to the [MaxCtrl](../mariadb-maxscale-24-08-beta-reference/mariadb-maxscale-2408-maxscale-2408-beta-maxctrl.md) documentation as well as the\
documentation of the [users](mariadb-maxscale-2408-maxscale-2408-beta-admin-user-resource.md) resource.
...
* [maxscale](mariadb-maxscale-2408-maxscale-2408-beta-maxscale-resource.md)
* [services](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md)
* [servers](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md)
* [listeners](mariadb-maxscale-2408-maxscale-2408-beta-listener-resource.md)
* [filters](mariadb-maxscale-2408-maxscale-2408-beta-filter-resource.md)
* [monitors](mariadb-maxscale-2408-maxscale-2408-beta-monitor-resource.md)
* [sessions](mariadb-maxscale-2408-maxscale-2408-beta-session-resource.md)
* [users](mariadb-maxscale-2408-maxscale-2408-beta-admin-user-resource.md)
* [sql](mariadb-maxscale-2408-maxscale-2408-beta-sql-resource.md)
...
All parameters that use boolean values use the same rules that are used for the[boolean values](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) in the\
...
* Filter the output of the result\
  ...
  valid JSON type as the value or a[filter-expression](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#filter-expressions). The comparison is done for each\
  ...
  be found [here](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#filter-expression-examples).\
...
The `expr` value must be a[filter-expression](mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md#filter-expressions). Similarly to the other `filter`\
