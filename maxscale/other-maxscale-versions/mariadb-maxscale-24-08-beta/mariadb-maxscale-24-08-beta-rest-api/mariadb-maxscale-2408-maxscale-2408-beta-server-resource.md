# MaxScale 24.08 Beta Server Resource

A server resource represents a backend database server.

* [Server Resource](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#server-resource)
  * [Resource Operations](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#resource-operations)
    * [Get a server](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#get-a-server)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#response)
    * [Get all servers](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#get-all-servers)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#response_1)
    * [Create a server](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#create-a-server)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#response_2)
    * [Update a server](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#update-a-server)
    * [Modifiable Fields](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#modifiable-fields)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#response_3)
    * [Update server relationships](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#update-server-relationships)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#response_4)
    * [Destroy a server](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#destroy-a-server)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#response_5)
    * [Set server state](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#set-server-state)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#response_6)
    * [Clear server state](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#clear-server-state)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-server-resource.md#response_7)
...
* The [address](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) or[socket](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) to use. Only\
  one of the fields can be defined.
* `data.attributes.parameters.port`
* The [port](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) to use. Needs\
...
In addition to the server[parameters](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md), the _services_\
