...
available in MaxScale are[standard MySQL password](mariadb-maxscale-2408-maxscale-2408-beta-mariadbmysql-authenticator.md),[GSSAPI](mariadb-maxscale-2408-maxscale-2408-beta-gssapi-client-authenticator.md) and[pluggable authentication modules (PAM)](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md).
...
defined in the service configuration. For more information, search the[configuration guide](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)\
