...
* [MariaDB MaxScale MaxGUI Guide](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#mariadb-maxscale-maxgui-guide)
* [Introduction](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#introduction)
* [Enabling MaxGUI](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#enabling-maxgui)
  * [Securing the GUI](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#securing-the-gui)
* [Authentication](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#authentication)
* [Pages](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#pages)
  * [Dashboard](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#dashboard)
  * [Detail](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#detail)
  * [Visualization](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#visualization)
  * [Settings](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#settings)
  * [Logs Archive](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#logs-archive)
  * [Workspace](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#workspace)
    * [1. Run Queries](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#1-run-queries)
    * [2. Data Migration](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#2-data-migration)
    * [3. Create an ERD](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#3-create-an-erd)
...
See [Configuration Guide](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) and[Configuration and Hardening](../mariadb-maxscale-24-08-beta-tutorials/mariadb-maxscale-2408-maxscale-2408-beta-rest-api-tutorial.md)\
...
This page shows information on each[MaxScale object](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) and allow to edit its\
parameter, relationships and perform other manipulation operations.

Access this page by clicking on the MaxScale object name on the[dashboard page](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-maxgui-guide.md#dashboard)
...
* Cluster: Visualizing a replication cluster into a tree graph and provides\
  ...
  moment, it supports only servers monitored by Monitor using[mariadbmon](../mariadb-maxscale-2408-beta-maxscale-24-08-beta-monitors/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md) module.
