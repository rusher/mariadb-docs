...
* [Mirror](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#mirror)
  * [Overview](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#overview)
  * [Configuration Parameters](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#configuration-parameters)
    * [main](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#main)
    * [exporter](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#exporter)
    * [file](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#file)
    * [kafka\_broker](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#kafka_broker)
    * [kafka\_topic](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#kafka_topic)
    * [on\_error](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#on_error)
    * [report](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#report)
  * [Example Configuration](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#example-configuration)
  * [Limitations](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#limitations)
...
servers in a manner similar to that of the[Tee filter](../mariadb-maxscale-24-08-beta-filters/mariadb-maxscale-2408-maxscale-2408-beta-tee-filter.md) with exporting of collected query metrics.
...
* `file`
* Exports metrics to a file. Configured with the [file](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#file) parameter.
* `kafka`
* Exports metrics to a Kafka broker. Configured with the[kafka\_broker](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#kafka_broker) and [kafka\_topic](mariadb-maxscale-2408-maxscale-2408-beta-mirror.md#kafka_topic)\
  parameters.
