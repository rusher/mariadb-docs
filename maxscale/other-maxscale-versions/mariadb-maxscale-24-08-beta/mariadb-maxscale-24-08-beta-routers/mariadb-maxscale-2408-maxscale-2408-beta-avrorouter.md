# mariadb-maxscale-2408-maxscale-2408-beta-avrorouter
...
This router is intended to be used in tandem with the[Binlog Server](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md).\
...
![](../../../.gitbook/assets/mariadb-corporation/MaxScale/24.08.0/Documentation/Routers/images/Binlog-Avro.png.png)
...
* [Avrorouter](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#avrorouter)
  * [Direct Replication Mode](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#direct-replication-mode)
  * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#configuration)
    * [Router Parameters](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#router-parameters)
      * [gtid\_start\_pos](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#gtid_start_pos)
      * [server\_id](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#server_id)
      * [source](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#source)
      * [codec](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#codec)
      * [match and exclude](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#match-and-exclude)
      * [binlogdir](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#binlogdir)
      * [avrodir](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#avrodir)
        * [filestem](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#filestem)
      * [start\_index](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#start_index)
    * [cooperative\_replication](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#cooperative_replication)
      * [Avro File Related Parameters](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#avro-file-related-parameters)
        * [group\_trx](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#group_trx)
        * [group\_rows](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#group_rows)
        * [block\_size](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#block_size)
        * [max\_file\_size](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#max_file_size)
        * [max\_data\_age](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#max_data_age)
        * [Example configuration](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#example-configuration)
  * [Module commands](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#module-commands)
    * [avrorouter::convert SERVICE {start | stop}](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#avrorouterconvert-service-start-stop)
    * [avrorouter::purge SERVICE](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#avrorouterpurge-service)
  * [Files Created by the Avrorouter](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#files-created-by-the-avrorouter)
  * [Resetting the Conversion Process](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#resetting-the-conversion-process)
  * [Stopping the Avrorouter](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#stopping-the-avrorouter)
  * [Example Client](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#example-client)
  * [Avro Schema Generator](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#avro-schema-generator)
    * [Simple Schema Generator](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#simple-schema-generator)
    * [Python Schema Generator](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#python-schema-generator)
    * [Go Schema Generator](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#go-schema-generator)
  * [Examples](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#examples)
  * [Building Avrorouter](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#building-avrorouter)
  * [Router Diagnostics](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#router-diagnostics)
  * [Limitations](mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md#limitations)
...
For information about common service parameters, refer to the[Configuration Guide](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md).
...
files are assumed to follow the naming schema _._ where is\
the binlog number and is the value of this router option.
...
Refer to the [Configuration Guide](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)\
...
Read [Module Commands](../mariadb-maxscale-24-08-beta-reference/mariadb-maxscale-2408-maxscale-2408-beta-module-commands.md) documentation for\
...
the user creation, please refer to the [CDC Protocol](../mariadb-maxscale-24-08-beta-protocols/mariadb-maxscale-2408-maxscale-2408-beta-change-data-capture-cdc-protocol.md)\
and [CDC Users](../mariadb-maxscale-24-08-beta-protocols/mariadb-maxscale-2408-maxscale-2408-beta-change-data-capture-cdc-users.md) documentation.
...
The [Avrorouter Tutorial](../mariadb-maxscale-24-08-beta-tutorials/mariadb-maxscale-2408-maxscale-2408-beta-avrorouter-tutorial.md) shows you how\
...
For more details about building MaxScale from source, please refer to the[Building MaxScale from Source Code](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-building-mariadb-maxscale-from-source-code.md)\
document.
