...
If duplicate tables are expected, use the[ignore\_tables\_regex](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#ignore_tables_regex) parameter to control which\
duplicate tables are allowed. To disable the duplicate database detection, use`ignore_tables_regex=.*`. Starting with MaxScale 24.08, the detection of\
...
See [Limitations](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#limitations) for more information.
...
* [SchemaRouter](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#schemarouter)
  * [Routing Logic](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#routing-logic)
    * [Custom SQL Commands](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#custom-sql-commands)
    * [Database Mapping](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#database-mapping)
  * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#configuration)
  * [Router Parameters](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#router-parameters)
    * [allow\_duplicates](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#allow_duplicates)
    * [ignore\_tables](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#ignore_tables)
    * [ignore\_tables\_regex](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#ignore_tables_regex)
    * [preferred\_server](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#preferred_server)
    * [ignore\_databases](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#ignore_databases)
    * [ignore\_databases\_regex](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#ignore_databases_regex)
    * [max\_sescmd\_history](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#max_sescmd_history)
    * [disable\_sescmd\_history](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#disable_sescmd_history)
    * [refresh\_databases](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#refresh_databases)
    * [refresh\_interval](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#refresh_interval)
    * [max\_staleness](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#max_staleness)
  * [Table Family Sharding](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#table-family-sharding)
  * [Router Diagnostics](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#router-diagnostics)
  * [Module commands](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#module-commands)
    * [invalidate SERVICE](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#invalidate-service)
    * [clear SERVICE](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#clear-service)
  * [Limitations](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#limitations)
  * [Examples](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#examples)
...
A [PCRE2 regular expression](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)\
...
This parameter has been removed in MaxScale 6.0, use[ignore\_tables](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#ignore_tables) instead.

#### `ignore_databases_regex`

This parameter has been removed in MaxScale 6.0, use[ignore\_tables\_regex](mariadb-maxscale-2408-maxscale-2408-beta-schemarouter.md#ignore_tables_regex) instead.

#### `max_sescmd_history`

This parameter has been moved to[the MaxScale core](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)\
in MaxScale 6.0.
...
The interval is specified as documented[here](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md). If no explicit unit\
...
[Here](../mariadb-maxscale-24-08-beta-tutorials/mariadb-maxscale-2408-maxscale-2408-beta-schemarouter-simple-sharding-with-two-servers.md) is a small tutorial on how\
