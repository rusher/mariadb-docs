# mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter
...
* [Binlogrouter](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#binlogrouter)
  * [Binlog purge, archive and compress](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#binlog-purge-archive-and-compress)
  * [Modifying binlog files manually](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#modifying-binlog-files-manually)
  * [Supported SQL Commands](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#supported-sql-commands)
  * [Semi-sync replication](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#semi-sync-replication)
  * [Configuration Parameters](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#configuration-parameters)
    * [datadir](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#datadir)
    * [archivedir](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#archivedir)
    * [server\_id](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#server_id)
    * [net\_timeout](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#net_timeout)
    * [select\_master](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#select_master)
    * [expiration\_mode](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#expiration_mode)
    * [expire\_log\_duration](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#expire_log_duration)
    * [expire\_log\_minimum\_files](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#expire_log_minimum_files)
    * [compression\_algorithm](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#compression_algorithm)
    * [number\_of\_noncompressed\_files](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#number_of_noncompressed_files)
    * [ddl\_only](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#ddl_only)
    * [encryption\_key\_id](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#encryption_key_id)
    * [encryption\_cipher](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#encryption_cipher)
    * [rpl\_semi\_sync\_slave\_enabled](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#rpl_semi_sync_slave_enabled)
  * [New installation](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#new-installation)
  * [Upgrading from legacy versions](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#upgrading-from-legacy-versions)
    * [Before you start](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#before-you-start)
    * [Deployment](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#deployment)
    * [Bootstrap binlogrouter](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#bootstrap-binlogrouter)
  * [Galera cluster](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#galera-cluster)
  * [Example](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#example)
  * [Limitations](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#limitations)
...
directory. See ['Modifying binlog files manually'](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#modifying-binlog-files-manually).

The related configuration options, which are explained in more detail in the\
configuration section are:[_expiration\_mode_](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#expiration_mode) _Select purge or archive._ [datadir](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#datadir) Directory where binlog files are stored (the default is usually fine).[_archivedir_](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#archivedir) _Directory to which files are archived. This directory_\
_must exist when MaxScale is started._ [expire\_log\_minimum\_files](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#expire_log_minimum_files) The minimum number of\
binlogs to keep before purge or archive is allowed.[_expire\_log\_duration_](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#expire_log_duration) _Duration from the last file_\
_modification until the binlog is eligible for purge or archive._ [compression\_algorithm](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#compression_algorithm) Select a compression algorithm\
or `none` for no compression. Currently only zstandard is supported.

* [number\_of\_noncompressed\_files](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#number_of_noncompressed_files) The minimum number of\
...
any changes if running a version prior to 23.08, except when a[bootstrap](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#bootstrap-binlogrouter) is needed.
...
* Purges binary logs up to but not including the given file. The file name\
  ...
  parameter [expire\_log\_duration](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#expire_log_duration).\
...
configuration can be found in the [example](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#example) section of this document.
...
Directory where binary log files are stored. By default the files are stored in`/var/lib/maxscale/binlogs`. **NOTE:** If you are upgrading from a version prior\
...
* Type: string
* Mandatory: Yes if \`expiration\_mode=archive"
* Default: No
* Dynamic: No
...
This is similar to the server system variable[expire\_log\_days](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/standard-replication/replication-and-binary-log-system-variables#expire_logs_days).
...
* Make sure that the configured data directory for the new binlogrouter\
  ...
  See [datadir](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#datadir).
...
2. Issue a `CHANGE MASTER TO` command, or use [select\_master](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#select_master).
...
See [select\_master](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#select_master).
...
if [select\_master](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#select_master) is set to `true` and the primary contains\
...
If [select\_master](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#select_master) is set to true issue:
...
When replicating from a Galera cluster, [select\_master](mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md#select_master) must be\
