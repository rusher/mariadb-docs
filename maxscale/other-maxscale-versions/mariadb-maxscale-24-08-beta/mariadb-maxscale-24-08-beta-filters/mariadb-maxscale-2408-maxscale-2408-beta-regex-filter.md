# MaxScale 24.08 Beta Regex Filter

* [Regex Filter](mariadb-maxscale-2408-maxscale-2408-beta-regex-filter.md#regex-filter)
  * [Overview](mariadb-maxscale-2408-maxscale-2408-beta-regex-filter.md#overview)
  * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-regex-filter.md#configuration)
  * [Filter Parameters](mariadb-maxscale-2408-maxscale-2408-beta-regex-filter.md#filter-parameters)
    * [match, options](mariadb-maxscale-2408-maxscale-2408-beta-regex-filter.md#match-options)
    * [replace](mariadb-maxscale-2408-maxscale-2408-beta-regex-filter.md#replace)
    * [source](mariadb-maxscale-2408-maxscale-2408-beta-regex-filter.md#source)
    * [user](mariadb-maxscale-2408-maxscale-2408-beta-regex-filter.md#user)
    * [log\_file](mariadb-maxscale-2408-maxscale-2408-beta-regex-filter.md#log_file)
    * [log\_trace](mariadb-maxscale-2408-maxscale-2408-beta-regex-filter.md#log_trace)
  * [Examples](mariadb-maxscale-2408-maxscale-2408-beta-regex-filter.md#examples)
    * [Example 1 - Replace MySQL 5.1 create table syntax with that for later versions](mariadb-maxscale-2408-maxscale-2408-beta-regex-filter.md#example-1-replace-mysql-51-create-table-syntax-with-that-for-later-versions)
...
_match_ is a[PCRE2 regular expression](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)\
which defines the text in the SQL statements that is replaced.

The _options_-parameter affects how the patterns are compiled as[usual](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md).\
...
session specific logging, please read the[Configuration Guide](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md).
