...
* [Consistent Critical Read Filter](mariadb-maxscale-2408-maxscale-2408-beta-consistent-critical-read-filter.md#consistent-critical-read-filter)
  * [Overview](mariadb-maxscale-2408-maxscale-2408-beta-consistent-critical-read-filter.md#overview)
    * [Controlling the Filter with SQL Comments](mariadb-maxscale-2408-maxscale-2408-beta-consistent-critical-read-filter.md#controlling-the-filter-with-sql-comments)
  * [Filter Parameters](mariadb-maxscale-2408-maxscale-2408-beta-consistent-critical-read-filter.md#filter-parameters)
    * [time](mariadb-maxscale-2408-maxscale-2408-beta-consistent-critical-read-filter.md#time)
    * [count](mariadb-maxscale-2408-maxscale-2408-beta-consistent-critical-read-filter.md#count)
    * [match, ignore and options](mariadb-maxscale-2408-maxscale-2408-beta-consistent-critical-read-filter.md#match-ignore-and-options)
    * [global](mariadb-maxscale-2408-maxscale-2408-beta-consistent-critical-read-filter.md#global)
  * [Example Configuration](mariadb-maxscale-2408-maxscale-2408-beta-consistent-critical-read-filter.md#example-configuration)
...
can be specified as documented[here](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)\
