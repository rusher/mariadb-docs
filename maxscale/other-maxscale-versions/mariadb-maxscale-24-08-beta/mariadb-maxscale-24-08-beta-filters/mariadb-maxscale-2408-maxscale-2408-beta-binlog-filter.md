...
* [Binlog Filter](mariadb-maxscale-2408-maxscale-2408-beta-binlog-filter.md#binlog-filter)
  * [Overview](mariadb-maxscale-2408-maxscale-2408-beta-binlog-filter.md#overview)
  * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-binlog-filter.md#configuration)
    * [match and exclude](mariadb-maxscale-2408-maxscale-2408-beta-binlog-filter.md#match-and-exclude)
    * [rewrite\_src and rewrite\_dest](mariadb-maxscale-2408-maxscale-2408-beta-binlog-filter.md#rewrite_src-and-rewrite_dest)
  * [Example Configuration](mariadb-maxscale-2408-maxscale-2408-beta-binlog-filter.md#example-configuration)
...
Both the _match_ and _exclude_ parameters are optional and work mostly as other[typical regular expression parameters](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md).\
...
For more information about the binlogrouter and how to use it, refer to the[binlogrouter documentation](../mariadb-maxscale-24-08-beta-routers/mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md).
