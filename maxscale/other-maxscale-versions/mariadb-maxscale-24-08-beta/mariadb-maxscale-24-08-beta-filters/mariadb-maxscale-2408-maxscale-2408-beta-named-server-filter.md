# MaxScale 24.08 Beta Named Server Filter

* [Named Server Filter](mariadb-maxscale-2408-maxscale-2408-beta-named-server-filter.md#named-server-filter)
  * [Overview](mariadb-maxscale-2408-maxscale-2408-beta-named-server-filter.md#overview)
  * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-named-server-filter.md#configuration)
  * [Filter Parameters](mariadb-maxscale-2408-maxscale-2408-beta-named-server-filter.md#filter-parameters)
    * [matchXY, options](mariadb-maxscale-2408-maxscale-2408-beta-named-server-filter.md#matchxy-options)
    * [targetXY](mariadb-maxscale-2408-maxscale-2408-beta-named-server-filter.md#targetxy)
    * [source](mariadb-maxscale-2408-maxscale-2408-beta-named-server-filter.md#source)
    * [user](mariadb-maxscale-2408-maxscale-2408-beta-named-server-filter.md#user)
  * [Additional remarks](mariadb-maxscale-2408-maxscale-2408-beta-named-server-filter.md#additional-remarks)
  * [Examples](mariadb-maxscale-2408-maxscale-2408-beta-named-server-filter.md#examples)
    * [Example 1 - Route queries targeting a specific table to a server](mariadb-maxscale-2408-maxscale-2408-beta-named-server-filter.md#example-1-route-queries-targeting-a-specific-table-to-a-server)
...
also be embedded into SQL-queries, see[Hint-Syntax](../mariadb-maxscale-24-08-beta-reference/mariadb-maxscale-2408-maxscale-2408-beta-hint-syntax.md).
...
_matchXY_ defines a[PCRE2 regular expression](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)\
...
attaches a routing hint defined by the _target_-setting to the query. Th&#x65;_&#x6F;ptions_-parameter affects how the patterns are compiled as[usual](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md).
