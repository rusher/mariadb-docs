# MaxScale 24.08 Beta Hintfilter

This filter adds routing hints to a service. The filter has no parameters.

* [Hintfilter](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#hintfilter)
* [Hint Syntax](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#hint-syntax)
  * [Comments and comment types](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#comments-and-comment-types)
  * [Hint body](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#hint-body)
    * [Routing destination hints](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#routing-destination-hints)
      * [Route to primary](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#route-to-primary)
      * [Route to replica](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#route-to-replica)
      * [Route to named server](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#route-to-named-server)
      * [Route to last used server](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#route-to-last-used-server)
      * [Name-value hints](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#name-value-hints)
  * [Hint stack](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#hint-stack)
* [Prepared Statements](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#prepared-statements)
  * [Binary Protocol](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#binary-protocol)
  * [Text Protocol](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#text-protocol)
* [Examples](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#examples)
  * [Routing SELECT queries to primary](mariadb-maxscale-2408-maxscale-2408-beta-hintfilter.md#routing-select-queries-to-primary)
