...
The *WCAR* filter captures client traffic and stores it in a replayable format.
...
* [WCAR: Workload Capture and Replay](#wcar-workload-capture-and-replay)
...
* [WCAR Parameters](#wcar-parameters)
