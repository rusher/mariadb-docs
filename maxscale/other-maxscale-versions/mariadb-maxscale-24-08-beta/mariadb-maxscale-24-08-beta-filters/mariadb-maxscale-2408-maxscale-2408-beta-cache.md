...
* [Cache](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#cache)
  * [Overview](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#overview)
  * [Limitations](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#limitations)
    * [Prepared Statements](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#prepared-statements)
    * [Multi-statements](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#multi-statements)
    * [Security](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#security)
    * [information\_schema](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#information_schema)
  * [Invalidation](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#invalidation)
    * [Best Efforts](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#best-efforts)
  * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#configuration)
    * [Filter Parameters](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#filter-parameters)
      * [storage](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#storage)
      * [storage\_options](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#storage_options)
      * [hard\_ttl](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#hard_ttl)
      * [soft\_ttl](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#soft_ttl)
      * [max\_resultset\_rows](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#max_resultset_rows)
      * [max\_resultset\_size](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#max_resultset_size)
      * [max\_count](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#max_count)
      * [max\_size](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#max_size)
      * [rules](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#rules)
      * [cached\_data](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#cached_data)
      * [selects](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#selects)
      * [cache\_in\_transactions](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#cache_in_transactions)
      * [debug](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#debug)
      * [enabled](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#enabled)
      * [invalidate](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#invalidate)
      * [clear\_cache\_on\_parse\_errors](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#clear_cache_on_parse_errors)
      * [users](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#users)
      * [timeout](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#timeout)
    * [Runtime Configuration](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#runtime-configuration)
      * [@maxscale.cache.populate](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#maxscalecachepopulate)
      * [@maxscale.cache.use](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#maxscalecacheuse)
      * [@maxscale.cache.soft\_ttl](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#maxscalecachesoft_ttl)
      * [@maxscale.cache.hard\_ttl](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#maxscalecachehard_ttl)
      * [Client Driven Caching](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#client-driven-caching)
  * [Threads, Users and Invalidation](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#threads-users-and-invalidation)
    * [Invalidation](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#invalidation_1)
      * [cached\_data=thread\_specific](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#cached_datathread_specific)
      * [cache\_data=shared](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#cache_datashared)
  * [Rules](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#rules_1)
    * [When to Store](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#when-to-store)
      * [Qualified Names](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#qualified-names)
      * [Implication of the default database](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#implication-of-the-default-database)
      * [Regexp Matching](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#regexp-matching)
      * [Examples](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#examples)
    * [When to Use](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#when-to-use)
      * [Examples](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#examples_1)
  * [Security](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#security_1)
  * [Storage](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#storage_1)
    * [storage\_inmemory](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#storage_inmemory)
    * [storage\_memcached](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#storage_memcached)
      * [server](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#server)
      * [max\_value\_size](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#max_value_size)
      * [Example](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#example)
      * [Limitations](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#limitations_1)
      * [Security](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#security_2)
    * [storage\_redis](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#storage_redis)
      * [server](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#server_1)
      * [username](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#username)
      * [password](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#password)
      * [ssl](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#ssl)
      * [ssl\_cert](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#ssl_cert)
      * [ssl\_key](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#ssl_key)
      * [ssl\_ca](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#ssl_ca)
      * [Authentication](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#authentication)
      * [SSL](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#ssl_1)
      * [Example](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#example_1)
      * [Limitations](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#limitations_2)
      * [Invalidation](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#invalidation_2)
      * [Security](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#security_3)
  * [Example](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#example_2)
    * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#configuration_1)
    * [cache\_rules.json](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#cache_rulesjson)
  * [Performance](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#performance)
    * [Summary](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#summary)
...
The default behaviour can be altered using the configuration parameter[cache\_in\_transactions](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#cache_in_transactions).

By default it is assumed that all `SELECT` statements are cacheable, which\
means that also statements like `SELECT LOCALTIME` are cached. Please check[selects](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#selects) for how to change the default behaviour.
...
Please read the section [Security](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#security-1) for more detailed information.
...
be no unintended sharing. Please see [users](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#users) for how to change\
the default behaviour.

#### `information_schema`

When [invalidation](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#invalidation) is enabled, SELECTs targeting tables\
...
invalidated even if the INSERT actually does not affect it. Please see[invalidate](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#invalidate) for how to enable the invalidation.
...
can be changed using the configuration parameter[clear\_cache\_on\_parse\_errors](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#clear_cache_on_parse_errors).

Note that what threading approach is used has a big impact on the\
invalidation. Please see[Threads, Users and Invalidation](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#threads-users-and-invalidation)\
...
is still important to configure a reasonable [soft](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#soft_ttl) and[hard](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#hard_ttl) TTL.
...
See [Storage](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#storage-1) for what storage modules are available.
...
backend (and cached). See also [soft\_ttl](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#soft_ttl).
...
However, as long as [hard\_ttl](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#hard_ttl) has not passed, _all_ other clients\
...
as described [here](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md).
...
cost. Please read [performance](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#performance) for more details.
...
at runtime. Please see[Runtime Configuration](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#runtime-configuration)\
for details.
...
be disabled and a connection attempt will be made after a [timeout](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#timeout)\
interval.
...
Please see [authentication](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#authentication) for more information.
...
Please see [ssl](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#ssl-1) for more information.
...
`storage_redis` supports invalidation, but the caveats documented [here](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#best-efforts)\
...
Unless [SSL](mariadb-maxscale-2408-maxscale-2408-beta-cache.md#ssl) has been enabled, _anybody_ with access to the network has\
...
However, when the[query classifier cache](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)\
