# MaxScale 24.08 Beta LDI Filter

* [LDI Filter](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#ldi-filter)
  * [How to Upload Data](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#how-to-upload-data)
    * [Data Uploads with MariaDB Xpand](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#data-uploads-with-mariadb-xpand)
  * [Common Problems With Data Loading](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#common-problems-with-data-loading)
    * [Missing Files](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#missing-files)
  * [Configuration Parameters](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#configuration-parameters)
    * [key](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#key)
    * [secret](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#secret)
    * [region](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#region)
    * [host](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#host)
    * [port](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#port)
    * [no\_verify](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#no_verify)
    * [use\_http](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#use_http)
    * [protocol\_version](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#protocol_version)
    * [import\_user](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#import_user)
    * [import\_password](mariadb-maxscale-2408-maxscale-2408-beta-ldi-filter.md#import_password)
