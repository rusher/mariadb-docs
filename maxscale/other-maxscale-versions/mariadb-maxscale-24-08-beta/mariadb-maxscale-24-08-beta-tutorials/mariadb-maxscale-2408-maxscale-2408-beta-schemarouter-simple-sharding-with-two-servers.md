...
This tutorial was written for Ubuntu 22.04, MaxScale 23.08 and[MariaDB 10.11](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/mariadb-10-11-series/what-is-mariadb-1011). In addition to\
...
brevity and backwards compatibility. For the minimal set of grants, refer to the[MaxScale Configuration Guide](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md).
...
service\_user credentials we defined earlier. By default the schemarouter warns\
if two or more nodes have duplicate schemas so we need to ignore them with`ignore_tables_regex=.*`.
