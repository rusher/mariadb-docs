...
The full list of all available endpoints in MaxScale can be found in the[REST API documentation](../mariadb-maxscale-24-08-beta-rest-api/mariadb-maxscale-2408-maxscale-2408-beta-rest-api.md).
