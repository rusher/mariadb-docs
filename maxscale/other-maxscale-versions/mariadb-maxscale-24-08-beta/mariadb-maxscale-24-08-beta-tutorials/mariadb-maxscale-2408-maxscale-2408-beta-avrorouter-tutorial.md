...
This tutorial is a short introduction to the[Avrorouter](../mariadb-maxscale-24-08-beta-routers/mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md), how to set it up and how it interacts\
...
Documentation](../mariadb-maxscale-24-08-beta-routers/mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md).
...
* Dump the database to a replica, configure it to replicate from the primary and\
  ...
  extra steps)
* Use the [cdc\_schema Go utility](../mariadb-maxscale-24-08-beta-routers/mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md)\
...
For more details about the SQL commands, refer to the[Binlogrouter](../mariadb-maxscale-24-08-beta-routers/mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md) documentation.
