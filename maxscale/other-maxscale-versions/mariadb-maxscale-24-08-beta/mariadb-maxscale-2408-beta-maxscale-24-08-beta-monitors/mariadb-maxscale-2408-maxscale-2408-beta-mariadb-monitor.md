# mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor

## MaxScale 24.08 Beta MariaDB Monitor

## MariaDB Monitor

* [MariaDB Monitor](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#mariadb-monitor)
  * [Overview](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#overview)
  * [Required Grants](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#required-grants)
    * [Cluster Manipulation Grants](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cluster-manipulation-grants)
  * [Primary selection](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#primary-selection)
  * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#configuration)
  * [Common Monitor Parameters](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#common-monitor-parameters)
  * [MariaDB Monitor optional parameters](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#mariadb-monitor-optional-parameters)
    * [assume\_unique\_hostnames](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#assume_unique_hostnames)
    * [private\_address](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#private_address)
    * [master\_conditions](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#master_conditions)
    * [slave\_conditions](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#slave_conditions)
    * [failcount](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#failcount)
    * [enforce\_writable\_master](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#enforce_writable_master)
    * [enforce\_read\_only\_slaves](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#enforce_read_only_slaves)
    * [enforce\_read\_only\_servers](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#enforce_read_only_servers)
    * [maintenance\_on\_low\_disk\_space](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#maintenance_on_low_disk_space)
    * [cooperative\_monitoring\_locks](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cooperative_monitoring_locks)
    * [script\_max\_replication\_lag](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#script_max_replication_lag)
  * [Cluster manipulation operations](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cluster-manipulation-operations)
    * [Operation details](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#operation-details)
      * [Failover](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#failover)
      * [Failover-safe](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#failover-safe)
      * [Switchover](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#switchover)
      * [Switchover-force](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#switchover-force)
      * [Rejoin](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#rejoin)
      * [Reset Replication](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#reset-replication)
    * [Manual activation](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#manual-activation)
      * [Queued switchover](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#queued-switchover)
      * [Switchover with key-value arguments](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#switchover-with-key-value-arguments)
    * [Automatic activation](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#automatic-activation)
    * [Limitations and requirements](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#limitations-and-requirements)
    * [External primary support](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#external-primary-support)
    * [Configuration parameters](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#configuration-parameters)
      * [auto\_failover](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#auto_failover)
      * [auto\_rejoin](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#auto_rejoin)
      * [switchover\_on\_low\_disk\_space](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#switchover_on_low_disk_space)
      * [enforce\_simple\_topology](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#enforce_simple_topology)
      * [replication\_user and replication\_password](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#replication_user-and-replication_password)
      * [replication\_master\_ssl](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#replication_master_ssl)
      * [replication\_custom\_options](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#replication_custom_options)
      * [failover\_timeout and switchover\_timeout](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#failover_timeout-and-switchover_timeout)
      * [verify\_master\_failure and master\_failure\_timeout](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#verify_master_failure-and-master_failure_timeout)
      * [servers\_no\_promotion](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#servers_no_promotion)
      * [promotion\_sql\_file and demotion\_sql\_file](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#promotion_sql_file-and-demotion_sql_file)
      * [handle\_events](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#handle_events)
  * [Cooperative monitoring](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cooperative-monitoring)
    * [Releasing locks](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#releasing-locks)
  * [Primary server write test](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#primary-server-write-test)
    * [write\_test\_interval](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#write_test_interval)
    * [write\_test\_table](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#write_test_table)
    * [write\_test\_fail\_action](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#write_test_fail_action)
  * [Backup operations](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#backup-operations)
    * [Rebuild server](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#rebuild-server)
    * [Create backup](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#create-backup)
    * [Restore from backup](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#restore-from-backup)
    * [Settings](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#settings)
      * [ssh\_user](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#ssh_user)
      * [ssh\_keyfile](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#ssh_keyfile)
      * [ssh\_check\_host\_key](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#ssh_check_host_key)
      * [ssh\_timeout](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#ssh_timeout)
      * [ssh\_port](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#ssh_port)
      * [rebuild\_port](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#rebuild_port)
      * [mariabackup\_use\_memory](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#mariabackup_use_memory)
      * [mariabackup\_parallel](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#mariabackup_parallel)
      * [backup\_storage\_address](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#backup_storage_address)
      * [backup\_storage\_path](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#backup_storage_path)
    * [sudoers.d configuration](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#sudoersd-configuration)
  * [ColumnStore commands](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#columnstore-commands)
    * [Get status](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#get-status)
    * [Add or remove node](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#add-or-remove-node)
    * [Start and stop cluster](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#start-and-stop-cluster)
    * [Set read-only or readwrite](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#set-read-only-or-readwrite)
    * [Settings](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#settings_1)
      * [cs\_admin\_port](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cs_admin_port)
      * [cs\_admin\_api\_key](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cs_admin_api_key)
      * [cs\_admin\_base\_path](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cs_admin_base_path)
  * [Other commands](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#other-commands)
    * [fetch-cmd-result](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#fetch-cmd-result)
    * [cancel-cmd](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cancel-cmd)
  * [Troubleshooting](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#troubleshooting)
    * [Failover/switchover fails](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#failoverswitchover-fails)
    * [Replica detection shows external primaries](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#replica-detection-shows-external-primaries)
  * [Using the MariaDB Monitor With Binlogrouter](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#using-the-mariadb-monitor-with-binlogrouter)
...
If [cluster manipulation operations](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cluster-manipulation-operations) are used,\
...
described in section[Failover, switchover and auto-rejoin](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#failover,-switchover-and-auto-rejoin).\
...
list of the grants can be found in the [Required Grants](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#required-grants)\
section.

### Common Monitor Parameters

For a list of optional parameters that all monitors support, read the[Monitor Common](mariadb-maxscale-2408-maxscale-2408-beta-common-monitor-parameters.md) document.

### MariaDB Monitor optional parameters

These are optional parameters specific to the MariaDB Monitor. Failover,\
switchover and rejoin-specific parameters are listed in their own[section](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cluster-manipulation-operations). Rebuild-related parameters are\
described in the [Rebuild server-section](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#rebuild-server). ColumnStore\
parameters are described in the [ColumnStore commands-section](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#settings).
...
given in [private\_address](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#private_address).
...
Enum, default: _primary\_monitor\_master, disk\_space\_ok_. Designate additional\
conditions for _Master_-status, i.e qualified for read and write queries.

Normally, if a suitable primary candidate server is found as described in[Primary selection](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#primary-selection), MaxScale designates it _Master_._master\_conditions_ sets additional conditions for a primary server. This\
...
5. primary\_monitor\_master : If this MaxScale is[cooperating](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cooperative-monitoring) with another MaxScale and this is the\
...
6. disk\_space\_ok : The candidate primary must not be low on disk space. This\
   option only takes effect if[disk space check](mariadb-maxscale-2408-maxscale-2408-beta-common-monitor-parameters.md) is enabled. Added in\
   MaxScale 23.08.5.
...
search for another server to fulfill the primary role. See section[Primary selection](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#primary-selection)\
...
lost \[Master]-status due to [master\_conditions](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#master_conditions) and is\
marked \[Slave].

#### `enforce_read_only_servers`

Boolean, default: false. Works similar to[enforce\_read\_only\_slaves](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#enforce_read_only_slaves) except will se&#x74;_&#x72;ead\_only_ on any writable server that is not the primary and not in\
...
parameters [disk\_space\_threshold](mariadb-maxscale-2408-maxscale-2408-beta-common-monitor-parameters.md) and[disk\_space\_check\_interval](mariadb-maxscale-2408-maxscale-2408-beta-common-monitor-parameters.md)\
...
servers or just over running servers. See[Cooperative monitoring](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cooperative-monitoring)\
...
see [general monitor documentation](https://mariadb.com/kb/en/node:maxscale-24-08-beta-common-monitor-parameters#script).
...
* [failover](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#failover), which replaces a failed primary with a replica
* [failover-safe](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#failover-safe), which replaces a failed primary with a replica\
  only if no data is clearly lost
* [switchover](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#switchover), which swaps a running primary with a replica
* [switchover-force](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#switchover-force), which swaps a running primary with a replica, ignoring\
  most errors
* [async-switchover](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#queued-switchover), which schedules a switchover and returns
* [rejoin](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#rejoin), which directs servers to replicate from the primary
* [reset-replication](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#reset-replication) (added in MaxScale 2.3.0), which deletes binary logs and\
  resets gtid:s

See [operation details](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#operation-details) for more information on the\
...
A list of the grants can be found in the [Required Grants](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#required-grants)\
section.
...
section [Manual activation](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#manual-activation) for more details.

See [Limitations and requirements](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#limitations-and-requirements) for\
...
for the [server](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)\
or the [monitor](mariadb-maxscale-2408-maxscale-2408-beta-common-monitor-parameters.md).\
Also, [disk\_space\_check\_interval](mariadb-maxscale-2408-maxscale-2408-beta-common-monitor-parameters.md)\
...
The timeouts are specified as documented[here](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md). If no explicit unit\
...
Enable additional primary failure verification for automatic failover.`verify_master_failure` is a boolean value (default: true) which enables this\
feature and `master_failure_timeout` defines the timeout (default: 10 seconds).

The primary failure timeout is specified as documented[here](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md). If no explicit unit\
is provided, the value is interpreted as seconds in MaxScale 2.4. In subsequent\
versions a value without a unit may be rejected. Note that since the granularity\
...
enabled with the[cooperative\_monitoring\_locks](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#cooperative_monitoring_locks)-setting.\
...
![](../../../.gitbook/assets/mariadb-corporation/MaxScale/24.08.0/Documentation/Monitors/images/coop_lock_no_majority.png.png)
...
![](../../../.gitbook/assets/mariadb-corporation/MaxScale/24.08.0/Documentation/Monitors/images/coop_lock_split_brain.png.png)
...
![](../../../.gitbook/assets/mariadb-corporation/MaxScale/24.08.0/Documentation/Monitors/images/coop_lock_flowchart.svg.svg)
...
This test inserts one row to the table configured in[write\_test\_table](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#write_test_table). If the insert fails or does not complete\
within [backend\_read\_timeout](mariadb-maxscale-2408-maxscale-2408-beta-common-monitor-parameters.md),\
the server fails the write test. What happens after that depends on[write\_test\_fail\_action](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#write_test_fail_action).
...
fails the write test [failcount](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#failcount) consecutive times. That is,\
...
1. Mariabackup. Backs up and restores MariaDB Server contents. Installed e.g.\
   with `yum install MariaDB-backup`. See[Mariabackup documentation](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/backing-up-and-restoring-databases/mariabackup) for more\
   information.
...
The monitor user may thus require additional privileges. See[Mariabackup documentation](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/backing-up-and-restoring-databases/mariabackup/mariabackup-overview#authentication-and-privileges)\
for more details.
...
difference is that the backup data is copied with _tar_ instead of Mariabackup.\
...
no `--use-memory` is set and Mariabackup will use its internal default. See[here](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/backing-up-and-restoring-databases/mariabackup/mariabackup-options#-use-memory) for more\
information.
...
String. Path to main backup storage directory on backup storage host. _ssh\_user_\
...
ColumnStore command settings are listed [here](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#settings). At least`cs_admin_api_key` must be set.
...
See the [Limitations and requirements-section](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#limitations_and_requirements).
...
controlled by the setting [assume\_unique\_hostnames](mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md#assume_unique_hostnames).
