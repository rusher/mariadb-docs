# MaxScale 24.08 Beta Galera Monitor

* [Galera Monitor](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#galera-monitor)
  * [Overview](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#overview)
    * [Galera clusters and replicas replicating from it](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#galera-clusters-and-replicas-replicating-from-it)
  * [Required Grants](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#required-grants)
  * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#configuration)
  * [Common Monitor Parameters](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#common-monitor-parameters)
  * [Galera Monitor optional parameters](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#galera-monitor-optional-parameters)
    * [disable\_master\_failback](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#disable_master_failback)
    * [available\_when\_donor](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#available_when_donor)
    * [disable\_master\_role\_setting](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#disable_master_role_setting)
    * [use\_priority](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#use_priority)
    * [root\_node\_as\_master](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#root_node_as_master)
    * [set\_donor\_nodes](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#set_donor_nodes)
  * [Interaction with Server Priorities](mariadb-maxscale-2408-maxscale-2408-beta-galera-monitor.md#interaction-with-server-priorities)
