...
* [Named Server Filter](mariadb-maxscale-2302-named-server-filter.md#named-server-filter)
  * [Overview](mariadb-maxscale-2302-named-server-filter.md#overview)
  * [Configuration](mariadb-maxscale-2302-named-server-filter.md#configuration)
  * [Filter Parameters](mariadb-maxscale-2302-named-server-filter.md#filter-parameters)
    * [matchXY](mariadb-maxscale-2302-named-server-filter.md#matchxy)
      * [options](mariadb-maxscale-2302-named-server-filter.md#options)
    * [targetXY](mariadb-maxscale-2302-named-server-filter.md#targetxy)
    * [source](mariadb-maxscale-2302-named-server-filter.md#source)
    * [user](mariadb-maxscale-2302-named-server-filter.md#user)
  * [Additional remarks](mariadb-maxscale-2302-named-server-filter.md#additional-remarks)
  * [Examples](mariadb-maxscale-2302-named-server-filter.md#examples)
    * [Example 1 - Route queries targeting a specific table to a server](mariadb-maxscale-2302-named-server-filter.md#example-1-route-queries-targeting-a-specific-table-to-a-server)
...
also be embedded into SQL-queries, see[Hint-Syntax](../mariadb-maxscale-23-02-reference/mariadb-maxscale-2302-hint-syntax.md).
