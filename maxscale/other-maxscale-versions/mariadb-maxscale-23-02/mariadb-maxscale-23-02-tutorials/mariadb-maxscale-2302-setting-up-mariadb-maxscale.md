# mariadb-maxscale-2302-setting-up-mariadb-maxscale
...
read[Configuring MariaDB Monitor](mariadb-maxscale-2302-configuring-the-mariadb-monitor.md).\
For a Galera cluster read[Configuring Galera Monitor](mariadb-maxscale-2302-configuring-the-galera-monitor.md).

### Configuring the services and listeners

This part is covered in two different tutorials. For a fully automated\
read-write-splitting setup, read the[Read Write Splitting Tutorial](mariadb-maxscale-2302-read-write-splitting-with-mariadb-maxscale.md).\
For a simple connection based setup, read the[Connection Routing Tutorial](mariadb-maxscale-2302-connection-routing-with-mariadb-maxscale.md).
...
For more information about MaxCtrl and how to secure it, see the[REST-API Tutorial](mariadb-maxscale-2302-rest-api-tutorial.md).
