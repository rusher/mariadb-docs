...
* Type: [boolean](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#booleans)
* Default: true
* Dynamic: No
...
* Type: [duration](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#durations)
* Mandatory: No
* Dynamic: Yes
* Default: `0s`
...
Log messages to MariaDB MaxScale's log file. The name of the log file is`maxscale.log` and it is located in the directory pointed by [logdir](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#logdir).
...
* Type: number, [duration](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#durations), [duration](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#durations)
* Mandatory: No
* Dynamic: Yes
...
* Type: [size](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#sizes)
* Mandatory: No
* Dynamic: Yes
...
the cache. The size of the cache can be specifed as explained [here](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#sizes).
...
* Type: [enum](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#enumerations)
* Mandatory: No
* Dynamic: No
...
* Type: [regex](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#regular-expressions)
* Mandatory: No
* Dynamic: Yes
* Default: None
...
* Type: [enum\_mask](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#enumerations)
* Mandatory: No
* Dynamic: No
...
Synchronization](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#configuration-synchronization) section.
...
* Type: [durations](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#durations)
* Mandatory No
* Dynamic: Yes
* Default: `0s`
...
queries will hang, possibly for a long time. The timeout is controlled by[multiplex\_timeout](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#multiplex_timeout).
