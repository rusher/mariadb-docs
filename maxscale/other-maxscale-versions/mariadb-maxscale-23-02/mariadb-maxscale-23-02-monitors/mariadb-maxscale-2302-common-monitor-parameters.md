...
This parameter duplicates the `disk_space_threshold`[server parameter](../mariadb-maxscale-23-02-getting-started/mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#disk_space_threshold).\
