# mariadb-maxscale-2302-mariadb-monitor

## MariaDB Monitor

## MariaDB Monitor

* [MariaDB Monitor](mariadb-maxscale-2302-mariadb-monitor.md#mariadb-monitor)
  * [Overview](mariadb-maxscale-2302-mariadb-monitor.md#overview)
  * [Required Grants](mariadb-maxscale-2302-mariadb-monitor.md#required-grants)
    * [Cluster Manipulation Grants](mariadb-maxscale-2302-mariadb-monitor.md#cluster-manipulation-grants)
  * [Primary selection](mariadb-maxscale-2302-mariadb-monitor.md#primary-selection)
  * [Configuration](mariadb-maxscale-2302-mariadb-monitor.md#configuration)
  * [Common Monitor Parameters](mariadb-maxscale-2302-mariadb-monitor.md#common-monitor-parameters)
  * [MariaDB Monitor optional parameters](mariadb-maxscale-2302-mariadb-monitor.md#mariadb-monitor-optional-parameters)
    * [assume\_unique\_hostnames](mariadb-maxscale-2302-mariadb-monitor.md#assume_unique_hostnames)
    * [master\_conditions](mariadb-maxscale-2302-mariadb-monitor.md#master_conditions)
    * [slave\_conditions](mariadb-maxscale-2302-mariadb-monitor.md#slave_conditions)
    * [failcount](mariadb-maxscale-2302-mariadb-monitor.md#failcount)
    * [enforce\_writable\_master](mariadb-maxscale-2302-mariadb-monitor.md#enforce_writable_master)
    * [enforce\_read\_only\_slaves](mariadb-maxscale-2302-mariadb-monitor.md#enforce_read_only_slaves)
    * [enforce\_read\_only\_servers](mariadb-maxscale-2302-mariadb-monitor.md#enforce_read_only_servers)
    * [maintenance\_on\_low\_disk\_space](mariadb-maxscale-2302-mariadb-monitor.md#maintenance_on_low_disk_space)
    * [cooperative\_monitoring\_locks](mariadb-maxscale-2302-mariadb-monitor.md#cooperative_monitoring_locks)
    * [script\_max\_replication\_lag](mariadb-maxscale-2302-mariadb-monitor.md#script_max_replication_lag)
  * [Cluster manipulation operations](mariadb-maxscale-2302-mariadb-monitor.md#cluster-manipulation-operations)
    * [Operation details](mariadb-maxscale-2302-mariadb-monitor.md#operation-details)
      * [Failover](mariadb-maxscale-2302-mariadb-monitor.md#failover)
      * [Switchover](mariadb-maxscale-2302-mariadb-monitor.md#switchover)
      * [Rejoin](mariadb-maxscale-2302-mariadb-monitor.md#rejoin)
      * [Reset Replication](mariadb-maxscale-2302-mariadb-monitor.md#reset-replication)
    * [Manual activation](mariadb-maxscale-2302-mariadb-monitor.md#manual-activation)
      * [Queued switchover](mariadb-maxscale-2302-mariadb-monitor.md#queued-switchover)
    * [Automatic activation](mariadb-maxscale-2302-mariadb-monitor.md#automatic-activation)
    * [Limitations and requirements](mariadb-maxscale-2302-mariadb-monitor.md#limitations-and-requirements)
    * [External primary support](mariadb-maxscale-2302-mariadb-monitor.md#external-primary-support)
    * [Configuration parameters](mariadb-maxscale-2302-mariadb-monitor.md#configuration-parameters)
      * [auto\_failover](mariadb-maxscale-2302-mariadb-monitor.md#auto_failover)
      * [auto\_rejoin](mariadb-maxscale-2302-mariadb-monitor.md#auto_rejoin)
      * [switchover\_on\_low\_disk\_space](mariadb-maxscale-2302-mariadb-monitor.md#switchover_on_low_disk_space)
      * [enforce\_simple\_topology](mariadb-maxscale-2302-mariadb-monitor.md#enforce_simple_topology)
      * [replication\_user and replication\_password](mariadb-maxscale-2302-mariadb-monitor.md#replication_user-and-replication_password)
      * [replication\_master\_ssl](mariadb-maxscale-2302-mariadb-monitor.md#replication_master_ssl)
      * [replication\_custom\_options](mariadb-maxscale-2302-mariadb-monitor.md#replication_custom_options)
      * [failover\_timeout and switchover\_timeout](mariadb-maxscale-2302-mariadb-monitor.md#failover_timeout-and-switchover_timeout)
      * [verify\_master\_failure](mariadb-maxscale-2302-mariadb-monitor.md#verify_master_failure)
      * [master\_failure\_timeout](mariadb-maxscale-2302-mariadb-monitor.md#master_failure_timeout)
      * [servers\_no\_promotion](mariadb-maxscale-2302-mariadb-monitor.md#servers_no_promotion)
      * [promotion\_sql\_file and demotion\_sql\_file](mariadb-maxscale-2302-mariadb-monitor.md#promotion_sql_file-and-demotion_sql_file)
      * [handle\_events](mariadb-maxscale-2302-mariadb-monitor.md#handle_events)
  * [Cooperative monitoring](mariadb-maxscale-2302-mariadb-monitor.md#cooperative-monitoring)
    * [Releasing locks](mariadb-maxscale-2302-mariadb-monitor.md#releasing-locks)
  * [Backup operations](mariadb-maxscale-2302-mariadb-monitor.md#backup-operations)
    * [Rebuild server](mariadb-maxscale-2302-mariadb-monitor.md#rebuild-server)
    * [Create backup](mariadb-maxscale-2302-mariadb-monitor.md#create-backup)
    * [Restore from backup](mariadb-maxscale-2302-mariadb-monitor.md#restore-from-backup)
    * [Settings](mariadb-maxscale-2302-mariadb-monitor.md#settings)
      * [ssh\_user](mariadb-maxscale-2302-mariadb-monitor.md#ssh_user)
      * [ssh\_keyfile](mariadb-maxscale-2302-mariadb-monitor.md#ssh_keyfile)
      * [ssh\_check\_host\_key](mariadb-maxscale-2302-mariadb-monitor.md#ssh_check_host_key)
      * [ssh\_timeout](mariadb-maxscale-2302-mariadb-monitor.md#ssh_timeout)
      * [ssh\_port](mariadb-maxscale-2302-mariadb-monitor.md#ssh_port)
      * [rebuild\_port](mariadb-maxscale-2302-mariadb-monitor.md#rebuild_port)
      * [backup\_storage\_address](mariadb-maxscale-2302-mariadb-monitor.md#backup_storage_address)
      * [backup\_storage\_path](mariadb-maxscale-2302-mariadb-monitor.md#backup_storage_path)
    * [sudoers.d configuration](mariadb-maxscale-2302-mariadb-monitor.md#sudoersd-configuration)
  * [ColumnStore commands](mariadb-maxscale-2302-mariadb-monitor.md#columnstore-commands)
    * [Get status](mariadb-maxscale-2302-mariadb-monitor.md#get-status)
    * [Add or remove node](mariadb-maxscale-2302-mariadb-monitor.md#add-or-remove-node)
    * [Start and stop cluster](mariadb-maxscale-2302-mariadb-monitor.md#start-and-stop-cluster)
    * [Set read-only or readwrite](mariadb-maxscale-2302-mariadb-monitor.md#set-read-only-or-readwrite)
    * [Settings](mariadb-maxscale-2302-mariadb-monitor.md#settings_1)
      * [cs\_admin\_port](mariadb-maxscale-2302-mariadb-monitor.md#cs_admin_port)
      * [cs\_admin\_api\_key](mariadb-maxscale-2302-mariadb-monitor.md#cs_admin_api_key)
      * [cs\_admin\_base\_path](mariadb-maxscale-2302-mariadb-monitor.md#cs_admin_base_path)
  * [Other commands](mariadb-maxscale-2302-mariadb-monitor.md#other-commands)
    * [fetch-cmd-result](mariadb-maxscale-2302-mariadb-monitor.md#fetch-cmd-result)
    * [cancel-cmd](mariadb-maxscale-2302-mariadb-monitor.md#cancel-cmd)
  * [Troubleshooting](mariadb-maxscale-2302-mariadb-monitor.md#troubleshooting)
    * [Failover/switchover fails](mariadb-maxscale-2302-mariadb-monitor.md#failoverswitchover-fails)
    * [Replica detection shows external primaries](mariadb-maxscale-2302-mariadb-monitor.md#replica-detection-shows-external-primaries)
  * [Using the MariaDB Monitor With Binlogrouter](mariadb-maxscale-2302-mariadb-monitor.md#using-the-mariadb-monitor-with-binlogrouter)
...
search for another server to fulfill the primary role. See section[Primary selection](mariadb-maxscale-2302-mariadb-monitor.md#primary-selection)\
...
Works similar to[enforce\_read\_only\_slaves](mariadb-maxscale-2302-mariadb-monitor.md#enforce_read_only_slaves) except will se&#x74;_&#x72;ead\_only_ on any writable server that is not the primary and not in\
...
for the [server](../mariadb-maxscale-23-02-getting-started/mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md#disk_space_threshold)\
or the [monitor](mariadb-maxscale-2302-common-monitor-parameters.md#disk_space_threshold).\
Also, [disk\_space\_check\_interval](mariadb-maxscale-2302-common-monitor-parameters.md#disk_space_check_interval)\
...
![](../../../.gitbook/assets/mariadb-corporation/MaxScale/23.02.13/Documentation/Monitors/images/coop_lock_no_majority.png.png)
...
![](../../../.gitbook/assets/mariadb-corporation/MaxScale/23.02.13/Documentation/Monitors/images/coop_lock_split_brain.png.png)
...
![](../../../.gitbook/assets/mariadb-corporation/MaxScale/23.02.13/Documentation/Monitors/images/coop_lock_flowchart.svg.svg)
...
MaxScale uses to access the servers. MaxScale must be able to run commands wit&#x68;_&#x73;udo_ on both the source and target servers. See [settings](mariadb-maxscale-2302-mariadb-monitor.md#settings) and[sudoers.d configuration](mariadb-maxscale-2302-mariadb-monitor.md#sudoersd-configuration) below\
