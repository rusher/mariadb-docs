...
release [2.1.0](mariadb-maxscale-21-mariadb-maxscale-210-release-notes-2017-02-16.md).

If you are upgrading from release 2.0, please also read the following\
release notes:[2.1.0](https://mariadb.com/kb/en/node:mariadb-maxscale-21-mariadb-maxscale-210-release-notes-2017-02-16)
...
For more information about the failover mode and how it works, please read the[MySQL Monitor](../maxscale-21-monitors/mariadb-maxscale-21-mysql-monitor.md) documentation.

#### GSSAPI

_GASSAPI_ based authentication can now be used with MaxScale.

For more information, please read the[GSSAPI Authentication](../maxscale-21-authenticators/mariadb-maxscale-21-gssapi-client-authenticator.md) documentation.
