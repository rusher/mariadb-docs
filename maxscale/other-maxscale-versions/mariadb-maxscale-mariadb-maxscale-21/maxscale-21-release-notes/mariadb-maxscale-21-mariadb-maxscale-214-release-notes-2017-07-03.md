...
release [2.1.3](../../mariadb-maxscale-21-06/README.md).


If you are upgrading from release 2.0, please also read the following
release notes:
[2.1.3](https://mariadb.com/kb/en/node:mariadb-maxscale-21-mariadb-maxscale-213-release-notes-2017-05-23)
...
Please refer to the
 [masking documentation](../maxscale-21-filters/mariadb-maxscale-21-masking.md)
 for details.
