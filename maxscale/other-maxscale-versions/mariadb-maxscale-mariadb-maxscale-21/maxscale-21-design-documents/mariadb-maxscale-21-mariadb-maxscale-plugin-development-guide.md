...
* [Introduction](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#introduction)
* [Module categories](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#module-categories)
* [Common definitions and headers](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#common-definitions-and-headers)
* [Module information container](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#module-information-container)
* [Module API](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#module-api)
* [Overview](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#overview)
* [General module management](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#general-module-management)
* [Protocol](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#protocol)
* [Authenticator](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#authenticator)
* [Filter and Router](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#filter-and-router)
* [Monitor](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#monitor)
* [Compiling, installing and running](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#compiling-installing-and-running)
* [Hands-on example: RoundRobinRouter](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#hands-on-example-roundrobinrouter)
* [Summary and conclusion](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#summary-and-conclusion)
...
5.1](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#hands-on-example:-roundrobinrouter). The source for the router is located\
...
information on the GWBUF, see [Filter and Router](mariadb-maxscale-21-mariadb-maxscale-plugin-development-guide.md#filter-and-router).
