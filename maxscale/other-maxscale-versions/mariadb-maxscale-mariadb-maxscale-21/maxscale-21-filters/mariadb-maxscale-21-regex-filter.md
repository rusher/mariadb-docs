...
session specific logging, please read the [Configuration Guide](../maxscale-21-getting-started/mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#global-settings)
and the [MaxAdmin](../maxscale-21-reference/mariadb-maxscale-21-maxadmin-admin-interface.md#change-maxscale-logging-options) documentation on changing the logging levels.
