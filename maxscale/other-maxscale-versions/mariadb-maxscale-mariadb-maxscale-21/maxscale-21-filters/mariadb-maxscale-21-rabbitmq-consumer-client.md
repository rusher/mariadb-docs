# mariadb-maxscale-21-rabbitmq-consumer-client
...
This utility tool is used to read messages from a RabbitMQ broker sent by the[RabbitMQ Filter](mariadb-maxscale-21-rabbitmq-filter.md) and forward these messages into an\
