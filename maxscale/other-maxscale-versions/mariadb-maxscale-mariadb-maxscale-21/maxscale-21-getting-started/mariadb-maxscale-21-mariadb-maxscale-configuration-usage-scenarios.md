# mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios
...
* [Configuration](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#configuration)
* [Global Settings](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#global-settings)
* [Service](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#service)
* [Server](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#server)
* [Listener](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#listener)
* [TLS/SSL Encryption](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#tlsssl-encryption)
* [Router Modules](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#routing-modules)
* [Diagnostic Modules](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#diagnostic-modules)
* [Monitor Modules](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#monitor-modules)
* [Filter Modules](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#filter-modules)
* [Reloading Configuration](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#reloading-configuration)
* [Authentication](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#authentication)
* [Error Reporting](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#error-reporting)
...
to `required` and provide the three files for `ssl_cert`, `ssl_key` and`ssl_ca_cert`.
