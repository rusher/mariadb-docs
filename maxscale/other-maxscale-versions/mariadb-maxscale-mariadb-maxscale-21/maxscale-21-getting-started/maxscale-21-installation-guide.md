...
Depending on your OS, the package will either be a *deb* or an *rpm*.


An *rpm* is installed as follows
...
[Install MariaDB MaxScale using a Tarball](mariadb-maxscale-21-installing-mariadb-maxscale-using-a-tarball.md).
...
[Building MariaDB MaxScale from Source Code](mariadb-maxscale-21-building-mariadb-maxscale-from-source-code.md)
...
For more details, refer to the [Configuration Guide](mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md).
...
1. Look in the directory defined with libdir=PATH in the configuration file under the [maxscale] section
1. Look in default directory in /usr/lib64/maxscale
