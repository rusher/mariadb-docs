# mariadb-maxscale-21-simple-sharding-with-two-servers

## MaxScale 2.1 - Simple Sharding with Two Servers

## Simple Sharding with Two Servers

![](../../../.gitbook/assets/mariadb-corporation/MaxScale/2.1.17/Documentation/Tutorials/images/Simple-Sharding.png.png)
...
Follow the [MaxScale Tutorial](mariadb-maxscale-21-setting-up-mariadb-maxscale.md) to install and prepare the required database users for MaxScale. You don't need to create the configuration file for MaxScale as it will be covered in the next section.
