...
* [Starting MariaDB MaxScale](mariadb-maxscale-21-mariadb-maxscale-administration-tutorial.md#starting)
* [Stopping MariaDB MaxScale](mariadb-maxscale-21-mariadb-maxscale-administration-tutorial.md#stopping)
* [Checking The Status Of The MariaDB MaxScale Services](mariadb-maxscale-21-mariadb-maxscale-administration-tutorial.md#checking)
* [Persistent Connections](mariadb-maxscale-21-mariadb-maxscale-administration-tutorial.md#persistent)
* [What Clients Are Connected To MariaDB MaxScale](mariadb-maxscale-21-mariadb-maxscale-administration-tutorial.md#clients)
* [Rotating the Log File](mariadb-maxscale-21-mariadb-maxscale-administration-tutorial.md#rotating)
* [Taking A Database Server Out Of Use](mariadb-maxscale-21-mariadb-maxscale-administration-tutorial.md#outofuse)
...
configuration file placed at `/etc/sysconfig/maxscale` on RPM installations and`/etc/default/maxscale` file on DEB installations. Set the arguments in a\
