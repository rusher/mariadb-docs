# mariadb-maxscale-21-maxadmin-admin-interface
...
* [Overview](mariadb-maxscale-21-maxadmin-admin-interface.md#overview)
* [Configuring MariaDB MaxScale for MaxAdmin](mariadb-maxscale-21-maxadmin-admin-interface.md#configuring-mariadb-maxscale-for-maxadmin)
* [Running MaxAdmin](mariadb-maxscale-21-maxadmin-admin-interface.md#running-maxadmin)
* [Working With Administration Interface Users](mariadb-maxscale-21-maxadmin-admin-interface.md#working-with-administration-interface-users)
* [Getting Help](mariadb-maxscale-21-maxadmin-admin-interface.md#getting-help)
* [Working with Services](mariadb-maxscale-21-maxadmin-admin-interface.md#working-with-services)
* [Working with Servers](mariadb-maxscale-21-maxadmin-admin-interface.md#working-with-servers)
* [Working with Sessions](mariadb-maxscale-21-maxadmin-admin-interface.md#working-with-sessions)
* [Descriptor Control Blocks](mariadb-maxscale-21-maxadmin-admin-interface.md#descriptor-control-blocks)
* [Working with Filters](mariadb-maxscale-21-maxadmin-admin-interface.md#working-with-filters)
* [Working with Monitors](mariadb-maxscale-21-maxadmin-admin-interface.md#working-with-monitors)
* [MariaDB MaxScale Status Commands](mariadb-maxscale-21-maxadmin-admin-interface.md#maxscale-status-commands)
* [Administration Commands](mariadb-maxscale-21-maxadmin-admin-interface.md#administration-commands)
* [Runtime Configuration Changes](mariadb-maxscale-21-maxadmin-admin-interface.md#runtime-configuration-changes)
* [Servers](mariadb-maxscale-21-maxadmin-admin-interface.md#servers)
* [Listeners](mariadb-maxscale-21-maxadmin-admin-interface.md#listeners)
* [Monitors](mariadb-maxscale-21-maxadmin-admin-interface.md#monitors)
* [Tuning MariaDB MaxScale](mariadb-maxscale-21-maxadmin-admin-interface.md#tuning-mariadb-maxscale)
