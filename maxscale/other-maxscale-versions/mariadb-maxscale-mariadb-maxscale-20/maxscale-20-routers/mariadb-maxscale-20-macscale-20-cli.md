...
Two components are required in order to run the command line interface for use wit&#x68;_&#x6D;axadmin_; a service and a listener. The listener may either use a Unix domain socket\
