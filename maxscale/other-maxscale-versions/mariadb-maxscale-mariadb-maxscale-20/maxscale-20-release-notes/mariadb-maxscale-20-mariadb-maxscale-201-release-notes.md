...
This document describes the changes in release 2.0.1, when compared to[release 2.0.0](../../mariadb-maxscale-21-06/).
...
The service parameter [strip\_db\_esc](../maxscale-20-getting-started/mariadb-maxscale-20-mariadb-maxscale-configuration-usage-scenarios.md#strip_db_esc)\
...
Please consult[MaxAdmin documentation](../maxscale-20-reference/mariadb-maxscale-20-maxadmin.md) for more details.
