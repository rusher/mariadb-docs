...
* [Running MaxAdmin](mariadb-maxscale-20-maxadmin.md#running)
* [Working With Administration Interface Users](mariadb-maxscale-20-maxadmin.md#interface)
* [Getting Help](mariadb-maxscale-20-maxadmin.md#help)
* [Working with Services](mariadb-maxscale-20-maxadmin.md#services)
* [Working with Servers](mariadb-maxscale-20-maxadmin.md#servers)
* [Working with Sessions](mariadb-maxscale-20-maxadmin.md#sessions)
* [Descriptor Control Blocks](mariadb-maxscale-20-maxadmin.md#dcbs)
* [Working with Filters](mariadb-maxscale-20-maxadmin.md#filters)
* [Working with Monitors](mariadb-maxscale-20-maxadmin.md#monitors)
* [MariaDB MaxScale Status Commands](mariadb-maxscale-20-maxadmin.md#statuscommands)
* [Administration Commands](mariadb-maxscale-20-maxadmin.md#admincommands)
* [Tuning MariaDB MaxScale](mariadb-maxscale-20-maxadmin.md#tuning)
...
MariaDB MaxScale can log messages to syslog, to a log file or to both. The approach can be set in the config file, but can also be changed from maxadmin. Syslog logging is identified by _syslog_ and file logging by _maxlog_.
...
There are two ways for rotating the log - _flush log maxscale_ and _flush logs_ - and the result is identical. The two alternatives are due to historical reasons; earlier MariaDB MaxScale had several different log files.
...
From version 1.3 onwards, MariaDB MaxScale has a single log file where messages of various priority (aka severity) are logged. Consequently, you no longer enable or disable log files but log priorities. The priorities are the same as those of syslog and the ones that can be enabled or disabled are _debug_, _info_, _notice_ and _warning_. _Error_ and any more severe messages can not be disabled.
