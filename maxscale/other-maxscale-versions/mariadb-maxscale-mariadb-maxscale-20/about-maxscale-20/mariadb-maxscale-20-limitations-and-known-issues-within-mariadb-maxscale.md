...
can be influenced with the server priority mechanic described in the[Galera Monitor](../../mariadb-maxscale-21-06/) manual.
...
For more information, read the[ReadWriteSplit](../../mariadb-maxscale-21-06/) router documentation.
