...
* [Throttle](mariadb-maxscale-25-throttle.md#throttle)
  * [Overview](mariadb-maxscale-25-throttle.md#overview)
  * [Configuration](mariadb-maxscale-25-throttle.md#configuration)
    * [Basic Configuration](mariadb-maxscale-25-throttle.md#basic-configuration)
    * [Allowing high frequency bursts](mariadb-maxscale-25-throttle.md#allowing-high-frequency-bursts)
    * [Filter Parameters](mariadb-maxscale-25-throttle.md#filter-parameters)
      * [max\_qps](mariadb-maxscale-25-throttle.md#max_qps)
      * [throttling\_duration](mariadb-maxscale-25-throttle.md#throttling_duration)
    * [sampling\_duration](mariadb-maxscale-25-throttle.md#sampling_duration)
    * [continuous\_duration](mariadb-maxscale-25-throttle.md#continuous_duration)

### Overview

The throttle filter replaces and extends on the limit\_queries functionality of[the Database Firewall filter](mariadb-maxscale-25-database-firewall-filter.md).
...
The value is specified as documented[here](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#durations).\
