# mariadb-maxscale-25-binlog-filter
...
* [Binlog Filter](mariadb-maxscale-25-binlog-filter.md#binlog-filter)
  * [Overview](mariadb-maxscale-25-binlog-filter.md#overview)
  * [Configuration](mariadb-maxscale-25-binlog-filter.md#configuration)
    * [match and exclude](mariadb-maxscale-25-binlog-filter.md#match-and-exclude)
    * [rewrite\_src and rewrite\_dest](mariadb-maxscale-25-binlog-filter.md#rewrite_src-and-rewrite_dest)
  * [Example Configuration](mariadb-maxscale-25-binlog-filter.md#example-configuration)
...
Both the _match_ and _exclude_ parameters are optional and work mostly as other[typical regular expression parameters](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#standard-regular-expression-settings-for-filters).\
