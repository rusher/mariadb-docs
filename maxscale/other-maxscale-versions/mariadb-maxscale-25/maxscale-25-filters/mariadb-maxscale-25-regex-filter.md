...
* [Regex Filter](mariadb-maxscale-25-regex-filter.md#regex-filter)
  * [Overview](mariadb-maxscale-25-regex-filter.md#overview)
  * [Configuration](mariadb-maxscale-25-regex-filter.md#configuration)
  * [Filter Parameters](mariadb-maxscale-25-regex-filter.md#filter-parameters)
    * [match, options](mariadb-maxscale-25-regex-filter.md#match-options)
    * [replace](mariadb-maxscale-25-regex-filter.md#replace)
    * [source](mariadb-maxscale-25-regex-filter.md#source)
    * [user](mariadb-maxscale-25-regex-filter.md#user)
    * [log\_file](mariadb-maxscale-25-regex-filter.md#log_file)
    * [log\_trace](mariadb-maxscale-25-regex-filter.md#log_trace)
  * [Examples](mariadb-maxscale-25-regex-filter.md#examples)
    * [Example 1 - Replace MySQL 5.1 create table syntax with that for later versions](mariadb-maxscale-25-regex-filter.md#example-1-replace-mysql-51-create-table-syntax-with-that-for-later-versions)
...
_match_ is a[PCRE2 regular expression](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#regular-expressions)\
which defines the text in the SQL statements that is replaced.

The _options_-parameter affects how the patterns are compiled as[usual](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#standard-regular-expression-settings-for-filters).\
...
session specific logging, please read the[Configuration Guide](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#global-settings).
