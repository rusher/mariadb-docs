...
* [Insert Stream Filter](mariadb-maxscale-25-insert-stream-filter.md#insert-stream-filter)
  * [Overview](mariadb-maxscale-25-insert-stream-filter.md#overview)
  * [Filter Parameters](mariadb-maxscale-25-insert-stream-filter.md#filter-parameters)
  * [Details of Operation](mariadb-maxscale-25-insert-stream-filter.md#details-of-operation)
    * [Estimating Network Bandwidth Reduction](mariadb-maxscale-25-insert-stream-filter.md#estimating-network-bandwidth-reduction)
  * [Example Configuration](mariadb-maxscale-25-insert-stream-filter.md#example-configuration)
