...
* [Cache](mariadb-maxscale-25-cache.md#cache)
  * [Overview](mariadb-maxscale-25-cache.md#overview)
  * [Limitations](mariadb-maxscale-25-cache.md#limitations)
    * [Prepared Statements](mariadb-maxscale-25-cache.md#prepared-statements)
    * [Multi-statements](mariadb-maxscale-25-cache.md#multi-statements)
    * [Security](mariadb-maxscale-25-cache.md#security)
  * [Invalidation](mariadb-maxscale-25-cache.md#invalidation)
    * [Best Efforts](mariadb-maxscale-25-cache.md#best-efforts)
  * [Configuration](mariadb-maxscale-25-cache.md#configuration)
    * [Filter Parameters](mariadb-maxscale-25-cache.md#filter-parameters)
      * [storage](mariadb-maxscale-25-cache.md#storage)
      * [storage\_options](mariadb-maxscale-25-cache.md#storage_options)
      * [hard\_ttl](mariadb-maxscale-25-cache.md#hard_ttl)
      * [soft\_ttl](mariadb-maxscale-25-cache.md#soft_ttl)
      * [max\_resultset\_rows](mariadb-maxscale-25-cache.md#max_resultset_rows)
      * [max\_resultset\_size](mariadb-maxscale-25-cache.md#max_resultset_size)
      * [max\_count](mariadb-maxscale-25-cache.md#max_count)
      * [max\_size](mariadb-maxscale-25-cache.md#max_size)
      * [rules](mariadb-maxscale-25-cache.md#rules)
      * [cached\_data](mariadb-maxscale-25-cache.md#cached_data)
      * [selects](mariadb-maxscale-25-cache.md#selects)
      * [cache\_in\_transactions](mariadb-maxscale-25-cache.md#cache_in_transactions)
      * [debug](mariadb-maxscale-25-cache.md#debug)
      * [enabled](mariadb-maxscale-25-cache.md#enabled)
      * [invalidate](mariadb-maxscale-25-cache.md#invalidate)
      * [clear\_cache\_on\_parse\_errors](mariadb-maxscale-25-cache.md#clear_cache_on_parse_errors)
      * [users](mariadb-maxscale-25-cache.md#users)
      * [timeout](mariadb-maxscale-25-cache.md#timeout)
    * [Runtime Configuration](mariadb-maxscale-25-cache.md#runtime-configuration)
      * [@maxscale.cache.populate](mariadb-maxscale-25-cache.md#maxscalecachepopulate)
      * [@maxscale.cache.use](mariadb-maxscale-25-cache.md#maxscalecacheuse)
      * [@maxscale.cache.soft\_ttl](mariadb-maxscale-25-cache.md#maxscalecachesoft_ttl)
      * [@maxscale.cache.hard\_ttl](mariadb-maxscale-25-cache.md#maxscalecachehard_ttl)
      * [Client Driven Caching](mariadb-maxscale-25-cache.md#client-driven-caching)
  * [Threads, Users and Invalidation](mariadb-maxscale-25-cache.md#threads-users-and-invalidation)
    * [Invalidation](mariadb-maxscale-25-cache.md#invalidation_1)
      * [cached\_data=thread\_specific](mariadb-maxscale-25-cache.md#cached_datathread_specific)
      * [cache\_data=shared](mariadb-maxscale-25-cache.md#cache_datashared)
  * [Rules](mariadb-maxscale-25-cache.md#rules_1)
    * [When to Store](mariadb-maxscale-25-cache.md#when-to-store)
      * [Qualified Names](mariadb-maxscale-25-cache.md#qualified-names)
      * [Implication of the default database](mariadb-maxscale-25-cache.md#implication-of-the-default-database)
      * [Regexp Matching](mariadb-maxscale-25-cache.md#regexp-matching)
      * [Examples](mariadb-maxscale-25-cache.md#examples)
    * [When to Use](mariadb-maxscale-25-cache.md#when-to-use)
      * [Examples](mariadb-maxscale-25-cache.md#examples_1)
  * [Security](mariadb-maxscale-25-cache.md#security_1)
  * [Storage](mariadb-maxscale-25-cache.md#storage_1)
    * [storage\_inmemory](mariadb-maxscale-25-cache.md#storage_inmemory)
    * [storage\_memcached](mariadb-maxscale-25-cache.md#storage_memcached)
      * [Limitations](mariadb-maxscale-25-cache.md#limitations_1)
      * [Security](mariadb-maxscale-25-cache.md#security_2)
    * [storage\_redis](mariadb-maxscale-25-cache.md#storage_redis)
      * [Limitations](mariadb-maxscale-25-cache.md#limitations_2)
      * [Invalidation](mariadb-maxscale-25-cache.md#invalidation_2)
      * [Security](mariadb-maxscale-25-cache.md#security_3)
  * [Example](mariadb-maxscale-25-cache.md#example)
    * [Configuration](mariadb-maxscale-25-cache.md#configuration_1)
    * [cache\_rules.json](mariadb-maxscale-25-cache.md#cache_rulesjson)
  * [Performance](mariadb-maxscale-25-cache.md#performance)
    * [Summary](mariadb-maxscale-25-cache.md#summary)
...
The default behaviour can be altered using the configuration parameter[cache\_in\_transactions](mariadb-maxscale-25-cache.md#cache_in_transactions).

By default it is assumed that all `SELECT` statements are cacheable, which\
means that also statements like `SELECT LOCALTIME` are cached. Please check[selects](mariadb-maxscale-25-cache.md#selects) for how to change the default behaviour.
...
Please read the section [Security](mariadb-maxscale-25-cache.md#security-1) for more detailed information.
...
be no unintended sharing. Please see [users](mariadb-maxscale-25-cache.md#users) for how to change\
...
invalidated even if the INSERT actually does not affect it. Please see[invalidate](mariadb-maxscale-25-cache.md#invalidate) for how to enable the invalidation.
...
can be changed using the configuration parameter[clear\_cache\_on\_parse\_errors](mariadb-maxscale-25-cache.md#clear_cache_on_parse_errors).

Note that what threading approach is used has a big impact on the\
invalidation. Please see[Threads, Users and Invalidation](mariadb-maxscale-25-cache.md#threads-users-and-invalidation)\
...
is still important to configure a reasonable [soft](mariadb-maxscale-25-cache.md#soft_ttl) and[hard](mariadb-maxscale-25-cache.md#hard_ttl) TTL.
...
See [Storage](mariadb-maxscale-25-cache.md#storage-1) for what storage modules are available.
...
The duration can be specified as explained[here](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#durations).\
...
cost. Please read [performance](mariadb-maxscale-25-cache.md#performance) for more details.
...
at runtime. Please see[Runtime Configuration](mariadb-maxscale-25-cache.md#runtime-configuration)\
for details.
...
be disabled and a connection attempt will be made after a [timeout](mariadb-maxscale-25-cache.md#timeout)\
interval.
...
`storage_redis` supports invalidation, but the caveats documented [here](mariadb-maxscale-25-cache.md#best-efforts)\
