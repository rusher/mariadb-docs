...
* [Lua Filter](mariadb-maxscale-25-lua-filter.md#lua-filter)
  * [Filter Parameters](mariadb-maxscale-25-lua-filter.md#filter-parameters)
    * [global\_script](mariadb-maxscale-25-lua-filter.md#global_script)
    * [session\_script](mariadb-maxscale-25-lua-filter.md#session_script)
  * [Lua Script Calling Convention](mariadb-maxscale-25-lua-filter.md#lua-script-calling-convention)
    * [Script Template](mariadb-maxscale-25-lua-filter.md#script-template)
    * [Functions Exposed by the Luafilter](mariadb-maxscale-25-lua-filter.md#functions-exposed-by-the-luafilter)
  * [Example Configuration and Script](mariadb-maxscale-25-lua-filter.md#example-configuration-and-script)
