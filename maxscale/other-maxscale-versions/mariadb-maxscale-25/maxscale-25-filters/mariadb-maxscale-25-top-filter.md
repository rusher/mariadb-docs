...
* [Top Filter](mariadb-maxscale-25-top-filter.md#top-filter)
  * [Overview](mariadb-maxscale-25-top-filter.md#overview)
  * [Configuration](mariadb-maxscale-25-top-filter.md#configuration)
    * [Filter Parameters](mariadb-maxscale-25-top-filter.md#filter-parameters)
      * [filebase](mariadb-maxscale-25-top-filter.md#filebase)
      * [count](mariadb-maxscale-25-top-filter.md#count)
      * [match, exclude and options](mariadb-maxscale-25-top-filter.md#match-exclude-and-options)
      * [source](mariadb-maxscale-25-top-filter.md#source)
      * [user](mariadb-maxscale-25-top-filter.md#user)
  * [Examples](mariadb-maxscale-25-top-filter.md#examples)
    * [Example 1 - Heavily Contended Table](mariadb-maxscale-25-top-filter.md#example-1-heavily-contended-table)
    * [Example 2 - One Application Server is Slow](mariadb-maxscale-25-top-filter.md#example-2-one-application-server-is-slow)
  * [Output Report](mariadb-maxscale-25-top-filter.md#output-report)
