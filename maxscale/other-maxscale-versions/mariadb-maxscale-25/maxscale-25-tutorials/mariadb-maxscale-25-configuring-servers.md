# MaxScale 2.5 Configuring Servers
...
For more information about TLS, refer to the[Configuration Guide](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md).
