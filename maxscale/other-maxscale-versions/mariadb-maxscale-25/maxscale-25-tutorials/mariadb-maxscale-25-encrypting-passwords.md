# MaxScale 2.5 Encrypting Passwords
...
If the key file is not in the default location, the[datadir](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#datadir) parameter must be\
