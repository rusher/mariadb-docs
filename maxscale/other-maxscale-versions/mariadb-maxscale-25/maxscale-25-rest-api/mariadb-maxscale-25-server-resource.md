...
* [Server Resource](mariadb-maxscale-25-server-resource.md#server-resource)
  * [Resource Operations](mariadb-maxscale-25-server-resource.md#resource-operations)
    * [Get a server](mariadb-maxscale-25-server-resource.md#get-a-server)
      * [Response](mariadb-maxscale-25-server-resource.md#response)
    * [Get all servers](mariadb-maxscale-25-server-resource.md#get-all-servers)
      * [Response](mariadb-maxscale-25-server-resource.md#response_1)
    * [Create a server](mariadb-maxscale-25-server-resource.md#create-a-server)
      * [Response](mariadb-maxscale-25-server-resource.md#response_2)
    * [Update a server](mariadb-maxscale-25-server-resource.md#update-a-server)
    * [Modifiable Fields](mariadb-maxscale-25-server-resource.md#modifiable-fields)
      * [Response](mariadb-maxscale-25-server-resource.md#response_3)
    * [Update server relationships](mariadb-maxscale-25-server-resource.md#update-server-relationships)
      * [Response](mariadb-maxscale-25-server-resource.md#response_4)
    * [Destroy a server](mariadb-maxscale-25-server-resource.md#destroy-a-server)
      * [Response](mariadb-maxscale-25-server-resource.md#response_5)
    * [Set server state](mariadb-maxscale-25-server-resource.md#set-server-state)
      * [Response](mariadb-maxscale-25-server-resource.md#response_6)
    * [Clear server state](mariadb-maxscale-25-server-resource.md#clear-server-state)
      * [Response](mariadb-maxscale-25-server-resource.md#response_7)
...
* The [address](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#address) or[socket](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#socket) to use. Only\
...
In addition to the server[parameters](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#server-1), the _services_\
