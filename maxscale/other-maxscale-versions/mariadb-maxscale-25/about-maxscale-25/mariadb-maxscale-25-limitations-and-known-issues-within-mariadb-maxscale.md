...
* [Limitations and Known Issues within MariaDB MaxScale](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#limitations-and-known-issues-within-mariadb-maxscale)
  * [Configuration limitations](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#configuration-limitations)
    * [Multiple MaxScales on same server](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#multiple-maxscales-on-same-server)
  * [Security limitiations](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#security-limitiations)
    * [MariaDB 10.2](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#mariadb-102)
  * [MariaDB Default Values](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#mariadb-default-values)
  * [Query Classification](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#query-classification)
  * [Prepared Statements](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#prepared-statements)
  * [Protocol limitations](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#protocol-limitations)
    * [Limitations with MySQL/MariaDB Protocol support (MariaDBClient)](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#limitations-with-mysqlmariadb-protocol-support-mariadbclient)
  * [Authenticator limitations](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#authenticator-limitations)
    * [Limitations in the GSSAPI authenticator](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#limitations-in-the-gssapi-authenticator)
    * [Limitations in the MySQL authenticator (MariaDBAuth)](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#limitations-in-the-mysql-authenticator-mariadbauth)
  * [Filter limitations](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#filter-limitations)
    * [Database Firewall limitations (dbfwfilter)](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#database-firewall-limitations-dbfwfilter)
    * [Tee filter limitations (tee)](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#tee-filter-limitations-tee)
  * [Monitor limitations](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#monitor-limitations)
    * [Limitations with Galera Cluster Monitoring (galeramon)](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#limitations-with-galera-cluster-monitoring-galeramon)
  * [Router limitations](mariadb-maxscale-25-limitations-and-known-issues-within-mariadb-maxscale.md#router-limitations)
...
can be influenced with the server priority mechanic described in the[Galera Monitor](../maxscale-25-monitors/mariadb-maxscale-25-galera-monitor.md) manual.
