...
Here is a simple example service definition that uses the servers from the[Configuring Servers](../maxscale-25-tutorials/mariadb-maxscale-25-configuring-servers.md) tutorial and the\
