...
* [Binlogrouter](mariadb-maxscale-25-binlogrouter.md#binlogrouter)
  * [Differences Between Old and New Binlogrouter Implementations](mariadb-maxscale-25-binlogrouter.md#differences-between-old-and-new-binlogrouter-implementations)
  * [Supported SQL Commands](mariadb-maxscale-25-binlogrouter.md#supported-sql-commands)
  * [Configuration Parameters](mariadb-maxscale-25-binlogrouter.md#configuration-parameters)
    * [datadir](mariadb-maxscale-25-binlogrouter.md#datadir)
    * [server\_id](mariadb-maxscale-25-binlogrouter.md#server_id)
    * [net\_timeout](mariadb-maxscale-25-binlogrouter.md#net_timeout)
    * [select\_master](mariadb-maxscale-25-binlogrouter.md#select_master)
    * [expire\_log\_duration](mariadb-maxscale-25-binlogrouter.md#expire_log_duration)
    * [expire\_log\_minimum\_files](mariadb-maxscale-25-binlogrouter.md#expire_log_minimum_files)
  * [New installation](mariadb-maxscale-25-binlogrouter.md#new-installation)
  * [Upgrading to version 2.5](mariadb-maxscale-25-binlogrouter.md#upgrading-to-version-25)
    * [Before you start](mariadb-maxscale-25-binlogrouter.md#before-you-start)
    * [Deployment](mariadb-maxscale-25-binlogrouter.md#deployment)
  * [Galera cluster](mariadb-maxscale-25-binlogrouter.md#galera-cluster)
  * [Example](mariadb-maxscale-25-binlogrouter.md#example)
  * [Limitations](mariadb-maxscale-25-binlogrouter.md#limitations)
...
* The list of servers where the database users for authentication are loaded\
  must be explicitly configured with the `cluster`, `servers` or`targets` parameter.
...
The documentation for the binlogrouter in MaxScale 2.4 is provided for reference[here](mariadb-maxscale-25-binlogrouter-24.md).
...
* Purges binary logs up to but not including the given file. The file name\
  ...
  parameter [expire\_log\_duration](mariadb-maxscale-25-binlogrouter.md#expire_log_duration).\
...
configuration can be found in the [example](mariadb-maxscale-25-binlogrouter.md#example) section of this document.
...
is specified as documented[here](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#durations). Default value is 10\
seconds.
...
or no automatic removal. This is similar to the server system variable[expire\_log\_days](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/standard-replication/replication-and-binary-log-system-variables#expire_logs_days).
...
* Make sure that the configured data directory for the new binlogrouter\
  ...
  See [datadir](mariadb-maxscale-25-binlogrouter.md#datadir).
...
2. Issue a `CHANGE MASTER TO` command, or use [select\_master](mariadb-maxscale-25-binlogrouter.md#select_master).
...
See [select\_master](mariadb-maxscale-25-binlogrouter.md#select_master).
