# mariadb-maxscale-25-avrorouter
...
This router is intended to be used in tandem with the[Binlog Server](mariadb-maxscale-25-binlogrouter.md).\
...
* [Avrorouter](mariadb-maxscale-25-avrorouter.md#avrorouter)
  * [Direct Replication Mode](mariadb-maxscale-25-avrorouter.md#direct-replication-mode)
  * [Configuration](mariadb-maxscale-25-avrorouter.md#configuration)
    * [Router Parameters](mariadb-maxscale-25-avrorouter.md#router-parameters)
      * [gtid\_start\_pos](mariadb-maxscale-25-avrorouter.md#gtid_start_pos)
      * [server\_id](mariadb-maxscale-25-avrorouter.md#server_id)
      * [source](mariadb-maxscale-25-avrorouter.md#source)
      * [codec](mariadb-maxscale-25-avrorouter.md#codec)
      * [match and exclude](mariadb-maxscale-25-avrorouter.md#match-and-exclude)
      * [binlogdir](mariadb-maxscale-25-avrorouter.md#binlogdir)
      * [avrodir](mariadb-maxscale-25-avrorouter.md#avrodir)
        * [filestem](mariadb-maxscale-25-avrorouter.md#filestem)
      * [start\_index](mariadb-maxscale-25-avrorouter.md#start_index)
        * [Example configuration](mariadb-maxscale-25-avrorouter.md#example-configuration)
      * [Avro File Related Parameters](mariadb-maxscale-25-avrorouter.md#avro-file-related-parameters)
        * [group\_trx](mariadb-maxscale-25-avrorouter.md#group_trx)
        * [group\_rows](mariadb-maxscale-25-avrorouter.md#group_rows)
        * [block\_size](mariadb-maxscale-25-avrorouter.md#block_size)
  * [Module commands](mariadb-maxscale-25-avrorouter.md#module-commands)
    * [avrorouter::convert SERVICE {start | stop}](mariadb-maxscale-25-avrorouter.md#avrorouterconvert-service-start-stop)
    * [avrorouter::purge SERVICE](mariadb-maxscale-25-avrorouter.md#avrorouterpurge-service)
  * [Files Created by the Avrorouter](mariadb-maxscale-25-avrorouter.md#files-created-by-the-avrorouter)
  * [Resetting the Conversion Process](mariadb-maxscale-25-avrorouter.md#resetting-the-conversion-process)
  * [Stopping the Avrorouter](mariadb-maxscale-25-avrorouter.md#stopping-the-avrorouter)
  * [Example Client](mariadb-maxscale-25-avrorouter.md#example-client)
  * [Avro Schema Generator](mariadb-maxscale-25-avrorouter.md#avro-schema-generator)
    * [Simple Schema Generator](mariadb-maxscale-25-avrorouter.md#simple-schema-generator)
    * [Python Schema Generator](mariadb-maxscale-25-avrorouter.md#python-schema-generator)
    * [Go Schema Generator](mariadb-maxscale-25-avrorouter.md#go-schema-generator)
  * [Examples](mariadb-maxscale-25-avrorouter.md#examples)
  * [Building Avrorouter](mariadb-maxscale-25-avrorouter.md#building-avrorouter)
  * [Router Diagnostics](mariadb-maxscale-25-avrorouter.md#router-diagnostics)
  * [Limitations](mariadb-maxscale-25-avrorouter.md#limitations)
...
For information about common service parameters, refer to the[Configuration Guide](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md).
...
For more details about building MaxScale from source, please refer to the[Building MaxScale from Source Code](../maxscale-25-getting-started/mariadb-maxscale-25-building-mariadb-maxscale-from-source-code.md)\
document.
