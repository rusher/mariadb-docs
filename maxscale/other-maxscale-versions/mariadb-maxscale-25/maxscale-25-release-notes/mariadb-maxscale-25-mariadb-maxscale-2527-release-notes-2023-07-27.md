...
* [MXS-4670](https://jira.mariadb.org/browse/MXS-4670) The fact that readconnroute doesn't block writes with router\_options=slave is not documented
...
* [MXS-4617](https://jira.mariadb.org/browse/MXS-4617) expire\_log\_duration not working
