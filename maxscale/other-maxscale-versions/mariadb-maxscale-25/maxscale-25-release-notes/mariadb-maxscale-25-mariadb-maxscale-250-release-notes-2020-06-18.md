...
* Network throttling (writeq\_high\_water and writeq\_low\_water) is now on by\
...
The settings `detect_stale_master`, `detect_standalone_master` and`detect_stale_slave` are replaced by the more flexible `master_conditions` and`slave_conditions`. The old settings may still be used, but will be removed in\
a later version.
...
Several changes, see [here](../maxscale-25-authenticators/mariadb-maxscale-25-authentication-modules.md)\
for more details.
...
Please see the[documentation](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-maxgui-guide.md)\
...
entries. See the[documentation](../maxscale-25-filters/mariadb-maxscale-25-cache.md#invalidation)\
for more information.

**New Cache Storage Modules**

The following storage modules have been added:[_storage\_memcached_](../maxscale-25-filters/mariadb-maxscale-25-cache.md#storage_memcached) [storage\_redis](../maxscale-25-filters/mariadb-maxscale-25-cache.md#storage_redis)
...
Please see the[documentation](../maxscale-25-filters/mariadb-maxscale-25-cache.md#users)\
for details.
...
so that all threads are evenly utilized. Please refer to[rebalance\_period](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#rebalance_period)\
and[rebalance\_threshold](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#rebalance_threshold)\
for more information.
...
operations are available for Columnstore 1.5. Please see the[documentation](../maxscale-25-monitors/mariadb-maxscale-25-columnstore-monitor.md)\
for details.
...
See [configuration guide](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#authenticator)\
and [pam plugin documentation](../maxscale-25-authenticators/mariadb-maxscale-25-pam-authenticator.md)\
for more details.
