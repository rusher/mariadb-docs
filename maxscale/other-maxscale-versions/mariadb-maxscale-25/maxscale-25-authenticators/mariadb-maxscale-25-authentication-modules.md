# mariadb-maxscale-25-authentication-modules

## MaxScale 2.5 Authentication Modules

## Authentication Modules

This document describes general MySQL protocol authentication in MaxScale. For\
REST-api authentication, see the[configuration guide](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md) and the[REST-api guide](../maxscale-25-rest-api/mariadb-maxscale-25-rest-api.md).
...
available in MaxScale are[standard MySQL password](mariadb-maxscale-25-mysql-authenticator.md),[GSSAPI](mariadb-maxscale-25-gssapi-client-authenticator.md) and[pluggable authentication modules (PAM)](mariadb-maxscale-25-pam-authenticator.md).
...
defined in the service configuration. For more information, search the[configuration guide](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md)\
...
2. Use [proxy protocol](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#proxy_protocol).
