...
For more information about MaxScale 2.5, refer to the[ChangeLog](../mariadb-maxscale-25-changelog.md).
...
of required grants, refer to the[protocol documentation](../maxscale-25-authenticators/mariadb-maxscale-25-authentication-modules.md).
...
Please see the [documentation](../maxscale-25-monitors/mariadb-maxscale-25-columnstore-monitor.md#master-selection)\
for details.
