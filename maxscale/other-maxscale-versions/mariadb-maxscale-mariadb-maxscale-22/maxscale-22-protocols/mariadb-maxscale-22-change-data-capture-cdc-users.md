...
authenticate using credentials provided in a format described in the [CDC Protocol documentation](../../mariadb-maxscale-21-06/).
...
more details on the format of the _cdcusers_ file, read the [CDC Protocol documentation](../../mariadb-maxscale-21-06/).
