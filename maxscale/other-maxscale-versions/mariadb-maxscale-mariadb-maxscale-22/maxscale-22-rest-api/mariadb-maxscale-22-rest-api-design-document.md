...
* [Resources](mariadb-maxscale-22-rest-api-design-document.md#resources)
* [Common Request Parameter](mariadb-maxscale-22-rest-api-design-document.md#common-request-parameters)
* [HTTP Headers](mariadb-maxscale-22-rest-api-design-document.md#http-headers)
* [Request Headers](mariadb-maxscale-22-rest-api-design-document.md#request-headers)
* [Response Headers](mariadb-maxscale-22-rest-api-design-document.md#response-headers)
* [Response Codes](mariadb-maxscale-22-rest-api-design-document.md#response-codes)
* [2xx Success](mariadb-maxscale-22-rest-api-design-document.md#2xx-success)
* [3xx Redirection](mariadb-maxscale-22-rest-api-design-document.md#3xx-redirection)
* [4xx Client Error](mariadb-maxscale-22-rest-api-design-document.md#4xx-client-error)
* [5xx Server Error](mariadb-maxscale-22-rest-api-design-document.md#5xx-server-error)
...
Read the [REST API](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#rest-api-configuration)\
...
can be intercepted from the network traffic. Refer to the[Configuration Guide](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#admin_ssl_key) for more\
...
refer to the [MaxAdmin](../maxscale-22-reference/mariadb-maxscale-22-maxadmin-admin-interface.md) documentation as well as the\
documentation of the [users](mariadb-maxscale-22-admin-user-resource.md) resource.
...
* [maxscale](mariadb-maxscale-22-maxscale-resource.md)
* [services](mariadb-maxscale-22-service-resource.md)
* [servers](mariadb-maxscale-22-server-resource.md)
* [filters](mariadb-maxscale-22-filter-resource.md)
* [monitors](mariadb-maxscale-22-monitor-resource.md)
* [sessions](mariadb-maxscale-22-session-resource.md)
* [users](mariadb-maxscale-22-admin-user-resource.md)
...
MaxScale administrative users, refer to the [MaxAdmin](../maxscale-22-reference/mariadb-maxscale-22-maxadmin-admin-interface.md)\
documentation.
