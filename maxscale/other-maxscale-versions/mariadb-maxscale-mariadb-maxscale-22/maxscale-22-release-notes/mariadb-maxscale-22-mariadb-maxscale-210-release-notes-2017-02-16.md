...
For more information about MariaDB BSL 1.1, please refer to[MariaDB BSL11](https://www.mariadb.com/bsl11).
...
Please see the[Configuration Guide](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#configuration)\
for details.
...
the module configuration directory. The default value i&#x73;_/etc/maxscale.modules.d_.

For example, the `dbfwfilter` rule files could be stored i&#x6E;_/etc/maxscale.modules.d/my\_rules.txt_ and referred to with`rules=my_rules.txt`.

For more details, refer to the documentation of _module\_configdir_ in the[Configuration Guide](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md)
...
That has now been changed so that the name of the log file is _always_\
...
For more information about this configuration entry, please see[Global Settings](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#global-settings).
...
Read the [Readwritesplit documentation](../maxscale-22-routers/mariadb-maxscale-22-readwritesplit.md) on`retry_failed_reads` for more details.
...
The galeramon monitor will only choose nodes with a _wsrep\_local\_index_\
...
For more details, read the [Named Server Filter documentation](../maxscale-22-filters/mariadb-maxscale-22-named-server-filter.md).
...
listeners. A set of new commands were added to maxadmin. See output of`maxadmin help` and `maxadmin help { create | destroy | alter | add | remove }`\
for more details.
...
Read [Module Commands](../../mariadb-maxscale-mariadb-maxscale-21/maxscale-21-reference/mariadb-maxscale-21-module-commands.md) documentation for more details.

In the 2.1 release of MaxScale, the \[_dbfwfilter_}(../Filters/Database-Firewall-Filter.md),[avrorouter](../maxscale-22-routers/mariadb-maxscale-22-avrorouter.md), [cache](../maxscale-22-filters/mariadb-maxscale-22-cache.md) and[masking](../maxscale-22-filters/mariadb-maxscale-22-masking.md) modules implement module commands.

#### Amazon RDS Aurora monitor

The new [Aurora Monitor](../../mariadb-maxscale-mariadb-maxscale-21/maxscale-21-monitors/mariadb-maxscale-21-aurora-monitor.md) module allows monitoring\
...
node. This module also supports launchable scripts on monitored events. Read the[Monitor Common Documentation](../maxscale-22-monitors/mariadb-maxscale-22-common-monitor-parameters.md) for more details.
...
for the mmmon module. For more details, please read the[MySQL Monitor Documentation](https://mariadb.com/kb/en/mariadb-maxscale-22-mysql-monitor/).
...
For more information, refer to the [CCRFilter](../maxscale-22-filters/mariadb-maxscale-22-consistent-critical-read-filter.md)\
documentation.
...
For more information, refer to the [Cache](../maxscale-22-filters/mariadb-maxscale-22-cache.md) documentation.
...
For more information, refer to the [Masking](../maxscale-22-filters/mariadb-maxscale-22-masking.md)\
documentation.
...
For more information, refer to the [Maxrows](../maxscale-22-filters/mariadb-maxscale-22-maxrows.md)\
documentation.
...
For more information, refer to the [Insert Stream Filter](../maxscale-22-filters/mariadb-maxscale-22-insert-stream-filter.md)\
documentation.

#### Galeramon Monitor new option

The `set_donor_nodes` option allows the setting of _global variable_ _wsrep\_sst\_donor_ with a list the preferred donor nodes (among slave ones).
...
* [MXS-887](https://jira.mariadb.org/browse/MXS-887) create\_env Jenkin job fails
...
* [MXS-831](https://jira.mariadb.org/browse/MXS-831) new\_master event not triggered by galeramon
...
* [MXS-805](https://jira.mariadb.org/browse/MXS-805) Server weights don't work with LEAST\_BEHIND\_MASTER
...
* [MXS-397](https://jira.mariadb.org/browse/MXS-397) Unsafe handling of dcb\_readqueue
