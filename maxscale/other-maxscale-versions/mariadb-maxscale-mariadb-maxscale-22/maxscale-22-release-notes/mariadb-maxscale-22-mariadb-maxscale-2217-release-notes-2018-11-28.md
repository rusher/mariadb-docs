...
* [MXS-2175](https://jira.mariadb.org/browse/MXS-2175) available\_when\_donor=true is not respected in Galera Monitor with xtrabackup-v2 sst method and only one synced node available in the cluster
...
* [MXS-2095](https://jira.mariadb.org/browse/MXS-2095) Fatal: MaxScale 2.2.15 received fatal signal 11 - libavrorouter.so(count\_columns+0x21)
