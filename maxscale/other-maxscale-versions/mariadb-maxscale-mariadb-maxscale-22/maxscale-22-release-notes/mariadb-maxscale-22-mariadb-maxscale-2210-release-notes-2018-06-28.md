...
* [MXS-1931](https://jira.mariadb.org/browse/MXS-1931) Debug assertion in is\_large\_query fails
...
* [MXS-1920](https://jira.mariadb.org/browse/MXS-1920)

## is not recognized as an until-end-of-line comment character
...
* [MXS-1910](https://jira.mariadb.org/browse/MXS-1910) Only ssl\_ca\_cert should be required for servers
* [MXS-1907](https://jira.mariadb.org/browse/MXS-1907) Can't define ssl\_verify\_peer\_certificate at runtime
* [MXS-1902](https://jira.mariadb.org/browse/MXS-1902) COM\_CHANGE\_USER lost connection
