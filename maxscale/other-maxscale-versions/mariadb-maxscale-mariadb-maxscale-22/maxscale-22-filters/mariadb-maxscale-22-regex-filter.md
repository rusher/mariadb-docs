...
session specific logging, please read the [Configuration Guide](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#global-settings)
and the [MaxAdmin](../maxscale-22-reference/mariadb-maxscale-22-maxadmin-admin-interface.md#change-maxscale-logging-options) documentation on changing the logging levels.
