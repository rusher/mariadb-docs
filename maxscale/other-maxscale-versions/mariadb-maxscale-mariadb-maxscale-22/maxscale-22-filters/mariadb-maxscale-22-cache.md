...
The default behaviour can be altered using the configuration parameter[cache\_inside\_transactions](mariadb-maxscale-22-cache.md#cache_inside_transactions).

By default it is assumed that all `SELECT` statements are cacheable, which\
means that also statements like `SELECT LOCALTIME` are cached. Please check[selects](mariadb-maxscale-22-cache.md#selects) for how to change the default behaviour.
...
Please read the section [Security](mariadb-maxscale-22-cache.md#security-1) for more detailed information.
...
See [Storage](mariadb-maxscale-22-cache.md#storage-1) for what storage modules are available.
...
as described [here](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#sizes).
...
The size can be specified as described[here](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#sizes).
...
cost. Please read [performance](mariadb-maxscale-22-cache.md#performance) for more details.
