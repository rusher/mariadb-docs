# mariadb-maxscale-22-avrorouter
...
This router is intended to be used in tandem with the [Binlog Server](../../mariadb-maxscale-21-06/).\
...
![](../../../.gitbook/assets/mariadb-corporation/MaxScale/2.2.21/Documentation/Routers/images/Binlog-Avro.png.png)
...
For information about common service parameters, refer to the[Configuration Guide](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md).
...
Only process events for tables that match this PCRE2 regular expression. See[Regular Expressions](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#regular-expressions)\
...
suffix. Refer to the[Configuration Guide](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md) for more\
...
the user creation, please refer to the [CDC Protocol](../../mariadb-maxscale-21-06/)\
and [CDC Users](../maxscale-22-protocols/mariadb-maxscale-22-change-data-capture-cdc-users.md) documentation.
...
The [Avrorouter Tutorial](../maxscale-22-tutorials/mariadb-maxscale-22-avrorouter-tutorial.md) shows you how\
...
You can then combine it with the _cdc\_kafka\_producer.py_ to publish these change records to a Kafka broker.
