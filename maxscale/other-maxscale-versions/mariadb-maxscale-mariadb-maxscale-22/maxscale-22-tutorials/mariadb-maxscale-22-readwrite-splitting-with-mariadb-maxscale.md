...
Read the [Configuring Servers](../../mariadb-maxscale-21-06/) mini-tutorial to see how\
...
For master-slave clusters read the[Configuring MariaDB Monitor](../../mariadb-maxscale-21-06/)\
tutorial. If you are using a Galera cluster, read the[Configuring Galera Monitor](../../mariadb-maxscale-21-06/)\
tutorial instead.
...
**Note:** For increased security [encrypt your passwords in the configuration file](../../mariadb-maxscale-21-06/).
...
The `service` parameter tells to which service the listener connects to. For the`Splitter-Listener` we set it to `Splitter-Service`.
...
The MaxAdmin configuration is described in the[Configuring MaxAdmin](../../mariadb-maxscale-21-06/) document.
