...
The throttle filter replaces and extends on the limit\_queries functionality of[the Database Firewall filter](mariadb-maxscale-23-database-firewall-filter.md).
