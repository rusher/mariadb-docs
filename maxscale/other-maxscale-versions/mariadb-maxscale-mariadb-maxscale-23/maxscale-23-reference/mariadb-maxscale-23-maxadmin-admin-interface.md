# mariadb-maxscale-23-maxadmin-admin-interface

## MaxAdmin - Admin Interface

## MaxAdmin - Admin Interface

**NOTE:** MaxAdmin is deprecated, use [MaxCtrl](mariadb-maxscale-23-maxctrl.md) instead.

## The Maxscale Administrative & Monitoring Client Application

* [MaxAdmin - Admin Interface](mariadb-maxscale-23-maxadmin-admin-interface.md#maxadmin-admin-interface)
* [The Maxscale Administrative & Monitoring Client Application](mariadb-maxscale-23-maxadmin-admin-interface.md#the-maxscale-administrative-monitoring-client-application)
* [Overview](mariadb-maxscale-23-maxadmin-admin-interface.md#overview)
* [Configuring MariaDB MaxScale for MaxAdmin](mariadb-maxscale-23-maxadmin-admin-interface.md#configuring-mariadb-maxscale-for-maxadmin)
* [Running MaxAdmin](mariadb-maxscale-23-maxadmin-admin-interface.md#running-maxadmin)
* [Working With Administration Interface Users](mariadb-maxscale-23-maxadmin-admin-interface.md#working-with-administration-interface-users)
  * [Administrative and Read-only Users](mariadb-maxscale-23-maxadmin-admin-interface.md#administrative-and-read-only-users)
  * [What Users Have Been Defined?](mariadb-maxscale-23-maxadmin-admin-interface.md#what-users-have-been-defined)
  * [Enabling a Linux account](mariadb-maxscale-23-maxadmin-admin-interface.md#enabling-a-linux-account)
  * [Disabling a Linux account](mariadb-maxscale-23-maxadmin-admin-interface.md#disabling-a-linux-account)
  * [Add A New User](mariadb-maxscale-23-maxadmin-admin-interface.md#add-a-new-user)
  * [Delete A User](mariadb-maxscale-23-maxadmin-admin-interface.md#delete-a-user)
  * [Creating Read-only Users](mariadb-maxscale-23-maxadmin-admin-interface.md#creating-read-only-users)
* [Command Line Switches](mariadb-maxscale-23-maxadmin-admin-interface.md#command-line-switches)
  * [Interactive Operation](mariadb-maxscale-23-maxadmin-admin-interface.md#interactive-operation)
  * [Command Line Operation](mariadb-maxscale-23-maxadmin-admin-interface.md#command-line-operation)
  * [The .maxadmin file](mariadb-maxscale-23-maxadmin-admin-interface.md#the-maxadmin-file)
* [Getting Help](mariadb-maxscale-23-maxadmin-admin-interface.md#getting-help)
* [Working With Services](mariadb-maxscale-23-maxadmin-admin-interface.md#working-with-services)
  * [What Services Are Available?](mariadb-maxscale-23-maxadmin-admin-interface.md#what-services-are-available)
  * [See Service Details](mariadb-maxscale-23-maxadmin-admin-interface.md#see-service-details)
  * [Examining Service Users](mariadb-maxscale-23-maxadmin-admin-interface.md#examining-service-users)
  * [Reloading Service User Data](mariadb-maxscale-23-maxadmin-admin-interface.md#reloading-service-user-data)
  * [Stopping A Service](mariadb-maxscale-23-maxadmin-admin-interface.md#stopping-a-service)
  * [Restart A Stopped Service](mariadb-maxscale-23-maxadmin-admin-interface.md#restart-a-stopped-service)
* [Working With Servers](mariadb-maxscale-23-maxadmin-admin-interface.md#working-with-servers)
  * [What Servers Are Configured?](mariadb-maxscale-23-maxadmin-admin-interface.md#what-servers-are-configured)
  * [Server Details](mariadb-maxscale-23-maxadmin-admin-interface.md#server-details)
  * [Setting The State Of A Server](mariadb-maxscale-23-maxadmin-admin-interface.md#setting-the-state-of-a-server)
  * [Viewing the persistent pool of DCB](mariadb-maxscale-23-maxadmin-admin-interface.md#viewing-the-persistent-pool-of-dcb)
* [Working With Sessions](mariadb-maxscale-23-maxadmin-admin-interface.md#working-with-sessions)
  * [What Sessions Are Active in MariaDB MaxScale?](mariadb-maxscale-23-maxadmin-admin-interface.md#what-sessions-are-active-in-mariadb-maxscale)
  * [Display Session Details](mariadb-maxscale-23-maxadmin-admin-interface.md#display-session-details)
* [Descriptor Control Blocks](mariadb-maxscale-23-maxadmin-admin-interface.md#descriptor-control-blocks)
  * [Finding DCB’s](mariadb-maxscale-23-maxadmin-admin-interface.md#finding-dcbs)
  * [DCB Of A Client Connection](mariadb-maxscale-23-maxadmin-admin-interface.md#dcb-of-a-client-connection)
  * [DCB Details](mariadb-maxscale-23-maxadmin-admin-interface.md#dcb-details)
* [Working with Filters](mariadb-maxscale-23-maxadmin-admin-interface.md#working-with-filters)
  * [What Filters Are Configured?](mariadb-maxscale-23-maxadmin-admin-interface.md#what-filters-are-configured)
  * [Retrieve Details Of A Filter Configuration](mariadb-maxscale-23-maxadmin-admin-interface.md#retrieve-details-of-a-filter-configuration)
  * [Filter Usage](mariadb-maxscale-23-maxadmin-admin-interface.md#filter-usage)
* [Working With Monitors](mariadb-maxscale-23-maxadmin-admin-interface.md#working-with-monitors)
  * [What Monitors Are Running?](mariadb-maxscale-23-maxadmin-admin-interface.md#what-monitors-are-running)
  * [Details Of A Particular Monitor](mariadb-maxscale-23-maxadmin-admin-interface.md#details-of-a-particular-monitor)
  * [Shutting Down A Monitor](mariadb-maxscale-23-maxadmin-admin-interface.md#shutting-down-a-monitor)
  * [Restarting A Monitor](mariadb-maxscale-23-maxadmin-admin-interface.md#restarting-a-monitor)
* [MaxScale Status Commands](mariadb-maxscale-23-maxadmin-admin-interface.md#maxscale-status-commands)
  * [MariaDB MaxScale Thread Usage](mariadb-maxscale-23-maxadmin-admin-interface.md#mariadb-maxscale-thread-usage)
  * [The Housekeeper Tasks](mariadb-maxscale-23-maxadmin-admin-interface.md#the-housekeeper-tasks)
* [Administration Commands](mariadb-maxscale-23-maxadmin-admin-interface.md#administration-commands)
  * [What Modules Are In use?](mariadb-maxscale-23-maxadmin-admin-interface.md#what-modules-are-in-use)
  * [Enabling syslog and maxlog logging](mariadb-maxscale-23-maxadmin-admin-interface.md#enabling-syslog-and-maxlog-logging)
  * [Rotating the log file](mariadb-maxscale-23-maxadmin-admin-interface.md#rotating-the-log-file)
  * [Change MariaDB MaxScale Logging Options](mariadb-maxscale-23-maxadmin-admin-interface.md#change-mariadb-maxscale-logging-options)
  * [Adjusting the Log Throttling](mariadb-maxscale-23-maxadmin-admin-interface.md#adjusting-the-log-throttling)
  * [Reloading The Configuration](mariadb-maxscale-23-maxadmin-admin-interface.md#reloading-the-configuration)
  * [Shutting Down MariaDB MaxScale](mariadb-maxscale-23-maxadmin-admin-interface.md#shutting-down-mariadb-maxscale)
* [Runtime Configuration Changes](mariadb-maxscale-23-maxadmin-admin-interface.md#runtime-configuration-changes)
  * [Servers](mariadb-maxscale-23-maxadmin-admin-interface.md#servers)
    * [Creating a New Server](mariadb-maxscale-23-maxadmin-admin-interface.md#creating-a-new-server)
    * [Adding Servers to Services and Monitors](mariadb-maxscale-23-maxadmin-admin-interface.md#adding-servers-to-services-and-monitors)
    * [Removing Servers from Services and Monitors](mariadb-maxscale-23-maxadmin-admin-interface.md#removing-servers-from-services-and-monitors)
    * [Altering Servers](mariadb-maxscale-23-maxadmin-admin-interface.md#altering-servers)
    * [Destroying Servers](mariadb-maxscale-23-maxadmin-admin-interface.md#destroying-servers)
  * [Listeners](mariadb-maxscale-23-maxadmin-admin-interface.md#listeners)
    * [Creating New Listeners](mariadb-maxscale-23-maxadmin-admin-interface.md#creating-new-listeners)
    * [Destroying Listeners](mariadb-maxscale-23-maxadmin-admin-interface.md#destroying-listeners)
  * [Monitors](mariadb-maxscale-23-maxadmin-admin-interface.md#monitors)
    * [Creating New Monitors](mariadb-maxscale-23-maxadmin-admin-interface.md#creating-new-monitors)
    * [Altering Monitors](mariadb-maxscale-23-maxadmin-admin-interface.md#altering-monitors)
    * [Destroying Monitors](mariadb-maxscale-23-maxadmin-admin-interface.md#destroying-monitors)
  * [Services](mariadb-maxscale-23-maxadmin-admin-interface.md#services)
    * [Altering Services](mariadb-maxscale-23-maxadmin-admin-interface.md#altering-services)
  * [MaxScale Core](mariadb-maxscale-23-maxadmin-admin-interface.md#maxscale-core)
    * [Altering MaxScale](mariadb-maxscale-23-maxadmin-admin-interface.md#altering-maxscale)
  * [Other Modules](mariadb-maxscale-23-maxadmin-admin-interface.md#other-modules)
* [MaxScale Internals](mariadb-maxscale-23-maxadmin-admin-interface.md#maxscale-internals)
...
**Note:** To forcefully prevent new connections from being made,[destroy the listener](mariadb-maxscale-23-maxadmin-admin-interface.md#destroying-listeners).
...
| stale       | The server is a [stale master server](../maxscale-23-monitors/mariadb-maxscale-23-mariadb-monitor.md) |
...
the [Configuration Guide](../../mariadb-maxscale-21-06/)\
