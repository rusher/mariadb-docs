...
* [MXS-2631](https://jira.mariadb.org/browse/MXS-2631) Duplicate tables found, but it's system tables (information\_schema., mysql.)
* [MXS-2609](https://jira.mariadb.org/browse/MXS-2609) Maxscale crash in RWSplitSession::retry\_master\_query()
