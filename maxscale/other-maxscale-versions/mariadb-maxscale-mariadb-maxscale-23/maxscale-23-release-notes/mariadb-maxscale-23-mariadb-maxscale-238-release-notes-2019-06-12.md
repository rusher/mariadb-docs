...
* [MXS-2541](https://jira.mariadb.org/browse/MXS-2541) Crash with transaction\_replay=true
...
* [MXS-2479](https://jira.mariadb.org/browse/MXS-2479) Don't throw error for PAM\_TEXT\_INFO in PAM conversation function
* [MXS-2473](https://jira.mariadb.org/browse/MXS-2473) Clarify documentation on regex-related options
* [MXS-2464](https://jira.mariadb.org/browse/MXS-2464) Crash in route\_stored\_query with ReadWriteSplit
