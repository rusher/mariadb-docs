...
* [MXS-2266](https://jira.mariadb.org/browse/MXS-2266) COM\_STMT\_CLOSE causes a warning to be logged
...
* [MXS-2207](https://jira.mariadb.org/browse/MXS-2207) qc\_mysqlembedded does not classify SET STATEMENT ... FOR UPDATE correctly.
