...
* [MXS-2480](https://jira.mariadb.org/browse/MXS-2480) Write paths to opened sqlite3 databases in log when log\_info is set
...
* [MXS-2563](https://jira.mariadb.org/browse/MXS-2563) Failing debug assertion at rwsplitsession.cc:1129 : m\_expected\_responses == 0
...
* [MXS-2521](https://jira.mariadb.org/browse/MXS-2521) COM\_STMT\_EXECUTE maybe return empty result
* [MXS-2490](https://jira.mariadb.org/browse/MXS-2490) Unknown prepared statement handler (0) given to mysqld\_stmt\_execute
* [MXS-2461](https://jira.mariadb.org/browse/MXS-2461) Unexpected internal state with ReadWriteSplit and proxy\_protocol=true
