...
* [MXS-2315](https://jira.mariadb.org/browse/MXS-2315) std::regex\_error exception on csmon startup
* [MXS-2311](https://jira.mariadb.org/browse/MXS-2311) connection\_keepalive and error : (4852) Unexpected internal state: received response 0x00 from server
...
* [MXS-2295](https://jira.mariadb.org/browse/MXS-2295) COM\_CHANGE\_USER does not clear out session command history
...
* [MXS-2038](https://jira.mariadb.org/browse/MXS-2038) debug assert at rwsplit\_route\_stmt.cc:469 failed: btype != BE\_MASTER
