# mariadb-maxscale-23-data-archiving-with-mqfilter-and-tee-filters
...
![](../../../.gitbook/assets/mariadb-corporation/MaxScale/2.3.20/Documentation/Tutorials/images/rabbit-and-tee.png.png)
...
The installation of MariaDB MaxScale is covered in the Installation chapter of the [MariaDB MaxScale Tutorial](../../mariadb-maxscale-21-06/).
...
in the Creating Database Users section of the[MariaDB MaxScale Tutorial](../../mariadb-maxscale-21-06/).
...
The `hostname` is the address and the `port` is the port of the RabbitMQ server. For`username` and `password` we will use the `msguser` and `msgpwd` credentials we\
...
please read [RabbitMQ Consumer Client](../maxscale-23-filters/mariadb-maxscale-23-rabbitmq-consumer-client.md).
