# mariadb-maxscale-23-mariadb-maxscale-as-a-binlog-server
...
* [Introduction](mariadb-maxscale-23-mariadb-maxscale-as-a-binlog-server.md#introduction)
* [MariaDB as a Binlog Server](mariadb-maxscale-23-mariadb-maxscale-as-a-binlog-server.md#mariadb-as-a-binlog-server)
* [MariaDB MaxScale's approach](mariadb-maxscale-23-mariadb-maxscale-as-a-binlog-server.md#mariadb-maxscales-approach)
* [Configuring MariaDB MaxScale as a Binlog Server](mariadb-maxscale-23-mariadb-maxscale-as-a-binlog-server.md#configuring-mariadb-maxscale-as-a-binlog-server)
* [Service Configuration](mariadb-maxscale-23-mariadb-maxscale-as-a-binlog-server.md#service-configuration)
* [Listener Configuration](mariadb-maxscale-23-mariadb-maxscale-as-a-binlog-server.md#listener-configuration)
* [Configuring Replication](mariadb-maxscale-23-mariadb-maxscale-as-a-binlog-server.md#configuring-replication)
* [Binlog Router Compatibility](mariadb-maxscale-23-mariadb-maxscale-as-a-binlog-server.md#binlog-router-compatibility)
* [MariaDB MaxScale Replication Diagnostics](mariadb-maxscale-23-mariadb-maxscale-as-a-binlog-server.md#mariadb-maxscale-replication-diagnostics)
...
Refer to the [Configuration-Guide](../../mariadb-maxscale-21-06/)\
...
Further details about level of encryption or certificates could be found in the[Configuration Guide](../../mariadb-maxscale-21-06/)
