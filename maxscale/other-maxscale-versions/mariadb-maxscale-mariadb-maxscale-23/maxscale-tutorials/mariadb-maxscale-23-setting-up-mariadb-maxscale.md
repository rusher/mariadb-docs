...
Read the [Configuring Servers](../../mariadb-maxscale-21-06/) mini-tutorial for server\
...
More options can be found in the[Configuration Guide](../../mariadb-maxscale-21-06/),[readwritesplit module documentation](../maxscale-23-routers/mariadb-maxscale-23-readwritesplit.md) and[readconnroute module documentation](../maxscale-23-routers/mariadb-maxscale-23-readconnroute.md).

For more information about MaxCtrl and how to secure it, see the[REST-API Tutorial](../../mariadb-maxscale-21-06/).
