# mariadb-maxscale-23-setting-up-mariadb-maxscale
...
Building from source code in GitHub is covered in[Building from Source](../maxscale-23-getting-started/mariadb-maxscale-23-building-mariadb-maxscale-from-source-code.md).
...
read[Configuring MariaDB Monitor](mariadb-maxscale-23-configuring-the-mariadb-monitor.md).\
For a Galera cluster read[Configuring Galera Monitor](mariadb-maxscale-23-configuring-the-galera-monitor.md).
