# mariadb-maxscale-23-rest-api-tutorial
...
If we want to remove a server from _all_ services, we can set the`relationships` field to `{}`. The REST API interprets this as an instruction\
...
The full list of all available endpoints in MaxScale can be found in the[REST API documentation](../maxscale-23-rest-api/maxscale-2-3-rest-api.md).
