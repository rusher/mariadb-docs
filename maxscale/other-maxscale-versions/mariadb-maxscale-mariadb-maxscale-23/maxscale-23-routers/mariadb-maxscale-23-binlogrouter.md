...
configured according to the[Configuration Guide](../../mariadb-maxscale-21-06/).
...
The burst size can be provided as specified[here](../../mariadb-maxscale-21-06/), except that IEC binary\
