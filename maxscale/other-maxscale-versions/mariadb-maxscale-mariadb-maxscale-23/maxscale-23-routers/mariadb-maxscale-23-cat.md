...
Here is a simple example service definition that uses the servers from the[Configuring Servers](../../mariadb-maxscale-21-06/) tutorial and the\
credentials from the [MaxScale Tutorial](../../mariadb-maxscale-21-06/).
