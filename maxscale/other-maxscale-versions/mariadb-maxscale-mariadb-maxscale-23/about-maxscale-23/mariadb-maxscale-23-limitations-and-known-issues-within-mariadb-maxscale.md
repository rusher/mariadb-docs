...
can be influenced with the server priority mechanic described in the[Galera Monitor](../maxscale-23-monitors/mariadb-maxscale-23-galera-monitor.md) manual.
...
will always be routed to the master. See[strict\_multi\_stmt](../maxscale-23-routers/mariadb-maxscale-23-readwritesplit.md#strict_multi_stmt) for more\
details.
