...
backend servers have a low *wait_timeout* value and the client connections live
...
[connection_timeout](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)
parameter.
...
[strict_multi_stmt](mariadb-maxscale-24-readwritesplit.md#strict_multi_stmt) for more
details.
