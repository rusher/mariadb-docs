...
* [Binlogrouter](mariadb-maxscale-24-binlogrouter.md#binlogrouter)
  * [Configuration](mariadb-maxscale-24-binlogrouter.md#configuration)
    * [Mandatory Router Parameters](mariadb-maxscale-24-binlogrouter.md#mandatory-router-parameters)
    * [Router Parameters](mariadb-maxscale-24-binlogrouter.md#router-parameters)
      * [binlogdir](mariadb-maxscale-24-binlogrouter.md#binlogdir)
      * [server\_id](mariadb-maxscale-24-binlogrouter.md#server_id)
      * [master\_id](mariadb-maxscale-24-binlogrouter.md#master_id)
      * [uuid](mariadb-maxscale-24-binlogrouter.md#uuid)
      * [master\_uuid](mariadb-maxscale-24-binlogrouter.md#master_uuid)
      * [master\_version](mariadb-maxscale-24-binlogrouter.md#master_version)
      * [master\_hostname](mariadb-maxscale-24-binlogrouter.md#master_hostname)
      * [slave\_hostname](mariadb-maxscale-24-binlogrouter.md#slave_hostname)
      * [user](mariadb-maxscale-24-binlogrouter.md#user)
      * [password](mariadb-maxscale-24-binlogrouter.md#password)
      * [heartbeat](mariadb-maxscale-24-binlogrouter.md#heartbeat)
      * [burstsize](mariadb-maxscale-24-binlogrouter.md#burstsize)
      * [mariadb10-compatibility](mariadb-maxscale-24-binlogrouter.md#mariadb10-compatibility)
      * [transaction\_safety](mariadb-maxscale-24-binlogrouter.md#transaction_safety)
      * [send\_slave\_heartbeat](mariadb-maxscale-24-binlogrouter.md#send_slave_heartbeat)
      * [semisync](mariadb-maxscale-24-binlogrouter.md#semisync)
      * [ssl\_cert\_verification\_depth](mariadb-maxscale-24-binlogrouter.md#ssl_cert_verification_depth)
      * [encrypt\_binlog](mariadb-maxscale-24-binlogrouter.md#encrypt_binlog)
      * [encryption\_algorithm](mariadb-maxscale-24-binlogrouter.md#encryption_algorithm)
      * [encryption\_key\_file](mariadb-maxscale-24-binlogrouter.md#encryption_key_file)
      * [mariadb10\_master\_gtid](mariadb-maxscale-24-binlogrouter.md#mariadb10_master_gtid)
      * [master\_retry\_count](mariadb-maxscale-24-binlogrouter.md#master_retry_count)
      * [connect\_retry](mariadb-maxscale-24-binlogrouter.md#connect_retry)
    * [Using secondary masters](mariadb-maxscale-24-binlogrouter.md#using-secondary-masters)
  * [Examples](mariadb-maxscale-24-binlogrouter.md#examples)
...
configured according to the[Configuration Guide](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md).
...
Read the [MySQL Authenticator](../maxscale-24-authenticators/mariadb-maxscale-24-mysql-authenticator.md)\
...
authenticator module. Read the[MySQL Authenticator](../maxscale-24-authenticators/mariadb-maxscale-24-mysql-authenticator.md)\
...
to the master. The duration can be specified as documented[here](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md). If no explicit\
...
The burst size can be provided as specified[here](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md), except that IEC binary\
...
The duration can be specified as documented[here](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md). If no explicit\
unit is provided, the value is interpreted as seconds in MaxScale 2.4. In\
subsequent versions a value without a unit may be rejected. Note that since\
the granularity of the parameter is seconds, a value specified in milliseconds\
will be rejected, even if the duration is longer than a second.\
...
The [Replication Proxy](../maxscale-24-tutorials/mariadb-maxscale-24-mariadb-maxscale-as-a-binlog-server.md)\
