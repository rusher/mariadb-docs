# mariadb-maxscale-24-smartrouter

## SmartRouter

## SmartRouter

* [SmartRouter](mariadb-maxscale-24-smartrouter.md#smartrouter)
  * [Overview](mariadb-maxscale-24-smartrouter.md#overview)
  * [Configuration](mariadb-maxscale-24-smartrouter.md#configuration)
    * [master](mariadb-maxscale-24-smartrouter.md#master)
    * [Service as a Server](mariadb-maxscale-24-smartrouter.md#service-as-a-server)
      * [Example](mariadb-maxscale-24-smartrouter.md#example)
  * [Cluster selection - how queries are routed](mariadb-maxscale-24-smartrouter.md#cluster-selection-how-queries-are-routed)
  * [Limitations](mariadb-maxscale-24-smartrouter.md#limitations)
  * [Complete configuration example](mariadb-maxscale-24-smartrouter.md#complete-configuration-example)
...
For details about the standard service parameters, refer to the[Configuration Guide](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md).
...
InnoDB engine. The ReadWriteSplit [documentation](mariadb-maxscale-24-readwritesplit.md) has more on\
master-slave setup.
...
is known as _Service as a Server_.
...
Assuming we have defined `RWS-Column`, `RWS-Column-Listener` and`RWS-Column-as-a-server` similarly, we can define the SmartQuery\
service as follows:
