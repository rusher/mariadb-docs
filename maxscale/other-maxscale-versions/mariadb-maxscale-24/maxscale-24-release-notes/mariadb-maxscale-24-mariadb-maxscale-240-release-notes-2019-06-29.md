...
MaxScale 2.4.0 will now use the SO\_REUSEPORT capability offered by newer kernels\
...
Please see the[documentation](../maxscale-24-monitors/mariadb-maxscale-24-clustrix-monitor.md) for details.
...
Please see the[documentation](../maxscale-24-routers/mariadb-maxscale-24-smartrouter.md) for details.
...
groupings of servers into primary and secondary groups. Servers configured with`rank=secondary` will only be used if no primary servers are available.

#### UNIX Domain Socket for Servers

Servers can now use the[socket](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md) parameter to define\
...
In the MaxScale configuration file, durations can now be suffixed with`h`, `m`, `s` or `ms` to indicate that the duration is specified as\
hours, minutes, seconds or milliseconds.

Please see the[configuration guide](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)\
for details.
...
connecting from will be blocked for 60 seconds. See[max\_auth\_errors\_until\_block](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)\
...
For more information, read the[REST-API](../maxscale-24-rest-api/mariadb-maxscale-24-server-resource.md#set-server-state) documentation for\
the `set` endpoint.
...
For more information on the readwritesplit router, refer to the[documentation](../maxscale-24-routers/mariadb-maxscale-24-readwritesplit.md).
...
always use connection counts. This allows the use of`slave_selection_criteria=LEAST_CURRENT_OPERATIONS` and`max_slave_connections=1`.
...
maintenance mode. To forcefully close all connections to a server use the`maxctrl set server <name> maintenance --force` command.
...
backend servers. Please see[MariaDB-Monitor documentation](../maxscale-24-monitors/mariadb-maxscale-24-mariadb-monitor.md#enforce_simple_topology)\
for more information.
