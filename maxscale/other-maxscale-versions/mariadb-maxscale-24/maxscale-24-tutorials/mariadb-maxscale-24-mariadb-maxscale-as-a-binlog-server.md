# mariadb-maxscale-24-mariadb-maxscale-as-a-binlog-server
...
* [Introduction](mariadb-maxscale-24-mariadb-maxscale-as-a-binlog-server.md#introduction)
* [MariaDB as a Binlog Server](mariadb-maxscale-24-mariadb-maxscale-as-a-binlog-server.md#mariadb-as-a-binlog-server)
* [MariaDB MaxScale's approach](mariadb-maxscale-24-mariadb-maxscale-as-a-binlog-server.md#mariadb-maxscales-approach)
* [Configuring MariaDB MaxScale as a Binlog Server](mariadb-maxscale-24-mariadb-maxscale-as-a-binlog-server.md#configuring-mariadb-maxscale-as-a-binlog-server)
* [Service Configuration](mariadb-maxscale-24-mariadb-maxscale-as-a-binlog-server.md#service-configuration)
* [Listener Configuration](mariadb-maxscale-24-mariadb-maxscale-as-a-binlog-server.md#listener-configuration)
* [Configuring Replication](mariadb-maxscale-24-mariadb-maxscale-as-a-binlog-server.md#configuring-replication)
* [Binlog Router Compatibility](mariadb-maxscale-24-mariadb-maxscale-as-a-binlog-server.md#binlog-router-compatibility)
* [MariaDB MaxScale Replication Diagnostics](mariadb-maxscale-24-mariadb-maxscale-as-a-binlog-server.md#mariadb-maxscale-replication-diagnostics)
...
Documentation](../maxscale-24-routers/mariadb-maxscale-24-binlogrouter.md).
...
The protocol used by slaves for connection to MariaDB MaxScale is the sam&#x65;_&#x4D;ariaDBClient_ protocol that is used for client applications to connect to\
...
Refer to the [Configuration-Guide](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)\
...
Further details about level of encryption or certificates could be found in the[Configuration Guide](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)
