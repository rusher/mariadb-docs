# mariadb-maxscale-24-setting-up-mariadb-maxscale
...
Building from source code in GitHub is covered in[Building from Source](../maxscale-24-getting-started/mariadb-maxscale-24-building-mariadb-maxscale-from-source-code.md).
...
read[Configuring MariaDB Monitor](mariadb-maxscale-24-configuring-the-mariadb-monitor.md).\
For a Galera cluster read[Configuring Galera Monitor](mariadb-maxscale-24-configuring-the-galera-monitor.md).
