...
_**This guide was written for lsyncd 2.1.5.**_
...
You can install lsyncd with either a package manager or by building from source code. This guide demonstrates installation using a package manager and those looking to build lsyncd from source should refer to its documentation: [Manual-to-Lsyncd-2.1.x](https://github.com/axkibe/lsyncd/wiki/Manual-to-Lsyncd-2.1.x)
