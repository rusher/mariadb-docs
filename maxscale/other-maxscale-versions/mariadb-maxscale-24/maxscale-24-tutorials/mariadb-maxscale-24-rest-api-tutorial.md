# mariadb-maxscale-24-rest-api-tutorial
...
The full list of all available endpoints in MaxScale can be found in the[REST API documentation](../maxscale-24-rest-api/maxscale-24-rest-api-maxscale-rest-api.md).
