...
Authenticator modules compatible with MySQL protocol in MaxScale are[MySQL](mariadb-maxscale-24-mysql-authenticator.md), [GSSAPI](mariadb-maxscale-24-gssapi-client-authenticator.md) and[PAM](mariadb-maxscale-24-pam-authenticator.md).
