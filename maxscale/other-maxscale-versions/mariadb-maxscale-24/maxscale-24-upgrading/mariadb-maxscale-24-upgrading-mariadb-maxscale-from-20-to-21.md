...
For more information about MariaDB MaxScale 2.1, please refer to the[ChangeLog](../mariadb-maxscale-24-changelog.md).
...
Starting with MaxScale 2.1, any changes made with the newly added[runtime configuration change](../maxscale-24-reference/mariadb-maxscale-24-maxadmin-admin-interface.md#runtime-configuration-changes)\
