# mariadb-maxscale-24-mariadb-maxscale-configuration-guide

## MariaDB MaxScale Configuration Guide

## MariaDB MaxScale Configuration Guide

* [MariaDB MaxScale Configuration Guide](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#mariadb-maxscale-configuration-guide)
* [Introduction](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#introduction)
* [Concepts](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#concepts)
  * [Glossary](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#glossary)
  * [Objects](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#objects)
    * [Server](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#server)
    * [Protocol](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#protocol)
    * [Monitor](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#monitor)
    * [Filter](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#filter)
    * [Router](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#router)
    * [Service](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#service)
    * [Listener](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#listener)
* [Administration](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#administration)
  * [Static Configuration Parameters](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#static-configuration-parameters)
* [Configuration](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#configuration)
  * [Names](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#names)
  * [Special Parameter Types](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#special-parameter-types)
    * [Sizes](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#sizes)
    * [Durations](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#durations)
    * [Regular Expressions](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#regular-expressions)
      * [Standard regular expression settings for filters](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#standard-regular-expression-settings-for-filters)
  * [Global Settings](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#global-settings)
    * [threads](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#threads)
    * [thread\_stack\_size](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#thread_stack_size)
    * [auth\_connect\_timeout](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#auth_connect_timeout)
    * [auth\_read\_timeout](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#auth_read_timeout)
    * [auth\_write\_timeout](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#auth_write_timeout)
    * [query\_retries](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#query_retries)
    * [query\_retry\_timeout](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#query_retry_timeout)
    * [passive](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#passive)
    * [ms\_timestamp](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#ms_timestamp)
    * [skip\_permission\_checks](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#skip_permission_checks)
    * [syslog](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#syslog)
    * [maxlog](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#maxlog)
    * [log\_to\_shm](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#log_to_shm)
    * [log\_warning](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#log_warning)
    * [log\_notice](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#log_notice)
    * [log\_info](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#log_info)
    * [log\_debug](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#log_debug)
    * [log\_messages](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#log_messages)
    * [log\_trace](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#log_trace)
    * [log\_augmentation](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#log_augmentation)
    * [log\_throttling](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#log_throttling)
    * [logdir](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#logdir)
    * [datadir](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#datadir)
    * [libdir](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#libdir)
    * [cachedir](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#cachedir)
    * [piddir](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#piddir)
    * [execdir](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#execdir)
    * [connector\_plugindir](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#connector_plugindir)
    * [persistdir](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#persistdir)
    * [module\_configdir](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#module_configdir)
    * [language](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#language)
    * [query\_classifier](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#query_classifier)
    * [query\_classifier\_cache\_size](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#query_classifier_cache_size)
    * [query\_classifier\_args](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#query_classifier_args)
      * [log\_unrecognized\_statements](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#log_unrecognized_statements)
    * [substitute\_variables](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#substitute_variables)
    * [sql\_mode](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#sql_mode)
    * [local\_address](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#local_address)
    * [users\_refresh\_time](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#users_refresh_time)
    * [retain\_last\_statements](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#retain_last_statements)
    * [dump\_last\_statements](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#dump_last_statements)
    * [session\_trace](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#session_trace)
    * [writeq\_high\_water](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#writeq_high_water)
    * [writeq\_low\_water](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#writeq_low_water)
    * [load\_persisted\_configs](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#load_persisted_configs)
    * [max\_auth\_errors\_until\_block](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#max_auth_errors_until_block)
    * [REST API Configuration](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#rest-api-configuration)
    * [admin\_host](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#admin_host)
    * [admin\_port](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#admin_port)
    * [admin\_auth](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#admin_auth)
    * [admin\_ssl\_key](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#admin_ssl_key)
    * [admin\_ssl\_cert](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#admin_ssl_cert)
    * [admin\_ssl\_ca\_cert](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#admin_ssl_ca_cert)
    * [admin\_enabled](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#admin_enabled)
    * [admin\_log\_auth\_failures](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#admin_log_auth_failures)
    * [admin\_pam\_readwrite\_service and admin\_pam\_readonly\_service](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#admin_pam_readwrite_service-and-admin_pam_readonly_service)
  * [Events](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#events)
    * ['authentication\_failure'](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#authentication_failure)
  * [Service](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#service_1)
    * [router](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#router_1)
    * [router\_options](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#router_options)
    * [filters](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#filters)
    * [servers](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#servers)
    * [cluster](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#cluster)
    * [user](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#user)
    * [password](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#password)
    * [enable\_root\_user](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#enable_root_user)
    * [localhost\_match\_wildcard\_host](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#localhost_match_wildcard_host)
    * [version\_string](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#version_string)
    * [weightby](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#weightby)
    * [auth\_all\_servers](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#auth_all_servers)
    * [strip\_db\_esc](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#strip_db_esc)
    * [retry\_on\_failure](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#retry_on_failure)
    * [log\_auth\_warnings](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#log_auth_warnings)
    * [connection\_timeout](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#connection_timeout)
    * [max\_connections](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#max_connections)
    * [max\_retry\_interval](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#max_retry_interval)
    * [session\_track\_trx\_state](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#session_track_trx_state)
    * [retain\_last\_statements](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#retain_last_statements_1)
    * [net\_write\_timeout](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#net_write_timeout)
  * [Server](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#server_1)
    * [address](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#address)
    * [port](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#port)
    * [socket](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#socket)
    * [protocol](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#protocol_1)
    * [monitoruser](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#monitoruser)
    * [monitorpw](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#monitorpw)
    * [extra\_port](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#extra_port)
    * [persistpoolmax](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#persistpoolmax)
    * [persistmaxtime](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#persistmaxtime)
    * [proxy\_protocol](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#proxy_protocol)
    * [authenticator](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#authenticator)
    * [authenticator\_options](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#authenticator_options)
    * [disk\_space\_threshold](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#disk_space_threshold)
    * [rank](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#rank)
  * [Monitor](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#monitor_1)
  * [Listener](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#listener_1)
    * [service](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#service_2)
    * [protocol](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#protocol_2)
    * [address](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#address_1)
    * [port](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#port_1)
    * [socket](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#socket_1)
    * [authenticator](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#authenticator_1)
    * [authenticator\_options](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#authenticator_options_1)
* [Available Protocols](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#available-protocols)
  * [MariaDBClient](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#mariadbclient)
  * [MariaDBBackend](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#mariadbbackend)
  * [maxscaled](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#maxscaled)
  * [HTTPD](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#httpd)
* [TLS/SSL encryption](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#tlsssl-encryption)
  * [ssl](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#ssl)
  * [ssl\_key](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#ssl_key)
  * [ssl\_cert](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#ssl_cert)
  * [ssl\_ca\_cert](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#ssl_ca_cert)
  * [ssl\_version](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#ssl_version)
  * [ssl\_cipher](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#ssl_cipher)
  * [ssl\_cert\_verify\_depth](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#ssl_cert_verify_depth)
  * [ssl\_verify\_peer\_certificate](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#ssl_verify_peer_certificate)
    * [Example SSL enabled server configuration](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#example-ssl-enabled-server-configuration)
    * [Example SSL enabled listener configuration](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#example-ssl-enabled-listener-configuration)
* [Module Types](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#module-types)
  * [Routing Modules](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#routing-modules)
  * [Monitor Modules](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#monitor-modules)
  * [Filter Modules](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#filter-modules)
* [Encrypting Passwords](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#encrypting-passwords)
  * [Creating Encrypted Passwords](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#creating-encrypted-passwords)
* [Runtime Configuration Changes](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#runtime-configuration-changes)
  * [Backing Up Configuration Changes](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#backing-up-configuration-changes)
* [Error Reporting](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#error-reporting)
* [Limitations](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#limitations)
* [Troubleshooting](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#troubleshooting)
  * [Authentication](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#authentication)
    * [Wildcard Hosts](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#wildcard-hosts)
  * [Systemd Watchdog](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#systemd-watchdog)
...
* Writing the MaxScale configuration file, which is described in the following[section](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#configuration).
* Performing runtime modifications using [MaxCtrl](../maxscale-24-reference/mariadb-maxscale-24-maxctrl.md)\
  or [MaxAdmin](../maxscale-24-reference/mariadb-maxscale-24-maxadmin-admin-interface.md).
...
The value is specified as documented [here](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#durations). If no explicit unit\
...
If you want to store the log in shared memory, define the directory with`logdir` in `/dev/shm`.
...
The durations can be specified as documented [here](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#durations). If no explicit\
...
the cache. The size of the cache can be specifed as explained [here](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#sizes).
...
throtting is started. The parameter accepts [size type values](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#sizes).
...
parameter accepts [size type values](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#sizes). The minimum allowed size is 512\
...
_NOTE_ The `servers` parameter is mutually exclusive with the `cluster` parameter.
...
_NOTE_ The `clusters` parameter is mutually exclusive with the `servers` parameter.
...
**Note:** This feature has been removed from MaxScale 2.4. See[retry\_on\_failure](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#retry_on_failure) for more details.
...
as documented [here](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#durations). If no explicit unit is provided, the value\
...
For more information about persistent connections, please read the[Administration Tutorial](../maxscale-24-tutorials/mariadb-maxscale-24-mariadb-maxscale-administration-tutorial.md).
...
master. Read the[readwritesplit documentation on server ranks](../maxscale-24-routers/mariadb-maxscale-24-readwritesplit.md#server-ranks)\
...
Common monitor parameters [can be found here](../maxscale-24-monitors/mariadb-maxscale-24-common-monitor-parameters.md).
...
* [ReadConnRoute](../maxscale-24-routers/mariadb-maxscale-24-readconnroute.md)

Read/Write aware statement based router:

* [ReadWriteSplit](../maxscale-24-routers/mariadb-maxscale-24-readwritesplit.md)
...
![](../../../.gitbook/assets/mariadb-corporation/MaxScale/2.4.19/Documentation/Getting-Started/images/image_10.png.png)
...
The [Filter Tutorial](../maxscale-24-tutorials/9077.md) document shows how you\
can add a filter to a service and combine multiple filters in one service.

* [Query Log All (QLA) Filter](../maxscale-24-filters/mariadb-maxscale-24-query-log-all-filter.md)
* [Regular Expression Filter](../maxscale-24-filters/mariadb-maxscale-24-regex-filter.md)
* [Tee Filter](../maxscale-24-filters/mariadb-maxscale-24-tee-filter.md)
* [Top Filter](../maxscale-24-filters/mariadb-maxscale-24-top-filter.md)
* [Database Firewall Filter](../maxscale-24-filters/mariadb-maxscale-24-database-firewall-filter.md)
* [Query Redirection Filter](../maxscale-24-filters/mariadb-maxscale-24-named-server-filter.md)
...
* MaxCtrl
* [create](../maxscale-24-reference/mariadb-maxscale-24-maxctrl.md#create)
* [destroy](../maxscale-24-reference/mariadb-maxscale-24-maxctrl.md#destroy)
* [add](../maxscale-24-reference/mariadb-maxscale-24-maxctrl.md#add)
* [remove](../maxscale-24-reference/mariadb-maxscale-24-maxctrl.md#remove)
* [alter](../maxscale-24-reference/mariadb-maxscale-24-maxctrl.md#alter)
* [REST API](../maxscale-24-rest-api/maxscale-24-rest-api-maxscale-rest-api.md) documentation
* MaxAdmin (deprecated)
* [Runtime Configuration Changes](../maxscale-24-reference/mariadb-maxscale-24-maxadmin-admin-interface.md#runtime-configuration-changes)
...
The current limitations of MaxScale are listed in the [Limitations](../about-maxscale-24/mariadb-maxscale-24-limitations-and-known-issues-within-mariadb-maxscale.md) document.
...
host from which they can connect. These limitations do not apply when[proxy\_protocol](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#proxy_protocol) is in use.
...
2. Clients running on the same host as MariaDB MaxScale can not access the\
   ...
   configured with the[localhost\_match\_wildcard\_host](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md#localhost_match_wildcard_host) option.
