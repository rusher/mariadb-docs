...
The throttle filter replaces and extends on the limit\_queries functionality of[the Database Firewall filter](mariadb-maxscale-24-database-firewall-filter.md).
...
The value is specified as documented[here](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md).\
