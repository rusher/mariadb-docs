...
* [Database Firewall filter](mariadb-maxscale-24-database-firewall-filter.md#database-firewall-filter)
* [Table of Contents](mariadb-maxscale-24-database-firewall-filter.md#table-of-contents)
  * [Overview](mariadb-maxscale-24-database-firewall-filter.md#overview)
  * [Configuration](mariadb-maxscale-24-database-firewall-filter.md#configuration)
    * [Filter Parameters](mariadb-maxscale-24-database-firewall-filter.md#filter-parameters)
      * [rules](mariadb-maxscale-24-database-firewall-filter.md#rules)
      * [action](mariadb-maxscale-24-database-firewall-filter.md#action)
      * [log\_match](mariadb-maxscale-24-database-firewall-filter.md#log_match)
      * [log\_no\_match](mariadb-maxscale-24-database-firewall-filter.md#log_no_match)
      * [treat\_string\_as\_field](mariadb-maxscale-24-database-firewall-filter.md#treat_string_as_field)
      * [treat\_string\_arg\_as\_field](mariadb-maxscale-24-database-firewall-filter.md#treat_string_arg_as_field)
      * [strict](mariadb-maxscale-24-database-firewall-filter.md#strict)
  * [Rule syntax](mariadb-maxscale-24-database-firewall-filter.md#rule-syntax)
    * [Mandatory rule parameters](mariadb-maxscale-24-database-firewall-filter.md#mandatory-rule-parameters)
      * [wildcard](mariadb-maxscale-24-database-firewall-filter.md#wildcard)
        * [Example](mariadb-maxscale-24-database-firewall-filter.md#example)
      * [columns](mariadb-maxscale-24-database-firewall-filter.md#columns)
        * [Example](mariadb-maxscale-24-database-firewall-filter.md#example_1)
      * [function](mariadb-maxscale-24-database-firewall-filter.md#function)
        * [Example](mariadb-maxscale-24-database-firewall-filter.md#example_2)
      * [not\_function](mariadb-maxscale-24-database-firewall-filter.md#not_function)
      * [Example](mariadb-maxscale-24-database-firewall-filter.md#example_3)
      * [uses\_function](mariadb-maxscale-24-database-firewall-filter.md#uses_function)
        * [Example](mariadb-maxscale-24-database-firewall-filter.md#example_4)
      * [function and columns](mariadb-maxscale-24-database-firewall-filter.md#function-and-columns)
        * [Example](mariadb-maxscale-24-database-firewall-filter.md#example_5)
      * [not\_function and columns](mariadb-maxscale-24-database-firewall-filter.md#not_function-and-columns)
        * [Example](mariadb-maxscale-24-database-firewall-filter.md#example_6)
      * [regex](mariadb-maxscale-24-database-firewall-filter.md#regex)
        * [Example](mariadb-maxscale-24-database-firewall-filter.md#example_7)
      * [limit\_queries](mariadb-maxscale-24-database-firewall-filter.md#limit_queries)
        * [Example](mariadb-maxscale-24-database-firewall-filter.md#example_8)
      * [no\_where\_clause](mariadb-maxscale-24-database-firewall-filter.md#no_where_clause)
        * [Example](mariadb-maxscale-24-database-firewall-filter.md#example_9)
    * [Optional rule parameters](mariadb-maxscale-24-database-firewall-filter.md#optional-rule-parameters)
      * [at\_times](mariadb-maxscale-24-database-firewall-filter.md#at_times)
      * [on\_queries](mariadb-maxscale-24-database-firewall-filter.md#on_queries)
    * [Applying rules to users](mariadb-maxscale-24-database-firewall-filter.md#applying-rules-to-users)
  * [Module commands](mariadb-maxscale-24-database-firewall-filter.md#module-commands)
    * [rules/reload FILTER \[FILE\]](mariadb-maxscale-24-database-firewall-filter.md#rulesreload-filter-file)
    * [rules FILTER](mariadb-maxscale-24-database-firewall-filter.md#rules-filter)
  * [Use Cases](mariadb-maxscale-24-database-firewall-filter.md#use-cases)
    * [Use Case 1 - Prevent rapid execution of specific queries](mariadb-maxscale-24-database-firewall-filter.md#use-case-1-prevent-rapid-execution-of-specific-queries)
    * [Use Case 2 - Only allow deletes with a where clause](mariadb-maxscale-24-database-firewall-filter.md#use-case-2-only-allow-deletes-with-a-where-clause)
