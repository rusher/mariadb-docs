...
The comments must follow the [MaxScale hint syntax](../maxscale-24-reference/mariadb-maxscale-24-hint-syntax.md)\
...
can be specified as documented[here](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)\
