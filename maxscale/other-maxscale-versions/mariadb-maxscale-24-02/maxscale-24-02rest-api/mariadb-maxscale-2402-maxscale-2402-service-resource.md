...
[servers](../maxscale-24-02getting-started/mariadb-maxscale-2402-maxscale-2402-mariadb-maxscale-configuration-guide.md) parameter. For
filters, this is equivalent to adding the filters in the
`data.relationships.filters.data` array to the
[filters](../maxscale-24-02getting-started/mariadb-maxscale-2402-maxscale-2402-mariadb-maxscale-configuration-guide.md) parameter in the
order they appear. For other services, this is equivalent to adding the list of
server names into the
[targets](../maxscale-24-02getting-started/mariadb-maxscale-2402-maxscale-2402-mariadb-maxscale-configuration-guide.md) parameter.
...
[sessions](mariadb-maxscale-2402-maxscale-2402-session-resource.md) resource should be used. If a session for
...
[service](../maxscale-24-02getting-started/mariadb-maxscale-2402-maxscale-2402-mariadb-maxscale-configuration-guide.md) documentation on
...
[this](mariadb-maxscale-2402-maxscale-2402-listener-resource.md) listeners endpoint instead.
