...
#### [MXS-4746](https://jira.mariadb.org/browse/MXS-4746) Add last\_gtid to session\_track\_system\_variables automatically when causal\_reads is enabled

MaxScale now automatically adds _last\_gtid_ to session-leve&#x6C;_&#x73;ession\_track\_system\_variables_ when `causal_reads` is enabled. The setting is\
...
thread count can be customized in monitor settings. See[MariaDB Monitor documentation](../maxscale-24-02monitors/mariadb-maxscale-2402-maxscale-2402-mariadb-monitor.md)\
...
#### [MXS-3616](https://jira.mariadb.org/browse/MXS-3616) Support MARIADB\_CLIENT\_EXTENDED\_TYPE\_INFO
...
used by MariaDB Monitor to detect and set up replication. See[MariaDB Monitor documentation](../maxscale-24-02monitors/mariadb-maxscale-2402-maxscale-2402-mariadb-monitor.md)\
for more information.
