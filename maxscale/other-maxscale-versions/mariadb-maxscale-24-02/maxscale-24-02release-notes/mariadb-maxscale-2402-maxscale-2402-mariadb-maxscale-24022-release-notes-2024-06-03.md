...
* [MXS-5091](https://jira.mariadb.org/browse/MXS-5091) admin\_audit file name does not use log\_dir value
...
* [MXS-5063](https://jira.mariadb.org/browse/MXS-5063) Maxscale crash - "terminate called after throwing an instance of 'std::bad\_alloc'"
...
* [MXS-5023](https://jira.mariadb.org/browse/MXS-5023) kill user and transaction\_replay don't play well together in Galera cluster
