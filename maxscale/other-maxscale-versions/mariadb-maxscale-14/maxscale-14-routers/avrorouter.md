...
For information about common service parameters, refer to the[Configuration Guide](../maxscale-14-getting-started/maxscale-configuration-usage-scenarios.md).
...
the user creation, please refer to the [CDC Protocol](../maxscale-14-protocols/cdc-protocol.md)\
and [CDC Users](../maxscale-14-protocols/change-data-capture-cdc-users.md) documentation.
...
The [Avrorouter Tutorial](../maxscale-14-tutorials/avrorouter-tutorial.md) shows you how\
...
configuring MaxScale with CMake, you will need to add `-DBUILD_AVRO=Y -DBUILD_CDC=Y` to build the avrorouter and the CDC protocol module.
