...
[Starting MaxScale](maxscale-administration-tutorial.md#starting)[Stopping MaxScale](maxscale-administration-tutorial.md#stopping)[Checking The Status Of The MaxScale Services](maxscale-administration-tutorial.md#checking)[Persistent Connections](maxscale-administration-tutorial.md#persistent)[What Clients Are Connected To MaxScale](maxscale-administration-tutorial.md#clients)[Rotating Log Files](maxscale-administration-tutorial.md#rotating)[Taking A Database Server Out Of Use](maxscale-administration-tutorial.md#outofuse)
