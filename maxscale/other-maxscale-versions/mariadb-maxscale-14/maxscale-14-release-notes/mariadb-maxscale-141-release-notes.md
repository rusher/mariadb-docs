...
release [1.4.0](mariadb-maxscale-140-beta-release-notes.md).
...
* [MXS-630](https://jira.mariadb.org/browse/MXS-630): Requirement of tables\_priv access not documented in "Upgrading" guide
* [MXS-629](https://jira.mariadb.org/browse/MXS-629): Lack of tables\_priv privilege causes confusing error message
