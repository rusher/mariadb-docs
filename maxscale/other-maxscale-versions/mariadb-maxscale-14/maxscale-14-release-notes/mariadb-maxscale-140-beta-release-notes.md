...
logging functionality with the *ignore* action, you can set up the filter in
...
[MaxScale Configuration Guide](../maxscale-14-getting-started/maxscale-configuration-usage-scenarios.md#listener-and-ssl).


### POSIX Extended Regular Expression Syntax


The *qlafilter*, the *topfilter* and the *namedserverfilter* now
accept *extended* as a filter option, which enables the POSIX Extended
...
[MaxScale Configuration Guide](../maxscale-14-getting-started/maxscale-configuration-usage-scenarios.md#service).
