...
authenticate using credentials provided in a format described in the [CDC Protocol documentation](cdc-protocol.md).
...
more details on the format of the _cdcusers_ file, read the [CDC Protocol documentation](cdc-protocol.md).
