...
* [Configuration](maxscale-configuration-usage-scenarios.md#configuration)
* [Global Settings](maxscale-configuration-usage-scenarios.md#global-settings)
* [Service](maxscale-configuration-usage-scenarios.md#service)
* [Server](maxscale-configuration-usage-scenarios.md#server)
* [Listener](maxscale-configuration-usage-scenarios.md#listener)
* [Listener and SSL](maxscale-configuration-usage-scenarios.md#listener-and-ssl)
* [Router Modules](maxscale-configuration-usage-scenarios.md#routing-modules)
* [Diagnostic Modules](maxscale-configuration-usage-scenarios.md#diagnostic-modules)
* [Monitor Modules](maxscale-configuration-usage-scenarios.md#monitor-modules)
* [Filter Modules](maxscale-configuration-usage-scenarios.md#filter-modules)
* [Reloading Configuration](maxscale-configuration-usage-scenarios.md#reloading-configuration)
* [Authentication](maxscale-configuration-usage-scenarios.md#authentication)
* [Error Reporting](maxscale-configuration-usage-scenarios.md#error-reporting)
...
You can enable automatic configuration of this value by setting the value to`auto`. This way MaxScale will detect the number of available processors and\
...
Enable to disable to logging of messages to _syslog_.
...
Since _MaxScale_ can log to both file and _syslog_ an approach that provides\
...
The strip\_db\_esc parameter strips escape characters from database names of grants when loading the users from the backend server. Some visual database management tools automatically escape some characters and this might cause conflicts when MaxScale tries to authenticate users.
...
The connection\_timeout parameter is used to disconnect sessions to MaxScale that have been idle for too long. The session timeouts are disabled by default. To enable them, define the timeout in seconds in the service's configuration section.
...
For more information about persistent connections, please read the [Administration Tutorial](../maxscale-14-tutorials/maxscale-administration-tutorial.md).
...
* [ReadConnRoute](../maxscale-14-routers/maxscale-readconnroute.md)

Read/Write aware statement based router:

* [ReadWriteSplit](../maxscale-14-routers/readwritesplit.md)
...
* [MaxAdmin Module](../../../maxscale-management/maxscale-troubleshooting.md)
...
The [Filter Tutorial](../maxscale-14-tutorials/tutorials-maxscale-filters.md) document shows how you can add a filter to a service and combine multiple filters in one service.

* [Query Log All (QLA) Filter](../maxscale-14-filters/maxscale-query-log-all-filter.md)
* [Regular Expression Filter](../maxscale-14-filters/maxscale-regex-filter-overview.md)
* [Tee Filter](../maxscale-14-filters/maxscale-tee-filter-overview.md)
* [Top Filter](../maxscale-14-filters/maxscale-top-filter-overview.md)
* [Database Firewall Filter](../maxscale-14-filters/maxscale-database-firewall-filter.md)
* [Query Redirection Filter](../maxscale-14-filters/maxscale-named-server-filter-overview.md)
...
To clarify, if a user _X_ is defined as using password _pass1_ from host _a_ and _pass2_ from host _b_ then there must be an entry in the `user` table for user _X_ from the MaxScale host, say _pass1_.
...
In this case the user _X_ would be able to connect to MaxScale from host a giving the password of _pass1_. In addition MaxScale would be able to create connections for this user to the backend servers using the username _X_ and password _pass1_, since the MaxScale host is also defined to have password _pass1_. User _X_ would not however be able to connect from host _b_ since they would need to provide the password _pass2_ in order to connect to MaxScale, but then MaxScale would not be able to connect to the backends as it would also use the password _pass2_ for these connections.
