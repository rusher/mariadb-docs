...
* [Overview](maxadmin.md#overview)
* [Running MaxAdmin](maxadmin.md#running)
* [Working With Administration Interface Users](maxadmin.md#interface)
* [Getting Help](maxadmin.md#help)
* [Working with Services](maxadmin.md#services)
* [Working with Servers](maxadmin.md#servers)
* [Working with Sessions](maxadmin.md#sessions)
* [Descriptor Control Blocks](maxadmin.md#dcbs)
* [Working with Filters](maxadmin.md#filters)
* [Working with Monitors](maxadmin.md#monitors)
* [MaxScale Status Commands](maxadmin.md#statuscommands)
* [Administration Commands](maxadmin.md#admincommands)
* [Configuring MaxScale to Accept MaxAdmin Connections](maxadmin.md#connections)
* [Tuning MaxScale](maxadmin.md#tuning)
...
MaxScale can log messages to syslog, to a log file or to both. The approach can be set in the config file, but can also be changed from maxadmin. Syslog logging is identified by _syslog_ and file logging by _maxlog_.
...
There are two ways for rotating the log - _flush log maxscale_ and _flush logs_ - and the result is identical. The two alternatives are due to historical reasons; earlier MaxScale had several different log files.
