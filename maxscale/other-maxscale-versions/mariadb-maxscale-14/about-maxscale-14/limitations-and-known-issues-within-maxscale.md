...
can be influenced with the server priority mechanic described in the[Galera Monitor](../maxscale-14-monitors/maxscale-galera-monitor.md) manual.
...
For more information, read the[ReadWriteSplit](../maxscale-14-routers/readwritesplit.md) router documentation.
