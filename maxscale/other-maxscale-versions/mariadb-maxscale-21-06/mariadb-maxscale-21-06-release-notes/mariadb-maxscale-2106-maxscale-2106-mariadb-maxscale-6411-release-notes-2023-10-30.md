...
This document describes the changes in release 6.4.11, when compared to the\
...
* [MXS-4784](https://jira.mariadb.org/browse/MXS-4784) MaxScale log viewer GUI doesn't automatically scroll to bottom
...
* [MXS-4779](https://jira.mariadb.org/browse/MXS-4779) Maxscale monitor suddenly loses entire cluster status (galeramon)
...
* [MXS-4747](https://jira.mariadb.org/browse/MXS-4747) log\_throttling is hard to modify via MaxCtrl
* [MXS-4738](https://jira.mariadb.org/browse/MXS-4738) The fact that disable\_master\_failback does not work with root\_node\_as\_master is not documented
