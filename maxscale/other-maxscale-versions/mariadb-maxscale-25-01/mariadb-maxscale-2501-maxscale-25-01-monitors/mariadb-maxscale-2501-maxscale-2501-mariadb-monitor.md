# mariadb-maxscale-2501-maxscale-2501-mariadb-monitor

## MaxScale 25.01 MariaDB Monitor

## MariaDB Monitor

* [MariaDB Monitor](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#mariadb-monitor)
  * [Overview](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#overview)
  * [Required Grants](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#required-grants)
    * [Cluster Manipulation Grants](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#cluster-manipulation-grants)
  * [Primary selection](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#primary-selection)
  * [Configuration](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#configuration)
  * [Common Monitor Settings](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#common-monitor-settings)
  * [Settings](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#settings)
    * [assume\_unique\_hostnames](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#assume_unique_hostnames)
    * [private\_address](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#private_address)
    * [master\_conditions](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#master_conditions)
    * [slave\_conditions](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#slave_conditions)
    * [failcount](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#failcount)
    * [enforce\_writable\_master](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#enforce_writable_master)
    * [enforce\_read\_only\_slaves](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#enforce_read_only_slaves)
    * [enforce\_read\_only\_servers](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#enforce_read_only_servers)
    * [maintenance\_on\_low\_disk\_space](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#maintenance_on_low_disk_space)
    * [cooperative\_monitoring\_locks](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#cooperative_monitoring_locks)
    * [script\_max\_replication\_lag](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#script_max_replication_lag)
  * [Cluster manipulation operations](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#cluster-manipulation-operations)
    * [Operation details](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#operation-details)
      * [Failover](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#failover)
      * [Failover-safe](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#failover-safe)
      * [Switchover](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#switchover)
      * [Switchover-force](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#switchover-force)
      * [Rejoin](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#rejoin)
      * [Reset Replication](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#reset-replication)
    * [Manual activation](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#manual-activation)
      * [Queued switchover](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#queued-switchover)
      * [Switchover with key-value arguments](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#switchover-with-key-value-arguments)
    * [Automatic activation](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#automatic-activation)
    * [Limitations and requirements](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#limitations-and-requirements)
    * [External primary support](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#external-primary-support)
    * [Settings for Cluster manipulation operations](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#settings-for-cluster-manipulation-operations)
      * [auto\_failover](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#auto_failover)
      * [auto\_rejoin](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#auto_rejoin)
      * [switchover\_on\_low\_disk\_space](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#switchover_on_low_disk_space)
      * [enforce\_simple\_topology](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#enforce_simple_topology)
      * [replication\_user](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#replication_user)
      * [replication\_password](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#replication_password)
      * [replication\_master\_ssl](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#replication_master_ssl)
      * [replication\_custom\_options](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#replication_custom_options)
      * [failover\_timeout](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#failover_timeout)
      * [switchover\_timeout](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#switchover_timeout)
      * [verify\_master\_failure](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#verify_master_failure)
      * [master\_failure\_timeout](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#master_failure_timeout)
      * [servers\_no\_promotion](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#servers_no_promotion)
      * [promotion\_sql\_file](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#promotion_sql_file)
      * [demotion\_sql\_file](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#demotion_sql_file)
      * [handle\_events](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#handle_events)
  * [Cooperative monitoring](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#cooperative-monitoring)
    * [Releasing locks](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#releasing-locks)
  * [Primary server write test](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#primary-server-write-test)
    * [Settings for Primary server write test](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#settings-for-primary-server-write-test)
      * [write\_test\_interval](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#write_test_interval)
      * [write\_test\_table](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#write_test_table)
      * [write\_test\_fail\_action](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#write_test_fail_action)
  * [Backup operations](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#backup-operations)
    * [Rebuild server](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#rebuild-server)
    * [Create backup](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#create-backup)
    * [Restore from backup](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#restore-from-backup)
    * [Settings for Backup operations](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#settings-for-backup-operations)
      * [ssh\_user](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#ssh_user)
      * [ssh\_keyfile](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#ssh_keyfile)
      * [ssh\_check\_host\_key](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#ssh_check_host_key)
      * [ssh\_timeout](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#ssh_timeout)
      * [ssh\_port](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#ssh_port)
      * [rebuild\_port](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#rebuild_port)
      * [mariabackup\_use\_memory](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#mariabackup_use_memory)
      * [mariabackup\_parallel](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#mariabackup_parallel)
      * [backup\_storage\_address](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#backup_storage_address)
      * [backup\_storage\_path](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#backup_storage_path)
    * [sudoers.d configuration](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#sudoersd-configuration)
  * [ColumnStore commands](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#columnstore-commands)
    * [Get status](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#get-status)
    * [Add or remove node](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#add-or-remove-node)
    * [Start and stop cluster](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#start-and-stop-cluster)
    * [Set read-only or readwrite](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#set-read-only-or-readwrite)
    * [Settings for Columnstore commands](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#settings-for-columnstore-commands)
      * [cs\_admin\_port](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#cs_admin_port)
      * [cs\_admin\_api\_key](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#cs_admin_api_key)
      * [cs\_admin\_base\_path](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#cs_admin_base_path)
  * [Other commands](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#other-commands)
    * [fetch-cmd-result](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#fetch-cmd-result)
    * [cancel-cmd](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#cancel-cmd)
  * [Troubleshooting](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#troubleshooting)
    * [Failover/switchover fails](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#failoverswitchover-fails)
    * [Replica detection shows external primaries](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#replica-detection-shows-external-primaries)
  * [Using the MariaDB Monitor With Binlogrouter](mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md#using-the-mariadb-monitor-with-binlogrouter)
