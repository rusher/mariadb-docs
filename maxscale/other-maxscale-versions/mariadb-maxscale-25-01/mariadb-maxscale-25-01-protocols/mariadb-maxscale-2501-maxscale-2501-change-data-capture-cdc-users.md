...
more details on the format of the *cdcusers* file, read the [CDC Protocol documentation](mariadb-maxscale-2501-maxscale-2501-change-data-capture-cdc-protocol.md).
