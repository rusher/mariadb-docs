...
* [Named Server Filter](mariadb-maxscale-2501-maxscale-2501-named-server-filter.md#named-server-filter)
  * [Overview](mariadb-maxscale-2501-maxscale-2501-named-server-filter.md#overview)
  * [Configuration](mariadb-maxscale-2501-maxscale-2501-named-server-filter.md#configuration)
  * [Settings](mariadb-maxscale-2501-maxscale-2501-named-server-filter.md#settings)
    * [matchXY](mariadb-maxscale-2501-maxscale-2501-named-server-filter.md#matchxy)
    * [options](mariadb-maxscale-2501-maxscale-2501-named-server-filter.md#options)
    * [targetXY](mariadb-maxscale-2501-maxscale-2501-named-server-filter.md#targetxy)
    * [source](mariadb-maxscale-2501-maxscale-2501-named-server-filter.md#source)
    * [user](mariadb-maxscale-2501-maxscale-2501-named-server-filter.md#user)
  * [Additional remarks](mariadb-maxscale-2501-maxscale-2501-named-server-filter.md#additional-remarks)
  * [Examples](mariadb-maxscale-2501-maxscale-2501-named-server-filter.md#examples)
    * [Example 1 - Route queries targeting a specific table to a server](mariadb-maxscale-2501-maxscale-2501-named-server-filter.md#example-1-route-queries-targeting-a-specific-table-to-a-server)
...
also be embedded into SQL-queries, see[Hint-Syntax](../mariadb-maxscale-25-01-reference/mariadb-maxscale-2501-maxscale-2501-hint-syntax.md).
