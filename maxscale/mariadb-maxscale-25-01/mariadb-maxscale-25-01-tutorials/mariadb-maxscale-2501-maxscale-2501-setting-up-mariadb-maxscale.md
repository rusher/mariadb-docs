...
[Building from Source](../mariadb-maxscale-25-01-getting-started/mariadb-maxscale-2501-maxscale-2501-building-mariadb-maxscale-from-source-code.md).
...
[Installation Guide](../mariadb-maxscale-25-01-getting-started/mariadb-maxscale-2501-maxscale-2501-mariadb-maxscale-installation-guide.md).
...
read
[Configuring MariaDB Monitor](mariadb-maxscale-2501-maxscale-2501-configuring-the-mariadb-monitor.md).
For a Galera cluster read
[Configuring Galera Monitor](mariadb-maxscale-2501-maxscale-2501-configuring-the-galera-monitor.md).
...
[Read Write Splitting Tutorial](mariadb-maxscale-2501-maxscale-2501-read-write-splitting-with-mariadb-maxscale.md).
For a simple connection based setup, read the
[Connection Routing Tutorial](mariadb-maxscale-2501-maxscale-2501-connection-routing-with-mariadb-maxscale.md).
...
[readwritesplit module documentation](../mariadb-maxscale-25-01-routers/mariadb-maxscale-2501-maxscale-2501-readwritesplit.md) and
[readconnroute module documentation](../mariadb-maxscale-25-01-routers/mariadb-maxscale-2501-maxscale-2501-readconnroute.md).


For more information about MaxCtrl and how to secure it, see the
[REST-API Tutorial](mariadb-maxscale-2501-maxscale-2501-rest-api-tutorial.md).
