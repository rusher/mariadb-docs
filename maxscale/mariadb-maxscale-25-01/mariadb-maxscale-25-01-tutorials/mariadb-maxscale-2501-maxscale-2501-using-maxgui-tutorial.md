...
1. Active Operations Bar: This bar chart represents the proportion of active
 operations on the server relative to the total number of connections. The
 value displayed is the ratio of `<code>active_operations</code>` to `<code>connections</code>`,
...
[MariaDB-Monitor](../mariadb-maxscale-2501-maxscale-25-01-monitors/mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md) can be viewed by mousing over
...
![](../../.gitbook/assets/mariadb-corporation/MaxScale/25.01.2-docs/Documentation/Tutorials/images/MaxGUI-session-by-workspace.png.png)
...
This table displays the result set from the `<code>PROCESSLIST</code>` table, with options to
filter processes created by the "Workspace".


![](../../.gitbook/assets/mariadb-corporation/MaxScale/25.01.2-docs/Documentation/Tutorials/images/MaxGUI-workspace-processlist.png.png)
...
[mariadbmon](../mariadb-maxscale-2501-maxscale-25-01-monitors/mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md) module in a card-like view.
...
the `<code>DELIMITER</code>` command to change the delimiter.


![](../../.gitbook/assets/mariadb-corporation/MaxScale/25.01.2-docs/Documentation/Tutorials/images/MaxGUI-workspace-query-editor-delimiter-change.png.png)


###### Annotation


1. Change the delimiter to `<code>//</code>`
...
and limitations [here](../mariadb-maxscale-25-01-about/mariadb-maxscale-2501-maxscale-2501-limitations-and-known-issues-within-mariadb-maxscale.md).


#### Connections


![](../../.gitbook/assets/mariadb-corporation/MaxScale/25.01.2-docs/Documentation/Tutorials/images/MaxGUI-workspace-data-migration-set-up-connections.png.png)
...
![](../../.gitbook/assets/mariadb-corporation/MaxScale/25.01.2-docs/Documentation/Tutorials/images/MaxGUI-workspace-data-migration-objects-selection.png.png)
...
![](../../.gitbook/assets/mariadb-corporation/MaxScale/25.01.2-docs/Documentation/Tutorials/images/MaxGUI-workspace-data-migration-migration-script.png.png)
...
![](../../.gitbook/assets/mariadb-corporation/MaxScale/25.01.2-docs/Documentation/Tutorials/images/MaxGUI-workspace-data-migration-migration-report.png.png)
...
![](../../.gitbook/assets/mariadb-corporation/MaxScale/25.01.2-docs/Documentation/Tutorials/images/MaxGUI-workspace-erd.png.png)
...
![](../../.gitbook/assets/mariadb-corporation/MaxScale/25.01.2-docs/Documentation/Tutorials/images/MaxGUI-workspace-erd-fk-options.png.png)
...
![](../../.gitbook/assets/mariadb-corporation/MaxScale/25.01.2-docs/Documentation/Tutorials/images/MaxGUI-workspace-erd-fk-quick-option.png.png)
...
![](../../.gitbook/assets/mariadb-corporation/MaxScale/25.01.2-docs/Documentation/Tutorials/images/MaxGUI-workspace-erd-entity-editor.png.png)
...
![](../../.gitbook/assets/mariadb-corporation/MaxScale/25.01.2-docs/Documentation/Tutorials/images/MaxGUI-workspace-erd-visual-enhancements.png.png)
