...
`<code>ignore_tables_regex=.*</code>`. Starting with MaxScale 25.01, the detection of
...
[the MaxScale core](../mariadb-maxscale-25-01-getting-started/mariadb-maxscale-2501-maxscale-2501-mariadb-maxscale-configuration-guide.md)
in MaxScale 6.0.
