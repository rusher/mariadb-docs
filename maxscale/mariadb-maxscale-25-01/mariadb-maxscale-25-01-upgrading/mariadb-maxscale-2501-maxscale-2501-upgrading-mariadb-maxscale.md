...
# MaxScale 25.01 Upgrading MariaDB MaxScale

# Upgrading MariaDB MaxScale


For more information about what has changed, please refer to the
[ChangeLog](../mariadb-maxscale-2501-maxscale-2501-changelog.md) and to the
...
* [Upgrading MariaDB MaxScale from 24.02 to 25.01](#upgrading-mariadb-maxscale-from-2402-to-2501)
...
[PsReuse](../mariadb-maxscale-25-01-filters/mariadb-maxscale-2501-maxscale-2501-psreuse.md) filter module.
...
[OptimisticTrx](../mariadb-maxscale-25-01-filters/mariadb-maxscale-2501-maxscale-2501-optimistic-transaction-execution-filter.md) filter module.
