...
In versions of MySQL 5.7.6 and later, the `<code>Password</code>` column was replaced by
`<code>authentication_string</code>`. Change `<code>user.password</code>` above with
`<code>user.authentication_string</code>`.
...
To enable TLS/SSL for a listener or a server, you must set the `<code>ssl</code>` parameter
to `<code>required</code>` and provide the three files for `<code>ssl_cert</code>`, `<code>ssl_key</code>` and
...
This enables SSL connections when set to `<code>required</code>`. If enabled, the three
...
the key defined in `<code>ssl_key</code>`.
...
certificate, the `<code>ssl_cert_verify_depth</code>` parameter must not be 0. If no
...
* [ReadConnRoute](../maxscale-21-routers/mariadb-maxscale-21-readconnroute.md)


Read/Write aware statement based router:
* [ReadWriteSplit](../maxscale-21-routers/mariadb-maxscale-21-readwritesplit.md)
...
* [Regular Expression Filter](../maxscale-21-filters/mariadb-maxscale-21-regex-filter.md)
* [Tee Filter](../maxscale-21-filters/mariadb-maxscale-21-tee-filter.md)
* [Top Filter](../maxscale-21-filters/mariadb-maxscale-21-top-filter.md)
* [Database Firewall Filter](../maxscale-21-filters/mariadb-maxscale-21-database-firewall-filter.md)
* [Query Redirection Filter](../maxscale-21-filters/mariadb-maxscale-21-named-server-filter.md)
...
In addition to these parameters, the server specific user credentials, *monuser*
and *monpw*, can also be updated at runtime.
