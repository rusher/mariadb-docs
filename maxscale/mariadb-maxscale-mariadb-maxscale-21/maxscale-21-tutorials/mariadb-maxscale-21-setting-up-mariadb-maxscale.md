...
[Building from Source](../maxscale-21-getting-started/mariadb-maxscale-21-building-mariadb-maxscale-from-source-code.md) document.
...
1. Create the user, substituting the username, password and host on which maxscale
