...
* MariaDB-Monitor allows customization of some Mariabackup settings. See
 [mariabackup_use_memory](maxscale-24-02monitors/mariadb-maxscale-2402-maxscale-2402-mariadb-monitor.md)
 and [mariabackup_parallel](maxscale-24-02monitors/mariadb-maxscale-2402-maxscale-2402-mariadb-monitor.md)
 for more information.
...
* `admin_readwrite_hosts` and `admin_readonly_hosts` added. These settings limit
 ...
 [here](maxscale-24-02getting-started/mariadb-maxscale-2402-maxscale-2402-mariadb-maxscale-configuration-guide.md)
 for more information.
...
* The [causal_reads](maxscale-24-02routers/mariadb-maxscale-2402-maxscale-2402-readwritesplit.md) feature no longer
...
* Additional metadata is sent in the connection handshake. For more information,
 refer to the
 [parameter](maxscale-24-02getting-started/mariadb-maxscale-2402-maxscale-2402-mariadb-maxscale-configuration-guide.md)
 documentation.
...
* Passthrough authentication mode added to MariaDBAuth-module. See
 [authenticator documentation](maxscale-24-02authenticators/mariadb-maxscale-2402-maxscale-2402-mariadbmysql-authenticator.md) for more
 information.
* Added `pam_mode=suid` option to PamAuth module. This option separates the
 ...
 [authenticator documentation](maxscale-24-02authenticators/mariadb-maxscale-2402-maxscale-2402-pam-authenticator.md)
...
* The `maxctrl cluster` commands have been removed. Use the built-in
 [configuration synchronization](maxscale-24-02getting-started/mariadb-maxscale-2402-maxscale-2402-mariadb-maxscale-configuration-guide.md)
...
* The REST-API is now supports ODBC-type connections in the `/sql`
 ...
 [documentation](maxscale-24-02rest-api/mariadb-maxscale-2402-maxscale-2402-sql-resource.md).
...
* MaxGUI Query Editor has changed the type of browser storage from local storage
 ...
 [Using-MaxGUI-Tutorial](maxscale-24-02tutorials/mariadb-maxscale-2402-maxscale-2402-using-maxgui-tutorial.md)
...
[idle_session_pool_time](maxscale-24-02getting-started/mariadb-maxscale-2402-maxscale-2402-mariadb-maxscale-configuration-guide.md)
for more information.
...
* Services can now directly route to other services with the help of the
 [target](maxscale-24-02getting-started/mariadb-maxscale-2402-maxscale-2402-mariadb-maxscale-configuration-guide.md) parameter.
...
* The replication lag of a slave server must now be less than
 [max_slave_replication_lag](maxscale-24-02routers/mariadb-maxscale-2402-maxscale-2402-readwritesplit.md)
...
* MariaDB-Monitor supports cooperative monitoring. See
 [cooperative monitoring](maxscale-24-02monitors/mariadb-maxscale-2402-maxscale-2402-mariadb-monitor.md)
 for more information.
