...
more details on the format of the *cdcusers* file, read the [CDC Protocol documentation](mariadb-maxscale-2402-maxscale-2402-change-data-capture-cdc-protocol.md).
