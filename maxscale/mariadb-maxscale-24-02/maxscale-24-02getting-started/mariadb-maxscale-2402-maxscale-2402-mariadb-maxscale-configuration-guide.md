...
* [Configuration](#configuration)
  ...
  * [Global Settings](#global-settings)
    ...
    * [admin_pam_readwrite_service/admin_pam_readonly_service](#admin_pam_readwrite_serviceadmin_pam_readonly_service)
...
crashes. The default is `<code>true</code>` although usually a core file is not needed,
...
| --- | --- |
| MaxScale Parameter | Server Variable Dependency |
| [connection_keepalive](#connection_keepalive) | 80% of the smallest [wait_timeout]server-system-variables/#wait_timeout) value of the servers used by the service |
...
events coming from the kernel. The default is `<code>auto</code>` which uses as many threads
...
value to `<code>auto</code>`. This way MariaDB MaxScale will detect the number of available
...
have been limited, the use of `<code>auto</code>` may cause MaxScale to use more resources
than what is available. In such a situation `<code>auto</code>` should not be used, but instead
an explicit number that corresponds to the amount of CPU resources available in
the container. As a rule of thumb, an appropriate value for `<code>threads</code>` is the
*vCPU* of the container rounded up to the nearest integer. For instance, if
the *vCPU* of the container is `<code>0.5</code>` then `<code>1</code>` is an appropriate value for
`<code>threads</code>`, if the *vCPU* is `<code>2.3</code>` then `<code>3</code>` is.
...
* Mandatory: No
* Dynamic: No
* Default: `<code>/var/run/maxscale</code>`
...
### `<code>admin_pam_readwrite_service/admin_pam_readonly_service</code>`
...
This setting defines the *user* the service uses to fetch user account
information from backends. A *password* is specified using [password](#password).
...
This settings defines the *password* the service uses to fetch user account
information from backends. The *password* may be either a plain text password or
an [encrypted password](#encrypting-passwords). The *user* is specified
using [user](#user).
...
* Mandatory: No
* Dynamic: Yes
* Default: `<code>28800s</code>` (>= MaxScale 24.02.5, 25.01.2), `<code>0s</code>` (<= MaxScale 24.02.4, 25.01.1)
...
The default value of `<code>wait_timeout</code>` changed from `<code>0s</code>` to `<code>28800s</code>` in MaxScale
...
session state modifying commands (e.g `<code>SET NAMES</code>`) that are used by a
...
`<code>max_sescmd_history</code>` limit. In practice this means that all binary protocol
...
`<code>max_sescmd_history</code>` apply to other text protocol commands e.g. `<code>SET NAMES</code>`.
...
a lot of `<code>PREPARE stmt FROM <sql></code>` commands, it is recommended that the value of
`<code>max_sescmd_history</code>` is increased accordingly.


In older versions of MaxScale, binary protocol prepared statements were limited
by `<code>max_sescmd_history</code>` and were also pruned by `<code>prune_sescmd_history</code>` but this
...
recommended value of `<code>max_sescmd_history</code>` is the number of state modifying
...
forms. In these cases, if more than `<code>max_sescmd_history</code>` packets are queued, the
...
primary. Read the
[readwritesplit documentation on server ranks](../maxscale-24-02routers/mariadb-maxscale-2402-maxscale-2402-readwritesplit.md)
...
[Server Priorities](../maxscale-24-02monitors/mariadb-maxscale-2402-maxscale-2402-galera-monitor.md)
...
`<code>protocol=nosqlprotocol</code>`. For more details on how to configure the NoSQL
...
See [Change Data Capture Protocol](../maxscale-24-02protocols/mariadb-maxscale-2402-maxscale-2402-change-data-capture-cdc-protocol.md) for more information.
...
with `<code>REQUIRE SSL</code>` or `<code>REQUIRE X509</code>`.
...
* [ReadConnRoute](../maxscale-24-02routers/mariadb-maxscale-2402-maxscale-2402-readconnroute.md)


Read/Write aware statement based router:
* [ReadWriteSplit](../maxscale-24-02routers/mariadb-maxscale-2402-maxscale-2402-readwritesplit.md)
...
![](../../.gitbook/assets/mariadb-corporation/MaxScale/24.02.5/Documentation/Getting-Started/images/filter_example.png.png)
...
* [Regular Expression Filter](../maxscale-24-02filters/mariadb-maxscale-2402-maxscale-2402-regex-filter.md)
* [Tee Filter](../maxscale-24-02filters/mariadb-maxscale-2402-maxscale-2402-tee-filter.md)
* [Top Filter](../maxscale-24-02filters/mariadb-maxscale-2402-maxscale-2402-top-filter.md)
* [Query Redirection Filter](../maxscale-24-02filters/mariadb-maxscale-2402-maxscale-2402-named-server-filter.md)
...
* MaxCtrl
* [create](../maxscale-24-02reference/mariadb-maxscale-2402-maxscale-2402-maxctrl.md)
* [destroy](../maxscale-24-02reference/mariadb-maxscale-2402-maxscale-2402-maxctrl.md)
* [add](../maxscale-24-02reference/mariadb-maxscale-2402-maxscale-2402-maxctrl.md)
* [remove](../maxscale-24-02reference/mariadb-maxscale-2402-maxscale-2402-maxctrl.md)
...
The current limitations of MaxScale are listed in the [Limitations](../maxscale-24-02about/mariadb-maxscale-2402-maxscale-2402-limitations-and-known-issues-within-mariadb-maxscale.md) document.
