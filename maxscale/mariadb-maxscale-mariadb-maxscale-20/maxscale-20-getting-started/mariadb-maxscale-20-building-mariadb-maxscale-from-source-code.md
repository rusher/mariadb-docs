...
Other useful targets for Make are `<code>documentation</code>`, which generates the Doxygen documentation, and `<code>uninstall</code>` which uninstall MariaDB MaxScale binaries after an install.
