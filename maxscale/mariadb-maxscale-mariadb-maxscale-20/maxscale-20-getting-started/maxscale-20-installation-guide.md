...
Alternatively you may download the MariaDB MaxScale source and build your own binaries. To do this, refer to the separate document [Building MariaDB MaxScale from Source Code](../../mariadb-maxscale-21-06/README.md)
...
For more details, refer to the [Configuration Guide](../../mariadb-maxscale-21-06/README.md).
