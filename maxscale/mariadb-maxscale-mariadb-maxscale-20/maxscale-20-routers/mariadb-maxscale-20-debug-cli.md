...
It should be noted that both `<code>user</code>` and `<code>developer</code>` instances of debugcli may be defined within the same instance of MariaDB MaxScale, however they must be defined as two distinct services, each with a distinct listener.
