...
any explicitly created accounts, use the command *show users*.
...
To enable MaxAdmin usage for a particular Linux account, use the command *enable account*.
...
To disable MaxAdmin usage for a particular Linux account, use the command *disable account*.
...
use the command *add user*. This command is passed a user name and a password.
