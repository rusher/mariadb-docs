...
The [Avrorouter Tutorial](../../mariadb-maxscale-21-06/README.md) contains
information on how to get started with the binlog-to-Avro translation.


The [Avrorouter](../../mariadb-maxscale-21-06/README.md) documentation has more information
on the details of this conversion process and how to configure the module.


The [CDC Protocol](../../mariadb-maxscale-21-06/README.md) documentation contains the details of
the new protocol.
...
*only when run on the same host*, and authorization is based upon the UNIX
...
[Configuration Guide](../maxscale-20-getting-started/mariadb-maxscale-20-mariadb-maxscale-configuration-usage-scenarios.md#query_classifier).
