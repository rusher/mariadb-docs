...
For more information about what has changed, please refer to the[ChangeLog](../../maxscale-versions/mariadb-maxscale-25-01/mariadb-maxscale-2501-maxscale-2501-changelog.md) and to the release notes.
...
The `reuse_prepared_statements` parameter has been replaced with the use of the [PsReuse](../../maxscale-versions/mariadb-maxscale-25-01/mariadb-maxscale-25-01-filters/mariadb-maxscale-2501-maxscale-2501-psreuse.md) filter module.
...
The `optimistic_trx` parameter has been replaced with the use of the[OptimisticTrx](../../maxscale-versions/mariadb-maxscale-25-01/mariadb-maxscale-25-01-filters/mariadb-maxscale-2501-maxscale-2501-optimistic-transaction-execution-filter.md) filter module.
...
and later. See [Cluster Manipulation Grants](../../maxscale-versions/mariadb-maxscale-25-01/mariadb-maxscale-2501-maxscale-25-01-monitors/mariadb-maxscale-2501-maxscale-2501-mariadb-monitor.md) for more information.
...
have been made into generic service parameters that are shared between all routers that support it.
...
of required grants, refer to the [protocol documentation](../../maxscale-versions/mariadb-maxscale-25-01/mariadb-maxscale-25-01-protocols/).
...
For more information about how to do this, please read the installation guide:[MariaDB MaxScale Installation Guide](../../maxscale-versions/mariadb-maxscale-25-01/mariadb-maxscale-25-01-getting-started/mariadb-maxscale-2501-maxscale-2501-mariadb-maxscale-installation-guide.md)
