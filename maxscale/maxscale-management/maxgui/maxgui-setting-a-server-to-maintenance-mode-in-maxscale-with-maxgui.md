...
MaxGUI is a graphical utility that can perform administrative tasks using MaxScale's [MaxScale's REST API](../../reference/maxscale-rest-api/). It is available starting in [MaxScale 2.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/maxscale/2.5). It can be used to set a server to maintenance mode.
