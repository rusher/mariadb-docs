...
MaxGUI is a graphical utility that can perform administrative tasks using MaxScale's [MaxScale's REST API](broken-reference). It is available starting in [MaxScale 2.5](broken-reference). It can be used to set a server to maintenance mode.
