...
MaxGUI is a graphical utility that can perform administrative tasks using MaxScale's [MaxScale's REST API](../../administrative-tools-for-mariadb-maxscale-maxctrl/operating-maxscale-with-maxctrl/). It is available starting in [MaxScale 2.5](broken-reference). It can be used to set a server to maintenance mode.
