---
description: >-
  Review the current constraints of MariaDB MaxScale. This document lists known
  issues regarding transaction parsing, protocol support, and specific module
  limitations.
---
...
The default master selection is based only on MIN(wsrep\_local\_index). This can be influenced with the server priority mechanic described in the [Galera Monitor](../reference/maxscale-monitors/galera-monitor.md) manual.
