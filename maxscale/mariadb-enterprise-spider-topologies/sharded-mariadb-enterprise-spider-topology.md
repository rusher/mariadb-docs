...
* Supports an ODBC foreign data wrapper in [MariaDB Enterprise Server 10.5](/en/mariadb-server-releases-mariadb-enterprise-server-10-5/) and later. The ODBC foreign data wrapper was backported to MariaDB Enterprise Server in a previous version. The ODBC foreign data wrapper is beta maturity. The maturity can be confirmed by querying the [information_schema.SPIDER_WRAPPER_PROTOCOLS](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/storage-engines/spider/information-schema-spider_wrapper_protocols-table) table.
...
![spider-sharded](../.gitbook/assets/sharded-mariadb-enterprise-spider-topology/+image/spider-sharded.png "spider-sharded")
