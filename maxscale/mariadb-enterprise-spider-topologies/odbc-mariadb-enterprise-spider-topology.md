...
* Supports an ODBC foreign data wrapper in [MariaDB Enterprise Server 10.5](/en/mariadb-server-releases-mariadb-enterprise-server-10-5/) and later. The ODBC foreign data wrapper is beta maturity. The maturity can be confirmed by querying the [information_schema.SPIDER_WRAPPER_PROTOCOLS](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/storage-engines/spider/information-schema-spider_wrapper_protocols-table) table.
...
![spider-federated-odbc](../.gitbook/assets/odbc-mariadb-enterprise-spider-topology/+image/spider-federated-odbc.png "spider-federated-odbc")
...
The ODBC foreign data wrapper is beta maturity. The maturity can be confirmed by querying the [information_schema.SPIDER_WRAPPER_PROTOCOLS](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/storage-engines/spider/information-schema-spider_wrapper_protocols-table) table.
