...
What this means is that in MaxScale 2.1 the following *readwritesplit*
configration.
...
Please see the
[Configuration Guide](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#configuration)
for details.
...
[avrorouter](../maxscale-22-tutorials/mariadb-maxscale-22-avrorouter-tutorial.md), [cache](../maxscale-22-filters/mariadb-maxscale-22-cache.md) and
[masking](../maxscale-22-filters/mariadb-maxscale-22-masking.md) modules implement module commands.
...
[Monitor Common Documentation](../maxscale-22-monitors/mariadb-maxscale-22-common-monitor-parameters.md) for more details.
...
[MySQL Monitor Documentation](https://mariadb.com/kb/en/mariadb-maxscale-22-mysql-monitor/).
...
MaxScale 2.1 comes with a new filter module, *ccrfilter*, which allows critical
...
A new filter module, *cache*, allows MaxScale to cache the results of SELECT
...
The new *masking* filter can mask sensitive information from result sets. This
...
The newly added *maxrows* filter can restrict the maximum size of a returned
