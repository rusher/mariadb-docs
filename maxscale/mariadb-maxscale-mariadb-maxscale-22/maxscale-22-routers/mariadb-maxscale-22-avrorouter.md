...
This router is intended to be used in tandem with the [Binlog Server](../../mariadb-maxscale-21-06/README.md).
...
[Regular Expressions](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#regular-expressions)
...
combined with the `<code>match</code>` parameter to implement table event filtering.
...
in Binlog Server: currently, if used with Avrorouter, the option `<code>mariadb10_master_gtid</code>`
...
suffix. Refer to the
[Configuration Guide](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md) for more
...
[Building MaxScale from Source Code](../maxscale-22-getting-started/mariadb-maxscale-22-building-mariadb-maxscale-from-source-code.md) document.
