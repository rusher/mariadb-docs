...
[Avrorouter](mariadb-maxscale-22-avrorouter-tutorial.md), how to set it up and how it interacts
...
Documentation](mariadb-maxscale-22-avrorouter-tutorial.md).
...
* Dump the database to a slave, configure it to replicate from the master and
 ...
 extra steps)
* Use the [cdc_schema Go utility](mariadb-maxscale-22-avrorouter-tutorial.md#avro-schema-generator)
