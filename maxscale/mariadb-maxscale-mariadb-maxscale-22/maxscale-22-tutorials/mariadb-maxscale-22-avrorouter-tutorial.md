...
[Avrorouter](../maxscale-22-routers/mariadb-maxscale-22-avrorouter.md), how to set it up and how it interacts
...
* Dump the database to a slave, configure it to replicate from the master and
 ...
 extra steps)
* Use the [cdc_schema Go utility](../maxscale-22-routers/mariadb-maxscale-22-avrorouter.md#avro-schema-generator)
...
[Binlogrouter](../../mariadb-maxscale-21-06/README.md) documentation.
