...
[Configuration Guide](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#admin_ssl_key) for more
...
example the resource `<code>/service</code>` will always return the `<code>Accept: GET, PATCH, PUT</code>`
header.
