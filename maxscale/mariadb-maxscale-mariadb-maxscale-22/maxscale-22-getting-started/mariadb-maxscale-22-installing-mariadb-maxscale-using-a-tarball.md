...
identifies the operating system, e.g. `<code>maxscale-2.0.1.centos.7.tar.gz</code>`.
...
Please refer to [Configuration Guide](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md) for details.
