...
This document describes the changes in release 6.4.8, when compared to the\
...
* [MXS-4662](https://jira.mariadb.org/browse/MXS-4662) Galeramon use\_priority example is incorrect
