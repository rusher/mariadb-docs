...
* [MXS-3775](https://jira.mariadb.org/browse/MXS-3775) Hang in RoutingWorker::execute\_concurrently
...
* [MXS-3767](https://jira.mariadb.org/browse/MXS-3767) connector\_plugindir does not pick up the default location.
...
* [MXS-3754](https://jira.mariadb.org/browse/MXS-3754) maxscale-6.1.1-1.rhel.8.x86\_64 crashes and coredumps on first startup after upgrade maxscale-2.5.15-1.rhel.8.x86\_64
* [MXS-3750](https://jira.mariadb.org/browse/MXS-3750) 6.1.1 CentOS7 x86\_64 RPMs fail on older CPUs without avx2 extension
* [MXS-3704](https://jira.mariadb.org/browse/MXS-3704) MaxScale always advertises the SESSION\_TRACK capability even with servers that don't support it (XPand)
