...
* [MXS-4552](https://jira.mariadb.org/browse/MXS-4552) "Unknown prepared statement handler" error when connection\_keepalive is disabled on a readconnroute service
...
* [MXS-4499](https://jira.mariadb.org/browse/MXS-4499) config\_sync\_cluster always uses the mysql database
