# MaxScale 23.08 Using MaxGUI Tutorial

## Using MaxGUI Tutorial

## Using MaxGUI Tutorial

* [Using MaxGUI Tutorial](mariadb-maxscale-2308-using-maxgui-tutorial.md#using-maxgui-tutorial)
* [Introduction](mariadb-maxscale-2308-using-maxgui-tutorial.md#introduction)
* [Dashboard](mariadb-maxscale-2308-using-maxgui-tutorial.md#dashboard)
  * [Annotation](mariadb-maxscale-2308-using-maxgui-tutorial.md#annotation)
  * [Create a new MaxScale object](mariadb-maxscale-2308-using-maxgui-tutorial.md#create-a-new-maxscale-object)
  * [View Replication Status](mariadb-maxscale-2308-using-maxgui-tutorial.md#view-replication-status)
  * [How to kill a session](mariadb-maxscale-2308-using-maxgui-tutorial.md#how-to-kill-a-session)
    * [Annotation](mariadb-maxscale-2308-using-maxgui-tutorial.md#annotation_1)
* [Detail](mariadb-maxscale-2308-using-maxgui-tutorial.md#detail)
  * [Annotation](mariadb-maxscale-2308-using-maxgui-tutorial.md#annotation_2)
* [Visualization](mariadb-maxscale-2308-using-maxgui-tutorial.md#visualization)
  * [Configuration](mariadb-maxscale-2308-using-maxgui-tutorial.md#configuration)
    * [Annotation](mariadb-maxscale-2308-using-maxgui-tutorial.md#annotation_3)
  * [Clusters](mariadb-maxscale-2308-using-maxgui-tutorial.md#clusters)
    * [Annotation](mariadb-maxscale-2308-using-maxgui-tutorial.md#annotation_4)
* [Settings](mariadb-maxscale-2308-using-maxgui-tutorial.md#settings)
  * [Annotation](mariadb-maxscale-2308-using-maxgui-tutorial.md#annotation_5)
* [Logs Archive](mariadb-maxscale-2308-using-maxgui-tutorial.md#logs-archive)
  * [Annotation](mariadb-maxscale-2308-using-maxgui-tutorial.md#annotation_6)
* [Workspace](mariadb-maxscale-2308-using-maxgui-tutorial.md#workspace)
  * [Run Queries](mariadb-maxscale-2308-using-maxgui-tutorial.md#run-queries)
    * [Query Editor worksheet](mariadb-maxscale-2308-using-maxgui-tutorial.md#query-editor-worksheet)
      * [Create a new connection](mariadb-maxscale-2308-using-maxgui-tutorial.md#create-a-new-connection)
      * [Schemas objects sidebar](mariadb-maxscale-2308-using-maxgui-tutorial.md#schemas-objects-sidebar)
        * [Set the current database](mariadb-maxscale-2308-using-maxgui-tutorial.md#set-the-current-database)
        * [Preview table data of the top 1000 rows](mariadb-maxscale-2308-using-maxgui-tutorial.md#preview-table-data-of-the-top-1000-rows)
        * [Describe table](mariadb-maxscale-2308-using-maxgui-tutorial.md#describe-table)
        * [Alter/Drop/Truncate table](mariadb-maxscale-2308-using-maxgui-tutorial.md#alterdroptruncate-table)
        * [Quickly insert an object into the editor](mariadb-maxscale-2308-using-maxgui-tutorial.md#quickly-insert-an-object-into-the-editor)
        * [Show object creation statement and insights info](mariadb-maxscale-2308-using-maxgui-tutorial.md#show-object-creation-statement-and-insights-info)
      * [Editor](mariadb-maxscale-2308-using-maxgui-tutorial.md#editor)
      * [Re-execute old queries](mariadb-maxscale-2308-using-maxgui-tutorial.md#re-execute-old-queries)
      * [Create query snippet](mariadb-maxscale-2308-using-maxgui-tutorial.md#create-query-snippet)
      * [Generate an ERD](mariadb-maxscale-2308-using-maxgui-tutorial.md#generate-an-erd)
  * [Data Migration](mariadb-maxscale-2308-using-maxgui-tutorial.md#data-migration)
    * [Data Migration worksheet](mariadb-maxscale-2308-using-maxgui-tutorial.md#data-migration-worksheet)
      * [Connections](mariadb-maxscale-2308-using-maxgui-tutorial.md#connections)
      * [Objects Selection](mariadb-maxscale-2308-using-maxgui-tutorial.md#objects-selection)
      * [Migration](mariadb-maxscale-2308-using-maxgui-tutorial.md#migration)
      * [Migration report](mariadb-maxscale-2308-using-maxgui-tutorial.md#migration-report)
  * [Create an ERD](mariadb-maxscale-2308-using-maxgui-tutorial.md#create-an-erd)
    * [ERD worksheet](mariadb-maxscale-2308-using-maxgui-tutorial.md#erd-worksheet)
      * [Generate an ERD from the existing databases](mariadb-maxscale-2308-using-maxgui-tutorial.md#generate-an-erd-from-the-existing-databases)
      * [Create a new ERD](mariadb-maxscale-2308-using-maxgui-tutorial.md#create-a-new-erd)
      * [Entity options](mariadb-maxscale-2308-using-maxgui-tutorial.md#entity-options)
      * [Foreign keys quick common options](mariadb-maxscale-2308-using-maxgui-tutorial.md#foreign-keys-quick-common-options)
      * [Viewing foreign key constraint SQL](mariadb-maxscale-2308-using-maxgui-tutorial.md#viewing-foreign-key-constraint-sql)
      * [Quickly draw a foreign key link](mariadb-maxscale-2308-using-maxgui-tutorial.md#quickly-draw-a-foreign-key-link)
      * [Entity editor](mariadb-maxscale-2308-using-maxgui-tutorial.md#entity-editor)
      * [Export options](mariadb-maxscale-2308-using-maxgui-tutorial.md#export-options)
      * [Applying the script](mariadb-maxscale-2308-using-maxgui-tutorial.md#applying-the-script)
      * [Visual Enhancement options](mariadb-maxscale-2308-using-maxgui-tutorial.md#visual-enhancement-options)
