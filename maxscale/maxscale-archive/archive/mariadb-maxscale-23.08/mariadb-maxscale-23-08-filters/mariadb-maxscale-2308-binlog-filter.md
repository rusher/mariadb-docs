...
* [Binlog Filter](mariadb-maxscale-2308-binlog-filter.md#binlog-filter)
  * [Overview](mariadb-maxscale-2308-binlog-filter.md#overview)
  * [Configuration](mariadb-maxscale-2308-binlog-filter.md#configuration)
    * [match](mariadb-maxscale-2308-binlog-filter.md#match)
    * [exclude](mariadb-maxscale-2308-binlog-filter.md#exclude)
    * [rewrite\_src](mariadb-maxscale-2308-binlog-filter.md#rewrite_src)
    * [rewrite\_dest](mariadb-maxscale-2308-binlog-filter.md#rewrite_dest)
  * [Example Configuration](mariadb-maxscale-2308-binlog-filter.md#example-configuration)
...
For more information about the binlogrouter and how to use it, refer to the[binlogrouter documentation](../mariadb-maxscale-23-08-routers/mariadb-maxscale-2308-binlogrouter.md).
