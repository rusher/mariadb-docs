...
* [Top Filter](mariadb-maxscale-2308-top-filter.md#top-filter)
  * [Overview](mariadb-maxscale-2308-top-filter.md#overview)
  * [Configuration](mariadb-maxscale-2308-top-filter.md#configuration)
    * [Filter Parameters](mariadb-maxscale-2308-top-filter.md#filter-parameters)
      * [filebase](mariadb-maxscale-2308-top-filter.md#filebase)
      * [count](mariadb-maxscale-2308-top-filter.md#count)
      * [match](mariadb-maxscale-2308-top-filter.md#match)
      * [exclude](mariadb-maxscale-2308-top-filter.md#exclude)
      * [options](mariadb-maxscale-2308-top-filter.md#options)
      * [source](mariadb-maxscale-2308-top-filter.md#source)
      * [user](mariadb-maxscale-2308-top-filter.md#user)
  * [Examples](mariadb-maxscale-2308-top-filter.md#examples)
    * [Example 1 - Heavily Contended Table](mariadb-maxscale-2308-top-filter.md#example-1-heavily-contended-table)
    * [Example 2 - One Application Server is Slow](mariadb-maxscale-2308-top-filter.md#example-2-one-application-server-is-slow)
  * [Output Report](mariadb-maxscale-2308-top-filter.md#output-report)
...
[Limits](../../../../../en/maxscale-2308-getting-started-mariadb-maxscale-configuration-guide/#standard-regular-expression-settings-for-filters)\
