...
To do this, refer to the separate document[Building MariaDB MaxScale from Source Code](mariadb-maxscale-2308-building-mariadb-maxscale-from-source-code.md)
