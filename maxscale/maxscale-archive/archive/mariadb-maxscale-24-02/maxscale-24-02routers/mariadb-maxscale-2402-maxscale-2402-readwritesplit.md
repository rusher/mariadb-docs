...
* [Readwritesplit](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#readwritesplit)
  * [Overview](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#overview)
  * [Interaction with servers in Maintenance and Draining state](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#interaction-with-servers-in-maintenance-and-draining-state)
  * [Configuration](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#configuration)
  * [Parameters](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#parameters)
    * [max\_slave\_connections](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#max_slave_connections)
      * [Behavior of max\_slave\_connections=0](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#behavior-of-max_slave_connections0)
    * [slave\_connections](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#slave_connections)
    * [max\_replication\_lag](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#max_replication_lag)
    * [use\_sql\_variables\_in](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#use_sql_variables_in)
    * [master\_reconnection](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#master_reconnection)
    * [slave\_selection\_criteria](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#slave_selection_criteria)
    * [master\_accept\_reads](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#master_accept_reads)
    * [strict\_multi\_stmt](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#strict_multi_stmt)
    * [strict\_sp\_calls](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#strict_sp_calls)
    * [strict\_tmp\_tables](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#strict_tmp_tables)
    * [master\_failure\_mode](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#master_failure_mode)
    * [retry\_failed\_reads](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#retry_failed_reads)
    * [delayed\_retry](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#delayed_retry)
    * [delayed\_retry\_timeout](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#delayed_retry_timeout)
    * [transaction\_replay](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#transaction_replay)
    * [transaction\_replay\_max\_size](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#transaction_replay_max_size)
    * [transaction\_replay\_attempts](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#transaction_replay_attempts)
    * [transaction\_replay\_timeout](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#transaction_replay_timeout)
    * [transaction\_replay\_retry\_on\_deadlock](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#transaction_replay_retry_on_deadlock)
    * [transaction\_replay\_safe\_commit](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#transaction_replay_safe_commit)
    * [transaction\_replay\_retry\_on\_mismatch](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#transaction_replay_retry_on_mismatch)
    * [transaction\_replay\_checksum](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#transaction_replay_checksum)
    * [optimistic\_trx](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#optimistic_trx)
    * [causal\_reads](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#causal_reads)
      * [Implementation of causal\_reads](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#implementation-of-causal_reads)
        * [Normal SQL](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#normal-sql)
        * [Prepared Statements](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#prepared-statements)
      * [Limitations of Causal Reads](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#limitations-of-causal-reads)
    * [causal\_reads\_timeout](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#causal_reads_timeout)
    * [lazy\_connect](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#lazy_connect)
    * [reuse\_prepared\_statements](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#reuse_prepared_statements)
  * [Router Diagnostics](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#router-diagnostics)
  * [Server Ranks](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#server-ranks)
  * [Routing hints](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#routing-hints)
    * [Known Limitations of Routing Hints](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#known-limitations-of-routing-hints)
  * [Module Commands](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#module-commands)
    * [reset-gtid](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#reset-gtid)
  * [Examples](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#examples)
  * [Readwritesplit routing decisions](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#readwritesplit-routing-decisions)
    * [Routing to Primary](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#routing-to-primary)
      * [Transaction Isolation Level Tracking](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#transaction-isolation-level-tracking)
    * [Routing to Replicas](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#routing-to-replicas)
    * [Routing to every session backend](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#routing-to-every-session-backend)
    * [Routing to previous target](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#routing-to-previous-target)
  * [Limitations](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#limitations)
    * [Prepared Statement Limitations](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#prepared-statement-limitations)
    * [Transaction Replay Limitations](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#transaction-replay-limitations)
      * [Limitations in Session State Modifications](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#limitations-in-session-state-modifications)
      * [Limitations in Service-to-Service Routing](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#limitations-in-service-to-service-routing)
      * [Limitations in multi-statement handling](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#limitations-in-multi-statement-handling)
      * [Limitations in client session handling](mariadb-maxscale-2402-maxscale-2402-readwritesplit.md#limitations-in-client-session-handling)
