...
* [WCAR: Workload Capture and Replay](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#wcar-workload-capture-and-replay)
  ...
  * [Prerequisites](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#prerequisites)
* [Capture](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#capture)
  * [Configuration](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#configuration)
  * [Example configuration](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#example-configuration)
  * [Capturing Traffic](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#capturing-traffic)
  * [Stopping the Capture](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#stopping-the-capture)
* [WCAR Commands](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#wcar-commands)
  * [start \[options\]](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#start-filter-options)
  * [stop](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#stop-filter)
* [Replay](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#replay)
  * [Installation](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#installation)
  * [Preparing the Replay MariaDB Database](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#preparing-the-replay-mariadb-database)
    * [Full Restore](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#full-restore)
    * [Restore for read-only Replay](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#restore-for-read-only-replay)
  * [Replaying the Capture](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#replaying-the-capture)
* [Visualizing](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#visualizing)
* [WCAR Parameters](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#wcar-parameters)
  * [capture\_dir](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#capture_dir)
  * [start\_capture](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#start_capture)
  * [capture\_duration](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#capture_duration)
  * [capture\_size](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#capture_size)
* [maxplayer command line options](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#maxplayer-command-line-options)
* [Limitations](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#limitations)
...
* **duration** Limit capture to this duration. See also configuration file value ['capture\_duration'](mariadb-maxscale-2402-maxscale-2402-wcar-workload-capture-and-replay.md#capture_duration).
* **size** Limit capture to approximately this many bytes in the file system. See also configuration file value ['capture\_size'](https://github.com/mariadb-corporation/docs-server/blob/test/maxscale/mariadb-maxscale-24-02/maxscale-24-02filters/capture_size/README.md).
