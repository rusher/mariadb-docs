...
* [MXS-4122](https://jira.mariadb.org/browse/MXS-4122) Fast Global causal\_reads
...
* [MXS-4325](https://jira.mariadb.org/browse/MXS-4325) Listeners do not accept ssl\_ca
...
* [MXS-4295](https://jira.mariadb.org/browse/MXS-4295) Switchover will wait even if slave server are lagging more than switchover\_timeout
* [MXS-4293](https://jira.mariadb.org/browse/MXS-4293) Memory leak with causal\_reads=universal
* [MXS-4292](https://jira.mariadb.org/browse/MXS-4292) Read-only transaction are not synchronized by causal\_reads=universal
...
* [MXS-4280](https://jira.mariadb.org/browse/MXS-4280) qc\_sqlite does not properly handle a LIMIT clause
...
* [MXS-4174](https://jira.mariadb.org/browse/MXS-4174) expire\_log\_duration and expire\_log\_minimum\_files not covered by tests
