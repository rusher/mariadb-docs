# MariaDB MaxScale 22.08.7 Release Notes

## MariaDB MaxScale 22.08.7 Release Notes -- 2023-08-01

## MariaDB MaxScale 22.08.7 Release Notes -- 2023-08-01

Release 22.08.7 is a GA release.

This document describes the changes in release 22.08.7, when compared to the\
...
* [MXS-4666](https://jira.mariadb.org/browse/MXS-4666) causal\_reads=local is serialized as causal\_reads=true
...
* [MXS-4656](https://jira.mariadb.org/browse/MXS-4656) Setting session\_track\_trx\_state=true leads to OOM kiled.
...
* [MXS-4634](https://jira.mariadb.org/browse/MXS-4634) readconnroute documentation page contains a typo "max\_slave\_replication\_lag"
...
* [MXS-4627](https://jira.mariadb.org/browse/MXS-4627) Rebalancing is unsafe to use with readwritesplit
