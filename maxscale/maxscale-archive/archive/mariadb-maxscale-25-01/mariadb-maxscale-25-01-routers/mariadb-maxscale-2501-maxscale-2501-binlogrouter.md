...
* [expiration\_mode](mariadb-maxscale-2501-maxscale-2501-binlogrouter.md#expiration_mode) Select purge or archive.
* [datadir](mariadb-maxscale-2501-maxscale-2501-binlogrouter.md#datadir) Directory where binlog files are stored (the default is usually fine).
* [archivedir](mariadb-maxscale-2501-maxscale-2501-binlogrouter.md#archivedir) Directory to which files are archived. This directory must exist when MaxScale is started.
