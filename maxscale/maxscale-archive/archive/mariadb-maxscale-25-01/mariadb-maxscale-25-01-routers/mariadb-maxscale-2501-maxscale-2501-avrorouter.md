...
For information about common service parameters, refer to the [Configuration Guide](../mariadb-maxscale-25-01-getting-started/mariadb-maxscale-2501-maxscale-2501-mariadb-maxscale-configuration-guide.md).
...
See [match](mariadb-maxscale-2501-maxscale-2501-avrorouter.md#match).
