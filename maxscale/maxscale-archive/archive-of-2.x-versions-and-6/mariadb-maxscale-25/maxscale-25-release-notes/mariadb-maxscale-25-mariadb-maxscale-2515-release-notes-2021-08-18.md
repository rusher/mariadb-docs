...
* [MXS-3694](https://jira.mariadb.org/browse/MXS-3694) MXS - crash when cache is used with invalidate and hard\_ttl
...
* [MXS-3508](https://jira.mariadb.org/browse/MXS-3508) causal\_reads=global results in missing data reads
* [MXS-3478](https://jira.mariadb.org/browse/MXS-3478) admin\_host missed on the static configuration parameters list
