...
To do this, refer to the separate document[Building MariaDB MaxScale from Source Code](../../mariadb-maxscale-24/maxscale-24-getting-started/mariadb-maxscale-24-building-mariadb-maxscale-from-source-code.md)
