...
* [Named Server Filter](mariadb-maxscale-25-named-server-filter.md#named-server-filter)
  * [Overview](mariadb-maxscale-25-named-server-filter.md#overview)
  * [Configuration](mariadb-maxscale-25-named-server-filter.md#configuration)
  * [Filter Parameters](mariadb-maxscale-25-named-server-filter.md#filter-parameters)
    * [matchXY, options](mariadb-maxscale-25-named-server-filter.md#matchxy-options)
    * [targetXY](mariadb-maxscale-25-named-server-filter.md#targetxy)
    * [source](mariadb-maxscale-25-named-server-filter.md#source)
    * [user](mariadb-maxscale-25-named-server-filter.md#user)
  * [Additional remarks](mariadb-maxscale-25-named-server-filter.md#additional-remarks)
  * [Examples](mariadb-maxscale-25-named-server-filter.md#examples)
    * [Example 1 - Route queries targeting a specific table to a server](mariadb-maxscale-25-named-server-filter.md#example-1-route-queries-targeting-a-specific-table-to-a-server)
...
also be embedded into SQL-queries, see[Hint-Syntax](../maxscale-25-reference/mariadb-maxscale-25-hint-syntax.md).
...
_matchXY_ defines a[PCRE2 regular expression](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#regular-expressions)\
...
attaches a routing hint defined by the _target_-setting to the query. Th&#x65;_&#x6F;ptions_-parameter affects how the patterns are compiled as[usual](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md#standard-regular-expression-settings-for-filters).
