...
For more details about building MaxScale from source, please refer to the[Building MaxScale from Source Code](../../mariadb-maxscale-24/maxscale-24-getting-started/mariadb-maxscale-24-building-mariadb-maxscale-from-source-code.md)\
document.
