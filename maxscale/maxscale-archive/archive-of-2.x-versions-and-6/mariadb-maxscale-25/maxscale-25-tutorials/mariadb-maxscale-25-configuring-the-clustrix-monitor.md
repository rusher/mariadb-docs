...
created, whose name is `@@<Monitor-Name>:node-<id>, where _Monitor-Name_ is the name of the monitor, in this example`Clustrix\` and _id_ is the node id\
...
For additional details, please consult the monitor[documentation](../maxscale-25-monitors/mariadb-maxscale-25-clustrix-monitor.md).
