...
This tutorial is a short introduction to the[Avrorouter](../maxscale-25-routers/mariadb-maxscale-25-avrorouter.md), how to set it up and how it interacts\
...
* Dump the database to a slave, configure it to replicate from the master and\
  ...
  extra steps)
* Use the [cdc\_schema Go utility](../maxscale-25-routers/mariadb-maxscale-25-avrorouter.md#avro-schema-generator)\
...
For more details about the SQL commands, refer to the[Binlogrouter](../maxscale-25-routers/mariadb-maxscale-25-binlogrouter.md) documentation.
