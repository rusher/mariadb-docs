...
There is no Clustrix specific router, but both the[readconnroute](../maxscale-25-routers/mariadb-maxscale-25-readconnroute.md) and\
...
to the _readwritesplit_[documentation](../maxscale-25-routers/mariadb-maxscale-25-readwritesplit.md#transaction_replay).
