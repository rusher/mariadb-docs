...
_match_ is a[PCRE2 regular expression](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)\
which defines the text in the SQL statements that is replaced.

The _options_-parameter affects how the patterns are compiled as[usual](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md).\
...
session specific logging, please read the [Configuration Guide](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)\
and the [MaxAdmin](../maxscale-24-reference/mariadb-maxscale-24-maxadmin-admin-interface.md#change-maxscale-logging-options) documentation on changing the logging levels.
