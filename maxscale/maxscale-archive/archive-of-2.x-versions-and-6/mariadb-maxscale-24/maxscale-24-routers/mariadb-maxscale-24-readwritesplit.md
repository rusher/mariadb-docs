...
* [Readwritesplit](mariadb-maxscale-24-readwritesplit.md#readwritesplit)
  * [Overview](mariadb-maxscale-24-readwritesplit.md#overview)
  * [Interaction with servers in Maintenance and Draining state](mariadb-maxscale-24-readwritesplit.md#interaction-with-servers-in-maintenance-and-draining-state)
  * [Configuration](mariadb-maxscale-24-readwritesplit.md#configuration)
  * [Parameters](mariadb-maxscale-24-readwritesplit.md#parameters)
    * [max\_slave\_connections](mariadb-maxscale-24-readwritesplit.md#max_slave_connections)
    * [max\_slave\_replication\_lag](mariadb-maxscale-24-readwritesplit.md#max_slave_replication_lag)
    * [use\_sql\_variables\_in](mariadb-maxscale-24-readwritesplit.md#use_sql_variables_in)
    * [connection\_keepalive](mariadb-maxscale-24-readwritesplit.md#connection_keepalive)
    * [master\_reconnection](mariadb-maxscale-24-readwritesplit.md#master_reconnection)
    * [slave\_selection\_criteria](mariadb-maxscale-24-readwritesplit.md#slave_selection_criteria)
      * [Server Weights and slave\_selection\_criteria](mariadb-maxscale-24-readwritesplit.md#server-weights-and-slave_selection_criteria)
      * [Interaction Between slave\_selection\_criteria and max\_slave\_connections](mariadb-maxscale-24-readwritesplit.md#interaction-between-slave_selection_criteria-and-max_slave_connections)
    * [max\_sescmd\_history](mariadb-maxscale-24-readwritesplit.md#max_sescmd_history)
    * [disable\_sescmd\_history](mariadb-maxscale-24-readwritesplit.md#disable_sescmd_history)
    * [prune\_sescmd\_history](mariadb-maxscale-24-readwritesplit.md#prune_sescmd_history)
    * [master\_accept\_reads](mariadb-maxscale-24-readwritesplit.md#master_accept_reads)
    * [strict\_multi\_stmt](mariadb-maxscale-24-readwritesplit.md#strict_multi_stmt)
    * [strict\_sp\_calls](mariadb-maxscale-24-readwritesplit.md#strict_sp_calls)
    * [master\_failure\_mode](mariadb-maxscale-24-readwritesplit.md#master_failure_mode)
    * [retry\_failed\_reads](mariadb-maxscale-24-readwritesplit.md#retry_failed_reads)
    * [delayed\_retry](mariadb-maxscale-24-readwritesplit.md#delayed_retry)
    * [delayed\_retry\_timeout](mariadb-maxscale-24-readwritesplit.md#delayed_retry_timeout)
    * [transaction\_replay](mariadb-maxscale-24-readwritesplit.md#transaction_replay)
    * [transaction\_replay\_max\_size](mariadb-maxscale-24-readwritesplit.md#transaction_replay_max_size)
    * [transaction\_replay\_attempts](mariadb-maxscale-24-readwritesplit.md#transaction_replay_attempts)
    * [transaction\_replay\_retry\_on\_deadlock](mariadb-maxscale-24-readwritesplit.md#transaction_replay_retry_on_deadlock)
    * [optimistic\_trx](mariadb-maxscale-24-readwritesplit.md#optimistic_trx)
    * [causal\_reads](mariadb-maxscale-24-readwritesplit.md#causal_reads)
    * [causal\_reads\_timeout](mariadb-maxscale-24-readwritesplit.md#causal_reads_timeout)
    * [lazy\_connect](mariadb-maxscale-24-readwritesplit.md#lazy_connect)
  * [Router Diagnostics](mariadb-maxscale-24-readwritesplit.md#router-diagnostics)
  * [Server Ranks](mariadb-maxscale-24-readwritesplit.md#server-ranks)
  * [Routing hints](mariadb-maxscale-24-readwritesplit.md#routing-hints)
  * [Examples](mariadb-maxscale-24-readwritesplit.md#examples)
  * [Readwritesplit routing decisions](mariadb-maxscale-24-readwritesplit.md#readwritesplit-routing-decisions)
    * [Routing to Master](mariadb-maxscale-24-readwritesplit.md#routing-to-master)
    * [Routing to Slaves](mariadb-maxscale-24-readwritesplit.md#routing-to-slaves)
    * [Routing to every session backend](mariadb-maxscale-24-readwritesplit.md#routing-to-every-session-backend)
    * [Routing to previous target](mariadb-maxscale-24-readwritesplit.md#routing-to-previous-target)
  * [Limitations](mariadb-maxscale-24-readwritesplit.md#limitations)
    * [Prepares Statement Limitations](mariadb-maxscale-24-readwritesplit.md#prepares-statement-limitations)
    * [Transaction Replay Limitations](mariadb-maxscale-24-readwritesplit.md#transaction-replay-limitations)
    * [Legacy Configuration](mariadb-maxscale-24-readwritesplit.md#legacy-configuration)
    * [JDBC Batched Statements](mariadb-maxscale-24-readwritesplit.md#jdbc-batched-statements)
      * [Limitations in multi-statement handling](mariadb-maxscale-24-readwritesplit.md#limitations-in-multi-statement-handling)
      * [Limitations in client session handling](mariadb-maxscale-24-readwritesplit.md#limitations-in-client-session-handling)
...
For more details about the standard service parameters, refer to the[Configuration Guide](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md).
...
The lag is specified as documented[here](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md). If no explicit unit\
...
The keepalive is specified as documented[here](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md). If no explicit unit\
is provided, the value is interpreted as seconds in MaxScale 2.4. In subsequent\
versions a value without a unit may be rejected. Note that since the granularity\
...
lower intervals than the configured _wait\_timeout_.
...
When `master_reconnection` is enabled in conjunction with either`master_failure_mode=fail_on_write` or `master_failure_mode=error_on_write`, the\
...
read-only mode (described in detail in the[master\_failure\_mode](mariadb-maxscale-24-readwritesplit.md#master_failure_mode) documentation).
...
Read the [configuration guide](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)\
...
them. To prevent this, use the[connection\_timeout](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)\
parameter.
...
available. If [master\_reconnection](mariadb-maxscale-24-readwritesplit.md#master_reconnection) is enabled, the\
...
The timeout is specified as documented[here](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md). If no explicit unit\
is provided, the value is interpreted as seconds in MaxScale 2.4. In subsequent\
versions a value without a unit may be rejected. Note that since the granularity\
...
syntax and functionality, please read [this](../maxscale-24-reference/mariadb-maxscale-24-hint-syntax.md)\
document.
...
will always be routed to the master. See[strict\_multi\_stmt](mariadb-maxscale-24-readwritesplit.md#strict_multi_stmt) for more\
details.
