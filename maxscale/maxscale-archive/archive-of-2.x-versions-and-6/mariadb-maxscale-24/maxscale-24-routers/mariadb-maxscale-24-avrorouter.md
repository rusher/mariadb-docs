...
This router is intended to be used in tandem with the[Binlog Server](mariadb-maxscale-24-binlogrouter.md).\
...
![](<../../../../.gitbook/assets/Binlog-Avro.png (6).png>)
...
* [Avrorouter](mariadb-maxscale-24-avrorouter.md#avrorouter)
  * [Direct Replication Mode](mariadb-maxscale-24-avrorouter.md#direct-replication-mode)
  * [Configuration](mariadb-maxscale-24-avrorouter.md#configuration)
    * [Router Parameters](mariadb-maxscale-24-avrorouter.md#router-parameters)
      * [gtid\_start\_pos](mariadb-maxscale-24-avrorouter.md#gtid_start_pos)
      * [server\_id](mariadb-maxscale-24-avrorouter.md#server_id)
      * [source](mariadb-maxscale-24-avrorouter.md#source)
      * [codec](mariadb-maxscale-24-avrorouter.md#codec)
      * [match and exclude](mariadb-maxscale-24-avrorouter.md#match-and-exclude)
      * [binlogdir](mariadb-maxscale-24-avrorouter.md#binlogdir)
      * [avrodir](mariadb-maxscale-24-avrorouter.md#avrodir)
        * [filestem](mariadb-maxscale-24-avrorouter.md#filestem)
      * [start\_index](mariadb-maxscale-24-avrorouter.md#start_index)
        * [Example configuration](mariadb-maxscale-24-avrorouter.md#example-configuration)
      * [Avro File Related Parameters](mariadb-maxscale-24-avrorouter.md#avro-file-related-parameters)
        * [group\_trx](mariadb-maxscale-24-avrorouter.md#group_trx)
        * [group\_rows](mariadb-maxscale-24-avrorouter.md#group_rows)
        * [block\_size](mariadb-maxscale-24-avrorouter.md#block_size)
  * [Module commands](mariadb-maxscale-24-avrorouter.md#module-commands)
    * [avrorouter::convert SERVICE {start | stop}](mariadb-maxscale-24-avrorouter.md#avrorouterconvert-service-start-stop)
    * [avrorouter::purge SERVICE](mariadb-maxscale-24-avrorouter.md#avrorouterpurge-service)
  * [Files Created by the Avrorouter](mariadb-maxscale-24-avrorouter.md#files-created-by-the-avrorouter)
  * [Resetting the Conversion Process](mariadb-maxscale-24-avrorouter.md#resetting-the-conversion-process)
  * [Stopping the Avrorouter](mariadb-maxscale-24-avrorouter.md#stopping-the-avrorouter)
  * [Example Client](mariadb-maxscale-24-avrorouter.md#example-client)
  * [Avro Schema Generator](mariadb-maxscale-24-avrorouter.md#avro-schema-generator)
    * [Simple Schema Generator](mariadb-maxscale-24-avrorouter.md#simple-schema-generator)
    * [Python Schema Generator](mariadb-maxscale-24-avrorouter.md#python-schema-generator)
    * [Go Schema Generator](mariadb-maxscale-24-avrorouter.md#go-schema-generator)
  * [Examples](mariadb-maxscale-24-avrorouter.md#examples)
  * [Building Avrorouter](mariadb-maxscale-24-avrorouter.md#building-avrorouter)
  * [Router Diagnostics](mariadb-maxscale-24-avrorouter.md#router-diagnostics)
  * [Limitations](mariadb-maxscale-24-avrorouter.md#limitations)
...
For information about common service parameters, refer to the[Configuration Guide](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md).
...
The _server\_id_ used when replicating from the master in direct\
...
**Note:** If the `source` parameter is defined the values for `binlogdir` and`filestem` are only read from the source service. This means that the\
...
the router\_options and they will be used as the source for the binary logs. This\
...
These [regular expression settings](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)\
...
Read [Module Commands](../maxscale-24-reference/mariadb-maxscale-24-module-commands.md) documentation for\
...
the user creation, please refer to the [CDC Protocol](../maxscale-24-protocols/mariadb-maxscale-24-change-data-capture-cdc-protocol.md)\
and [CDC Users](../maxscale-24-protocols/mariadb-maxscale-24-change-data-capture-cdc-users.md) documentation.
...
The [Avrorouter Tutorial](../maxscale-24-tutorials/mariadb-maxscale-24-avrorouter-tutorial.md) shows you how\
