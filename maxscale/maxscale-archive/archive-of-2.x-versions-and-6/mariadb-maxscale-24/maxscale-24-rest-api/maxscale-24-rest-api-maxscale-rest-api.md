...
* [Resources](maxscale-24-rest-api-maxscale-rest-api.md#resources)
* [Common Request Parameter](maxscale-24-rest-api-maxscale-rest-api.md#common-request-parameters)
* [HTTP Headers](maxscale-24-rest-api-maxscale-rest-api.md#http-headers)
* [Request Headers](maxscale-24-rest-api-maxscale-rest-api.md#request-headers)
* [Response Headers](maxscale-24-rest-api-maxscale-rest-api.md#response-headers)
* [Response Codes](maxscale-24-rest-api-maxscale-rest-api.md#response-codes)
* [2xx Success](maxscale-24-rest-api-maxscale-rest-api.md#2xx-success)
* [3xx Redirection](maxscale-24-rest-api-maxscale-rest-api.md#3xx-redirection)
* [4xx Client Error](maxscale-24-rest-api-maxscale-rest-api.md#4xx-client-error)
* [5xx Server Error](maxscale-24-rest-api-maxscale-rest-api.md#5xx-server-error)
...
Read the [REST API](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)\
...
can be intercepted from the network traffic. Refer to the[Configuration Guide](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md) for more\
...
refer to the [MaxAdmin](../maxscale-24-reference/mariadb-maxscale-24-maxadmin-admin-interface.md) documentation as well as the\
documentation of the [users](mariadb-maxscale-24-admin-user-resource.md) resource.
...
* [maxscale](mariadb-maxscale-24-maxscale-resource.md)
* [services](mariadb-maxscale-24-service-resource.md)
* [servers](mariadb-maxscale-24-server-resource.md)
* [filters](mariadb-maxscale-24-filter-resource.md)
* [monitors](mariadb-maxscale-24-monitor-resource.md)
* [sessions](mariadb-maxscale-24-session-resource.md)
* [users](mariadb-maxscale-24-admin-user-resource.md)
...
about MaxScale administrative users, refer to the[MaxAdmin](../maxscale-24-reference/mariadb-maxscale-24-maxadmin-admin-interface.md) documentation.
