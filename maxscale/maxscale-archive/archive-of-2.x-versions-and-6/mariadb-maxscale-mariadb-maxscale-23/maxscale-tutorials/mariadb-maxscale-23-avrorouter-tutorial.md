...
This tutorial is a short introduction to the[Avrorouter](../maxscale-23-routers/mariadb-maxscale-23-avrorouter.md), how to set it up and how it interacts\
...
Documentation](../maxscale-23-routers/mariadb-maxscale-23-avrorouter.md).
...
* Dump the database to a slave, configure it to replicate from the master and\
  ...
  extra steps)
* Use the [cdc\_schema Go utility](../maxscale-23-routers/mariadb-maxscale-23-avrorouter.md#avro-schema-generator)\
...
For more details about the SQL commands, refer to the[Binlogrouter](../maxscale-23-routers/mariadb-maxscale-23-binlogrouter.md) documentation.
