...
![](<../../../../.gitbook/assets/Simple-Sharding.png (8).png>)
...
The database users should be configured according to [the configuration guide](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/). The [MaxScale Tutorial](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/) contains easy to follow instructions on how to set up MaxScale.
...
Follow the [MaxScale Tutorial](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/) to install and prepare the required database users for MaxScale. You don't need to create the configuration file for MaxScale as it will be covered in the next section.
