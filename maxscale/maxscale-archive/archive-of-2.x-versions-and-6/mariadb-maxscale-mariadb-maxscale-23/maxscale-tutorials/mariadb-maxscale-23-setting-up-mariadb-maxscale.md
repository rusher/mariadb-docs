...
Building from source code in GitHub is covered in[Building from Source](https://github.com/mariadb-corporation/docs-server/blob/test/maxscale/other-maxscale-versions/mariadb-maxscale-mariadb-maxscale-23/maxscale-tutorials/broken-reference/README.md).

### Installing MaxScale

The precise installation process varies from one distribution to another. Details on\
package installation can be found in the[Installation Guide](../maxscale-23-getting-started/mariadb-maxscale-23-mariadb-maxscale-installation-guide.md).
...
Read the [Configuring Servers](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/) mini-tutorial for server\
configuration instructions.

### Configuring the monitor

The type of monitor used depends on the type of cluster used. For a master-slave cluster\
read[Configuring MariaDB Monitor](https://github.com/mariadb-corporation/docs-server/blob/test/maxscale/other-maxscale-versions/mariadb-maxscale-mariadb-maxscale-23/maxscale-tutorials/broken-reference/README.md).\
For a Galera cluster read[Configuring Galera Monitor](https://github.com/mariadb-corporation/docs-server/blob/test/maxscale/other-maxscale-versions/mariadb-maxscale-mariadb-maxscale-23/maxscale-tutorials/broken-reference/README.md).

### Configuring the services and listeners

This part is covered in two different tutorials. For a fully automated\
read-write-splitting setup, read the[Read Write Splitting Tutorial](mariadb-maxscale-23-readwrite-splitting-with-mariadb-maxscale.md).\
For a simple connection based setup, read the[Connection Routing Tutorial](mariadb-maxscale-23-connection-routing-with-mariadb-maxscale.md).
...
More options can be found in the[Configuration Guide](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/),[readwritesplit module documentation](../maxscale-23-routers/mariadb-maxscale-23-readwritesplit.md) and[readconnroute module documentation](../maxscale-23-routers/mariadb-maxscale-23-readconnroute.md).

For more information about MaxCtrl and how to secure it, see the[REST-API Tutorial](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/).
