...
Read the [Authentication Modules](mariadb-maxscale-23-authentication-modules-in-maxscale.md) document for more\
...
See the [Limitations](../about-maxscale-23/mariadb-maxscale-23-limitations-and-known-issues-within-mariadb-maxscale.md) document for more details.
