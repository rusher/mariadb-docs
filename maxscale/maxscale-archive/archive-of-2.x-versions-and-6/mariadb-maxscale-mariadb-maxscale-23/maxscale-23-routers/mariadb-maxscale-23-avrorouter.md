...
This router is intended to be used in tandem with the[Binlog Server](mariadb-maxscale-23-binlogrouter.md).\
...
* [Configuration](mariadb-maxscale-23-avrorouter.md#configuration)
* [Router Parameters](mariadb-maxscale-23-avrorouter.md#router-parameters)
  * [source](mariadb-maxscale-23-avrorouter.md#source)
  * [codec](mariadb-maxscale-23-avrorouter.md#codec)
  * [match and exclude](mariadb-maxscale-23-avrorouter.md#match-and-exclude)
* [Router Options](mariadb-maxscale-23-avrorouter.md#router-options)
  * [General Options](mariadb-maxscale-23-avrorouter.md#general-options)
    * [binlogdir](mariadb-maxscale-23-avrorouter.md#binlogdir)
    * [avrodir](mariadb-maxscale-23-avrorouter.md#avrodir)
    * [filestem](mariadb-maxscale-23-avrorouter.md#filestem)
    * [start\_index](mariadb-maxscale-23-avrorouter.md#start_index)
  * [Avro file options](mariadb-maxscale-23-avrorouter.md#avro-file-options)
    * [group\_trx](mariadb-maxscale-23-avrorouter.md#group_trx)
    * [group\_rows](mariadb-maxscale-23-avrorouter.md#group_rows)
    * [block\_size](mariadb-maxscale-23-avrorouter.md#block_size)
* [Module commands](mariadb-maxscale-23-avrorouter.md#module-commands)
* [avrorouter::convert SERVICE {start | stop}](mariadb-maxscale-23-avrorouter.md#avrorouterconvert-service-start--stop)
* [avrorouter::purge SERVICE](mariadb-maxscale-23-avrorouter.md#avrorouterpurge-service)
* [Files Created by the Avrorouter](mariadb-maxscale-23-avrorouter.md#files-created-by-the-avrorouter)
* [Resetting the Conversion Process](mariadb-maxscale-23-avrorouter.md#resetting-the-conversion-process)
* [Stopping the Avrorouter](mariadb-maxscale-23-avrorouter.md#stopping-the-avrorouter)
* [Example Client](mariadb-maxscale-23-avrorouter.md#example-client)
* [Avro Schema Generator](mariadb-maxscale-23-avrorouter.md#avro-schema-generator)
* [Python Schema Generator](mariadb-maxscale-23-avrorouter.md#python-schema-generator)
* [Go Schema Generator](mariadb-maxscale-23-avrorouter.md#go-schema-generator)
* [Examples](mariadb-maxscale-23-avrorouter.md#examples)
* [Building Avrorouter](mariadb-maxscale-23-avrorouter.md#building-avrorouter)

### Configuration

For information about common service parameters, refer to the[Configuration Guide](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/).
...
options. The following options should be given as a value to the`router_options` parameter.
...
the user creation, please refer to the [CDC Protocol](../maxscale-23-protocols/mariadb-maxscale-23-change-data-capture-cdc-protocol.md)\
and [CDC Users](../maxscale-23-protocols/mariadb-maxscale-23-change-data-capture-cdc-users.md) documentation.
...
The [Avrorouter Tutorial](../maxscale-tutorials/mariadb-maxscale-23-avrorouter-tutorial.md) shows you how\
