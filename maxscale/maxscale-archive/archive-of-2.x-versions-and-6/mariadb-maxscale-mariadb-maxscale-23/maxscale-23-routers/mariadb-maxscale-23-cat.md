...
Here is a simple example service definition that uses the servers from the[Configuring Servers](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/) tutorial and the\
credentials from the [MaxScale Tutorial](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/).
