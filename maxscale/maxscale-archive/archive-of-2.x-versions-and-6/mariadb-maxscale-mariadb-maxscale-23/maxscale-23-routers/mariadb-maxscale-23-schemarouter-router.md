...
See [Limitations](mariadb-maxscale-23-schemarouter-router.md#limitations) for more information.

From 2.3.0 onwards, SchemaRouter is capable of limited table family sharding.

## Table of Contents

* [Routing Logic](mariadb-maxscale-23-schemarouter-router.md#routing-logic)
* [Configuration](mariadb-maxscale-23-schemarouter-router.md#configuration)
* [Router Parameters](mariadb-maxscale-23-schemarouter-router.md#router-parameters)
* [ignore\_databases](mariadb-maxscale-23-schemarouter-router.md#ignore_databases)
* [ignore\_databases\_regex](mariadb-maxscale-23-schemarouter-router.md#ignore_databases_regex)
* [preferred\_server](mariadb-maxscale-23-schemarouter-router.md#preferred_server)
* [Table Family Sharding](mariadb-maxscale-23-schemarouter-router.md#table-family-sharding)
* [Router Options](mariadb-maxscale-23-schemarouter-router.md#router-options)
* [max\_sescmd\_history](mariadb-maxscale-23-schemarouter-router.md#max_sescmd_history)
* [disable\_sescmd\_history](mariadb-maxscale-23-schemarouter-router.md#disable_sescmd_history)
* [refresh\_databases](mariadb-maxscale-23-schemarouter-router.md#refresh_databases)
* [refresh\_interval](mariadb-maxscale-23-schemarouter-router.md#refresh_interval)
* [Limitations](mariadb-maxscale-23-schemarouter-router.md#limitations)
* [Examples](mariadb-maxscale-23-schemarouter-router.md#examples)
...
A[PCRE2 regular expression](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/)\
