...
* [Cache](mariadb-maxscale-23-cache.md#cache)
* [Table of Contents](mariadb-maxscale-23-cache.md#table-of-contents)
  * [Overview](mariadb-maxscale-23-cache.md#overview)
  * [Limitations](mariadb-maxscale-23-cache.md#limitations)
    * [Invalidation](mariadb-maxscale-23-cache.md#invalidation)
    * [Prepared Statements](mariadb-maxscale-23-cache.md#prepared-statements)
    * [Security](mariadb-maxscale-23-cache.md#security)
  * [Configuration](mariadb-maxscale-23-cache.md#configuration)
    * [Filter Parameters](mariadb-maxscale-23-cache.md#filter-parameters)
      * [storage](mariadb-maxscale-23-cache.md#storage)
      * [storage\_options](mariadb-maxscale-23-cache.md#storage_options)
      * [hard\_ttl](mariadb-maxscale-23-cache.md#hard_ttl)
      * [soft\_ttl](mariadb-maxscale-23-cache.md#soft_ttl)
      * [max\_resultset\_rows](mariadb-maxscale-23-cache.md#max_resultset_rows)
      * [max\_resultset\_size](mariadb-maxscale-23-cache.md#max_resultset_size)
      * [max\_count](mariadb-maxscale-23-cache.md#max_count)
      * [max\_size](mariadb-maxscale-23-cache.md#max_size)
      * [rules](mariadb-maxscale-23-cache.md#rules)
      * [cached\_data](mariadb-maxscale-23-cache.md#cached_data)
      * [selects](mariadb-maxscale-23-cache.md#selects)
      * [cache\_inside\_transactions](mariadb-maxscale-23-cache.md#cache_inside_transactions)
      * [debug](mariadb-maxscale-23-cache.md#debug)
      * [enabled](mariadb-maxscale-23-cache.md#enabled)
    * [Runtime Configuration](mariadb-maxscale-23-cache.md#runtime-configuration)
      * [@maxscale.cache.populate](mariadb-maxscale-23-cache.md#maxscalecachepopulate)
      * [@maxscale.cache.use](mariadb-maxscale-23-cache.md#maxscalecacheuse)
      * [@maxscale.cache.soft\_ttl](mariadb-maxscale-23-cache.md#maxscalecachesoft_ttl)
      * [@maxscale.cache.hard\_ttl](mariadb-maxscale-23-cache.md#maxscalecachehard_ttl)
      * [Client Driven Caching](mariadb-maxscale-23-cache.md#client-driven-caching)
  * [Rules](mariadb-maxscale-23-cache.md#rules_1)
    * [When to Store](mariadb-maxscale-23-cache.md#when-to-store)
      * [Qualified Names](mariadb-maxscale-23-cache.md#qualified-names)
      * [Implication of the default database](mariadb-maxscale-23-cache.md#implication-of-the-default-database)
      * [Regexp Matching](mariadb-maxscale-23-cache.md#regexp-matching)
      * [Examples](mariadb-maxscale-23-cache.md#examples)
    * [When to Use](mariadb-maxscale-23-cache.md#when-to-use)
      * [Examples](mariadb-maxscale-23-cache.md#examples_1)
  * [Security](mariadb-maxscale-23-cache.md#security_1)
  * [Storage](mariadb-maxscale-23-cache.md#storage_1)
    * [storage\_inmemory](mariadb-maxscale-23-cache.md#storage_inmemory)
  * [Example](mariadb-maxscale-23-cache.md#example)
    * [Configuration](mariadb-maxscale-23-cache.md#configuration_1)
    * [cache\_rules.json](mariadb-maxscale-23-cache.md#cache_rulesjson)
  * [Performance](mariadb-maxscale-23-cache.md#performance)
    * [Summary](mariadb-maxscale-23-cache.md#summary)
...
The default behaviour can be altered using the configuration parameter[cache\_inside\_transactions](mariadb-maxscale-23-cache.md#cache_inside_transactions).

By default it is assumed that all `SELECT` statements are cacheable, which\
means that also statements like `SELECT LOCALTIME` are cached. Please check[selects](mariadb-maxscale-23-cache.md#selects) for how to change the default behaviour.
...
Please read the section [Security](mariadb-maxscale-23-cache.md#security-1) for more detailed information.
...
See [Storage](mariadb-maxscale-23-cache.md#storage-1) for what storage modules are available.
...
as described [here](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/).
...
The size can be specified as described[here](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/).
...
cost. Please read [performance](mariadb-maxscale-23-cache.md#performance) for more details.
...
at runtime. Please see[Runtime Configuration](mariadb-maxscale-23-cache.md#runtime-configuation)\
for details.
