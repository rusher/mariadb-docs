...
For more information about MariaDB MaxScale 2.1, please refer to the[ChangeLog](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/).
...
Starting with MaxScale 2.1, any changes made with the newly added[runtime configuration change](../maxscale-23-reference/mariadb-maxscale-23-maxadmin-admin-interface.md#runtime-configuration-changes)\
