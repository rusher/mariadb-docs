...
* [Common Monitor Parameters](mariadb-maxscale-23-common-monitor-parameters.md#common-monitor-parameters)
  * [Parameters](mariadb-maxscale-23-common-monitor-parameters.md#parameters)
    * [user](mariadb-maxscale-23-common-monitor-parameters.md#user)
    * [password](mariadb-maxscale-23-common-monitor-parameters.md#password)
    * [monitor\_interval](mariadb-maxscale-23-common-monitor-parameters.md#monitor_interval)
    * [backend\_connect\_timeout](mariadb-maxscale-23-common-monitor-parameters.md#backend_connect_timeout)
    * [backend\_write\_timeout](mariadb-maxscale-23-common-monitor-parameters.md#backend_write_timeout)
    * [backend\_read\_timeout](mariadb-maxscale-23-common-monitor-parameters.md#backend_read_timeout)
    * [backend\_connect\_attempts](mariadb-maxscale-23-common-monitor-parameters.md#backend_connect_attempts)
    * [disk\_space\_threshold](mariadb-maxscale-23-common-monitor-parameters.md#disk_space_threshold)
    * [disk\_space\_check\_interval](mariadb-maxscale-23-common-monitor-parameters.md#disk_space_check_interval)
    * [script](mariadb-maxscale-23-common-monitor-parameters.md#script)
    * [script\_timeout](mariadb-maxscale-23-common-monitor-parameters.md#script_timeout)
    * [events](mariadb-maxscale-23-common-monitor-parameters.md#events)
  * [Script events](mariadb-maxscale-23-common-monitor-parameters.md#script-events)
    * [journal\_max\_age](mariadb-maxscale-23-common-monitor-parameters.md#journal_max_age)
  * [Monitor Crash Safety](mariadb-maxscale-23-common-monitor-parameters.md#monitor-crash-safety)
  * [Script example](mariadb-maxscale-23-common-monitor-parameters.md#script-example)
...
This parameter duplicates the `disk_space_threshold`[server parameter](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/).\
...
See section [Script example](mariadb-maxscale-23-common-monitor-parameters.md#script-example) below for an example script.
