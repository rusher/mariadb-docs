...
* [MariaDB Monitor](mariadb-maxscale-23-mariadb-monitor.md#mariadb-monitor)
  ...
  * [Master selection](mariadb-maxscale-23-mariadb-monitor.md#master-selection)
  * [Configuration](mariadb-maxscale-23-mariadb-monitor.md#configuration)
  * [Common Monitor Parameters](mariadb-maxscale-23-mariadb-monitor.md#common-monitor-parameters)
  * [MariaDB Monitor optional parameters](mariadb-maxscale-23-mariadb-monitor.md#mariadb-monitor-optional-parameters)
    * [assume\_unique\_hostnames](mariadb-maxscale-23-mariadb-monitor.md#assume_unique_hostnames)
    * [detect\_replication\_lag](mariadb-maxscale-23-mariadb-monitor.md#detect_replication_lag)
    * [detect\_stale\_master](mariadb-maxscale-23-mariadb-monitor.md#detect_stale_master)
    * [detect\_stale\_slave](mariadb-maxscale-23-mariadb-monitor.md#detect_stale_slave)
    * [mysql51\_replication](mariadb-maxscale-23-mariadb-monitor.md#mysql51_replication)
    * [multimaster](mariadb-maxscale-23-mariadb-monitor.md#multimaster)
    * [ignore\_external\_masters](mariadb-maxscale-23-mariadb-monitor.md#ignore_external_masters)
    * [detect\_standalone\_master](mariadb-maxscale-23-mariadb-monitor.md#detect_standalone_master)
    * [failcount](mariadb-maxscale-23-mariadb-monitor.md#failcount)
    * [allow\_cluster\_recovery](mariadb-maxscale-23-mariadb-monitor.md#allow_cluster_recovery)
    * [enforce\_read\_only\_slaves](mariadb-maxscale-23-mariadb-monitor.md#enforce_read_only_slaves)
    * [maintenance\_on\_low\_disk\_space](mariadb-maxscale-23-mariadb-monitor.md#maintenance_on_low_disk_space)
  * [Cluster manipulation operations](mariadb-maxscale-23-mariadb-monitor.md#cluster-manipulation-operations)
    * [Operation details](mariadb-maxscale-23-mariadb-monitor.md#operation-details)
    * [Manual activation](mariadb-maxscale-23-mariadb-monitor.md#manual-activation)
    * [Automatic activation](mariadb-maxscale-23-mariadb-monitor.md#automatic-activation)
    * [Limitations and requirements](mariadb-maxscale-23-mariadb-monitor.md#limitations-and-requirements)
    * [External master support](mariadb-maxscale-23-mariadb-monitor.md#external-master-support)
    * [Configuration parameters](mariadb-maxscale-23-mariadb-monitor.md#configuration-parameters)
      * [auto\_failover](mariadb-maxscale-23-mariadb-monitor.md#auto_failover)
      * [auto\_rejoin](mariadb-maxscale-23-mariadb-monitor.md#auto_rejoin)
      * [switchover\_on\_low\_disk\_space](mariadb-maxscale-23-mariadb-monitor.md#switchover_on_low_disk_space)
      * [replication\_user and replication\_password](mariadb-maxscale-23-mariadb-monitor.md#replication_user-and-replication_password)
      * [replication\_master\_ssl](mariadb-maxscale-23-mariadb-monitor.md#replication_master_ssl)
      * [failover\_timeout and switchover\_timeout](mariadb-maxscale-23-mariadb-monitor.md#failover_timeout-and-switchover_timeout)
      * [verify\_master\_failure and master\_failure\_timeout](mariadb-maxscale-23-mariadb-monitor.md#verify_master_failure-and-master_failure_timeout)
      * [servers\_no\_promotion](mariadb-maxscale-23-mariadb-monitor.md#servers_no_promotion)
      * [promotion\_sql\_file and demotion\_sql\_file](mariadb-maxscale-23-mariadb-monitor.md#promotion_sql_file-and-demotion_sql_file)
      * [handle\_events](mariadb-maxscale-23-mariadb-monitor.md#handle_events)
  * [Troubleshooting](mariadb-maxscale-23-mariadb-monitor.md#troubleshooting)
    * [Failover/switchover fails](mariadb-maxscale-23-mariadb-monitor.md#failoverswitchover-fails)
    * [Slave detection shows external masters](mariadb-maxscale-23-mariadb-monitor.md#slave-detection-shows-external-masters)
  * [Using the MariaDB Monitor With Binlogrouter](mariadb-maxscale-23-mariadb-monitor.md#using-the-mariadb-monitor-with-binlogrouter)
...
described in section[Failover, switchover and auto-rejoin](mariadb-maxscale-23-mariadb-monitor.md#failover,-switchover-and-auto-rejoin).\
...
and is always required. See[Cluster manipulation operations](mariadb-maxscale-23-mariadb-monitor.md#cluster-manipulation-operations) for more\
...
switchover and rejoin-specific parameters are listed in their own[section](mariadb-maxscale-23-mariadb-monitor.md#cluster-manipulation-operations).
...
this is detected, the server is assigned the `Slave` and `Slave of External Server` labels and will be treated as a slave server. Most of the time this\
...
search for another server to fultill the master role. See section[Master selection](mariadb-maxscale-23-mariadb-monitor.md#master-selection)\
...
parameters [disk\_space\_threshold](https://mariadb.com/kb/en/node:mariadb-maxscale-23-common-monitor-parameters#disk_space_threshold) and[disk\_space\_check\_interval](https://mariadb.com/kb/en/node:mariadb-maxscale-23-common-monitor-parameters#disk_space_check_interval)\
...
See [operation details](mariadb-maxscale-23-mariadb-monitor.md#operation-details) for more information on the\
...
section [Manual activation](mariadb-maxscale-23-mariadb-monitor.md#manual-activation) for more details.

See [Limitations and requirements](mariadb-maxscale-23-mariadb-monitor.md#limitations-and-requirements) for\
...
8. Remove the slave connection the new master used to replicate from the old\
   master.
9. Disable the read\_only-flag.
10. Enable scheduled server events (if event handling is on). Only events that were\
...
3. Kill connections from super-users since read\_only does not affect them.
...
9. Enable scheduled server events (if event handling is on). Events are only enabled\
...
for the [server](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/)\
...
event. Effectively, if a slave has received an event within`master_failure_timeout` seconds, the master is not considered down when\
...
settings of the monitor should help. Another settings to look at are `query_retries` and`query_retry_timeout`. These are general MaxScale settings described in the[Configuration guide](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/). Setting`query_retries` to 2 is a reasonable first try.
...
controlled by the setting [assume\_unique\_hostnames](mariadb-maxscale-23-mariadb-monitor.md#assume_unique_hostnames).
...
For addition information read the[Replication Proxy](../maxscale-tutorials/mariadb-maxscale-23-mariadb-maxscale-as-a-binlog-server.md)\
tutorial.
