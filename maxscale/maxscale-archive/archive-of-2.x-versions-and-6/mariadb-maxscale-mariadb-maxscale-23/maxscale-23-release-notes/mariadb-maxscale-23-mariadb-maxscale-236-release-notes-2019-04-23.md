...
* [MXS-2344](https://jira.mariadb.org/browse/MXS-2344) Support MASTER\_SSL in mariadbmon for encrypting replication traffic
...
For more information, read the[REST-API](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/) documentation for\
the `set` endpoint.

### Bug fixes

* [MXS-2423](https://jira.mariadb.org/browse/MXS-2423) retain\_last\_statements not in maxctrl show maxscale
* [MXS-2419](https://jira.mariadb.org/browse/MXS-2419) Hangs on query during multiple transaction replays
* [MXS-2418](https://jira.mariadb.org/browse/MXS-2418) Crash on transaction replay if log\_info is on and session starts with no master
