...
session specific logging, please read the [Configuration Guide](../maxscale-20-getting-started/mariadb-maxscale-20-mariadb-maxscale-configuration-usage-scenarios.md#global-settings)\
and the [MaxAdmin](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/) documentation on changing the logging levels.
