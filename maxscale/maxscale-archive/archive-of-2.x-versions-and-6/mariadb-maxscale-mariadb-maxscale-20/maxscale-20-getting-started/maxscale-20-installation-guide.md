...
* Go to [download](https://mariadb.com/my_portal/download).
...
* [maxscale](https://mariadb.com/my_portal/download/maxscale)
* [maxscale](https://mariadb.com/downloads/maxscale)
...
Before starting MariaDB MaxScale, you need to create a configuration file for it; please see further [down](maxscale-20-installation-guide.md#configuring-mariadb-maxscale).
...
For more details, refer to the [Configuration Guide](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/).
