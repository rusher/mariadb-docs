...
This parameter allows the location that MariaDB MaxScale uses to store binlog files to be set. If this parameter is not set to a directory name then MariaDB MaxScale will store the binlog files in the directory /var/cache/maxscale/.\
...
The [Replication Proxy](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/) tutorial will show you how to configure and administrate a binlogrouter installation.
