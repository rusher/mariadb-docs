...
Before starting MariaDB MaxScale, you need to create a configuration file for it; please see further [down](mariadb-maxscale-installation-guide.md#configuring-mariadb-maxscale).
