...
* [MXS-683](https://jira.mariadb.org/browse/MXS-683): qc\_mysqlembedded reports as-name instead of original-name.
* [MXS-681](https://jira.mariadb.org/browse/MXS-681): Loading service users error
* [MXS-680](https://jira.mariadb.org/browse/MXS-680): qc\_mysqlembedded fails to look into function when reporting affected fields
* [MXS-679](https://jira.mariadb.org/browse/MXS-679): qc\_mysqlembedded excludes some fields, when reporting affected fields
