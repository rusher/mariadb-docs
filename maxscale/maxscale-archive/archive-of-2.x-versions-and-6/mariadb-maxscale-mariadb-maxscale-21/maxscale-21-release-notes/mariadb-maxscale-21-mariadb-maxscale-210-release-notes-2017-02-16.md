...
Please see the[Configuration Guide](../maxscale-21-getting-started/mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#configuration)\
for details.
...
For more details, refer to the documentation of _module\_configdir_ in the[Configuration Guide](../maxscale-21-getting-started/mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md)
...
For more information about this configuration entry, please see[Global Settings](../maxscale-21-getting-started/mariadb-maxscale-21-mariadb-maxscale-configuration-usage-scenarios.md#global-settings).
...
Read the [Readwritesplit documentation](../maxscale-21-routers/mariadb-maxscale-21-readwritesplit.md) on`retry_failed_reads` for more details.
...
For more information about persistent connections, please read the[Administration Tutorial](../maxscale-21-tutorials/mariadb-maxscale-21-mariadb-maxscale-administration-tutorial.md).
...
For more details, read the [Galeramon documentation](../maxscale-21-monitors/mariadb-maxscale-21-galera-monitor.md).
...
For more details, read the [Named Server Filter documentation](../maxscale-21-filters/mariadb-maxscale-21-named-server-filter.md).
...
node. This module also supports launchable scripts on monitored events. Read the[Monitor Common Documentation](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/) for more details.
...
for the mmmon module. For more details, please read the[MySQL Monitor Documentation](../maxscale-21-monitors/mariadb-maxscale-21-mysql-monitor.md).
...
the [MySQL Monitor Documentation](../maxscale-21-monitors/mariadb-maxscale-21-mysql-monitor.md).
...
For more information, refer to the [CCRFilter](../maxscale-21-filters/mariadb-maxscale-21-consistent-critical-read-filter.md)\
documentation.
...
For more information, refer to the [Cache](../maxscale-21-filters/mariadb-maxscale-21-maxscale-21-cache.md) documentation.
...
For more information, refer to the [Masking](../maxscale-21-filters/mariadb-maxscale-21-masking.md)\
documentation.
...
For more information, refer to the [Maxrows](../maxscale-21-filters/mariadb-maxscale-21-maxrows.md)\
documentation.
...
For more details, read the [Binlogrouter documentation](../maxscale-21-routers/mariadb-maxscale-21-binlogrouter.md).
