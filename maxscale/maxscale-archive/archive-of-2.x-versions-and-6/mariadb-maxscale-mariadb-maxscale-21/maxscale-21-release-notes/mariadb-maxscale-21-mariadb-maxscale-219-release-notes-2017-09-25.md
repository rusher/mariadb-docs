...
This document describes the changes in release 2.1.9, when compared to release[2.1.8](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/).

If you are upgrading from release 2.0, please also read the following release\
notes:

* [2.1.8](https://mariadb.com/kb/en/node:mariadb-maxscale-218-release-notes-2017-09-20)
