...
![](<../../../../.gitbook/assets/Binlog-Avro.png (9).png>)
...
For more information on the avrorouter options, read the[Avrorouter Documentation](../maxscale-21-routers/mariadb-maxscale-21-avrorouter.md).
...
* Use the [cdc\_schema Go utilty](../maxscale-21-routers/mariadb-maxscale-21-avrorouter.md#avro-schema-generator)
