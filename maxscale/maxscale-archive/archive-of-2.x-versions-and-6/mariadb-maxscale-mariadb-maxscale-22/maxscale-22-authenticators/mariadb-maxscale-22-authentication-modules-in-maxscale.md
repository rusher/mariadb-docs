...
Authenticator modules compatible with MySQL protocol in MaxScale are[MySQL](../../mariadb-maxscale-mariadb-maxscale-21/maxscale-21-authenticators/mariadb-maxscale-21-mysql-authenticator.md), [GSSAPI](mariadb-maxscale-22-gssapi-client-authenticator.md) and[PAM](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/).
