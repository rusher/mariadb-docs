...
* [Glossary](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#glossary)
* [Configuration](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#configuration)
* [Special Parameter Types](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#special-parameter-types)
* [Global Settings](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#global-settings)
  * [REST API Configuration](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#rest-api-configuration)
* [Service](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#service)
* [Server](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#server)
* [Listener](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#listener)
* [TLS/SSL Encryption](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#tlsssl-encryption)
* [Router Modules](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#routing-modules)
* [Diagnostic Modules](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#diagnostic-modules)
* [Monitor Modules](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#monitor-modules)
* [Filter Modules](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#filter-modules)
* [Encrypting Passwords](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#encrypting-passwords)
* [Runtime Configuration Changes](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#runtime-configuration-changes)
* [Authentication](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#authentication)
* [Error Reporting](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#error-reporting)
...
should be enclosed in slashes e.g. `match=/^select/` defines the pattern`^select`. The slashes allow whitespace to be read from the ends of the regex\
...
of MaxScale. Currently, _QLAFilter_ accepts parameters in regular expression\
form.
...
as explained in detail [here](mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#sizes).
...
Enable or disable the writing of the _maxscale.log_ file to shared memory. If\
enabled, then the actual log file will be created under `/dev/shm` and a\
symbolic link to that file will be created in the _MaxScale_ log directory.

Logging to shared memory may be appropriate if _log\_info_ and/or _log\_debug_ are\
...
Since _MariaDB MaxScale_ can log to both file and _syslog_ an approach that\
provides maximum flexibility is to enable _syslog_ and _log\_to\_shm_, and to\
disable _maxlog_. That way messages will normally be logged to _syslog_, but if\
there is something to investigate, _log\_debug_ and _maxlog_ can be enabled fro&#x6D;_&#x6D;axadmin_, in which case informational messages will be logged to th&#x65;_&#x6D;axscale.log_ file that resides in shared memory. But note that _log\_debug_\
...
* MaxCtrl
* [create](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/)
* [destroy](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/)
* [add](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/)
* [remove](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/)
* [alter](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/)
* [REST API](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/) documentation
...
error log file. By default, MariaDB MaxScale will log to a file in`/var/log/maxscale`, the only exception to this is if the log directory is not\
