...
to the [CDC Connector documentation](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/) for more details.
...
the users of service. Please refer to the documentation for[details](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#users_refresh_time).
...
for [details](../maxscale-22-getting-started/mariadb-maxscale-22-mariadb-maxscale-configuration-usage-scenarios.md#local_address).
...
server. Check[MariaDB Monitor documentation](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/)\
...
* [MXS-1654](https://jira.mariadb.org/browse/MXS-1654) MaxScale crashes if env-variables are used without substitute\_variables=1 having been defined
...
* [MXS-1606](https://jira.mariadb.org/browse/MXS-1606) After enabling detect\_replication\_lag MariaDBMon does not create the maxscale\_schema.replication\_heartbeat database and table
* [MXS-1604](https://jira.mariadb.org/browse/MXS-1604) PamAuth Default Authentication is Different from MariaDB
* [MXS-1591](https://jira.mariadb.org/browse/MXS-1591) Adding get\_lock and release\_lock support
