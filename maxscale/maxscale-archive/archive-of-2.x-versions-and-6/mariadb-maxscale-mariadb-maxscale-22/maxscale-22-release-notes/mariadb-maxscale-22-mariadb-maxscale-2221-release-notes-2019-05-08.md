...
The disabling is now only temporary and lasts for 'failcount' monitor iterations. Check[MariaDB-Monitor documentation](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/)\
