...
This tutorial is a short introduction to the[Avrorouter](../maxscale-22-routers/mariadb-maxscale-22-avrorouter.md), how to set it up and how it interacts\
...
Documentation](../maxscale-22-routers/mariadb-maxscale-22-avrorouter.md).
...
* Dump the database to a slave, configure it to replicate from the master and\
  ...
  extra steps)
* Use the [cdc\_schema Go utility](../maxscale-22-routers/mariadb-maxscale-22-avrorouter.md#avro-schema-generator)\
...
For more details about the SQL commands, refer to the[Binlogrouter](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/) documentation.
