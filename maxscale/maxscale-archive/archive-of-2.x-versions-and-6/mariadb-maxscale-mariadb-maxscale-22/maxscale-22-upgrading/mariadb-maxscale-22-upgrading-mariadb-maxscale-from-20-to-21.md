...
Starting with MaxScale 2.1, any changes made with the newly added[runtime configuration change](../maxscale-22-reference/mariadb-maxscale-22-maxadmin-admin-interface.md#runtime-configuration-changes)\
