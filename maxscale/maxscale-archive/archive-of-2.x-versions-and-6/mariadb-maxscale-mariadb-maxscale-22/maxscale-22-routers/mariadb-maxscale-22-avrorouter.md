...
This router is intended to be used in tandem with the [Binlog Server](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/).\
...
![](<../../../../.gitbook/assets/Binlog-Avro.png (10).png>)
...
the user creation, please refer to the [CDC Protocol](../../../archive-of-2x.xx-versions/mariadb-maxscale-21-06/)\
