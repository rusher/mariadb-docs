...
[Configuration Guide](https://mariadb.com/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#service).
...
[MySQL Authenticator](../mariadb-maxscale-2208-authenticators/mariadb-maxscale-2208-mysql-authenticator.md)
...
[here](/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#durations). If no explicit
...
[here](/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#sizes), except that IEC binary
