...
[Configuration Guide](/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/).
...
[here](/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#durations). If no explicit unit
...
**Note:** This parameter has been moved into the MaxScale core. For the
 ...
 [connection_keepalive](https://mariadb.com/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#connection_keepalive)
...
[the MaxScale core](https://mariadb.com/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#max_sescmd_history)
in MaxScale 6.0.
...
This parameter has been moved to
[the MaxScale core](https://mariadb.com/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#disable_sescmd_history)
in MaxScale 6.0.
...
This parameter has been moved to
[the MaxScale core](https://mariadb.com/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#prune_sescmd_history)
in MaxScale 6.0.
...
[connection_timeout](https://mariadb.com/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#connection_timeout)
parameter.
...
The timeout is
[a duration type](/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#durations)
...
[CCRFilter](../mariadb-maxscale-2208--filters/mariadb-maxscale-2208-consistent-critical-read-filter.md) module provides.
* `fast_global`
...
[strict_multi_stmt](mariadb-maxscale-2208-readwritesplit.md#strict_multi_stmt) for more
details.
