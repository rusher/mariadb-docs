...
* [MariaDB Protocol Module](mariadb-maxscale-2208-mariadb-protocol-module.md#mariadb-protocol-module)
  * [Configuration](mariadb-maxscale-2208-mariadb-protocol-module.md#configuration)
    * [allow\_replication](mariadb-maxscale-2208-mariadb-protocol-module.md#allow_replication)
