...
See [Configuration Guide](/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/) and
[Configuration and Hardening](../mariadb-maxscale-2208-tutorials/mariadb-maxscale-2208-rest-api-tutorial.md#configuration-and-hardening)
...
[MaxScale object](/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#objects) and allow to edit its
...
* Cluster: Visualizing a replication cluster into a tree graph and provides
 ...
 [mariadbmon](../mariadb-maxscale-2208-monitors/mariadb-maxscale-2208-mariadb-monitor.md) module.
