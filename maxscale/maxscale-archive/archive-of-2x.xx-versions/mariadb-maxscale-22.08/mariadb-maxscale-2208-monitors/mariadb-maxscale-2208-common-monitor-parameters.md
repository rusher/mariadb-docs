...
* [Common Monitor Parameters](mariadb-maxscale-2208-common-monitor-parameters.md#common-monitor-parameters)
  * [Parameters](mariadb-maxscale-2208-common-monitor-parameters.md#parameters)
    * [module](mariadb-maxscale-2208-common-monitor-parameters.md#module)
    * [user](mariadb-maxscale-2208-common-monitor-parameters.md#user)
    * [password](mariadb-maxscale-2208-common-monitor-parameters.md#password)
    * [servers](mariadb-maxscale-2208-common-monitor-parameters.md#servers)
    * [monitor\_interval](mariadb-maxscale-2208-common-monitor-parameters.md#monitor_interval)
    * [backend\_connect\_timeout](mariadb-maxscale-2208-common-monitor-parameters.md#backend_connect_timeout)
    * [backend\_write\_timeout](mariadb-maxscale-2208-common-monitor-parameters.md#backend_write_timeout)
    * [backend\_read\_timeout](mariadb-maxscale-2208-common-monitor-parameters.md#backend_read_timeout)
    * [backend\_connect\_attempts](mariadb-maxscale-2208-common-monitor-parameters.md#backend_connect_attempts)
    * [disk\_space\_threshold](mariadb-maxscale-2208-common-monitor-parameters.md#disk_space_threshold)
    * [disk\_space\_check\_interval](mariadb-maxscale-2208-common-monitor-parameters.md#disk_space_check_interval)
    * [script](mariadb-maxscale-2208-common-monitor-parameters.md#script)
    * [script\_timeout](mariadb-maxscale-2208-common-monitor-parameters.md#script_timeout)
    * [events](mariadb-maxscale-2208-common-monitor-parameters.md#events)
    * [journal\_max\_age](mariadb-maxscale-2208-common-monitor-parameters.md#journal_max_age)
  * [Monitor Crash Safety](mariadb-maxscale-2208-common-monitor-parameters.md#monitor-crash-safety)
  * [Script example](mariadb-maxscale-2208-common-monitor-parameters.md#script-example)
...
The timeout is specified as documented[here](../../../../../en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#durations). If no explicit unit\
is provided, the value is interpreted as seconds in MaxScale 2.4. In subsequent\
versions a value without a unit may be rejected. Note that since the granularity\
of the timeout is seconds, a timeout specified in milliseconds will be rejected,\
...
This parameter duplicates the `disk_space_threshold`[server parameter](../../../../../en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#disk_space_threshold).\
...
between disk space checks. The interval is specified as documented[here](../../../../../en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#durations). If no explicit unit\
is provided, the value is interpreted as milliseconds in MaxScale 2.4. In subsequent\
versions a value without a unit may be rejected.\
...
The timeout for the executed script. The interval is specified as documented[here](../../../../../en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#durations). If no explicit unit\
is provided, the value is interpreted as seconds in MaxScale 2.4. In subsequent\
versions a value without a unit may be rejected. Note that since the granularity\
of the timeout is seconds, a timeout specified in milliseconds will be rejected,\
...
The maximum journal file age. The interval is specified as documented[here](../../../../../en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#durations). If no explicit unit\
is provided, the value is interpreted as seconds in MaxScale 2.4. In subsequent\
versions a value without a unit may be rejected. Note that since the granularity\
