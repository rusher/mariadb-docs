...
* [MXS-5214](https://jira.mariadb.org/browse/MXS-5214) servers\_no\_promotion should prevent a server from being promoted due to replication change
...
* [MXS-5402](https://jira.mariadb.org/browse/MXS-5402) Monitor connections do not check SSL certificate host even when ssl\_verify\_peer\_host is enabled for the server
...
* [MXS-5384](https://jira.mariadb.org/browse/MXS-5384) maxscale version 24 auth\_all\_servers not picking up users on replicas
...
* [MXS-5356](https://jira.mariadb.org/browse/MXS-5356) Readwritesplit master\_reconnection is incompatible with GET\_LOCK
