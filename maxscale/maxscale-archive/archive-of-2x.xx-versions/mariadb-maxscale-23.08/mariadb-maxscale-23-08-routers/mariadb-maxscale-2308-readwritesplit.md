...
[Configuration Guide](/en/maxscale-2308-getting-started-mariadb-maxscale-configuration-guide/).
...
[here](/en/maxscale-2308-getting-started-mariadb-maxscale-configuration-guide/#durations). Note that since
...
**Note:** This parameter has been moved into the MaxScale core. For the
 ...
 [connection_keepalive](https://mariadb.com/kb/en/maxscale-2308-getting-started-mariadb-maxscale-configuration-guide/#connection_keepalive)
...
[the MaxScale core](/en/maxscale-2308-getting-started-mariadb-maxscale-configuration-guide/#max_sescmd_history)
in MaxScale 6.0.
...
This parameter has been moved to
[the MaxScale core](/en/maxscale-2308-getting-started-mariadb-maxscale-configuration-guide/#disable_sescmd_history)
in MaxScale 6.0.
...
This parameter has been moved to
[the MaxScale core](https://mariadb.com/kb/en/maxscale-2308-getting-started-mariadb-maxscale-configuration-guide/#prune_sescmd_history)
in MaxScale 6.0.
...
[connection_timeout](https://mariadb.com/kb/en/maxscale-2308-getting-started-mariadb-maxscale-configuration-guide/#connection_timeout)
parameter.
...
[here](/en/maxscale-2308-getting-started-mariadb-maxscale-configuration-guide/#durations). If no explicit unit
...
The timeout is
[a duration type](/en/maxscale-2308-getting-started-mariadb-maxscale-configuration-guide/#durations)
...
[CCRFilter](../mariadb-maxscale-23-08-filters/mariadb-maxscale-2308-consistent-critical-read-filter.md) module provides.
* `fast_global`
...
[strict_multi_stmt](mariadb-maxscale-2308-readwritesplit.md#strict_multi_stmt) for more
details.
