# MaxScale 23.08 MariaDB Monitor
...
search for another server to fulfill the primary role. See section[Primary selection](mariadb-maxscale-2308-mariadb-monitor.md#primary-selection)\
...
Works similar to[enforce\_read\_only\_slaves](mariadb-maxscale-2308-mariadb-monitor.md#enforce_read_only_slaves) except will se&#x74;_&#x72;ead\_only_ on any writable server that is not the primary and not in\
...
old primary has diverged from the cluster. See[Configuring the Master Wait Point](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/replication-cluster-multi-master/standard-replication/semisynchronous-replication)\
...
![](../../../../.gitbook/assets/mariadb-corporation/MaxScale/23.08.10/Documentation/Monitors/images/coop_lock_no_majority.png.png)
...
![](../../../../.gitbook/assets/mariadb-corporation/MaxScale/23.08.10/Documentation/Monitors/images/coop_lock_split_brain.png.png)
...
![](../../../../.gitbook/assets/mariadb-corporation/MaxScale/23.08.10/Documentation/Monitors/images/coop_lock_flowchart.svg.svg)
...
MaxScale uses to access the servers. MaxScale must be able to run commands wit&#x68;_&#x73;udo_ on both the source and target servers. See [settings](mariadb-maxscale-2308-mariadb-monitor.md#settings) and[sudoers.d configuration](mariadb-maxscale-2308-mariadb-monitor.md#sudoersd-configuration) below\
