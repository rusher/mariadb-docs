...
* [MXS-4969](https://jira.mariadb.org/browse/MXS-4969) Can't create more than max_prepared_stmt_count statements
...
* [MXS-4961](https://jira.mariadb.org/browse/MXS-4961) Result of KILL CONNECTION_ID() does not propagate all the way to the client
