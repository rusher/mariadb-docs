...
[Install MariaDB MaxScale using a Tarball](mariadb-maxscale-2308-installing-mariadb-maxscale-using-a-tarball.md).
...
[Building MariaDB MaxScale from Source Code](mariadb-maxscale-2308-building-mariadb-maxscale-from-source-code.md)
...
[Configuration Guide](/en/maxscale-2308-getting-started-mariadb-maxscale-configuration-guide/) and the module specific documents
