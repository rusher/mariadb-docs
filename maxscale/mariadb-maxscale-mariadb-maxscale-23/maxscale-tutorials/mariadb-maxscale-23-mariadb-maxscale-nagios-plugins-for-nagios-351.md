...
![](../../.gitbook/assets/mariadb-corporation/MaxScale/2.3.20/Documentation/Tutorials/images/HowMaxScaleWorksWithNagios.png.png)
...
1. check_maxscale_resources.pl: This command provides you status of various resources
...
1. check_maxscale_monitor.pl: This command provides you status of the configured
...
please refer to [MaxAdmin Utility](../maxscale-23-reference/mariadb-maxscale-23-maxadmin-admin-interface.md)
