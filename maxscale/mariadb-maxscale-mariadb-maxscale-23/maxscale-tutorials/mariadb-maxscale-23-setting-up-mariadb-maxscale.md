...
[Building from Source](../maxscale-23-getting-started/mariadb-maxscale-23-building-mariadb-maxscale-from-source-code.md).
...
[Installation Guide](../maxscale-23-getting-started/mariadb-maxscale-23-mariadb-maxscale-installation-guide.md).
...
Read the [Configuring Servers](../../mariadb-maxscale-21-06/README.md) mini-tutorial for server
...
read
[Configuring MariaDB Monitor](mariadb-maxscale-23-configuring-the-mariadb-monitor.md).
For a Galera cluster read
[Configuring Galera Monitor](mariadb-maxscale-23-configuring-the-galera-monitor.md).
...
[Read Write Splitting Tutorial](mariadb-maxscale-23-readwrite-splitting-with-mariadb-maxscale.md).
For a simple connection based setup, read the
[Connection Routing Tutorial](mariadb-maxscale-23-connection-routing-with-mariadb-maxscale.md).
...
[readwritesplit module documentation](../maxscale-23-routers/mariadb-maxscale-23-readwritesplit.md) and
[readconnroute module documentation](../maxscale-23-routers/mariadb-maxscale-23-readconnroute.md).


For more information about MaxCtrl and how to secure it, see the
[REST-API Tutorial](../../mariadb-maxscale-21-06/README.md).
