...
The database users should be configured according to [the configuration guide](../../mariadb-maxscale-21-06/README.md). The [MaxScale Tutorial](../../mariadb-maxscale-21-06/README.md) contains easy to follow instructions on how to set up MaxScale.
...
Follow the [MaxScale Tutorial](../../mariadb-maxscale-21-06/README.md) to install and prepare the required database users for MaxScale. You don't need to create the configuration file for MaxScale as it will be covered in the next section.
