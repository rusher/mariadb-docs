...
`<code>relationships</code>` field to `<code>{}</code>`. The REST API interprets this as an instruction
...
[REST API documentation](../maxscale-23-rest-api/maxscale-2-3-rest-api.md).
