...
A session can be killed easily on the "Current Sessions" list which can be found on the [Dashboard](using-maxgui.md#dashboard), Server detail, and Service detail page.
