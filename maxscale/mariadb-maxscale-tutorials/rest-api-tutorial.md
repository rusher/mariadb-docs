...
To query a resource collection endpoint, append it to the URL. The `/v1/filters/` endpoint shows the list of filters configured in MaxScale. This is a _resource collection_ endpoint: it contains the list of all resources of a particular type.
...
The full list of all available endpoints in MaxScale can be found in the [REST API documentation](../reference/maxscale-rest-api/maxscale-rest-api.md).
