...
The REST API calls that MaxCtrl and MaxGui issue to MaxScale can be logged by enabling [admin\_audit](../maxscale-versions/mariadb-maxscale-25-01/mariadb-maxscale-25-01-getting-started/mariadb-maxscale-2501-maxscale-2501-mariadb-maxscale-configuration-guide.md).
