---
description: >-
  Configure the readwritesplit router for query-based load balancing. Route
  writes to the primary and distribute reads across replicas to optimize
  performance.
---
...
This tutorial is a part of [MariaDB MaxScale Tutorial](setting-up-mariadb-maxscale.md). Please read it and follow the instructions. Return here once basic setup is complete.
...
The _service_ parameter tells which service the listener connects to. For the\_Splitter-Listener\_ we set it to _Splitter-Service_.
...
For the last steps, please return to [MaxScale Tutorial](setting-up-mariadb-maxscale.md).
