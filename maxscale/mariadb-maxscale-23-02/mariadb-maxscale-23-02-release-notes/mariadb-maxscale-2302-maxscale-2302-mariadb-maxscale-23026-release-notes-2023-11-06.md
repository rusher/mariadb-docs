...
# MaxScale 23.02 MariaDB MaxScale 23.02.6 Release Notes -- 2023-11-06
...
[upgrading document](../mariadb-maxscale-23-02-upgrading/mariadb-maxscale-2302-upgrading-mariadb-maxscale-from-2208-to-2302.md) for
...
* [MXS-4847](https://jira.mariadb.org/browse/MXS-4847) Crash on `<code>maxctrl list sessions</code>`
