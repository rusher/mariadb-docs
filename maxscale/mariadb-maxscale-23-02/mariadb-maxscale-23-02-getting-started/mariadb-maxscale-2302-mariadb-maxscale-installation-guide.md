...
[Install MariaDB MaxScale using a Tarball](mariadb-maxscale-2302-installing-mariadb-maxscale-using-a-tarball.md).
...
[Building MariaDB MaxScale from Source Code](mariadb-maxscale-2302-building-mariadb-maxscale-from-source-code.md)
...
[Configuration Guide](mariadb-maxscale-2302-mariadb-maxscale-configuration-guide.md) and the module specific documents
