...
[Avrorouter](../mariadb-maxscale-23-02-routers/mariadb-maxscale-2302-avrorouter.md), how to set it up and how it interacts
...
Documentation](../mariadb-maxscale-23-02-routers/mariadb-maxscale-2302-avrorouter.md).
...
* Dump the database to a replica, configure it to replicate from the primary and
 ...
 extra steps)
* Use the [cdc_schema Go utility](../mariadb-maxscale-23-02-routers/mariadb-maxscale-2302-avrorouter.md#avro-schema-generator)
...
[Binlogrouter](../mariadb-maxscale-23-02-routers/mariadb-maxscale-2302-binlogrouter.md) documentation.
