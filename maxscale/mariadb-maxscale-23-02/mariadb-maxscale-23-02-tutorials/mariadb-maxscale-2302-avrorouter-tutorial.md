...
[Avrorouter](mariadb-maxscale-2302-avrorouter-tutorial.md), how to set it up and how it interacts
...
Documentation](mariadb-maxscale-2302-avrorouter-tutorial.md).
...
* Dump the database to a replica, configure it to replicate from the primary and
 ...
 extra steps)
* Use the [cdc_schema Go utility](mariadb-maxscale-2302-avrorouter-tutorial.md#avro-schema-generator)
...
[Binlogrouter](../mariadb-maxscale-23-02-routers/mariadb-maxscale-2302-binlogrouter-24.md) documentation.
