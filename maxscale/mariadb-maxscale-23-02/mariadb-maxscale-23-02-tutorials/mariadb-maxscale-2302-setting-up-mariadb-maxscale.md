...
[Building from Source](../mariadb-maxscale-23-02-getting-started/mariadb-maxscale-2302-building-mariadb-maxscale-from-source-code.md).
...
[Installation Guide](../mariadb-maxscale-23-02-getting-started/mariadb-maxscale-2302-mariadb-maxscale-installation-guide.md).
...
read
[Configuring MariaDB Monitor](mariadb-maxscale-2302-configuring-the-mariadb-monitor.md).
For a Galera cluster read
[Configuring Galera Monitor](mariadb-maxscale-2302-configuring-the-galera-monitor.md).
...
[Read Write Splitting Tutorial](mariadb-maxscale-2302-read-write-splitting-with-mariadb-maxscale.md).
For a simple connection based setup, read the
[Connection Routing Tutorial](mariadb-maxscale-2302-connection-routing-with-mariadb-maxscale.md).
...
[readwritesplit module documentation](../mariadb-maxscale-23-02-routers/mariadb-maxscale-2302-readwritesplit.md) and
[readconnroute module documentation](../mariadb-maxscale-23-02-routers/mariadb-maxscale-2302-readconnroute.md).


For more information about MaxCtrl and how to secure it, see the
[REST-API Tutorial](mariadb-maxscale-2302-rest-api-tutorial.md).
