...
MaxGUI is a graphical utility that can perform administrative tasks using MaxScale's [MaxScale's REST API](../../administrative-tools-for-mariadb-maxscale-maxctrl/operating-maxscale-with-maxctrl/README.md). It is available starting in [MaxScale 2.5](../../../mariadb-maxscale-25/README.md). It supports many different operations.
