...
[MaxGUI](README.md) is a graphical utility that can perform administrative tasks using [MaxScale's REST API](../administrative-tools-for-mariadb-maxscale-maxctrl/operating-maxscale-with-maxctrl/README.md). It is available starting in MaxScale 2.5. It supports many different operations.


[MaxGUI](README.md) is not available out-of-the box. MaxScale requires some configuration before [MaxGUI](README.md) can be used.
