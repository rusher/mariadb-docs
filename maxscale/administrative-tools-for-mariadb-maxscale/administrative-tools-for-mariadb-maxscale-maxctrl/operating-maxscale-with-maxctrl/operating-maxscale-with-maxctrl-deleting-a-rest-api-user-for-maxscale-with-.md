...
MaxCtrl is a command-line utility that can perform administrative tasks using MaxScale's [MaxScale's REST API](README.md). It can be used to delete a user for the [MaxScale's REST API](README.md).
