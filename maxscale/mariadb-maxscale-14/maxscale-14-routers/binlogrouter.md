...
The binlogrouter requires the `<code>server</code>`, `<code>user</code>` and `<code>passwd</code>` parameters. These should be configured according to the [Configuration Guide](../maxscale-14-getting-started/maxscale-configuration-usage-scenarios.md#service).
