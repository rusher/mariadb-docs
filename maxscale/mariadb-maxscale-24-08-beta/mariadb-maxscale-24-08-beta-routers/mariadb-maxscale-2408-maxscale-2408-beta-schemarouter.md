...
`<code>ignore_tables_regex=.*</code>`. Starting with MaxScale 24.08, the detection of
duplicate tables can be turned off with `<code>allow_duplicates=true</code>`.
...
* [SchemaRouter](#schemarouter)
  ...
  * [Module commands](#module-commands)
    ...
    * [invalidate SERVICE](#invalidate-service)
...
possible with `<code>ignore_tables_regex=.*</code>`.
...
[the MaxScale core](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)
in MaxScale 6.0.
