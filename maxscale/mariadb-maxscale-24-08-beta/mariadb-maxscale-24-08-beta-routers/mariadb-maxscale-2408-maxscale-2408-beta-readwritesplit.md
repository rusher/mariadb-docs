...
[here](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md). Note that since
...
[connection_timeout](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)
parameter.
...
The timeout is
[a duration type](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md)
...
individual DML statements that `<code>delayed_retry</code>` enables. The result of this is
...
replayed. This means that when `<code>transaction_replay_safe_commit</code>` is enabled,
...
[OptimisticTrx](../mariadb-maxscale-24-08-beta-filters/mariadb-maxscale-2408-maxscale-2408-beta-optimistic-transaction-execution-filter.md) filter in MaxScale 24.08 and the
...
[CCRFilter](../mariadb-maxscale-24-08-beta-filters/mariadb-maxscale-2408-maxscale-2408-beta-consistent-critical-read-filter.md) module provides.
...
The `<code>SET</code>` command will synchronize the replica to a certain logical point in
...
[strict_multi_stmt](mariadb-maxscale-2408-maxscale-2408-beta-readwritesplit.md) for more
details.
