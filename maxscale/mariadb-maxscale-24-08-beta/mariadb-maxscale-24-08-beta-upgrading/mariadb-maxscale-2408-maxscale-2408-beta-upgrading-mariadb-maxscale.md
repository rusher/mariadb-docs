...
[ChangeLog](../mariadb-maxscale-2408-maxscale-2408-beta-changelog.md) and to the
...
* [Upgrading MariaDB MaxScale from 24.02 to 24.08](#upgrading-mariadb-maxscale-from-2402-to-2408)
...
* [Upgrading MariaDB MaxScale from 2.0 to 2.1](#upgrading-mariadb-maxscale-from-20-to-21)
  ...
  * [ReadWriteSplit](#readwritesplit_2)
...
The `<code>reuse_prepared_statements</code>` parameter has been replaced with the use of the
[PsReuse](../mariadb-maxscale-24-08-beta-filters/mariadb-maxscale-2408-maxscale-2408-beta-psreuse.md) filter module.
...
The `<code>optimistic_trx</code>` parameter has been replaced with the use of the
[OptimisticTrx](../mariadb-maxscale-24-08-beta-filters/mariadb-maxscale-2408-maxscale-2408-beta-optimistic-transaction-execution-filter.md) filter module.
...
[protocol documentation](../mariadb-maxscale-24-08-beta-authenticators/mariadb-maxscale-2408-maxscale-2408-beta-authentication-modules.md).
