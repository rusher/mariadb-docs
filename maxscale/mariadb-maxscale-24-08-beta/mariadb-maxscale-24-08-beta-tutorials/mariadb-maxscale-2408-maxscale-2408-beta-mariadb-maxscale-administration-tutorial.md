...
by enabling [admin_audit](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md).
...
For e.g. `<code>maxctrl alter maxscale admin_audit_file=/var/log/maxscale/admin_audit.march.csv</code>`.
...
[Configuration Guide](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) for a full list
