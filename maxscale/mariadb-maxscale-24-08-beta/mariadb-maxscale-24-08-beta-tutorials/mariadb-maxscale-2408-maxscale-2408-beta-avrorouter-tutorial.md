...
[Avrorouter](../mariadb-maxscale-24-08-beta-routers/mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md), how to set it up and how it interacts
...
* Dump the database to a replica, configure it to replicate from the primary and
 ...
 extra steps)
* Use the [cdc_schema Go utility](../mariadb-maxscale-24-08-beta-routers/mariadb-maxscale-2408-maxscale-2408-beta-avrorouter.md)
...
[Binlogrouter](../mariadb-maxscale-24-08-beta-routers/mariadb-maxscale-2408-maxscale-2408-beta-binlogrouter.md) documentation.
