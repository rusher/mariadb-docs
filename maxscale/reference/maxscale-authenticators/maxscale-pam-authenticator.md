...
* [PAM Authenticator](maxscale-pam-authenticator.md#pam-authenticator)
  ...
  * [Settings](maxscale-pam-authenticator.md#settings)
    * [pam\_use\_cleartext\_plugin](maxscale-pam-authenticator.md#pam_use_cleartext_plugin)
    * [pam\_mode](maxscale-pam-authenticator.md#pam_mode)
    * [pam\_backend\_mapping](maxscale-pam-authenticator.md#pam_backend_mapping)
    * [pam\_mapped\_pw\_file](maxscale-pam-authenticator.md#pam_mapped_pw_file)
...
Anonymous mapping is only attempted if the client username is not found in the`mysql.user`-table as explained in [Configuration](maxscale-pam-authenticator.md#configuration). This means,\
