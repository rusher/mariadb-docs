...
client. Since each server generates their own random messages, MaxScale
...
MaxScale now authenticates incoming clients with ed25519 if their user
...
[user mapping](../../maxscale-management/deployment/maxscale-configuration-guide.md#user_mapping_file)
