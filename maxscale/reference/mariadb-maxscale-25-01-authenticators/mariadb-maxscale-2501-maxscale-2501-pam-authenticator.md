...
* [PAM Authenticator](mariadb-maxscale-2501-maxscale-2501-pam-authenticator.md#pam-authenticator)
  * [Configuration](mariadb-maxscale-2501-maxscale-2501-pam-authenticator.md#configuration)
  * [Settings](mariadb-maxscale-2501-maxscale-2501-pam-authenticator.md#settings)
    * [pam\_use\_cleartext\_plugin](mariadb-maxscale-2501-maxscale-2501-pam-authenticator.md#pam_use_cleartext_plugin)
    * [pam\_mode](mariadb-maxscale-2501-maxscale-2501-pam-authenticator.md#pam_mode)
    * [pam\_backend\_mapping](mariadb-maxscale-2501-maxscale-2501-pam-authenticator.md#pam_backend_mapping)
    * [pam\_mapped\_pw\_file](mariadb-maxscale-2501-maxscale-2501-pam-authenticator.md#pam_mapped_pw_file)
  * [Anonymous user mapping](mariadb-maxscale-2501-maxscale-2501-pam-authenticator.md#anonymous-user-mapping)
  * [Implementation details and limitations](mariadb-maxscale-2501-maxscale-2501-pam-authenticator.md#implementation-details-and-limitations)
    * [Two-factor authentication support](mariadb-maxscale-2501-maxscale-2501-pam-authenticator.md#two-factor-authentication-support)
  * [Test tool](mariadb-maxscale-2501-maxscale-2501-pam-authenticator.md#test-tool)
...
can be manually added using the service setting[user\_accounts\_file](../../maxscale-versions/mariadb-maxscale-25-01/mariadb-maxscale-25-01-getting-started/mariadb-maxscale-2501-maxscale-2501-mariadb-maxscale-configuration-guide.md).
...
Instead of using `pam_backend_mapping`, consider using the listener setting[user\_mapping\_file](../../maxscale-versions/mariadb-maxscale-25-01/mariadb-maxscale-25-01-getting-started/mariadb-maxscale-2501-maxscale-2501-mariadb-maxscale-configuration-guide.md),\
