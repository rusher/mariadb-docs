---
description: >-
  Enforce read-only access at the proxy level. This filter rejects modification
  statements like INSERT or UPDATE protecting the database from accidental
  writes.
---
...
This filter is an _implicit filter_ and has no configuration parameters and does not need its own configuration section. To enable it, simply add it to the service using the module name.
