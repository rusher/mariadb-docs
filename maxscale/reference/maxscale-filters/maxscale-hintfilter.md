---
description: >-
  Control query routing using SQL comments. This filter interprets hints
  embedded in queries to direct traffic to specific servers, primaries, or
  replicas.
---
...
Support for binary protocol prepared statements was added in MaxScale 6.0 ([MXS-2838](https://jira.mariadb.org/browse/MXS-2838)).
