...
backend (and cached). See also [soft\_ttl](maxscale-cache.md#soft_ttl).
...
However, as long as [hard\_ttl](maxscale-cache.md#hard_ttl) has not passed, _all_ other clients\
...
as described [here](../../maxscale-archive/archive-of-2x.xx-versions/mariadb-maxscale-25-01/mariadb-maxscale-25-01-getting-started/mariadb-maxscale-2501-maxscale-2501-mariadb-maxscale-configuration-guide.md).
...
be disabled and a connection attempt will be made after a [timeout](maxscale-cache.md#timeout)\
interval.
...
However, when the[query classifier cache](../../maxscale-archive/archive-of-2x.xx-versions/mariadb-maxscale-25-01/mariadb-maxscale-25-01-getting-started/mariadb-maxscale-2501-maxscale-2501-mariadb-maxscale-configuration-guide.md)\
