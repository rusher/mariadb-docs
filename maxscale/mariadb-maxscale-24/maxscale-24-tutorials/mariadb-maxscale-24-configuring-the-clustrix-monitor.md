...
is the name of the monitor, in this example</code>`Clustrix` and *id* is the node id
...
using the `<code>cluster</code>` parameter. This will cause the service to use the Clustrix
nodes that the Clustrix monitor discovers at runtime.


For additional details, please consult the monitor
[documentation](../maxscale-24-monitors/mariadb-maxscale-24-clustrix-monitor.md).
