...
Read the [Authentication Modules](mariadb-maxscale-24-authentication-modules-in-maxscale.md) document for more
...
See the [Limitations](../about-maxscale-24/mariadb-maxscale-24-limitations-and-known-issues-within-mariadb-maxscale.md) document for more details.
