...
Please see the
[documentation](../maxscale-24-monitors/mariadb-maxscale-24-clustrix-monitor.md) for details.


### Smart Router


MaxScale has now a new router *SmartRouter* that is capable of routing a query
...
Please see the
[documentation](../maxscale-24-routers/mariadb-maxscale-24-smartrouter.md) for details.
...
A server is set in the *Draining* state the same way as it is
set in the *Maintenance* state:
...
[socket](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md) parameter to define
...
*Not* providing an explicit unit is strongly discouraged as it will be
...
[max_auth_errors_until_block](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)
...
[MariaDB-Monitor documentation](../maxscale-24-monitors/mariadb-maxscale-24-mariadb-monitor.md#enforce_simple_topology)
for more information.
