...
[Install MariaDB MaxScale using a Tarball](mariadb-maxscale-24-installing-mariadb-maxscale-using-a-tarball.md).
...
[Building MariaDB MaxScale from Source Code](mariadb-maxscale-24-building-mariadb-maxscale-from-source-code.md)
...
[Configuration Guide](mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md) and the module specific documents
...
Two command line tools are available, `<code>maxctrl</code>` and `<code>maxadmin</code>`, that will interact with a running
