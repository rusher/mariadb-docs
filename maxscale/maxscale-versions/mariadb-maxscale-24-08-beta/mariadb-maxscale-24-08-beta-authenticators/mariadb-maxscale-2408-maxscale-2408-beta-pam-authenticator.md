# MaxScale 24.08 Beta PAM Authenticator

* [PAM Authenticator](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md#pam-authenticator)
  * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md#configuration)
    * [pam\_use\_cleartext\_plugin](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md#pam_use_cleartext_plugin)
    * [pam\_mode](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md#pam_mode)
    * [pam\_backend\_mapping](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md#pam_backend_mapping)
    * [pam\_mapped\_pw\_file](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md#pam_mapped_pw_file)
  * [Anonymous user mapping](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md#anonymous-user-mapping)
  * [Implementation details and limitations](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md#implementation-details-and-limitations)
    * [Two-factor authentication support](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md#two-factor-authentication-support)
  * [Test tool](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md#test-tool)
...
operating system PAM config is used for authenticating the user. If th&#x65;_&#x61;uthentication\_string_ for a user is empty, the fallback service "mysql" is\
used.
...
second password. See[the limitations section](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md#implementation-details-and-limitations)\
...
can be manually added using the service setting[user\_accounts\_file](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md).
...
Instead of using `pam_backend_mapping`, consider using the listener setting[user\_mapping\_file](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md),\
...
Anonymous mapping is only attempted if the client username is not found in the`mysql.user`-table as explained in [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-pam-authenticator.md#configuration). This means,\
