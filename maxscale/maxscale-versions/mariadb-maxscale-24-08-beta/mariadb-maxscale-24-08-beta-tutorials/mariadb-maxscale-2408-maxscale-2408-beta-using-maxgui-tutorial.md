...
* [Using MaxGUI Tutorial](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#using-maxgui-tutorial)
* [Introduction](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#introduction)
* [Dashboard](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#dashboard)
  * [Annotation](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#annotation)
  * [Create a new MaxScale object](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#create-a-new-maxscale-object)
  * [View Replication Status](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#view-replication-status)
  * [How to kill a session](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#how-to-kill-a-session)
    * [Annotation](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#annotation_1)
  * [View sessions created by the "Workspace"](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#view-sessions-created-by-the-workspace)
    * [Dashboard "Current Sessions" tab](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#dashboard-current-sessions-tab)
      * [Annotation](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#annotation_2)
    * [Query Editor "Processlist"](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#query-editor-processlist)
      * [Annotation](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#annotation_3)
* [Detail](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#detail)
  * [Annotation](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#annotation_4)
* [Visualization](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#visualization)
  * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#configuration)
    * [Annotation](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#annotation_5)
  * [Clusters](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#clusters)
    * [Annotation](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#annotation_6)
* [Settings](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#settings)
  * [Annotation](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#annotation_7)
* [Logs Archive](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#logs-archive)
  * [Annotation](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#annotation_8)
* [Workspace](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#workspace)
  * [Run Queries](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#run-queries)
    * [Query Editor worksheet](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#query-editor-worksheet)
      * [Create a new connection](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#create-a-new-connection)
      * [Schemas objects sidebar](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#schemas-objects-sidebar)
        * [Set the current database](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#set-the-current-database)
        * [Preview table data of the top 1000 rows](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#preview-table-data-of-the-top-1000-rows)
        * [Describe table](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#describe-table)
        * [Alter/Drop/Truncate/Create table](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#alterdroptruncatecreate-table)
        * [Alter/Drop/Create schema](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#alterdropcreate-schema)
        * [Alter/Create View, Function, Stored Procedure, Trigger](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#altercreate-view-function-stored-procedure-trigger)
        * [Quickly insert an object into the editor](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#quickly-insert-an-object-into-the-editor)
        * [Show object creation statement and insights info](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#show-object-creation-statement-and-insights-info)
      * [Editor](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#editor)
        * [How to write compound statements](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#how-to-write-compound-statements)
          * [Annotation](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#annotation_9)
      * [Re-execute old queries](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#re-execute-old-queries)
      * [Create query snippet](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#create-query-snippet)
      * [Generate an ERD](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#generate-an-erd)
  * [Data Migration](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#data-migration)
    * [Data Migration worksheet](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#data-migration-worksheet)
      * [Connections](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#connections)
      * [Objects Selection](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#objects-selection)
      * [Migration](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#migration)
      * [Migration report](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#migration-report)
  * [Create an ERD](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#create-an-erd)
    * [ERD worksheet](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#erd-worksheet)
      * [Generate an ERD from the existing databases](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#generate-an-erd-from-the-existing-databases)
      * [Create a new ERD](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#create-a-new-erd)
      * [Entity options](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#entity-options)
      * [Foreign keys quick common options](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#foreign-keys-quick-common-options)
      * [Viewing foreign key constraint SQL](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#viewing-foreign-key-constraint-sql)
      * [Quickly draw a foreign key link](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#quickly-draw-a-foreign-key-link)
      * [Entity editor](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#entity-editor)
      * [Export options](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#export-options)
      * [Applying the script](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#applying-the-script)
      * [Visual Enhancement options](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#visual-enhancement-options)
...
![](<../../../.gitbook/assets/MaxGUI-dashboard.png (2).png>)
...
The replication status of a server monitored by[MariaDB-Monitor](../mariadb-maxscale-2408-beta-maxscale-24-08-beta-monitors/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md) can be viewed by mousing over\
...
found on the [Dashboard](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#dashboard), Server detail, and Service detail page.

![](<../../../.gitbook/assets/MaxGUI-kill-session.png (2).png>)
...
![](<../../../.gitbook/assets/MaxGUI-detail.png (2).png>)
...
![](<../../../.gitbook/assets/MaxGUI-config-visualization.png (2).png>)
...
This page shows all monitor clusters using[mariadbmon](../mariadb-maxscale-2408-beta-maxscale-24-08-beta-monitors/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-monitor.md) module in a card-like view.\
Clicking on the card will visualize the cluster into a tree graph as shown in\
the figure below.

![](<../../../.gitbook/assets/MaxGUI-cluster-visualization.png (2).png>)
...
![](<../../../.gitbook/assets/MaxGUI-settings.png (2).png>)
...
![](<../../../.gitbook/assets/MaxGUI-logs-archive.png (2).png>)
...
![](<../../../.gitbook/assets/MaxGUI-workspace.png (2).png>)
...
![](<../../../.gitbook/assets/MaxGUI-workspace-query-editor.png (2).png>)
...
To view the statement that creates the given object in the [Schemas objects sidebar](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#schemas-objects-sidebar), right-clicking on schema or table node and\
...
To re-execute a query, follow the same step to [insert an object into the editor](mariadb-maxscale-2408-maxscale-2408-beta-using-maxgui-tutorial.md#quickly-insert-an-object-into-the-editor)\
...
![](<../../../.gitbook/assets/MaxGUI-workspace-data-migration-set-up-connections.png (2).png>)
...
![](<../../../.gitbook/assets/MaxGUI-workspace-data-migration-objects-selection.png (2).png>)
...
![](<../../../.gitbook/assets/MaxGUI-workspace-data-migration-migration-script.png (2).png>)
...
![](<../../../.gitbook/assets/MaxGUI-workspace-data-migration-migration-report.png (2).png>)
