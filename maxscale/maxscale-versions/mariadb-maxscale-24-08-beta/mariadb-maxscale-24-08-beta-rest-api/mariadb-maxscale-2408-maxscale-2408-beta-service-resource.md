# MaxScale 24.08 Beta Service Resource
...
* [Service Resource](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#service-resource)
  * [Resource Operations](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#resource-operations)
    * [Get a service](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#get-a-service)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#response)
    * [Get all services](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#get-all-services)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#response_1)
    * [Create a service](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#create-a-service)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#response_2)
    * [Destroy a service](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#destroy-a-service)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#response_3)
    * [Update a service](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#update-a-service)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#response_4)
    * [Update service relationships](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#update-service-relationships)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#response_5)
    * [Stop a service](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#stop-a-service)
      * [Parameters](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#parameters)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#response_6)
    * [Start a service](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#start-a-service)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#response_7)
    * [Reload users of a service](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#reload-users-of-a-service)
      * [Response](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#response_8)
    * [Get service listeners](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#get-service-listeners)
    * [Get a single service listener](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#get-a-single-service-listener)
    * [Create a new listener](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#create-a-new-listener)
    * [Destroy a listener](mariadb-maxscale-2408-maxscale-2408-beta-service-resource.md#destroy-a-listener)
...
* The [user](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) to use
* `data.attributes.parameters.password`
* The [password](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) to use
...
server names into the[servers](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) parameter. For\
filters, this is equivalent to adding the filters in the`data.relationships.filters.data` array to the[filters](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) parameter in the\
order they appear. For other services, this is equivalent to adding the list of\
server names into the[targets](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) parameter.
...
To find out whether a service is still in use after it has been destroyed, the[sessions](mariadb-maxscale-2408-maxscale-2408-beta-session-resource.md) resource should be used. If a session for\
...
All standard service parameters can be modified. Refer to the[service](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) documentation on\
...
to the [filters](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md) parameter\
for more details.
...
This endpoint is deprecated, use the[this](mariadb-maxscale-2408-maxscale-2408-beta-listener-resource.md) listeners endpoint instead.
...
This endpoint is deprecated, use the [this](mariadb-maxscale-2408-maxscale-2408-beta-listener-resource.md)\
