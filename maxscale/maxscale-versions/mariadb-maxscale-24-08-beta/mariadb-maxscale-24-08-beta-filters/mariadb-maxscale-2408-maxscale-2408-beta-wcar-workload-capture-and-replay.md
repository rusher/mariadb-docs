# MaxScale 24.08 Beta WCAR: Workload Capture and Replay
...
* [WCAR: Workload Capture and Replay](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#wcar-workload-capture-and-replay)
  * [Prerequisites](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#prerequisites)
* [Capture](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#capture)
  * [Configuration](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#configuration)
  * [Example configuration](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#example-configuration)
  * [Capturing Traffic](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#capturing-traffic)
  * [Stopping the Capture](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#stopping-the-capture)
* [WCAR Commands](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#wcar-commands)
  * [start \[options\]](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#start-filter-options)
  * [stop](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#stop-filter)
* [Replay](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#replay)
  * [Installation](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#installation)
  * [Preparing the Replay MariaDB Database](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#preparing-the-replay-mariadb-database)
    * [Full Restore](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#full-restore)
    * [Restore for read-only Replay](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#restore-for-read-only-replay)
  * [Replaying the Capture](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#replaying-the-capture)
* [Visualizing](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#visualizing)
* [WCAR Parameters](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#wcar-parameters)
  * [capture\_dir](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#capture_dir)
  * [start\_capture](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#start_capture)
  * [capture\_duration](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#capture_duration)
  * [capture\_size](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#capture_size)
* [maxplayer command line options](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#maxplayer-command-line-options)
* [Limitations](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#limitations)
...
Once MaxScale has been started, the captured traffic will be written to files in`/var/lib/maxscale/wcar/<name>` where `<name>` is the name of the filter (`WCAR`\
in the examples).
...
date and `HHMMSS` is the time and the `SUFFIX` is one of `.cx`, `.ex` or`.gx`. For example, a capture started on the 18th of April 2024 at 10:26:11\
...
* **duration** Limit capture to this duration. See also configuration file value ['capture\_duration'](mariadb-maxscale-2408-maxscale-2408-beta-wcar-workload-capture-and-replay.md#capture_duration).
* **size** Limit capture to approximately this many bytes in the file system. See also configuration file value ['capture\_size'](https://mariadb.com/kb/en/capture_size).
...
maxplayer -u user -p pwd --speed 1.5 -i 5s -o baseline.csv /home/mariadb/maxscale/var/lib/maxscale/wcar/WCAR/capture\_2024-06-11\_135251.cx --help\
File /home/mariadb/maxscale/var/lib/maxscale/wcar/WCAR/capture\_2024-06-11\_135251.cx does not exist\
...
\--host The address of the replay server in : format.\
...
\--analyze Enabling this option will track the server Rows\_read statistic for each query.\
...
Input file: /home/mariadb/maxscale/var/lib/maxscale/wcar/WCAR/capture\_2024-06-11\_135251.cx
...
* COM\_RESET\_CONNECTION is not captured ([MXS-5055](https://jira.mariadb.org/browse/MXS-5055))
