...
* [Diff - router for comparing servers](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#diff-router-for-comparing-servers)
  * [Overview](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#overview)
    * [Histogram](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#histogram)
    * [Discrepancies](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#discrepancies)
    * [EXPLAIN](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#explain)
    * [QPS](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#qps)
    * [Reporting](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#reporting)
  * [Setup](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#setup)
    * [Prerequisites](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#prerequisites)
    * [Running Diff](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#running-diff)
      * [Create](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#create)
      * [Start](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#start)
      * [Status](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#status)
      * [Summary](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#summary)
      * [Stop](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#stop)
      * [Destroy](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#destroy)
  * [Visualizing](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#visualizing)
  * [Continuous Reporting](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#continuous-reporting)
  * [Mode](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#mode)
  * [Configuration Parameters](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#configuration-parameters)
    * [main](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#main)
    * [service](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#service)
    * [explain](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#explain_1)
    * [explain\_entries](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#explain_entries)
    * [explain\_period](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#explain_period)
    * [max\_request\_lag](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#max_request_lag)
    * [on\_error](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#on_error)
    * [percentile](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#percentile)
    * [qps\_window](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#qps_window)
    * [report](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#report)
    * [reset\_replication](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#reset_replication)
    * [retain\_faster\_statements](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#retain_faster_statements)
    * [retain\_slower\_statements](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#retain_slower_statements)
    * [samples](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#samples)
  * [Limitations](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#limitations)
...
Before starting to register histogram data, Diff will collect[samples](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#samples) from _main_ that will be used for defining the\
...
EXPLAINs are not always executed, but the frequency is controlled by[explain\_entries](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#explain_entries) and[explain\_period](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#explain_period). The EXPLAIN results are included in\
the [output](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#reporting) of Diff.

#### QPS

While running, Diff will also collect QPS information over a sliding\
window whose size is defined by [qps\_period](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#qps_period).

#### Reporting

Diff produces two kinds of output:

* Output that is generated when Diff terminates or upon[request](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#summary). That output can be visualized as explained[here](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#visualizing).
* [Optionally](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#report) Diff can continuously report queries whose\
  responses from _main_ and other _differ_ as described[here](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#discrepancies).
...
service specified in [service](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#service). The output files are created\
in that directory.
...
The visualization of the results is done using the[maxvisualize](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#visualizing) program.
...
every time [summary](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#summary) is executed.
...
If the value of [report](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#report) is something else but `never`, Diff\
...
Diff will, depending on the value of[reset\_replication](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#reset_replication)\
...
a server and must be one of the servers listed in[targets](../mariadb-maxscale-24-08-beta-getting-started/mariadb-maxscale-2408-maxscale-2408-beta-mariadb-maxscale-configuration-guide.md).
...
* Type: [enum](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#enumerations)
* Mandatory: No
* Dynamic: Yes
...
is EXPLAINed during the period specified by[explain\_period](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#explain_period).
...
Specifies the length of the period during which at most[explain\_entries](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#explain_entries) number of EXPLAINs are executed\
for a statement.
...
and stored. When a [summary](mariadb-maxscale-2408-maxscale-2408-beta-diff-router-for-comparing-servers.md#summary) is requested, the QPS information\
will also be saved.
