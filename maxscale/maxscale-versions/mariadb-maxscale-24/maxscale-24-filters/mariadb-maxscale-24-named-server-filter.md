...
also be embedded into SQL-queries, see[Hint-Syntax](../maxscale-24-reference/mariadb-maxscale-24-hint-syntax.md).
...
_matchXY_ defines a[PCRE2 regular expression](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md)\
...
attaches a routing hint defined by the _target_-setting to the query. Th&#x65;_&#x6F;ptions_-parameter affects how the patterns are compiled as[usual](../maxscale-24-getting-started/mariadb-maxscale-24-mariadb-maxscale-configuration-guide.md).
