...
a dry-run mode. For more information about the firewall filter, please refer to[Database Firewall Filter](../maxscale-14-filters/maxscale-database-firewall-filter.md).
...
on how to configure this, please refer to the[MaxScale Configuration Guide](../maxscale-14-getting-started/maxscale-configuration-usage-scenarios.md#listener-and-ssl).
...
For more information, refer to the configuration guide:[MaxScale Configuration Guide](../maxscale-14-getting-started/maxscale-configuration-usage-scenarios.md#service).
...
details about how to do this, please refer to the installation guide:[MariaDB MaxScale Installation Guide](../maxscale-14-getting-started/mariadb-maxscale-installation-guide.md)
...
* [MXS-497](https://jira.mariadb.org/browse/MXS-497): MaxScale does not contemplate client multiple statements (CLIENT\_MULTI\_STATEMENTS)
...
For more information, please refer to the [Limitations](../about-maxscale-14/limitations-and-known-issues-within-maxscale.md) document.
