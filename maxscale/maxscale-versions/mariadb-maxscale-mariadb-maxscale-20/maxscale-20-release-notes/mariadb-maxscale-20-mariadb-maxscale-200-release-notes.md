...
The [Avrorouter Tutorial](../../mariadb-maxscale-21-06/) contains\
information on how to get started with the binlog-to-Avro translation.

The [Avrorouter](../../mariadb-maxscale-21-06/) documentation has more information\
on the details of this conversion process and how to configure the module.

The [CDC Protocol](../../mariadb-maxscale-21-06/) documentation contains the details of\
the new protocol.
