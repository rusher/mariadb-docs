...
server names into the[servers](../../mariadb-maxscale-21-06/) parameter. For\
filters, this is equivalent to adding the filters in the`data.relationships.filters.data` array to the[filters](../../mariadb-maxscale-21-06/) parameter in the\
order they appear.
...
* [authenticator\_options](../../mariadb-maxscale-21-06/)
...
All standard service parameters can be modified. Refer to the[service](../../mariadb-maxscale-21-06/) documentation on\
...
to the [filters](../../mariadb-maxscale-21-06/) parameter\
for more details.
