...
This tutorial is a part of the [MariaDB MaxScale Tutorial](../../mariadb-maxscale-21-06/).\
...
user authentication data. These users were created at the start of the[MaxScale Tutorial](../../mariadb-maxscale-21-06/).

For increased security, see [password encryption](../../mariadb-maxscale-21-06/).
...
For the last steps, please return to [MaxScale Tutorial](../../mariadb-maxscale-21-06/).
