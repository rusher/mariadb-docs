...
![](<../../../.gitbook/assets/Simple-Sharding.png (2).png>)
...
Follow the [MaxScale Tutorial](mariadb-maxscale-2302-setting-up-mariadb-maxscale.md) to install and prepare the required database users for MaxScale. You don't need to create the configuration file for MaxScale as it will be covered in the next section.
