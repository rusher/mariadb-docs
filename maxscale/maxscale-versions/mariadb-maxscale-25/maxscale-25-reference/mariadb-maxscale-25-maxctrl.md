...
For more information about the MaxScale REST API, refer to the[REST API documentation](../maxscale-25-rest-api/mariadb-maxscale-25-rest-api.md) and the[Configuration Guide](../maxscale-25-getting-started/mariadb-maxscale-25-mariadb-maxscale-configuration-guide.md).

* [MaxCtrl](mariadb-maxscale-25-maxctrl.md#maxctrl)
* [Limitations](mariadb-maxscale-25-maxctrl.md#limitations)
* [Commands](mariadb-maxscale-25-maxctrl.md#commands)
  * [list](mariadb-maxscale-25-maxctrl.md#list)
    * [list servers](mariadb-maxscale-25-maxctrl.md#list-servers)
    * [list services](mariadb-maxscale-25-maxctrl.md#list-services)
    * [list listeners](mariadb-maxscale-25-maxctrl.md#list-listeners)
    * [list monitors](mariadb-maxscale-25-maxctrl.md#list-monitors)
    * [list sessions](mariadb-maxscale-25-maxctrl.md#list-sessions)
    * [list filters](mariadb-maxscale-25-maxctrl.md#list-filters)
    * [list modules](mariadb-maxscale-25-maxctrl.md#list-modules)
    * [list threads](mariadb-maxscale-25-maxctrl.md#list-threads)
    * [list users](mariadb-maxscale-25-maxctrl.md#list-users)
    * [list commands](mariadb-maxscale-25-maxctrl.md#list-commands)
  * [show](mariadb-maxscale-25-maxctrl.md#show)
    * [show server](mariadb-maxscale-25-maxctrl.md#show-server)
    * [show servers](mariadb-maxscale-25-maxctrl.md#show-servers)
    * [show service](mariadb-maxscale-25-maxctrl.md#show-service)
    * [show services](mariadb-maxscale-25-maxctrl.md#show-services)
    * [show monitor](mariadb-maxscale-25-maxctrl.md#show-monitor)
    * [show monitors](mariadb-maxscale-25-maxctrl.md#show-monitors)
    * [show session](mariadb-maxscale-25-maxctrl.md#show-session)
    * [show sessions](mariadb-maxscale-25-maxctrl.md#show-sessions)
    * [show filter](mariadb-maxscale-25-maxctrl.md#show-filter)
    * [show filters](mariadb-maxscale-25-maxctrl.md#show-filters)
    * [show listener](mariadb-maxscale-25-maxctrl.md#show-listener)
    * [show listeners](mariadb-maxscale-25-maxctrl.md#show-listeners)
    * [show module](mariadb-maxscale-25-maxctrl.md#show-module)
    * [show modules](mariadb-maxscale-25-maxctrl.md#show-modules)
    * [show maxscale](mariadb-maxscale-25-maxctrl.md#show-maxscale)
    * [show thread](mariadb-maxscale-25-maxctrl.md#show-thread)
    * [show threads](mariadb-maxscale-25-maxctrl.md#show-threads)
    * [show logging](mariadb-maxscale-25-maxctrl.md#show-logging)
    * [show commands](mariadb-maxscale-25-maxctrl.md#show-commands)
    * [show qc\_cache](mariadb-maxscale-25-maxctrl.md#show-qc_cache)
    * [show dbusers](mariadb-maxscale-25-maxctrl.md#show-dbusers)
  * [set](mariadb-maxscale-25-maxctrl.md#set)
    * [set server](mariadb-maxscale-25-maxctrl.md#set-server)
  * [clear](mariadb-maxscale-25-maxctrl.md#clear)
    * [clear server](mariadb-maxscale-25-maxctrl.md#clear-server)
  * [drain](mariadb-maxscale-25-maxctrl.md#drain)
    * [drain server](mariadb-maxscale-25-maxctrl.md#drain-server)
  * [enable](mariadb-maxscale-25-maxctrl.md#enable)
    * [enable log-priority](mariadb-maxscale-25-maxctrl.md#enable-log-priority)
  * [disable](mariadb-maxscale-25-maxctrl.md#disable)
    * [disable log-priority](mariadb-maxscale-25-maxctrl.md#disable-log-priority)
  * [create](mariadb-maxscale-25-maxctrl.md#create)
    * [create server](mariadb-maxscale-25-maxctrl.md#create-server)
    * [create monitor](mariadb-maxscale-25-maxctrl.md#create-monitor)
    * [create service](mariadb-maxscale-25-maxctrl.md#create-service)
    * [create filter](mariadb-maxscale-25-maxctrl.md#create-filter)
    * [create listener](mariadb-maxscale-25-maxctrl.md#create-listener)
    * [create user](mariadb-maxscale-25-maxctrl.md#create-user)
    * [create report](mariadb-maxscale-25-maxctrl.md#create-report)
  * [destroy](mariadb-maxscale-25-maxctrl.md#destroy)
    * [destroy server](mariadb-maxscale-25-maxctrl.md#destroy-server)
    * [destroy monitor](mariadb-maxscale-25-maxctrl.md#destroy-monitor)
    * [destroy listener](mariadb-maxscale-25-maxctrl.md#destroy-listener)
    * [destroy service](mariadb-maxscale-25-maxctrl.md#destroy-service)
    * [destroy filter](mariadb-maxscale-25-maxctrl.md#destroy-filter)
    * [destroy user](mariadb-maxscale-25-maxctrl.md#destroy-user)
  * [link](mariadb-maxscale-25-maxctrl.md#link)
    * [link service](mariadb-maxscale-25-maxctrl.md#link-service)
    * [link monitor](mariadb-maxscale-25-maxctrl.md#link-monitor)
  * [unlink](mariadb-maxscale-25-maxctrl.md#unlink)
    * [unlink service](mariadb-maxscale-25-maxctrl.md#unlink-service)
    * [unlink monitor](mariadb-maxscale-25-maxctrl.md#unlink-monitor)
  * [start](mariadb-maxscale-25-maxctrl.md#start)
    * [start service](mariadb-maxscale-25-maxctrl.md#start-service)
    * [start monitor](mariadb-maxscale-25-maxctrl.md#start-monitor)
    * [start services](mariadb-maxscale-25-maxctrl.md#start-services)
  * [stop](mariadb-maxscale-25-maxctrl.md#stop)
    * [stop service](mariadb-maxscale-25-maxctrl.md#stop-service)
    * [stop monitor](mariadb-maxscale-25-maxctrl.md#stop-monitor)
    * [stop services](mariadb-maxscale-25-maxctrl.md#stop-services)
  * [alter](mariadb-maxscale-25-maxctrl.md#alter)
    * [alter server](mariadb-maxscale-25-maxctrl.md#alter-server)
    * [alter monitor](mariadb-maxscale-25-maxctrl.md#alter-monitor)
    * [alter service](mariadb-maxscale-25-maxctrl.md#alter-service)
    * [alter service-filters](mariadb-maxscale-25-maxctrl.md#alter-service-filters)
    * [alter logging](mariadb-maxscale-25-maxctrl.md#alter-logging)
    * [alter maxscale](mariadb-maxscale-25-maxctrl.md#alter-maxscale)
    * [alter user](mariadb-maxscale-25-maxctrl.md#alter-user)
  * [rotate](mariadb-maxscale-25-maxctrl.md#rotate)
    * [rotate logs](mariadb-maxscale-25-maxctrl.md#rotate-logs)
  * [reload](mariadb-maxscale-25-maxctrl.md#reload)
    * [reload service](mariadb-maxscale-25-maxctrl.md#reload-service)
  * [call](mariadb-maxscale-25-maxctrl.md#call)
    * [call command](mariadb-maxscale-25-maxctrl.md#call-command)
  * [cluster](mariadb-maxscale-25-maxctrl.md#cluster)
    * [cluster diff](mariadb-maxscale-25-maxctrl.md#cluster-diff)
    * [cluster sync](mariadb-maxscale-25-maxctrl.md#cluster-sync)
  * [api](mariadb-maxscale-25-maxctrl.md#api)
    * [api get](mariadb-maxscale-25-maxctrl.md#api-get)
  * [classify](mariadb-maxscale-25-maxctrl.md#classify)
...
Warning: This command is not safe to interrupt. If interrupted, the servers might not be added back to the service. For a better alternative, use `set server <server> drain`.
```
