...
[configuration guide](/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/) and the
[REST-api guide](/en/mariadb-maxscale-2208-maxscale-rest-api/).
...
[standard MySQL password](mariadb-maxscale-2208-mysql-authenticator.md),
[GSSAPI](mariadb-maxscale-2208-gssapi-client-authenticator.md) and
[pluggable authentication modules (PAM)](mariadb-maxscale-2208-pam-authenticator.md).
