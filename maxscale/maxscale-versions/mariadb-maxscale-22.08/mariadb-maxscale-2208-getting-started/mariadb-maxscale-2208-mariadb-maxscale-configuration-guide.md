...
*true* values and `false`, `no`, `off` and `0` as *false* values. The REST API
...
master. Read the
[readwritesplit documentation on server ranks](../mariadb-maxscale-2208-routers/mariadb-maxscale-2208-readwritesplit.md#server-ranks)
...
[Server Priorities](../mariadb-maxscale-2208-monitors/mariadb-maxscale-2208-galera-monitor.md#interaction-with-server-priorities)
