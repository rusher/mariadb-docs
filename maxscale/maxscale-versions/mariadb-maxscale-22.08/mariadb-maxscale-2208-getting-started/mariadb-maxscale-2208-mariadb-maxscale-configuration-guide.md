...
* [MariaDB MaxScale Configuration Guide](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#mariadb-maxscale-configuration-guide)
* [Introduction](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#introduction)
* [Concepts](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#concepts)
  * [Glossary](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#glossary)
  * [Objects](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#objects)
    * [Server](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#server)
    * [Monitor](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#monitor)
    * [Filter](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#filter)
    * [Router](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#router)
    * [Service](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#service)
    * [Listener](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#listener)
* [Administration](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#administration)
  * [Static Configuration Parameters](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#static-configuration-parameters)
* [Configuration](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#configuration)
  * [Names](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#names)
  * [Dynamic Configuration](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#dynamic-configuration)
  * [Special Parameter Types](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#special-parameter-types)
    * [Booleans](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#booleans)
    * [Sizes](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#sizes)
    * [Durations](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#durations)
    * [Regular Expressions](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#regular-expressions)
      * [Standard regular expression settings for filters](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#standard-regular-expression-settings-for-filters)
    * [Enumerations](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#enumerations)
    * [Path Lists](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#path-lists)
  * [Global Settings](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#global-settings)
    * [auto\_tune](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#auto_tune)
    * [threads](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#threads)
    * [rebalance\_period](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#rebalance_period)
    * [rebalance\_threshold](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#rebalance_threshold)
    * [rebalance\_window](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#rebalance_window)
    * [skip\_name\_resolve](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#skip_name_resolve)
    * [auth\_connect\_timeout](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#auth_connect_timeout)
    * [auth\_read\_timeout](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#auth_read_timeout)
    * [auth\_write\_timeout](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#auth_write_timeout)
    * [query\_retries](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#query_retries)
    * [query\_retry\_timeout](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#query_retry_timeout)
    * [passive](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#passive)
    * [ms\_timestamp](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#ms_timestamp)
    * [skip\_permission\_checks](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#skip_permission_checks)
    * [syslog](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#syslog)
    * [maxlog](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#maxlog)
    * [log\_warning](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_warning)
    * [log\_notice](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_notice)
    * [log\_info](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_info)
    * [log\_debug](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_debug)
    * [log\_warn\_super\_user](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_warn_super_user)
    * [log\_augmentation](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_augmentation)
    * [log\_throttling](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_throttling)
    * [logdir](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#logdir)
    * [datadir](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#datadir)
    * [secretsdir](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#secretsdir)
    * [libdir](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#libdir)
    * [sharedir](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#sharedir)
    * [cachedir](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#cachedir)
    * [piddir](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#piddir)
    * [execdir](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#execdir)
    * [connector\_plugindir](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#connector_plugindir)
    * [persistdir](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#persistdir)
    * [module\_configdir](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#module_configdir)
    * [language](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#language)
    * [query\_classifier](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#query_classifier)
    * [query\_classifier\_cache\_size](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#query_classifier_cache_size)
    * [query\_classifier\_args](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#query_classifier_args)
      * [log\_unrecognized\_statements](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_unrecognized_statements)
    * [substitute\_variables](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#substitute_variables)
    * [sql\_mode](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#sql_mode)
    * [local\_address](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#local_address)
    * [users\_refresh\_time](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#users_refresh_time)
    * [users\_refresh\_interval](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#users_refresh_interval)
    * [retain\_last\_statements](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#retain_last_statements)
    * [dump\_last\_statements](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#dump_last_statements)
    * [session\_trace](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#session_trace)
    * [session\_trace\_match](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#session_trace_match)
    * [writeq\_high\_water](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#writeq_high_water)
    * [writeq\_low\_water](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#writeq_low_water)
    * [persist\_runtime\_changes](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#persist_runtime_changes)
    * [load\_persisted\_configs](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#load_persisted_configs)
    * [max\_auth\_errors\_until\_block](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#max_auth_errors_until_block)
    * [debug](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#debug)
    * [REST API Configuration](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#rest-api-configuration)
    * [admin\_host](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_host)
    * [admin\_port](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_port)
    * [admin\_auth](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_auth)
    * [admin\_ssl\_key](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_ssl_key)
    * [admin\_ssl\_cert](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_ssl_cert)
    * [admin\_ssl\_ca\_cert](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_ssl_ca_cert)
    * [admin\_ssl\_ca](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_ssl_ca)
    * [admin\_ssl\_version](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_ssl_version)
    * [admin\_enabled](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_enabled)
    * [admin\_gui](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_gui)
    * [admin\_secure\_gui](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_secure_gui)
    * [admin\_log\_auth\_failures](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_log_auth_failures)
    * [admin\_pam\_readwrite\_service/admin\_pam\_readonly\_service](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_pam_readwrite_serviceadmin_pam_readonly_service)
    * [admin\_jwt\_algorithm](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_jwt_algorithm)
    * [admin\_jwt\_key](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_jwt_key)
    * [admin\_oidc\_url](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_oidc_url)
    * [admin\_verify\_url](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#admin_verify_url)
    * [config\_sync\_cluster](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#config_sync_cluster)
    * [config\_sync\_user](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#config_sync_user)
    * [config\_sync\_password](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#config_sync_password)
    * [config\_sync\_db](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#config_sync_db)
    * [config\_sync\_interval](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#config_sync_interval)
    * [config\_sync\_timeout](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#config_sync_timeout)
    * [key\_manager](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#key_manager)
  * [Events](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#events)
    * ['authentication\_failure'](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#authentication_failure)
  * [Service](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#service_1)
    * [router](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#router_1)
    * [filters](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#filters)
    * [targets](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#targets)
    * [servers](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#servers)
    * [cluster](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#cluster)
    * [user](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#user)
    * [password](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#password)
    * [enable\_root\_user](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#enable_root_user)
    * [localhost\_match\_wildcard\_host](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#localhost_match_wildcard_host)
    * [version\_string](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#version_string)
    * [auth\_all\_servers](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#auth_all_servers)
    * [strip\_db\_esc](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#strip_db_esc)
    * [log\_auth\_warnings](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_auth_warnings)
    * [log\_warning](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_warning_1)
    * [log\_notice](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_notice_1)
    * [log\_info](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_info_1)
    * [log\_debug](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#log_debug_1)
    * [connection\_timeout](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#connection_timeout)
    * [max\_connections](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#max_connections)
    * [session\_track\_trx\_state](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#session_track_trx_state)
    * [retain\_last\_statements](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#retain_last_statements_1)
    * [connection\_keepalive](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#connection_keepalive)
    * [force\_connection\_keepalive](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#force_connection_keepalive)
    * [net\_write\_timeout](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#net_write_timeout)
    * [max\_sescmd\_history](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#max_sescmd_history)
    * [prune\_sescmd\_history](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#prune_sescmd_history)
    * [disable\_sescmd\_history](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#disable_sescmd_history)
    * [user\_accounts\_file](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#user_accounts_file)
    * [user\_accounts\_file\_usage](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#user_accounts_file_usage)
    * [idle\_session\_pool\_time](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#idle_session_pool_time)
      * [Details, limitations and suggestions for connection sharing](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#details-limitations-and-suggestions-for-connection-sharing)
    * [multiplex\_timeout](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#multiplex_timeout)
  * [Server](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#server_1)
    * [address](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#address)
    * [port](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#port)
    * [socket](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#socket)
    * [monitoruser](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#monitoruser)
    * [monitorpw](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#monitorpw)
    * [extra\_port](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#extra_port)
    * [persistpoolmax](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#persistpoolmax)
    * [persistmaxtime](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#persistmaxtime)
    * [max\_routing\_connections](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#max_routing_connections)
    * [proxy\_protocol](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#proxy_protocol)
    * [disk\_space\_threshold](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#disk_space_threshold)
    * [rank](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#rank)
    * [priority](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#priority)
  * [Monitor](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#monitor_1)
  * [Listener](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#listener_1)
    * [service](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#service_2)
    * [protocol](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#protocol)
    * [address](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#address_1)
    * [port](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#port_1)
    * [socket](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#socket_1)
    * [authenticator](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#authenticator)
    * [authenticator\_options](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#authenticator_options)
    * [sql\_mode](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#sql_mode_1)
    * [connection\_init\_sql\_file](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#connection_init_sql_file)
    * [user\_mapping\_file](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#user_mapping_file)
* [Available Protocols](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#available-protocols)
  * [MariaDBClient](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#mariadbclient)
  * [CDC](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#cdc)
* [TLS/SSL encryption](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#tlsssl-encryption)
  * [ssl](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#ssl)
  * [ssl\_key](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#ssl_key)
  * [ssl\_cert](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#ssl_cert)
  * [ssl\_ca\_cert](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#ssl_ca_cert)
  * [ssl\_ca](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#ssl_ca)
  * [ssl\_version](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#ssl_version)
  * [ssl\_cipher](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#ssl_cipher)
  * [ssl\_cert\_verify\_depth](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#ssl_cert_verify_depth)
  * [ssl\_verify\_peer\_certificate](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#ssl_verify_peer_certificate)
  * [ssl\_verify\_peer\_host](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#ssl_verify_peer_host)
  * [ssl\_crl](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#ssl_crl)
    * [Example SSL enabled server configuration](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#example-ssl-enabled-server-configuration)
    * [Example SSL enabled listener configuration](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#example-ssl-enabled-listener-configuration)
* [Module Types](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#module-types)
  * [Routing Modules](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#routing-modules)
  * [Monitor Modules](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#monitor-modules)
  * [Filter Modules](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#filter-modules)
* [Encrypting Passwords](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#encrypting-passwords)
  * [Creating Encrypted Passwords](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#creating-encrypted-passwords)
* [Runtime Configuration Changes](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#runtime-configuration-changes)
  * [Configuration Synchronization](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#configuration-synchronization)
    * [Error Handling in Configuration Synchronization](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#error-handling-in-configuration-synchronization)
    * [Synchronization of Encrypted Passwords](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#synchronization-of-encrypted-passwords)
    * [Managing Configuration Synchronization](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#managing-configuration-synchronization)
    * [Limitations in Configuration Synchronization](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#limitations-in-configuration-synchronization)
  * [Backing Up Configuration Changes](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#backing-up-configuration-changes)
* [Encryption Key Managers](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#encryption-key-managers)
  * [File-based Key Manager](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#file-based-key-manager)
    * [Limitations](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#limitations)
    * [Parameters](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#parameters)
      * [file.keyfile](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#filekeyfile)
  * [KMIP Key Manager](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#kmip-key-manager)
    * [Limitations](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#limitations_1)
    * [Parameters](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#parameters_1)
      * [kmip.host](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#kmiphost)
      * [kmip.port](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#kmipport)
      * [kmip.cert](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#kmipcert)
      * [kmip.key](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#kmipkey)
      * [kmip.ca](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#kmipca)
  * [HashiCorp Vault Key Manager](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#hashicorp-vault-key-manager)
    * [Limitations](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#limitations_2)
    * [Parameters](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#parameters_2)
      * [vault.token](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#vaulttoken)
      * [vault.host](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#vaulthost)
      * [vault.port](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#vaultport)
      * [vault.ca](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#vaultca)
      * [vault.tls](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#vaulttls)
      * [vault.mount](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#vaultmount)
      * [vault.timeout](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#vaulttimeout)
* [Error Reporting](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#error-reporting)
* [Limitations](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#limitations_3)
* [Performance Optimization](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#performance-optimization)
  * [MaxScale Diagnostics using MaxCtrl](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#maxscale-diagnostics-using-maxctrl)
    * [Configuration](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#configuration_1)
      * [threads](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#threads_1)
      * [query\_classifier\_cache\_size](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#query_classifier_cache_size_1)
    * [Example](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#example)
* [Troubleshooting](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#troubleshooting)
  * [Systemd Watchdog](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#systemd-watchdog)
...
For more information on how to manually set these states via MaxCtrl, read the[Administration Tutorial](../mariadb-maxscale-2208-tutorials/mariadb-maxscale-2208-mariadb-maxscale-administration-tutorial.md).
...
* Type: [duration](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#durations)
* Mandatory: No
* Dynamic: Yes
* Default: `0s`
...
* Type: [boolean](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#booleans)
* Mandatory: No
* Dynamic: Yes
* Default: `false`
...
Log messages to MariaDB MaxScale's log file. The name of the log file is`maxscale.log` and it is located in the directory pointed by [logdir](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#logdir).
...
* Type: number, [duration](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#durations), [duration](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#durations)
* Mandatory: No
* Dynamic: Yes
...
* Type: [size](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#sizes)
* Mandatory: No
* Dynamic: Yes
...
* Type: [enum](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#enumerations)
* Mandatory: No
* Dynamic: No
...
* Type: [regex](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#regular-expressions)
* Mandatory: No
* Dynamic: Yes
* Default: None
...
* Type: [size](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#size)
* Mandatory: No
* Dynamic: Yes
* Default: `65536`
...
For more information, read the [REST API documentation](../../../../en/mariadb-maxscale-2208-maxscale-rest-api/).
...
* Type: [enum\_mask](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#enumerations)
* Mandatory: No
* Dynamic: No
...
documentation](../../../../en/mariadb-maxscale-2208-maxscale-rest-api/).
...
Synchronization](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#configuration-synchronization) section.
...
See [MySQL protocol authentication documentation](../../../../en/mariadb-maxscale-2208-maxscale-2208-authentication-modules/)\
...
* Type: [durations](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#durations)
* Mandatory No
* Dynamic: Yes
* Default: `0s`
...
queries will hang, possibly for a long time. The timeout is controlled by[multiplex\_timeout](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#multiplex_timeout).
...
* Type: [enum](mariadb-maxscale-2208-mariadb-maxscale-configuration-guide.md#enumeration)
* Mandatory: No
* Dynamic: Yes
* Values: `default`, `oracle`
* Default: `default`
...
See [Change Data Capture Protocol](../mariadb-maxscale-2208-protocols/mariadb-maxscale-2208-change-data-capture-cdc-protocol.md) for more information.
...
* [ReadConnRoute](../mariadb-maxscale-2208-routers/mariadb-maxscale-2208-readconnroute.md)

Read/Write aware statement based router:

* [ReadWriteSplit](../mariadb-maxscale-2208-routers/mariadb-maxscale-2208-readwritesplit.md)
...
![](../../../.gitbook/assets/mariadb-corporation/MaxScale/22.08.17/Documentation/Getting-Started/images/filter_example.png.png)
...
* [Regular Expression Filter](../mariadb-maxscale-2208--filters/mariadb-maxscale-2208-regex-filter.md)
* [Tee Filter](../mariadb-maxscale-2208--filters/mariadb-maxscale-2208-tee-filter.md)
* [Top Filter](../mariadb-maxscale-2208--filters/mariadb-maxscale-2208-top-filter.md)
* [Query Redirection Filter](../mariadb-maxscale-2208--filters/mariadb-maxscale-2208-named-server-filter.md)
...
* MaxCtrl
* [create](../mariadb-maxscale-2208-reference/mariadb-maxscale-2208-maxctrl.md#create)
* [destroy](../mariadb-maxscale-2208-reference/mariadb-maxscale-2208-maxctrl.md#destroy)
* [add](../mariadb-maxscale-2208-reference/mariadb-maxscale-2208-maxctrl.md#add)
* [remove](../mariadb-maxscale-2208-reference/mariadb-maxscale-2208-maxctrl.md#remove)
* [alter](../mariadb-maxscale-2208-reference/mariadb-maxscale-2208-maxctrl.md#alter)
* [REST API](../../../../en/mariadb-maxscale-2208-maxscale-rest-api/) documentation
...
The current limitations of MaxScale are listed in the [Limitations](../mariadb-maxscale-2208-about/mariadb-maxscale-2208-limitations-and-known-issues-within-mariadb-maxscale.md) document.
