...
* MaxGUI Query Editor has changed the type of browser storage from local storage
 ...
 [Using-MaxGUI-Tutorial](https://mariadb.com/kb/en/using-maxgui-tutorial/)
...
* The [csmon](mariadb-maxscale-2208-monitors/mariadb-maxscale-2208-columnstore-monitor.md) and [auroramon](mariadb-maxscale-2208-monitors/mariadb-maxscale-2208-aurora-monitor.md)
...
* [MariaDB MaxScale 22.08.16 Release Notes](https://mariadb.com/kb/en/maxscale-22-08-mariadb-maxscale-22-08-16-release-notes/)
* [MariaDB MaxScale 22.08.15 Release Notes](https://mariadb.com/kb/en/maxscale-22-08-mariadb-maxscale-22-08-15-release-notes-2024-12-09/)
* [MariaDB MaxScale 22.08.14 Release Notes](https://mariadb.com/kb/en/maxscale-22-08-mariadb-maxscale-22-08-14-release-notes-2024-09-09/)
* [MariaDB MaxScale 22.08.13 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-22-08-13-release-notes-2024-06-03/)
* [MariaDB MaxScale 22.08.12 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-22-08-12-release-notes-2024-03-11/)
* [MariaDB MaxScale 22.08.11 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-22-08-11-release-notes-2023-12-01/)
* [MariaDB MaxScale 22.08.10 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-22-08-10-release-notes-2023-11-06/)
* [MariaDB MaxScale 22.08.9 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-22-08-9-release-notes-2023-10-30/)
* [MariaDB MaxScale 22.08.8 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-22-08-8-release-notes-2023-08-30/)
* [MariaDB MaxScale 22.08.7 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-22-08-7-release-notes-2023-08-01/)
* [MariaDB MaxScale 22.08.6 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-22-08-6-release-notes-2023-05-26/)
* [MariaDB MaxScale 22.08.5 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-22-08-5-release-notes-2023-03-27/)
* [MariaDB MaxScale 22.08.4 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-22-08-4-release-notes-2023-01-19/)
* [MariaDB MaxScale 22.08.3 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-22-08-3-release-notes-2022-12-02/)
* [MariaDB MaxScale 22.08.2 Release Notes](mariadb-maxscale-2208-release-notes/mariadb-maxscale-2208-mariadb-maxscale-22082-release-notes-2022-10-20.md)
* [MariaDB MaxScale 22.08.1 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-22081-release-notes-2022-09-12/)
* [MariaDB MaxScale 22.08.0 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-release-notes-2022-08-17/)
...
* [MariaDB MaxScale 6.4.2 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-642-release-notes-2022-09-02/)
* [MariaDB MaxScale 6.4.1 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-641-release-notes-2022-07-14/)
* [MariaDB MaxScale 6.4.0 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-640-release-notes-2022-06-09/)
...
* [MariaDB MaxScale 6.3.1 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-631-release-notes-2022-05-16/)
* [MariaDB MaxScale 6.3.0 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-630-release-notes-2022-04-14/)
...
* MaxScale can read client user accounts from a file and map them to backend
 ...
 [user_accounts_file](https://mariadb.com/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#user_accounts_file)
 and listener setting
 [user_mapping_file](https://mariadb.com/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#user_mapping_file)
...
* [MariaDB MaxScale 6.2.4 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-624-release-notes-2022-03-30/)
* [MariaDB MaxScale 6.2.3 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-623-release-notes-2022-03-09/)
* [MariaDB MaxScale 6.2.2 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-622-release-notes-2022-02-14/)
* [MariaDB MaxScale 6.2.1 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-621-release-notes-2022-01-13/)
* [MariaDB MaxScale 6.2.0 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-620-release-notes-2021-11-26/)
...
[idle_session_pool_time](https://mariadb.com/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#idle_session_pool_time)
for more information.
...
* [MariaDB MaxScale 6.1.4 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-614-release-notes-2021-10-18/)
* [MariaDB MaxScale 6.1.3 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-613-release-notes-20211001/)
* [MariaDB MaxScale 6.1.2 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-612-release-notes-2021-09-27/)
* [MariaDB MaxScale 6.1.1 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-611-release-notes/)
* [MariaDB MaxScale 6.1.0 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-610-release-notes-2021-07-15/)
* [MariaDB MaxScale 6.0.0 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-600-release-notes-2021-06-30/)
...
* Services can now directly route to other services with the help of the
 [target](https://mariadb.com/kb/en/maxscale-2208-getting-started-mariadb-maxscale-configuration-guide/#target) parameter.
...
* The replication lag of a slave server must now be less than
 [max_slave_replication_lag](mariadb-maxscale-2208-routers/mariadb-maxscale-2208-readwritesplit.md#max_slave_replication_lag)
...
* MariaDB-Monitor supports cooperative monitoring. See
 [cooperative monitoring](mariadb-maxscale-2208-monitors/mariadb-maxscale-2208-mariadb-monitor.md#cooperative-monitoring)
 for more information.
...
* New routers, [mirror](mariadb-maxscale-2208-routers/mariadb-maxscale-2208-mirror.md) and [kafkacdc](mariadb-maxscale-2208-routers/mariadb-maxscale-2208-kafkacdc.md).
...
* [MariaDB MaxScale 2.5.21 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-2521-release-notes-2022-07-08/)
* [MariaDB MaxScale 2.5.20 Release Notes](https://mariadb.com/kb/en/mariadb-maxscale-2208-mariadb-maxscale-2520-release-notes-2022-05-10/)
