...
[Avrorouter](../mariadb-maxscale-2208-routers/mariadb-maxscale-2208-avrorouter.md), how to set it up and how it interacts
...
Documentation](../mariadb-maxscale-2208-routers/mariadb-maxscale-2208-avrorouter.md).
...
* Dump the database to a slave, configure it to replicate from the master and
 ...
 extra steps)
* Use the [cdc_schema Go utility](../mariadb-maxscale-2208-routers/mariadb-maxscale-2208-avrorouter.md#avro-schema-generator)
...
[Binlogrouter](../mariadb-maxscale-2208-routers/mariadb-maxscale-2208-binlogrouter.md) documentation.
