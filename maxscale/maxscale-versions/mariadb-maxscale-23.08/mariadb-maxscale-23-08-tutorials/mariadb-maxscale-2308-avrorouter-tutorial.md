...
[Avrorouter](../mariadb-maxscale-23-08-routers/mariadb-maxscale-2308-avrorouter.md), how to set it up and how it interacts
...
![](../../../.gitbook/assets/mariadb-corporation/MaxScale/23.08.10/Documentation/Routers/images/Binlog-Avro.png.png)
...
Documentation](../mariadb-maxscale-23-08-routers/mariadb-maxscale-2308-avrorouter.md).
...
* Dump the database to a replica, configure it to replicate from the primary and
 ...
 extra steps)
* Use the [cdc_schema Go utility](../mariadb-maxscale-23-08-routers/mariadb-maxscale-2308-avrorouter.md#avro-schema-generator)
...
[Binlogrouter](../mariadb-maxscale-23-08-routers/mariadb-maxscale-2308-binlogrouter.md) documentation.
