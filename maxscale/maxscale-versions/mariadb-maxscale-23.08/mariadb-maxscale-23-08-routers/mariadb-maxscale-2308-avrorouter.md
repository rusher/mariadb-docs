...
[Binlog Server](mariadb-maxscale-2308-binlogrouter.md).
...
naming schema *<filestem>.<n>* where *<n>* is the binlog number and *<filestem>*
...
[Building MaxScale from Source Code](../mariadb-maxscale-23-08-getting-started/mariadb-maxscale-2308-building-mariadb-maxscale-from-source-code.md)
document.
