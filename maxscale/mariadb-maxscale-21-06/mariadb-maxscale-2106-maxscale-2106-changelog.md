...
[idle_session_pool_time](mariadb-maxscale-21-06-getting-started/mariadb-maxscale-2106-maxscale-2106-mariadb-maxscale-configuration-guide.md)
for more information.
...
* Services can now directly route to other services with the help of the
 [target](mariadb-maxscale-21-06-getting-started/mariadb-maxscale-2106-maxscale-2106-mariadb-maxscale-configuration-guide.md) parameter.
...
* The replication lag of a slave server must now be less than
 [max_slave_replication_lag](mariadb-maxscale-21-06-routers/mariadb-maxscale-2106-maxscale-2106-readwritesplit.md)
...
* MariaDB-Monitor supports cooperative monitoring. See
 [cooperative monitoring](mariadb-maxscale-2106-maxscale-21-06-monitors/mariadb-maxscale-2106-maxscale-2106-mariadb-monitor.md)
 for more information.
