...
* [Authentication](#authentication)
  ...
  * [Bootstrapping the Authentication/Authorization](#bootstrapping-the-authenticationauthorization)
    ...
    * [TLS/SSL](#tlsssl)
  * [Local Account Database](#local-account-database)
...
`<code><libdir>/nosqlprotocol/<listener-name>-v1.db</code>`, where
`<code><libdir></code>` is the *libdir* of MaxScale, typically
...
* Type: enumeration (multiple values separated by `<code>,</code>` can be specified)
* Mandatory: No
...
[MaxScale tutorial](../mariadb-maxscale-21-06-tutorials/mariadb-maxscale-2106-maxscale-2106-setting-up-mariadb-maxscale.md).
