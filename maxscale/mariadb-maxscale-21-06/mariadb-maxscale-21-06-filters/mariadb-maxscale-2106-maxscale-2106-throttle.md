...
* [Throttle](#throttle)
  ...
  * [Configuration](#configuration)
    ...
    * [Allowing high frequency bursts](#allowing-high-frequency-bursts)
...
[the Database Firewall filter](mariadb-maxscale-2106-maxscale-2106-database-firewall-filter.md).
