...
See [Cassandra Storage Engine Overview](../../../server/reference/storage-engines/legacy-storage-engines/cassandra/cassandra-storage-engine-overview.md) for details.
