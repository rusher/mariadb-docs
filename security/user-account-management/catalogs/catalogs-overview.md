...
* The user cannot take a backup of all their data (not even with [mariadb-dump](../../../clients-and-utilities/mariadb-dumpslow.md)). This is because the ‘mysql’ schema, which includes users, stored procedures etc. cannot be copied as its data is shared among all server users.
...
![moving-to-catalogs](/kb/en/catalogs-overview/+image/moving-to-catalogs "moving-to-catalogs")
...
* Users can [mariadb-dump](../../../clients-and-utilities/mariadb-dumpslow.md) of all their tables (including the ‘mysql’ database) and apply it on their own on premise MariaDB or to another ‘MariaDB catalog’ to duplicate their setup.
 ...
 * [plugin](/kb/en/mysqlplugin-table/)
 * [help_*](/kb/en/mysqlhelp_category-table/) tables
 * [time_zone*](/kb/en/mysqltime_zone_name-table/) tables
 ...
 * [innodb_index_stats](/kb/en/mysqlinnodb_index_stats/) (innodb internal)
 * [servers](/kb/en/mysqlservers-table/) (federated)
 ...
 * [func](/kb/en/mysqlfunc-table/) (udf)
 * [performance_schema](../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md)
...
* A normal user can do ‘set catalog current-catalog’. This will be needed to be able to execute a [mariadb-dump](../../../clients-and-utilities/mariadb-dumpslow.md) that includes this command.
 ...
 * [mariadb-dump](../../../clients-and-utilities/mariadb-dumpslow.md)
...
Ref: [https://mariadb.com/kb/en/connection/#handshake-response-packet](https://mariadb.com/kb/en/connection/#handshake-response-packet)
...
* Use [mariadb-dump](../../../clients-and-utilities/mariadb-dumpslow.md) to dump the original data
