---
description: >-
  MariaDB Cloud REST API reference: service provisioning, pricing/billing,
  configuration, user management, backup/restore scheduling, and lifecycle
  operations via swagger docs.
---
