---
description: >-
  Configure outbound replication from a MariaDB Cloud Replicated Transactions
  service to an external MariaDB or MySQL server in your data center, AWS RDS,
  or other managed cloud.
---
