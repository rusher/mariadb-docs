...
7. See [What is MariaDB Galera Cluster?: Galera wsrep provider Versions](../../galera-cluster-quickstart-guides/mariadb-galera-cluster-guide.md) for information on which MariaDB releases uses which Galera wsrep provider versions.
