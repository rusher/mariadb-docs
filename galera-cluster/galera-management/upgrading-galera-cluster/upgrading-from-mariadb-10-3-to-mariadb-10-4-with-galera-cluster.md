...
1. First, take a look at [Upgrading from MariaDB 10.3 to MariaDB 10.4](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/install-and-upgrade-mariadb/upgrading/upgrading-to-unmaintained-mariadb-releases/upgrading-from-mariadb-103-to-mariadb-104) to see what has changed between the major versions.
...
4. Run `[mysql_upgrade](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/clients-and-utilities/legacy-clients-and-utilities/mysql_upgrade)` with the `--skip-write-binlog` option.
