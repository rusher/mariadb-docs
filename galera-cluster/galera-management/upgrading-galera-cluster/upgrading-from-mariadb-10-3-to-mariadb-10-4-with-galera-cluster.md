...
7. See [What is MariaDB Galera Cluster? Galera wsrep provider Versions](https://github.com/codership/galera/) for information on which MariaDB releases uses which Galera wsrep provider versions.
...
4. Run [mysql\_upgrade](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/clients-and-utilities/legacy-clients-and-utilities/mysql_upgrade) with the `--skip-write-binlog` option.
