...
1. First, take a look at [Upgrading from MariaDB 10.6 to MariaDB 10.11](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/getting-installing-and-upgrading-mariadb/upgrading/upgrading-from-mariadb-10-6-to-mariadb-10-11) to see what has changed between the major versions.
...
1. With wsrep off, run `[mariadb-upgrade](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/clients-and-utilities/mariadb-upgrade)` with the `--skip-write-binlog` option.
