...
1. Next, make sure that the Galera version numbers are compatible.
  ...
  1. See [What is MariaDB Galera Cluster?: Galera wsrep provider Versions](/en/what-is-mariadb-galera-cluster/#galera-wsrep-provider-versions) for information on which MariaDB releases uses which Galera wsrep provider versions.
