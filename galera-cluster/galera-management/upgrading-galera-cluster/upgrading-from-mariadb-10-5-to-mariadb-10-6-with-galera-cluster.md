...
1. First, take a look at [Upgrading from MariaDB 10.5 to MariaDB 10.6](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/install-and-upgrade-mariadb/upgrading/upgrading-from-to-specific-versions/upgrading-from-mariadb-10-5-to-mariadb-10-6) to see what has changed between the major versions.
