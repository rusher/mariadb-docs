...
* Description: Method used for taking the [state snapshot transfer (SST)](../high-availability/introduction-to-state-snapshot-transfers-ssts.md). See [Introduction to State Snapshot Transfers (SSTs): SST Methods](../high-availability/introduction-to-state-snapshot-transfers-ssts.md#sst-methods) for more information.
