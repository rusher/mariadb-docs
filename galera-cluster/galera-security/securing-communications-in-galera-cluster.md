...
The method that you would use to enable TLS for [State Snapshot Transfers (SSTs)](../high-availability/introduction-to-state-snapshot-transfers-ssts.md) would depend on the value of [wsrep\_sst\_method](../reference/galera-cluster-system-variables.md#wsrep_sst_method).
...
This SST method supports encryption in transit via [stunnel](https://www.stunnel.org/). See [Introduction to State Snapshot Transfers (SSTs): rsync](../high-availability/introduction-to-state-snapshot-transfers-ssts.md#rsync) for more information.
