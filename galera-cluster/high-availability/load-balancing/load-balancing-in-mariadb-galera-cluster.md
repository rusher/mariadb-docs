---
description: >-
  Load balancing strategies for MariaDB Galera Cluster, with MariaDB MaxScale
  as the recommended database-aware proxy and guidance on read-write splitting
  versus round-robin connections.
---
