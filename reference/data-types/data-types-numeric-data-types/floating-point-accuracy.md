...
If you are comparing [DOUBLEs](double.md) or [FLOATs](floating-point-accuracy.md) with numeric decimals, it is not safe to use the [equality](../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/equality-propagation-optimization.md) operator.
