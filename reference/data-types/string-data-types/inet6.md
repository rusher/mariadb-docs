...
The INET6 data type was added in [MariaDB 10.5.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-105-series/mariadb-1050-release-notes)
...
Besides creating one's own [stored function](/kb/en/stored-functions/), there is no a way to retrieve an INET6 value using long text representation.
...
* CAST from INET6 to [CHAR](../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/charset-narrowing-optimization.md) returns short text address notation.
* CAST from INET6 to [BINARY](../../../server-usage/programming-customizing-mariadb/stored-routines/binary-logging-of-stored-routines.md) returns its 16-byte binary string representation.
* CAST from INET6 to data types other than [CHAR](../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/charset-narrowing-optimization.md) (e.g. SIGNED, UNSIGNED, TIME, etc) returns an error.
...
An INET6 expression can be mixed for result (i.e. [UNION](../../sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/joins-subqueries/union.md), [CASE..THEN](case), [COALESCE](../../sql-statements-and-structure/operators/comparison-operators/coalesce.md) etc) with:
...
* [HEX()](../../sql-statements-and-structure/sql-statements/built-in-functions/string-functions/hex.md) with an INET6 argument returns a hexadecimal representation of the underlying 16-byte binary string
...
INET6 understands both [text](text.md) and [binary(16)](../../../server-usage/programming-customizing-mariadb/stored-routines/binary-logging-of-stored-routines.md) address representation in [prepared statement](/kb/en/prepared-statements/) parameters ([PREPARE](../../sql-statements-and-structure/sql-statements/prepared-statements/prepare-statement.md)..[EXECUTE](../../sql-statements-and-structure/sql-statements/prepared-statements/execute-statement.md) and [EXECUTE IMMEDIATE](../../sql-statements-and-structure/sql-statements/prepared-statements/execute-immediate.md) statements).

#

## Migration between BINARY(16) and INET6

Before [MariaDB 10.5.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-105-series/mariadb-1050-release-notes), you may have used [BINARY(16)](../../../server-usage/programming-customizing-mariadb/stored-routines/binary-logging-of-stored-routines.md) as a storage for IPv6 internet addresses, in combination with [INET6_ATON](../../sql-statements-and-structure/sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/inet6_aton.md) and [INET6_NTOA](../../sql-statements-and-structure/sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/inet6_ntoa.md) to respectively insert and retrieve data.

From 10.5, you can [ALTER](../../sql-statements-and-structure/sql-statements/data-definition/alter/alter-table.md) BINARY(16) columns storing IPv6 addresses to INET6. After such an alter, there is no a need to use INET6_ATON() and INET6_NTOA(). Addresses can be inserted and retrieved directly.
...
Casting from INET6 to anything other than [CHAR](../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/charset-narrowing-optimization.md) returns an error:
...
[HEX](../../sql-statements-and-structure/sql-statements/built-in-functions/string-functions/hex.md) with an INET6 argument returning a hexadecimal representation:
...
Before [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105):
...
Migrating to INET6, from [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105):
...
From [MariaDB 11.3.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-11-3-rolling-releases/mariadb-11-3-0-release-notes), casting from [INET4](inet4.md) data types to INET6 is permitted, allowing INET4 values to be inserted into INET6 columns.

Before [MariaDB 11.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-113):
...
From [MariaDB 11.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-113):
