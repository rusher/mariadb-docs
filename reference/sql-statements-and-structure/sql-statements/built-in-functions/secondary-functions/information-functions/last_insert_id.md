...
if all rows in the [INSERT](../../../../../../server-usage/programming-customizing-mariadb/views/inserting-and-updating-with-views.md) or [UPDATE](../../../data-manipulation/changing-deleting-data/update.md) statement were successful.
...
* If a [stored procedure](/kb/en/stored-procedures/) executes statements that change the value of LAST_INSERT_ID(), the new value will be seen by statements that follow the procedure call.

* For [stored functions](/kb/en/stored-functions/) and [triggers](../../../../../../server-usage/programming-customizing-mariadb/triggers-events/triggers/triggers-and-implicit-locks.md) that change the value, the value is restored when the function or trigger ends, so following statements will not see a changed value.
...
* [Sequences](/kb/en/sequences/) - an alternative to auto_increment
