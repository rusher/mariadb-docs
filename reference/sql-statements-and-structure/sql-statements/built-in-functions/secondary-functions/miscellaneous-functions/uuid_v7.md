...
From [MariaDB 11.7](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-117), it is possible to generate UUIDv4 and UUIDv7, in addition to UUIDv1.
...
Returns a Universally Unique Identifier (UUID) version 7. To generate a version 1 UUID, see the [UUID](../../../../../data-types/string-data-types/uuid-data-type.md) function. To generate a version 4 UUID, see [UUID_v4](uuid_v4.md).
...
Statements using the UUID_v7() function are [not safe for statement-based replication](/kb/en/unsafe-statements-for-replication/).
...
* [UUID()](../../../../../data-types/string-data-types/uuid-data-type.md) v1
* [UUID_v4()](uuid_v4.md)
