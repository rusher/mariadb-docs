...
This is the format used by other tools, such as [mariadb-dump](../../../../../../clients-and-utilities/mariadb-dumpslow.md).
...
If the `[LOW_PRIORITY](/en/high_priority-and-low_priority-clauses/)` keyword is used, insertions are delayed until no other clients are reading from the table. The `CONCURRENT` keyword allows the use of [concurrent inserts](../concurrent-inserts.md). These clauses cannot be specified together.
...
* The [CONNECT](../../../../../../security/user-account-management/catalogs/connecting-to-a-server-configured-for-catalogs.md) storage engine has an [XML table type](../../../../../storage-engines/connect/connect-table-types/connect-table-types-data-files.md#xml-table-type).