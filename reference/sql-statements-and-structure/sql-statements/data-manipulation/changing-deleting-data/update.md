...
updated in the order that is specified. The [LIMIT](../../../../../security/user-account-management/limiting-size-of-created-disk-temporary-files-and-tables/limiting-size-of-created-disk-temporary-files-and-tables-overview.md) clause
places a limit on the number of rows that can be updated.

Both clauses can be used with multiple-table updates. Prior to [MariaDB 10.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-103), for the multiple-table syntax, `UPDATE` updates rows in each table named in table_references that satisfy the conditions. In this case,
[ORDER BY](../selecting-data/order-by.md) and [LIMIT](../../../../../security/user-account-management/limiting-size-of-created-disk-temporary-files-and-tables/limiting-size-of-created-disk-temporary-files-and-tables-overview.md) could not be used.
...
specified as described in [SELECT](../../../../../server-usage/replication-cluster-multi-master/standard-replication/selectively-skipping-replication-of-binlog-events.md).
...
[SELECT](../../../../../server-usage/replication-cluster-multi-master/standard-replication/selectively-skipping-replication-of-binlog-events.md) privilege for any columns that are read but
