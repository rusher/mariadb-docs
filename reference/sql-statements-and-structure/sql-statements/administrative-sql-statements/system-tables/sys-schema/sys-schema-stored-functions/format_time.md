...
`format_time` is a [stored function](/en/stored-functions/) available with the [Sys Schema](../sys-schema-sys_config-table.md). Given a time in picoseconds, returns a human-readable time value and unit indicator. Unit can be:
