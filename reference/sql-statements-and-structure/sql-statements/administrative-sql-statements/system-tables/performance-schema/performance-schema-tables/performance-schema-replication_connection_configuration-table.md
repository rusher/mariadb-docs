...
The `replication_connection_configuration` table was added in [MariaDB 10.6.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-106-series/mariadb-1060-release-notes).

The [Performance Schema](../performance-schema-status-variables.md) replication_connection_configuration table displays replica's configuration settings used for connecting to the primary.
