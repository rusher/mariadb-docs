...
The [Information Schema](/en/information_schema/) `ENABLED_ROLES` table shows the enabled [roles](../../../../../../../security/user-account-management/roles/roles_overview.md) for the current session.
