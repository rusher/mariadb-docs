...
The [Information Schema](/en/information_schema/) `INNODB_BUFFER_PAGE_LRU` table contains information about pages in the [buffer pool](/en/xtradbinnodb-memory-buffer/) and how they are ordered for eviction purposes.
