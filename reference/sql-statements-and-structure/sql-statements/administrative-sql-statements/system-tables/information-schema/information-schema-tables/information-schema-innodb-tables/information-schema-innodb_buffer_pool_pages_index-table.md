...
The [Information Schema](/en/information_schema/) `INNODB_BUFFER_POOL_PAGES` table is a Percona enhancement, and is only available for XtraDB, not InnoDB (see [XtraDB and InnoDB](/en/xtradb-and-innodb/)). It contains information about [buffer pool](/en/xtradbinnodb-memory-buffer/) index pages.
