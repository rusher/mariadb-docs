...
The [Information Schema](/en/information_schema/) `CHARACTER_SETS` table contains a list of supported [character sets](/en/data-types-character-sets-and-collations/), their default collations and maximum lengths.
