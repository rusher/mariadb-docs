...
The [Information Schema](/en/information_schema/) `COLLATIONS` table contains a list of supported [collations](/en/data-types-character-sets-and-collations/).
...
For example, in [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106), the following two statements return the same results:
...
In [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105) and before, `utf8` should be specified instead of `utf8mb3`.
