...
#### MariaDB starting with [10.5.12](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-105-series/mariadb-10512-release-notes)
...
The [Information Schema](/en/information_schema/) `SQL_FUNCTIONS` table contains the list of [MariaDB functions](/en/built-in-functions/).
