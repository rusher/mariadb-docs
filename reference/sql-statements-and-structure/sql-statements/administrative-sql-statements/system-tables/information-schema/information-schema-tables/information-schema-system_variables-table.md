...
The [Information Schema](/en/information_schema/) `SYSTEM_VARIABLES` table shows current values and various metadata of all [system variables](../../../../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md).
...
| GLOBAL_VALUE_PATH | Which config file the variable got its value from. NULL if not set in any config file. Added in [MariaDB 10.5.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-105-series/mariadb-1050-release-notes). |
