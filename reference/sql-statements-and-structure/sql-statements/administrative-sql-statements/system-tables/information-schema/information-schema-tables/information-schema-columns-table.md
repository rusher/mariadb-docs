...
The [Information Schema](/kb/en/information_schema/) `COLUMNS` table provides information about columns in each table on the server.
...
| DATA_TYPE | The column's [data type](/kb/en/data-types/). |
| CHARACTER_MAXIMUM_LENGTH | Maximum length. |
| CHARACTER_OCTET_LENGTH | Same as the CHARACTER_MAXIMUM_LENGTH except for multi-byte [character sets](/kb/en/data-types-character-sets-and-collations/). |
...
| DATETIME_PRECISION | Fractional-seconds precision, or NULL if not a [time data type](/kb/en/date-and-time-data-types/). |
| CHARACTER_SET_NAME | [Character set](/kb/en/data-types-character-sets-and-collations/) if a non-binary [string data type](/kb/en/string-data-types/), otherwise NULL. |
| COLLATION_NAME | [Collation](/kb/en/data-types-character-sets-and-collations/) if a non-binary [string data type](/kb/en/string-data-types/), otherwise NULL. |
...
| IS_GENERATED | Indicates whether the column value is [generated (virtual, or computed)](/kb/en/virtual-computed-columns/). Can be ALWAYS or NEVER. |
| GENERATION_EXPRESSION | The expression used for computing the column value in a [generated (virtual, or computed)](/kb/en/virtual-computed-columns/) column. |
