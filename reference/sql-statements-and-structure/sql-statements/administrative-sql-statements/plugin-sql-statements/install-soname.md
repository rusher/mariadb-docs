...
This statement is a variant of [INSTALL PLUGIN](install-plugin.md). It installs **all** [plugins](/en/mariadb-plugins/) from a given `plugin_library`. See [INSTALL PLUGIN](install-plugin.md) for details.
