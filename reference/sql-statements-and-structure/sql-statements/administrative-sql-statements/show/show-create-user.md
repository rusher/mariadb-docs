...
Shows the [CREATE USER](../../account-management-sql-commands/create-user.md) statement that creates the given user. The statement requires the [SELECT](../../account-management-sql-commands/grant.md#table-privileges) privilege for the [mysql](/kb/en/the-mysql-database-tables/) database, except for the current user. The [CREATE USER](../../account-management-sql-commands/create-user.md) statement for the current user is shown where no user is specified.
