...
Shows the events in the [binary log](../../../../../server-usage/programming-customizing-mariadb/stored-routines/binary-logging-of-stored-routines.md). If you do not specify '`log_name`',
