...
If the [Sphinx Storage Engine](/en/sphinxse/) is installed, the following is also supported:
...
The `[information_schema](../../../../../server-usage/programming-customizing-mariadb/views/information-schema-views-table.md).[INNODB_MUTEXES](../system-tables/information-schema/information-schema-tables/information-schema-innodb-tables/information-schema-innodb_mutexes-table.md)` table provides similar information.

#

## SHOW ENGINE PERFORMANCE_SCHEMA STATUS

This statement shows how much memory is used for `[performance_schema](../system-tables/performance-schema/performance-schema-status-variables.md)` tables and internal buffers.
