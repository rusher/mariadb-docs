...
This statement shows a [CREATE VIEW](../../../../../server-usage/programming-customizing-mariadb/views/create-view.md) statement that creates the given [view](/en/views/), as well as the character set used by the connection when the view was created. This statement
