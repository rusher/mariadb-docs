...
From [MariaDB 11.7](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-117), one can also use
...
The [DATABASE()](../../../../clients-and-utilities/graphical-and-enhanced-clients/database-workbench.md) function ([SCHEMA()](../built-in-functions/secondary-functions/information-functions/schema.md) is a synonym) returns the default database.
...
* [USE CATALOG](/kb/en/changing-catalog/)