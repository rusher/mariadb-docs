...
When a [CREATE TABLE](create-tablespace.md) or [ALTER TABLE](../alter/alter-table.md) command is issued, MariaDB will silently change a column specification in the following cases:
...
* If [strict SQL mode](../../../../../server-management/variables-and-modes/sql-mode.md#strict-mode) is not enabled (it is enabled by default from [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102)), a [VARCHAR](../../../../data-types/string-data-types/varchar.md) column longer than 65535 become [TEXT](../../../../data-types/string-data-types/text.md), and a [VARBINARY](../../../../data-types/string-data-types/varbinary.md) columns longer than 65535 becomes a [BLOB](../../../../data-types/string-data-types/blob.md). If strict mode is enabled the silent changes will not be made, and an error will occur.
...
| FLOAT4 | [FLOAT](../../../../data-types/data-types-numeric-data-types/floating-point-accuracy.md) |
...
| INT4 | [INT](../../../../../clients-and-utilities/server-client-software/client-libraries/clientserver-protocol/replication-protocol/intvar_event.md) |
