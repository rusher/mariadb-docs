...
The `CREATE PACKAGE` statement can be used when [Oracle SQL_MODE](/en/sql_modeoracle-from-mariadb-103/) is set, or in any mode from [MariaDB 11.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-114).
...
From [MariaDB 11.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-114), non-Oracle mode:
