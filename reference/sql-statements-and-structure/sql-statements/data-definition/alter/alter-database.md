...
The `COLLATE` clause changes the default database collation. See [Character Sets and Collations](/en/data-types-character-sets-and-collations/) for more.
