...
This page describes client-side of [MariaDB 10.0.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-100-series/mariadb-1001-release-notes) API and MariaDB Connector/C 2.0 for reading and writing [Dynamic Columns](dynamic-columns-api.md) blobs.
