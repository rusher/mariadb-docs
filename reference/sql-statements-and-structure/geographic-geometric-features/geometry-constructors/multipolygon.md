...
Constructs a [WKB](../wkb/wkb-polyfromwkb.md) MultiPolygon value from a set of WKB [Polygon](../wkb/polygonfromwkb.md) arguments. If any argument is not a WKB Polygon, the return value is `NULL`.
