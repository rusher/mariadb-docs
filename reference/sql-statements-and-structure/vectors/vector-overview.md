...
* [LangChain, MariaDB Vectore Store](https://pypi.org/project/langchain-mariadb/)
* [LlamaIndex, MariaDB Vectore Store](https://docs.llamaindex.ai/en/stable/api_reference/storage/vector_store/mariadb/)
* [Spring AI, MariaDB Vector Store](https://docs.spring.io/spring-ai/reference/api/vectordbs/mariadb.html)