...
The [Performance Schema](../sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md) can also be used to find out who is allocated memory and for what.
...
The heap profiling is configured using environment variables. The details can be found in the *Modifying Runtime Behavior* section of the gperftools documentation: [https://gperftools.github.io/gperftools/heapprofile.html](https://gperftools.github.io/gperftools/heapprofile.html)
