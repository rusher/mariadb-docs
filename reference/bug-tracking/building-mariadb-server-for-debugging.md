...
(A more detailed explanation can be found [here](/en/how-to-produce-a-full-stack-trace-for-mysqld-the-mariadb-server/).)
...
* Add the [--core-file](/en/mysqld-options/#-core-file) option to your /.my.cnf or /etc/my.cnf file under the [mysqld] tag.
...
* [How to produce a stack trace from a core file](/en/how-to-produce-a-full-stack-trace-for-mysqld/)