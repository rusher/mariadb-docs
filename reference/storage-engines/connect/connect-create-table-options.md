...
| BLOCK_SIZE | Integer | The number of rows each block of a [FIX](connect-table-types/connect-dos-and-fix-table-types.md), [BIN](connect-table-types/connect-bin-table-type.md), [DBF](connect-table-types/connect-dbf-table-type.md), or [VEC](connect-table-types/connect-vec-table-type.md) table contains. For an [ODBC](/kb/en/connect-table-types-odbc-table-type-accessing-tables-from-other-dbms/) table this is the RowSet size option. For a [JDBC](/kb/en/connect-jdbc-table-type-accessing-tables-from-other-dbms/) table this is the fetch size. |
| CATFUNC | String | The catalog function used by a [catalog table](connect-table-types/connect-table-types-catalog-tables.md). |
| COLIST | String | The column list of [OCCUR](/kb/en/connect-table-types-occur-table-type/) tables or $project of [MONGO](/kb/en/connect-mongo-table-type-accessing-collections-from-mongodb/) tables. |
...
| CONNECTION | String | Specifies the connection of an [ODBC](/kb/en/connect-table-types-odbc-table-type-accessing-tables-from-other-dbms/), [JDBC](/kb/en/connect-jdbc-table-type-accessing-tables-from-other-dbms/) or [MYSQL](/kb/en/connect-table-types-mysql-table-type-accessing-mysqlmariadb-tables/) table. |
| DATA_CHARSET | String | The character set used in the external file or data source. |
| DBNAME | String | The target database for [ODBC](/kb/en/connect-table-types-odbc-table-type-accessing-tables-from-other-dbms/), [JDBC](/kb/en/connect-jdbc-table-type-accessing-tables-from-other-dbms/), [MYSQL](/kb/en/connect-table-types-mysql-table-type-accessing-mysqlmariadb-tables/), [catalog](connect-table-types/connect-table-types-catalog-tables.md), and [PROXY](/kb/en/connect-table-types-proxy-table-type/) based tables. The database concept is sometimes known as a schema. |
...
| HTTP | String | The HTTP of the client of REST queries. From [Connect 1.06.0010](../../../security/user-account-management/catalogs/connecting-to-a-server-configured-for-catalogs.md). |
| HUGE | Boolean | To specify that a table file can be larger than 2GB. For a [MYSQL](/kb/en/connect-table-types-mysql-table-type-accessing-mysqlmariadb-tables/) table, prevents the result set from being stored in memory. |
...
| QCHAR | String | Specifies the character used for quoting some fields of a [CSV](connect-table-types/connect-csv-and-fmt-table-types.md) table or the identifiers of an [ODBC](/kb/en/connect-table-types-odbc-table-type-accessing-tables-from-other-dbms/)/[JDBC](/kb/en/connect-jdbc-table-type-accessing-tables-from-other-dbms/) tables. |
...
| SEP_CHAR | String | Specifies the field separator character of a [CSV](connect-table-types/connect-csv-and-fmt-table-types.md) or [XCOL](/kb/en/connect-table-types-xcol-table-type/) table. Also, used to specify the Jpath separator for [JSON tables](connect-table-types/connect-json-table-type.md). |
...
| SRCDEF | String | The source definition of a table retrieved via [ODBC](/kb/en/connect-table-types-odbc-table-type-accessing-tables-from-other-dbms/), [JDBC](/kb/en/connect-jdbc-table-type-accessing-tables-from-other-dbms/) or the MySQL API or used by a [PIVOT](/kb/en/connect-table-types-pivot-table-type/) table. |
...
| TABLE_TYPE | String | The external table [type](connect-table-types/connect-table-types-overview.md): [DOS](connect-table-types/connect-dos-and-fix-table-types.md), [FIX](connect-table-types/connect-dos-and-fix-table-types.md), [BIN](connect-table-types/connect-bin-table-type.md), [CSV](connect-table-types/connect-csv-and-fmt-table-types.md), [FMT](connect-table-types/connect-csv-and-fmt-table-types.md), [XML](connect-table-types/connect-xml-table-type.md), [JSON](connect-table-types/connect-json-table-type.md), [INI](connect-table-types/connect-ini-table-type.md), [DBF](connect-table-types/connect-dbf-table-type.md), [VEC](connect-table-types/connect-vec-table-type.md), [ODBC](/kb/en/connect-table-types-odbc-table-type-accessing-tables-from-other-dbms/), [JDBC](/kb/en/connect-jdbc-table-type-accessing-tables-from-other-dbms/), [MYSQL](/kb/en/connect-table-types-mysql-table-type-accessing-mysqlmariadb-tables/), [TBL](/kb/en/connect-table-types-tbl-table-type-table-list/), [PROXY](/kb/en/connect-table-types-proxy-table-type/), [XCOL](/kb/en/connect-table-types-xcol-table-type/), [OCCUR](/kb/en/connect-table-types-occur-table-type/), [PIVOT](/kb/en/connect-table-types-pivot-table-type/), [ZIP](connect-table-types/connect-zipped-file-tables.md), [VIR](connect-table-types/connect-table-types-vir.md), [DIR](connect-table-types/connect-table-types-special-virtual-tables.md#dir-type), [WMI](connect-table-types/connect-table-types-special-virtual-tables.md#windows-management-instrumentation-table-type-wmi), [MAC](connect-table-types/connect-table-types-special-virtual-tables.md#mac-address-table-type-mac), and [OEM](connect-table-types/connect-table-types-oem.md). Defaults to [DOS](connect-table-types/connect-dos-and-fix-table-types.md), [MYSQL](/kb/en/connect-table-types-mysql-table-type-accessing-mysqlmariadb-tables/), or [PROXY](/kb/en/connect-table-types-proxy-table-type/) depending on what options are used. |
| TABNAME | String | The target table or node for [ODBC](/kb/en/connect-table-types-odbc-table-type-accessing-tables-from-other-dbms/), [JDBC](/kb/en/connect-jdbc-table-type-accessing-tables-from-other-dbms/), [MYSQL](/kb/en/connect-table-types-mysql-table-type-accessing-mysqlmariadb-tables/), [PROXY](/kb/en/connect-table-types-proxy-table-type/), or [catalog tables](connect-table-types/connect-table-types-catalog-tables.md); or the top node name for [XML](connect-table-types/connect-xml-table-type.md) tables. |
| URI | String | The URI of a REST request.. From [Connect 1.06.0010](../../../security/user-account-management/catalogs/connecting-to-a-server-configured-for-catalogs.md). |
...
commands or by the “AS select statement” of the [CREATE TABLE](../../sql-statements-and-structure/sql-statements/data-definition/create/create-tablespace.md)
