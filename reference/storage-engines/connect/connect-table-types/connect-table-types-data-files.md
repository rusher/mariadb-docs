...
the table. This description comes from the `[CREATE TABLE](../../../sql-statements-and-structure/sql-statements/data-definition/create/create-tablespace.md)`
...
Multiple tables are specified by the option MULTIPLE=*n*, which can take
four values:

| 0 | Not a multiple table (the default). This can be used in an [ALTER TABLE](../../../sql-statements-and-structure/sql-statements/data-definition/alter/alter-table.md) statement. |
...
I/O functions (`[XML](%5B%5Bconnect-xml-table-type)` and
...
[DOS](connect-dos-and-fix-table-types.md),
[FIX](connect-dos-and-fix-table-typess),
[BIN](connect-bin-table-type.md),
[CSV](connect-csv-and-fmt-table-types.md) and
[FMT](connect-csv-and-fmt-table-types.md). This can save some disk space
...
1. Made of compressed blocks of block_size records (enabling block indexing)
...
This is also different from what MariaDB does with [dynamic columns](../../../sql-statements-and-structure/nosql/dynamic-columns-api.md), which is close to what MySQL and PostgreSQL do with the JSON column type.
