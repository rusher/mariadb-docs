...
[TBL](/en/connect-table-types-tbl-table-type-table-list/), [XCOL](/en/connect-table-types-xcol-table-type/), [OCCUR](/en/connect-table-types-occur-table-type/), or [PIVOT](/en/connect-table-types-pivot-table-type/). Sure enough, PROXY tables are CONNECT tables, meaning that
...
temporary CONNECT table of [MYSQL](/en/connect-table-types-mysql-table-type-accessing-mysqlmariadb-tables/) type to access it. This connection uses
...
than when using `[FEDERATEDX](/en/federatedx-storage-engine/)` tables.
