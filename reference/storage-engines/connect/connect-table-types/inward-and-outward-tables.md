...
specific commands such as [INSERT](../../../../server-usage/programming-customizing-mariadb/views/inserting-and-updating-with-views.md), [UPDATE](../../../sql-statements-and-structure/sql-statements/data-manipulation/changing-deleting-data/update.md), or [DELETE](../../../sql-statements-and-structure/sql-statements/data-manipulation/changing-deleting-data/delete.md). For other commands such as [CREATE](../../../../security/user-account-management/catalogs/create-catalog.md), [DROP](../../../../security/user-account-management/catalogs/drop-catalog.md), or [ALTER](../../../../server-usage/programming-customizing-mariadb/triggers-events/event-scheduler/alter-event.md) their data is never modified or erased.
...
If the specified file does not exist, it is created when data is inserted into the table. If a [SELECT](../../../../server-usage/replication-cluster-multi-master/standard-replication/selectively-skipping-replication-of-binlog-events.md) is issued before the file is created, the following error is produced:
...
accordingly without changing the data. [ALTER](../../../../server-usage/programming-customizing-mariadb/triggers-events/event-scheduler/alter-event.md) can be used safely to, for
...
Changing the table type with [ALTER](../../../../server-usage/programming-customizing-mariadb/triggers-events/event-scheduler/alter-event.md) often makes no sense. But many suspicious
...
A special type of file-based CONNECT tables are “inward” tables. They are file-based tables whose file name is not specified in the [CREATE TABLE](../../../sql-statements-and-structure/sql-statements/data-definition/create/create-tablespace.md) statement (no *file_name* option).
