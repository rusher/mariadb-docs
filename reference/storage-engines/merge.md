...
collection of identical [MyISAM](../../clients-and-utilities/myisam-clients-and-utilities/myisamchk-table-information.md) tables that can be used as one.
...
It is possible to build a MERGE table on MyISAM tables which have one or more [virtual columns](/en/virtual-columns/). MERGE itself does not support virtual columns, thus such columns will be seen as regular columns. The data types and sizes will still need to be identical, and they cannot be NOT NULL.
