...
# Features missing in [MariaDB 5.5](/en/what-is-mariadb-55/)

* No online [ALTER TABLE](../../sql-statements-and-structure/sql-statements/data-definition/alter/alter-table.md).
...
# Features missing in [MariaDB 10.0](/en/what-is-mariadb-100/)

[MariaDB 10.0](/en/what-is-mariadb-100/) (starting from 10.0.5) has online [ALTER TABLE](../../sql-statements-and-structure/sql-statements/data-definition/alter/alter-table.md). So the features missing will be:

* No `INSERT NOAR` or `UPDATE NOAR` commands.

 * We are working with Tokutek to improve this feature before adding it to MariaDB.
* No online [OPTIMIZE TABLE](../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/optimizing-tables/optimize-table.md) before [10.0.11](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-100-series/mariadb-10011-release-notes) ([r4199](http://bazaar.launchpad.net/~maria-captains/maria/10.0/revision/4199))
* No gdb stack trace on sigsegv
