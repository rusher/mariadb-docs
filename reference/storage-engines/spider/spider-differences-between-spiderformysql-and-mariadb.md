...
* With `SpiderForMySQL`, the [CREATE TABLE](../../sql-statements-and-structure/sql-statements/data-definition/create/create-tablespace.md) statement uses `CONNECTION` to define spider table variables whereas MariaDB uses `COMMENT`.

#

## Features

* `[HANDLER](../../sql-statements-and-structure/nosql/handlersocket/handlersocket-external-resources.md)` can not be translated to SQL in MariaDB
