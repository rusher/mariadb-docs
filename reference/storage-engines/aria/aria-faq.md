...
This FAQ provides information on the [Aria](../../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/aria-encryption/aria-enabling-encryption.md) storage engine.

The ***Aria*** storage engine was previously known as ***Maria***, (see, the [Aria Name](the-aria-name.md)). In current releases of [MariaDB](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-release-criteria), you can refer to the engine as Maria or Aria. As this will change in future releases, please update references in your scripts and automation to use the correct name.
...
It has been in development since 2007 and was first announced on Monty's [blog](http://monty-says.blogspot.com/2008/01/maria-engine-is-released.html). The same core MySQL engineers who developed the MySQL server and the [MyISAM](../../../clients-and-utilities/myisam-clients-and-utilities/myisamchk-table-information.md), [MERGE](../merge.md), and [MEMORY](../memory-storage-engine.md) storage engines are also working on Aria.
...
* Row locking
* Group commit (Already in [MariaDB 5.2](/en/what-is-mariadb-52/))
...
Documentation is available at [Aria](../../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/aria-encryption/aria-enabling-encryption.md) and related topics. The project is maintained on [GitHub](https://github.com/MariaDB/server).
...
You can usually find some of the Maria developers on our Zulip instance at [https://mariadb.zulipchat.com](https://mariadb.zulipchat.com) or on the [IRC](/en/irc/) channel #maria at [https://libera.chat/](https://libera.chat/).
...
* From [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105), max key length is 2000 bytes, compared to 1000 bytes in MyISAM.
...
# Differences between [MariaDB 5.1](/en/what-is-mariadb-51/) release and the normal MySQL-5.1 release?

See:

* [Aria storage engine](aria-storage-engine.md)
* [MariaDB versus MySQL](/en/mariadb-versus-mysql/)
...
* Remove logs and run [aria_chk](../../../clients-and-utilities/aria-clients-and-utilities/aria_chk.md) on your `*.MAI` files.
...
Note that if you change the page size you have to dump all your old tables into text (with [mariadb-dump](../../../clients-and-utilities/mariadb-dumpslow.md)) and remove the old Aria log and files:
