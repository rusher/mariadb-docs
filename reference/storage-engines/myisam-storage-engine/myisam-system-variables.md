...
This page documents system variables related to the [MyISAM](../../../clients-and-utilities/myisam-clients-and-utilities/myisamchk-table-information.md) storage engine. For options, see [MyISAM Options](/kb/en/mysqld-options/#myisam-options).
...
* Description: [MyISAM](../../../clients-and-utilities/myisam-clients-and-utilities/myisamchk-table-information.md) key cache block size in bytes .
...
* Description: Size in bytes of the default pointer, used in a [MyISAM](../../../clients-and-utilities/myisam-clients-and-utilities/myisamchk-table-information.md) [CREATE TABLE](../../sql-statements-and-structure/sql-statements/data-definition/create/create-tablespace.md) with no MAX_ROWS option.
 ...
 * `DEFAULT` (<= [MariaDB 10.2.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-102-series/mariadb-1023-release-notes))
 * `OFF`
