...
The PARSEC Authentication Plugin was introduced in [MariaDB 11.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-116). It is intended to be the default in a future release.
...
1. Server replies with ["ok"](../../../clients-and-utilities/server-client-software/client-libraries/clientserver-protocol/4-server-response-packets/ok_packet.md) or ["access denied"](https://mariadb.com/kb/en/err_packet/)
