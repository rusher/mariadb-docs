---
description: >-
  MariaDB Enterprise Operator 25.08 is a Stable (GA) release of MariaDB
  Enterprise Operator, released on 2025-08-26
---
...
<<<<<<< HEAD
If you're updating from previous versions, **please follow the [UPDATE GUIDE](https://mariadb.com/docs/tools/mariadb-enterprise-operator/updates/update-25.08)** to ensure a safe transition.
=======
If you're updaing from previous versions, **please follow the** [**UPDATE GUIDE**](https://mariadb.com/docs/tools/mariadb-enterprise-operator/updates/update-25.08) to ensure a safe transition.
