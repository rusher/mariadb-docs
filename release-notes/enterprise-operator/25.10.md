...
If you're updating from previous versions, **please follow the [UPDATE GUIDE](https://mariadb.com/docs/tools/mariadb-enterprise-operator/updates/update-25.10)** to ensure a safe transition.
