...
* [Revision #2975](https://bazaar.launchpad.net/~maria-captains/maria/5.2/revision/2975)\
  ...
  * Ensure we don't read a [MariaDB 5.3](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-3-series/changes-improvements-in-mariadb-5-3.md) errmsg.sys file or new errmsg.sys file\
