...
[Download 10.3.37](https://downloads.mariadb.org/mariadb/10.3.37/)[Release Notes](https://github.com/mariadb-corporation/docs-server/blob/test/release-notes/changelogs/changelogs-mariadb-10-3-series/broken-reference/README.md)[Changelog](mariadb-10-3-37-changelog.md)[Overview of 10.3](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-3-series/what-is-mariadb-103.md)
...
* [Revision #78030b67b9](https://github.com/MariaDB/server/commit/78030b67b9)\
  ...
  * Do not use C++11 before [MariaDB 10.4](https://github.com/mariadb-corporation/docs-server/blob/test/release-notes/changelogs/changelogs-mariadb-10-3-series/broken-reference/README.md)
...
* [Revision #f65ba9aeb7](https://github.com/MariaDB/server/commit/f65ba9aeb7)\
  ...
  * [MDEV-17124](https://jira.mariadb.org/browse/MDEV-17124): [mariadb 10.1.34](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-1-series/mariadb-10134-release-notes.md), views and prepared statements: ERROR 1615 (HY000): Prepared statement needs to be re-prepared
