...
[Download 10.3.37](https://downloads.mariadb.org/mariadb/10.3.37/)[Release Notes](broken-reference)[Changelog](mariadb-10-3-37-changelog.md)[Overview of 10.3](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-3-series/what-is-mariadb-103.md)
...
* [Revision #78030b67b9](https://github.com/MariaDB/server/commit/78030b67b9)\
  ...
  * Do not use C++11 before [MariaDB 10.4](broken-reference)
