...
[Download](https://downloads.mariadb.org/mariadb/10.0.10) |[Release Notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-0-series/mariadb-10010-release-notes.md) |**Changelog** |[Overview of 10.0](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-0-series/changes-improvements-in-mariadb-10-0.md)

**Release date:** 31 Mar 2014

For the highlights of this release, see the[release notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-0-series/mariadb-10010-release-notes.md).
...
* [Revision #4108](https://bazaar.launchpad.net/~maria-captains/maria/10.0/revision/4108) \[merge]\
  ...
  * [Revision #3413.21.574](https://bazaar.launchpad.net/~maria-captains/maria/10.0/revision/3413.21.574)\
    ...
    * [MDEV-5831](https://jira.mariadb.org/browse/MDEV-5831) Upgrade from [MariaDB 5.5.36](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-5-series/mariadb-5536-release-notes.md) via yum fails
