...
[Download](https://downloads.mariadb.org/mariadb/10.0.12)[Release Notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-0-series/mariadb-10012-release-notes.md)[Changelog](mariadb-10012-changelog.md)[Overview of 10.0](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-0-series/changes-improvements-in-mariadb-10-0.md)

**Release date:** 16 Jun 2014

For the highlights of this release, see the[release notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-0-series/mariadb-10012-release-notes.md).
...
* [Revision #4249](https://bazaar.launchpad.net/~maria-captains/maria/10.0/revision/4249)\
  ...
  * [MDEV-6253](https://jira.mariadb.org/browse/MDEV-6253) MySQL Users Break when Migrating from MySQL 5.1 to [MariaDB 10.0.10](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-0-series/mariadb-10010-release-notes.md)
...
* [Revision #4231](https://bazaar.launchpad.net/~maria-captains/maria/10.0/revision/4231) \[merge]\
  ...
  * [MariaDB 5.5.38](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-5-series/mariadb-5538-release-notes.md) merge
...
* [Revision #4222](https://bazaar.launchpad.net/~maria-captains/maria/10.0/revision/4222)\
  ...
  * [MDEV-6258](https://jira.mariadb.org/browse/MDEV-6258) [MariaDB 10.0](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-0-series/changes-improvements-in-mariadb-10-0.md) performance schema timestamps relative to epoch
