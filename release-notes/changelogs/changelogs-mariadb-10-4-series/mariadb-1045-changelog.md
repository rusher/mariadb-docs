...
[Download](https://downloads.mariadb.org/mariadb/10.4.5)[Release Notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-4-series/mariadb-1045-release-notes.md)[Changelog](mariadb-1045-changelog.md)[Overview of 10.4](broken-reference)

**Release date:** 21 May 2019

For the highlights of this release, see the[release notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-4-series/mariadb-1045-release-notes.md).
...
* [Revision #43bbf88dcb](https://github.com/MariaDB/server/commit/43bbf88dcb)\
  ...
  * [MDEV-19158](https://jira.mariadb.org/browse/MDEV-19158): [MariaDB 10.2.22](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-2-series/mariadb-10222-release-notes.md) is writing duplicate entries into binary log
...
* [Revision #645f77a6bc](https://github.com/MariaDB/server/commit/645f77a6bc)\
  ...
  * [MDEV-19195](https://jira.mariadb.org/browse/MDEV-19195) Active Record unit test fails with [MariaDB 10.4.3](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-4-series/mariadb-1043-release-notes.md)
