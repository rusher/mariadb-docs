...
[Download](https://downloads.mariadb.org/mariadb/10.4.3)[Release Notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-4-series/mariadb-1043-release-notes.md)[Changelog](mariadb-1043-changelog.md)[Overview of 10.4](broken-reference)

**Release date:** 25 Feb 2019

For the highlights of this release, see the[release notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-4-series/mariadb-1043-release-notes.md).
