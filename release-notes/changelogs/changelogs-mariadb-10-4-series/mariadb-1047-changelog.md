...
For the highlights of this release, see the[release notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-4-series/mariadb-1047-release-notes.md).
...
* [Revision #76200870ea](https://github.com/MariaDB/server/commit/76200870ea)\
  ...
  * [MDEV-17204](https://jira.mariadb.org/browse/MDEV-17204) [Mariadb 10.3.9](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-3-series/mariadb-1039-release-notes.md) Spider DB SQL Alias no execute (#1348)
