...
he most recent release of [MariaDB 10.4](broken-reference) is:[**MariaDB 10.4.34**](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-4-series/mariadb-10-4-34-release-notes.md) Stable (GA) [Download Now](https://downloads.mariadb.org/mariadb/10.4.34/)

[Download](https://downloads.mariadb.org/mariadb/10.4.1/)[Release Notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-4-series/mariadb-1041-release-notes.md)[Changelog](mariadb-1041-changelog.md)[Overview of 10.4](broken-reference)

**Release date:** 20 Dec 2018

For the highlights of this release, see the[release notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-4-series/mariadb-1041-release-notes.md).
...
* [Revision #3efed7533c](https://github.com/MariaDB/server/commit/3efed7533c)\
  ...
  * Fix lock\_ddl\_per\_table handling in mariabackup.
...
* [Revision #c0ca164b1c](https://github.com/MariaDB/server/commit/c0ca164b1c)\
  ...
  * [MDEV-17308](https://jira.mariadb.org/browse/MDEV-17308) mariabackup to use the BACKUP statement instead of FTWRL
...
* [Revision #93c360e3a5](https://github.com/MariaDB/server/commit/93c360e3a5)\
  ...
  * [MDEV-15253](https://jira.mariadb.org/browse/MDEV-15253): Default optimizer setting changes for [MariaDB 10.4](broken-reference)
