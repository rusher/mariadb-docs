...
* [Revision #2989](https://bazaar.launchpad.net/~maria-captains/maria/5.3/revision/2989) \[merge]\
  ...
  * [Revision #2982.2.1](https://bazaar.launchpad.net/~maria-captains/maria/5.3/revision/2982.2.1) \[merge]\
    ...
    * Merge with [MariaDB 5.2](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-2-series/changes-improvements-in-mariadb-5-2.md)
...
* [Revision #2981](https://bazaar.launchpad.net/~maria-captains/maria/5.3/revision/2981) \[merge]\
  ...
  * Merge [MWL#180](https://askmonty.org/worklog/?tid=180) into main [MariaDB 5.3](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-3-series/changes-improvements-in-mariadb-5-3.md).
  ...
  * [Revision #2977.1.1](https://bazaar.launchpad.net/~maria-captains/maria/5.3/revision/2977.1.1) \[merge]\
    ...
    * Merge [MWL#180](https://askmonty.org/worklog/?tid=180), binlog checksum backport, into [MariaDB 5.3](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-3-series/changes-improvements-in-mariadb-5-3.md)-based tree.
...
* [Revision #2969](https://bazaar.launchpad.net/~maria-captains/maria/5.3/revision/2969) \[merge]\
  ...
  * Merge test case fix from [MariaDB 5.2](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-2-series/changes-improvements-in-mariadb-5-2.md)-rpl into 5.3.
...
* [Revision #2966](https://bazaar.launchpad.net/~maria-captains/maria/5.3/revision/2966) \[merge]\
  ...
  * Merge various replication-related patches into [MariaDB 5.3](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-3-series/changes-improvements-in-mariadb-5-3.md):
  ...
  * [Revision #2732.26.13](https://bazaar.launchpad.net/~maria-captains/maria/5.3/revision/2732.26.13) \[merge]\
    ...
    * Merge [MariaDB 5.2.5](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-2-series/mariadb-525-release-notes.md) release into MariaDB-5.2-rpl.
...
[MariaDB 5.3.0](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-3-series/mariadb-530-release-notes.md) Changelog — page:`[1](mariadb-530-changelog.md)[2](mariadb-530-changelog-p2.md)3[4](mariadb-530-changelog-p4.md)[5](mariadb-530-changelog-p5.md)[6](mariadb-530-changelog-p6.md)`
