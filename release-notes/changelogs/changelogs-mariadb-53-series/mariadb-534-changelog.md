...
[Download](https://downloads.askmonty.org/mariadb/5.3.4) |[Release Notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-3-series/mariadb-534-release-notes.md) |**Changelog** |[Overview of 5.3](broken-reference)

**Release date:** 15 Feb 2012

For the highlights of this release, see the[release notes](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-3-series/mariadb-534-release-notes.md).
...
* [Revision #3421](https://bazaar.launchpad.net/~maria-captains/maria/5.3/revision/3421)\
  ...
  * Fix for [Bug #910123](https://bugs.launchpad.net/bugs/910123) [MariaDB 5.3.3](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-3-series/mariadb-533-release-notes.md) causes 1093 error on Drupal
