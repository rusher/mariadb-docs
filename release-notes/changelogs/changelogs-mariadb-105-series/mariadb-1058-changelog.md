...
[Download 10.5.8](https://downloads.mariadb.org/mariadb/10.5.8/)[Release Notes](../../mariadb-community-server-release-notes/mariadb-10-5-series/mariadb-1058-release-notes.md)[Changelog](mariadb-1058-changelog.md)[Overview of 10.5](../../mariadb-community-server-release-notes/mariadb-10-5-series/what-is-mariadb-105.md)

**Release date:** 11 Nov 2020

For the highlights of this release, see the[release notes](../../mariadb-community-server-release-notes/mariadb-10-5-series/mariadb-1058-release-notes.md).
...
* Includes all fixes from [MariaDB 10.4.17](../changelogs-mariadb-10-4-series/mariadb-10417-changelog.md)
* Merge [Revision #7da6353b15](https://github.com/MariaDB/server/commit/7da6353b15) 2020-11-10 12:34:23 +0100 - Merge branch '10.4' into 10.5
* Merge [Revision #5fbfdae130](https://github.com/MariaDB/server/commit/5fbfdae130) 2020-11-10 11:24:13 +0100 - Merge branch '10.3' into 10.4
* [Revision #dba846ce2a](https://github.com/MariaDB/server/commit/dba846ce2a)\
  2020-11-10 12:29:20 +0300
  * [MDEV-24117](https://jira.mariadb.org/browse/MDEV-24117): Memory management problem (in range optimizer)
* Merge [Revision #212d92ad26](https://github.com/MariaDB/server/commit/212d92ad26) 2020-11-09 23:32:49 +0100 - Merge branch '10.2' into 10.3
