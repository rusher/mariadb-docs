...
* [Revision #5534d81](https://github.com/MariaDB/server/commit/5534d81)\
  ...
  * Merged change from MySQL 5.6 to [MariaDB 10.1](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-1-series/changes-improvements-in-mariadb-10-1.md) XtraDB including the test case
...
* [Revision #5dd0c77](https://github.com/MariaDB/server/commit/5dd0c77)\
  ...
  * [MDEV-9362](https://jira.mariadb.org/browse/MDEV-9362): InnoDB tables using DATA\_DIRECTORY created using MySQL 5.6 do not work with [MariaDB 10.1](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-1-series/changes-improvements-in-mariadb-10-1.md)
...
* [Revision #ea83c1d](https://github.com/MariaDB/server/commit/ea83c1d)\
  ...
  * [MDEV-9977](https://jira.mariadb.org/browse/MDEV-9977): Crash when accessing large (>4G) InnoDB table on [MariaDB 10.1](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-1-series/changes-improvements-in-mariadb-10-1.md).x 32-bit binaries.
