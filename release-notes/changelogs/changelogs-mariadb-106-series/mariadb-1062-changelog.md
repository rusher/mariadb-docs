...
[Download 10.6.2](https://downloads.mariadb.org/mariadb/10.6.2/)[Release Notes](../../mariadb-community-server-release-notes/mariadb-10-6-series/mariadb-1062-release-notes.md)[Changelog](mariadb-1062-changelog.md)[Overview of 10.6](../../mariadb-community-server-release-notes/mariadb-10-6-series/what-is-mariadb-106.md)

**Release date:** 18 Jun 2021

**Do not use non-stable (non-GA) releases in production!**

For the highlights of this release, see the[release notes](../../mariadb-community-server-release-notes/mariadb-10-6-series/mariadb-1062-release-notes.md).
