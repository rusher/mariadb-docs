...
**Note:** This page describes features in the source repository for [**MariaDB 10.5**](what-is-mariadb-105.md). There are currently no official packages or\
...
[MariaDB 10.5.29](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/mariadb-10-5-series/mariadb-10-5-29-release-notes) is a [_**Stable (GA)**_](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-release-criteria) release.
