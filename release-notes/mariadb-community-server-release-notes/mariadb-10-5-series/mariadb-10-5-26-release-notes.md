...
[Download 10.5.26](https://downloads.mariadb.org/mariadb/10.5.26/)[Release Notes](mariadb-10-5-26-release-notes.md)[Changelog](../../changelogs/changelogs-mariadb-105-series/mariadb-10-5-26-changelog.md)[Overview of 10.5](what-is-mariadb-105.md)
...
* As per the [MariaDB Deprecation Policy](../../mariadb-platform-deprecation-policy.md), this will be the last release of [MariaDB 10.5](what-is-mariadb-105.md) for Debian 10 "Buster", and RHEL/CentOS 7
* [IMPORT TABLESPACE](https://github.com/mariadb-corporation/docs-release-notes/blob/test/mariadb-community-server-release-notes/release-notes-mariadb-10-5-series/import-tablespace/README.md) no longer unnecessarily traverses tablespaces list ([MDEV-34670](https://jira.mariadb.org/browse/MDEV-34670))
