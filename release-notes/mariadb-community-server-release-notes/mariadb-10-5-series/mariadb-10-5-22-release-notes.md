...
[Download](https://mariadb.com/downloads/)[Release Notes](mariadb-10-5-22-release-notes.md)[Changelog](../../changelogs/changelogs-mariadb-105-series/mariadb-10-5-22-changelog.md)[Overview of 10.5](what-is-mariadb-105.md)
...
[MariaDB 10.5.22](mariadb-10-5-22-release-notes.md) is a [_**Stable (GA)**_](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-release-criteria) release.
...
* As per the [MariaDB Deprecation Policy](../../mariadb-platform-deprecation-policy.md), this will be the last release of [MariaDB 10.5](what-is-mariadb-105.md) for Ubuntu 18.04 LTS "Bionic"
