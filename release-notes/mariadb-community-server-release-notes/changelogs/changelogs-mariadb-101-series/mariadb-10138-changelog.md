...
[Download](https://downloads.mariadb.org/mariadb/10.1.38)[Release Notes](../../old-releases/release-notes-mariadb-10-1-series/mariadb-10138-release-notes.md)[Changelog](mariadb-10138-changelog.md)[Overview of 10.1](../../old-releases/release-notes-mariadb-10-1-series/changes-improvements-in-mariadb-10-1.md)

**Release date:** 6 Feb 2019

For the highlights of this release, see the[release notes](../../old-releases/release-notes-mariadb-10-1-series/mariadb-10138-release-notes.md).
...
* [Revision #6e2af7d084](https://github.com/MariaDB/server/commit/6e2af7d084)\
  ...
  * mariadb-backup : Remove unused parameter innodb\_buffer\_pool\_size
...
* [Revision #f17c284c57](https://github.com/MariaDB/server/commit/f17c284c57)\
  ...
  * [MDEV-18347](https://jira.mariadb.org/browse/MDEV-18347): mariadb-backup doesn't read all server option groups from configuration files
