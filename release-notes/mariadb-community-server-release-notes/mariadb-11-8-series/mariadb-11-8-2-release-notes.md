...
The following list of tasks due to be fixed in [MariaDB 11.8.2](mariadb-11-8-2-release-notes.md) is pulled from [JIRA](https://app.gitbook.com/s/WCInJQ9cmGjq1lsTG91E/development-articles/general-info/tools/jira).

Loading Issues from \[Jira]\(https://jira.mariadb.org/issues/?jql=project = MDEV AND fixVersion = 11.8.2 ORDER BY component ASC)
...
information on each push, see the [changelog](https://github.com/mariadb-corporation/docs-release-notes/blob/test/mariadb-community-server-release-notes/release-notes-mariadb-11-8-series/mariadb-11-8-2-changelog/README.md).
