...
* [mariabackup](broken-reference): [MDEV-14536](https://jira.mariadb.org/browse/MDEV-14536) - during backup, retry read of log blocks, if there is (possibly intermittent) checksum mismatch
