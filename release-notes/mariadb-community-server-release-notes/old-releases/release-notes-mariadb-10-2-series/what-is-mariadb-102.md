...
* Added catchall for [list partitions](broken-reference) ([MDEV-8348](https://jira.mariadb.org/browse/MDEV-8348))
...
* Default value of [innodb\_log\_compressed\_pages](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb/innodb-system-variables) changed to `ON` from [MariaDB 10.1.2](broken-reference) to [MariaDB 10.1.25](../release-notes-mariadb-10-1-series/mariadb-10125-release-notes.md) ([MDEV-7635](https://jira.mariadb.org/browse/MDEV-7635) and [MDEV-13247](https://jira.mariadb.org/browse/MDEV-13247))
...
| 18 Apr 2016 | [MariaDB 10.2.0](broken-reference)                | Alpha       | [Release Notes](broken-reference)               | [Changelog](../../../changelogs/changelogs-mariadb-102-series/mariadb-1020-changelog.md)  |
