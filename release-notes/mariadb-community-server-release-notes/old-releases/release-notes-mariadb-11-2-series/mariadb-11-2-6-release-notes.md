...
[MariaDB 11.2](what-is-mariadb-112.md) is a short-term stable series of MariaDB and will be [maintained until](https://mariadb.org/about/#maintenance-policy) October 2024. It is an evolution of [MariaDB 11.1](../release-notes-mariadb-11-1-series/what-is-mariadb-111.md) with several entirely new features.

[MariaDB 11.2.6](mariadb-11-2-6-release-notes.md) is a [_**Stable (GA)**_](../../../mariadb-release-criteria.md) release.

[MariaDB 11.2.6](mariadb-11-2-6-release-notes.md) is the last release of the [MariaDB 11.2](what-is-mariadb-112.md) release series.
...
For a full list of contributors to [MariaDB 11.2.6](mariadb-11-2-6-release-notes.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-4-4-11-2-6-10-11-10-10-6-20-and-10-5-27-now-available/).
