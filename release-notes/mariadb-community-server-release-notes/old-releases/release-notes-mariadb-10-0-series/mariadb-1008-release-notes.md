...
[MariaDB 10.0.8](mariadb-1008-release-notes.md) is an [_**RC**_](../../../mariadb-release-criteria.md) (_Release Candidate_)\
...
* Added a new server variable, [old\_mode](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/system-variables/server-system-variables#old_mode), to allow selectively restoring old behavior, in contrast to the old "all-or-nothing" approach of the `--old` command-line option. See [OLD MODE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/old-mode) for more.
* Added a new read-only server variable [malloc\_library](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/system-variables/server-system-variables#malloc_version)
