# MariaDB Galera Cluster 10.0.33 Release Notes
...
[Download](https://downloads.mariadb.org/mariadb-galera/10.0.33)[Release Notes](mariadb-galera-cluster-10033-release-notes.md)[Changelog](../mariadb-galera-100-changelogs/mariadb-galera-cluster-10033-changelog.md)[Overview of MariaDB Galera Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/what-is-mariadb-galera-cluster/README.md)

**Release date:** 14 Nov 2017

MariaDB Galera Cluster 10.0.33 is a [_**Stable**_](../../../../mariadb-release-criteria.md) (GA)\
release. It is a merge of [MariaDB 10.0.33](../../release-notes-mariadb-10-0-series/mariadb-10033-release-notes.md) and[Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
For a list of changes made in MariaDB Galera Cluster 10.0.33, with links to\
detailed information on each push, see the[MariaDB Galera Cluster 10.0.33 Changelog](../mariadb-galera-100-changelogs/mariadb-galera-cluster-10033-changelog.md).\
For changes made in [MariaDB 10.0.33](../../release-notes-mariadb-10-0-series/mariadb-10033-release-notes.md), see the[MariaDB 10.0.33 Changelog](../../../../changelogs/changelogs-mariadb-100-series/mariadb-10033-changelog.md)
...
* See the [MariaDB 10.0.33 Release Notes](../../release-notes-mariadb-10-0-series/mariadb-10033-release-notes.md) and[Changelog](../../../../changelogs/changelogs-mariadb-100-series/mariadb-10033-changelog.md) for more information on the changes in\
  MariaDB.
