...
[Download](https://downloads.mariadb.org/mariadb-galera/10.0.21)[Release Notes](mariadb-galera-cluster-10021-release-notes.md)[Changelog](../mariadb-galera-100-changelogs/mariadb-galera-cluster-10021-changelog.md)[Overview of MariaDB Galera Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/what-is-mariadb-galera-cluster/README.md)

**Release date:** 18 Aug 2015

MariaDB Galera Cluster 10.0.21 is a [_**Stable**_](../../../../mariadb-release-criteria.md) (GA)\
release. It is a merge of [MariaDB 10.0.21](../../release-notes-mariadb-10-0-series/mariadb-10021-release-notes.md) and[Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
detailed information on each push, see the[MariaDB Galera Cluster 10.0.21 Changelog](../mariadb-galera-100-changelogs/mariadb-galera-cluster-10021-changelog.md).
...
* See the [MariaDB 10.0.21 Release Notes](../../release-notes-mariadb-10-0-series/mariadb-10021-release-notes.md) and[Changelog](../../../changelogs/changelogs-mariadb-100-series/mariadb-10021-changelog.md) for more information on the changes in\
  MariaDB.
