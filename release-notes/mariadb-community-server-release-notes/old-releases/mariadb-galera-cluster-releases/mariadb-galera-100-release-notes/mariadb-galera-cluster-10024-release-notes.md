...
release. It is a merge of [MariaDB 10.0.24](broken-reference) and[Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
* See the [MariaDB 10.0.24 Release Notes](broken-reference) and[Changelog](../../../../changelogs/changelogs-mariadb-100-series/mariadb-10024-changelog.md) for more information on the changes in\
  MariaDB.
