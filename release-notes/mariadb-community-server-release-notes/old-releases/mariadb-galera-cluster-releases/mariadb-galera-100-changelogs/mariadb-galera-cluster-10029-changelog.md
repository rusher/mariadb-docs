# MariaDB Galera Cluster 10.0.29 Changelog
...
[Download](https://downloads.mariadb.org/mariadb-galera/10.0.29)[Release Notes](../mariadb-galera-100-release-notes/mariadb-galera-cluster-10029-release-notes.md)[Changelog](mariadb-galera-cluster-10029-changelog.md)[Overview of MariaDB Galera Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/what-is-mariadb-galera-cluster/README.md)

**Release date:** 16 Jan 2017

For the highlights of this release, see the[release notes](../mariadb-galera-100-release-notes/mariadb-galera-cluster-10029-release-notes.md).\
For changes made in MariaDB, see the [MariaDB 10.0.29 Changelog](../../../../changelogs/changelogs-mariadb-100-series/mariadb-10029-changelog.md).
