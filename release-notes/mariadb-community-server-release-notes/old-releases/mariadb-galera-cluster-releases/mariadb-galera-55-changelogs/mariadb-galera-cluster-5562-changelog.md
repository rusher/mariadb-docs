# MariaDB Galera Cluster 5.5.62 Changelog
...
[Download](https://downloads.mariadb.org/mariadb-galera/5.5.62)[Release Notes](../mariadb-galera-55-release-notes/mariadb-galera-cluster-5562-release-notes.md)[Changelog](mariadb-galera-cluster-5562-changelog.md)[Overview of MariaDB Galera Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/what-is-mariadb-galera-cluster/README.md)

**Release date:** 31 Oct 2018

For the highlights of this release, see the[release notes](../mariadb-galera-55-release-notes/mariadb-galera-cluster-5562-release-notes.md). For changes in\
MariaDB, see the [MariaDB 5.5.62 Changelog](../../../changelogs/changelogs-mariadb-55-series/mariadb-5562-changelog.md).
