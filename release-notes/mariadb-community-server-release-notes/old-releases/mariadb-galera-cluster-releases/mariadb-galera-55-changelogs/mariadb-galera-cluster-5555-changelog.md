# MariaDB Galera Cluster 5.5.55 Changelog
...
[Download](https://downloads.mariadb.org/mariadb-galera/5.5.55)[Release Notes](../mariadb-galera-55-release-notes/mariadb-galera-cluster-5555-release-notes.md)[Changelog](mariadb-galera-cluster-5555-changelog.md)[Overview of MariaDB Galera Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/what-is-mariadb-galera-cluster/README.md)

**Release date:** 22 Apr 2017

For the highlights of this release, see the[release notes](../mariadb-galera-55-release-notes/mariadb-galera-cluster-5555-release-notes.md). For changes in\
MariaDB, see the [MariaDB 5.5.55 Changelog](../../../changelogs/changelogs-mariadb-55-series/mariadb-5555-changelog.md).
...
* [Revision #5ca8121292](https://github.com/MariaDB/server/commit/5ca8121292) 2017-04-18 12:01:56 +0530 - Merge tag 'mariadb-5.5.55' into bb-5.5-sachin-merge
