...
[Download](https://downloads.mariadb.org/mariadb-galera/5.5.53)[Release Notes](mariadb-galera-cluster-5553-release-notes.md)[Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5553-changelog.md)[Overview of MariaDB Galera Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/what-is-mariadb-galera-cluster/README.md)

**Release date:** 20 Oct 2016

MariaDB Galera Cluster 5.5.53 is a [_**Stable**_](../../../../mariadb-release-criteria.md) (GA)\
release. It is a merge of [MariaDB 5.5.53](../../release-notes-mariadb-5-5-series/mariadb-5553-release-notes.md) and[Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
* See the [MariaDB 5.5.53 Release Notes](../../release-notes-mariadb-5-5-series/mariadb-5553-release-notes.md) and[Changelog](../../../../changelogs/changelogs-mariadb-55-series/mariadb-5553-changelog.md) for more information on the changes in\
  MariaDB.
...
A full list of all changes is in the [changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5553-changelog.md).
