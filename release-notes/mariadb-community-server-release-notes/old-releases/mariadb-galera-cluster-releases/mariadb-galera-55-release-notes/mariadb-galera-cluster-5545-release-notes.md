...
[Download](https://downloads.mariadb.org/mariadb-galera/5.5.45)[Release Notes](mariadb-galera-cluster-5545-release-notes.md)[Changelog](../mariadb-galera-55-changelogs/mariadb-galera-cluster-5545-changelog.md)[Overview of MariaDB Galera Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/what-is-mariadb-galera-cluster/README.md)

**Release date:** 18 Aug 2015

MariaDB Galera Cluster 5.5.45 is a [_**Stable**_](../../../../mariadb-release-criteria.md) (GA) release.\
It is a merge of [MariaDB 5.5.45](../../release-notes-mariadb-5-5-series/mariadb-5545-release-notes.md) and[Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
* This version of MariaDB Galera Cluster supports `wsrep` API v25 which means\
  ...
  MariaDB repositories and is also available from the[downloads](https://downloads.mariadb.org/mariadb-galera/5.5.45) page.
* See the [MariaDB 5.5.45 Release Notes](../../release-notes-mariadb-5-5-series/mariadb-5545-release-notes.md) and[Changelog](../../../changelogs/changelogs-mariadb-55-series/mariadb-5545-changelog.md) for more information on the changes in\
  MariaDB.
