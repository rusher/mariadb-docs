...
[Download](https://downloads.mariadb.org/mariadb/10.1.43/)[Release Notes](mariadb-10143-release-notes.md)[Changelog](../../../changelogs/changelogs-mariadb-101-series/mariadb-10143-changelog.md)[Overview of 10.1](changes-improvements-in-mariadb-10-1.md)
...
[MariaDB 10.1.43](mariadb-10143-release-notes.md) is a [_**Stable (GA)**_](../../../mariadb-release-criteria.md) release.
...
* See also the release notes for [MariaDB 10.1.42](mariadb-10142-release-notes.md) for additional items of note
* Fixes for the following [security vulnerabilities](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/security/securing-mariadb/security):
  * CVE-\`-\`\`\`

## Changelog

For a complete list of changes made in [MariaDB 10.1.43](mariadb-10143-release-notes.md), with links to detailed\
information on each push, see the [changelog](../../../changelogs/changelogs-mariadb-101-series/mariadb-10143-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.1.43](mariadb-10143-release-notes.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-4-10-10-3-20-10-2-29-and-10-1-43-now-available/).
