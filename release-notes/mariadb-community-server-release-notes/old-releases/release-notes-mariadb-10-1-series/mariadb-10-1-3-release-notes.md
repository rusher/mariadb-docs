...
[MariaDB 10.1.3](mariadb-10-1-3-release-notes.md) is a [_**Beta**_](../../../mariadb-release-criteria.md) release. One should not expect any notable new features or incompatible interface changes in 10.1 after this release.
...
* [INFORMATION\_SCHEMA.APPLICABLE\_ROLES](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/administrative-sql-statements/system-tables/information-schema/information-schema-tables/information-schema-applicable_roles-table) table has a new `IS_DEFAULT` column ([MDEV-6918](https://jira.mariadb.org/browse/MDEV-6918)). See [SET DEFAULT ROLE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/account-management-sql-statements/set-default-role).
