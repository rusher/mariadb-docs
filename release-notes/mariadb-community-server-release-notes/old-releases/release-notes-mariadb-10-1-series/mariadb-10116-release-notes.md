...
[Download](https://downloads.mariadb.org/mariadb/10.1.16)[Release Notes](mariadb-10116-release-notes.md)[Changelog](../../../changelogs/changelogs-mariadb-101-series/mariadb-10116-changelog.md)[Overview of 10.1](changes-improvements-in-mariadb-10-1.md)
...
[MariaDB 10.1.16](mariadb-10116-release-notes.md) is a [_**Stable (GA)**_](../../../mariadb-release-criteria.md) release.
...
* [Performance Schema](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/administrative-sql-statements/system-tables/performance-schema) updated to 5.6.31
...
* [TokuDB](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/tokudb) updated to 5.6.30-76.3
...
* As per the [MariaDB Deprecation Policy](../../../mariadb-platform-deprecation-policy.md), this will be the last release of [MariaDB 10.1](changes-improvements-in-mariadb-10-1.md) for Ubuntu 15.10 "wily"

## Changelog

For a complete list of changes made in [MariaDB 10.1.16](mariadb-10116-release-notes.md), with links to detailed\
