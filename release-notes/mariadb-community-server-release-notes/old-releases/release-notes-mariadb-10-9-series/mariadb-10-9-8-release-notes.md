...
[MariaDB 10.9.8](mariadb-10-9-8-release-notes.md) is a [_**Stable (GA)**_](../../../mariadb-release-criteria.md) release.
...
* As per the [MariaDB Deprecation Policy](../../../mariadb-platform-deprecation-policy.md), this will be the last release of [MariaDB 10.9](what-is-mariadb-109.md) for Ubuntu 18.04 LTS "Bionic" and Ubuntu 22.10 "Kinetic"
...
information on each push, see the [changelog](../../../changelogs/changelogs-mariadb-109-series/mariadb-10-9-8-changelog.md).
