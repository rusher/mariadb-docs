...
[Download 10.10.6](https://downloads.mariadb.org/mariadb/10.10.6/)[Release Notes](mariadb-10-10-6-release-notes.md)[Changelog](../../../changelogs/changelogs-mariadb-10-10-series/mariadb-10-10-6-changelog.md)[Overview of 10.10](what-is-mariadb-1010.md)
...
[MariaDB 10.10.6](mariadb-10-10-6-release-notes.md) is a [_**Stable (GA)**_](../../../mariadb-release-criteria.md) release.
...
* As per the [MariaDB Deprecation Policy](../../../mariadb-platform-deprecation-policy.md), this will be the last release of [MariaDB 10.10](what-is-mariadb-1010.md) for Ubuntu 18.04 LTS "Bionic" and Ubuntu 22.10 "Kinetic"
...
* `SET GLOBAL innodb_undo_log_truncate=ON` does not free space when no undo logs exist ([MDEV-31382](https://jira.mariadb.org/browse/MDEV-31382))
...
For a complete list of changes made in [MariaDB 10.10.6](mariadb-10-10-6-release-notes.md), with links to detailed\
information on each push, see the [changelog](../../../changelogs/changelogs-mariadb-10-10-series/mariadb-10-10-6-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.10.6](mariadb-10-10-6-release-notes.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-0-3-10-11-5-10-10-6-10-9-8-10-6-15-10-5-22-10-4-31-now-available/).
