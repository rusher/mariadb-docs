...
* Several improvements to MariaDB Server and backup for dealing with encrypted or page\_compressed pages:
  ...
  * [MDEV-18025](https://jira.mariadb.org/browse/MDEV-18025): [mariadb-backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backing-up-and-restoring-databases/mariabackup) fails to detect corrupted page\_compressed=1 tables
