...
* [MDEV-18105](https://jira.mariadb.org/browse/MDEV-18105) - [Mariabackup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backing-up-and-restoring-databases/mariabackup) fails to copy encrypted InnoDB system tablespace if LSN>4G
...
* Several improvements to MariaDB Server and backup for dealing with encrypted or page\_compressed pages:
  ...
  * [MDEV-18025](https://jira.mariadb.org/browse/MDEV-18025): [Mariabackup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backing-up-and-restoring-databases/mariabackup) fails to detect corrupted page\_compressed=1 tables
