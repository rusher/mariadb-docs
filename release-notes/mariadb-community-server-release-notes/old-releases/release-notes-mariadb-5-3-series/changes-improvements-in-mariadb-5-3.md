...
We have created an [Optimizer Feature Comparison Matrix](../../../compatibility-and-differences/optimizer-feature-comparison-matrix.md) showing the new optimizer features in [MariaDB 5.5](../release-notes-mariadb-5-5-series/changes-improvements-in-mariadb-5-5.md) and 5.3 compared to MySQL 5.5 and 5.6.
