...
[Download](https://downloads.mariadb.org/mariadb/10.4.4)[Release Notes](mariadb-1044-release-notes.md)[Changelog](../../../changelogs/changelogs-mariadb-10-4-series/mariadb-1044-changelog.md)[Overview of 10.4](broken-reference)
...
* As per the [MariaDB Deprecation Policy](../../../mariadb-platform-deprecation-policy.md), this is the\
  last release of [MariaDB 10.4](broken-reference) for Ubuntu 14.04 Trusty
