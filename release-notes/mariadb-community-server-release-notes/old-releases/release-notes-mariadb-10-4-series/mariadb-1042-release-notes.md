...
[Download](https://downloads.mariadb.org/mariadb/10.4.2/)[Release Notes](mariadb-1042-release-notes.md)[Changelog](../../../changelogs/changelogs-mariadb-10-4-series/mariadb-1042-changelog.md)[Overview of 10.4](broken-reference)
...
10.4](broken-reference). With a rolling upgrade, a live cluster can be upgraded node by node, and\
