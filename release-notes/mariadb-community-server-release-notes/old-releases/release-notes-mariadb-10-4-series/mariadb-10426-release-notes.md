...
[MariaDB 10.4.26](mariadb-10426-release-notes.md) is a [_**Stable (GA)**_](../../../mariadb-release-criteria.md) release.
...
* As per the [MariaDB Deprecation Policy](../../../mariadb-platform-deprecation-policy.md), this will be the last release of [MariaDB 10.4](what-is-mariadb-104.md) for Debian 10 "Buster" for ppc64el
