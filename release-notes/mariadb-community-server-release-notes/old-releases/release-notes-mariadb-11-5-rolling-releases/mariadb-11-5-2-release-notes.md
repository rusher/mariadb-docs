...
[MariaDB 11.5.2](mariadb-11-5-2-release-notes.md) is a [_**Stable (GA)**_](../../../mariadb-release-criteria.md) release. It is an evolution of [MariaDB 11.4](../../mariadb-11-4-series/what-is-mariadb-114.md) with several entirely new features.

[MariaDB 11.5](what-is-mariadb-115.md) is a [rolling release](../../../mariadb-release-model.md). One is expected to upgrade to [MariaDB 11.6.2](../release-notes-mariadb-11-6-rolling-releases/mariadb-11-6-2-release-notes.md), there will be no 11.5.3.
...
* As per the [MariaDB Deprecation Policy](../../../mariadb-platform-deprecation-policy.md), this will be the last release of [MariaDB 11.5](what-is-mariadb-115.md) for Debian 10 "Buster", RHEL/CentOS 7, Ubuntu 23.10 "Mantic", and Fedora 38
