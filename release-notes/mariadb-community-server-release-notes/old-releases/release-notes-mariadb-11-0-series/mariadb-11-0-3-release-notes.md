...
[MariaDB 11.0.3](mariadb-11-0-3-release-notes.md) is a [_**Stable (GA)**_](../../../mariadb-release-criteria.md) release.
...
* As per the [MariaDB Deprecation Policy](../../../mariadb-platform-deprecation-policy.md), this will be the last release of [MariaDB 11.0](what-is-mariadb-110.md) for Ubuntu 18.04 LTS "Bionic" and Ubuntu 22.10 "Kinetic"
