...
[MariaDB 11.0.5](mariadb-11-0-5-release-notes.md) is a [_**Stable (GA)**_](../../../mariadb-release-criteria.md) release.
...
* As per the [MariaDB Deprecation Policy](../../../mariadb-platform-deprecation-policy.md), this will be the last release of [MariaDB 11.0](what-is-mariadb-110.md) for Fedora 37, Ubuntu 23.04 "Lunar", and Windows Server 2019
