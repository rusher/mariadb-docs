...
* [OQGRAPH](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/oqgraph-storage-engine) (In [MariaDB 5.2](../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-2-series/changes-improvements-in-mariadb-5-2.md) and later. Disabled in [MariaDB 5.5](broken-reference) only.)
...
* [TokuDB](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/tokudb) (In [MariaDB 5.5](broken-reference) and later, removed in 10.6)
...
* Many optimizer enhancements in [MariaDB 5.3](broken-reference). [Subqueries](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/selecting-data/joins-subqueries/subqueries) are now finally usable.\
