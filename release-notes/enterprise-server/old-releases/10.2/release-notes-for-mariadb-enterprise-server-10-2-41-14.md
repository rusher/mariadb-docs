...
* [MariaDB Enterprise Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/galera-cluster/README.md), powered by Galera, crashes with errors like: [\[ERROR\] WSREP: Trx 236236 tries to abort slave trx 236238](../10-2/broken-reference/) ([MDEV-25835](https://jira.mariadb.org/browse/MDEV-25835))
