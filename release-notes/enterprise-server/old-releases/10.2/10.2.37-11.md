...
| ------------------------------------------------------------------------------- | ----------------------------------- |
| [CVE-2021-27928](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-27928) | N/A (Critical)[#1](10.2.37-11.md#1) |
...
* [mariadb\_es\_repo\_setup --include-unsupported](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/install-and-upgrade-mariadb/mariadb-package-repository-setup-and-usage#mariadb_es_repo_setup-2) command-line option added
* [mariadb\_es\_repo\_setup --skip-check-installed](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/install-and-upgrade-mariadb/mariadb-package-repository-setup-and-usage#mariadb_es_repo_setup-2) command-line option added
* [mariadb\_es\_repo\_setup --version](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/install-and-upgrade-mariadb/mariadb-package-repository-setup-and-usage#mariadb_es_repo_setup-2) command-line option added
* [mariadb\_repo\_setup --version](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/install-and-upgrade-mariadb/mariadb-package-repository-setup-and-usage) command-line option added
