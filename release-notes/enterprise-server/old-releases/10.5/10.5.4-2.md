...
MariaDB ColumnStore is a columnar storage engine for analytical workloads. MariaDB ColumnStore 1.5.3 is included in this release. Specific details on this component may be found in the [ColumnStore 1.5.3 release notes](../../../columnstore/old-releases/columnstore-1-5/mariadb-columnstore-1-5-3-release-notes.md).
