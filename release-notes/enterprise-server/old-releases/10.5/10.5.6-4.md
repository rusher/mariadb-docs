...
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- |
| [CVE-2020-15180](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2020-15180)                                                                                               | N/A (Critical)[#1](10.5.6-4.md#1) |
...
* This release originally included [ColumnStore 5.4.1](../../../columnstore/old-releases/mariadb-columnstore-5-4-release-notes/mariadb-columnstore-5-4-1-release-notes.md).
* This release has been updated to include [ColumnStore 5.4.3](../../../columnstore/old-releases/mariadb-columnstore-5-4-release-notes/mariadb-columnstore-5-4-3-release-notes.md) on 2020-11-09.
