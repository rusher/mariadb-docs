---
description: >-
  MariaDB Enterprise Server 10.5.18-13 is a Stable (GA) maintenance release of
  MariaDB Enterprise Server 10.5, released on 2022-12-21
---
...
* When a [TIMESTAMP column](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/data-types/date-and-time-data-types/timestamp) is filtered in a subquery inside the [ALL operator](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/selecting-data/subqueries/subqueries-and-all), the results can be incorrect. ([MDEV-27101](https://jira.mariadb.org/browse/MDEV-27101))
...
* When a [INET6](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/data-types/string-data-types/inet6) column is filtered in a subquery inside the [ALL operator](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/selecting-data/subqueries/subqueries-and-all), the results can be incorrect. ([MDEV-27099](https://jira.mariadb.org/browse/MDEV-27099))
...
* [ER\_PK\_INDEX\_CANT\_BE\_IGNORED](../10-5/broken-reference/) error code added
