...
1. MariaDB CVEs are assigned a word rating instead of a CVSS base score. See the [MariaDB Engineering Policy](https://mariadb.com/engineering-policies) for details.
...
* New [MariaDB Enterprise Backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-enterprise-backup) [--log-innodb-page-corruption](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#log-innodb-page-corruption) to continue the backup process when corruption is encountered. Corrupted pages are logged in `backup_corrupted` file in the backup destination directory. ([MDEV-22929](https://jira.mariadb.org/browse/MDEV-22929))
* [MariaDB Enterprise Backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-enterprise-backup) adds `completed with Error`! to the end of the log file if the backup is started with parameter [--log-innodb-page-corruption](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#log-innodb-page-corruption) and completed with corrupted tables. The new log entry `canceled with Error!` will be used when the backup could not be completed. (MENT-1059)
...
* Galera `wsrep` library updated to 26.4.7 in [MariaDB Enterprise Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/).
* Encryption Plugin for [HashiCorp Vault](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/hashicorp-key-management-plugin) added. (MENT-852)
...
* In a very unlikely event, corruption of system tablespace or last recovered page can occur on recovery or a [MariaDB Backup prepare](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup). (MENT-1124, [MDEV-24449](https://jira.mariadb.org/browse/MDEV-24449))
...
* Server hang due to [Galera](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/) lock conflict resolution. ([MDEV-23328](https://jira.mariadb.org/browse/MDEV-23328))
...
* [MariaDB Enterprise Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/) crash after execution of XA START ([MDEV-24469](https://jira.mariadb.org/browse/MDEV-24469))
...
* Plugin system variables and activation options can break mariadbd [--wsrep\_recover](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/reference/galera-cluster-system-variables#wsrep_recover) for [MariaDB Enterprise Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/). ([MDEV-20717](https://jira.mariadb.org/browse/MDEV-20717))
...
* Garbd of [MariaDB Enterprise Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/) can't initiate `SST` ([MDEV-23647](https://jira.mariadb.org/browse/MDEV-23647))
...
* [mariadb-backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup) [--log-innodb-page-corruption](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#log-innodb-page-corruption) command-line option added
...
* [mariadb\_es\_repo\_setup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/install-and-upgrade-mariadb/installing-mariadb/binary-packages/mariadb-package-repository-setup-and-usage#mariadb_es_repo_setup) --skip-check-installed command-line option added
* [mariadb\_es\_repo\_setup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/install-and-upgrade-mariadb/installing-mariadb/binary-packages/mariadb-package-repository-setup-and-usage#mariadb_es_repo_setup) --version command-line option added
...
In alignment with the [enterprise lifecycle](../../enterprise-server-lifecycle.md), MariaDB Enterprise Server 10.4.18-11 is provided for:
