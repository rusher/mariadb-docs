...
* For [MariaDB Enterprise Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/) (Galera Library 26.4.4):
...
* Dropping a partition with wsrep\_OSU\_method=RSU and SESSION sql\_log\_bin=0 caused the [MariaDB Enterprise Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/) (Galera) node to hang. ([MDEV-21189](https://jira.mariadb.org/browse/MDEV-21189))
...
* Querying the [wsrep\_on](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/reference/galera-cluster-system-variables#wsrep_on) system status variable after enabling Galera Cluster Replication in [MariaDB Enterprise Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/) for a running server could result in a crash. (MENT-633)
...
* Running the script `mysql_tzinfo_to_sql` for [MariaDB Enterprise Cluster](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/) could result in inconsistent timezone information across different nodes. ([MDEV-21209](https://jira.mariadb.org/browse/MDEV-21209))
