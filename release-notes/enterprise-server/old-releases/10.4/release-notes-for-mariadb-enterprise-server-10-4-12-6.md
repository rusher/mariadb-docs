...
* [MariaDB Enterprise Backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-enterprise-backup) could crash when used in combination with FLUSH TABLES and UNLOCK TABLES (MENT-438)
