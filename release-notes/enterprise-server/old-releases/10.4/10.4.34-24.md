...
MariaDB Enterprise Server 10.4.34-24 is a maintenance release of [MariaDB Enterprise Server 10.4](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/install-and-upgrade-mariadb/upgrading/upgrade-paths/archived/mariadb-enterprise-server-10.4). This release includes a variety of fixes.
...
* For the complete list of changes in this release, see the [changelog](changelog-10.4.34-24.md).
