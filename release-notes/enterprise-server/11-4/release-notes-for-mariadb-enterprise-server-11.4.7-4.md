...
MariaDB Enterprise Server 11.4.7-4 is a maintenance release of [MariaDB Enterprise Server](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/) 11.4. This release includes a variety of fixes.
...
| [CVE-2023-52971](http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2023-52971) | 4.9                 |
...
WHERE col IN (SELECT ... LEFT JOIN tbl ON tbl.column=reference\_outside\_subquery)
...
* Server crashes when creating a table using function with a return type sys\_refcursor ([MDEV-36409](https://jira.mariadb.org/browse/MDEV-36409))
* Assertion \`thd->lex == sp\_instr\_lex' failed in LEX \*sp\_lex\_instr::parse\_expr(THD \*, sp\_head \*, LEX \*) ([MDEV-36377](https://jira.mariadb.org/browse/MDEV-36377))
* Crash on \`DECLARE spvar1 ROW TYPE OF cursor1\` after a table recreation ([MDEV-36462](https://jira.mariadb.org/browse/MDEV-36462))
...
* USER\_STATISTICS.BUSY\_TIME is in microseconds ([MDEV-36586](https://jira.mariadb.org/browse/MDEV-36586))
...
* Doubled memory usage (11.4.4 <-> 11.4.5) ([MDEV-36213](https://jira.mariadb.org/browse/MDEV-36213))
...
For the complete list of changes in this release, see the [changelog](changelog-for-mariadb-enterprise-server-11.4.7-4.md).
