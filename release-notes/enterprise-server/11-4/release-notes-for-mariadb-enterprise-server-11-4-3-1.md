...
* By default, replication uses Global Transaction IDs (GTID), which makes replicas crash-safe. ([MDEV-19801](https://jira.mariadb.org/browse/MDEV-19801))
  ...
  * In previous releases, when [CHANGE MASTER](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/standard-replication/gtid#change-master) TO was executed without explicitly specifying `MASTER_USE_GTID`, it would default to `MASTER_USE_GTID=no`.
