...
* Server crash when [SELECT](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/selecting-data/select) [WSREP\_LAST\_SEEN\_GTID()](https://mariadb.com/kb/en/WSREP_LAST_SEEN_GTID\(\)) while [Galera](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/galera/README.md) replication is not enabled (wsrep-on=OFF). ([MDEV-23466](https://jira.mariadb.org/browse/MDEV-23466))
...
* Server crashes after changing [innodb\_buffer\_pool\_size](https://mariadb.com/kb/en/innodb_buffer_pool_size) at runtime via a [SET](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/administrative-sql-statements/set-commands/set) statement. ([MDEV-23693](https://jira.mariadb.org/browse/MDEV-23693))
