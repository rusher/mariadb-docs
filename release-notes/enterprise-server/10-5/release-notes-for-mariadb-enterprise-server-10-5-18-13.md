...
* When [SHOW COLUMNS](https://mariadb.com/kb/en/SHOW_COLUMNS) is used on a temporary table, an empty result set is returned. ([MDEV-28455](https://jira.mariadb.org/browse/MDEV-28455))
...
* [ER\_PK\_INDEX\_CANT\_BE\_IGNORED](https://mariadb.com/kb/en/e4174/ER_PK_INDEX_CANT_BE_IGNORED) error code added
