...
* When a [TIMESTAMP column](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/data-types/date-and-time-data-types/timestamp) is filtered in a subquery inside the [ALL operator](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/operators), the results can be incorrect. ([MDEV-27101](https://jira.mariadb.org/browse/MDEV-27101))
...
* When a [INET6 column](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/data-types/string-data-types/inet6) is filtered in a subquery inside the [ALL operator](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/operators), the results can be incorrect. ([MDEV-27099](https://jira.mariadb.org/browse/MDEV-27099))
...
* When the `TZ` environment variable is set on Windows, the [system\_time\_zone](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#system_time_zone) system variable is incorrect. ([MDEV-29102](https://jira.mariadb.org/browse/MDEV-29102))
