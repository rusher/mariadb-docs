...
*   When executing an ALTER TABLE
    ...
    * Mariabackup stores the password into the tool\_command setting in the file xtrabackup\_info, if the password is provided as command-line option ([MDEV-34434](https://jira.mariadb.org/browse/MDEV-34434))
