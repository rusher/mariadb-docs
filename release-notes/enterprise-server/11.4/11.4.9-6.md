...
MariaDB Enterprise Server 11.4.9-6 is a Stable (GA) maintenance release of [MariaDB Enterprise Server 11.4](whats-new.md). This release includes a variety of fixes.
...
For the complete list of changes in this release, see the [changelog](changelog-11.4.9-6.md).
