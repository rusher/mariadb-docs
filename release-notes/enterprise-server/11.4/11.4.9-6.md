...
* Backport @@new\_mode variable to 11.4 ([MDEV-37907](https://jira.mariadb.org/browse/MDEV-37907))
...
* Log write buffering added to the SERVER\_AUDIT and SERVER\_AUDIT2 plugins.
  * The buffering is controlled by the added variables:
  * server\_audit\_file\_buffer\_size - defines the size of the buffer.
...
* Backport bugfix MDEV-34134 "Assertion failure in online\_alter\_log\_row or server hang upon replicating REPAIR on mysql.gtid\_slave\_pos" to ES 11.4 ([MENT-2462](https://jira.mariadb.org/browse/MENT-2462))
