...
# Release Notes for MariaDB Enterprise Server 11.4.13-10

<a href="https://mariadb.com/downloads/enterprise/enterprise-server/" class="button primary">Download</a> <a class="button secondary">Release Notes</a> <a href="changelog-11.4.13-10.md" class="button secondary">Changelog</a> <a href="whats-new.md" class="button secondary">Overview of Enterprise Server 11.4</a>
...
MariaDB Enterprise Server 11.4.13-10 is a Stable (GA) maintenance release of [MariaDB Enterprise Server 11.4](whats-new.md). This release includes a variety of fixes.

{% hint style="success" %}
<p align="center"><strong>See</strong> <a href="whats-new.md"><strong>what's new in MariaDB Enterprise Server 11.4</strong></a></p>
{% endhint %}
...
For the complete list of changes in this release, see the [changelog](changelog-11.4.13-10.md).
...
In alignment to the enterprise lifecycle, MariaDB Enterprise Server 11.4.13-10 is provided for:
