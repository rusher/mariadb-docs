---
description: >-
  MariaDB Enterprise Server 11.4.10-7 is a Stable (GA) maintenance release of
  MariaDB Enterprise Server 11.4, released on 2026-03-17
---
...
*   When an inplace ALTER operation is rolled back, InnoDB drops intermediate tables and their associated FTS internal tables. However, MariaBackup's DDL tracking can incorrectly report
    ...
    this as a backup failure. ([MDEV-38041](https://jira.mariadb.org/browse/MDEV-38041))
