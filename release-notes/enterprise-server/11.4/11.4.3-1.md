---
description: >-
  MariaDB Enterprise Server 11.4.3-1 is a Release Candidate (RC) release of
  MariaDB Enterprise Server 11.4, released on 2024-11-19
---
...
* For [INSERT](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/inserting-loading-data/insert) operations that insert multiple rows, error reporting has been improved: ([MDEV-10075](https://jira.mariadb.org/browse/MDEV-10075))
  * In [GET DIAGNOSTICS](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/programmatic-compound-statements/programmatic-compound-statements-diagnostics/get-diagnostics), the ROW\_NUMBER property allows retrieval of the row number that caused the error or warning:
