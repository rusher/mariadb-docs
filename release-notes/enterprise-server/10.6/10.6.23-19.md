...
MariaDB Enterprise Server 10.6.23-19 is a Stable (GA) maintenance release of [MariaDB Enterprise Server 10.6](whats-new.md). This release includes a variety of fixes.
...
In alignment to the [enterprise lifecycle](../enterprise-server-lifecycle.md), MariaDB Enterprise Server 10.6.23-19 is provided for:
