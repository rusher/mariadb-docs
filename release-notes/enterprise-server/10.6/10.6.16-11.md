---
description: >-
  MariaDB Enterprise Server 11.6.16-11 is a Stable (GA) maintenance release of
  MariaDB Enterprise Server 10.6, released on 2023-12-12
---
...
MariaDB Enterprise Server 10.6.16-11 is a Stable (GA) maintenance release of [MariaDB Enterprise Server](https://app.gitbook.com/s/rBEU9juWLfTDcdwF3Q14/mariadb-columnstore/architecture/columnstore-architectural-overview#mariadb-enterprise-server) 10.6. This release includes a variety of fixes.
