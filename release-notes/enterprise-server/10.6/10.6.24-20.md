...
MariaDB Enterprise Server 10.6.24-20 is a Stable (GA) maintenance release of [MariaDB Enterprise Server 10.6](whats-new.md). This release includes a variety of fixes.
