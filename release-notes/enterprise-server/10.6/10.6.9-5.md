---
description: >-
  MariaDB Enterprise Server 11.6.9-5 is a Stable (GA) maintenance release of
  MariaDB Enterprise Server 10.6, released on 2022-09-12
---
...
MariaDB Enterprise Server 10.6.9-5 is a Stable (GA) maintenance release of [MariaDB Enterprise Server](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/mariadb-enterprise-server/README.md) 10.6. This release includes a variety of fixes.
