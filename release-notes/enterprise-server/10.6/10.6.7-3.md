---
description: >-
  MariaDB Enterprise Server 11.6.7-3 is a Stable (GA) maintenance release of
  MariaDB Enterprise Server 10.6, released on 2022-03-14
---
...
MariaDB Enterprise Server 10.6.7-3 is a Stable (GA) maintenance release of [MariaDB Enterprise Server](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/mariadb-enterprise-server/README.md) 10.6. This release includes a variety of fixes.
...
* When [--stream=xbstream](../10-6/broken-reference/) is set, MariaDB Enterprise Backup can hang on lock acquisitions due to a deadlock. ([MDEV-26558](https://jira.mariadb.org/browse/MDEV-26558))
...
* This release incorporates [MariaDB ColumnStore storage engine version 6.2.3](../../columnstore/old-releases/mariadb-columnstore-6-release-notes/mariadb-columnstore-6-2-3-release-notes.md).
