---
description: >-
  MariaDB Enterprise Server 11.6.12-7 is a Stable (GA) maintenance release of
  MariaDB Enterprise Server 10.6, released on 2023-03-13
---
...
MariaDB Enterprise Server 10.6.12-7 is a Stable (GA) maintenance release of [MariaDB Enterprise Server](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/mariadb-enterprise-server/README.md) 10.6. This release includes a variety of fixes.
...
* An upgrade to MariaDB Server 10.5 and [MariaDB 10.6](../../community-server/10.6/what-is-mariadb-106.md) incorrectly reports that a recovery is needed. ([MDEV-24412](https://jira.mariadb.org/browse/MDEV-24412))
