...
* ([MDEV-34195](https://jira.mariadb.org/browse/MDEV-34195)) Compilation of [MariaDB 10.11.8](../../community-server/mariadb-10-11-series/mariadb-10-11-8-release-notes.md) fails on x32, sizeof(MYSQL) is wrong
