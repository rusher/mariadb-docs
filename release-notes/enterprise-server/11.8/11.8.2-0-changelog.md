...
* ([MDEV-34195](https://jira.mariadb.org/browse/MDEV-34195)) Compilation of [MariaDB 10.11.8](../../community-server/10.11/10.11.8.md) fails on x32, sizeof(MYSQL) is wrong
