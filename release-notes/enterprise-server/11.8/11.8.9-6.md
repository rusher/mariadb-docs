...
description: >-
  ...
  MariaDB Enterprise Server 11.8, released on 2026-09-07
---
...
<!-- TODO(DOCS-6574): the 11 GHSA IDs below are plain text because the advisories are
     published on GitHub only after the release goes live on mariadb.com - every
     per-advisory URL 404s until then and would fail the lychee gate. Once Serg has
     published them, link each ID to
     https://github.com/MariaDB/server/security/advisories/<GHSA-ID> as a small
     post-release update, and re-run doc-lint. -->
