...
{% include "../../.gitbook/includes/unreleased-es-11.8.md" %}
...
([MDEV-34914](https://jira.mariadb.org/browse/MDEV-34914))
...
* Q4 2025 release merge ([MDEV-37509](https://jira.mariadb.org/browse/MDEV-37509))
...
1. Connects\_Tried, which provides the number of attempts the replica has made to connect to the primary, and
2. Master\_Retry\_Count, which provides the number of times the replica will attempt to connect to a primary before giving up. ([MENT-2129](https://jira.mariadb.org/browse/MENT-2129))
