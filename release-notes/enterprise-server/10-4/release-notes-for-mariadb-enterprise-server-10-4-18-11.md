...
* [CREATE-VIEWCREATE VIEW](https://mariadb.com/kb/en/CREATE-VIEWCREATE_VIEW) containing [WITH](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/selecting-data/common-table-expressions/with) clause can crash. ([MDEV-22781](https://jira.mariadb.org/browse/MDEV-22781))
...
* [CHECK\_CONSTRAINTS](https://mariadb.com/kb/en/CHECK_CONSTRAINTS) information schema table schema changed
...
* [mariadb\_es\_repo\_setup](https://mariadb.com/kb/en/mariadb_es_repo_setup) --include-unsupported command-line option added
...
* [mariadb\_repo\_setup](https://mariadb.com/kb/en/mariadb_repo_setup) --version command-line option added
