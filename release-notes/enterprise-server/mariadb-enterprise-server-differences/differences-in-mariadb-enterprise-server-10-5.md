...
* [MariaDB Enterprise Cluster](https://mariadb.com/kb/en/mariadb-galera-cluster-quickstart/) (powered by Galera)
...
* [Hashicorp Vault Plugin](https://mariadb.com/kb/en/hashicorp-vault-understanding-the-hashicorp-vault-encryption-plugin)
