...
* When the [--symbolic-links](https://mariadb.com/kb/en/symbolic-links) option is disabled, such as when `--skip-symbolic-links` or `--disable-symbolic-links` is set, InnoDB still allows symbolic links and .isl files to be created if tables have the `DATA DIRECTORY` option. ([MDEV-26870](https://jira.mariadb.org/browse/MDEV-26870))
...
* [innodb\_buffer\_pool\_size](https://mariadb.com/kb/en/innodb-system-variable/#innodb_buffer_pool_size) system variable minimum value changed from `5242880` to `2097152`
...
* [innodb\_ft\_cache\_size](https://mariadb.com/kb/en/innodb-system-variable/#innodb_ft_cache_size) system variable maximum value changed from `80000000` to `1099511627776`
* [innodb\_ft\_total\_cache\_size](https://mariadb.com/kb/en/innodb-system-variable/#innodb_ft_total_cache_size##) system variable dynamic changed from `No` to `Yes`
...
* `mysql_upgrade` [--check-if-upgrade-is-needed](https://mariadb.com/kb/en/check-if-upgrade-is-needed) command-line option added
* `mysqld` [--rocksdb-ignore-datadic-errors](https://mariadb.com/kb/en/myrocks-server-variables/#rocksdb-ignore-datadic-errors) command-line option added
