...
* [UPDATE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/changing-deleting-data/update) does not insert history row for [system versioned](https://mariadb.com/kb/en/system_versioned-table) or application period based tables if the row has not changed. ([MDEV-23446](https://jira.mariadb.org/browse/MDEV-23446))
...
* [max\_sort\_length](https://mariadb.com/kb/en/server-system-variable/#max_sort_length) system variable minimum value changed from 8 to 64
...
* [setup\_actors](https://mariadb.com/kb/en/performance-schema-setup_actorse-table) performance schema table schema changed
