...
* [mariadb\_es\_repo\_setup --include-unsupported](https://mariadb.com/docs/server/ref/repo/cli/mariadb_es_repo_setup) command-line option added
* [mariadb\_es\_repo\_setup --skip-check-installed](https://mariadb.com/docs/server/ref/repo/cli/mariadb_es_repo_setup) command-line option added
* [mariadb\_es\_repo\_setup --version](https://mariadb.com/docs/server/ref/repo/cli/mariadb_es_repo_setup) command-line option added
