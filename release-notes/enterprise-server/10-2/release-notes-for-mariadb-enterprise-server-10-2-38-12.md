...
* [MariaDB Enterprise Backup](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/mariadb-enterprise-server/README.md) deletes the current source file after a `No space left on device` error, before exiting. Only the incomplete target file is still available. ([MDEV-25221](https://jira.mariadb.org/browse/MDEV-25221))
...
* State snapshot transfer (SST) for [MariaDB Enterprise Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/galera-cluster/README.md) using [MariaDB Enterprise Backup](https://mariadb.com/docs/server/ref/mdb/cli/mariadb-backup/) fails when the --log-bin option was set on the command-line with no value at server startup. ([MDEV-24903](https://jira.mariadb.org/browse/MDEV-24903))
...
* [MariaDB Enterprise Backup](https://mariadb.com/docs/server/ref/mdb/cli/mariadb-backup/) fails [--prepare](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/prepared-statements/prepare-statement) on large backup. ([MDEV-24197](https://jira.mariadb.org/browse/MDEV-24197))
...
* State snapshot transfer (SST) for [MariaDB Enterprise Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/galera-cluster/README.md) using [MariaDB Enterprise Backup](https://mariadb.com/docs/server/ref/mdb/cli/mariadb-backup/) fails when the [--innodb](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb) option was set on the command-line at server startup. ([MDEV-25328](https://jira.mariadb.org/browse/MDEV-25328))
...
* [RENAME TABLE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-definition/rename-table) causes `"Ignoring data file ... with space ID xxxx, since the redo log references ... with space ID xxxx."` for [MariaDB Enterprise Backup](https://mariadb.com/docs/server/ref/mdb/cli/mariadb-backup/). ([MDEV-25568](https://jira.mariadb.org/browse/MDEV-25568))
