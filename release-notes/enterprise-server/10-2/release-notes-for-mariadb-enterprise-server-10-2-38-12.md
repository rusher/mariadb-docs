...
* Table corruption [ER\_NO\_SUCH\_TABLE\_IN\_ENGINE](broken-reference/) or [ER\_CRASHED\_ON\_USAGE](broken-reference/) after [ALTER](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-definition/alter) on [InnoDB](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb) table with foreign key. ([MDEV-24532](https://jira.mariadb.org/browse/MDEV-24532))
* [MariaDB Enterprise Backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backing-up-and-restoring-databases/backup-and-restore-with-mariadb-enterprise-server/mariadb-enterprise-backup) deletes the current source file after a `No space left on device` error, before exiting. Only the incomplete target file is still available. ([MDEV-25221](https://jira.mariadb.org/browse/MDEV-25221))
...
* [innodb\_flush\_method=O\_DIRECT](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/system-variables/server-system-variables#innodb_flush_methodb) fails on compressed tables. ([MDEV-25121](https://jira.mariadb.org/browse/MDEV-25121))
* Server crashes in `check_grant` upon invoking function with [userstat](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/system-variables/server-system-variables#userstat) enabled. ([MDEV-25242](https://jira.mariadb.org/browse/MDEV-25242))
...
* [InnoDB](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb) startup hangs when a recovered transaction exists for the [mysql.innodb\_index\_stats](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/system-variables/server-system-variables#innodb_table_stats) or [mysql.innodb\_table\_stats](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/system-variables/server-system-variables#innodb_table_stat) system tables and a DDL transaction needs to be rolled back. ([MDEV-25503](https://jira.mariadb.org/browse/MDEV-25503))
...
* Query returns a [ER\_BAD\_FIELD\_ERROR](broken-reference/) error when a subquery contains a JOIN with an ON clause that references an outer column. ([MDEV-25002](https://jira.mariadb.org/browse/MDEV-25002))
* Query returns a [ER\_BAD\_FIELD\_ERROR](broken-reference/) error when a Common Table Expression (CTE) contains a `UNION` ([MDEV-24597](https://jira.mariadb.org/browse/MDEV-24597))
...
* State snapshot transfer (SST) for [MariaDB Enterprise Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/galera-cluster/README.md) using [MariaDB Enterprise Backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backing-up-and-restoring-databases/backup-and-restore-with-mariadb-enterprise-server/mariadb-enterprise-backup) fails when the --log-bin option was set on the command-line with no value at server startup. ([MDEV-24903](https://jira.mariadb.org/browse/MDEV-24903))
...
* [MariaDB Enterprise Backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backing-up-and-restoring-databases/backup-and-restore-with-mariadb-enterprise-server/mariadb-enterprise-backup) fails [--prepare](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/prepared-statements/prepare-statement) on large backup. ([MDEV-24197](https://jira.mariadb.org/browse/MDEV-24197))
...
* State snapshot transfer (SST) for [MariaDB Enterprise Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/galera-cluster/README.md) using [MariaDB Enterprise Backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backing-up-and-restoring-databases/backup-and-restore-with-mariadb-enterprise-server/mariadb-enterprise-backup) fails when the [--innodb](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb) option was set on the command-line at server startup. ([MDEV-25328](https://jira.mariadb.org/browse/MDEV-25328))
...
* [MariaDB Enterprise Backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backing-up-and-restoring-databases/backup-and-restore-with-mariadb-enterprise-server/mariadb-enterprise-backup) logs an error instead of a warning when it reads an invalid log block checksum during a [--backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backing-up-and-restoring-databases/mariabackup). ([MDEV-25456](https://jira.mariadb.org/browse/MDEV-25456))
...
* [RENAME TABLE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-definition/rename-table) causes `"Ignoring data file ... with space ID xxxx, since the redo log references ... with space ID xxxx."` for [MariaDB Enterprise Backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backing-up-and-restoring-databases/backup-and-restore-with-mariadb-enterprise-server/mariadb-enterprise-backup). ([MDEV-25568](https://jira.mariadb.org/browse/MDEV-25568))
