...
* [MariaDB Enterprise Backup](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-enterprise-backup) logs an error instead of a warning when it reads an invalid log block checksum during a [--backup](broken-reference/). ([MDEV-25456](https://jira.mariadb.org/browse/MDEV-25456))
