...
* [mariabackup --rollback-xa](https://github.com/mariadb-corporation/docs-server/blob/test/release-notes/enterprise-server/10-2/broken-reference/README.md) command-line option added
