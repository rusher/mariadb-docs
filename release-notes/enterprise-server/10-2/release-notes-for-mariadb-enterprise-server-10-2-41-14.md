...
* Executing [CREATE OR REPLACE TABLE AS SELECT](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-definition/create/create-table) under [LOCK TABLE](https://mariadb.com/kb/en/locl-table) can cause in a crash. ([MDEV-23391](https://jira.mariadb.org/browse/MDEV-23391))
...
* [MariaDB Enterprise Cluster](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/galera-cluster/README.md), powered by Galera, crashes with errors like: [\[ERROR\] WSREP: Trx 236236 tries to abort slave trx 236238](https://mariadb.com/kb/en/\[ERROR]_WSREP%3A_Trx_236236_tries_to_abort_slave_trx_236238) ([MDEV-25835](https://jira.mariadb.org/browse/MDEV-25835))
