...
* When [wsrep\_sst\_method=mariadb-backup](broken-reference) is set for MariaDB Enterprise Cluster, but MariaDB Enterprise Backup is not installed on the joiner node, the joiner node fails to start. ([MDEV-15209](https://jira.mariadb.org/browse/MDEV-15209))
