...
* When a CTE is used in a subquery of a [DELETE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/changing-deleting-data/delete) statement, the server incorrectly raises an error with the [ER\_NO\_DB\_ERROR](broken-reference/) error code. ([MDEV-26470](https://jira.mariadb.org/browse/MDEV-26470))
...
* When a CTE is used with a `UNION` in a [CREATE TABLE .. AS ..](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-definition/create/create-table) statement, the server incorrectly raises an error with the [ER\_NO\_DB\_ERROR](broken-reference/) error code. ([MDEV-27086](https://jira.mariadb.org/browse/MDEV-27086))
...
* [innodb\_buffer\_pool\_size](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/system-variables/server-system-variables#innodb_buffer_pool_size) system variable minimum value changed from 5242880 to 2097152
* `mysql_upgrade` [--check-if-upgrade-is-needed](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/system-variables/server-system-variables#check-if-upgrade-is-needed) command-line option added
* `mysqld` [--rocksdb-ignore-datadic-errors](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/system-variables/server-system-variables#rocksdb-ignore-datadic-errors) command-line option added
* [rocksdb\_ignore\_datadic\_errors](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/system-variables/server-system-variables#rocksdb_ignore_datadic_errors) system variable added
