...
* Limit [innodb\_encryption\_threads](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/system-variables/server-system-variables#innodb_encryption_threads) to `255` ([MDEV-22258](https://jira.mariadb.org/browse/MDEV-22258))
...
* [innodb\_log\_optimize\_ddl](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/system-variables/server-system-variables#innodb_log_optimize_ddl) =off is not crash safe. ([MDEV-21347](https://jira.mariadb.org/browse/MDEV-21347))
...
* [mariabackup --prepare](broken-reference) does not stop on errors while applying InnoDB redo log. ([MDEV-22354](https://jira.mariadb.org/browse/MDEV-22354))
...
In alignment with the [enterprise lifecycle](../enterprise-server-lifecycle.md), MariaDB Enterprise Server 10.2.33-8 is provided for:
