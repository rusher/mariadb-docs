...
* Recovery with [mariadb-backup](broken-reference) crash related to [InnoDB](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb) with custom [innodb\_data\_file\_path](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/myrocks/myrocks-system-variables#innodb_data_file_path) ([MDEV-19978](https://jira.mariadb.org/browse/MDEV-19978))
...
* [mariadb-backup](broken-reference) [--rsync option](https://github.com/mariadb-corporation/docs-server/blob/test/release-notes/enterprise-server/10-2/broken-reference/README.md) removed
