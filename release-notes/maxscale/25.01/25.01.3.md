...
If you are upgrading from an older major version of MaxScale, please read the [upgrading document](/maxscale/maxscale-management/installation-and-configuration/upgrading-maxscale) for this MaxScale version.
...
There are some limitations and known issues within this version of MaxScale. For more information, please refer to the [Limitations](/maxscale/maxscale-quickstart-guides/mariadb-maxscale-limitations-guide) document.
