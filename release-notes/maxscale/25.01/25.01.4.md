...
Release 25.01.4 is a GA release. It was released on 2025-09-08.

This document describes the changes in release 25.01.4, when compared to the previous release in the same series.

If you are upgrading from an older major version of MaxScale, please read the [upgrading document](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-management/installation-and-configuration/upgrading-maxscale) for this MaxScale version.
...
* [MXS-5317](https://jira.mariadb.org/browse/MXS-5317) Role-based result row limit in Query Editor
...
* [MXS-5732](https://jira.mariadb.org/browse/MXS-5732) Schema tree explorer doesn't show all tables or schemas
...
* [MXS-5693](https://jira.mariadb.org/browse/MXS-5693) Maxscale Uptime on the GUI is overlapping
