...
## MariaDB MaxScale 22.08.9 Release Notes -- 2023-10-30
...
* [MXS-4736](https://jira.mariadb.org/browse/MXS-4736) Read-only transaction sometimes loses statements with causal\_reads=universal and transaction\_replay=true
