...
{% hint style="danger" %}
**NOTE** After 2.5.12 was released, a serious [regression](https://jira.mariadb.org/browse/MXS-3585) was noticed. Do not use MaxScale 2.5.12, but install or upgrade to MaxScale 2.5.13 that contains a fix for the regression.
{% endhint %}
...
* [MXS-3565](https://jira.mariadb.org/browse/MXS-3565) COM\_STMT\_EXECUTE target selection is too restrictive when no metadata is provided
...
* [MXS-3536](https://jira.mariadb.org/browse/MXS-3536) max\_slave\_connections=0 doesn't work as expected
