# MariaDB MaxScale 23.02 Changelog
...
* Added `replication_custom_options`-setting to both MariaDB Monitor and server.
  ...
  connections. See [MariaDB Monitor documentation](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-archive/archive/mariadb-maxscale-23-02/mariadb-maxscale-23-02-monitors/mariadb-maxscale-2302-mariadb-monitor#replication_custom_options)
...
* The REST-API is now supports ODBC-type connections in the `/sql`
  endpoints. For more information, refer to the SQL resource [documentation](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-archive/archive/mariadb-maxscale-23-02/mariadb-maxscale-23-02-rest-api/mariadb-maxscale-2302-sql-resource#open-sql-connection-to-server).
...
* The new `/sql/:id/etl` endpoints allow ETL operations to be done from
  ...
  new API functions, refer to the SQL resource [documentation](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-archive/archive/mariadb-maxscale-23-02/mariadb-maxscale-23-02-rest-api/mariadb-maxscale-2302-sql-resource#prepare-etl-operation).
