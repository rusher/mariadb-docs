---
description: >-
  MaxScale 23.02.0 is a Beta release of MariaDB MaxScale 23.02, released on
  2023-02-22
---
...
`maxctrl (list|show) sessions` and _MaxGUI_ now show for each session an _i/o activity_ number that gives an indication of the load of a particular
