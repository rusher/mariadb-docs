---
description: >-
  MaxScale 24.02.3 is a Beta release of MariaDB MaxScale 24.02, released on
  2024-02-27
---
...
MaxScale now automatically adds _last\_gtid_ to session-level _session\_track\_system\_variables_ when `causal_reads` is enabled. The setting is
