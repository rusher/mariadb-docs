# MariaDB MaxScale 24.02.7 Release Notes -- 2025-09-08
...
If you are upgrading from an older major version of MaxScale, please read the [upgrading document](../Upgrading/Upgrading-To-MaxScale-24.02.md) for this MaxScale version.
...
* [MXS-5052](https://jira.mariadb.org/browse/MXS-5052) Allow encrypt_binlog=ON and innodb_encrypt_log=ON with Data-at-rest encryption when rebuilding with --async-rebuild-server
