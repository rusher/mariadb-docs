...
* [MariDB MaxScale 21.06.19 Release Notes](21.06.19.md)
...
* MaxScale can read client user accounts from a file and map them to backend\
  users. See service setting [user\_accounts\_file](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-archive/archive/mariadb-maxscale-21-06/mariadb-maxscale-21-06-getting-started/mariadb-maxscale-2106-maxscale-2106-mariadb-maxscale-configuration-guide#user_accounts_file)\
  and listener setting [user\_mapping\_file](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-archive/archive/mariadb-maxscale-21-06/mariadb-maxscale-21-06-getting-started/mariadb-maxscale-2106-maxscale-2106-mariadb-maxscale-configuration-guide#user_mapping_file)\
...
* Backend connection multiplexing added. See [idle\_session\_pool\_time](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-archive/archive/mariadb-maxscale-21-06/mariadb-maxscale-21-06-getting-started/mariadb-maxscale-2106-maxscale-2106-mariadb-maxscale-configuration-guide#idle_session_pool_time)\
  for more information.
...
* Services can now directly route to other services with the help of the [target](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-archive/archive/mariadb-maxscale-21-06/mariadb-maxscale-21-06-getting-started/mariadb-maxscale-2106-maxscale-2106-mariadb-maxscale-configuration-guide#targets) parameter.
* Server parameters protocol and authenticator have been deprecated. Any\
  definitions are ignored.
* Listeners support multiple authenticators.
* The replication lag of a slave server must now be less than [max\_slave\_replication\_lag](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-archive/archive/mariadb-maxscale-21-06/mariadb-maxscale-21-06-routers/mariadb-maxscale-2106-maxscale-2106-readwritesplit#max_slave_replication_lag)\
...
* MariaDB-Monitor supports cooperative monitoring. See [cooperative monitoring](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-archive/archive/mariadb-maxscale-21-06/mariadb-maxscale-2106-maxscale-21-06-monitors/mariadb-maxscale-2106-maxscale-2106-mariadb-monitor#cooperative-monitoring)\
  for more information.
