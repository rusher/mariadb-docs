---
description: >-
  Release notes for MariaDB Connector/C++ 1.1.5, a Stable (GA) release published
  27 August 2024.
---
...
This is a GA release of the [MariaDB Connector/C++ 1.1](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-cpp) series, the interface between C++ applications, and MariaDB Server. MariaDB Connector/C++ enables development of C++ applications using a JDBC-based API, which is also used by MariaDB Connector/JDBC.
