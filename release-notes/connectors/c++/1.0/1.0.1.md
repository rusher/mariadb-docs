---
description: >-
  Release notes for MariaDB Connector/C++ 1.0.1, a Stable (GA) release published
  17 June 2021.
---
...
[MariaDB Connector/C++](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-cpp/mariadb-connector-c++-guide) is the interface between C++ applications and MariaDB Server. MariaDB Connector/C++ enables development of C++ applications using a JDBC-based API, which is also used by MariaDB Connector/J.
