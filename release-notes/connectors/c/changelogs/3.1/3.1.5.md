---
description: >-
  Full changelog for MariaDB Connector/C 3.1.5, listing every commit in the
  release.
---
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](../../3.1/3.1.5.md)[Changelog](3.1.5.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* [Revision #9473573](https://github.com/mariadb-corporation/mariadb-connector-c/commit/9473573)\
  ...
  * Added test for testing maximum number of parameters in binary protocol.
