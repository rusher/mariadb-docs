---
description: >-
  Full changelog for MariaDB Connector/C 3.1.3, listing every commit in the
  release.
---
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](../../mariadb-connector-c-31-release-notes/mariadb-connector-c-313-release-notes.md)[Changelog](mariadb-connector-c-313-changelog.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* [Revision #0c20765](https://github.com/mariadb-corporation/mariadb-connector-c/commit/0c20765)\
  ...
  * Fix of memory leak in the test and end spaces.
```
