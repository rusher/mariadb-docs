---
description: >-
  Full changelog for MariaDB Connector/C 3.1.10, listing every commit in the
  release.
---
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](../../3.1/3.1.10.md)[Changelog](3.1.10.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* [Revision #804bf08](https://github.com/mariadb-corporation/mariadb-connector-c/commit/804bf08)\
  ...
  * removed additional check for ZLIB\_FOUND, since option REQUIRED was specified before.
