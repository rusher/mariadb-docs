---
description: >-
  Full changelog for MariaDB Connector/C 3.1.8, listing every commit in the
  release.
---
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](../../3.1/3.1.8.md)[Changelog](3.1.8.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)

**Release date:** 14 May 2020

For the highlights of this release, see the [release notes](../../3.1/3.1.8.md).
...
* [Revision #c0d5d7d](https://github.com/mariadb-corporation/mariadb-connector-c/commit/c0d5d7d)\
  ...
  * Fix typo in output string: initial -> initial
