---
description: >-
  Full changelog for MariaDB Connector/C 3.2.0, listing every commit in the
  release.
---
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](../../3.2/3.2.0.md)[Changelog](3.2.0.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* [Revision #b637cda](https://github.com/mariadb-corporation/mariadb-connector-c/commit/b637cda)\
  ...
  * Move MariaDB Cloud test to allowed\_failures section due to sporadic non-reproducible errors.
