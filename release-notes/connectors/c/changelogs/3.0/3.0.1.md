---
description: >-
  Full changelog for MariaDB Connector/C 3.0.1, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-c/3.0.1)[Release Notes](../../3.0/3.0.1.md)[Changelog](3.0.1.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* [Revision #87e861c](https://github.com/mariadb-corporation/mariadb-connector-c/commit/87e861c)\
  ...
  * client side implementation for [MDEV-10340](https://jira.mariadb.org/browse/MDEV-10340): int STDCALL mysql\_reset\_connection(MYSQL \*mysql)
...
* [Revision #fbf6fd1](https://github.com/mariadb-corporation/mariadb-connector-c/commit/fbf6fd1)\
  ...
  * Valgrind fixes: - fixed 2 uninitialized memory errors - fixed leak in client test
...
* [Revision #9207626](https://github.com/mariadb-corporation/mariadb-connector-c/commit/9207626)\
  ...
  * 10.2-integration re-added api functions - mysql\_debug (dummy) - mysql\_get\_parameters added low level api functions - mysql\_net\_field\_length - mysql\_net\_read
...
* [Revision #a06574a](https://github.com/mariadb-corporation/mariadb-connector-c/commit/a06574a)\
  ...
  * Implement mysql\_stmt\_execute\_direct without COM\_MULTI. Network roundtrip is avoided, but no other optimization done in this commit. Like, possible to accumulate send 2 command packets in single send(), and it is trivial to do, but omitted here on reasons of clarity
...
* [Revision #392dc4d](https://github.com/mariadb-corporation/mariadb-connector-c/commit/392dc4d)\
  ...
  * Fix for [MDEV-10173](https://jira.mariadb.org/browse/MDEV-10173): Ignore decimals if the value exceeds the type specific maximum of 6 digits
...
* [Revision #e1280ab](https://github.com/mariadb-corporation/mariadb-connector-c/commit/e1280ab)\
  ...
  * Use case-insensitive comparison for character set names
...
* [Revision #bb365dd](https://github.com/mariadb-corporation/mariadb-connector-c/commit/bb365dd)\
  ...
  * SSL fixes: - wrong include directory for OpenSSL - added errormessage for SEC\_E\_ILLEGAL\_MESSAGE
* [Revision #5eaeb24](https://github.com/mariadb-corporation/mariadb-connector-c/commit/5eaeb24)\
  2016-03-12 09:52:40 +0100
  * Fixed timeout when using named\_pipe: - if timeout is 0, we need to specify INFINITE (overlapped) - don't set read/write timeout before connection was established successfully
...
* [Revision #2f67911](https://github.com/mariadb-corporation/mariadb-connector-c/commit/2f67911)\
  ...
  * changed plugin library types from SHARED to MODULE Fixed float/double/decimal conversion for prepared statements: since \_gcvt (Windows) and gcvt (\*nix) deliver different results we use now dtoa.c from server package, which is licensed under LGPL.
...
* [Revision #409d673](https://github.com/mariadb-corporation/mariadb-connector-c/commit/409d673)\
  ...
  * 10.2 - integration fixes - enable data truncation reporting for ps by default - added plugin prototype definitions to mysql.h10.2 - integration fixes
