---
description: >-
  Full changelog for MariaDB Connector/C 3.0.2, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-c/3.0.2)[Release Notes](../../3.0/3.0.2.md)[Changelog](3.0.2.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* [Revision #5c4cf7a](https://github.com/mariadb-corporation/mariadb-connector-c/commit/5c4cf7a)\
  ...
  * Implementation of SHA256 authentication plugin ([CONC-229](https://jira.mariadb.org/browse/CONC-229)). On Windows the sha256 plugin doesn't need any external TLS/Crypto libraries, it uses windows crypto library. On non Windws platforms the plugin requires OpenSSL (GnuTLS doesn't support OAEP v2.0 padding yet)
