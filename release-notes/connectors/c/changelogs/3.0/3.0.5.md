---
description: >-
  Full changelog for MariaDB Connector/C 3.0.5, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-c/3.0.5)[Release Notes](../../3.0/3.0.5.md)[Changelog](3.0.5.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)

**Release date:** 7 Jun 2018

For the highlights of this release, see the [release notes](../../3.0/3.0.5.md).
...
* [Revision #2689375](https://github.com/mariadb-corporation/mariadb-connector-c/commit/2689375)\
  ...
  * \[test] removing plugins from server test build. server test build can be build with plugins according to build options. This patch permit will not install those plugins (particularly mariadb-plugin-cracklib-password-check)
...
* [Revision #3e164b5](https://github.com/mariadb-corporation/mariadb-connector-c/commit/3e164b5)\
  ...
  * Fix test failures if testing against server < 10.2
...
* [Revision #35d6fb1](https://github.com/mariadb-corporation/mariadb-connector-c/commit/35d6fb1)\
  ...
  * Fixed windows build: target name for sha256 password plugin wasn't specified
