---
description: >-
  Full changelog for MariaDB Connector/C 3.0.6, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-c/3.0.6)[Release Notes](../../3.0/3.0.6.md)[Changelog](3.0.6.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* [Revision #b19f6a4](https://github.com/mariadb-corporation/mariadb-connector-c/commit/b19f6a4)\
  ...
  * [CONC-329](https://jira.mariadb.org/browse/CONC-329): change pvio\_\*\_blocking to return int to accommodate SOCKET\_ERROR(-1)
* [Revision #d2ee129](https://github.com/mariadb-corporation/mariadb-connector-c/commit/d2ee129)\
  2018-07-27 07:32:08 +0200
  * [CONC-297](https://jira.mariadb.org/browse/CONC-297): Fixed regression bug (which happened due to a bad merge)
