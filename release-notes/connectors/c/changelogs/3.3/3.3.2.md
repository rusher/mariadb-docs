---
description: >-
  Full changelog for MariaDB Connector/C 3.3.2, listing every commit in the
  release.
---
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](../../3.3/3.3.2.md)[Changelog](3.3.2.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)

**Release date:** 22 Aug 2022

For the highlights of this release, see the [release notes](../../3.3/3.3.2.md).
...
* [Revision #18ae382](https://github.com/mariadb-corporation/mariadb-connector-c/commit/18ae382)\
  ...
  * update MARIADB\_CLIENT\_VERSION\_PATCH to next [MariaDB 10.5](../../../../community-server/old-releases/10.5/what-is-mariadb-105.md)
