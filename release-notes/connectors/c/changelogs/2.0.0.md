---
description: >-
  Full changelog for MariaDB Connector/C 2.0.0, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-c/2.0.0)[Release Notes](../2.0.0.md)[Changelog](2.0.0.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/connectors-quickstart-guides/mariadb-connector-c-guide)

**Release date:** 2 Apr 2014

For the highlights of this release, see the [release notes](../2.0.0.md).
...
* [Revision #129](https://bazaar.launchpad.net/~maria-captains/mariadb-native-client/trunk/revision/129)\
  ...
  * Include code signing process in vs build (disabled exclude\_from\_all)
...
* [Revision #117](https://bazaar.launchpad.net/~maria-captains/mariadb-native-client/trunk/revision/117)\
  ...
  * Fix for [CONC-75](https://jira.mariadb.org/browse/CONC-75): options not handled correctly after a reconnect occurred
...
* [Revision #113](https://bazaar.launchpad.net/~maria-captains/mariadb-native-client/trunk/revision/113)\
  ...
  * Fix for [CONC-70](https://jira.mariadb.org/browse/CONC-70): Unknown error when reading large packets via compressed protocol
...
* [Revision #88](https://bazaar.launchpad.net/~maria-captains/mariadb-native-client/trunk/revision/88)\
  ...
  * Merge from 10.0 dynamic column implementation: - functions which operate with numeric keys now have suffix \_num - Fixes for MDEV 4993-4995
...
* [Revision #81](https://bazaar.launchpad.net/~maria-captains/mariadb-native-client/trunk/revision/81)\
  ...
  * Added dynamic column api Added character set conversion
