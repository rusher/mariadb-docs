---
description: >-
  Full changelog for MariaDB Connector/C 2.3.2, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-c/2.3.2)[Release Notes](../../2.3/2.3.2.md)[Changelog](2.3.2.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)

**Release date:** 18 Jan 2017

For the highlights of this release, see the [release notes](../../2.3/2.3.2.md).
