---
description: >-
  Release notes for MariaDB Connector/C 2.2.0, a Stable (GA) release published
  29 September 2015.
---
...
[Download](https://downloads.mariadb.org/connector-c/2.2.0)[Release Notes](2.2.0.md)[Changelog](../changelogs/2.2/2.2.0.md)[About of MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
information on each push, see the [changelog](../changelogs/2.2/2.2.0.md).
