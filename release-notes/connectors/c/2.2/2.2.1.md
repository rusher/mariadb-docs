---
description: >-
  Release notes for MariaDB Connector/C 2.2.1, a Stable (GA) release published
  18 November 2015.
---
...
[Download](https://downloads.mariadb.org/connector-c/2.2.1)[Release Notes](2.2.1.md)[Changelog](../changelogs/2.2/2.2.1.md)[About of MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* Fixed build errors for Microsoft Visual Studio 2015
...
information on each push, see the [changelog](../changelogs/2.2/2.2.1.md).
