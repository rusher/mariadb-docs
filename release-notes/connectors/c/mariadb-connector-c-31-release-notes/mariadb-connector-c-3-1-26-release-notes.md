...
MariaDB Connector/C 3.1.25 was not released separately but is included in [MariaDB Community Server 10.5.27](../../../community-server/old-releases/mariadb-10-5-series/mariadb-10-5-27-release-notes.md). MariaDB Connector/C 3.1.26 includes additional bug fixes for the Connector.
