---
description: >-
  Release notes for MariaDB Connector/C 3.1.5, a Stable (GA) release published
  11 November 2019.
---
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](3.1.5.md)[Changelog](../changelogs/3.1/3.1.5.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* Included in [MariaDB 10.4.10](../../../community-server/old-releases/10.4/10.4.10.md), [MariaDB 10.3.20](../../../community-server/old-releases/10.3/10.3.20.md), and [MariaDB 10.2.29](../../../community-server/old-releases/10.2/10.2.29.md)

## Changelog

For a list of changes made in this release, with links to detailed information\
on each push, see the [changelog](../changelogs/3.1/3.1.5.md).
