---
description: >-
  Release notes for MariaDB Connector/C 3.1.16, a Stable (GA) release published
  15 February 2022.
---
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](3.1.16.md)[Changelog](../changelogs/3.1/3.1.16.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* [MDEV-27304](https://jira.mariadb.org/browse/MDEV-27304): FIx detection of MariaDB Server: If the server was started with --version option, it might not contain the 5.5.5 prefix
...
on each push, see the [changelog](../changelogs/3.1/3.1.16.md).
