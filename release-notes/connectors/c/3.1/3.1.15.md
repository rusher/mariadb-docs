---
description: >-
  Release notes for MariaDB Connector/C 3.1.15, a Stable (GA) release published
  10 November 2021.
---
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](3.1.15.md)[Changelog](../changelogs/3.1/3.1.15.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
on each push, see the [changelog](../changelogs/3.1/3.1.15.md).
