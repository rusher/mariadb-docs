---
description: >-
  Release notes for MariaDB Connector/C 3.1.8, a Stable (GA) release published
  14 May 2020.
---
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](3.1.8.md)[Changelog](../changelogs/3.1/3.1.8.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* Included in [MariaDB 10.5.3](../../../community-server/old-releases/10.5/10.5.3.md), [MariaDB 10.4.13](../../../community-server/old-releases/10.4/10.4.13.md), [MariaDB 10.3.23](../../../community-server/old-releases/10.3/10.3.23.md), and [MariaDB 10.2.32](../../../community-server/old-releases/10.2/10.2.32.md)
