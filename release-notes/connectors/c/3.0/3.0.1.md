---
description: >-
  Release notes for MariaDB Connector/C 3.0.1, a Beta release published 18
  January 2017.
---
...
[Download](https://downloads.mariadb.org/connector-c/3.0.1)[Release Notes](3.0.1.md)[Changelog](../changelogs/3.0/3.0.1.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* support for extended client/server capabilities (requires [MariaDB 10.2](../../../community-server/old-releases/10.2/what-is-mariadb-102.md) or newer)
