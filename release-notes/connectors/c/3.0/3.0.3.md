---
description: >-
  Release notes for MariaDB Connector/C 3.0.3, a Stable (GA) release published
  18 January 2018.
---
...
[Download](https://downloads.mariadb.org/connector-c/3.0.3)[Release Notes](3.0.3.md)[Changelog](../changelogs/3.0/3.0.3.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
* Added MARIADB\_BASE\_VERSION definition in mariadb\_version.h to distinguish MARIADB from MySQL
