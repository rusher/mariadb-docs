---
description: >-
  Release notes for MariaDB Connector/C 3.0.5, a Stable (GA) release published 7
  June 2018.
---
...
[Download](https://downloads.mariadb.org/connector-c/3.0.5)[Release Notes](3.0.5.md)[Changelog](../changelogs/3.0/3.0.5.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
on each push, see the [changelog](../changelogs/3.0/3.0.5.md).
