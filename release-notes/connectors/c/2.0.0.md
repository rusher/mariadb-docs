...
[Download](https://downloads.mariadb.org/connector-c/2.0.0)[Release Notes](2.0.0.md)[Changelog](changelogs/2.0.0.md)[About MariaDB Connector/C](broken-reference/)
...
information on each push, see the [changelog](changelogs/2.0.0.md).
