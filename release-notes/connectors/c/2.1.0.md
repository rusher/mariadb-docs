...
[Download](https://downloads.mariadb.org/connector-c/2.1.0)[Release Notes](2.1.0.md)[Changelog](changelogs/2.1.0.md)[About MariaDB Connector/C](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/about-mariadb-connector-c/README.md)
...
information on each push, see the [changelog](changelogs/2.1.0.md).
