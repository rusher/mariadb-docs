...
[Download](https://downloads.mariadb.org/connector-c/2.1.0) [Release Notes](2.1.0.md) [Changelog](changelogs/2.1.0.md) About MariaDB Connector/C
...
* Non-blocking (asynchronous) API. For a detailed description, see [Non-blocking Client Library](https://app.gitbook.com/s/WCInJQ9cmGjq1lsTG91E/development-articles/mariadb-internals/using-mariadb-with-your-programs-api/non-blocking-client-library).
...
For a list of changes made in this release, with links to detailed information on each push, see the [changelog](changelogs/2.1.0.md).
