---
description: >-
  Release notes for MariaDB Connector/C 3.4.3, a Stable (GA) release published
  12 November 2024.
---
...
MariaDB Connector/C 3.4.2 was not released separately but is included in [MariaDB Community Server 11.4.4](../../../community-server/11.4/11.4.4.md). MariaDB Connector/C 3.4.3 includes additional bug fixes for the Connector and is included in [MariaDB Community Server 11.6.2](../../../community-server/old-releases/11.6/11.6.2.md), and [11.7.1](../../../community-server/old-releases/11.7/11.7.1.md).
...
* Man pages are no longer stored in github repository. They can be build with cmake option -DWITH\_DOCS=ON (requires python 3 and pandoc).
