---
description: >-
  Release notes for MariaDB Connector/C 2.3.4, a Stable (GA) release published 4
  December 2017.
---
...
[Download](https://downloads.mariadb.org/connector-c/2.3.4)[Release Notes](2.3.4.md)[Changelog](../changelogs/2.3/2.3.4.md)[About MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-c)
...
information on each push, see the [changelog](../changelogs/2.3/2.3.4.md).
