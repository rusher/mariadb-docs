---
description: >-
  Release notes for MariaDB Connector/Python 0.9.56 beta, a Beta release
...
on each push, see the [changelog](../changelogs/0.9/0.9.56.md).
