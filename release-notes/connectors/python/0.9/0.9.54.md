---
description: >-
  Release notes for MariaDB Connector/Python 0.9.54-beta, a Beta release
...
on each push, see the [changelog](../changelogs/0.9/0.9.54.md).
