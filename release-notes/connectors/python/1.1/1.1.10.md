---
description: >-
  Release notes for MariaDB Connector/Python 1.1.10, a Stable (GA) release
...
on each push, see the [changelog](../changelogs/1.1/1.1.10.md).
