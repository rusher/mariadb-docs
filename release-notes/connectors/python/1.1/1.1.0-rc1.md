---
description: >-
  Release notes for MariaDB Connector/Python 1.1.0 RC1, a Release Candidate (RC)
  release published 7 April 2022.
---
...
* [CONPY-88](https://jira.mariadb.org/browse/CONPY-88): Get additional information in fieldinfo: cursor->description() now contains 3 additional elements: table\_name, original column name and original table name
