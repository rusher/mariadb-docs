---
description: >-
  Release notes for MariaDB Connector/Python 1.1.6, a Stable (GA) release
...
on each push, see the [changelog](../changelogs/1.1/1.1.6.md).
