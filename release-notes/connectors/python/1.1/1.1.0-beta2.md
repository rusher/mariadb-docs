---
description: >-
  Release notes for MariaDB Connector/Python 1.1.0 Beta2, a Beta release
...
on each push, see the [changelog](../changelogs/1.1/1.1.0-beta2.md).
