...
For the highlights of this release, see the[release notes](../../mariadb-connector-python-1-1-release-notes/mariadb-connector-python-1-1-0-alpha1-release-notes.md).
...
* [Revision #18b81fd](https://github.com/mariadb-corporation/mariadb-connector-python/commit/18b81fd)\
  2021-08-18 07:19:48 +0200
  * Documentation fixes
* [Revision #2e7dcde](https://github.com/mariadb-corporation/mariadb-connector-python/commit/2e7dcde)\
  2021-08-16 10:41:07 +0200
  * Removed converter from C Code
* [Revision #307046b](https://github.com/mariadb-corporation/mariadb-connector-python/commit/307046b)\
  2021-08-16 10:12:41 +0200
  * Removed unused MemberDefs from connection
* [Revision #445f3bc](https://github.com/mariadb-corporation/mariadb-connector-python/commit/445f3bc)\
  2021-08-16 10:11:46 +0200
  * Documentation update:
* [Revision #3fbe0e3](https://github.com/mariadb-corporation/mariadb-connector-python/commit/3fbe0e3)\
  2021-08-16 10:11:24 +0200
  * removed newline from end of file
* [Revision #aaf5011](https://github.com/mariadb-corporation/mariadb-connector-python/commit/aaf5011)\
  2021-08-16 10:10:22 +0200
  * gitignore update
* [Revision #7494e2b](https://github.com/mariadb-corporation/mariadb-connector-python/commit/7494e2b)\
  2021-08-16 10:09:45 +0200
  * Documentation fixes and update
* [Revision #6bbe026](https://github.com/mariadb-corporation/mariadb-connector-python/commit/6bbe026)\
  2021-08-16 10:08:15 +0200
  * Moved MemberDef properties
* [Revision #1ab9f83](https://github.com/mariadb-corporation/mariadb-connector-python/commit/1ab9f83)\
  2021-08-16 09:32:32 +0200
  * Test fix:
* [Revision #fc32956](https://github.com/mariadb-corporation/mariadb-connector-python/commit/fc32956)\
  2021-08-16 09:29:55 +0200
  * Check server capabilities at the beginning of function
* [Revision #d3d1cfc](https://github.com/mariadb-corporation/mariadb-connector-python/commit/d3d1cfc)\
  2021-08-16 09:28:32 +0200
  * Fixed rowcount for executemany() when connected to a MySQL database server.
* [Revision #a614b9f](https://github.com/mariadb-corporation/mariadb-connector-python/commit/a614b9f)\
  2021-08-05 10:09:12 +0200
  * Fixed a previous copy/paste error
* [Revision #8797449](https://github.com/mariadb-corporation/mariadb-connector-python/commit/8797449)\
  2021-08-05 09:57:09 +0200
  * Raise exception if number of parameter doesn't match.
* [Revision #1d201f1](https://github.com/mariadb-corporation/mariadb-connector-python/commit/1d201f1)\
  2021-08-05 08:52:32 +0200
  * Removed refrence decrement in tuple construct.
* [Revision #9ac0551](https://github.com/mariadb-corporation/mariadb-connector-python/commit/9ac0551)\
  2021-08-05 08:32:20 +0200
  * Default mode for cursor changed:
* [Revision #8cd33d5](https://github.com/mariadb-corporation/mariadb-connector-python/commit/8cd33d5)\
  2021-08-03 11:31:31 +0200
  * Fixed memory leak in parser
* [Revision #cb0c3c8](https://github.com/mariadb-corporation/mariadb-connector-python/commit/cb0c3c8)\
  2021-08-01 11:29:22 +0200
  * Documentation update
* [Revision #b3713fd](https://github.com/mariadb-corporation/mariadb-connector-python/commit/b3713fd)\
  2021-08-01 11:16:19 +0200
  * initialization fixes
* [Revision #47ca11d](https://github.com/mariadb-corporation/mariadb-connector-python/commit/47ca11d)\
  2021-08-01 10:31:10 +0200
  * Documentation update
* [Revision #ebb09cf](https://github.com/mariadb-corporation/mariadb-connector-python/commit/ebb09cf)\
  2021-07-28 06:55:10 +0200
  * Documentation
* [Revision #5a81686](https://github.com/mariadb-corporation/mariadb-connector-python/commit/5a81686)\
  2021-07-26 06:54:38 +0200
  * Documentation work
* [Revision #6c6e100](https://github.com/mariadb-corporation/mariadb-connector-python/commit/6c6e100)\
  2021-07-23 11:07:43 +0200
  * remove commit/rollback from c code
* [Revision #ea97f66](https://github.com/mariadb-corporation/mariadb-connector-python/commit/ea97f66)\
  2021-07-22 16:06:27 +0200
  * connection class:
* [Revision #5870f5d](https://github.com/mariadb-corporation/mariadb-connector-python/commit/5870f5d)\
  2021-07-22 14:15:53 +0200
  * cursor:
* [Revision #2bd40ca](https://github.com/mariadb-corporation/mariadb-connector-python/commit/2bd40ca)\
  2021-07-18 18:16:38 +0200
  * Test fixes
* [Revision #8ee02ac](https://github.com/mariadb-corporation/mariadb-connector-python/commit/8ee02ac)\
  2021-07-14 22:14:52 +0200
  * Cursor fixes for execute, implemented execute\_direct
* [Revision #c8a9f50](https://github.com/mariadb-corporation/mariadb-connector-python/commit/c8a9f50)\
  2021-07-12 10:52:02 +0200
  * Updated required minimum version of Connector\&C (3.2.4)
* [Revision #84df56c](https://github.com/mariadb-corporation/mariadb-connector-python/commit/84df56c)\
  2021-07-12 09:46:05 +0200
  * connection and cursor class are now written in native python
* [Revision #27730cd](https://github.com/mariadb-corporation/mariadb-connector-python/commit/27730cd)\
  2021-03-21 22:44:42 +0100
  * Moved more methods and propertys from C to Python code
* [Revision #1299be5](https://github.com/mariadb-corporation/mariadb-connector-python/commit/1299be5)\
  2021-01-18 06:41:15 +0100
  * fixed typo
* [Revision #1f084d1](https://github.com/mariadb-corporation/mariadb-connector-python/commit/1f084d1)\
  2021-01-18 06:39:05 +0100
  * disable pooling until tests are ready
* [Revision #b5936a9](https://github.com/mariadb-corporation/mariadb-connector-python/commit/b5936a9)\
  2021-01-18 06:37:09 +0100
  * Added new class Pool
* [Revision #aa65cc8](https://github.com/mariadb-corporation/mariadb-connector-python/commit/aa65cc8)\
  2021-01-18 06:11:03 +0100
  * Exchanged C written connection pool class by native python class.
* [Revision #2ce8f2c](https://github.com/mariadb-corporation/mariadb-connector-python/commit/2ce8f2c)\
  2020-12-02 10:41:29 +0100
  * Added missing dbapi20.py
* [Revision #feb990d](https://github.com/mariadb-corporation/mariadb-connector-python/commit/feb990d)\
  2020-12-01 20:59:27 +0100
  * Moved DBAPI 2.0 Date/Time/Timestamp constructors from C code to Python module dpapi20.py
* [Revision #a2b3e98](https://github.com/mariadb-corporation/mariadb-connector-python/commit/a2b3e98)\
  2020-12-01 08:28:01 +0100
  * Replaced Mrdb\_Fieldinfo by python fieldinfo class
* [Revision #7df428e](https://github.com/mariadb-corporation/mariadb-connector-python/commit/7df428e)\
  2020-11-30 16:49:16 +0100
  * Moved Objects from c to python code
* [Revision #e8d7854](https://github.com/mariadb-corporation/mariadb-connector-python/commit/e8d7854)\
  2020-11-25 13:44:18 +0100
  * codespell typo fixes
* [Revision #ba6af78](https://github.com/mariadb-corporation/mariadb-connector-python/commit/ba6af78)\
  2020-11-25 13:16:51 +0100
  * Fixed travis link for build status
* [Revision #8a9ab45](https://github.com/mariadb-corporation/mariadb-connector-python/commit/8a9ab45)\
