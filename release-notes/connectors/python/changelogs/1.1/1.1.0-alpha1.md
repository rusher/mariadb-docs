---
description: >-
  Full changelog for MariaDB Connector/Python 1.1.0 Alpha1, listing every commit
  in the release.
---

# Connector/Python 1.1.0 Alpha1 Changelog

The most recent [_**Stable**_](../../../../community-server/about/release-criteria.md) _**(GA)**_ release of MariaDB Connector/Python is:[**MariaDB Connector/Python 1.1.12**](../../1.1/1.1.12.md)

[Download](https://mariadb.com/downloads/#connectors)[Release Notes](../../1.1/1.1.0-alpha1.md)[Changelog](1.1.0-alpha1.md)[Connector/Python Overview](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/connectors-quickstart-guides/connector-python-guide)

**Release date:** 18 Aug 2021

For the highlights of this release, see the [release notes](../../1.1/1.1.0-alpha1.md).
...
* [Revision #1d201f1](https://github.com/mariadb-corporation/mariadb-connector-python/commit/1d201f1)\
  ...
  * Removed reference decrement in tuple construct.
...
* [Revision #27730cd](https://github.com/mariadb-corporation/mariadb-connector-python/commit/27730cd)\
  ...
  * Moved more methods and properties from C to Python code
