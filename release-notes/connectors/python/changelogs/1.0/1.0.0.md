---
description: >-
  Full changelog for MariaDB Connector/Python 1.0.0, listing every commit in the
  release.
---
...
* [Revision #b745643](https://github.com/mariadb-corporation/mariadb-connector-python/commit/b745643)\
  ...
  * CONPY\_76: Added the following aliases for connection parameter
    * username
    * passwd
    * db
...
* [Revision #6dbcaf5](https://github.com/mariadb-corporation/mariadb-connector-python/commit/6dbcaf5)\
  ...
  * Calculation of data type using \_PyLong\_NumBits was incorrect
