---
description: >-
  Release notes for MariaDB Connector/Python 1.0.1, a Stable (GA) release
...
* [CONPY-106](https://jira.mariadb.org/browse/CONPY-106): Exception types are chosen now by error number instead of SQL state.
...
on each push, see the [changelog](../changelogs/1.0/1.0.1.md).
