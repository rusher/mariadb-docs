---
description: >-
  Release notes for MariaDB Connector/Node.js 2.2.0, a Stable (GA) release
...
[Download](https://mariadb.com/downloads/#connectors) | [Release Notes](2.2.0.md) | [Changelog](../changelogs/2.x/2.2.0.md) | [Connector/Node.js Overview](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/mariadb-connector-node-js-guide)
...
connection
  ...
  .catch(err => {
          ...
          // at Object.module.exports.createError (C:\projects\mariadb-connector-nodejs.git\lib\misc\errors.js:55:10)
          // at PacketNodeEncoded.readError (C:\projects\mariadb-connector-nodejs.git\lib\io\packet.js:510:19)
          // at Query.readResponsePacket (C:\projects\mariadb-connector-nodejs.git\lib\cmd\resultset.js:46:28)
          // at PacketInputStream.receivePacketBasic (C:\projects\mariadb-connector-nodejs.git\lib\io\packet-input-stream.js:104:9)
          // at PacketInputStream.onData (C:\projects\mariadb-connector-nodejs.git\lib\io\packet-input-stream.js:160:20)
...
on each push, see the [changelog](../changelogs/2.x/2.2.0.md).
