---
description: >-
  Release notes for MariaDB Connector/Node.js 2.1.0, a Stable (GA) release
...
* \[[CONJS-57](https://jira.mariadb.org/browse/CONJS-57)] Multiple alternative authentication methods for the same user ([MariaDB 10.4](../../../community-server/old-releases/10.4/what-is-mariadb-104.md))
