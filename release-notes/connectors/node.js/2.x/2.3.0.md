---
description: >-
  Release notes for MariaDB Connector/Node.js 2.3.0, a Stable (GA) release
...
[Download](https://mariadb.com/downloads/#connectors) | [Release Notes](2.3.0.md) | [Changelog](../changelogs/2.x/2.3.0.md) | [Connector/Node.js Overview](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/mariadb-connector-node-js-guide)
...
on each push, see the [changelog](../changelogs/2.x/2.3.0.md).
