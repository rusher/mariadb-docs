---
description: >-
  Release notes for MariaDB Connector/Node.js 2.0.2, a Release Candidate (RC)
  release published 13 December 2018.
---
...
[Download](https://mariadb.com/downloads/connectors) | [Release Notes](2.0.2.md) | [Changelog](../changelogs/2.x/2.0.2.md) | [Connector/Node.js Overview](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/mariadb-connector-node-js-guide.md)
...
on each push, see the [changelog](../changelogs/2.x/2.0.2.md).
