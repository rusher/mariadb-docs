# MariaDB Connector/Node.js 2.4.2 Release Notes
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](mariadb-connector-nodejs-242-release-notes.md)[Changelog](../changelogs/mariadb-connector-nodejs-2x-changelogs/mariadb-connector-nodejs-242-changelog.md)[Connector/Node.js Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/about-mariadb-connector-nodejs/README.md)

**Release date:** 23 Jul 2020

MariaDB Connector/Node.js 2.4.2 is a [_**Stable**_](../../../mariadb-release-criteria.md) _**(GA)**_ release.
