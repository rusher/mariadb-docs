...
[Download](https://mariadb.com/downloads/#connectors) | [Release Notes](../../3.x/3.3.1.md) | [Changelog](3.3.1.md) | [Connector/Node.js Overview](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/mariadb-connector-node-js-guide)

**Release date:** 5 Jun 2024

For the highlights of this release, see the [release notes](../../3.x/3.3.1.md).
