...
[Download](https://mariadb.com/downloads/#connectors) | [Release Notes](../../3.x/3.0.1.md) | [Changelog](3.0.1.md) | [Connector/Node.js Overview](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/mariadb-connector-node-js-guide)

**Release date:** 26 Jul 2022

For the highlights of this release, see the [release notes](../../3.x/3.0.1.md).
