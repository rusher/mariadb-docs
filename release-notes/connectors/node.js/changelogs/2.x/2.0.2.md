---
description: >-
  Full changelog for MariaDB Connector/Node.js 2.0.2, listing every commit in
  the release.
---
...
[Download](https://mariadb.com/downloads/connectors) | [Release Notes](../../2.x/2.0.2.md) | [Changelog](2.0.2.md) | [Connector/Node.js Overview](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/mariadb-connector-node-js-guide)

**Release date:** 13 Dec 2018

For the highlights of this release, see the [release notes](../../2.x/2.0.2.md).
