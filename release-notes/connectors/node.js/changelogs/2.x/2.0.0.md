---
description: >-
  Full changelog for MariaDB Connector/Node.js 2.0.0, listing every commit in
  the release.
---
...
[Download](https://downloads.mariadb.org/connector-nodejs/2.0.0/) | [Release Notes](../../2.x/2.0.0.md) | [Changelog](2.0.0.md) | [Connector/Node.js Overview](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/mariadb-connector-node-js-guide)

**Release date:** 25 Sep 2018

For the highlights of this release, see the [release notes](../../2.x/2.0.0.md).
