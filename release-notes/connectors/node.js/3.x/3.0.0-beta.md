...
[Download](https://mariadb.com/downloads/#connectors) | [Release Notes](3.0.0-beta.md) | [Changelog](../changelogs/3.x/3.0.0-beta.md) | [Connector/Node.js Overview](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/mariadb-connector-node-js-guide)
...
* Implement [mariadb 10.6](../../../community-server/10.6/what-is-mariadb-106.md) new feature, skipping metadata when possible for better performance
...
If reusing query multiple time, this permits to perform better, specifically using [mariadb 10.6](../../../community-server/10.6/what-is-mariadb-106.md). Performance comparison with mysql2 driver show up to 20% performance gain. More info will follow before GA release.
...
on each push, see the [changelog](../changelogs/3.x/3.0.0-beta.md).
