...
[Download](https://mariadb.com/downloads/#connectors) | [Release Notes](3.0.0-rc.md) | [Changelog](../changelogs/3.x/3.0.0-rc.md) | [Connector/Node.js Overview](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/mariadb-connector-node-js-guide)
...
see [3.0.0-beta](3.0.0-beta.md) for 3.0.0 content from previous version.
...
on each push, see the [changelog](../changelogs/3.x/3.0.0-rc.md).
