...
**For an overview of MariaDB Connector/Node.js see the**[**About MariaDB Connector/Node.js**](https://mariadb.com/kb/en/about-mariadb-connectornodejs/) **page**

## Features

First alpha release of the connector.\
See related documentation:

* [API](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/connector-nodejs-promise-api)
* [connection options](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-nodejs/node-js-connection-options)
