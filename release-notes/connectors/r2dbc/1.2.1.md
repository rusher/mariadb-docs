---
description: >-
  Connector/R2DBC 1.2.1 is a Stable (GA) release of MariaDB Connector/R2DBC,
...
This release is compatible with MariaDB Connector/R2DBC 1.1 and is the maintenance path for version 1.1. This release is compatible with [R2DBC 1.0.0](https://r2dbc.io/spec/1.0.0.RELEASE/spec/html/) specification.
