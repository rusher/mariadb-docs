---
description: >-
  Connector/R2DBC 1.3.0 is a Stable (GA) release of MariaDB Connector/R2DBC,
...
MariaDB Connector/R2DBC 1.3.0 is a [_**Stable**_](../../../community-server/about/release-criteria.md) _**(GA)**_ release.

This release is compatible with MariaDB Connector/R2DBC 1.2 and is the maintenance path for version 1.2. This release is compatible with [R2DBC](https://r2dbc.io/spec/1.0.0.RELEASE/spec/html/) 1.0.0 specification.
