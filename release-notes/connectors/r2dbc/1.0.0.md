---
description: >-
  Connector/R2DBC 1.0.0 is a Stable (GA) release of MariaDB Connector/R2DBC,
...
MariaDB Connector/R2DBC 1.0.0 is a [_**Stable**_](../../../community-server/about/release-criteria.md) _**(GA)**_ release.

This is the first generally available (GA) release of MariaDB Connector/R2DBC. This release is compatible with [R2DBC 0.8.3](https://r2dbc.io/spec/0.8.3.RELEASE/spec/html/) specification.
