---
description: >-
  Connector/R2DBC 1.3.1 is a Stable (GA) release of MariaDB Connector/R2DBC,
...
MariaDB Connector/R2DBC 1.3.1 is a [_**Stable**_](../../../community-server/about/release-criteria.md) _**(GA)**_ release.

This is a maintenance release for the 1.3 line, back-porting the corrections and security fixes made after 1.3.0. This release is compatible with the [R2DBC](https://r2dbc.io/spec/1.0.0.RELEASE/spec/html/) 1.0.0 specification.
...
on each push, see the [changelog](changelogs/1.3.1.md).
