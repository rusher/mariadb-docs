---
description: >-
  Release notes for MariaDB Connector/J 3.0.4, a Stable (GA) release published
  25 March 2022.
---
...
[Download](https://mariadb.com/downloads/#connectors) | [Release Notes](3.0.4.md) | [Changelog](../changelogs/3.0/3.0.4.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
information on each push, see the [changelog](../changelogs/3.0/3.0.4.md).
