---
description: >-
  Release notes for MariaDB Connector/J 3.0.0, an Alpha release published 4 May
  2021.
---
...
* Performance Improvements:
  ...
  * Performance enhancement with [MariaDB 10.6](../../../community-server/10.6/what-is-mariadb-106.md) server when using option `useServerPrepStmts`, skipping metadata (see [MDEV-19237](https://jira.mariadb.org/browse/MDEV-19237))
