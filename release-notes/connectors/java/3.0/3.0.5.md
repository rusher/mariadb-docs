---
description: >-
  Release notes for MariaDB Connector/J 3.0.5, a Stable (GA) release published
  25 May 2022.
---
...
[Download](https://mariadb.com/downloads/#connectors) | **Release Notes** | [Changelog](../changelogs/3.0/3.0.5.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
* [CONJ-962](https://jira.mariadb.org/browse/CONJ-962) resultset for negative TIME value return erroneous LocalDateTime values
...
information on each push, see the [changelog](../changelogs/3.0/3.0.5.md).
