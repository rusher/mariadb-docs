...
[Download](https://downloads.mariadb.org/connector-java/1.1.9/)[Release Notes](mariadb-connector-j-119-release-notes.md)[Changelog](../changelogs/mariadb-connector-j-11-changelogs/mariadb-connector-j-119-changelog.md)[Connector/J Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/about-the-mariadb-connector-j/README.md)
...
information on each push, see the[changelog](../changelogs/mariadb-connector-j-11-changelogs/mariadb-connector-j-119-changelog.md).
