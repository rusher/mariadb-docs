...
[Download](https://downloads.mariadb.org/client-java/1.1.0/) | **Release Notes** | [Changelog](../changelogs/mariadb-connector-j-11-changelogs/mariadb-java-client-110-changelog.md)

**Release date:** 15 Jan 2013

MariaDB Java Client 1.1.0 is a [_**Stable**_](../../../mariadb-release-criteria.md) _**(GA)**_\
...
information on each push, see the[changelog](../changelogs/mariadb-connector-j-11-changelogs/mariadb-java-client-110-changelog.md).
