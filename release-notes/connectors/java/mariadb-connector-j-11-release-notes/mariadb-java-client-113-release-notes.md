...
[Download](https://downloads.mariadb.org/client-java/1.1.3/) | **Release Notes** | [Changelog](../changelogs/mariadb-connector-j-11-changelogs/mariadb-java-client-113-changelog.md) |[Java Client Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/about-the-mariadb-java-client/README.md)
...
information on each push, see the[changelog](../changelogs/mariadb-connector-j-11-changelogs/mariadb-java-client-113-changelog.md).
