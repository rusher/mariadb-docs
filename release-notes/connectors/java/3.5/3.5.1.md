---
description: >-
  Release notes for MariaDB Connector/J 3.5.1, a Stable (GA) release published
  20 November 2024.
---
...
[Download](https://mariadb.com/downloads/connectors/connectors-data-access/java8-connector) | **Release Notes** | [Changelog](../changelogs/3.5/3.5.1.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
information on each push, see the [changelog](../changelogs/3.5/3.5.1.md).
