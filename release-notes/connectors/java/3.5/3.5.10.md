...
MariaDB Connector/J 3.5.10 is a [_**Stable**_](../../../community-server/about/release-criteria.md) _**(GA)**_ release.
...
information on each push, see the [changelog](../changelogs/3.5/3.5.10.md).
