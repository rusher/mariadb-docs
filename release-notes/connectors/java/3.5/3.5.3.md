---
description: >-
  Release notes for MariaDB Connector/J 3.5.3, a Stable (GA) release published
  27 March 2025.
---
...
information on each push, see the [changelog](../changelogs/3.5/3.5.3.md).
