---
description: >-
  Release notes for MariaDB Connector/J 3.5.0, a Stable (GA) release published
  24 October 2024.
---
...
[Download](https://mariadb.com/downloads/connectors/connectors-data-access/java8-connector) | **Release Notes** | [Changelog](../changelogs/3.5/3.5.0.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
Starting with [MariaDB 11.4](../../../community-server/11.4/what-is-mariadb-114.md) we recommend to instead set [character\_set\_collations](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#character_set_collations)
...
information on each push, see the [changelog](../changelogs/3.5/3.5.0.md).
