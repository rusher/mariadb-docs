---
description: >-
  Release notes for MariaDB Connector/J 3.5.2, a Stable (GA) release published
  11 February 2025.
---
...
[Download](https://mariadb.com/downloads/connectors/connectors-data-access/java8-connector) | **Release Notes** | [Changelog](../changelogs/3.5/3.5.2.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
information on each push, see the [changelog](../changelogs/3.5/3.5.2.md).
