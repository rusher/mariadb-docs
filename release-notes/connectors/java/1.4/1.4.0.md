---
description: Release notes for MariaDB Connector/J 1.4.0, published 1 April 2016.
---
...
See more details at: [GSSAPI/SSPI configuration](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/gssapi-authentication-with-mariadb-connector-j)
...
* [CONJ-213](https://jira.mariadb.org/browse/CONJ-213) : new option "continueBatchOnError". Permit to continue batch when an exception occur : When executing a batch and an error occur, must the batch stop immediately (default) or finish remaining batch before throwing exception.
