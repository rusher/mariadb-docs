...
[Download](https://downloads.mariadb.org/connector-java/1.4.6/)[Release Notes](mariadb-connector-j-146-release-notes.md)[Changelog](../changelogs/1.4/mariadb-connector-j-146-changelog.md)[Connector/J Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/about-mariadb-connector-j/README.md)

**Release date:** 15 Jun 2016

MariaDB Connector/J 1.4.6 is a [_**Stable**_](../../../community-server/about/release-criteria.md) _**(GA)**_\
release.
...
information on each push, see the[changelog](../changelogs/1.4/mariadb-connector-j-146-changelog.md).
