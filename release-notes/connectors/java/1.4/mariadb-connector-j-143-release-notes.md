# MariaDB Connector/J 1.4.3 Release Notes

{% include "../../../.gitbook/includes/latest-java.md" %}

[Download](https://downloads.mariadb.org/connector-java/1.4.3/)[Release Notes](mariadb-connector-j-143-release-notes.md)[Changelog](../changelogs/1.4/mariadb-connector-j-143-changelog.md)[Connector/J Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/about-mariadb-connector-j/README.md)

**Release date:** 26 Apr 2016

MariaDB Connector/J 1.4.3 is a [_**Stable**_](../../../mariadb-release-criteria.md) _**(GA)**_\
release.
...
information on each push, see the[changelog](../changelogs/1.4/mariadb-connector-j-143-changelog.md).
