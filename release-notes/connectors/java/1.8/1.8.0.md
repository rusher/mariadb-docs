...
* \[[CONJ-675](https://jira.mariadb.org/browse/CONJ-675)] permit multiple alternative authentication methods for the same user (future [MariaDB 10.4](../../../community-server/old-releases/release-notes-mariadb-10-4-series/what-is-mariadb-104.md) feature)
