---
description: >-
  Full changelog for MariaDB Connector/J 1.1.8, listing every commit in the
  release.
---
...
* [Revision #548](https://bazaar.launchpad.net/~maria-captains/mariadb-java-client/trunk/revision/548) \[merge]\
  ...
  * Fix for [CONJ-79](https://jira.mariadb.org/browse/CONJ-79): ResultSet from previous query after "Read timed out" socket exception
