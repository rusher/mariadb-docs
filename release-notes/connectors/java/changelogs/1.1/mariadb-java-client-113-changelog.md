# Connector/J 1.1.3 Changelog

{% include "../../../../.gitbook/includes/latest-java.md" %}

[Download](https://downloads.mariadb.org/client-java/1.1.3/) | [Release Notes](../../1.1/mariadb-java-client-113-release-notes.md) | **Changelog** | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)

**Release date:** 1 Jul 2013

For the highlights of this release, see the [release notes](../../1.1/mariadb-java-client-113-release-notes.md).
