# Connector/J 1.1.6 Changelog

{% include "../../../../.gitbook/includes/latest-java.md" %}

[Download](https://downloads.mariadb.org/client-java/1.1.6/) | [Release Notes](../../1.1/mariadb-java-client-116-release-notes.md) | **Changelog** | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)

**Release date:** 18 Feb 2014

For the highlights of this release, see the [release notes](../../1.1/mariadb-java-client-116-release-notes.md).
