...
* commons-dbcp is now used only when testing, and there is no more need to import it. For more information, see the [About the MariaDB Connector/J]({connectors}/mariadb-connector-j/about-mariadb-connector-j) page.
