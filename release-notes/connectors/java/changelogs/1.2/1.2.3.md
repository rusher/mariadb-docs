---
description: >-
  Full changelog for MariaDB Connector/J 1.2.3, listing every commit in the
  release.
---

# Connector/J 1.2.3 Changelog

{% include "../../../../.gitbook/includes/latest-java.md" %}

[Download](https://downloads.mariadb.org/connector-java/1.2.3/) | [Release Notes](../../1.2/1.2.3.md) | **Changelog** | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)

**Release date:** 06 Oct 2015

For the highlights of this release, see the [release notes](../../1.2/1.2.3.md).
