# MariaDB Connector/J 1.2.0 Changelog

{% include "../../../../.gitbook/includes/latest-java.md" %}

[Download](https://downloads.mariadb.org/connector-java/1.2.0/)[Release Notes](../../1.2/mariadb-connector-j-120-release-notes.md)[Changelog](mariadb-connector-j-120-changelog.md)[Connector/J Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/about-the-mariadb-connector-j/README.md)

**Release date:** 17 Jul 2015

For the highlights of this release, see the[release notes](../../1.2/mariadb-connector-j-120-release-notes.md).
