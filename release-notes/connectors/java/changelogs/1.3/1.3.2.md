---
description: >-
  Full changelog for MariaDB Connector/J 1.3.2, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-java/1.3.2/) | [Release Notes](../../1.3/1.3.2.md) | **Changelog** | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)

**Release date:** 23 Nov 2015

For the highlights of this release, see the [release notes](../../1.3/1.3.2.md).
...
* various test improvements
  ...
  * avoid race condition when testing aurora : [Revision #5432632](https://github.com/mariadb-corporation/mariadb-connector-j/commit/5432632) 2015-11-20
