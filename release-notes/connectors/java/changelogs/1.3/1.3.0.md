---
description: >-
  Full changelog for MariaDB Connector/J 1.3.0, listing every commit in the
  release.
---
...
* [CONJ-94](https://jira.mariadb.org/browse/CONJ-94) : new Date/Time/Timestamps implementation that handle timezone and daylight correctly.
...
* add development snapshot repository information - [Revision #3a2a4d2](https://github.com/mariadb-corporation/mariadb-connector-j/commit/3a2a4d2) 2015-09-04
