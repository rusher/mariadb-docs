---
description: >-
  Full changelog for MariaDB Connector/J 2.2.1, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-java/2.2.1/) | [Release Notes](../../2.2/2.2.1.md) | **Changelog** | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)

**Release date:** 22 Dec 2017

For the highlights of this release, see the [release notes](../../2.2/2.2.1.md).
