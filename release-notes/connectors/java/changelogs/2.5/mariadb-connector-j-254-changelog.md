# MariaDB Connector/J 2.5.4 Changelog

{% include "../../../../.gitbook/includes/latest-java.md" %}

[Download](https://mariadb.com/downloads/#connectors)[Release Notes](../../2.5/mariadb-connector-j-254-release-notes.md)[Changelog](mariadb-connector-j-254-changelog.md)[Connector/J Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/about-mariadb-connector-j/README.md)

**Release date:** 27 Jan 2020

For the highlights of this release, see the[release notes](../../2.5/mariadb-connector-j-254-release-notes.md).
