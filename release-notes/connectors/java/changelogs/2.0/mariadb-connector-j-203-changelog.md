# MariaDB Connector/J 2.0.3 Changelog

{% include "../../../../.gitbook/includes/latest-java.md" %}

[Download](https://downloads.mariadb.org/connector-java/2.0.3/)[Release Notes](../../2.0/mariadb-connector-j-203-release-notes.md)[Changelog](mariadb-connector-j-203-changelog.md)[Connector/J Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/about-mariadb-connector-j/README.md)

**Release date:** 27 Jun 2017

For the highlights of this release, see the[release notes](../../2.0/mariadb-connector-j-203-release-notes.md).

The revision number links will take you to the revision's page on GitHub. On[GitHub](https://github.com/MariaDB/mariadb-connector-j) you can view more\
details of the revision and view diffs of the code modified in that revision.

* [Revision #bb70ae1c](https://github.com/mariadb-corporation/mariadb-connector-j/commit/bb70ae1c) - bump 2.0.3 version
* [Revision #40e9eba2](https://github.com/mariadb-corporation/mariadb-connector-j/commit/40e9eba2) - \[misc] remove meaningless test
* [Revision #8795ba38](https://github.com/mariadb-corporation/mariadb-connector-j/commit/8795ba38) - \[misc] ensure not having race condition leading to NPE when option enablePacketDebug is not set
