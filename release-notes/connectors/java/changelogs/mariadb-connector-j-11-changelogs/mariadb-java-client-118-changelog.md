...
[Download](https://downloads.mariadb.org/client-java/1.1.8)[Release Notes](../../mariadb-connector-j-11-release-notes/mariadb-java-client-118-release-notes.md)[Changelog](mariadb-java-client-118-changelog.md)[Java Client Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/about-the-mariadb-java-client/README.md)

**Release date:** 16 Jan 2015

For the highlights of this release, see the[release notes](../../mariadb-connector-j-11-release-notes/mariadb-java-client-118-release-notes.md).
