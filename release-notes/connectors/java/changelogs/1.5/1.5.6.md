---
description: >-
  Full changelog for MariaDB Connector/J 1.5.6, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-java/1.5.6/) | [Release Notes](../../1.5/1.5.6.md) | **Changelog** | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)

**Release date:** 22 Dec 2016

For the highlights of this release, see the [release notes](../../1.5/1.5.6.md).
