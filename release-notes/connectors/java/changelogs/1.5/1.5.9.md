---
description: >-
  Full changelog for MariaDB Connector/J 1.5.9, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-java/1.5.9/) | [Release Notes](../../1.5/1.5.9.md) | **Changelog** | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)

**Release date:** 20 Mar 2017

For the highlights of this release, see the [release notes](../../1.5/1.5.9.md).
