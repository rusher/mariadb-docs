---
description: >-
  Full changelog for MariaDB Connector/J 1.5.1, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-java/1.5.1/) | [Release Notes](../../1.5/1.5.1.md) | **Changelog** | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)

**Release date:** 16 Aug 2016

For the highlights of this release, see the [release notes](../../1.5/1.5.1.md).
...
* [Revision #cea40ac](https://github.com/mariadb-corporation/mariadb-connector-j/commit/cea40ac) - Changes made based on feedback & improvements: - Removed use of TimeZone.setDefault - setTimeZone used instead on date formatter - Variable urlEndStr is set on AuroraListener initialization - Remains the same for a clus
