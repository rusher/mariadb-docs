...
[Download](https://mariadb.com/downloads/#connectors) | [Release Notes](../../2.7/2.7.1.md) | **Changelog** | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)

**Release date:** 23 Nov 2020

For the highlights of this release, see the [release notes](../../2.7/2.7.1.md).
...
* [Revision #f281de76](https://github.com/mariadb-corporation/mariadb-connector-j/commit/f281de76) - \[misc] travis MariaDB Cloud HA testing addition
...
* [Revision #86418697](https://github.com/mariadb-corporation/mariadb-connector-j/commit/86418697) - added osgi related package imports for gss
* [Revision #2af5b1a2](https://github.com/mariadb-corporation/mariadb-connector-j/commit/2af5b1a2) - \[[CONJ-839](https://jira.mariadb.org/browse/CONJ-839)] batch exception message correction when using with option `rewriteBatchedStatements`
...
* [Revision #37fde5fc](https://github.com/mariadb-corporation/mariadb-connector-j/commit/37fde5fc) - \[misc] test correction for maxscale and MariaDB Cloud environment
* [Revision #cb926cdc](https://github.com/mariadb-corporation/mariadb-connector-j/commit/cb926cdc) - \[misc] enable load local infile test for [MariaDB 10.4](../../../../community-server/old-releases/release-notes-mariadb-10-4-series/what-is-mariadb-104.md)+
* [Revision #d633c8df](https://github.com/mariadb-corporation/mariadb-connector-j/commit/d633c8df) - \[[CONJ-842](https://jira.mariadb.org/browse/CONJ-842)] Byte array parameters are not sent as long data
...
* [Revision #884e7b9c](https://github.com/mariadb-corporation/mariadb-connector-j/commit/884e7b9c) - \[[CONJ-842](https://jira.mariadb.org/browse/CONJ-842)] Byte array parameters are not sent as long data
...
* [Revision #b84c27de](https://github.com/mariadb-corporation/mariadb-connector-j/commit/b84c27de) - \[misc] appveyor server msi retrieval, follow redirection
* [Revision #5c9d7fe9](https://github.com/mariadb-corporation/mariadb-connector-j/commit/5c9d7fe9) - \[[CONJ-834](https://jira.mariadb.org/browse/CONJ-834)] use of BULK is conditioned to server 10.2.7+ version, not capability
