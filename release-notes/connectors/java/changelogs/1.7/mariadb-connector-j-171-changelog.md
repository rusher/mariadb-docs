# MariaDB Connector/J 1.7.1 Changelog
...
[Download](https://downloads.mariadb.org/connector-java/1.7.1/)[Release Notes](../../1.7/mariadb-connector-j-171-release-notes.md)[Changelog](mariadb-connector-j-171-changelog.md)[Connector/J Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/about-mariadb-connector-j/README.md)

**Release date:** 22 Dec 2017

For the highlights of this release, see the[release notes](../../1.7/mariadb-connector-j-171-release-notes.md).

The revision number links will take you to the revision's page on GitHub. On[GitHub](https://github.com/MariaDB/mariadb-connector-j) you can view more\
details of the revision and view diffs of the code modified in that revision.

* [Revision #88040b4b](https://github.com/mariadb-corporation/mariadb-connector-j/commit/88040b4b) - bump 1.7.1 version
* [Revision #aa91dc91](https://github.com/mariadb-corporation/mariadb-connector-j/commit/aa91dc91) - \[misc] remove debug log from travis logs
* [Revision #bff419b6](https://github.com/mariadb-corporation/mariadb-connector-j/commit/bff419b6) - \[misc] java-6 code migration after 2.2.1 merge
...
* [Revision #843fa656](https://github.com/mariadb-corporation/mariadb-connector-j/commit/843fa656) - \[misc] checkstyle correction
