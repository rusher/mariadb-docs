---
description: >-
  Full changelog for MariaDB Connector/J 1.7.2, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-java/1.7.2/) | [Release Notes](../../1.7/1.7.2.md) | **Changelog** | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)

**Release date:** 20 Feb 2018

For the highlights of this release, see the [release notes](../../1.7/1.7.2.md).
