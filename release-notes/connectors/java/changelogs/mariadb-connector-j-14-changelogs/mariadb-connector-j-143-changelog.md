# MariaDB Connector/J 1.4.3 Changelog

The most recent [_**Stable**_](../../../../mariadb-release-criteria.md) _**(GA)**_ release of [MariaDB Connector/J](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/about-mariadb-connector-j/README.md) is:[**MariaDB Connector/J 3.5.3**](../../mariadb-connector-j-3-5-release-notes/mariadb-connector-j-3-5-3-release-notes.md)

[Download](https://downloads.mariadb.org/connector-java/1.4.3/)[Release Notes](../../mariadb-connector-j-14-release-notes/mariadb-connector-j-143-release-notes.md)[Changelog](mariadb-connector-j-143-changelog.md)[Connector/J Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/about-mariadb-connector-j/README.md)

**Release date:** 26 Apr 2016

For the highlights of this release, see the[release notes](../../mariadb-connector-j-14-release-notes/mariadb-connector-j-143-release-notes.md).
...
* [Revision #3385a01](https://github.com/mariadb-corporation/mariadb-connector-j/commit/3385a01) \[misc] use keyserver port 80 to correct Travis testing with [MariaDB 5.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-5-series/changes-improvements-in-mariadb-5-5)
