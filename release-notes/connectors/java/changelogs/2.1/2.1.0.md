---
description: >-
  Full changelog for MariaDB Connector/J 2.1.0, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-java/2.1.0/) | [Release Notes](../../2.1/2.1.0.md) | **Changelog** | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)

**Release date:** 31 Jul 2017

For the highlights of this release, see the [release notes](../../2.1/2.1.0.md).
