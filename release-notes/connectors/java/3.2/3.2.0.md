---
description: >-
  Release notes for MariaDB Connector/J 3.2.0, a Stable (GA) release published
  25 August 2023.
---
...
When using maxscale 23.08.0+, when a maxscale node fails, connector will now prioritize reconnection to the maxscales nodes having less connections, to ensure connections repartition after failover.\
