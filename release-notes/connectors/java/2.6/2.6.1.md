---
description: >-
  Release notes for MariaDB Connector/J 2.6.1, a Stable (GA) release published
  23 June 2020.
---
...
[Download](https://mariadb.com/downloads/#connectors) | **Release Notes** | [Changelog](../changelogs/2.6/2.6.1.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
* [CONJ-782](https://jira.mariadb.org/browse/CONJ-782) - MariaDB Cloud testing

## Changelog

For a complete list of changes made in MariaDB Connector/J 2.6.1, with links to detailed\
information on each push, see the [changelog](../changelogs/2.6/2.6.1.md).
