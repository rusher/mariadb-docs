---
description: >-
  Release notes for MariaDB Connector/J 3.1.2, a Stable (GA) release published
  24 January 2023.
---
...
* [CONJ-1042](https://jira.mariadb.org/browse/CONJ-1042) fix DatabaseMetaData.getColumns() on old server version (< MySQL 5.6.4 and < [MariaDB 5.3.0](../../../community-server/old-releases/5.3/5.3.0.md))
