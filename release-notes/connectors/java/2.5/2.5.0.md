---
description: >-
  Release notes for MariaDB Connector/J 2.5.0, a Release Candidate (RC) release
...
[Download](https://mariadb.com/downloads/connectors/connectors-data-access/java8-connector) | **Release Notes** | [Changelog](../changelogs/2.5/2.5.0.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
To use this credential authentication, com.amazonaws:aws-java-sdk-rds dependency must be registered in classpath.\
...
information on each push, see the [changelog](../changelogs/2.5/2.5.0.md).
