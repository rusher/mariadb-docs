---
description: >-
  Release notes for MariaDB Connector/J 3.4.0, a Stable (GA) release published
  17 May 2024.
---
...
Since [MariaDB 10.3.1](../../../community-server/old-releases/10.3/10.3.1.md), the server has a new system variable redirect\_url to provide a connection string using the forma `mariadb/mysql://[<user>[:<password>]@]<host>[:<port>]/[<db>[?<opt1>=<value1>[&<opt2>=<value2>]]]`.
