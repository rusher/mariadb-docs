---
description: >-
  Release notes for MariaDB Connector/J 3.4.1, a Stable (GA) release published
  17 July 2024.
---
...
[Download](https://mariadb.com/downloads/connectors/connectors-data-access/java8-connector) | **Release Notes** | [Changelog](../changelogs/3.4/3.4.1.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
to a more detailed host description, permitting to set localsocket or pipe, and to define a specific ssl mode depending on the host. New format:
...
information on each push, see the [changelog](../changelogs/3.4/3.4.1.md).
