---
description: >-
  Release notes for MariaDB Connector/J 2.0.0, a Release Candidate (RC) release
...
With server with version [MariaDB 10.2](../../../community-server/old-releases/10.2/what-is-mariadb-102.md), MySQL 5.7, ensure driver state :
