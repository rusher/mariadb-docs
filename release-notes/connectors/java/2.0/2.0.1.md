---
description: >-
  Release notes for MariaDB Connector/J 2.0.1, a Stable (GA) release published
  11 May 2017.
---
...
* [CONJ-467](https://jira.mariadb.org/browse/CONJ-467) - changing database metadata compatibility to 4.2
...
With a [MariaDB 10.2](../../../community-server/old-releases/10.2/what-is-mariadb-102.md) or MySQL 5.7 server, ensure driver state:
...
For servers > [MariaDB 10.1.2](../../../community-server/old-releases/10.1/10.1.2.md), the query timeout will be handled server side using the "SET MAX\_STATEMENT\_TIME FOR" command.
