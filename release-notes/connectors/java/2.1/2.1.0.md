---
description: >-
  Release notes for MariaDB Connector/J 2.1.0, a Stable (GA) release published
  31 July 2017.
---
...
[Download](https://downloads.mariadb.org/connector-java/2.1.0/) | **Release Notes** | [Changelog](../changelogs/2.1/2.1.0.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
(batch without Statement.RETURN\_GENERATED\_KEYS and streams) to have faster batch (significant only if server >= [MariaDB 10.2.7](../../../community-server/old-releases/10.2/10.2.7.md)).
