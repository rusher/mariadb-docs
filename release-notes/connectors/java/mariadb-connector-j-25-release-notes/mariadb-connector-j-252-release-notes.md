# MariaDB Connector/J 2.5.2 Release Notes

The most recent [_**Stable**_](../../../mariadb-release-criteria.md) _**(GA)**_ release of [MariaDB Connector/J](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/about-mariadb-connector-j/README.md) is:[**MariaDB Connector/J 3.5.3**](../mariadb-connector-j-3-5-release-notes/mariadb-connector-j-3-5-3-release-notes.md)

[Download](https://downloads.mariadb.com/Connectors/java/connector-java-2.5.2)[Release Notes](mariadb-connector-j-252-release-notes.md)[Changelog](../changelogs/mariadb-connector-j-25-changelogs/mariadb-connector-j-252-changelog.md)[Connector/J Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/about-mariadb-connector-j/README.md)

**Release date:** 22 Nov 2019

MariaDB Connector/J 2.5.2 is a [_**Stable**_](../../../mariadb-release-criteria.md) _**(GA)**_ release.

**NOTE:** MariaDB Connector/J 2.5.2 is fully compatible with the latest release of\
...
information on each push, see the [changelog](../changelogs/mariadb-connector-j-25-changelogs/mariadb-connector-j-252-changelog.md).
