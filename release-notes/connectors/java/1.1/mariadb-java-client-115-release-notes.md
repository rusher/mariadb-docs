...
[Download](https://downloads.mariadb.org/client-java/1.1.5/) |**Release Notes** |[Changelog](../changelogs/1.1/mariadb-java-client-115-changelog.md) |[Java Client Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/about-the-mariadb-java-client/README.md)
