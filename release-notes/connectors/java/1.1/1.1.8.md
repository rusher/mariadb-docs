---
description: >-
  Release notes for MariaDB Connector/J 1.1.8, published 16 January 2015.
---
...
[Download](https://downloads.mariadb.org/client-java/1.1.8) | **Release Notes** | [Changelog](../changelogs/1.1/1.1.8.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
information on each push, see the [changelog](../changelogs/1.1/1.1.8.md).
...
* ResultSet from previous query after "Read timed out" socket exception ([CONJ-79](https://jira.mariadb.org/browse/CONJ-79))
