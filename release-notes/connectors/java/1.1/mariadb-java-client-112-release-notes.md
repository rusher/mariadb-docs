...
[Download](https://downloads.mariadb.org/client-java/1.1.2/) | **Release Notes** | [Changelog](../changelogs/1.1/mariadb-java-client-112-changelog.md) |[Java Client Overview](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/about-the-mariadb-java-client/README.md)
...
information on each push, see the[changelog](../changelogs/1.1/mariadb-java-client-112-changelog.md).
