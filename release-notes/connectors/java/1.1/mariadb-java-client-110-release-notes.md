...
[Download](https://downloads.mariadb.org/client-java/1.1.0/) | **Release Notes** | [Changelog](../changelogs/1.1/mariadb-java-client-110-changelog.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
