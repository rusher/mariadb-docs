...
[Download](https://downloads.mariadb.org/client-java/1.1.8) | **Release Notes** | [Changelog](../changelogs/1.1/mariadb-java-client-118-changelog.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)

**Release date:** 16 Jan 2015

MariaDB Java Client 1.1.8 is a [_**Stable**_](../../../community-server/about/release-criteria.md) _**(GA)**_\
...
information on each push, see the [changelog](../changelogs/1.1/mariadb-java-client-118-changelog.md).
