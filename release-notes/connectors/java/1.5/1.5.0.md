---
description: Release notes for MariaDB Connector/J 1.5.0, published 1 August 2016.
---
...
Since [MariaDB 10.2.2](../../../community-server/old-releases/10.2/10.2.2.md), last PREPARE statement id can be identified with value "-1".\
...
LOAD DATA INFILE The fastest way to load many data is using query [LOAD DATA INFILE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/inserting-loading-data/load-data-into-tables-or-index/load-data-infile).\
