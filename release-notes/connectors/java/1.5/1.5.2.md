---
description: >-
  Release notes for MariaDB Connector/J 1.5.2, published 1 September 2016.
---
...
[Download](https://downloads.mariadb.org/connector-java/1.5.2/) | **Release Notes** | [Changelog](../changelogs/1.5/1.5.2.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
See [see openJDK issue](https://bugs.openjdk.java.net/browse/JDK-6722928) for more information
...
Since [MariaDB 10.2.2](../../../community-server/old-releases/10.2/10.2.2.md), the last PREPARE statement id can be identified with value "-1".\
...
* [MariaDB Connector/J 1.5.0 Changelog](../changelogs/1.5/1.5.0.md)
* [MariaDB Connectot/J 1.5.1 Changelog](../changelogs/1.5/1.5.1.md)
* [MariaDB Connectot/J 1.5.2 Changelog](../changelogs/1.5/1.5.2.md)
