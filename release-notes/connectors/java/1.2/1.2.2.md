---
description: >-
  Release notes for MariaDB Connector/J 1.2.2, published 10 September 2015.
---
...
[Download](https://downloads.mariadb.org/connector-java/1.2.2/) | **Release Notes** | [Changelog](../changelogs/1.2/1.2.2.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
information on each push, see the [changelog](../changelogs/1.2/1.2.2.md).
