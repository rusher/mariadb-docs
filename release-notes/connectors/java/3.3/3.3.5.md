---
description: >-
  Release notes for MariaDB Connector/J 3.3.5, a Stable (GA) release published
  15 June 2026.
---
...
MariaDB Connector/J 3.3.5 is a [_**Stable**_](../../../community-server/about/release-criteria.md) _**(GA)**_ release.
...
For a complete list of changes made in MariaDB Connector/J 3.3.5, with links to detailed\
information on each push, see the [changelog](../changelogs/3.3/3.3.5.md).
