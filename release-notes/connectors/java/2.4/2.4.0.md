---
description: >-
  Release notes for MariaDB Connector/J 2.4.0, a Stable (GA) release published
  29 January 2019.
---
...
[Download](https://mariadb.com/downloads/connectors/connectors-data-access/java8-connector) | **Release Notes** | [Changelog](../changelogs/2.4/2.4.0.md) | [About MariaDB Connector/J](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-j/about-mariadb-connector-j)
...
* [CONJ-673](https://jira.mariadb.org/browse/CONJ-673): aborting a connection while fetching a query still does read whole resultset
