---
description: >-
  Release notes for MariaDB Connector/ODBC 1.0.0, a Stable (GA) release
...
[Download](https://downloads.mariadb.org/connector-odbc/1.0.0)[Release Notes](1.0.0.md)[Changelog](../changelogs/1.0/1.0.0.md)[Overview of MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)
...
* When using MariaDB ODBC Connector with ODBC Driver Manager 3.81, the Driver Manager returns error IM001 (The driver doesn't support this function) for SQLExecute, SQLExecDirect or SQLBindCol. ([ODBC-5](https://jira.mariadb.org/browse/ODBC-5))
...
information on each push, see the [changelog](../changelogs/1.0/1.0.0.md).
