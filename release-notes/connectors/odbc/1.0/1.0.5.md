---
description: >-
  Release notes for MariaDB Connector/ODBC 1.0.5, a Stable (GA) release
...
[Download](https://downloads.mariadb.org/connector-odbc/1.0.5)[Release Notes](1.0.5.md)[Changelog](../changelogs/1.0/1.0.5.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)
...
* Fixed [ODBC-19](https://jira.mariadb.org/browse/ODBC-19): Using same pointer as StrLen\_Or\_IndPtr for several columns,\
...
* Fixed many issues preventing normal functioning of MS Access with the Connector. In\
  particular - [1](https://github.com/mariadb-corporation/mariadb-connector-odbc/issues)
...
detailed information on each push, see the [changelog](../changelogs/1.0/1.0.5.md).
