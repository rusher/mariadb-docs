---
description: >-
  Release notes for MariaDB Connector/ODBC 1.0.6, a Stable (GA) release
...
[Download](https://downloads.mariadb.org/connector-odbc/1.0.6)[Release Notes](1.0.6.md)[Changelog](../changelogs/1.0/1.0.6.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)
...
detailed information on each push, see the [changelog](../changelogs/1.0/1.0.6.md).
