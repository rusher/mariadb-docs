---
description: >-
  Release notes for MariaDB Connector/ODBC 3.1.22, a Stable (GA) release
...
detailed information on each push, see the [changelog](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc).
