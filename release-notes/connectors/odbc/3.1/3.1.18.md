---
description: >-
  Release notes for MariaDB Connector/ODBC 3.1.18, a Stable (GA) release
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](3.1.18.md)[Changelog](../changelogs/3.1/3.1.18.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)
...
detailed information on each push, see the [changelog](../changelogs/3.1/3.1.18.md).
