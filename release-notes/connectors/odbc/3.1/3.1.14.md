...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](3.1.14.md)[Changelog](../changelogs/3.1/3.1.14.md)[About MariaDB Connector/ODBC](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/about-mariadb-connector-odbc/README.md)
...
detailed information on each push, see the [changelog](../changelogs/3.1/3.1.14.md).
