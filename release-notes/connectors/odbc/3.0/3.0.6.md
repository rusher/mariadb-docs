...
[Download](https://downloads.mariadb.org/connector-odbc/3.0.6)[Release Notes](3.0.6.md)[Changelog](../changelogs/3.0/3.0.6.md)[About MariaDB Connector/ODBC](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/about-mariadb-connector-odbc/README.md)
...
detailed information on each push, see the [changelog](../changelogs/3.0/3.0.6.md).
