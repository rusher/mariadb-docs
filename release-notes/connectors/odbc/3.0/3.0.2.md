...
[Download](https://downloads.mariadb.org/connector-odbc/3.0.2)[Release Notes](3.0.2.md)[Changelog](../changelogs/3.0/3.0.2.md)[About MariaDB Connector/ODBC](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/about-mariadb-connector-odbc/README.md)
...
sending them row by row. This only works with a server version >= [MariaDB 10.2.7](../../../community-server/old-releases/10.2/10.2.7.md).
...
detailed information on each push, see the [changelog](../changelogs/3.0/3.0.2.md).
