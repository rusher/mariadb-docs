...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](3.0.9.md)[Changelog](../changelogs/3.0/3.0.9.md)[About MariaDB Connector/ODBC](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/about-mariadb-connector-odbc/README.md)
...
detailed information on each push, see the [changelog](../changelogs/3.0/3.0.9.md).
