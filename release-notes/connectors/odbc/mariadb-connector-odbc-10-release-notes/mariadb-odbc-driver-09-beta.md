...
MariaDB ODBC Driver 0.9.1 is built on top of the MariaDB LPGL C Client library\
and uses the binary prepared statement protocol.

Please, note that a beta version is NOT the final version of the product and we\
do not guarantee an absence of errors that may disrupt the computer's operation\
system and/or result data loss. We recommend against use of any beta software\
