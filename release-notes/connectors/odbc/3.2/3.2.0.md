---
description: >-
  Release notes for MariaDB Connector/ODBC 3.2.0, an Alpha release published 21
  April 2023.
---
...
[Download](https://mariadb.com/downloads/connectors/connectors-data-access/odbc-connector/) | [Release Notes](3.2.0.md) | [Changelog](../changelogs/3.2/3.2.0.md) | [About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)
...
MariaDB Connector/ODBC 3.2.0 is built on top of [MariaDB Connector/C v.3.3.2](../../c/3.3/3.3.2.md), and contains all fixes and changes from [MariaDB Connector/ODBC v.3.1.18](../3.1/3.1.18.md)
...
detailed information on each push, see the [changelog](../changelogs/3.2/3.2.0.md).
