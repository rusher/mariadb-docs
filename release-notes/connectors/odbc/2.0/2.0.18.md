---
description: >-
  Release notes for MariaDB Connector/ODBC 2.0.18, a Stable (GA) release
...
[Download](https://downloads.mariadb.org/connector-odbc/2.0.18)[Release Notes](2.0.18.md)[Changelog](../changelogs/2.0/2.0.18.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)
...
* [ODBC-166](https://jira.mariadb.org/browse/ODBC-166) - Incorrect Display Size for decimal column
...
detailed information on each push, see the [changelog](../changelogs/2.0/2.0.18.md).
