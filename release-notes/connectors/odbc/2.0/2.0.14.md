---
description: >-
  Release notes for MariaDB Connector/ODBC 2.0.14, a Stable (GA) release
...
[Download](https://downloads.mariadb.org/connector-odbc/2.0.14)[Release Notes](2.0.14.md)[Changelog](../changelogs/2.0/2.0.14.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)
...
detailed information on each push, see the [changelog](../changelogs/2.0/2.0.14.md).
