---
description: >-
  Release notes for MariaDB Connector/ODBC 2.0.19, a Stable (GA) release
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](2.0.19.md)[Changelog](../changelogs/2.0/2.0.19.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)
...
* [ODBC-169](https://jira.mariadb.org/browse/ODBC-169) - Empty results or error if executing multiple selects in a batch
...
detailed information on each push, see the [changelog](../changelogs/2.0/2.0.19.md).
