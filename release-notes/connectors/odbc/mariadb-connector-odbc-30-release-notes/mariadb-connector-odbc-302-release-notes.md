# MariaDB Connector/ODBC 3.0.2 Release Notes
...
sending them row by row. This only works with a server version >= [MariaDB 10.2.7](../../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-2-series/mariadb-1027-release-notes.md).
