---
description: >-
  Full changelog for MariaDB Connector/ODBC 2.0.11, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-odbc/2.0.11)[Release Notes](../../2.0/2.0.11.md)[Changelog](2.0.11.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)

**Release date:** 9 Jun 2016

For the highlights of this release, see the [release notes](../../2.0/2.0.11.md).
