---
description: >-
  Full changelog for MariaDB Connector/ODBC 2.0.18, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-odbc/2.0.18)[Release Notes](../../2.0/2.0.18.md)[Changelog](2.0.18.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)

**Release date:** 8 Sep 2018

For the highlights of this release, see the [release notes](../../2.0/2.0.18.md).
...
* [Revision #c21b408](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/c21b408)\
  ...
  * Fixed genertaion source package with git.\
    It uses now .gitattributes file, and does not include libmariadb, test,\
...
* [Revision #d888051](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/d888051)\
  ...
  * [ODBC-159](https://jira.mariadb.org/browse/ODBC-159) The fix and the testcase. In case if the query is a multistatement, connector split it into\
