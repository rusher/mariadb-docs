---
description: >-
  Full changelog for MariaDB Connector/ODBC 2.0.19, listing every commit in the
  release.
---
...
[Download](https://mariadb.com/downloads/#connectors)[Release Notes](../../2.0/2.0.19.md)[Changelog](2.0.19.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)

**Release date:** 5 Jun 2019

For the highlights of this release, see the [release notes](../../2.0/2.0.19.md).
...
* [Revision #35f9e5d](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/35f9e5d)\
  ...
  * [ODBC-219](https://jira.mariadb.org/browse/ODBC-219) The fix and the testcase.
    ...
    * The bug occurred becaule IRD was not reset in the SQLMoreResults in the\
      described case.
