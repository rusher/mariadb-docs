---
description: >-
  Full changelog for MariaDB Connector/ODBC 2.0.9, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-odbc/2.0.9)[Release Notes](../../2.0/2.0.9.md)[Changelog](2.0.9.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)

**Release date:** 16 Nov 2015

For the highlights of this release, see the [release notes](../../1.0/1.0.5.md).
...
* [Revision #1607c16](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/1607c16)\
  ...
  * Fixes for unresolved externals: Replace \_ito64a by longong2str Replace atoi64 by strtoll Bumped version number
...
* [Revision #17fe70c](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/17fe70c)\
  ...
  * fixed hard coded comparison for selected database in catalog test
...
* [Revision #bd25021](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/bd25021)\
  ...
  * Fixed one more missing symbol on linux Move MbstrCharLen to ma\_string.c, added one more parameter to MADB\_ConvertAnsi2Unicode - determining whether to copy terminating blank additionally. That helps to resolve issue what length to returrn if source string length included terminating byte. Changed LengthIndicator type to SQLLEN\* Documented MADB\_ConvertAnsi2Unicode a bit.
...
* [Revision #0cfdfd7](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/0cfdfd7)\
  ...
  * Changed lpszDefault to empty string. According to the ODBC specification this argument cannot be NULL.
