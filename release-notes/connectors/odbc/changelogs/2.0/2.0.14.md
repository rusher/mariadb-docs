---
description: >-
  Full changelog for MariaDB Connector/ODBC 2.0.14, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-odbc/2.0.14)[Release Notes](../../2.0/2.0.14.md)[Changelog](2.0.14.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)

**Release date:** 7 Apr 2017

For the highlights of this release, see the [release notes](../../2.0/2.0.14.md).
...
* [Revision #0d1fdac](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/0d1fdac)\
  ...
  * Cherry-picking from 3.0 - fixed (not) closing of MYSQL\_STMT handles, and optimized some excessive close/init of them. Fix of possible memory leak in case of preparing of a multistatement query, and not executing it.
...
* [Revision #3a77b1a](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/3a77b1a)\
  ...
  * Removed last traces of 'def' catalog. Still were in some catalog functions
