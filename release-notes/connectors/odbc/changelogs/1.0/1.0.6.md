---
description: >-
  Full changelog for MariaDB Connector/ODBC 1.0.6, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-odbc/1.0.6)[Release Notes](../../1.0/1.0.6.md)[Changelog](1.0.6.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)
...
* [Revision #ab1b3e7](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/ab1b3e7)\
  ...
  * Cherrypicking of latest(after the last merge) changes from 2.0 Mainly tests fixes, minor code restructuring(introduced ma\_common, less dependencies in maodbcs etc)
