---
description: >-
  Full changelog for MariaDB Connector/ODBC 1.0.5, listing every commit in the
  release.
---
...
[Download](https://downloads.mariadb.org/connector-odbc/1.0.5)[Release Notes](../../1.0/1.0.5.md)[Changelog](1.0.5.md)[About MariaDB Connector/ODBC](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-odbc)
...
* [Revision #d470ee7f](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/d470ee7f)\
  ...
  * Made debug log available in all build types and controlled solely by\
    connection option.
...
* [Revision #b93bc66c](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/b93bc66c)\
  ...
  * Our catalo functions + SQLGetTypeInfo return all integer fields as int,\
    ...
    SQL\_C\_DEFAULT type, and yilds error if returned data length differs from\
...
* [Revision #51c95a77](https://github.com/mariadb-corporation/mariadb-connector-odbc/commit/51c95a77)\
  ...
  * Fixed bug in display length calculation for binary fields, and for string\
