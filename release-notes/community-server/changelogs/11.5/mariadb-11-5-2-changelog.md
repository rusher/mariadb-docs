...
[Download](https://mariadb.com/downloads/)[Release Notes](../../old-releases/11.5/11.5.2.md)[Changelog](mariadb-11-5-2-changelog.md)[Overview of 11.5](../../old-releases/11.5/what-is-mariadb-115.md)

[_Alternate download from mariadb.org_](https://downloads.mariadb.org/mariadb/11.5.2/)

**Release date:** 14 Aug 2024

For the highlights of this release, see the [release notes](../../old-releases/11.5/11.5.2.md).
...
* Includes all fixes from [MariaDB 11.4.3](../11.4/11.4.3.md)
