...
[Download 11.0.2](https://downloads.mariadb.org/mariadb/11.0.2/)[Release Notes](../../old-releases/11.0/11.0.2.md)[Changelog](mariadb-11-0-2-changelog.md)[Overview of 11.0](../../old-releases/11.0/what-is-mariadb-110.md)

**Release date:** 6 Jun 2023

For the highlights of this release, see the [release notes](../../old-releases/11.0/11.0.2.md).
...
* Includes all fixes from [MariaDB 10.11.4](../10.11/10.11.4.md)
