...
<a href="../../11.4/11.4.6.md" class="button secondary">Release Notes</a> <a href="11.4.6.md" class="button secondary">Changelog</a> <a href="../../11.4/what-is-mariadb-114.md" class="button secondary">Overview of 11.4</a>

For the highlights of this release, see the [release notes](../../11.4/).
...
* Includes all fixes from [MariaDB 10.11.12](../10.11/10.11.12.md)
