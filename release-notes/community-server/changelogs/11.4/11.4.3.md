...
<a href="https://downloads.mariadb.org/mariadb/11.4.3/" class="button primary">Download</a> <a href="../../11.4/11.4.3.md" class="button secondary">Release Notes</a> <a href="11.4.3.md" class="button secondary">Changelog</a> <a href="../../11.4/what-is-mariadb-114.md" class="button secondary">Overview of 11.4</a>

**Release date:** 8 Aug 2024

For the highlights of this release, see the [release notes](../../11.4/11.4.3.md).
...
* Includes all fixes from [MariaDB 11.2.5](../11.2/mariadb-11-2-5-changelog.md)
