...
<a href="https://downloads.mariadb.org/mariadb/11.4.5/" class="button primary">Download</a> <a href="../../11.4/11.4.5.md" class="button secondary">Release Notes</a> <a href="11.4.5.md" class="button secondary">Changelog</a> <a href="../../11.4/what-is-mariadb-114.md" class="button secondary">Overview of 11.4</a>

**Release date:** 4 Feb 2025

For the highlights of this release, see the [release notes](../../11.4/11.4.5.md).
...
* Includes all fixes from [MariaDB 10.11.11](../10.11/10.11.11.md)
* Includes all fixes from [MariaDB 11.2.6](../11.2/mariadb-11-2-6-changelog.md)
