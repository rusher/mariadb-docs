...
<a href="https://mariadb.com/downloads/community" class="button primary">Download</a> <a href="../../10.11/10.11.14.md" class="button secondary">Release Notes</a> <a href="10.11.14.md" class="button secondary">Changelog</a> <a href="../../10.11/what-is-mariadb-1011.md" class="button secondary">Overview of 10.11</a>

[<sup>_Alternate download from mariadb.org_</sup>](https://downloads.mariadb.org/mariadb/10.11.14/)

**Release date:** 6 Aug 2025

For the highlights of this release, see the [release notes](../../10.11/10.11.14.md).
...
* Includes all fixes from [MariaDB 10.6.23](../10.6/10.6.23.md)
