...
<a href="https://downloads.mariadb.org/mariadb/10.11.1/" class="button primary">Download</a> <a href="../../10.11/10.11.1.md" class="button secondary">Release Notes</a> <a href="10.11.1.md" class="button secondary">Changelog</a> <a href="../../10.11/what-is-mariadb-1011.md" class="button secondary">Overview of 10.11</a>

**Release date:** 17 Nov 2022

For the highlights of this release, see the [release notes](../../10.11/).
...
* Changes from [10.11.0](../../10.11/10.11.0.md) are also included in this changelog
* Includes all fixes from [MariaDB 10.10.2](../10.10/10.10.2.md)
