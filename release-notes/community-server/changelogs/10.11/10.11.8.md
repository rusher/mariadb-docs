...
<a href="https://downloads.mariadb.org/mariadb/10.11.8/" class="button primary">Download</a> <a href="../../10.11/10.11.8.md" class="button secondary">Release Notes</a> <a href="10.11.8.md" class="button secondary">Changelog</a> <a href="../../10.11/what-is-mariadb-1011.md" class="button secondary">Overview of 10.11</a>

**Release date:** 16 May 2024

For the highlights of this release, see the [release notes](../../10.11/10.11.8.md).
...
* Includes all fixes from [MariaDB 10.6.18](../10.6/10.6.18.md)
...
* [Revision #06a884a570](https://github.com/MariaDB/server/commit/06a884a570)\
  ...
  * [MDEV-33429](https://jira.mariadb.org/browse/MDEV-33429) compilation of [MariaDB 10.11.7](../../10.11/10.11.7.md) fails on arm32, sizeof(MYSQL) is wrong
