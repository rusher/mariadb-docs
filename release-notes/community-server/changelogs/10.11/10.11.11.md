...
<a href="https://downloads.mariadb.org/mariadb/10.11.11/" class="button primary">Download</a> <a href="../../10.11/10.11.11.md" class="button secondary">Release Notes</a> <a href="10.11.11.md" class="button secondary">Changelog</a> <a href="../../10.11/what-is-mariadb-1011.md" class="button secondary">Overview of 10.11</a>

**Release date:** 4 Feb 2025

For the highlights of this release, see the [release notes](../../10.11/10.11.11.md).
...
* Includes all fixes from [MariaDB 10.6.21](../10.6/10.6.21.md)
