...
<a href="https://downloads.mariadb.org/mariadb/10.6.18/" class="button primary">Download</a> <a href="../../10.6/10.6.18.md" class="button secondary">Release Notes</a> <a href="10.6.18.md" class="button secondary">Changelog</a> <a href="../../10.6/what-is-mariadb-106.md" class="button secondary">Overview of 10.6</a>

**Release date:** 16 May 2024

For the highlights of this release, see the [release notes](../../10.6/10.6.18.md).
...
* [Revision #c1da568502](https://github.com/MariaDB/server/commit/c1da568502)\
  ...
  * [MDEV-33726](https://jira.mariadb.org/browse/MDEV-33726) Moving from [MariaDB 10.5](../../old-releases/10.5/what-is-mariadb-105.md) to 10.6 mysql\_upgrade
