...
<a href="https://downloads.mariadb.org/mariadb/10.6.9/" class="button primary">Download</a> <a href="../../10.6/10.6.9.md" class="button secondary">Release Notes</a> <a href="10.6.9.md" class="button secondary">Changelog</a> <a href="../../10.6/what-is-mariadb-106.md" class="button secondary">Overview of 10.6</a>

**Release date:** 15 Aug 2022

For the highlights of this release, see the [release notes](../../10.6/10.6.9.md).
