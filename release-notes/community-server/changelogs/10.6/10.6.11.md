...
<a href="https://downloads.mariadb.org/mariadb/10.6.11/" class="button primary">Download</a> <a href="../../10.6/10.6.11.md" class="button secondary">Release Notes</a> <a href="10.6.12.md" class="button secondary">Changelog</a> <a href="../../10.6/what-is-mariadb-106.md" class="button secondary">Overview of 10.6</a>

**Release date:** 7 Nov 2022

For the highlights of this release, see the [release notes](../../10.6/10.6.11.md).
...
* [Revision #3dd03a2334](https://github.com/MariaDB/server/commit/3dd03a2334)\
  ...
  * [MDEV-29347](https://jira.mariadb.org/browse/MDEV-29347) [MariaDB 10.6.8](../../10.6/10.6.8.md) fails to start when ONLY\_FULL\_GROUP\_BY gets provided
