...
<a href="https://mariadb.com/downloads/community" class="button primary">Download</a> <a href="../../10.6/10.6.22.md" class="button secondary">Release Notes</a> <a href="10.6.22.md" class="button secondary">Changelog</a> <a href="../../10.6/what-is-mariadb-106.md" class="button secondary">Overview of 10.6</a>

[_Alternate download from mariadb.org_](https://downloads.mariadb.org/mariadb/10.6.22/)

**Release date:** 8 May 2025

For the highlights of this release, see the [release notes](../../10.6/10.6.22.md).
