...
<a href="https://downloads.mariadb.org/mariadb/10.6.10/" class="button primary">Download</a> <a href="../../10.6/10.6.10.md" class="button secondary">Release Notes</a> <a href="10.6.10.md" class="button secondary">Changelog</a> <a href="../../10.6/what-is-mariadb-106.md" class="button secondary">Overview of 10.6</a>

**Release date:** 19 Sep 2022

For the highlights of this release, see the [release notes](../../10.6/10.6.10.md).
...
* [Revision #ec37906646](https://github.com/MariaDB/server/commit/ec37906646)\
  ...
  * [MDEV-29321](https://jira.mariadb.org/browse/MDEV-29321) Percona XtraDB 5.7 can't be upgrade to [MariaDB 10.6](../../10.6/what-is-mariadb-106.md) or above
