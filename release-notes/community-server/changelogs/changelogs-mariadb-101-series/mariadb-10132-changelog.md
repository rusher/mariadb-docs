...
[Download](https://downloads.mariadb.org/mariadb/10.1.32)[Release Notes](../../old-releases/10.1/10.1.32.md)[Changelog](mariadb-10132-changelog.md)[Overview of 10.1](../../old-releases/10.1/changes-improvements-in-mariadb-10-1.md)

**Release date:** 27 Mar 2018

For the highlights of this release, see the [release notes](../../old-releases/10.1/10.1.32.md).
