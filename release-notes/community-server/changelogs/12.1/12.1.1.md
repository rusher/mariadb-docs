...
<a href="https://mariadb.org/download/" class="button primary">Download</a> <a href="../../12.1/12.1.1.md" class="button secondary">Release Notes</a> <a href="12.1.1.md" class="button secondary">Changelog</a> <a href="../../12.1/changes-and-improvements-in-mariadb-12.1.md" class="button secondary">Overview of 12.1</a>

**Release date:** 7 Aug 2025

For the highlights of this release, see the [release notes](../../12.1/12.1.1.md).
...
* Includes all fixes from [MariaDB 12.0.2](../12.0/12.0.2.md)
