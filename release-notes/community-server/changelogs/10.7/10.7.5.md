...
[Download 10.7.5](https://downloads.mariadb.org/mariadb/10.7.5/)[Release Notes](https://mariadb.com/docs/release-notes/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-7-series)[Changelog](10.7.5.md)[Overview of 10.7](../../old-releases/10.7/what-is-mariadb-107.md)
...
* Includes all fixes from [MariaDB 10.6.9](../10.6/10.6.9.md)
