...
[Download 10.7.1](https://mariadb.org/download/?tab=mariadb\&release=10.7.1\&product=mariadb)[Release Notes](https://mariadb.com/docs/release-notes/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-7-series)[Changelog](10.7.1.md)[Overview of 10.7](../../old-releases/10.7/what-is-mariadb-107.md)
...
* Includes all fixes from [MariaDB 10.6.5](../10.6/10.6.5.md)
