...
[Download 10.4.30](https://downloads.mariadb.org/mariadb/10.4.30/)[Release Notes](../../old-releases/10.4/10.4.30.md)[Changelog](mariadb-10-4-30-changelog.md)[Overview of 10.4](../../old-releases/10.4/what-is-mariadb-104.md)

**Release date:** 7 Jun 2023

For the highlights of this release, see the [release notes](../../old-releases/10.4/10.4.30.md).
