...
<a href="https://mariadb.com/downloads" class="button primary">Download</a> <a href="../../11.8/11.8.2.md" class="button secondary">Release Notes</a> <a href="11.8.2.md" class="button secondary">Changelog</a> <a href="../../11.8/what-is-mariadb-118.md" class="button secondary">Overview of 11.8</a>

[<sup>_Alternate download from mariadb.org_</sup>](https://downloads.mariadb.org/mariadb/11.8.2/)

**Release date:** 4 Jun 2025

For the highlights of this release, see the [release notes](../../11.8/11.8.2.md).
...
* Includes all fixes from [MariaDB 11.4.7](../11.4/11.4.7.md)
