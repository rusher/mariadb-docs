...
[Download 11.2.4](https://downloads.mariadb.org/mariadb/11.2.4/)[Release Notes](../../old-releases/11.2/11.2.4.md)[Changelog](mariadb-11-2-4-changelog.md)[Overview of 11.2](../../old-releases/11.2/what-is-mariadb-112.md)

**Release date:** 16 May 2024

For the highlights of this release, see the [release notes](../../old-releases/11.2/11.2.4.md).
...
* Includes all fixes from [MariaDB 11.1.5](../11.1/mariadb-11-1-5-changelog.md)
