...
[Download 11.2.2](https://downloads.mariadb.org/mariadb/11.2.2/)[Release Notes](../../old-releases/11.2/11.2.2.md)[Changelog](mariadb-11-2-2-changelog.md)[Overview of 11.2](../../old-releases/11.2/what-is-mariadb-112.md)

**Release date:** 21 Nov 2023

For the highlights of this release, see the [release notes](../../old-releases/11.2/11.2.2.md).
...
* Includes all fixes from [MariaDB 11.1.3](../11.1/mariadb-11-1-3-changelog.md)
