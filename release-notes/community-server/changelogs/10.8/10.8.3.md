...
[Download 10.8.3](https://mariadb.org/download/?tab=mariadb\&release=10.8.3\&product=mariadb)[Release Notes](../../old-releases/10.8/10.8.3.md)[Changelog](10.8.3.md)[Overview of 10.8](../../old-releases/10.8/what-is-mariadb-108.md)

**Release date:** 20 May 2022

For the highlights of this release, see the [release notes](../../old-releases/10.8/10.8.3.md).
...
* Includes all fixes from [MariaDB 10.7.4](../10.7/10.7.4.md)
...
* [Revision #b884410a0e](https://github.com/MariaDB/server/commit/b884410a0e)\
  ...
  * [MDEV-28232](https://jira.mariadb.org/browse/MDEV-28232): Add missing conflict and breaks for [MariaDB 10.7](../../old-releases/10.7/what-is-mariadb-107.md)
