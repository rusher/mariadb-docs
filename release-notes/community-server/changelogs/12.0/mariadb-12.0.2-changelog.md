...
<a href="https://dlm.mariadb.com/browse/mariadb_server/12.0.2/" class="button primary">Download</a> <a href="../../12.0/12.0.2.md" class="button secondary">Release Notes</a> <a href="mariadb-12.0.2-changelog.md" class="button secondary">Changelog</a> <a href="../../12.0/what-is-mariadb-120.md" class="button secondary">Overview of 12.0</a>

[<sup>_Alternate download from mariadb.org_</sup>](https://downloads.mariadb.org/mariadb/12.0.2/)

**Release date:** 7 Aug 2025

For the highlights of this release, see the [release notes](../../12.0/12.0.2.md).
...
* Includes all fixes from [MariaDB 11.8.3](../11.8/11.8.3.md)
