...
[MariaDB 10.2](../../old-releases/release-notes-mariadb-10-2-series/what-is-mariadb-102.md) and later can replicate from a MySQL 5.7 primary server.
...
Prior to [MariaDB 10.6.21](../../mariadb-10-6-series/mariadb-10-6-21-release-notes.md), [MariaDB 10.11.11](../../mariadb-10-11-series/mariadb-10-11-11-release-notes.md), [MariaDB 11.4.5](../../mariadb-11-4-series/mariadb-11-4-5-release-notes.md) and [MariaDB 11.7.2](../../old-releases/mariadb-11-7-rolling-releases/mariadb-11-7-2-release-notes.md), MariaDB Server could not replicate from a MySQL 8.0 primary server, because MySQL 8.0 has a binary log format that includes new events which makes it incompatible.

[MariaDB 10.6.21](../../mariadb-10-6-series/mariadb-10-6-21-release-notes.md), [MariaDB 10.11.11](../../mariadb-10-11-series/mariadb-10-11-11-release-notes.md), [MariaDB 11.4.5](../../mariadb-11-4-series/mariadb-11-4-5-release-notes.md), [MariaDB 11.7.2](../../old-releases/mariadb-11-7-rolling-releases/mariadb-11-7-2-release-notes.md) and newer can replicate from a MySQL 8.0 server with the following conditions:
