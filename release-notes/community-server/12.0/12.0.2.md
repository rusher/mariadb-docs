...
For a complete list of changes made in MariaDB 12.0.1, with links to detailed information on each push, see the [changelog](../changelogs/12.0/mariadb-12.0.2-changelog.md).
