---
description: >-
  MariaDB 12.0.2 is a Stable (GA) release of MariaDB Community Server 12.0,
  released on 2025-08-07
---

# MariaDB 12.0.2 Release Notes

<a href="https://dlm.mariadb.com/browse/mariadb_server/12.0.2/" class="button primary">Download</a> <a href="12.0.2.md" class="button secondary">Release Notes</a> <a href="../changelogs/12.0/12.0.2.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-120.md" class="button secondary">Overview of 12.0</a>

[<sup>_Alternate download from mariadb.org_</sup>](https://downloads.mariadb.org/mariadb/12.0.2/)

**Release date:** 7 Aug 2025

MariaDB 12.0.2 is a [_**Stable (GA)**_](../about/release-criteria.md) release. It is an evolution of [MariaDB 11.8](../11.8/what-is-mariadb-118.md) with several entirely new features.
...
For a complete list of changes made in MariaDB 12.0.1, with links to detailed information on each push, see the [changelog](../changelogs/12.0/12.0.2.md).
