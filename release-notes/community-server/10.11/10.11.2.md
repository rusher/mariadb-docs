---
description: >-
  MariaDB 10.11.2 is a Stable (GA) release of MariaDB Community Server 10.11,
...
<a href="https://downloads.mariadb.org/mariadb/10.11.2/" class="button primary">Download</a> <a href="10.11.2.md" class="button secondary">Release Notes</a> <a href="../changelogs/10.11/10.11.2.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-1011.md" class="button secondary">Overview of 10.11</a>

**Release date:** 16 Feb 2023

[MariaDB 10.11](what-is-mariadb-1011.md) is a long term maintenance release series of MariaDB, [maintained until](https://mariadb.org/about/#maintenance-policy) February 2028. It is an evolution of [MariaDB 10.10](../old-releases/10.10/what-is-mariadb-1010.md) with several entirely new features.

[MariaDB 10.11.2](10.11.2.md) is a [_**Stable (GA)**_](../about/release-criteria.md) release.
...
For a full list of contributors to [MariaDB 10.11.2](10.11.2.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-7-1-rc-and-mariadb-10-6-5-10-5-13-10-4-22-10-3-32-and-10-2-41-now-available/).
