---
description: >-
  MariaDB 10.11.1 is a Release Candidate (RC) release of MariaDB Community
  Server 10.11, released on 2022-11-17
---
...
<a href="https://downloads.mariadb.org/mariadb/10.11.1/" class="button primary">Download</a> <a href="10.11.1.md" class="button secondary">Release Notes</a> <a href="../changelogs/10.11/10.11.1.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-1011.md" class="button secondary">Overview of 10.11</a>

**Release date:** 17 Nov 2022

{% include "../../.gitbook/includes/non-stable.md" %}

[MariaDB 10.11](what-is-mariadb-1011.md) is a current development series of MariaDB. It is an evolution of [MariaDB 10.10](../old-releases/10.10/what-is-mariadb-1010.md) with several entirely new features.

[MariaDB 10.11.1](10.11.1.md) is a [_**Release Candidate (RC)**_](../about/release-criteria.md) release.
...
* Allow [innodb\_undo\_tablespaces](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb/innodb-system-variables#innodb_undo_tablespaces) to be changed after database creation ([MDEV-19229](https://jira.mariadb.org/browse/MDEV-19229))
...
For a complete list of changes made in [MariaDB 10.11.1](10.11.1.md), with links to detailed\
information on each push, see the [changelog](../changelogs/10.11/10.11.1.md).

## Contributors

For a full list of contributors to [MariaDB 10.11.1](10.11.1.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-7-1-rc-and-mariadb-10-6-5-10-5-13-10-4-22-10-3-32-and-10-2-41-now-available/).
