---
description: >-
  MariaDB 10.11.3 is a Stable (GA) release of MariaDB Community Server 10.11,
...
<a href="https://downloads.mariadb.org/mariadb/10.11.3/" class="button primary">Download</a> <a href="10.11.3.md" class="button secondary">Release Notes</a> <a href="../changelogs/10.11/10.11.3.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-1011.md" class="button secondary">Overview of 10.11</a>

**Release date:** 10 May 2023

[MariaDB 10.11](what-is-mariadb-1011.md) is the current long term maintenance development series of MariaDB, [maintained until](https://mariadb.org/about/#maintenance-policy) February 2028. It is an evolution of [MariaDB 10.10](../old-releases/10.10/what-is-mariadb-1010.md) with several entirely new features.

[MariaDB 10.11.3](10.11.3.md) is a [_**Stable (GA)**_](../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 10.11.3](10.11.3.md), with links to detailed\
information on each push, see the [changelog](../changelogs/10.11/10.11.3.md).

## Contributors

For a full list of contributors to [MariaDB 10.11.3](10.11.3.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-11-3-10-10-4-10-9-6-10-8-8-10-6-13-10-5-20-10-4-29-and-10-3-39-now-available/).
