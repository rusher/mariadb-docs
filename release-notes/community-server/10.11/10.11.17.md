...
# MariaDB 10.11.17 Release Notes

{% include "../../.gitbook/includes/unreleased-10-11.md" %}

<a href="https://mariadb.com/downloads/community" class="button primary">Download</a> <a href="10.11.17.md" class="button secondary">Release Notes</a> <a href="../changelogs/10.11/10.11.17.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-1011.md" class="button secondary">Overview of 10.11</a>
...
MariaDB 10.11.17 is a _**Stable (GA)**_ release.
...
* Needless posix\_fadvise(POSIX\_FADV\_DONTNEED) system calls where replaced with a single call when the file was opened rather than after each write. ([MDEV-38507](https://jira.mariadb.org/browse/MDEV-38507))
...
* Plugins compile time errors ([MDEV-14373](https://jira.mariadb.org/browse/MDEV-14373))
...
* Fix signed/unsigned type mismatch in setval() for GET\_ULONG ([MDEV-38915](https://jira.mariadb.org/browse/MDEV-38915))
...
* Assertion in json\_find\_path() fails after computing array size of invalid json structure ([MDEV-38264](https://jira.mariadb.org/browse/MDEV-38264))
...
* If user has limited write set size using wsrep\_max\_ws\_rows or wsrep\_max\_ws\_size for Galera then multi-table update that updates transactional and non-transactional table is not allowed.

Furthermore, limiting write set size is not allowed if there is active Galera transaction. ([MDEV-28750](https://jira.mariadb.org/browse/MDEV-28750))
...
* galera.GCF-360 test: IST failure ([MDEV-36621](https://jira.mariadb.org/browse/MDEV-36621))
...
* Cherry-pick fix for Galera test failure on MDEV-38073 ([MDEV-39007](https://jira.mariadb.org/browse/MDEV-39007))
...
* Assertion \`mdl\_key->length() == 3' failed in MDL\_map::find\_or\_insert ([MDEV-38798](https://jira.mariadb.org/browse/MDEV-38798))
...
* Fixes infinite loop when my\_copy fails. ([MDEV-38696](https://jira.mariadb.org/browse/MDEV-38696))
...
* MSAN/Valgrind warnings in Explain\_table\_access::tag\_to\_json ([MDEV-37904](https://jira.mariadb.org/browse/MDEV-37904))
...
* Server crash and UBSAN null-pointer-use in Window\_funcs\_sort::setup ([MDEV-28619](https://jira.mariadb.org/browse/MDEV-28619))
...
* Fixed possible 1 byte stack buffer overflow in proxy header v1 parsing. ([MDEV-39219](https://jira.mariadb.org/browse/MDEV-39219))

### Query Cache

* Server hangs or crashes in Query\_cache::move\_by\_type upon FLUSH QUERY CACHE ([MDEV-25365](https://jira.mariadb.org/browse/MDEV-25365))
...
* .mariadb\_history rename race condition ([MDEV-38494](https://jira.mariadb.org/browse/MDEV-38494))
* mariadbcheck --silent ([MDEV-38778](https://jira.mariadb.org/browse/MDEV-38778))

### Sequences

* Server crashes in Item\_func\_nextval::val\_int upon update on a view ([MDEV-38815](https://jira.mariadb.org/browse/MDEV-38815))
...
* Fix crash when resolving `$HOME` ([MDEV-39118](https://jira.mariadb.org/browse/MDEV-39118))
...
* mariadb-upgrade note is useless and wrong ([MDEV-34210](https://jira.mariadb.org/browse/MDEV-34210))

### Views

* Some views are broken in Oracle mode after upgrade to Q1 2026 ([MDEV-38799](https://jira.mariadb.org/browse/MDEV-38799))
...
* Fixes for the following security vulnerabilities:
  ...
  * [CVE-2026-44169](https://www.cve.org/CVERecord?id=CVE-2026-44169)
...
For a complete list of changes made in MariaDB 10.11.17, with links to detailed information on each push, see the [changelog](../changelogs/10.11/10.11.17.md).
