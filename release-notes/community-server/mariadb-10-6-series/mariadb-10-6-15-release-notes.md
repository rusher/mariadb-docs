...
[MariaDB 10.6.15](mariadb-10-6-15-release-notes.md) is a [_**Stable (GA)**_](../about/release-criteria.md) release.
...
* As per the [MariaDB Deprecation Policy](../about/platform-deprecation-policy.md), this will be the last release of [MariaDB 10.6](what-is-mariadb-106.md) for Ubuntu 18.04 LTS "Bionic" and Ubuntu 22.10 "Kinetic"
