...
For a complete list of changes made in MariaDB 10.6.24, with links to detailed information on each push, see the [changelog](../changelogs/changelogs-mariadb-106-series/mariadb-10.6.24-changelog.md).
