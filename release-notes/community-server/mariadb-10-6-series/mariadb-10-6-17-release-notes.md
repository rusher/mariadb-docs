...
[MariaDB 10.6.17](mariadb-10-6-17-release-notes.md) is a [_**Stable (GA)**_](../about/release-criteria.md) release.
...
* As per the [MariaDB Deprecation Policy](../about/platform-deprecation-policy.md), this will be the last release of [MariaDB 10.6](what-is-mariadb-106.md) for Fedora 37, and Windows Server 2019
