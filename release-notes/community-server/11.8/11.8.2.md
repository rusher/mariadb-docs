---
description: >-
  MariaDB 11.8.2 is a Stable (GA) release of MariaDB Community Server 11.8,
...
<a href="https://mariadb.com/downloads" class="button primary">Download</a> <a href="11.8.2.md" class="button secondary">Release Notes</a> <a href="../changelogs/11.8/11.8.2.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-118.md" class="button secondary">Overview of 11.8</a>

[<sup>_Alternate download from mariadb.org_</sup>](https://downloads.mariadb.org/mariadb/11.8.2/)

**Release date:** 4 Jun 2025

[MariaDB 11.8.2](11.8.2.md) is a [_**Stable (GA)**_](../about/release-criteria.md) release. It is an evolution of [MariaDB 11.7](../old-releases/mariadb-11-7-rolling-releases/what-is-mariadb-117.md) with several entirely new features.
...
For a complete list of changes made in MariaDB 11.8.2, with links to detailed information on each push, see the [changelog](../changelogs/11.8/11.8.2.md).

## Contributors

For a full list of contributors to [MariaDB 11.8.2](11.8.2.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-7-1-rc-and-mariadb-10-6-5-10-5-13-10-4-22-10-3-32-and-10-2-41-now-available/).
