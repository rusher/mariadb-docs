...
<a href="https://mariadb.com/downloads" class="button primary">Download</a> <a href="11.8.7.md" class="button secondary">Release Notes</a> <a href="../changelogs/11.8/11.8.7.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-118.md" class="button secondary">Overview of 11.8</a>

[<sup>_Alternate download from mariadb.org_</sup>](https://downloads.mariadb.org/mariadb/11.8.7/)

**Release date:** ?

MariaDB 11.8.7 is a [_**Stable (GA)**_](../about/release-criteria.md) release. It is an evolution of [MariaDB 11.7](../old-releases/11.7/what-is-mariadb-117.md) with several entirely new features.
...
* Fix UBSAN runtime errors in string comparison functions. ([MDEV-35717](https://jira.mariadb.org/browse/MDEV-35717))
...
* JSON\_OBJECTAGG(NULL) in decimal context ([MDEV-39135](https://jira.mariadb.org/browse/MDEV-39135))
...
* Object Longlong\_hybrid in bison union ([MDEV-39282](https://jira.mariadb.org/browse/MDEV-39282))
...
* regression in t\_connect ([MDEV-38179](https://jira.mariadb.org/browse/MDEV-38179))
...
For a complete list of changes made in MariaDB 11.8.7, with links to detailed information on each push, see the [changelog](../changelogs/11.8/11.8.7.md).
