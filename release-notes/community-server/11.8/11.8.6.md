...
* spider test suite failures in any network sandbox: Can't get hardware address with error ([MDEV-37098](https://jira.mariadb.org/browse/MDEV-37098))
...
* Assertion if FLUSH PRIVILEGES is interrupted in --skip-grant-tables ([MDEV-37506](https://jira.mariadb.org/browse/MDEV-37506))
...
* mysql\_upgrade does not fix charset and collation for mysql.user ([MDEV-38698](https://jira.mariadb.org/browse/MDEV-38698))
...
* Error 153: No savepoint with that name upon ROLLBACK TO SAVEPOINT, assertion failure ([MDEV-36787](https://jira.mariadb.org/browse/MDEV-36787))
...
* Assertion failures `null_ptr < ptr` and `ptr - null_ptr <= (int)table->s->rec_buff_length` with BEFORE trigger and UPDATE ([MDEV-37341](https://jira.mariadb.org/browse/MDEV-37341))
...
* Assertion `! thd->in_sub_stmt` failed in bool trans\_rollback\_stmt(THD\*) ([MDEV-34117](https://jira.mariadb.org/browse/MDEV-34117))
...
* Assertion `client_state.transaction().active()` failed in int wsrep\_thd\_append\_key(THD\*, const wsrep\_key\*, int, Wsrep\_service\_key\_type) ([MDEV-36909](https://jira.mariadb.org/browse/MDEV-36909))
...
* SIGSEGV in Wsrep\_server\_service::release\_high\_priority\_service | discard\_streaming\_applier ([MDEV-37354](https://jira.mariadb.org/browse/MDEV-37354))
...
* Assertion `level != Sql_condition::WARN_LEVEL_ERROR` failed in void push\_warning(THD\*, Sql\_state\_errno\_level::enum\_warning\_level, uint, const char\*) ([MDEV-38201](https://jira.mariadb.org/browse/MDEV-38201))
...
* Server crashes at my\_hash\_free ([MDEV-33640](https://jira.mariadb.org/browse/MDEV-33640))
* JSON\_SCHEMA\_VALID() crashes with a long enum ([MDEV-38356](https://jira.mariadb.org/browse/MDEV-38356))

### Optimizer

* Segmentation fault due to Deep Recursion in table.cc and sql\_lex.cc ([MDEV-32724](https://jira.mariadb.org/browse/MDEV-32724))
* ASAN: use-after-poison in get\_hash\_symbol  ([MDEV-35815](https://jira.mariadb.org/browse/MDEV-35815))
...
* On partitionen tables algorithm is not supported throw "no such file or directory" error ([MDEV-35562](https://jira.mariadb.org/browse/MDEV-35562))
...
* Userstat Plugin CPU\_TIME much higher than BUSY\_TIME in versions 10.11.X and beyond ([MDEV-38028](https://jira.mariadb.org/browse/MDEV-38028))
...
* Server crashes in Item\_func\_nextval::val\_int after select from view  ([MDEV-28650](https://jira.mariadb.org/browse/MDEV-28650))
* Server crashes at Item\_func\_nextval::val\_int ([MDEV-33985](https://jira.mariadb.org/browse/MDEV-33985))
...
* Crash during the Item\_subselect::init - outer\_select is NULL ([MDEV-36876](https://jira.mariadb.org/browse/MDEV-36876))
