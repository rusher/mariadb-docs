...
[Download 11.3.1](https://downloads.mariadb.org/mariadb/11.3.1/) | [Release Notes](11.3.1.md) | [Changelog](../../changelogs/11.3/mariadb-11-3-1-changelog.md) | [Overview of 11.3](what-is-mariadb-113.md)

**Release date:** 21 Nov 2023

**Do not use non-stable (non-GA) releases in production!**

[MariaDB 11.3](what-is-mariadb-113.md) is a current development series of MariaDB. It is an evolution of [MariaDB 11.2](../11.2/what-is-mariadb-112.md) with several entirely new features.

[MariaDB 11.3.1](11.3.1.md) is a [_**Release Candidate (RC)**_](../../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 11.3.1](11.3.1.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/11.3/mariadb-11-3-1-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 11.3.1](11.3.1.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-3-1-11-2-2-now-available/).
