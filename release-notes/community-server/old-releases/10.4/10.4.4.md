---
description: >-
  MariaDB 10.4.4 is an RC release of MariaDB Community Server 10.4, released on
  2019-04-07
---
...
[Download](https://downloads.mariadb.org/mariadb/10.4.4) | [Release Notes](10.4.4.md) | [Changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-1044-changelog.md) | [Overview of 10.4](what-is-mariadb-104.md)
...
[MariaDB 10.4.4](10.4.4.md) is a [_**Release Candidate**_](../../about/release-criteria.md) release.
...
* Repositories for CentOS 7, RHEL 7 & 8, Fedora 28 & 29, and SLES 12 & 15 now\
  ...
  doing so are found on the [Building MariaDB from a Source RPM](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/install-and-upgrade-mariadb/compiling-mariadb-from-source/legacy-guides/building-mariadb-from-a-source-rpm)\
  page
* The [Galera library](https://codership.com/content/using-galera-cluster) in the repositories has\
  been updated to version 26.4.2
* As per the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md), this is the\
  last release of [MariaDB 10.4](./) for Ubuntu 14.04 Trusty
* Fixes for the following [security vulnerabilities](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/security/cve):
  * CVE-\`-\`\`\`

## Changelog

For a complete list of changes made in [MariaDB 10.4.4](10.4.4.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-1044-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.4.4](10.4.4.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-4-4-now-available/).
