---
description: >-
  MariaDB 10.4.3 is an RC release of MariaDB Community Server 10.4, released on
  2019-02-25
---
...
[Download](https://downloads.mariadb.org/mariadb/10.4.3) | [Release Notes](10.4.3.md) | [Changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-1043-changelog.md) | [Overview of 10.4](what-is-mariadb-104.md)

**Release date:** 25 Feb 2019

[MariaDB 10.4](./) is the current _development_ series of MariaDB. It is an evolution\
of [MariaDB 10.3](../10.3/what-is-mariadb-103.md) with several entirely new features not found anywhere else\
and with backported and reimplemented features from MySQL.

[MariaDB 10.4.3](10.4.3.md) is a [_**Release Candidate**_](../../about/release-criteria.md) release.
...
* Debian has stopped supporting the ppc64el architecture for Debian 8\
  Jessie and so this is the last release of [MariaDB 10.4](./) on Jessie for that\
  architecture
...
For a complete list of changes made in [MariaDB 10.4.3](10.4.3.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-1043-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.4.3](10.4.3.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-4-3-now-available/).
