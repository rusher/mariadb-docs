---
description: >-
  MariaDB 10.4.34 is a Stable (GA) release of MariaDB Community Server 10.4,
  released on 2024-05-16
---

# MariaDB 10.4.34 Release Notes

[Download](https://mariadb.com/downloads/) | [Release Notes](10.4.34.md) | [Changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-10-4-34-changelog.md) | [Overview of 10.4](./)

[_Alternate download from mariadb.org_](https://downloads.mariadb.org/mariadb/10.4.34/)

**Release date:** 16 May 2024

[MariaDB 10.4](./) is a previous _stable_ series of MariaDB, [maintained until](https://mariadb.org/about/#maintenance-policy) June 2024. It is an evolution of [MariaDB 10.3](../10.3/what-is-mariadb-103.md) with several entirely new features not found anywhere else and with backported and reimplemented features from MySQL.

[MariaDB 10.4.34](10.4.34.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.

[MariaDB 10.4.34](10.4.34.md) is the last release of the [MariaDB 10.4](./) release series.
...
* Incorrect handling of UPDATE in PS mode in case a table's column declared as NOT NULL ([MDEV-33549](https://jira.mariadb.org/browse/MDEV-33549))
...
For a complete list of changes made in [MariaDB 10.4.34](10.4.34.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-10-4-34-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.4.34](10.4.34.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-2-4-11-1-5-11-0-6-10-11-8-10-6-18-10-5-25-10-4-34-now-available/).
