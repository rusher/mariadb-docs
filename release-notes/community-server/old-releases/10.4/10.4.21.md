---
description: >-
  MariaDB 10.4.21 is a Stable (GA) release of MariaDB Community Server 10.4,
...
[Download 10.4.21](https://downloads.mariadb.org/mariadb/10.4.21/) | [Release Notes](10.4.21.md) | [Changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-10421-changelog.md) | [Overview of 10.4](what-is-mariadb-104.md)
...
[MariaDB 10.4.21](10.4.21.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* As per the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md), this will be the last release of [MariaDB 10.4](./) for Ubuntu 20.10 Groovy
* [Galera]({galera}) updated to 26.4.9
...
For a complete list of changes made in [MariaDB 10.4.21](10.4.21.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-10421-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.4.21](10.4.21.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-6-4-10-5-12-10-4-21-10-3-31-and-10-2-40-now-available/).
