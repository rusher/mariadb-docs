...
[Download](https://downloads.mariadb.org/mariadb/10.4.1/) | [Release Notes](10.4.1.md) | [Changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-1041-changelog.md) | [Overview of 10.4](what-is-mariadb-104.md)

**Release date:** 20 Dec 2018

[MariaDB 10.4](./) is the current _development_ series of MariaDB. It is an evolution of [MariaDB 10.3](../10.3/what-is-mariadb-103.md) with several entirely new features not found anywhere else and with backported and reimplemented features from MySQL.
