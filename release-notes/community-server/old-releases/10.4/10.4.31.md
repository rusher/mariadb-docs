---
description: >-
  MariaDB 10.4.31 is a Stable (GA) release of MariaDB Community Server 10.4,
  released on 2023-08-14
---

# MariaDB 10.4.31 Release Notes

[Download](https://mariadb.com/downloads/) | [Release Notes](10.4.31.md) | [Changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-10-4-31-changelog.md) | [Overview of 10.4](what-is-mariadb-104.md)
...
[MariaDB 10.4.31](10.4.31.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* As per the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md), this will be the last release of [MariaDB 10.4](./) for Ubuntu 18.04 LTS "Bionic"
...
* `I_S.parameters` not immediately changed updated after procedure change ([MDEV-31064](https://jira.mariadb.org/browse/MDEV-31064))
...
For a complete list of changes made in [MariaDB 10.4.31](10.4.31.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-10-4-31-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.4.31](10.4.31.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-0-3-10-11-5-10-10-6-10-9-8-10-6-15-10-5-22-10-4-31-now-available/).
