---
description: >-
  MariaDB 10.4.32 is a Stable (GA) release of MariaDB Community Server 10.4,
...
[Download 10.4.32](https://downloads.mariadb.org/mariadb/10.4.32/) | [Release Notes](10.4.32.md) | [Changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-10-4-32-changelog.md) | [Overview of 10.4](what-is-mariadb-104.md)
...
[MariaDB 10.4.32](10.4.32.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* [Galera]({galera}) updated to 26.4.16
...
For a complete list of changes made in [MariaDB 10.4.32](10.4.32.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-10-4-32-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.4.32](10.4.32.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-1-3-11-0-4-10-11-6-10-10-7-10-6-16-10-5-23-10-4-32-now-available/).
