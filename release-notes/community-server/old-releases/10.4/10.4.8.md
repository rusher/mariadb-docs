---
description: >-
  MariaDB 10.4.8 is a Stable (GA) release of MariaDB Community Server 10.4,
...
[Download](https://downloads.mariadb.org/mariadb/10.4.8/) | [Release Notes](10.4.8.md) | [Changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-1048-changelog.md) | [Overview of 10.4](what-is-mariadb-104.md)
...
[MariaDB 10.4.8](10.4.8.md) will be a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 10.4.8](10.4.8.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-1048-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.4.8](10.4.8.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-4-8-10-3-18-and-10-2-27-now-available/).
