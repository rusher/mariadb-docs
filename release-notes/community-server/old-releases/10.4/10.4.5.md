---
description: >-
  MariaDB 10.4.5 is an RC release of MariaDB Community Server 10.4, released on
  2019-05-21
---
...
[Download](https://downloads.mariadb.org/mariadb/10.4.5) | [Release Notes](10.4.5.md) | [Changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-1045-changelog.md) | [Overview of 10.4](what-is-mariadb-104.md)
...
[MariaDB 10.4.5](10.4.5.md) is a [_**Release Candidate (RC)**_](../../about/release-criteria.md) release.
...
* As per the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md), this is the last release of [MariaDB 10.4](./) for Fedora 28
...
For a complete list of changes made in [MariaDB 10.4.5](10.4.5.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-1045-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.4.5](10.4.5.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-4-5-now-available/).
