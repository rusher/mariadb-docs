---
description: >-
  MariaDB 10.4.9 is a Stable (GA) release of MariaDB Community Server 10.4,
...
[Download](https://mariadb.com/downloads/) | [Release Notes](10.4.9.md) | [Changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-1049-changelog.md) | [Overview of 10.4](what-is-mariadb-104.md)
...
[MariaDB 10.4.9](10.4.9.md) will be a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* [Galera wsrep library](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/3VYeeVGUV4AMqrA3zwy7/readme/mariadb-galera-cluster-guide) updated to 26.4.3
...
For a complete list of changes made in [MariaDB 10.4.9](10.4.9.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-4-series/mariadb-1049-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.4.9](10.4.9.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-4-9-10-3-19-and-10-2-28-10-1-42-and-5-5-66-now-available/).
