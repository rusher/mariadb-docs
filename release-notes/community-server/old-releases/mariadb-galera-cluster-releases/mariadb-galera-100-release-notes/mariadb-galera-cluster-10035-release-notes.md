...
release. It is a merge of [MariaDB 10.0.35](../../10.0/10.0.35.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
For changes made in [MariaDB 10.0.35](../../10.0/10.0.35.md), see the [MariaDB 10.0.35 Changelog](../../../changelogs/changelogs-mariadb-100-series/mariadb-10035-changelog.md)
...
* See the [MariaDB 10.0.35 Release Notes](../../10.0/10.0.35.md) and [Changelog](../../../changelogs/changelogs-mariadb-100-series/mariadb-10035-changelog.md) for more information on the changes in\
  MariaDB.
