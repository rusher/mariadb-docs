...
release. It is a merge of [MariaDB 10.0.21](../../10.0/10.0.21.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
* See the [MariaDB 10.0.21 Release Notes](../../10.0/10.0.21.md) and [Changelog](../../../changelogs/changelogs-mariadb-100-series/mariadb-10021-changelog.md) for more information on the changes in\
  MariaDB.
