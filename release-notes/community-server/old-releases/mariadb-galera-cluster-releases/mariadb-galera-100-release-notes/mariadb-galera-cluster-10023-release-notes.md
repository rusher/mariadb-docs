...
release. It is a merge of [MariaDB 10.0.23](../../10.0/10.0.23.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
* See the [MariaDB 10.0.23 Release Notes](../../10.0/10.0.23.md) and [Changelog](../../../changelogs/changelogs-mariadb-100-series/mariadb-10023-changelog.md) for more information on the changes in\
  MariaDB.
