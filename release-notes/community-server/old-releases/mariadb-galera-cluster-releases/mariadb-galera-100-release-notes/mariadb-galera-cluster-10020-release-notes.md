...
MariaDB Galera Cluster 10.0.20 is a [_**Stable**_](../../../about/release-criteria.md) (GA)\
release. It is a merge of [MariaDB 10.0.20](../../10.0/10.0.20.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
* See the [MariaDB 10.0.20 Release Notes](../../10.0/10.0.20.md) and [Changelog](../../../changelogs/changelogs-mariadb-100-series/mariadb-10020-changelog.md) for more information on the changes in\
  MariaDB.
