...
MariaDB Galera Cluster 5.5.41 is a [_**Stable**_](../../../about/release-criteria.md) (GA) release.\
It is a merge of [MariaDB 5.5.41](../../5.5/5.5.41.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
* MariaDB Galera Cluster 5.5.41 includes [MariaDB 5.5.41](../../5.5/5.5.41.md) with Codership\
...
See the [MariaDB 5.5.41 Release Notes](../../5.5/5.5.41.md) and [Changelog](../../../changelogs/changelogs-mariadb-55-series/mariadb-5541-changelog.md) for more information on the changes in\
MariaDB.
