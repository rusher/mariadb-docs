...
MariaDB Galera Cluster 5.5.44 is a [_**Stable**_](../../../about/release-criteria.md) (GA) release.\
It is a merge of [MariaDB 5.5.44](../../5.5/5.5.44.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
* See the [MariaDB 5.5.44 Release Notes](../../5.5/5.5.44.md) and [Changelog](../../../changelogs/changelogs-mariadb-55-series/mariadb-5544-changelog.md) for more information on the changes in\
  MariaDB.
