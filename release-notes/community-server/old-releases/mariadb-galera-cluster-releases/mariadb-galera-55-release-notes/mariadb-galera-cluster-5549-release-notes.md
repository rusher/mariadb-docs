...
release. It is a merge of [MariaDB 5.5.49](../../5.5/5.5.49.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
* See the [MariaDB 5.5.49 Release Notes](../../5.5/5.5.49.md) and [Changelog](../../../changelogs/changelogs-mariadb-55-series/mariadb-5549-changelog.md) for more information on the changes in\
  MariaDB.
