...
It is a merge of [MariaDB 5.5.36](../../5.5/5.5.36.md) and [Galera Cluster](https://codership.com/content/using-galera-cluster) with\
...
## Includes [MariaDB 5.5.36](../../5.5/5.5.36.md) and Galera

MariaDB Galera Cluster 5.5.36 includes [MariaDB 5.5.36](../../5.5/5.5.36.md) with Codership additions\
...
See the [MariaDB 5.5.36 Release Notes](../../5.5/5.5.36.md) and [Changelog](../../../changelogs/changelogs-mariadb-55-series/mariadb-5536-changelog.md) for more information on the changes in\
MariaDB.
