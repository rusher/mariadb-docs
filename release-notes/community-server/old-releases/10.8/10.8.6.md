...
[Download 10.8.6](https://downloads.mariadb.org/mariadb/10.8.6/) | [Release Notes](10.8.6.md) | [Changelog](../../changelogs/10.8/10.8.6.md) | [Overview of 10.8](what-is-mariadb-108.md)

**Release date:** 7 Nov 2022

[MariaDB 10.8](what-is-mariadb-108.md) is a previous short-term maintenance stable series of MariaDB, maintained until May 2023. It is an evolution of [MariaDB 10.7](../10.7/what-is-mariadb-107.md) with several entirely new features.

[MariaDB 10.8.6](10.8.6.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 10.8.6](10.8.6.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/10.8/10.8.6.md).

## Contributors

For a full list of contributors to [MariaDB 10.8.6](10.8.6.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-9-4-10-8-6-10-7-7-10-6-11-10-5-18-10-4-27-and-10-3-37-now-available/).
