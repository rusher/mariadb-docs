...
[Download 10.8.0](https://downloads.mariadb.org/mariadb/10.8.0/) | [Release Notes](10.8.0.md) | [Changelog](../../changelogs/changelogs-mariadb-100-series/mariadb-1008-changelog.md) | [Overview of 10.8](what-is-mariadb-108.md)
...
[MariaDB 10.8.0](10.8.0.md) is not a single release, but is instead a number of feature preview releases based on feature branches. Each should be considered as having a maturity of an [_**Alpha**_](../../about/release-criteria.md) release.\
...
* Note that this feature was not included in [MariaDB 10.8.1](10.8.1.md).
...
For a complete list of changes made in [MariaDB 10.8.0](10.8.0.md), with links to detailed\
