...
[Download](https://downloads.mariadb.org/mariadb/10.8.8/) | [Release Notes](10.8.8.md) | [Changelog](../../changelogs/10.8/10.8.8.md) | [Overview of 10.8](what-is-mariadb-108.md)

**Release date:** 10 May 2023

[MariaDB 10.8](what-is-mariadb-108.md) is a previous short-term maintenance stable series of MariaDB, [maintained until](https://mariadb.org/about/#maintenance-policy) May 2023. It is an evolution of [MariaDB 10.7](../10.7/what-is-mariadb-107.md) with several entirely new features.

[MariaDB 10.8.8](10.8.8.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.

[MariaDB 10.8.8](10.8.8.md) is the last release of the [MariaDB 10.8](what-is-mariadb-108.md) release series.
...
For a complete list of changes made in [MariaDB 10.8.8](10.8.8.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/10.8/10.8.8.md).

## Contributors

For a full list of contributors to [MariaDB 10.8.8](10.8.8.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-11-3-10-10-4-10-9-6-10-8-8-10-6-13-10-5-20-10-4-29-and-10-3-39-now-available/).
