...
<a href="https://downloads.mariadb.org/mariadb/11.6.0" class="button primary">Download</a> <a href="11.6.0.md" class="button secondary">Release Notes</a> <a href="what-is-mariadb-116.md" class="button secondary">Overview of 11.6</a>
...
[MariaDB 11.6.0](11.6.0.md) is a single preview release. Features are to be considered preview, and none are guaranteed to make it into [MariaDB 11.6](what-is-mariadb-116.md).
