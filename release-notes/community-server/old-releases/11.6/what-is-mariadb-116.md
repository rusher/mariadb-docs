...
* [Vectors](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/vectors) are a feature that allow MariaDB Server to perform as a relational vector database. In [MariaDB 10.6](../../10.6/what-is-mariadb-106.md), only available in the [Vector preview release](11.6.0-vector.md).
* Vector Search was added to [MariaDB 11.7](../11.7/what-is-mariadb-117.md).
...
| ----------- | ---------------------------------- | ----------- | --------------------------------- | -------------------------------------------------------------- |
| 21 Nov 2024 | [MariaDB 11.6.2](11.6.2.md)        | Stable (GA) | [Release Notes](11.6.2.md)        | [Changelog](../../changelogs/11.6/mariadb-11-6-2-changelog.md) |
| 14 Aug 2024 | [MariaDB 11.6.1](11.6.1.md)        | RC          | [Release Notes](11.6.1.md)        | [Changelog](../../changelogs/11.6/mariadb-11-6-1-changelog.md) |
| 29 Jul 2024 | [MariaDB 11.6.0](11.6.0.md) Vector | Alpha       | [Release Notes](11.6.0-vector.md) |                                                                |
| 26 Jun 2024 | [MariaDB 11.6.0](11.6.0.md)        | Alpha       | [Release Notes](11.6.0.md)        |                                                                |
