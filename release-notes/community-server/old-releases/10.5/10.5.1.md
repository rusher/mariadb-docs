---
description: >-
  MariaDB 10.5.1 is a Beta release of MariaDB Community Server 10.5,
...
[MariaDB 10.5.1](10.5.1.md) is a [_**Beta**_](../../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 10.5.1](10.5.1.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-105-series/mariadb-1051-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.5.1](10.5.1.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-5-1-now-available/).
