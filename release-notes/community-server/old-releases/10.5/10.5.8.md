---
description: >-
  MariaDB 10.5.8 is a Stable (GA) release of MariaDB Community Server 10.5,
...
<a href="https://downloads.mariadb.org/mariadb/10.5.8/" class="button primary">Download</a> <a href="10.5.8.md" class="button secondary">Release Notes</a> <a href="10.5.8.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-105.md" class="button secondary">Overview of 10.5</a>
...
[MariaDB 10.5.8](10.5.8.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.

Thanks, and enjoy MariaDB!

## Notable Changes

* Out-of-cycle release to fix regressions in [MariaDB 10.5.7](10.5.7.md)
...
For a complete list of changes made in [MariaDB 10.5.8](10.5.8.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-105-series/mariadb-1058-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.5.8](10.5.8.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-5-8-10-4-17-10-3-27-and-10-2-36-now-available/).
