---
description: >-
  MariaDB 10.5.2 is a Beta release of MariaDB Community Server 10.5,
...
[MariaDB 10.5.2](10.5.2.md) is a [_**Beta**_](../../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 10.5.2](10.5.2.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-105-series/mariadb-1052-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.5.2](10.5.2.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-5-2-now-available/).
