...
* [mariadb-backup]({server}/server-usage/backup-and-restore/mariadb-backup) does not honor ignore\_db\_dirs from server config ([MDEV-19347](https://jira.mariadb.org/browse/MDEV-19347))
