---
description: >-
  MariaDB 10.5.14 is a Stable (GA) release of MariaDB Community Server 10.5,
...
<a href="10.5.14.md" class="button secondary">Release Notes</a> <a href="../../changelogs/changelogs-mariadb-105-series/mariadb-10514-changelog.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-105.md" class="button secondary">Overview of 10.5</a>
...
[MariaDB 10.5.14](10.5.14.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 10.5.14](10.5.14.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-105-series/mariadb-10514-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.5.14](10.5.14.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-8-1-rc-and-mariadb-10-7-2-10-6-6-10-5-14-10-4-23-10-3-33-and-10-2-42-now-available/).
