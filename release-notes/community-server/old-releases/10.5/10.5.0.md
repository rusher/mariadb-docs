---
description: >-
  MariaDB 10.5.0 is an Alpha release of MariaDB Community Server 10.5,
...
[MariaDB 10.5.0](10.5.0.md) is an [_**Alpha**_](../../about/release-criteria.md) release.
...
* [JSON\_ARRAYAGG](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-functions/aggregate-functions/json_arrayagg)
* [JSON\_OBJECTAGG](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-functions/aggregate-functions/json_objectagg)
...
For a complete list of changes made in [MariaDB 10.5.0](10.5.0.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-105-series/mariadb-1050-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.5.0](10.5.0.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-5-0-now-available/).
