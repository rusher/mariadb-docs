---
description: >-
  MariaDB 10.5.5 is a Stable (GA) release of MariaDB Community Server 10.5,
...
[MariaDB 10.5.5](10.5.5.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* Fixes to performance regressions introduced in [MariaDB 10.5.4](10.5.4.md) ([MDEV-23017](https://jira.mariadb.org/browse/MDEV-23017), [MDEV-23369](https://jira.mariadb.org/browse/MDEV-23369), [MDEV-23410](https://jira.mariadb.org/browse/MDEV-23410))
...
For a complete list of changes made in [MariaDB 10.5.5](10.5.5.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-105-series/mariadb-1055-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.5.5](10.5.5.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-5-5-10-4-14-10-3-24-10-2-33-and-10-1-46-now-available/).
