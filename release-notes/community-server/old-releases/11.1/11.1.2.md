...
[Download 11.1.2](https://downloads.mariadb.org/mariadb/11.1.2/) | [Release Notes](11.1.2.md) | [Changelog](../../changelogs/11.1/mariadb-11-1-2-changelog.md) | [Overview of 11.1](what-is-mariadb-111.md)

**Release date:** 21 Aug 2023

[MariaDB 11.1](what-is-mariadb-111.md) is a current short-term stable series of MariaDB, [maintained until](https://mariadb.org/about/#maintenance-policy) August 2024. It is an evolution of [MariaDB 11.0](../11.0/what-is-mariadb-110.md) with several entirely new features.

[MariaDB 11.1.2](11.1.2.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 11.1.2](11.1.2.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/11.1/mariadb-11-1-2-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 11.1.2](11.1.2.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-2-1-11-1-2-now-available/).
