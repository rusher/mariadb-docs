...
[Download 11.1.5](https://downloads.mariadb.org/mariadb/11.1.5/) | [Release Notes](11.1.5.md) | [Changelog](../../changelogs/11.1/mariadb-11-1-5-changelog.md) | [Overview of 11.1](what-is-mariadb-111.md)

**Release date:** 16 May 2024

[MariaDB 11.1](what-is-mariadb-111.md) is a current short-term stable series of MariaDB and will be [maintained until](https://mariadb.org/about/#maintenance-policy) August 2024. It is an evolution of [MariaDB 11.0](../11.0/what-is-mariadb-110.md) with several entirely new features.

[MariaDB 11.1.5](11.1.5.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* Fix Spider: ERROR 12710 (HY000): Invalid information from remote table when using [MariaDB 10.5](../10.5/what-is-mariadb-105.md) local and [MariaDB 10.6](../../10.6/what-is-mariadb-106.md) remote ([MDEV-33777](https://jira.mariadb.org/browse/MDEV-33777))
...
* Moving from [MariaDB 10.5](../10.5/what-is-mariadb-105.md) to 10.6 mysql\_upgrade is not updating some system tables ([MDEV-33726](https://jira.mariadb.org/browse/MDEV-33726))
...
For a complete list of changes made in [MariaDB 11.1.5](11.1.5.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/11.1/mariadb-11-1-5-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 11.1.5](11.1.5.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-2-4-11-1-5-11-0-6-10-11-8-10-6-18-10-5-25-10-4-34-now-available/).
