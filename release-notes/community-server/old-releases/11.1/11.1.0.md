...
[Download](https://downloads.mariadb.org/mariadb/11.1.0) | [Release Notes](../11.0/11.0.1.md) | [Changelog](../../changelogs/11.0/mariadb-11-0-1-changelog.md) | [Overview of 11.1](what-is-mariadb-111.md)

**Release date:** 27 Mar 2023

**Do not use&#x20;**_**alpha**_**&#x20;releases in production!**

[MariaDB 11.1](what-is-mariadb-111.md) is a current development series of MariaDB, and will be maintained for one year after its Generally Available release. It is an evolution of [MariaDB 11.0](../11.0/what-is-mariadb-110.md) with several entirely new features.

[MariaDB 11.1.0](11.1.0.md) is a single preview release. Features are to be considered preview, and none are guaranteed to make it into [MariaDB 11.1](what-is-mariadb-111.md).
