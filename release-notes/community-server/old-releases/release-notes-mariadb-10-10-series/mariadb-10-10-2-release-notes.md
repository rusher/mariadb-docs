...
[Download 10.10.2](https://downloads.mariadb.org/mariadb/10.10.2/)[Release Notes](mariadb-10-10-2-release-notes.md)[Changelog](../../changelogs/10.10/10.10.2.md)[Overview of 10.10](what-is-mariadb-1010.md)

**Release date:** 17 Nov 2022

[MariaDB 10.10](what-is-mariadb-1010.md) is a current short-term series of MariaDB, [maintained until](https://mariadb.org/about/#maintenance-policy) November 2023. It is an evolution of [MariaDB 10.9](../release-notes-mariadb-10-9-series/what-is-mariadb-109.md) with several entirely new features.

[MariaDB 10.10.2](mariadb-10-10-2-release-notes.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* Minor correction in [unsafe](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/standard-replication/unsafe-statements-for-statement-based-replication) warning message ([MDEV-28827](https://jira.mariadb.org/browse/MDEV-28827))
...
information on each push, see the [changelog](../../changelogs/10.10/10.10.2.md).

## Contributors

For a full list of contributors to [MariaDB 10.10.2](mariadb-10-10-2-release-notes.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-10-1-rc-and-10-9-2-ga-now-available/).
