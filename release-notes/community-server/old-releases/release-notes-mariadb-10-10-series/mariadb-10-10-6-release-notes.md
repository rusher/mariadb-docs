...
[MariaDB 10.10.6](mariadb-10-10-6-release-notes.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* As per the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md), this will be the last release of [MariaDB 10.10](what-is-mariadb-1010.md) for Ubuntu 18.04 LTS "Bionic" and Ubuntu 22.10 "Kinetic"
