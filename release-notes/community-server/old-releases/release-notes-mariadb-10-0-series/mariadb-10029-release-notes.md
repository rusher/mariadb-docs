...
[Download](https://downloads.mariadb.org/mariadb/10.0.29) | [Release Notes](mariadb-10029-release-notes.md) | [Changelog](../../changelogs/changelogs-mariadb-100-series/mariadb-10029-changelog.md) | [Overview of 10.0](changes-improvements-in-mariadb-10-0.md)
...
* [Performance Schema](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/system-tables/performance-schema) updated to 5.6.35
...
For a complete list of changes made in [MariaDB 10.0.29](mariadb-10029-release-notes.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-100-series/mariadb-10029-changelog.md).
