...
[Download](https://downloads.mariadb.org/mariadb/10.0.3) |**Release Notes** |[Changelog](../../changelogs/changelogs-mariadb-100-series/mariadb-1003-changelog.md) |[Overview of 10.0](changes-improvements-in-mariadb-10-0.md)
...
[MariaDB 10.0.3](mariadb-1003-release-notes.md) is an [_**Alpha**_](../../about/release-criteria.md) release.\
...
This release of [MariaDB 10.0](changes-improvements-in-mariadb-10-0.md) includes repositories for the recently released Ubuntu 13.04 "Raring". These packages also support Mint 15 "Olivia".

Visit the [repository configuration tool](https://downloads.mariadb.org/mariadb/repositories/) to get started.
