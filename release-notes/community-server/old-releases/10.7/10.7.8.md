...
[Download](https://downloads.mariadb.org/mariadb/10.7.8/) | [Release Notes](10.7.8.md) | [Changelog](../../changelogs/10.7/10.7.8.md) | [Overview of 10.7](what-is-mariadb-107.md)
...
[MariaDB 10.7.8](10.7.8.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.

[MariaDB 10.7.8](10.7.8.md) is the last release of the [MariaDB 10.7](what-is-mariadb-107.md) release series.
...
For a complete list of changes made in [MariaDB 10.7.8](10.7.8.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/10.7/10.7.8.md).

## Contributors

For a full list of contributors to [MariaDB 10.7.8](10.7.8.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-10-3-10-9-5-10-8-7-10-7-8-10-6-12-10-5-19-10-4-28-and-10-3-38-now-available/).
