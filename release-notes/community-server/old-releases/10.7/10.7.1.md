...
[Download 10.7.1](https://downloads.mariadb.org/mariadb/10.7.1/) | [Release Notes](10.7.1.md) | [Changelog](../../changelogs/10.7/10.7.1.md) | [Overview of 10.7](what-is-mariadb-107.md)
...
[MariaDB 10.7.1](10.7.1.md) is a [_**Release Candidate (RC)**_](../../about/release-criteria.md) release.
...
This release includes all features from the [MariaDB 10.7.0](10.7.0.md) preview releases except for the JSON histogram preview feature, which was not ready in time to be included.
...
* The redundant PARTITION keyword is now optional in the [partition definition](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/tables/create-table#partitions) ([MDEV-26471](https://jira.mariadb.org/browse/MDEV-26471))
...
For a complete list of changes made in [MariaDB 10.7.1](10.7.1.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/10.7/10.7.1.md).

## Contributors

For a full list of contributors to [MariaDB 10.7.1](10.7.1.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-7-1-rc-and-mariadb-10-6-5-10-5-13-10-4-22-10-3-32-and-10-2-41-now-available/).
