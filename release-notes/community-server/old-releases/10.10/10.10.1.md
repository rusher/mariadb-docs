...
[Download 10.10.1](https://downloads.mariadb.org/mariadb/10.10.1/)[Release Notes](10.10.1.md)[Changelog](../../changelogs/10.10/10.10.1.md)[Overview of 10.10](what-is-mariadb-1010.md)
...
[MariaDB 10.10.1](10.10.1.md) is a [_**Release Candidate (RC)**_](../../about/release-criteria.md) release.
...
* Deprecate and ignore the parameter [innodb\_prefix\_index\_cluster\_optimization](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb/innodb-system-variables#innodb_prefix_index_cluster_optimization) ([MDEV-28540](https://jira.mariadb.org/browse/MDEV-28540))
...
For a complete list of changes made in [MariaDB 10.10.1](10.10.1.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/10.10/10.10.1.md).

## Contributors

For a full list of contributors to [MariaDB 10.10.1](10.10.1.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-10-1-rc-and-10-9-2-ga-now-available/).
