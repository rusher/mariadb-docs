...
[Download 10.10.2](https://downloads.mariadb.org/mariadb/10.10.2/)[Release Notes](10.10.2.md)[Changelog](../../changelogs/10.10/10.10.2.md)[Overview of 10.10](what-is-mariadb-1010.md)

**Release date:** 17 Nov 2022

[MariaDB 10.10](what-is-mariadb-1010.md) is a current short-term series of MariaDB, [maintained until](https://mariadb.org/about/#maintenance-policy) November 2023. It is an evolution of [MariaDB 10.9](../10.9/what-is-mariadb-109.md) with several entirely new features.

[MariaDB 10.10.2](10.10.2.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 10.10.2](10.10.2.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/10.10/10.10.2.md).

## Contributors

For a full list of contributors to [MariaDB 10.10.2](10.10.2.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-10-1-rc-and-10-9-2-ga-now-available/).
