...
[Download](https://downloads.mariadb.org/mariadb/10.10.7/)[Release Notes](10.10.7.md)[Changelog](../../changelogs/10.10/10.10.7.md)[Overview of 10.10](what-is-mariadb-1010.md)
...
of [MariaDB 10.9](../10.9/what-is-mariadb-109.md) with several entirely new features.

[MariaDB 10.10.7](10.10.7.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.

[MariaDB 10.10.7](10.10.7.md) is the last release of the [MariaDB 10.10](what-is-mariadb-1010.md) release series.
...
For a complete list of changes made in [MariaDB 10.10.7](10.10.7.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/10.10/10.10.7.md).

## Contributors

For a full list of contributors to [MariaDB 10.10.7](10.10.7.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-1-3-11-0-4-10-11-6-10-10-7-10-6-16-10-5-23-10-4-32-now-available/).
