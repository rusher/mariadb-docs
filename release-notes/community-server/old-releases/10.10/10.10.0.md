...
[Download 10.10.0](https://downloads.mariadb.org/mariadb/10.10.0)[Release Notes](10.10.0.md)[Changelog](../../changelogs/10.10/)[Overview of 10.10](what-is-mariadb-1010.md)
...
[MariaDB 10.10.0](10.10.0.md) is not a single release, but is instead a number of preview releases based on feature branches. Each should be considered [_**Alpha**_](../../about/release-criteria.md).
...
* [ALTER ONLINE TABLE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-definition/alter/alter-table#alter-online-table) ([MDEV-16329](https://jira.mariadb.org/browse/MDEV-16329) not included in [MariaDB 10.10.1](10.10.1.md)
* Atomic CREATE OR REPLACE TABLE ([MDEV-25292](https://jira.mariadb.org/browse/MDEV-25292)) (not included in [MariaDB 10.10.1](10.10.1.md))
...
For a complete list of changes made in [MariaDB 10.10.0](10.10.0.md), with links to detailed\
