...
[Download](https://downloads.mariadb.org/mariadb/10.3.15/) | [Release Notes](10.3.15.md) | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10315-changelog.md) | [Overview of 10.3](what-is-mariadb-103.md)

**Release date:** 14 May 2019

[MariaDB 10.3](what-is-mariadb-103.md) is an evolution of [MariaDB 10.2](../10.2/what-is-mariadb-102.md) with several entirely new features\
not found anywhere else and with backported and reimplemented features from\
MySQL.

[MariaDB 10.3.15](10.3.15.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* [MDEV-19054](https://jira.mariadb.org/browse/MDEV-19054) - `mysql_upgrade_service` now allows MySQL 5.7 to [MariaDB 10.2](../10.2/what-is-mariadb-102.md) upgrade
...
For a complete list of changes made in [MariaDB 10.3.15](10.3.15.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10315-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.3.15](10.3.15.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-3-15-mariadb-connector-c-3-0-10-mariadb-connector-node-js-2-0-5-and-mariadb-connector-odbc-3-1-1-now-available/).
