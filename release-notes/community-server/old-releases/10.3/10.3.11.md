...
[Download](https://downloads.mariadb.org/mariadb/10.3.11/) | [Release Notes](10.3.11.md) | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10311-changelog.md) | [Overview of 10.3](what-is-mariadb-103.md)
...
[MariaDB 10.3.11](10.3.11.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* Fixed crash on upgrade from [MariaDB 10.1](../10.1/changes-improvements-in-mariadb-10-1.md) or earlier: [MDEV-12023](https://jira.mariadb.org/browse/MDEV-12023)
...
For a complete list of changes made in [MariaDB 10.3.11](10.3.11.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10311-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.3.11](10.3.11.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-3-11-and-mariadb-connector-c-3-0-7-connector-odbc-3-0-7-and-connector-node-js-2-0-1-now-available/).
