...
[Download](https://downloads.mariadb.org/mariadb/10.3.0) | [Release Notes](10.3.0.md) | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1030-changelog.md) | [Overview of 10.3](what-is-mariadb-103.md)

**Release date:** 16 Apr 2017

[MariaDB 10.3](what-is-mariadb-103.md) is the new development series of MariaDB. It is an evolution of [MariaDB 10.2](../10.2/what-is-mariadb-102.md) with several entirely new features not found anywhere else.

[MariaDB 10.3.0](10.3.0.md) is an [_**Alpha**_](../../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 10.3.0](10.3.0.md), with links to detailed\
