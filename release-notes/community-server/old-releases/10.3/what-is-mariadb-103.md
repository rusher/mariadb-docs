...
* [INTERSECT](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/selecting-data/set-operations/intersect) and [EXCEPT](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/selecting-data/set-operations/except). These are both now [reserved words](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/sql-language-structure/reserved-words) and can no longer be used as an [identifier](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/sql-language-structure/identifier-names) without being quoted ([MDEV-10141](https://jira.mariadb.org/browse/MDEV-10141))
...
* New [sql\_mode](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/sql_mode) `SIMULTANEOUS_ASSIGNMENT` to make the SET part of the [UPDATE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/changing-deleting-data/update) statement evaluate all assignments simultaneously, not left-to-right.
...
* When running with [sql\_mode=ORACLE](../../about/compatibility-and-differences/sql_modeoracle.md), the server now understands a subset of Oracle's PL/SQL language instead of the traditional MariaDB syntax for stored routines. See [MDEV-10142](https://jira.mariadb.org/browse/MDEV-10142), [MDEV-10764](https://jira.mariadb.org/browse/MDEV-10764) and [SQL\_MODE=ORACLE From MariaDB 10.3](https://mariadb.com/docs/release-notes/compatibility-and-differences/sql_modeoracle) to know the current status.
* New [sql\_mode](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/sql_mode), EMPTY\_STRING\_IS\_NULL.
* [INTERSECT](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/selecting-data/set-operations/intersect) and [EXCEPT](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/selecting-data/set-operations/except) are both now [reserved words](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/sql-language-structure/reserved-words) and can no longer be used as an [identifier](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/sql-language-structure/identifier-names) without being quoted ([MDEV-10141](https://jira.mariadb.org/browse/MDEV-10141))
...
* The Information Schema is optimized to use much less memory when selecting from [INFORMATION\_SCHEMA.TABLES](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/system-tables/information-schema/information-schema-tables/information-schema-tables-table) or any other table with many [VARCHAR](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/data-types/string-data-types/varchar) or [TEXT](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/data-types/string-data-types/text) columns ([MDEV-14275](https://jira.mariadb.org/browse/MDEV-14275))
* The [Information Schema Columns table](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/system-tables/information-schema/information-schema-tables/information-schema-columns-table) now displays [system versioning](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/temporal-tables/system-versioned-tables) info in the EXTRA column - [MDEV-15062](https://jira.mariadb.org/browse/MDEV-15062)

### Logging

* Disable logging of certain statements to the [general log](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/server-monitoring-logs/general-query-log) or the [slow query log](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/server-monitoring-logs/slow-query-log) with the [log\_disabled\_statements](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#log_disabled_statements) and [log\_slow\_disabled\_statements](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#log_slow_disabled_statements) system variables.
* A new option to [log\_slow\_filter](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#log_slow_filter), `filsort_priority_queue`.
...
10.3 continues refactoring for the data type API started in 10.2, which will make it possible to have user data type plugins. This work is still in progress (see [MDEV-4912](https://jira.mariadb.org/browse/MDEV-4912) for the current status and subtasks). Most of the task in this category do not change the server behavior. Some tasks do have a [visible effect](10.3.0.md#data-type-api).

### Idle Transactions

Connections with idle transactions can be automatically killed after a specified time period by means of the [idle\_transaction\_timeout](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#idle_transaction_timeout), [idle\_readonly\_transaction\_timeout](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#idle_readonly_transaction_timeout) and [idle\_write\_transaction\_timeout](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#idle_write_transaction_timeout) system variables.
...
* The max value of the [max\_prepared\_stmt\_count](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#max_prepared_stmt_count) system variable has been increased from 1048576 to 4294967295
* The [proxy\_protocol\_networks](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#proxy_protocol_networks) variable can now be modified without restarting the server ([MDEV-15501](https://jira.mariadb.org/browse/MDEV-15501))
...
* [CVE-2022-27456](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27456): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27452](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27452): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27449](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27449): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27448](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27448): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27447](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27447): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27445](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27445): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27387](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27387): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27386](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27386): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27385](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27385): [MariaDB 10.3.32](10.3.32.md)
* [CVE-2022-27384](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27384): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27383](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27383): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27381](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27381): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27380](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27380): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27379](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27379): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27378](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27378): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27377](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27377): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-27376](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-27376): [MariaDB 10.3.35](10.3.35.md)
* [CVE-2022-24052](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-24052): [MariaDB 10.3.33](10.3.33.md)
* [CVE-2022-24051](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-24051): [MariaDB 10.3.33](10.3.33.md)
* [CVE-2022-24050](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022
https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-2758): [MariaDB 10.3.17](10.3.17.md)
* [CVE-2019-2740](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-2740): [MariaDB 10.3.17](10.3.17.md)
* [CVE-2019-2739](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-2739): [MariaDB 10.3.17](10.3.17.md)
* [CVE-2019-2737](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-2737): [MariaDB 10.3.17](10.3.17.md)
* [CVE-2019-2628](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-2628): [MariaDB 10.3.15](10.3.15.md)
* [CVE-2019-2627](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-2627): [MariaDB 10.3.15](10.3.15.md)
* [CVE-2019-2614](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-2614): [MariaDB 10.3.15](10.3.15.md)
* [CVE-2019-2537](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-2537): [MariaDB 10.3.13](10.3.13.md)
* [CVE-2019-2510](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-2510): [MariaDB 10.3.13](10.3.13.md)
* [CVE-2019-2503](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2019-2503): [MariaDB 10.3.10](10.3.10.md)
* [CVE-2018-3284](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3284): [MariaDB 10.3.11](10.3.11.md)
* [CVE-2018-3282](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3282): [MariaDB 10.3.11](10.3.11.md)
* [CVE-2018-3277](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3277): [MariaDB 10.3.11](10.3.11.md)
* [CVE-2018-3251](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3251): [MariaDB 10.3.11](10.3.11.md)
* [CVE-2018-3200](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3200): [MariaDB 10.3.11](10.3.11.md)
* [CVE-2018-3185](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3185): [MariaDB 10.3.11](10.3.11.md)
* [CVE-2018-3174](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3174): [MariaDB 10.3.11](10.3.11.md)
* [CVE-2018-3173](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3173): [MariaDB 10.3.11](10.3.11.md)
* [CVE-2018-3162](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3162): [MariaDB 10.3.11](10.3.11.md)
* [CVE-2018-3156](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3156): [MariaDB 10.3.11](10.3.11.md)
* [CVE-2018-3143](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3143): [MariaDB 10.3.11](10.3.11.md)
* [CVE-2018-3066](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3066): [MariaDB 10.3.9](10.3.9.md)
* [CVE-2018-3064](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-3064): [MariaDB 10.3.9](10.3.9.md)
...
* [System Variable Differences Between MariaDB 10.3 and MySQL 8.0](../../about/compatibility-and-differences/system-variable-differences-between-mariadb-and-mysql/system-variable-differences-between-mariadb-and-mysql-unmaintained-series/system-variable-differences-between-mariadb-10-3-and-mysql-8-0.md)
* [Function Differences Between MariaDB 10.3 and MySQL 8.0](../../about/compatibility-and-differences/function-differences-between-mariadb-and-mysql/function-differences-between-mariadb-and-mysql-unmaintained-series/function-differences-between-mariadb-10-3-and-mysql-8-0.md)
* [System Variable Differences Between MariaDB 10.3 and MySQL 5.7](../../about/compatibility-and-differences/system-variable-differences-between-mariadb-and-mysql/system-variable-differences-between-mariadb-and-mysql-unmaintained-series/system-variable-differences-between-mariadb-10-3-and-mysql-5-7.md)
* [Function Differences Between MariaDB 10.3 and MySQL 5.7](../../about/compatibility-and-differences/function-differences-between-mariadb-and-mysql/function-differences-between-mariadb-and-mysql-unmaintained-series/function-differences-between-mariadb-103-and-mysql-57.md)
...
| 8 Nov 2021  | [MariaDB 10.3.32](10.3.32.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.32.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10332-changelog.md)   |
| 6 Aug 2021  | [MariaDB 10.3.31](10.3.31.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.31.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10331-changelog.md)   |
| 23 Jun 2021 | [MariaDB 10.3.30](10.3.30.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.30.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10330-changelog.md)   |
| 7 May 2021  | [MariaDB 10.3.29](10.3.29.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.29.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10329-changelog.md)   |
| 22 Feb 2021 | [MariaDB 10.3.28](10.3.28.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.28.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10328-changelog.md)   |
| 11 Nov 2020 | [MariaDB 10.3.27](10.3.27.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.27.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10327-changelog.md)   |
| 3 Nov 2020  | [MariaDB 10.3.26](10.3.26.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.26.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10326-changelog.md)   |
| 7 Oct 2020  | [MariaDB 10.3.25](10.3.25.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.25.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10325-changelog.md)   |
| 10 Aug 2020 | [MariaDB 10.3.24](10.3.24.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.24.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10324-changelog.md)   |
| 12 May 2020 | [MariaDB 10.3.23](10.3.23.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.23.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10323-changelog.md)   |
| 28 Jan 2020 | [MariaDB 10.3.22](10.3.22.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.22.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10322-changelog.md)   |
| 11 Dec 2019 | [MariaDB 10.3.21](10.3.21.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.21.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10321-changelog.md)   |
| 8 Nov 2019  | [MariaDB 10.3.20](10.3.20.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.20.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10320-changelog.md)   |
| 5 Nov 2019  | [MariaDB 10.3.19](10.3.19.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.19.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10319-changelog.md)   |
| 11 Sep 2019 | [MariaDB 10.3.18](10.3.18.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.18.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10318-changelog.md)   |
| 31 Jul 2019 | [MariaDB 10.3.17](10.3.17.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.17.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10317-changelog.md)   |
| 17 Jun 2019 | [MariaDB 10.3.16](10.3.16.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.16.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10316-changelog.md)   |
| 14 May 2019 | [MariaDB 10.3.15](10.3.15.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.15.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10315-changelog.md)   |
| 2 Apr 2019  | [MariaDB 10.3.14](10.3.14.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.14.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10314-changelog.md)   |
| 21 Feb 2019 | [MariaDB 10.3.13](10.3.13.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.13.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10313-changelog.md)   |
| 7 Jan 2019  | [MariaDB 10.3.12](10.3.12.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.12.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10312-changelog.md)   |
| 20 Nov 2018 | [MariaDB 10.3.11](10.3.11.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.11.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10311-changelog.md)   |
| 4 Oct 2018  | [MariaDB 10.3.10](10.3.10.md)                                                                                                                                                 | Stable (GA)            | [Release Notes](10.3.10.md)                                                                                                                                               | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10310-changelog.md)   |
| 15 Aug 2018 | [MariaDB 10.3.9](10.3.9.md)                                                                                                                                                   | Stable (GA)            | [Release Notes](10.3.9.md)                                                                                                                                                | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1039-changelog.md)    |
| 2 Jul 2018  | [MariaDB 10.3.8](10.3.8.md)                                                                                                                                                   | Stable (GA)            | [Release Notes](10.3.8.md)                                                                                                                                                | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1038-changelog.md)    |
| 25 May 2018 | [MariaDB 10.3.7](10.3.7.md)                                                                                                                                                   | Stable (GA)            | [Release Notes](10.3.7.md)                                                                                                                                                | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1037-changelog.md)    |
| 16 Apr 2018 | [MariaDB 10.3.6](10.3.6.md)                                                                                                                                                   | Release Candidate (RC) | [Release Notes](10.3.6.md)                                                                                                                                                | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1036-changelog.md)    |
| 26 Feb 2018 | [MariaDB 10.3.5](10.3.5.md)                                                                                                                                                   | Release Candidate (RC) | [Release Notes](10.3.5.md)                                                                                                                                                | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1035-changelog.md)    |
| 18 Jan 2018 | [MariaDB 10.3.4](10.3.4.md)                                                                                                                                                   | Beta                   | [Release Notes](10.3.4.md)                                                                                                                                                | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1034-changelog.md)    |
| 23 Dec 2017 | [MariaDB 10.3.3](10.3.3.md)                                                                                                                                                   | Beta                   | [Release Notes](10.3.3.md)                                                                                                                                                | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1033-changelog.md)    |
| 9 Oct 2017  | [MariaDB 10.3.2](10.3.2.md)                                                                                                                                                   | Alpha                  | [Release Notes](10.3.2.md)                                                                                                                                                | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1032-changelog.md)    |
| 29 Aug 2017 | [MariaDB 10.3.1](10.3.1.md)                                                                                                                                                   | Alpha                  | [Release Notes](10.3.1.md)                                                                                                                                                | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1031-changelog.md)    |
| 16 Apr 2017 | [MariaDB 10.3.0](10.3.0.md)                                                                                                                                                   | Alpha                  | [Release Notes](10.3.0.md)                                                                                                                                                | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1030-changelog.md)    |
