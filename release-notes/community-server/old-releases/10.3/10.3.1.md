...
[Download](https://downloads.mariadb.org/mariadb/10.3.1) | [Release Notes](10.3.1.md) | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1031-changelog.md) | [Overview of 10.3](what-is-mariadb-103.md)
...
[MariaDB 10.3.1](10.3.1.md) is an [_**Alpha**_](../../about/release-criteria.md) release.
...
* A new option to [log\_slow\_filter](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#log_slow_filter), `filsort_priority_queue` (renamed to `filesort_priority_queue` in [MariaDB 10.3.2](10.3.2.md)).
...
For a complete list of changes made in [MariaDB 10.3.1](10.3.1.md), with links to detailed\
