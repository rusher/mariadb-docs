...
[Download](https://downloads.mariadb.org/mariadb/10.3.12/) | [Release Notes](10.3.12.md) | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10312-changelog.md) | [Overview of 10.3](what-is-mariadb-103.md)
...
[MariaDB 10.3.12](10.3.12.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* Fixes for regressions introduced in [MariaDB 10.3.10](10.3.10.md) by the backup-safe TRUNCATE TABLE ([MDEV-13564](https://jira.mariadb.org/browse/MDEV-13564), innodb\_safe\_truncate=ON) and innodb\_undo\_log\_truncate:
...
For a complete list of changes made in [MariaDB 10.3.12](10.3.12.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-10312-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.3.12](10.3.12.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-3-12-and-mariadb-connector-c-3-0-8-now-available/).
