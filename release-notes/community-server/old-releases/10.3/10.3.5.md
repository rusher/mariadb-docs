...
[Download](https://downloads.mariadb.org/mariadb/10.3.5/) | [Release Notes](10.3.5.md) | [Changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1035-changelog.md) | [Overview of 10.3](what-is-mariadb-103.md)
...
[MariaDB 10.3.5](10.3.5.md) is a [_**RC**_](../../about/release-criteria.md) release.
...
[MariaDB 10.3.5](10.3.5.md) includes all bug fixes from [MariaDB 10.2.13](../10.2/10.2.13.md), including the following:
...
For a complete list of changes made in [MariaDB 10.3.5](10.3.5.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-10-3-series/mariadb-1035-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.3.5](10.3.5.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-3-5-mariadb-connector-j-2-2-2-1-7-2-now-available/).
