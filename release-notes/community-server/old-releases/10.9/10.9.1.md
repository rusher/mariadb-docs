...
[Download 10.9.1](https://downloads.mariadb.org/mariadb/10.9.1) | [Release Notes](10.9.1.md) | [Changelog](../../changelogs/10.9/10.9.1.md) | [Overview of 10.9](what-is-mariadb-109.md)
...
[MariaDB 10.9.1](10.9.1.md) is a [_**Release Candidate (RC)**_](../../about/release-criteria.md) release.
...
* As per the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md), this will be the last release of [MariaDB 10.5](../10.5/what-is-mariadb-105.md) for Debian 9 "Stretch", Ubuntu 21.10 "Impish", and Fedora 34
...
For a complete list of changes made in [MariaDB 10.9.1](10.9.1.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/10.9/10.9.1.md).

## Contributors

For a full list of contributors to [MariaDB 10.9.1](10.9.1.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-9-1-10-8-3-10-7-4-10-6-8-10-5-16-10-4-25-10-3-35-and-10-2-44-now-available/).
