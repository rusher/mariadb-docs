...
[Download 10.9.2](https://downloads.mariadb.org/mariadb/10.9.2/) | [Release Notes](10.9.2.md) | [Changelog](../../changelogs/10.9/10.9.2.md) | [Overview of 10.9](what-is-mariadb-109.md)
...
of [MariaDB 10.8](../10.8/what-is-mariadb-108.md) with several entirely new features.

[MariaDB 10.9.2](10.9.2.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* Range optimizer regression for key IN (const, ....) ([MDEV-25020](https://jira.mariadb.org/browse/MDEV-25020))
  * The issue can be observed on [MariaDB 10.5.9](../10.5/10.5.9.md) and later versions which have the fix for [MDEV-9750](https://jira.mariadb.org/browse/MDEV-9750). That fix introduceds optimizer\_max\_sel\_arg\_weight.
...
* The [Spider](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/storage-engines/spider) version number now matches the server version (and the [spider\_version](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/spider/spider-system-variables) system variable removed) ([MDEV-26282](https://jira.mariadb.org/browse/MDEV-26282))
* [spider\_init\_sql\_alloc\_size](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/spider/spider-system-variables) and [spider\_buffer\_size](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/spider/spider-system-variables) have been deprecated ([MDEV-27926](https://jira.mariadb.org/browse/MDEV-27926), [MDEV-28560](https://jira.mariadb.org/browse/MDEV-28560))
...
* [CONNECT Engine](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/storage-engines/connect) now supports [INSERT IGNORE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/data-manipulation/inserting-loading-data/insert-ignore) with [Mysql Table type](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/connect/connect-table-types/connect-mysql-table-type-accessing-mysqlmariadb-tables) ([MDEV-27766](https://jira.mariadb.org/browse/MDEV-27766))
...
For a complete list of changes made in [MariaDB 10.9.2](10.9.2.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/10.9/10.9.2.md).

## Contributors

For a full list of contributors to [MariaDB 10.9.2](10.9.2.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-10-1-rc-and-10-9-2-ga-now-available/).
