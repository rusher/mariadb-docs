...
[Download](https://downloads.mariadb.org/mariadb/10.9.5) | [Release Notes](10.9.5.md) | [Changelog](../../changelogs/10.9/10.9.5.md) | [Overview of 10.9](what-is-mariadb-109.md)

**Release date:** 6 Feb 2023

[MariaDB 10.9](what-is-mariadb-109.md) is the current short-term maintenance stable series of MariaDB, maintained until August 2023. It is an evolution of [MariaDB 10.8](../10.8/what-is-mariadb-108.md) with several entirely new features.

[MariaDB 10.9.5](10.9.5.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 10.9.5](10.9.5.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/10.9/10.9.5.md).

## Contributors

For a full list of contributors to [MariaDB 10.9.5](10.9.5.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-10-3-10-9-5-10-8-7-10-7-8-10-6-12-10-5-19-10-4-28-and-10-3-38-now-available/).
