...
[MariaDB 10.9.0](10.9.0.md) is not a single release, but is instead a number of preview releases based on feature branches. Each should be considered [_**Alpha**_](../../about/release-criteria.md).\
...
* Asynchronous [redo log](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb/innodb-redo-log) write ([MDEV-26603](https://jira.mariadb.org/browse/MDEV-26603)) (not included in [MariaDB 10.9.1](10.9.1.md))
...
* [information\_schema.tables.table\_type](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/system-tables/information-schema/information-schema-tables/information-schema-tables-table) now shows TEMPORARY for local temporary tables ([MDEV-12459](https://jira.mariadb.org/browse/MDEV-12459)) (not included in [MariaDB 10.9.1](10.9.1.md))
