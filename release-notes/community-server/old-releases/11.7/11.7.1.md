...
<a href="https://downloads.mariadb.org/mariadb/11.7.1/" class="button primary">Download</a> <a href="11.7.1.md" class="button secondary">Release Notes</a> <a href="../../changelogs/11.7/mariadb-11-7-1-changelog.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-117.md" class="button secondary">Overview of 11.7</a>

**Release date:** 21 Nov 2024

{% include "../../../.gitbook/includes/non-stable.md" %}

[MariaDB 11.7](what-is-mariadb-117.md) is a [rolling release](../../about/release-model.md). It is an evolution of [MariaDB 11.6](../11.6/what-is-mariadb-116.md) with several entirely new features.

[MariaDB 11.7.1](11.7.1.md) is a [_**Release Candidate (RC)**_](../../about/release-criteria.md) release.
...
* [Vectors](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-structure/vectors) are a feature that allow MariaDB Server to perform as a relational vector database. Previously available in the special [Vector preview release](../11.6/11.6.0-vector.md), it has now been added to MariaDB Community Server 11.7.1 with various enhancements ([MDEV-34939](https://jira.mariadb.org/browse/MDEV-34939))
...
For a complete list of changes made in [MariaDB 11.7.1](11.7.1.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/11.7/mariadb-11-7-1-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 11.7.1](11.7.1.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-6-2-and-mariadb-11-7-1-now-available/).
