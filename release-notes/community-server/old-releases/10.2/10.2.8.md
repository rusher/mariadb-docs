...
[Download](https://downloads.mariadb.org/mariadb/10.2.8) | [Release Notes](10.2.8.md) | [Changelog](../../changelogs/changelogs-mariadb-102-series/mariadb-1028-changelog.md) | [Overview of 10.2](what-is-mariadb-102.md)
...
[MariaDB 10.2.8](10.2.8.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* [mariadb-backup](https://mariadb.com/docs/server/server-usage/backup-and-restore/mariadb-backup) now included for Debian and Ubuntu (in [MariaDB 10.2.7](10.2.7.md) it was released only for Red Hat, CentOS, and Fedora)
...
For a complete list of changes made in [MariaDB 10.2.8](10.2.8.md), with links to detailed\
