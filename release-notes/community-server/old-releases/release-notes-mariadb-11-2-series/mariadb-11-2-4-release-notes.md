...
[MariaDB 11.2](what-is-mariadb-112.md) is a current short-term stable series of MariaDB and will be [maintained until](https://mariadb.org/about/#maintenance-policy) October 2024. It is an evolution of [MariaDB 11.1](../release-notes-mariadb-11-1-series/what-is-mariadb-111.md) with several entirely new features.

[MariaDB 11.2.4](mariadb-11-2-4-release-notes.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* Fix crash in mariadb-backup --prepare --export after `--prepare` ([MDEV-33023](https://jira.mariadb.org/browse/MDEV-33023))
...
For a full list of contributors to [MariaDB 11.2.4](mariadb-11-2-4-release-notes.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-2-4-11-1-5-11-0-6-10-11-8-10-6-18-10-5-25-10-4-34-now-available/).
