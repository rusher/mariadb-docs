...
[MariaDB 10.2.2](mariadb-1022-release-notes.md) is a [_**Beta**_](../../about/release-criteria.md) release.
...
* Optimizer improvement: conditions can be [pushed down into non-mergeable views/derived tables](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#optimizer_switch) ([MDEV-9197](https://jira.mariadb.org/browse/MDEV-9197))
