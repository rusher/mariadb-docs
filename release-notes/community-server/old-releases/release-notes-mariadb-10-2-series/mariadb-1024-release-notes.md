...
[MariaDB 10.2.4](mariadb-1024-release-notes.md) is a [_**Release Candidate**_](../../about/release-criteria.md) _**(RC)**_ release.
...
* As per the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md), this will be the last release of [MariaDB 10.2](what-is-mariadb-102.md) for Ubuntu 12.04 "precise", Fedora 23, and openSUSE 13
