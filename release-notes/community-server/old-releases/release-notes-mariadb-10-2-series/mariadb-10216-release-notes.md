...
[MariaDB 10.2.16](mariadb-10216-release-notes.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* [MyRocks](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/myrocks) is now [Stable (GA)](../../about/release-criteria.md)
