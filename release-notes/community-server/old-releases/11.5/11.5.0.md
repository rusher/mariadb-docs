...
<a href="https://downloads.mariadb.org/mariadb/11.5.0/" class="button primary">Download</a> <a href="11.5.0.md" class="button secondary">Release Notes</a> <a href="what-is-mariadb-115.md" class="button secondary">Overview of 11.5</a>
...
[MariaDB 11.5.0](11.5.0.md) is a single preview release. Features are to be considered preview, and none are guaranteed to make it into [MariaDB 11.5](what-is-mariadb-115.md).
