...
[Download](https://downloads.mariadb.org/mariadb/11.2.6/) | [Release Notes](11.2.6.md) | [Changelog](../../changelogs/11.2/mariadb-11-2-6-changelog.md) | [Overview of 11.2](what-is-mariadb-112.md)

[_Alternate download from mariadb.org_](https://downloads.mariadb.org/mariadb/11.2.6/)

**Release date:** 1 Nov 2024

[MariaDB 11.2](what-is-mariadb-112.md) is a short-term stable series of MariaDB and will be [maintained until](https://mariadb.org/about/#maintenance-policy) October 2024. It is an evolution of [MariaDB 11.1](../11.1/what-is-mariadb-111.md) with several entirely new features.

[MariaDB 11.2.6](11.2.6.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.

[MariaDB 11.2.6](11.2.6.md) is the last release of the [MariaDB 11.2](what-is-mariadb-112.md) release series.
...
For a complete list of changes made in [MariaDB 11.2.6](11.2.6.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/11.2/mariadb-11-2-6-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 11.2.6](11.2.6.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-4-4-11-2-6-10-11-10-10-6-20-and-10-5-27-now-available/).
