...
[MariaDB 10.0](changes-improvements-in-mariadb-10-0.md) is the current development version of MariaDB. It is built on thethe [MariaDB 5.5 serie](../5.5/changes-improvements-in-mariadb-5-5.md) with backported features from MySQL\
5.6 and entirely new features not found anywhere else.

[MariaDB 10.0.2](10.0.2.md) is an [_**Alpha**_](../../about/release-criteria.md) release.\
...
For a list of changes made in [MariaDB 10.0.2](10.0.2.md), with links to detailed\
...
## New Features in [MariaDB 10.0.2](10.0.2.md) Alpha
...
* [MDEV-4022](https://jira.mariadb.org/browse/MDEV-4022) - [table attributes](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/product-development/plugin-development/storage-engines-storage-engine-development/engine-defined-new-tablefieldindex-attributes) with sysvar as a default value.
