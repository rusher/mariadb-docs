...
[MariaDB 10.0.9](10.0.9.md) is an [_**RC**_](../../about/release-criteria.md) (_Release Candidate_)\
...
[MariaDB 10.0.9](10.0.9.md) is primarily a bug-fix and polishing release.
...
* [Extended-keys optimization ](/broken/spaces/WCInJQ9cmGjq1lsTG91E/pages/hQ8119jaKVqgAcnaABXn)is now enabled by default.
...
For a complete list of changes made in [MariaDB 10.0.9](10.0.9.md), with links to detailed\
