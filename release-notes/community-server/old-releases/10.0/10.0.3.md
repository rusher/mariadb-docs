...
[MariaDB 10.0](changes-improvements-in-mariadb-10-0.md) is the current development version of MariaDB. It is built on the [MariaDB 5.5 series](../5.5/changes-improvements-in-mariadb-5-5.md) with backported and reimplemented\
features from MySQL 5.6 and entirely new features not found anywhere else.

[MariaDB 10.0.3](10.0.3.md) is an [_**Alpha**_](../../about/release-criteria.md) release.\
...
For a list of changes made in [MariaDB 10.0.3](10.0.3.md), with links to detailed\
...
The [MariaDB 10.0](changes-improvements-in-mariadb-10-0.md) series builds off of the [MariaDB 5.5](../5.5/changes-improvements-in-mariadb-5-5.md) series. It also includes\
