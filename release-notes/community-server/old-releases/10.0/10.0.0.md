...
[MariaDB 10.0](changes-improvements-in-mariadb-10-0.md) is the development version of MariaDB. It is built on the [MariaDB 5.5 series](../5.5/changes-improvements-in-mariadb-5-5.md) with backported features from MySQL 5.6\
and entirely new features not found anywhere else.

[MariaDB 10.0.0](10.0.0.md) is an [_**Alpha**_](../../about/release-criteria.md) release.\
...
For a list of changes made in [MariaDB 10.0.0](10.0.0.md), with links to detailed\
...
## New Features in [MariaDB 10.0.0](10.0.0.md) Alpha
