...
[Download](https://downloads.mariadb.org/mariadb/10.0.12) | [Release Notes](10.0.12.md) | [Changelog](../../changelogs/changelogs-mariadb-100-series/mariadb-10012-changelog.md) | [Overview of 10.0](changes-improvements-in-mariadb-10-0.md)
...
the [MariaDB 5.5](../5.5/changes-improvements-in-mariadb-5-5.md) series with several entirely new features not found anywhere else and\
with backported and reimplemented features from MySQL 5.6.

[MariaDB 10.0.12](10.0.12.md) is a [_**Stable**_](../../about/release-criteria.md) (_GA_) release.
...
[MariaDB 10.0.12](10.0.12.md) is primarily a bug-fix release.
...
For a complete list of changes made in [MariaDB 10.0.12](10.0.12.md), with links to detailed\
