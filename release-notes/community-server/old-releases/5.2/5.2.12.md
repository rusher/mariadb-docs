...
[MariaDB 5.2.12](5.2.12.md) is a [_**Stable**_](../../about/release-criteria.md) _**(GA)**_ release. In\
...
For a list of changes made in [MariaDB 5.2.12](5.2.12.md), with links to detailed\
...
[MariaDB 5.2.12](5.2.12.md) fixes a bug that under certain rare circumstances allowed a user\
...
## Includes [MariaDB 5.1.62](../5.1/5.1.62.md) and MySQL 5.1.62

This version of MariaDB includes [MariaDB 5.1.62](../5.1/5.1.62.md), and by extension, MySQL\
5.1.62. See the [MariaDB 5.1.62 Release Notes](../5.1/5.1.62.md) for\
the changes made in [MariaDB 5.1.62](../5.1/5.1.62.md) and see [Changes in MySQL 5.1.62](https://dev.mysql.com/doc/refman/5.1/en/news-5-1-62.html)\
