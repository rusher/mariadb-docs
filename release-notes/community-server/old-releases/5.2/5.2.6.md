...
[MariaDB 5.2.6](5.2.6.md) is a [Stable release](../../about/release-criteria.md). In general this means there are no known serious bugs and we believe the code is ready for general usage. A "stable" MariaDB release is equivalent to a MySQL "GA" release.

For a high-level description of [MariaDB 5.2.6](5.2.6.md) see the [What is MariaDB 5.2](changes-improvements-in-mariadb-5-2.md) page.

For a list of every change made in [MariaDB 5.2.6](5.2.6.md), including the various bugs\
...
[MariaDB 5.2.6](5.2.6.md) contains the following changes:
...
5.1.54-12.5 (the version of XtraDB included in [MariaDB 5.2.5](5.2.5.md)).
