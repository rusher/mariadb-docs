...
See the [MariaDB versus MySQL](https://mariadb.com/docs/release-notes/compatibility-and-differences/mariadb-vs-mysql-compatibility) page for a high-level overview of the differences between MariaDB and MySQL. For a description of this release see the [MariaDB 5.1 overview](../5.1/changes-improvements-in-mariadb-5-1.md).
...
* Storage engines can now allow the user to specify additional attributes per\
  ...
  introduces. See: [Extending CREATE TABLE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/product-development/plugin-development/storage-engines-storage-engine-development/engine-defined-new-tablefieldindex-attributes) for more\
  information.
