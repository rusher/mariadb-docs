...
[MariaDB 5.2.9](5.2.9.md) is a [Stable release](../../about/release-criteria.md).In general this means\
...
Compared to [MariaDB 5.2.8](5.2.8.md), [MariaDB 5.2.9](5.2.9.md) is a\
bug-fix release.

For a list of every change made in [MariaDB 5.2.9](5.2.9.md), with links to detailed\
...
We've updated the Ubuntu packages for [MariaDB 5.2.9](5.2.9.md). Apart from now including\
