...
## Includes [MariaDB 5.1.67](../5.1/5.1.67.md) and MySQL 5.1.67

This release includes [MariaDB 5.1.67](../5.1/5.1.67.md) and (by extension) MySQL 5.1.67. See [Changes in MySQL 5.1.67](https://dev.mysql.com/doc/relnotes/mysql/5.1/en/news-5-1-67.html)\
