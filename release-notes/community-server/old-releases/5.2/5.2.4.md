...
## Includes [MariaDB 5.1.53](../5.1/5.1.53.md)

[MariaDB 5.2.4](5.2.4.md) has all changes from [MariaDB 5.1.53](../5.1/5.1.53.md), including MySQL 5.1.53.
...
Like [previous releases](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/release-notes/README.md), [MariaDB 5.2.4](5.2.4.md) includes several bug\
fixes and other improvements. Specific bugs fixed in [MariaDB 5.2.4](5.2.4.md) include:
