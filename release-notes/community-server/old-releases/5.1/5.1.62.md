...
[MariaDB 5.1.62](5.1.62.md) is a [_**Stable**_](../../about/release-criteria.md) _**(GA)**_ release. In\
...
For a list of changes made in [MariaDB 5.1.62](5.1.62.md), with links to detailed\
...
[MariaDB 5.1.62](5.1.62.md) fixes a bug that under certain rare circumstances allowed a user to\
