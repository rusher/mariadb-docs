...
For [MariaDB 5.1.42](5.1.42.md) we have merged in all of the upstream changes from\
...
included with [MariaDB 5.1.41](5.1.41.md) RC).
...
Like we did with our previous releases, various additional changes were made in [MariaDB 5.1.42](5.1.42.md) in our desire to fix warnings and eliminate bugs.

In [MariaDB 5.1.42](5.1.42.md) these included fixing a bug where one connection didn't see\
