...
[Download](https://downloads.askmonty.org/mariadb/5.1.55) | **Release Notes** | [Changelog](changes-improvements-in-mariadb-5-1.md) |[Overview of 5.1](changes-improvements-in-mariadb-5-1.md)
...
For a list of every change made in [MariaDB 5.1.55](5.1.55.md), see the [Changelog](changes-improvements-in-mariadb-5-1.md). For a high-level description of [MariaDB 5.1](changes-improvements-in-mariadb-5-1.md) see the [MariaDB 5.1 overview](changes-improvements-in-mariadb-5-1.md).
...
For [MariaDB 5.1.55](5.1.55.md) we have merged in all of the upstream changes from MySQL\
...
Like [previous releases](../../../README.md), [MariaDB 5.1.55](5.1.55.md) includes several bug\
fixes and other improvements. Specific bugs fixed in [MariaDB 5.1.55](5.1.55.md) include:
