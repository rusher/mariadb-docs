...
For [MariaDB 5.1.44](5.1.44.md) we have merged in all of the upstream changes from MySQL\
...
While preparing for [MariaDB 5.1.44](5.1.44.md) we were made aware of a performance problem\
...
Like we did with our previous releases, various improvements were made in [MariaDB 5.1.44](5.1.44.md) in our desire to fix warnings and eliminate bugs.

In [MariaDB 5.1.44](5.1.44.md) these included a fix for [Bug #534626](https://bugs.launchpad.net/bugs/534626): "MyISAM table\
...
We have continued to improve our test suite in [MariaDB 5.1.44](5.1.44.md) to cover\
