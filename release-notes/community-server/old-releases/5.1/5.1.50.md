...
For [MariaDB 5.1.50](5.1.50.md) we have merged in all of the upstream changes from MySQL\
...
Like [previous releases](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/release-notes/README.md), [MariaDB 5.1.50](5.1.50.md) includes several bug fixes and other improvements. Specific bugs fixed in [MariaDB 5.1.50](5.1.50.md) include:
