...
For [MariaDB 5.1.47](5.1.47.md) we have merged in all of the upstream changes from MySQL\
...
version included since [MariaDB 5.1.42](5.1.42.md)).
...
See [xtstat](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/clients-and-utilities/legacy-clients-and-utilities/xtstat) for information on this utility.

## Windows build improvements

Several steps were taken during the development of [MariaDB 5.1.47](5.1.47.md) to improve\
...
A few Ubuntu-specific fixes are included with [MariaDB 5.1.47](5.1.47.md):
...
In [MariaDB 5.1.47](5.1.47.md) we've continued to fix bugs and compiler warnings, including\
