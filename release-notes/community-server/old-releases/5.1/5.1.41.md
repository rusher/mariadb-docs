...
In addition to the differences noted in the MariaDB [5.1.38](5.1.38.md) and [5.1.39](5.1.39.md) release notes, the main differences between MariaDB and MySQL are:

## Includes MySQL 5.1.41

For [MariaDB 5.1.41](5.1.41.md) we have merged in all of the upstream changes from MySQL 5.1.41. The [MySQL 5.1.41 release notes](https://dev.mysql.com/doc/refman/5.1/en/news-5-1-41.html) have details of what changes were made upstream by MySQL since 5.1.39
...
included with [MariaDB 5.1.38](5.1.38.md) Beta).
...
Release notes since the RC2 version in [MariaDB 5.1.39](5.1.39.md) Beta are as follows:
...
Like we did with the 5.1.39 Beta, various changes were made in [MariaDB 5.1.41](5.1.41.md) RC in our desire to fix warnings and eliminate bugs. These included removing or fixing invalid tests, cleaning up the codebase where appropriate, and so on.

## About Our Builds

We are working on setting up a [BuildBot](/broken/spaces/WCInJQ9cmGjq1lsTG91E/pages/YDeiIobaziVWZCxk4IlA) network which will enable\
