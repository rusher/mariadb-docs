...
[Download](https://downloads.askmonty.org/mariadb/5.1.66) |**Release Notes** |[Changelog](changes-improvements-in-mariadb-5-1.md) **Release date:** 29 Nov 2012
...
For a list of changes made in [MariaDB 5.1.66](5.1.66.md), with links to detailed information on each push, see the [MariaDB 5.1.66 Changelog](../../changelogs/changelogs-mariadb-51-series/mariadb-5166-changelog.md).
