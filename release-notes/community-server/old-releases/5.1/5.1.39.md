...
In addition to the differences noted in the [MariaDB 5.1.38 Release Notes](5.1.38.md), the main\
differences between MariaDB and MySQL are:

### Includes MySQL 5.1.39

For [MariaDB 5.1.39](5.1.39.md) we have merged in all of the upstream changes from MySQL\
...
included with [MariaDB 5.1.38](5.1.38.md)).
...
Various changes were made in [MariaDB 5.1.39](5.1.39.md) in our desire to fix warnings and\
...
For [MariaDB 5.1.39](5.1.39.md) we have continued our work on improving the test suite. One\
...
For [MariaDB 5.1.39](5.1.39.md) we switched from using Ubuntu 9.04 and glibc 2.9 for our\
