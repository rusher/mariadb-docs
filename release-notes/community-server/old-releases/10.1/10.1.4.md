...
[Download](https://downloads.mariadb.org/mariadb/10.1.4) | [Release Notes](10.1.4.md) | [Changelog](../../changelogs/changelogs-mariadb-101-series/mariadb-10-1-4-changelog.md) | [Overview of 10.1](changes-improvements-in-mariadb-10-1.md)
...
[MariaDB 10.1.4](10.1.4.md) is a [_**Beta**_](../../about/release-criteria.md) release.
...
* Lots of changes related to encryption. See the [updated documentation](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/security/encryption/data-at-rest-encryption/data-at-rest-encryption-overview). In particular:
...
* Command-line option `innodb-scrub-log-interval` was renamed to [innodb-scrub-log-speed](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb/innodb-system-variables) and now sets the log scrubbing speed in bytes per second.
...
For a complete list of changes made in [MariaDB 10.1.4](10.1.4.md), with links to detailed\
