...
[Download](https://downloads.mariadb.org/mariadb/10.1.8) | [Release Notes](10.1.8.md) | [Changelog](../../changelogs/changelogs-mariadb-101-series/mariadb-10-1-8-changelog.md) | [Overview of 10.1](changes-improvements-in-mariadb-10-1.md)
...
[MariaDB 10.1.8](10.1.8.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* For [CSV](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/csv) tables, the [IETF\_QUOTES](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/tables/create-table#ietf_quotes) option\
...
For a complete list of changes made in [MariaDB 10.1.8](10.1.8.md), with links to detailed\
