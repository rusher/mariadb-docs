...
A regression was discovered after the release of [MariaDB 10.1.27](10.1.27.md). It has been pulled from the downloads system, but some mirrors may still have it. **Do not download or install this version.** Stay with [MariaDB 10.1.26](10.1.26.md) until 10.1.28 is released.

[Download](https://downloads.mariadb.org/mariadb/10.1.27) | [Release Notes](10.1.27.md) | [Changelog](../../changelogs/changelogs-mariadb-101-series/mariadb-10127-changelog.md) | [Overview of 10.1](changes-improvements-in-mariadb-10-1.md)
...
[MariaDB 10.1.27](10.1.27.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 10.1.27](10.1.27.md), with links to detailed\
