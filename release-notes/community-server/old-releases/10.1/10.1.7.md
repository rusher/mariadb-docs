...
[Download](https://downloads.mariadb.org/mariadb/10.1.7) | [Release Notes](10.1.7.md) | [Changelog](../../changelogs/changelogs-mariadb-101-series/mariadb-10-1-7-changelog.md) | [Overview of 10.1](changes-improvements-in-mariadb-10-1.md)
...
[MariaDB 10.1.7](10.1.7.md) is a [_**Release Candidate**_](../../about/release-criteria.md) _**(RC)**_ release.
...
* MariaDB can now also encrypt [binary logs](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/server-monitoring-logs/binary-log) (including relay\
  logs). To enable binary logs [encryption](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/security/encryption/data-at-rest-encryption/data-at-rest-encryption-overview) make sure\
...
At the moment only the [back-log](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#back_log) and [host-cache-size](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#host_cache_size) options support this prefix.

* Fixes for the following [security vulnerabilities](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/security/cve):
  * CVE-\`-\`\`\`

For a complete list of changes made in [MariaDB 10.1.7](10.1.7.md), with links to detailed\
