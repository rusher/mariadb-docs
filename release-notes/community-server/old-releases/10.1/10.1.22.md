...
[Download](https://downloads.mariadb.org/mariadb/10.1.22) | [Release Notes](10.1.22.md) | [Changelog](../../changelogs/changelogs-mariadb-101-series/mariadb-10122-changelog.md) | [Overview of 10.1](changes-improvements-in-mariadb-10-1.md)
...
[MariaDB 10.1.22](10.1.22.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
Updating from [MariaDB 10.1.21](10.1.21.md) to [MariaDB 10.1.22](10.1.22.md) is **highly recommended** due to two high-priority regression fixes. See below for links to the relevant MDEVs.
...
For a complete list of changes made in [MariaDB 10.1.22](10.1.22.md), with links to detailed\
