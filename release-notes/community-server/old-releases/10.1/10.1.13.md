...
[Download](https://downloads.mariadb.org/mariadb/10.1.13) | [Release Notes](10.1.13.md) | [Changelog](../../changelogs/changelogs-mariadb-101-series/mariadb-10113-changelog.md) | [Overview of 10.1](changes-improvements-in-mariadb-10-1.md)
...
[MariaDB 10.1.13](10.1.13.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.

**For an overview of** [**MariaDB 10.1**](changes-improvements-in-mariadb-10-1.md) **see the**[**What is MariaDB 10.1?**](../10.0/changes-improvements-in-mariadb-10-0.md) **page.**
...
For a complete list of changes made in [MariaDB 10.1.13](10.1.13.md), with links to detailed\
