...
[MariaDB 10.1.13](mariadb-10113-release-notes.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* [MDEV-9659](https://jira.mariadb.org/browse/MDEV-9659) [AWS Key management encryption plugin](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin) (currently distributed in source form only).
* [MDEV-6058](https://jira.mariadb.org/browse/MDEV-6058) new server variables; [log\_slow\_admin\_statements](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#log_slow_admin_statements) and [log\_slow\_slave\_statements](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/standard-replication/replication-and-binary-log-system-variables).
