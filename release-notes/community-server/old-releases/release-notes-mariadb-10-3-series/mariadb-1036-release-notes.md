...
[MariaDB 10.3.6](mariadb-1036-release-notes.md) is a [_**RC**_](../../about/release-criteria.md) release.
...
* Added the [DISKS plugin](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/system-tables/information-schema/information-schema-tables/information-schema-disks-table), for monitoring the disk space situation.
...
* Added new status variables to count the usage of user defined aggregate functions: [Feature\_custom\_aggregate\_functions](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-status-variables#feature_custom_aggregate_functions) - [MDEV-14592](https://jira.mariadb.org/browse/MDEV-14592)
...
* As per the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md), this will be the last release of [MariaDB 10.3](what-is-mariadb-103.md) for Debian 7 Wheezy
