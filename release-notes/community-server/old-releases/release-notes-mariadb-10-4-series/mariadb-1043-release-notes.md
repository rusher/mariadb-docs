...
[MariaDB 10.4.3](mariadb-1043-release-notes.md) is a [_**Release Candidate**_](../../about/release-criteria.md) release.
...
* [MDEV-18551](https://jira.mariadb.org/browse/MDEV-18551): The default for [eq\_range\_index\_dive\_limit](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#eq_range_index_dive_limit) is now `200` (previously `0`)
...
* [MDEV-18439](https://jira.mariadb.org/browse/MDEV-18439): [core\_file](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#core_file) on Windows now defaults to `ON`
...
* [analyze\_sample\_percentage](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-management/variables-and-modes/server-system-variables#analyze_sample_percentage) system variable
