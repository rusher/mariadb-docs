...
<a href="https://downloads.mariadb.org/mariadb/10.5.18/" class="button primary">Download</a> <a href="mariadb-10-5-18-release-notes.md" class="button secondary">Release Notes</a> <a href="../../changelogs/changelogs-mariadb-105-series/mariadb-10-5-18-changelog.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-105.md" class="button secondary">Overview of 10.5</a>
...
[MariaDB 10.5.18](mariadb-10-5-18-release-notes.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* [mariadb-backup --compress](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#compress) hangs ([MDEV-29043](https://jira.mariadb.org/browse/MDEV-29043))
...
* InnoDB crash recovery fixes ([MDEV-29438](https://jira.mariadb.org/browse/MDEV-29438), [MDEV-29475](https://jira.mariadb.org/browse/MDEV-29475))
* InnoDB crash recovery fixes ([MDEV-29559](https://jira.mariadb.org/browse/MDEV-29559))
* MVCC and locking ([MDEV-28709](https://jira.mariadb.org/browse/MDEV-28709))
...
For a complete list of changes made in [MariaDB 10.5.18](mariadb-10-5-18-release-notes.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/changelogs-mariadb-105-series/mariadb-10-5-18-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 10.5.18](mariadb-10-5-18-release-notes.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-9-4-10-8-6-10-7-7-10-6-11-10-5-18-10-4-27-and-10-3-37-now-available/).
