...
[Download](https://downloads.mariadb.org/mariadb/5.5.54) | [Release Notes](mariadb-5554-release-notes.md) | [Changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5554-changelog.md) | [Overview of 5.5](changes-improvements-in-mariadb-5-5.md)
...
[MariaDB 5.5.54](mariadb-5554-release-notes.md) is a maintenance release. It includes bugfixes and\
...
* As per the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md), this is the last release of [MariaDB 5.5](changes-improvements-in-mariadb-5-5.md) for CentOS 5, RHEL 5, and openSUSE 13
...
A full list of all changes is in the [changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5554-changelog.md).
