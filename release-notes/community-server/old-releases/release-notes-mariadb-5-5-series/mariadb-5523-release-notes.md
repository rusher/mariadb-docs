...
[Download](https://downloads.askmonty.org/mariadb/5.5.23) | **Release Notes** | [Changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5523-changelog.md) | [Overview of 5.5](changes-improvements-in-mariadb-5-5.md)

**Release date:** 11 Apr 2012

[MariaDB 5.5.23](mariadb-5523-release-notes.md) is a [_**Stable**_](../../about/release-criteria.md) _**(GA)**_\
...
**Note:** _There are no RPM packages of_ [_MariaDB 5.5.23_](mariadb-5523-release-notes.md) _available at this time._
...
## Includes [MariaDB 5.3.6](../release-notes-mariadb-5-3-series/mariadb-536-release-notes.md)
...
This version of MariaDB includes MySQL 5.5.23.\
See [Changes in MySQL 5.5.23](https://dev.mysql.com/doc/refman/5.5/en/news-5-5-23.html)\
