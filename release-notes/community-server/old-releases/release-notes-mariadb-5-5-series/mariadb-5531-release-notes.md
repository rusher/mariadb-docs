...
[Download](https://downloads.mariadb.org/mariadb/5.5.31) | **Release Notes** | [Changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5531-changelog.md) | [Overview of 5.5](changes-improvements-in-mariadb-5-5.md)
...
In accordance with the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md) the following distributions have reached the end of their support periods (EOL):
