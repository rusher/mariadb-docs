...
[Download](https://downloads.mariadb.org/mariadb/5.5.61) | [Release Notes](mariadb-5561-release-notes.md) | [Changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5561-changelog.md) | [Overview of 5.5](changes-improvements-in-mariadb-5-5.md)
...
[MariaDB 5.5.61](mariadb-5561-release-notes.md) is a maintenance release. It includes bugfixes and\
updates, including from MySQL 5.5.61.
...
A full list of all changes is in the [changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5561-changelog.md).

## Contributors

For a full list of contributors to [MariaDB 5.5.61](mariadb-5561-release-notes.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-5-5-61-mariadb-connector-node-js-0-7-0-and-mariadb-connector-j-2-2-6-now-available/).
