...
[Download](https://downloads.mariadb.org/mariadb/5.5.64/) | [Release Notes](mariadb-5564-release-notes.md) | [Changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5564-changelog.md) | [Overview of 5.5](changes-improvements-in-mariadb-5-5.md)
...
* As per the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md), this will be\
  the last release of [MariaDB 5.5](changes-improvements-in-mariadb-5-5.md) for Ubuntu 14.04 Trusty
...
For a full list of contributors to [MariaDB 5.5.64](mariadb-5564-release-notes.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-5-5-64-now-available/).
