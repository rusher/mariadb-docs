...
recent [MariaDB 5.5.33](5.5.33.md) release.
...
* [MDEV-5029](https://jira.mariadb.org/browse/MDEV-5029) Crash in [MariaDB 5.5.33](5.5.33.md) with inconsistent .frm from older MariaDB release
