...
## Includes [MariaDB 5.3.12](../5.3/5.3.12.md) and MySQL 5.5.31

This release includes [MariaDB 5.3.12](../5.3/5.3.12.md) and MySQL 5.5.31. See [Changes in MySQL 5.5.31](https://dev.mysql.com/doc/relnotes/mysql/5.5/en/news-5-5-31.html)\
...
This release ([MariaDB 5.5.31](5.5.31.md)) is therefore the last MariaDB release to feature packages for these distros. The [repositories](https://downloads.mariadb.org/mariadb/repositories/) for them will remain online until the 5.5.32 release. At that time they will go away.
