...
[MariaDB 5.5.24](5.5.24.md) is a [_**Stable**_](../../about/release-criteria.md) _**(GA)**_\
...
For a list of changes made in [MariaDB 5.5.24](5.5.24.md), with links to detailed\
...
## Includes [MariaDB 5.3.7](../5.3/5.3.7.md) and MySQL 5.5.24

[MariaDB 5.5.24](5.5.24.md) includes [MariaDB 5.3.7](../5.3/5.3.7.md) and MySQL 5.5.24. See the [MariaDB 5.3.7](../5.3/5.3.7.md)[Release Notes](../5.3/5.3.7.md) and [Changelog](../../changelogs/changelogs-mariadb-53-series/mariadb-537-changelog.md) for more information on the changes in [MariaDB 5.3.7](../5.3/5.3.7.md). See [Changes in MySQL 5.5.24](https://dev.mysql.com/doc/refman/5.5/en/news-5-5-24.html)\
...
[MariaDB 5.5.24](5.5.24.md) introduces new RPM packages and YUM repositories for RedHat,\
Fedora, and CentOS.
...
[MariaDB 5.5.24](5.5.24.md) also includes binaries for BSD 9 and MacOS X 10.5. As with the new\
