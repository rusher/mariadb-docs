...
[MariaDB 5.5.22](5.5.22.md) is a [_**Release Candidate**_](../../about/release-criteria.md) _**(RC)**_\
...
For a list of changes made in [MariaDB 5.5.22](5.5.22.md)-rc, with links to detailed\
...
**Note:** _There are no RPM packages of_ [_MariaDB 5.5.22_](5.5.22.md) _available at this time._
