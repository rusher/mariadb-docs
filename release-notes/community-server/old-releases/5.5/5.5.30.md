...
## Includes [MariaDB 5.3.12](../5.3/5.3.12.md) and MySQL 5.5.30

This release includes [MariaDB 5.3.12](../5.3/5.3.12.md) and MySQL 5.5.30. See [Changes in MySQL 5.5.30](https://dev.mysql.com/doc/relnotes/mysql/5.5/en/news-5-5-30.html)\
