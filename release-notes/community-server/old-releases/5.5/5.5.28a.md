...
[MariaDB 5.5.28](5.5.28.md) a is a [_**Stable**_](../../about/release-criteria.md) _**(GA)**_\
...
For a list of changes made in [MariaDB 5.5.28](5.5.28.md) a, with links to detailed\
