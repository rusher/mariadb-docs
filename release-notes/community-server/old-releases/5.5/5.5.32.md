...
## Includes [MariaDB 5.3.12](../5.3/5.3.12.md) and MySQL 5.5.32

This release includes [MariaDB 5.3.12](../5.3/5.3.12.md) and MySQL 5.5.32. See [Changes in MySQL 5.5.32](https://dev.mysql.com/doc/relnotes/mysql/5.5/en/news-5-5-32.html)\
...
* As long as XtraDB is used, [MariaDB 5.5.32](5.5.32.md) is not affected by [MySQL Bug #69623](https://bugs.mysql.com/bug.php?id=69623) (multi-file tablespaces do not work after an upgrade).
