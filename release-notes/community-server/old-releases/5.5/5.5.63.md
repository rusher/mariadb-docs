...
[Download](https://downloads.mariadb.org/mariadb/5.5.63) | [Release Notes](5.5.63.md) | [Changelog](../../changelogs/changelogs-mariadb-55-series/mariadb-5563-changelog.md) | [Overview of 5.5](changes-improvements-in-mariadb-5-5.md)
...
[MariaDB 5.5.63](5.5.63.md) is a maintenance release.
...
For a full list of contributors to [MariaDB 5.5.63](5.5.63.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-5-5-63-now-available/).
