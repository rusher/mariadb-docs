...
[MariaDB 5.3.3](5.3.3.md) is a [Release Candidate](../../about/release-criteria.md) release. In general\
...
Compared to [MariaDB 5.3.0](5.3.0.md), 5.3.1, and 5.3.2, [MariaDB 5.3.3](5.3.3.md) is a bug-fix release\
...
* Usability:
  * [EXPLAIN](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/administrative-sql-statements/analyze-and-explain-statements/explain) output has been improved to be easier to understand
...
* Other:
  * Ubuntu 11.10 "Oneiric" [repositories](https://downloads.askmonty.org/mariadb/repositories/) are now available for [MariaDB 5.3.3](5.3.3.md).

For a list of every change made in [MariaDB 5.3.3](5.3.3.md), with links to detailed\
information on each push, see the [MariaDB 5.3.3 Changelog](https://github.com/mariadb-corporation/docs-server/blob/test/release-notes/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-3-series/broken-reference/README.md). It is worth noting that [MariaDB 5.3](changes-improvements-in-mariadb-5-3.md) is built on [MariaDB 5.2](../5.2/changes-improvements-in-mariadb-5-2.md),[MariaDB 5.1](../5.1/changes-improvements-in-mariadb-5-1.md), and MySQL 5.1.
