...
[MariaDB 5.3.10](5.3.10.md) is a [_**Stable**_](../../about/release-criteria.md) _**(GA)**_ release. In\
...
For a list of changes made in [MariaDB 5.3.10](5.3.10.md), with links to detailed\
...
## Includes [MariaDB 5.2](../5.2/changes-improvements-in-mariadb-5-2.md) and MySQL 5.1.66

This version of MariaDB includes the latest changes to [MariaDB 5.2](../5.2/changes-improvements-in-mariadb-5-2.md), and, by\
extension, [MariaDB 5.1](../5.1/changes-improvements-in-mariadb-5-1.md), including MySQL 5.1.66. See [Changes in MySQL 5.1.66](https://dev.mysql.com/doc/refman/5.1/en/news-5-1-66.html)\
...
change made in [MariaDB 5.3.10](5.3.10.md), with links to detailed information on each push.
