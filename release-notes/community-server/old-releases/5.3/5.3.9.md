...
[MariaDB 5.3.9](5.3.9.md) is a [_**Stable**_](../../about/release-criteria.md) _**(GA)**_ release. In\
...
For a list of changes made in [MariaDB 5.3.9](5.3.9.md), with links to detailed\
...
change made in [MariaDB 5.3.9](5.3.9.md), with links to detailed information on each push.
