...
[MariaDB 5.3.6](5.3.6.md) is a [_**Stable**_](../../about/release-criteria.md) _**(GA)**_ release. In\
...
For a list of changes made in [MariaDB 5.3.6](5.3.6.md), with links to detailed\
...
[MariaDB 5.3.6](5.3.6.md) fixes a bug that under certain rare circumstances allowed a user\
...
## Includes [MariaDB 5.2.12](../5.2/5.2.12.md) and MySQL 5.1.62

This version of MariaDB includes [MariaDB 5.2.12](../5.2/5.2.12.md), and, by extension, [MariaDB 5.1.62](../5.1/5.1.62.md)\
and MySQL 5.1.62. See the [MariaDB 5.2.12 Release Notes](../5.2/5.2.12.md)\
for the changes made in [MariaDB 5.2.12](../5.2/5.2.12.md) and see [Changes in MySQL 5.1.62](https://dev.mysql.com/doc/refman/5.1/en/news-5-1-62.html)\
for what changed between this and previous MySQL versions.

## Performance Improvements

[MariaDB 5.3.6](5.3.6.md) includes several performance improvements, including a fix for [Bug #913030](https://bugs.launchpad.net/bugs/913030): "Optimizer chooses a suboptimal excution plan for Q18 from DBT-3".

## Other various bug fixes and enhancements

[MariaDB 5.3.6](5.3.6.md) also includes numerous bug fixes and enhancements, including:
...
made in [MariaDB 5.3.6](5.3.6.md), with links to detailed information on each push.
