...
[Download 10.9.2](https://downloads.mariadb.org/mariadb/10.9.2/) | [Release Notes](mariadb-1092-release-notes.md) | [Changelog](../../changelogs/10.9/10.9.2.md) | [Overview of 10.9](what-is-mariadb-109.md)

**Release date:** 22 Aug 2022

[MariaDB 10.9](what-is-mariadb-109.md) is a current stable series of MariaDB, maintained until August 2023. It is an evolution\
of [MariaDB 10.8](../release-notes-mariadb-10-8-series/what-is-mariadb-108.md) with several entirely new features.

[MariaDB 10.9.2](mariadb-1092-release-notes.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.
...
* [FULLTEXT search](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/ha-and-performance/optimization-and-tuning/optimization-and-indexes/full-text-indexes) with apostrophe, and mandatory words ([MDEV-20797](https://jira.mariadb.org/browse/MDEV-20797))
...
* The [Spider](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/storage-engines/spider) version number now matches the server version (and the [spider\_version](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/storage-engines/spider/spider-system-variables) system variable removed) ([MDEV-26282](https://jira.mariadb.org/browse/MDEV-26282))
...
* As per the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md), this will be the last release of [MariaDB 10.9](what-is-mariadb-109.md) for Debian 10 "Buster" for ppc64el
...
information on each push, see the [changelog](../../changelogs/10.9/10.9.2.md).
