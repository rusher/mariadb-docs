...
[MariaDB 10.9.0](mariadb-1090-release-notes.md) is not a single release, but is instead a number of preview releases based on feature branches. Each should be considered [_**Alpha**_](../../about/release-criteria.md).\
...
* [information\_schema.tables.table\_type](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/system-tables/information-schema/information-schema-tables/information-schema-tables-table) now shows TEMPORARY for local temporary tables ([MDEV-12459](https://jira.mariadb.org/browse/MDEV-12459)) (not included in [MariaDB 10.9.1](mariadb-1091-release-notes.md))
