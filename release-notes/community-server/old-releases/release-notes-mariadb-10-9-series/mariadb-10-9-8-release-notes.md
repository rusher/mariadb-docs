...
[Download](https://mariadb.com/downloads) | [Release Notes](mariadb-10-9-8-release-notes.md) | [Changelog](../../changelogs/10.9/10.9.8.md) | [Overview of 10.9](what-is-mariadb-109.md)

[_Alternate download from mariadb.org_](https://downloads.mariadb.org/mariadb/10.9.8/)

**Release date:** 14 Aug 2023

[MariaDB 10.9](what-is-mariadb-109.md) is a previous short-term stable series of MariaDB, [maintained until](https://mariadb.org/about/#maintenance-policy) August 2023. It is an evolution of [MariaDB 10.8](../release-notes-mariadb-10-8-series/what-is-mariadb-108.md) with several entirely new features.

[MariaDB 10.9.8](mariadb-10-9-8-release-notes.md) is a [_**Stable (GA)**_](../../about/release-criteria.md) release.

[MariaDB 10.9.8](mariadb-10-9-8-release-notes.md) is the last release of the [MariaDB 10.9](what-is-mariadb-109.md) release series.
...
* As per the [MariaDB Maintenance Policy](https://mariadb.org/about/#maintenance-policy), this will be the final release of [MariaDB 10.9](what-is-mariadb-109.md)
...
* As per the [MariaDB Deprecation Policy](../../about/platform-deprecation-policy.md), this will be the last release of [MariaDB 10.9](what-is-mariadb-109.md) for Ubuntu 18.04 LTS "Bionic" and Ubuntu 22.10 "Kinetic"
...
For a complete list of changes made in [MariaDB 10.9.8](mariadb-10-9-8-release-notes.md), with links to detailed\
information on each push, see the [changelog](../../changelogs/10.9/10.9.8.md).

## Contributors

For a full list of contributors to [MariaDB 10.9.8](mariadb-10-9-8-release-notes.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-0-3-10-11-5-10-10-6-10-9-8-10-6-15-10-5-22-10-4-31-now-available/).
