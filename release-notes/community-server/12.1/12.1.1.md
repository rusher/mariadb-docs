---
description: >-
  MariaDB 12.1.1 is a Release Candidate (RC) release of MariaDB Community
  Server 12.1, released on 2025-08-07
---
...
<a href="https://downloads.mariadb.org/mariadb/12.1.1/" class="button primary">Download</a> <a href="12.1.1.md" class="button secondary">Release Notes</a> <a href="../changelogs/12.1/12.1.1.md" class="button secondary">Changelog</a> <a href="changes-and-improvements-in-mariadb-12.1.md" class="button secondary">Overview of 12.1</a>
...
For a complete list of changes made in MariaDB 12.1.1, with links to detailed information on each push, see the [changelog](../changelogs/12.1/12.1.1.md).
