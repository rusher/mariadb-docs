...
For a complete list of changes made in MariaDB 12.1.1, with links to detailed information on each push, see the [changelog](../changelogs/12.1/mariadb-12.1.1-changelog.md).
