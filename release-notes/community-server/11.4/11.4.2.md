---
description: >-
  MariaDB 11.4.2 is a Stable (GA) release of MariaDB Community Server 11.4,
...
<a href="https://downloads.mariadb.org/mariadb/11.4.2/" class="button primary">Download</a> <a href="11.4.2.md" class="button secondary">Release Notes</a> <a href="../changelogs/11.4/11.4.2.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-114.md" class="button secondary">Overview of 11.4</a>

**Release date:** 29 May 2024

[MariaDB 11.4](what-is-mariadb-114.md) is the current long-term series of MariaDB and will be [maintained until](https://mariadb.org/about/#maintenance-policy) May 2029. It is an evolution of [MariaDB 11.3](../old-releases/11.3/what-is-mariadb-113.md) with several entirely new features.

[MariaDB 11.4.2](11.4.2.md) is a [_**Stable (GA)**_](../about/release-criteria.md) release.
...
* Spider: ERROR 12710 (HY000): Invalid information from remote table when using [MariaDB 10.5](../old-releases/10.5/what-is-mariadb-105.md) local and [MariaDB 10.6](../10.6/what-is-mariadb-106.md) remote ([MDEV-33777](https://jira.mariadb.org/browse/MDEV-33777))
...
* Port backup features from Enterprise Server. This adds support for [BACKUP STAGE](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-statements/administrative-sql-statements/backup-commands/backup-stage) to [mariadb-backup](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup), and obsoletes the [no-backup-locks](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#no-backup-locks) and [rsync](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#rsync) options ([MDEV-32932](https://jira.mariadb.org/browse/MDEV-32932))
* [mariadb-backup](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup) now preserves [innodb\_encrypt\_tables](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb/innodb-system-variables#innodb_encrypt_tables) ([MDEV-33334](https://jira.mariadb.org/browse/MDEV-33334))
* Fix [mariadb-backup](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup) problem on older mariadb (opendir(NULL)) caused by [MDEV-30968](https://jira.mariadb.org/browse/MDEV-30968) ([MDEV-31251](https://jira.mariadb.org/browse/MDEV-31251))
* Fix [mariadb-backup --backup](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#backup) FATAL ERROR: ... Can't open datafile cool\_down/t3 ([MDEV-33011](https://jira.mariadb.org/browse/MDEV-33011))
* [mariadb-backup --backup](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#backup) now includes retry logic for undo tablespaces ([MDEV-33980](https://jira.mariadb.org/browse/MDEV-33980))
* Fix crash recovery in [mariadb-backup --prepare](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup/mariadb-backup-options#prepare) due to insufficient [innodb\_log\_file\_size](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/server-usage/storage-engines/innodb/innodb-system-variables#innodb_log_file_size) ([MDEV-33540](https://jira.mariadb.org/browse/MDEV-33540))
* Fix crash in [mariadb-backup --prepare --export](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup) after `--prepare` ([MDEV-33023](https://jira.mariadb.org/browse/MDEV-33023))
* [mariadb-backup](https://app.gitbook.com/o/diTpXxF5WsbHqTReoBsS/s/SsmexDFPv2xG2OTyO5yV/server-usage/backup-and-restore/mariadb-backup) now considers O/S user when `--user` option is omitted ([MDEV-32893](https://jira.mariadb.org/browse/MDEV-32893))
...
* View created via [JSON\_ARRAYAGG](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/sql-functions/aggregate-functions/json_arrayagg) now returns correct json object ([MDEV-30646](https://jira.mariadb.org/browse/MDEV-30646))
...
* Moving from [MariaDB 10.5](../old-releases/10.5/what-is-mariadb-105.md) to 10.6 mysql\_upgrade is not updating some system tables ([MDEV-33726](https://jira.mariadb.org/browse/MDEV-33726))
...
For a complete list of changes made in [MariaDB 11.4.2](11.4.2.md), with links to detailed\
information on each push, see the [changelog](../changelogs/11.4/11.4.2.md).

## Contributors

For a full list of contributors to [MariaDB 11.4.2](11.4.2.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-4-2-and-mariadb-11-5-1-now-available/).
