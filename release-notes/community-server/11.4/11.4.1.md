---
description: >-
  MariaDB 11.4.1 is a Release Candidate (RC) release of MariaDB Community
  Server 11.4, released on 2024-02-16
---
...
<a href="https://downloads.mariadb.org/mariadb/11.4.1/" class="button primary">Download</a> <a href="11.4.1.md" class="button secondary">Release Notes</a> <a href="../changelogs/11.4/11.4.1.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-114.md" class="button secondary">Overview of 11.4</a>
...
[MariaDB 11.4.1](11.4.1.md) is a [_**Release Candidate (RC)**_](../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 11.4.1](11.4.1.md), with links to detailed\
information on each push, see the [changelog](../changelogs/11.4/11.4.1.md).

### Contributors

For a full list of contributors to [MariaDB 11.4.1](11.4.1.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-2-1-11-1-2-now-available/).
