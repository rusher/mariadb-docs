---
description: >-
  MariaDB 10.6.11 is a Stable (GA) release of MariaDB Community Server 10.6,
...
<a href="https://downloads.mariadb.org/mariadb/10.6.11/" class="button primary">Download</a> <a href="10.6.11.md" class="button secondary">Release Notes</a> <a href="../changelogs/10.6/10.6.11.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-106.md" class="button secondary">Overview of 10.6</a>

**Release date:** 7 Nov 2022

[MariaDB 10.6](what-is-mariadb-106.md) is the current long-term maintenance stable series of MariaDB, maintained until July 2026. It is an evolution of [MariaDB 10.5](../old-releases/10.5/what-is-mariadb-105.md) with several entirely new features.

[MariaDB 10.6.11](10.6.11.md) is a [_**Stable (GA)**_](../about/release-criteria.md) release.
...
For a complete list of changes and bugfixes made in [MariaDB 10.6.11](10.6.11.md), with links to detailed\
information on each push, see the [changelog](../changelogs/10.6/10.6.11.md).

## Contributors

For a full list of contributors to [MariaDB 10.6.11](10.6.11.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-9-4-10-8-6-10-7-7-10-6-11-10-5-18-10-4-27-and-10-3-37-now-available/).
