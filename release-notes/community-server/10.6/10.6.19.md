---
description: >-
  MariaDB 10.6.19 is a Stable (GA) release of MariaDB Community Server 10.6,
...
<a href="https://downloads.mariadb.org/mariadb/10.6.19/" class="button primary">Download</a> <a href="10.6.19.md" class="button secondary">Release Notes</a> <a href="../changelogs/10.6/10.6.19.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-106.md" class="button secondary">Overview of 10.6</a>
...
[MariaDB 10.6.19](10.6.19.md) is a [_**Stable (GA)**_](../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 10.6.19](10.6.19.md), with links to detailed\
information on each push, see the [changelog](../changelogs/10.6/10.6.19.md).

## Contributors

For a full list of contributors to [MariaDB 10.6.19](10.6.19.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-11-6-1-11-5-2-11-4-3-11-2-5-11-1-6-10-11-9-10-6-19-and-10-5-26-now-available/).
