...
| CVE ID (with cve.org link)                                                      | CVSS base score | Community Server 10.6 Release |
| ------------------------------------------------------------------------------- | --------------- | ----------------------------- |
...
| [CVE-2026-3494](https://www.cve.org/CVERecord?id=CVE-2026-3494)                 | 5.3             | [MariaDB 10.6.25](10.6.25.md) |
