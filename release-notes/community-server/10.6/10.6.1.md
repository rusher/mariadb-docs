---
description: >-
  MariaDB 10.6.1 is a Beta release of MariaDB Community Server 10.6, released on
  2021-05-21
---
...
<a href="https://downloads.mariadb.org/mariadb/10.6.1/" class="button primary">Download</a> <a href="10.6.1.md" class="button secondary">Release Notes</a> <a href="../changelogs/10.6/10.6.1.md" class="button secondary">Changelog</a> <a href="what-is-mariadb-106.md" class="button secondary">Overview of 10.6</a>
...
[MariaDB 10.6.1](10.6.1.md) is a [_**Beta**_](../about/release-criteria.md) release.
...
For a complete list of changes made in [MariaDB 10.6.1](10.6.1.md), with links to detailed\
information on each push, see the [changelog](../changelogs/10.6/10.6.1.md).

## Contributors

For a full list of contributors to [MariaDB 10.6.1](10.6.1.md), see the [MariaDB Foundation release announcement](https://mariadb.org/mariadb-10-6-1-now-available/).
