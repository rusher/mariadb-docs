...
* [mariadb-backup]({server}/server-usage/backup-and-restore/mariadb-backup) prepare fails for incrementals if a new schema is created after full backup is taken ([MDEV-28446](https://jira.mariadb.org/browse/MDEV-28446))
