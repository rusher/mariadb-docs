...
* CMAPI now disables the [ExeMgr process](https://mariadb.com/docs/server/architecture/components/enterprise-columnstore/query-evaluation/#ExeMgr_Process/Facility) on replica nodes to avoid unnecessary CPU usage. ([MCOL-4860](https://jira.mariadb.org/browse/MCOL-4860))
...
* Some [CMAPI Log](https://mariadb.com/docs/server/ref/col/logging/cmapi) messages have been clarified. ([MCOL-4851](https://jira.mariadb.org/browse/MCOL-4851))
...
* The [CMAPI configuration file](https://mariadb.com/docs/server/ref/cmapi/#Configuration) is now automatically created by default if it is not found. ([MCOL-4851](https://jira.mariadb.org/browse/MCOL-4851))
