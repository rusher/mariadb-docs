...
In alignment with the [enterprise lifecycle](../../enterprise-server-lifecycle.md), MariaDB Enterprise ColumnStore 23.10.0 is provided for:
...
* [Upgrade Multi-Node MariaDB Enterprise ColumnStore from 6 to 23.10](https://mariadb.com/docs/server/service-management/upgrades/enterprise-columnstore/multi-node/from-6-23-10/)
