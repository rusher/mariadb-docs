...
* Crash may occur when using cpimport ([LOAD DATA LOCAL INFILE](https://app.gitbook.com/s/rBEU9juWLfTDcdwF3Q14/sql-commands/data-manipulation-statements/columnstore-load-data-infile)) to process data containing multi-byte characters. ([MCOL-4005](https://jira.mariadb.org/browse/MCOL-4005))
