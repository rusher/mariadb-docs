...
MariaDB ColumnStore 1.0.9 is a [_**GA**_](../../mariadb-release-criteria.md) release.
...
* [1.0.8 GA to 1.0.9 upgrade procedure](broken-reference)
...
* An Amazon AWS AMI Image is available for this release, please search for AMI name "MariaDB-ColumnStore-1.0.9". AMI specific installation instructions can be found [here](broken-reference).
