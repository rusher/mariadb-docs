...
[MariaDB ColumnStore 1.0.1](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/mariadb-columnstore/README.md) is the development version of MariaDB ColumnStore. It is built by porting InfiniDB 4.6.2 on [MariaDB 10.1.14](broken-reference).
...
* Porting of InfiniDB source code as “columnstore” storage engine on [MariaDB 10.1.14](broken-reference)
