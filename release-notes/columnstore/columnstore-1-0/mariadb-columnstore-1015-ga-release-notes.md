...
[MariaDB ColumnStore 1.0.15](https://github.com/mariadb-corporation/docs-release-notes/blob/test/kb/en/mariadb-columnstore/README.md) is a maintenance GA release of MariaDB ColumnStore. This release of MariaDB ColumnStore provides improvements over the previous 1.0.14 GA release.

MariaDB ColumnStore 1.0.15 is a [_**GA**_](../../mariadb-release-criteria.md) release.
...
* [MCOL-1631](https://jira.mariadb.org/browse/MCOL-1631) - The base MariaDB server version is now [10.1.35](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-1-series/mariadb-10135-release-notes.md) which include several maintenance and security fixes.

## Bugs and issues fixed

* [MCOL-1631](https://jira.mariadb.org/browse/MCOL-1631) - Merge [MariaDB 10.1.35](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-1-series/mariadb-10135-release-notes.md)

## Upgrade

The following procedure outlines upgrading a 1.0.14 ColumnStore install to 1.0.15:

* [1.0.14 GA to 1.0.15 upgrade procedure](https://github.com/mariadb-corporation/docs-server/blob/test/release-notes/columnstore/columnstore-1-0/broken-reference/README.md)\
