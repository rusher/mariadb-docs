...
MariaDB ColumnStore 1.1.7 is a [_**GA**_](../../mariadb-release-criteria.md) release.
...
* [MCOL-2158](https://jira.mariadb.org/browse/MCOL-2158) - The base MariaDB server version is now [10.2.22](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-2-series/mariadb-10222-release-notes.md) which include several maintenance and security fixes.
...
* [MCOL-2005](https://jira.mariadb.org/browse/MCOL-2005) - Merge [MariaDB 10.2.21](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-2-series/mariadb-10221-release-notes.md) into develop-1.1
...
* [MCOL-2158](https://jira.mariadb.org/browse/MCOL-2158) - Merge [MariaDB 10.2.22](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-2-series/mariadb-10222-release-notes.md)
...
* [1.1.6 GA to 1.1.7 GA upgrade procedure](broken-reference)
...
* An Amazon AWS AMI Image is available for this release, please search for AMI name "MariaDB-ColumnStore-1.1.7". AMI specific installation instructions can be found [here](broken-reference).
