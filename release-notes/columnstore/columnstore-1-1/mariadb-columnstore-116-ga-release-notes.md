...
MariaDB ColumnStore 1.1.6 is a [_**GA**_](../../mariadb-release-criteria.md) release.
...
* [MCOL-1615](https://jira.mariadb.org/browse/MCOL-1615) - The base MariaDB server version is now [10.2.17](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-2-series/mariadb-10217-release-notes.md) which include several maintenance and security fixes.
...
* [MCOL-1615](https://jira.mariadb.org/browse/MCOL-1615) - Merge [MariaDB 10.2.17](../../mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-2-series/mariadb-10217-release-notes.md)
...
* [1.1.5 GA to 1.1.6 GA upgrade procedure](broken-reference)
...
* An Amazon AWS AMI Image is available for this release, please search for AMI name "MariaDB-ColumnStore-1.1.6". AMI specific installation instructions can be found [here](broken-reference).
