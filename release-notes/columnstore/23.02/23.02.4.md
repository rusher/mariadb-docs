...
[MariaDB ColumnStore](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/mariadb-columnstore/README.md) 23.02.4 is a maintenance release of MariaDB ColumnStore. MariaDB ColumnStore is a columnar storage engine included with MariaDB Enterprise Server.

MariaDB ColumnStore 23.02.4 was released on 2023-07-03. This release is of General Availability (GA) maturity. MariaDB ColumnStore 23.02.4 is the fourth GA release in the 23.02 series.

MariaDB ColumnStore 23.02 replaces MariaDB ColumnStore 22.08 in MariaDB Enterprise Server 10.6.

This release of MariaDB ColumnStore is included with MariaDB Enterprise Server 10.6.14-9.

Users of earlier MariaDB ColumnStore releases are encouraged to upgrade.
...
In alignment with the [enterprise lifecycle](../../enterprise-server/enterprise-server-lifecycle.md), MariaDB ColumnStore 23.02.4 is provided for:
