...
* [MCOL-1319](https://jira.mariadb.org/browse/MCOL-1319) - The base MariaDB server version is now [10.2.14](../../../community-server/old-releases/10.2/10.2.14.md) which include several maintenance and security fixes.
