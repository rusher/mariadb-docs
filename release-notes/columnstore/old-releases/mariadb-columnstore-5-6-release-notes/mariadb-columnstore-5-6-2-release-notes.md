...
MariaDB ColumnStore 5.6.2 was released on 2021-06-30.

## Issues Fixed

* Possible segfault with disk-based aggregation. ([MCOL-4788](https://jira.mariadb.org/browse/MCOL-4788), [MCOL-563](https://jira.mariadb.org/browse/MCOL-563))

## Platforms

In alignment with the [enterprise lifecycle](../../../enterprise-server/enterprise-server-lifecycle.md), MariaDB ColumnStore 5.6.2 is provided for:
