...
* [MCOL-3398](https://jira.mariadb.org/browse/MCOL-3398) - The base MariaDB server version is now [10.3.16](../../../community-server/old-releases/10.3/10.3.16.md) which include several maintenance and security fixes.
