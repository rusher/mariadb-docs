...
* [MCOL-1952](https://jira.mariadb.org/browse/MCOL-1952) - The base MariaDB server version is now [10.3.11](../../../community-server/old-releases/10.3/10.3.11.md) which include several maintenance and security fixes.
