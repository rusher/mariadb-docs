...
[MariaDB ColumnStore](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/mariadb-columnstore/README.md) 22.08.1 is a maintenance release of [MariaDB ColumnStore](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/mariadb-columnstore/README.md) . MariaDB ColumnStore is a columnar storage engine included with MariaDB Enterprise Server. This is the first release in the ColumnStore 22.08 series.

MariaDB ColumnStore 22.08.1 was released on 2022-09-12. This release is of General Availability (GA) maturity.
...
This release has been withdrawn. Users of MariaDB ColumnStore 22.08.1 should upgrade to MariaDB ColumnStore 22.08.3.
...
In alignment with the [enterprise lifecycle](../../enterprise-server/enterprise-server-lifecycle.md), MariaDB ColumnStore 22.08.1 is provided for:
