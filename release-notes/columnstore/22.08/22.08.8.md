...
[MariaDB ColumnStore](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/mariadb-columnstore/README.md) 22.08.8 is a maintenance release of [MariaDB ColumnStore](https://github.com/mariadb-corporation/docs-release-notes/blob/test/en/mariadb-columnstore/README.md). MariaDB ColumnStore is a columnar storage engine included with MariaDB Enterprise Server.

MariaDB ColumnStore 22.08.8 was released on 2023-02-10. This release is of General Availability (GA) maturity.

MariaDB ColumnStore 22.08 replaces MariaDB ColumnStore 6 in MariaDB Enterprise Server 10.6.

This release of MariaDB ColumnStore is included with MariaDB Enterprise Server 10.6.11-6.

Users of earlier MariaDB ColumnStore 22.08 releases are encouraged to upgrade.
...
In alignment with the [enterprise lifecycle](../../enterprise-server/about/enterprise-server-lifecycle.md), MariaDB ColumnStore 22.08.8 is provided for:
