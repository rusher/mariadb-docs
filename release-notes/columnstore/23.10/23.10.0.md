...
MariaDB ColumnStore 23.10.0 is a feature release of MariaDB ColumnStore. MariaDB ColumnStore is a columnar storage engine included with MariaDB Enterprise Server.

MariaDB ColumnStore 23.10.0 was released on 2023-10-11. This release is of General Availability (GA) maturity. MariaDB ColumnStore 23.10.0 is the first GA release in the 23.10 series.

This release of MariaDB ColumnStore is included with MariaDB Enterprise Server 10.6.15-10.
...
In alignment with the [enterprise lifecycle](../../enterprise-server/enterprise-server-lifecycle.md), MariaDB ColumnStore 23.10.0 is provided for:
