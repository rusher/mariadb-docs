...
MariaDB ColumnStore 23.10.1 is a feature release of MariaDB ColumnStore. MariaDB ColumnStore is a columnar storage engine included with MariaDB Enterprise Server.

MariaDB ColumnStore 23.10.1 was released on 2024-03-11. This release is of General Availability (GA) maturity. MariaDB ColumnStore 23.10.1 is a GA release in the 23.10 series.

This release of MariaDB ColumnStore is included with MariaDB Enterprise Server 10.6.17-12.

The changes listed here are relative to MariaDB ColumnStore 23.02.4.
...
In alignment with the [enterprise lifecycle](../../enterprise-server/enterprise-server-lifecycle.md), MariaDB ColumnStore 23.10.1 is provided for:
