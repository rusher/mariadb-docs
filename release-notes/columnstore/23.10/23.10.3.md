...
MariaDB ColumnStore 23.10.3 is a maintenance release of MariaDB ColumnStore. MariaDB ColumnStore is a columnar storage engine included with MariaDB Enterprise Server.

MariaDB ColumnStore 23.10.3 was released on 2025-01-27. This release is of General Availability (GA) maturity. MariaDB ColumnStore 23.10.3 is a GA release in the 23.10 series.

This release of MariaDB ColumnStore is included with MariaDB Enterprise Server 10.6.20-16.
...
In alignment with the [enterprise lifecycle](../../enterprise-server/enterprise-server-lifecycle.md), MariaDB ColumnStore 23.10.3 is provided for:
