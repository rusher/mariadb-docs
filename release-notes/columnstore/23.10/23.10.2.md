...
MariaDB ColumnStore 23.10.2 is a feature release of MariaDB ColumnStore. MariaDB ColumnStore is a columnar storage engine included with MariaDB Enterprise Server.

MariaDB ColumnStore 23.10.2 was released on 2024-08-19. This release is of General Availability (GA) maturity. MariaDB ColumnStore 23.10.2 is a GA release in the 23.10 series.

This release of MariaDB ColumnStore is included with MariaDB Enterprise Server 10.6.18-14.
...
In alignment with the [enterprise lifecycle](../../enterprise-server/enterprise-server-lifecycle.md), MariaDB ColumnStore 23.10.2 is provided for:
