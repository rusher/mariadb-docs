...
* MariaDB Server 5.5.64 was released on 29 Apr 2019.
* Please note: Newer releases exist within the MariaDB Server 5.5 release series.
* [What's new in this release?](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-5-series/mariadb-5564-release-notes)
...
* This release contains [security content](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-5-series/mariadb-5564-release-notes)
