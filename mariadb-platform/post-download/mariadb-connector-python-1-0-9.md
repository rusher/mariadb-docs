...
* MariaDB Connector/Python 1.0.9 was released on 21 Dec 2021.
* Please note: Newer releases exist within the MariaDB Connector/Python 1.0 release series.
* [What's new in this release?](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/connectors/python/mariadb-connector-python-1-0-release-notes/mariadb-connector-python-1-0-9-release-notes)
...
* The prior release in this series was MariaDB Connector/Python 1.0.8, released on 22 Oct 2021.
* This release (MariaDB Connector/Python 1.0.9) was released on 21 Dec 2021.
* The next release in this series is MariaDB Connector/Python 1.0.10, released on 18 Feb 2022.
* The latest release in this series is MariaDB Connector/Python 1.0.11, released on 12 Apr 2022.
