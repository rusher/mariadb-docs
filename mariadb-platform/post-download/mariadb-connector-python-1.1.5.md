...
* MariaDB Connector/Python 1.1.5 was released on 7 Nov 2022.
* Please note: Newer releases exist within the MariaDB Connector/Python 1.1 release series.
* [What's new in this release?](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/connectors/python/mariadb-connector-python-1-1-release-notes/mariadb-connector-python-1-1-5-release-notes)
...
* The prior release in this series was MariaDB Connector/Python 1.1.4, released on 10 Aug 2022.
* This release (MariaDB Connector/Python 1.1.5) was released on 7 Nov 2022.
* The next release in this series is MariaDB Connector/Python 1.1.6, released on 1 Mar 2023.
* The latest release in this series is MariaDB Connector/Python 1.1.7, released on 10 Jul 2023.
