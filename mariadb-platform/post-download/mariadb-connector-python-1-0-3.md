...
* MariaDB Connector/Python 1.0.3 was released on 7 Oct 2020.
* Please note: Newer releases exist within the MariaDB Connector/Python 1.0 release series.
* [What's new in this release?](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/connectors/python/mariadb-connector-python-1-0-release-notes/mariadb-connector-python-1-0-3-release-notes)
...
* The prior release in this series was MariaDB Connector/Python 1.0.2, released on 18 Sep 2020.
* This release (MariaDB Connector/Python 1.0.3) was released on 7 Oct 2020.
* The next release in this series is MariaDB Connector/Python 1.0.4, released on 20 Oct 2020.
