...
* MariaDB Connector/Python 1.0.5 was released on 25 Nov 2020.
* Please note: Newer releases exist within the MariaDB Connector/Python 1.0 release series.
* [What's new in this release?](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/connectors/python/mariadb-connector-python-1-0-release-notes/mariadb-connector-python-1-0-5-release-notes)
...
* The prior release in this series was MariaDB Connector/Python 1.0.4, released on 20 Oct 2020.
* This release (MariaDB Connector/Python 1.0.5) was released on 25 Nov 2020.
* The next release in this series is MariaDB Connector/Python 1.0.6, released on 24 Feb 2021.
