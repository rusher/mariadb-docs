...
1. [MariaDB ColumnStore AMI "MariaDB ColumnStore AMI"](#mariadb-columnstore-ami) 

  1. [New Installation and upgrades "New Installation and upgrades"](#new-installation-and-upgrades)
  1. [Amazon AWS-CLI Tool Set "Amazon AWS-CLI Tool Set"](#amazon-aws-cli-tool-set)
  1. [Amazon AWS setup and AMI Launching "Amazon AWS setup and AMI Launching"](#amazon-aws-setup-and-ami-launching) 

    1. [AWS Certifications Keys - Access and Secret Keys "AWS Certifications Keys - Access and Secret Keys"](#aws-certifications-keys-access-and-secret-keys)
  1. [Amazon IAM Role "Amazon IAM Role"](#amazon-iam-role)
  1. [AWS Management Console page "AWS Management Console page"](#aws-management-console-page) 

    1. [Amazon AMI EC2 Instance user and password setup "Amazon AMI EC2 Instance user and password setup"](#amazon-ami-ec2-instance-user-and-password-setup)
  1. [Access to Launched AMI Instance "Access to Launched AMI Instance"](#access-to-launched-ami-instance)
  1. [MariaDB ColumnStore System installation "MariaDB ColumnStore System installation"](#mariadb-columnstore-system-installation) 

    1. [MariaDB ColumnStore One Step Quick Installer Script, quick_installer_amazon.sh "MariaDB ColumnStore One Step Quick Installer Script, quick_installer_amazon.sh"](#mariadb-columnstore-one-step-quick-installer-script-quick_installer_amazonsh) 

      1. [Running quick_installer_multi_server.sh help as non-root <USER> user "Running quick_installer_multi_server.sh help as non-root <USER> user"](#running-quick_installer_multi_serversh-help-as-non-root-user-user)
      1. [Running quick_installer_multi_server.sh 1um/2pm setup as non-root <USER> user "Running quick_installer_multi_server.sh 1um/2pm setup as non-root <USER> user"](#running-quick_installer_multi_serversh-1um2pm-setup-as-non-root-user-user)
    1. [MariaDB ColumnStore Post Install Script, postConfigure "MariaDB ColumnStore Post Install Script, postConfigure"](#mariadb-columnstore-post-install-script-postconfigure)
...
1. [MariaDB Columnstore System Configuration settings "MariaDB Columnstore System Configuration settings"](#mariadb-columnstore-system-configuration-settings) 

  1. [vm.swappiness "vm.swappiness"](#vmswappiness) 
...
[index.html#cli-aws-ec2](https://docs.aws.amazon.com/cli/latest/reference/ec2/index.html#cli-aws-ec2)
...
1. ec2-associate-address
1. ec2-disassociate-address
1. ec2-create-volume
1. ec2-describe-volumes
1. ec2-detach-volume
1. ec2-attach-volume
1. ec2-delete-volume
1. ec2-create-tags
...
[introduction.html](https://docs.aws.amazon.com/IAM/latest/UserGuide/introduction.html)


[iam-policies-for-amazon-ec2.html](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/iam-policies-for-amazon-ec2.html)
...
* From AWS Console on the Instance page:
  ...
  * Select Size : Recommend using Instance type of "m4.2xlarge" type to get optimal
 performance.
...
[Installing and Configuring MariaDB ColumnStore](preparing-and-installing-mariadb-columnstore-10x/installing-and-configuring-mariadb-columnstore.md)
