...
1. [MariaDB ColumnStore One Step Quick Installer Script, quick_installer_single_server.sh "MariaDB ColumnStore One Step Quick Installer Script, quick_installer_single_server.sh"](#mariadb-columnstore-one-step-quick-installer-script-quick_installer_single_serversh) 

  1. [Running quick_installer_single_server.sh help as root user "Running quick_installer_single_server.sh help as root user"](#running-quick_installer_single_serversh-help-as-root-user)
  1. [Running quick_installer_single_server.sh as root user "Running quick_installer_single_server.sh as root user"](#running-quick_installer_single_serversh-as-root-user)
  1. [Running quick_installer_single_server.sh as non-root user "Running quick_installer_single_server.sh as non-root user"](#running-quick_installer_single_serversh-as-non-root-user)
