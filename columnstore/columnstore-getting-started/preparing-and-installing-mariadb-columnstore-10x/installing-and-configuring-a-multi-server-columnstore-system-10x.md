...
1. [MariaDB ColumnStore Post Install Script, postConfigure "MariaDB ColumnStore Post Install Script, postConfigure"](#mariadb-columnstore-post-install-script-postconfigure) 
  ...
  1. [Setup System Module Type Configuration "Setup System Module Type Configuration"](#setup-system-module-type-configuration)
  ...
  1. [Setup the Module Configuration "Setup the Module Configuration"](#setup-the-module-configuration)
...
NOTE: Local Query Feature allows the ability to query data from a single Performance
 Module. See [Local PM Query Mode](../../managing-columnstore/managing-columnstore-database-environment/configuring-columnstore-local-pm-query-mode.md) for additional information.
