...
1. [MaxScale CDC Data Adapter "MaxScale CDC Data Adapter"](#maxscale-cdc-data-adapter) 

  1. [Installation "Installation"](#installation) 

    1. [Pre-requisite: "Pre-requisite:"](#pre-requisite)
    1. [CentOS 7 "CentOS 7"](#centos-7)
    1. [Debian 9/Ubuntu Xenial: "Debian 9/Ubuntu Xenial:"](#debian-9ubuntu-xenial)
    1. [Debian 8: "Debian 8:"](#debian-8)
  1. [Usage "Usage"](#usage) 

    1. [Streaming Multiple Tables "Streaming Multiple Tables"](#streaming-multiple-tables)
    1. [Automated Table Creation on ColumnStore "Automated Table Creation on ColumnStore"](#automated-table-creation-on-columnstore)
    1. [Data Transformation Mode "Data Transformation Mode"](#data-transformation-mode)
  1. [Quick Start "Quick Start"](#quick-start)
1. [Kafka to ColumnStore Adapter "Kafka to ColumnStore Adapter"](#kafka-to-columnstore-adapter)
1. [ColumnStore - Pentaho Data Integration - Data Adapter "ColumnStore - Pentaho Data Integration - Data Adapter"](#columnstore-pentaho-data-integration-data-adapter) 

  1. [Compatibility notice "Compatibility notice"](#compatibility-notice)
  1. [Installation "Installation"](#installation) 

    1. [Ubuntu dependencies "Ubuntu dependencies"](#ubuntu-dependencies)
    1. [CentOS dependencies "CentOS dependencies"](#centos-dependencies)
    1. [Windows 10 dependencies "Windows 10 dependencies"](#windows-10-dependencies)
...
![maxscale-cdc-adapter](../.gitbook/assets/columnstore-streaming-data-adapters/+image/maxscale-cdc-adapter.jpg "maxscale-cdc-adapter") 
...
![PDI Plugin Block info graphic](../.gitbook/assets/columnstore-streaming-data-adapters/+image/cs_pdi_diagram.png "PDI Plugin Block info graphic")
...
1. extract the archive mariadb-columnstore-kettle-bulk-exporter-plugin-*.zip into your PDI installation directory $PDI-INSTALLATION/plugins.
1. copy [MariaDB's JDBC Client](https://mariadb.com/downloads/mariadb-ax/connector) mariadb-java-client-2.2.x.jar into PDI's lib directory $PDI-INSTALLATION/lib.
1. install the additional library dependencies
...
![PDI Plugin Block settings info graphic](../.gitbook/assets/columnstore-streaming-data-adapters/+image/cs_pdi_block_settings.png "PDI Plugin Block settings info graphic")
...
Information on how to prepare the *Columnstore.xml* configuration file can be found [here](columnstore-bulk-write-sdk.md).


### Usage


![PDI Plugin Block mapping info graphic](../.gitbook/assets/columnstore-streaming-data-adapters/+image/cs_pdi_block_mapping.png "PDI Plugin Block mapping info graphic")
