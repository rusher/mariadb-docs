...
1. [MariaDB ColumnStore software upgrade 1.0.2 to 1.0.3 "MariaDB ColumnStore software upgrade 1.0.2 to 1.0.3"](#mariadb-columnstore-software-upgrade-102-to-103) 
...
**Download the package mariadb-columnstore-1.0.3-1-centos#.x86_64.rpm.tar.gz to the PM1 server where you are installing MariaDB ColumnStore.** Shutdown the MariaDB ColumnStore system:
...
`<code>tar -zxf mariadb-columnstore-1.0.3-1-centos#.x86_64.rpm.tar.gz</code>`
