...
1. [MariaDB ColumnStore software upgrade 1.0.15 to 1.0.16 "MariaDB ColumnStore software upgrade 1.0.15 to 1.0.16"](#mariadb-columnstore-software-upgrade-1015-to-1016) 
...
**Download the package mariadb-columnstore-1.0.16-1-centos#.x86_64.rpm.tar.gz to the PM1 server where you are installing MariaDB ColumnStore.** Shutdown the MariaDB ColumnStore system:
...
-mariadb-columnstore-1.0.16-1.x86_64.bin.tar.gz (Binary 64-BIT)to the
