...
1. [MariaDB ColumnStore software upgrade 1.0.6 to 1.0.7 "MariaDB ColumnStore software upgrade 1.0.6 to 1.0.7"](#mariadb-columnstore-software-upgrade-106-to-107) 

  1. [Changes for 1.0.7 "Changes for 1.0.7"](#changes-for-107) 

    1. [MariaDB ColumnStore Schema Sync feature "MariaDB ColumnStore Schema Sync feature"](#mariadb-columnstore-schema-sync-feature) 

      1. [Amazon AMI Certification Keys "Amazon AMI Certification Keys"](#amazon-ami-certification-keys)
...
`<code>tar -zxf mariadb-columnstore-1.0.7-1-centos#.x86_64.rpm.tar.gz</code>`
...
`<code> tar -zxvf -mariadb-columnstore-1.0.7-1.x86_64.bin.tar.gz</code>`
