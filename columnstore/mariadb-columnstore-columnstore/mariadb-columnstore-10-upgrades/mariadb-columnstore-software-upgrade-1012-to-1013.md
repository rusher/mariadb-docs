...
1. [MariaDB ColumnStore software upgrade 1.0.12 to 1.0.13 "MariaDB ColumnStore software upgrade 1.0.12 to 1.0.13"](#mariadb-columnstore-software-upgrade-1012-to-1013) 
...
**Download the package mariadb-columnstore-1.0.13-1-centos#.x86_64.rpm.tar.gz to the PM1 server where you are installing MariaDB ColumnStore.** Shutdown the MariaDB ColumnStore system:
...
-mariadb-columnstore-1.0.13-1.x86_64.bin.tar.gz (Binary 64-BIT)to the
