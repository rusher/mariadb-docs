...
1. [MariaDB ColumnStore software upgrade 1.0.7 to 1.0.8 "MariaDB ColumnStore software upgrade 1.0.7 to 1.0.8"](#mariadb-columnstore-software-upgrade-107-to-108) 

  1. [Changes for 1.0.8 "Changes for 1.0.8"](#changes-for-108)
...
**Download the package mariadb-columnstore-1.0.8-1-centos#.x86_64.rpm.tar.gz to the PM1 server where you are installing MariaDB ColumnStore.** Shutdown the MariaDB ColumnStore system:
...
`<code>tar -zxf mariadb-columnstore-1.0.8-1-centos#.x86_64.rpm.tar.gz</code>`
...
`<code> tar -zxvf -mariadb-columnstore-1.0.8-1.x86_64.bin.tar.gz</code>`
