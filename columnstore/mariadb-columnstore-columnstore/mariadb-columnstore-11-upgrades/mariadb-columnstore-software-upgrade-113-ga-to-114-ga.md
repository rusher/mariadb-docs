...
1. [MariaDB ColumnStore software upgrade 1.1.3 GA to 1.1.4 GA "MariaDB ColumnStore software upgrade 1.1.3 GA to 1.1.4 GA"](#mariadb-columnstore-software-upgrade-113-ga-to-114-ga) 
...
**Download the package mariadb-columnstore-1.1.4-1-centos#.x86_64.rpm.tar.gz to the PM1 server where you are installing MariaDB ColumnStore.** Shutdown the MariaDB ColumnStore system:
