...
1. [MariaDB ColumnStore software upgrade 1.0.11 to 1.1.0 Beta "MariaDB ColumnStore software upgrade 1.0.11 to 1.1.0 Beta"](#mariadb-columnstore-software-upgrade-1011-to-110-beta) 
...
**Download the package mariadb-columnstore-1.1.0-1-centos#.x86_64.rpm.tar.gz to the PM1 server where you are installing MariaDB ColumnStore.** Shutdown the MariaDB ColumnStore system:
...
-mariadb-columnstore-1.1.0-1.x86_64.bin.tar.gz (Binary 64-BIT)to the
