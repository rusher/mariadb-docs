...
1. [MariaDB ColumnStore software upgrade 1.1.5 GA to 1.1.6 GA "MariaDB ColumnStore software upgrade 1.1.5 GA to 1.1.6 GA"](#mariadb-columnstore-software-upgrade-115-ga-to-116-ga) 
...
**Download the package mariadb-columnstore-1.1.6-1-centos#.x86_64.rpm.tar.gz to the PM1 server where you are installing MariaDB ColumnStore.** Shutdown the MariaDB ColumnStore system:
