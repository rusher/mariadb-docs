...
1. [MariaDB ColumnStore software upgrade 1.1.6 GA to 1.2.0 Alpha "MariaDB ColumnStore software upgrade 1.1.6 GA to 1.2.0 Alpha"](#mariadb-columnstore-software-upgrade-116-ga-to-120-alpha) 
...
**Download the package mariadb-columnstore-1.2.0-1-centos#.x86_64.rpm.tar.gz to the PM1 server where you are installing MariaDB ColumnStore.** Shutdown the MariaDB ColumnStore system:
