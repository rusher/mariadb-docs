...
1. [MariaDB ColumnStore software upgrade 1.1.6 GA to 1.2.2 GA "MariaDB ColumnStore software upgrade 1.1.6 GA to 1.2.2 GA"](#mariadb-columnstore-software-upgrade-116-ga-to-122-ga) 
...
**Download the package mariadb-columnstore-1.2.2-1-centos#.x86_64.rpm.tar.gz to the PM1 server where you are installing MariaDB ColumnStore.**
...
[mariadb-columnstore-software-upgrade-116-ga-to-122-ga.md](mariadb-columnstore-software-upgrade-116-ga-to-122-ga.md)
