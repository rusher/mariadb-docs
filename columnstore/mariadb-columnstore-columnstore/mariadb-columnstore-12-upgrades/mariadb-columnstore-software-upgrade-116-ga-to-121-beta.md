...
1. [MariaDB ColumnStore software upgrade 1.1.6 GA to 1.2.1 Beta "MariaDB ColumnStore software upgrade 1.1.6 GA to 1.2.1 Beta"](#mariadb-columnstore-software-upgrade-116-ga-to-121-beta) 

  1. [Changes in 1.2.1 "Changes in 1.2.1"](#changes-in-121) 
...
As part of the upgrade process to 1.2.1, the user is required to run the mysql_upgrade script on all of the following nodes.
...
**Download the package mariadb-columnstore-1.2.1-1-centos#.x86_64.rpm.tar.gz to the PM1 server where you are installing MariaDB ColumnStore.**
...
[mariadb-columnstore-software-upgrade-116-ga-to-121-beta.md](mariadb-columnstore-software-upgrade-116-ga-to-121-beta.md)
...
* Download the package into the /usr/local directory mariadb-columnstore-1.2.1-1.x86_64.bin.tar.gz
...
* Download the package into the user's home directory mariadb-columnstore-1.2.1-1.x86_64.bin.tar.gz
