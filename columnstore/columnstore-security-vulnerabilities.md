...
The appropriate release notes listed [here](/en/columnstore-release-notes/) document CVEs fixed within a given release. Additional information can also be found at [Security Vulnerabilities Fixed in MariaDB](../general-resources/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/security-vulnerabilities-in-oracle-mysql-that-did-not-exist-in-mariadb.md).
