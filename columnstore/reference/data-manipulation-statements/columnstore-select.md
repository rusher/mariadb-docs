...
The WHERE clause filters data retrieval based on criteria. Note that _column\_alias_ cannot be used in the WHERE clause. The following statement returns rows in the region table where the region = ‘ASIA’:
