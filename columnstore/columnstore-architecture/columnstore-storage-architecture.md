...
MariaDB ColumnStore supports logging committed transaction to the server's [Binary Log](../../maxscale/mariadb-maxscale-14/maxscale-14-routers/binlogrouter.md).
