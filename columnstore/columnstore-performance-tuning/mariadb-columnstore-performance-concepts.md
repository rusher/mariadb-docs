...
1. [Data loading "Data loading"](#data-loading)
1. [Query execution "Query execution"](#query-execution)
1. [ColumnStore query execution paradigms "ColumnStore query execution paradigms"](#columnstore-query-execution-paradigms) 

  1. [Data scanning and filtering "Data scanning and filtering"](#data-scanning-and-filtering)
  1. [Joins "Joins"](#joins)
  1. [Aggregations "Aggregations"](#aggregations)
  1. [Order by and limit "Order by and limit"](#order-by-and-limit)
  1. [Complex queries "Complex queries"](#complex-queries)
  1. [Partitioning "Partitioning"](#partitioning)
