...
1. [MariaDB ColumnStore software upgrade 1.0.13 to 1.0.14 "MariaDB ColumnStore software upgrade 1.0.13 to 1.0.14"](#mariadb-columnstore-software-upgrade-1013-to-1014) 
...
**Download the package mariadb-columnstore-1.0.14-1-centos#.x86_64.rpm.tar.gz to the PM1 server where you are installing MariaDB ColumnStore.** Shutdown the MariaDB ColumnStore system:
