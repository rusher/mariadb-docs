...
1. [MariaDB ColumnStore software upgrade 1.0.9 to 1.0.10 "MariaDB ColumnStore software upgrade 1.0.9 to 1.0.10"](#mariadb-columnstore-software-upgrade-109-to-1010) 
...
**Download the package mariadb-columnstore-1.0.10-1-centos#.x86_64.rpm.tar.gz to the PM1 server where you are installing MariaDB ColumnStore.** Shutdown the MariaDB ColumnStore system:
