...
1. [Basic user management "Basic user management"](#basic-user-management)
1. [PAM Unix authentication "PAM Unix authentication"](#pam-unix-authentication)
1. [PAM LDAP authentication "PAM LDAP authentication"](#pam-ldap-authentication)
1. [PAM LDAP group authentication "PAM LDAP group authentication"](#pam-ldap-group-authentication)
1. [User Resource Allocation "User Resource Allocation"](#user-resource-allocation) 

  1. [User Priority Management "User Priority Management"](#user-priority-management) 

    1. [Enabling User Priority "Enabling User Priority"](#enabling-user-priority)
  1. [User Priority Processing "User Priority Processing"](#user-priority-processing)
...
The PAM plugin can also be utilized for LDAP group authentication. A good reference written by a MariaDB support engineer on setting up OpenLDAP can be found [here](https://www.geoffmontee.com/configuring-ldap-authentication-and-group-mapping-with-mariadb/). Some additional notes that may be of help:
