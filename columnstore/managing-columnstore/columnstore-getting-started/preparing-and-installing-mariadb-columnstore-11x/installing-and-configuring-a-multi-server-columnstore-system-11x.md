...
1. [Preparing to Install "Preparing to Install"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#preparing-to-install)
2. [ColumnStore Cluster Test Tool "ColumnStore Cluster Test Tool"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#columnstore-cluster-test-tool)
3. [MariaDB ColumnStore One Step Quick Installer Script, quick\_installer\_multi\_server.sh "MariaDB ColumnStore One Step Quick Installer Script, quick\_installer\_multi\_server.sh"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#mariadb-columnstore-one-step-quick-installer-script-quick_installer_multi_serversh)
4. [Running quick\_installer\_multi\_server.sh help as root user "Running quick\_installer\_multi\_server.sh help as root user"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#running-quick_installer_multi_serversh-help-as-root-user)
5. [Running quick\_installer\_multi\_server.sh for a 1um/1pm non-distributed system as root user "Running quick\_installer\_multi\_server.sh for a 1um/1pm non-distributed system as root user"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#running-quick_installer_multi_serversh-for-a-1um1pm-non-distributed-system-as-root-user)
6. [Running quick\_installer\_multi\_server.sh for a 2 pm combo distributed install system as non-root user "Running quick\_installer\_multi\_server.sh for a 2 pm combo distributed install system as non-root user"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#running-quick_installer_multi_serversh-for-a-2-pm-combo-distributed-install-system-as-non-root-user)
7. [MariaDB ColumnStore Post Install Script, postConfigure "MariaDB ColumnStore Post Install Script, postConfigure"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#mariadb-columnstore-post-install-script-postconfigure)
8. [Common Installation Examples "Common Installation Examples"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#common-installation-examples)
9. [Post Configuration tool "Post Configuration tool"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#post-configuration-tool)
10. [postConfigure script "postConfigure script"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#postconfigure-script)
11. [postConfigure Install options "postConfigure Install options"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#postconfigure-install-options)
...
```
1. [Non-Distributed Install "Non-Distributed Install"](#non-distributed-install)
```

1. [Running postConfigure "Running postConfigure"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#running-postconfigure)
...
1. [postConfigure examples "postConfigure examples"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#postconfigure-examples)

```
1. [Distributed Install example "Distributed Install example"](#distributed-install-example)
```

```
1. [Non-Distributed Install example "Non-Distributed Install example"](#non-distributed-install-example)
1. [Data Replication Install example "Data Replication Install example"](#data-replication-install-example)
```

1. [MariaDB Columnstore Memory Configuration "MariaDB Columnstore Memory Configuration"](installing-and-configuring-a-multi-server-columnstore-system-11x.md#mariadb-columnstore-memory-configuration)

## Preparing to Install

After the MariaDB ColumnStore servers have been setup based on the [Preparing for Installations](../preparing-and-installing-mariadb-columnstore-10x/preparing-for-columnstore-installation-10x.md) document and the required MariaDB ColumnStore Packages have been Installed, use of the following option to configure and install MariaDB ColumnStore:
...
[preparing-for-columnstore-installation-11x.md](preparing-for-columnstore-installation-11x.md)
...
[system-troubleshooting-mariadb-columnstore.md](../../system-troubleshooting-mariadb-columnstore.md)
