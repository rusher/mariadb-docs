...
1. [Prerequisite "Prerequisite"](preparing-for-columnstore-installation-11x.md#prerequisite)
2. [Configuration preparation "Configuration preparation"](preparing-for-columnstore-installation-11x.md#configuration-preparation)
3. [MariaDB ColumnStore port usage "MariaDB ColumnStore port usage"](preparing-for-columnstore-installation-11x.md#mariadb-columnstore-port-usage)
4. [Storage and Database files (DBRoots) "Storage and Database files (DBRoots)"](preparing-for-columnstore-installation-11x.md#storage-and-database-files-dbroots)
5. [Performance optimization considerations "Performance optimization considerations"](preparing-for-columnstore-installation-11x.md#performance-optimization-considerations)
6. [System settings considerations "System settings considerations"](preparing-for-columnstore-installation-11x.md#system-settings-considerations)
7. [Firewall considerations "Firewall considerations"](preparing-for-columnstore-installation-11x.md#firewall-considerations)
8. [Package dependencies "Package dependencies"](preparing-for-columnstore-installation-11x.md#package-dependencies)
9. [Boost libraries "Boost libraries"](preparing-for-columnstore-installation-11x.md#boost-libraries)
10. [Other packages "Other packages"](preparing-for-columnstore-installation-11x.md#other-packages)
11. [Data Redundancy packages "Data Redundancy packages"](preparing-for-columnstore-installation-11x.md#data-redundancy-packages)
12. [System Logging Package "System Logging Package"](preparing-for-columnstore-installation-11x.md#system-logging-package)
13. [Choosing the type of initial download/install "Choosing the type of initial download/install"](preparing-for-columnstore-installation-11x.md#choosing-the-type-of-initial-downloadinstall)
14. [Where to Install "Where to Install"](preparing-for-columnstore-installation-11x.md#where-to-install)
15. [Root user installs "Root user installs"](preparing-for-columnstore-installation-11x.md#root-user-installs)
16. [Initial download/install of MariaDB ColumnStore Package Repositories "Initial download/install of MariaDB ColumnStore Package Repositories"](preparing-for-columnstore-installation-11x.md#initial-downloadinstall-of-mariadb-columnstore-package-repositories)
17. [Initial download/install of MariaDB ColumnStore Package with the AX package "Initial download/install of MariaDB ColumnStore Package with the AX package"](preparing-for-columnstore-installation-11x.md#initial-downloadinstall-of-mariadb-columnstore-package-with-the-ax-package)
18. [Initial download/install of MariaDB ColumnStore RPMs "Initial download/install of MariaDB ColumnStore RPMs"](preparing-for-columnstore-installation-11x.md#initial-downloadinstall-of-mariadb-columnstore-rpms)
19. [Initial download/install of MariaDB ColumnStore binary package "Initial download/install of MariaDB ColumnStore binary package"](preparing-for-columnstore-installation-11x.md#initial-downloadinstall-of-mariadb-columnstore-binary-package)
20. [Initial download/install of MariaDB ColumnStore DEB package "Initial download/install of MariaDB ColumnStore DEB package"](preparing-for-columnstore-installation-11x.md#initial-downloadinstall-of-mariadb-columnstore-deb-package)
21. [Non-root user installs "Non-root user installs"](preparing-for-columnstore-installation-11x.md#non-root-user-installs)
22. [Creation of the non-root user (by root user) "Creation of the non-root user (by root user)"](preparing-for-columnstore-installation-11x.md#creation-of-the-non-root-user-by-root-user)
23. [Update sudo configuration (by root user) "Update sudo configuration (by root user)"](preparing-for-columnstore-installation-11x.md#update-sudo-configuration-by-root-user)
24. [Set the user file limits (by root user) "Set the user file limits (by root user)"](preparing-for-columnstore-installation-11x.md#set-the-user-file-limits-by-root-user)
25. [Modify fstab if using SAN Mounted Database Files (by root user) "Modify fstab if using SAN Mounted Database Files (by root user)"](preparing-for-columnstore-installation-11x.md#modify-fstab-if-using-san-mounted-database-files-by-root-user)
26. [Uninstall existing MariaDB Columnstore installation, if needed (by root user) "Uninstall existing MariaDB Columnstore installation, if needed (by root user)"](preparing-for-columnstore-installation-11x.md#uninstall-existing-mariadb-columnstore-installation-if-needed-by-root-user)
27. [Update permissions on certain directories that MariaDB Columnstore writes (by root user) "Update permissions on certain directories that MariaDB Columnstore writes (by root user)"](preparing-for-columnstore-installation-11x.md#update-permissions-on-certain-directories-that-mariadb-columnstore-writes-by-root-user)
28. [MariaDB Columnstore installation (by non-root user) "MariaDB Columnstore installation (by non-root user)"](preparing-for-columnstore-installation-11x.md#mariadb-columnstore-installation-by-non-root-user)
29. [Post-installation (by root user) "Post-installation (by root user)"](preparing-for-columnstore-installation-11x.md#post-installation-by-root-user)
30. [ColumnStore Cluster Test Tool "ColumnStore Cluster Test Tool"](preparing-for-columnstore-installation-11x.md#columnstore-cluster-test-tool)
31. [ColumnStore Configuration and Installation Tool "ColumnStore Configuration and Installation Tool"](preparing-for-columnstore-installation-11x.md#columnstore-configuration-and-installation-tool)
...
The MariaDB ColumnStore binary package can be installed from the MariaDB Downloads page.on the "all versions" link and then step down into the OS version to the bottom level directory where you will see 2 packages, one for rpm/deb and the bother for the binary. Select the binary package to download.
