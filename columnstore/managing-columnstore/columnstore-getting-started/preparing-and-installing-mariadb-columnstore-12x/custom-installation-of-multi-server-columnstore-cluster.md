...
1. [Custom Install Wizard: postConfigure "Custom Install Wizard: postConfigure"](custom-installation-of-multi-server-columnstore-cluster.md#custom-install-wizard-postconfigure)
2. [Running postConfigure as root user "Running postConfigure as root user"](custom-installation-of-multi-server-columnstore-cluster.md#running-postconfigure-as-root-user)
3. [Running postConfigure as non-root user "Running postConfigure as non-root user"](custom-installation-of-multi-server-columnstore-cluster.md#running-postconfigure-as-non-root-user)
4. [Distributed vs Non-Distributed options "Distributed vs Non-Distributed options"](custom-installation-of-multi-server-columnstore-cluster.md#distributed-vs-non-distributed-options)
...
1. [Storage Configuration Options "Storage Configuration Options"](custom-installation-of-multi-server-columnstore-cluster.md#storage-configuration-options)
2. [Common Installation Examples "Common Installation Examples"](custom-installation-of-multi-server-columnstore-cluster.md#common-installation-examples)
...
1. [MariaDB Columnstore Memory Configuration "MariaDB Columnstore Memory Configuration"](custom-installation-of-multi-server-columnstore-cluster.md#mariadb-columnstore-memory-configuration)
...
Before running the postConfigure script, you must have done [Preparing for ColumnStore Installation 1.2.x](preparing-for-columnstore-installation-120.md) steps and the pre-requisite validation using [ColumnStore Cluster Tester Tool](../preparing-and-installing-mariadb-columnstore-11x/mariadb-columnstore-cluster-test-tool.md). Once you have done these steps, then run the postConfigure script from the node designated as PM1.
...
Before starting postConfigure for Non-Distributed Install, please ensure you have installed the MariaDB ColumnStore packages on all the nodes per [Preparation Steps](preparing-for-columnstore-installation-120.md). And on the non-pm1 nodes startup the ColumnStore service before running postConfigure.
...
[preparing-for-and-installing-columnstore-version-121.md](preparing-for-and-installing-columnstore-version-121.md)
