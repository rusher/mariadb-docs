...
1. [Prerequisite "Prerequisite"](preparing-for-columnstore-installation-120.md#prerequisite)
2. [Configuration preparation "Configuration preparation"](preparing-for-columnstore-installation-120.md#configuration-preparation)
3. [MariaDB ColumnStore port usage "MariaDB ColumnStore port usage"](preparing-for-columnstore-installation-120.md#mariadb-columnstore-port-usage)
4. [Storage and Database files (DBRoots) "Storage and Database files (DBRoots)"](preparing-for-columnstore-installation-120.md#storage-and-database-files-dbroots)
5. [Performance optimization considerations "Performance optimization considerations"](preparing-for-columnstore-installation-120.md#performance-optimization-considerations)
6. [System settings considerations "System settings considerations"](preparing-for-columnstore-installation-120.md#system-settings-considerations)
7. [Firewall considerations "Firewall considerations"](preparing-for-columnstore-installation-120.md#firewall-considerations)
8. [Package dependencies "Package dependencies"](preparing-for-columnstore-installation-120.md#package-dependencies)
9. [Boost libraries "Boost libraries"](preparing-for-columnstore-installation-120.md#boost-libraries)
10. [Other packages "Other packages"](preparing-for-columnstore-installation-120.md#other-packages)
11. [Data Redundancy packages "Data Redundancy packages"](preparing-for-columnstore-installation-120.md#data-redundancy-packages)
12. [System Logging Package "System Logging Package"](preparing-for-columnstore-installation-120.md#system-logging-package)
13. [Choosing the type of initial download/install "Choosing the type of initial download/install"](preparing-for-columnstore-installation-120.md#choosing-the-type-of-initial-downloadinstall)
14. [Where to Install "Where to Install"](preparing-for-columnstore-installation-120.md#where-to-install)
15. [Root user installs "Root user installs"](preparing-for-columnstore-installation-120.md#root-user-installs)
16. [Initial download/install of MariaDB ColumnStore Package Repositories "Initial download/install of MariaDB ColumnStore Package Repositories"](preparing-for-columnstore-installation-120.md#initial-downloadinstall-of-mariadb-columnstore-package-repositories)
17. [Initial download/install of MariaDB ColumnStore Package with the AX package "Initial download/install of MariaDB ColumnStore Package with the AX package"](preparing-for-columnstore-installation-120.md#initial-downloadinstall-of-mariadb-columnstore-package-with-the-ax-package)
18. [Initial download/install of MariaDB ColumnStore RPMs "Initial download/install of MariaDB ColumnStore RPMs"](preparing-for-columnstore-installation-120.md#initial-downloadinstall-of-mariadb-columnstore-rpms)
19. [Initial download/install of MariaDB ColumnStore binary package "Initial download/install of MariaDB ColumnStore binary package"](preparing-for-columnstore-installation-120.md#initial-downloadinstall-of-mariadb-columnstore-binary-package)
20. [Initial download/install of MariaDB ColumnStore DEB package "Initial download/install of MariaDB ColumnStore DEB package"](preparing-for-columnstore-installation-120.md#initial-downloadinstall-of-mariadb-columnstore-deb-package)
21. [Non-root user installs "Non-root user installs"](preparing-for-columnstore-installation-120.md#non-root-user-installs)
22. [Creation of the non-root user (by root user) "Creation of the non-root user (by root user)"](preparing-for-columnstore-installation-120.md#creation-of-the-non-root-user-by-root-user)
23. [Update sudo configuration (by root user) "Update sudo configuration (by root user)"](preparing-for-columnstore-installation-120.md#update-sudo-configuration-by-root-user)
24. [Set the user file limits (by root user) "Set the user file limits (by root user)"](preparing-for-columnstore-installation-120.md#set-the-user-file-limits-by-root-user)
25. [Modify fstab if using SAN Mounted Database Files (by root user) "Modify fstab if using SAN Mounted Database Files (by root user)"](preparing-for-columnstore-installation-120.md#modify-fstab-if-using-san-mounted-database-files-by-root-user)
26. [Uninstall existing MariaDB Columnstore installation, if needed (by root user) "Uninstall existing MariaDB Columnstore installation, if needed (by root user)"](preparing-for-columnstore-installation-120.md#uninstall-existing-mariadb-columnstore-installation-if-needed-by-root-user)
27. [Update permissions on certain directories that MariaDB Columnstore writes (by root user) "Update permissions on certain directories that MariaDB Columnstore writes (by root user)"](preparing-for-columnstore-installation-120.md#update-permissions-on-certain-directories-that-mariadb-columnstore-writes-by-root-user)
28. [MariaDB Columnstore installation (by non-root user) "MariaDB Columnstore installation (by non-root user)"](preparing-for-columnstore-installation-120.md#mariadb-columnstore-installation-by-non-root-user)
29. [Post-installation (by root user) "Post-installation (by root user)"](preparing-for-columnstore-installation-120.md#post-installation-by-root-user)
30. [ColumnStore Cluster Test Tool "ColumnStore Cluster Test Tool"](preparing-for-columnstore-installation-120.md#columnstore-cluster-test-tool)
31. [ColumnStore Configuration and Installation Tool "ColumnStore Configuration and Installation Tool"](preparing-for-columnstore-installation-120.md#columnstore-configuration-and-installation-tool)
...
DBRoots are the MariaDB ColumnStore Datafile containers or directories. For example on a root install, they are /usr/local/mariadb/columnstore/data where N is the dbroot number.
...
If you are using local disk to store the database files, the DBRoot directories will be created under the installation directory, for example /usr/local/mariadb/columnstore/data where N is the DBRoot number.\
...
* Cache memory settings:\
  To optimize Linux to cache directories and inodes the vm.vfs\_cache\_pressure can be set to a lower value than 100 to attempt to retain caches for inode and directory structures. This will help improve read performance. A value of 10 is suggested. The following commands must all be run as the root user or with sudo.
...
**Download the package mariadb-columnstore-release#.x86\_64.tar.gz (RHEL5 64-BIT) to the server where you are installing MariaDB ColumnStore and place in the /root directory.** Unpack the tarball, which will generate multiple RPMs that will reside in the\
/root/ directory.

`tar -zxf mariadb-columnstore-release#.x86_64.tar`

**Install the RPMs. The MariaDB ColumnStore software will be installed in /usr/local/.`rpm -ivh mariadb-columnstore*release#*.rpm`**

**Initial download/install of MariaDB ColumnStore binary package**

The MariaDB ColumnStore binary package can be installed from the MariaDB Downloads page.on the "all versions" link and then step down into the OS version to the bottom level directory where you will see 2 packages, one for rpm/deb and the other for the binary. Select the binary package to download.
...
2. Unpack the tarball, which will generate DEBs.`tar -zxf mariadb-columnstore-release#.amd64.deb.tar.gz`
3. Install the MariaDB ColumnStore DEBs. The MariaDB ColumnStore software will be installed in /usr/\
   local/.`dpkg -i mariadb-columnstore*release#*.deb`
...
* Choose an installation directory in which the non-root user has full read-write access. The\
  ...
  '/home/mysql/mariadb/columnstore'.\
...
* Now place the MariaDB Columnstore binary tar file in your home directory on the host you will be using as\
  ...
  tar -xf mariadb-columnstore-release#.x86\_64.bin.tar.gz
