...
1. [ColumnStore Cluster Test Tool "ColumnStore Cluster Test Tool"](installing-and-configuring-a-multi-server-columnstore-system-10x.md#columnstore-cluster-test-tool)
2. [MariaDB ColumnStore Post Install Script, postConfigure "MariaDB ColumnStore Post Install Script, postConfigure"](installing-and-configuring-a-multi-server-columnstore-system-10x.md#mariadb-columnstore-post-install-script-postconfigure)
3. [Common Installation Examples "Common Installation Examples"](installing-and-configuring-a-multi-server-columnstore-system-10x.md#common-installation-examples)
4. [Running postConfigure as root user: "Running postConfigure as root user:"](installing-and-configuring-a-multi-server-columnstore-system-10x.md#running-postconfigure-as-root-user)
5. [Running postConfigure as non-root user: "Running postConfigure as non-root user:"](installing-and-configuring-a-multi-server-columnstore-system-10x.md#running-postconfigure-as-non-root-user)
6. [Setup System Server Type Configuration "Setup System Server Type Configuration"](installing-and-configuring-a-multi-server-columnstore-system-10x.md#setup-system-server-type-configuration)
7. [Setup System Module Type Configuration "Setup System Module Type Configuration"](installing-and-configuring-a-multi-server-columnstore-system-10x.md#setup-system-module-type-configuration)
8. [Setup High Availability Data Storage Mount Configuration "Setup High Availability Data Storage Mount Configuration"](installing-and-configuring-a-multi-server-columnstore-system-10x.md#setup-high-availability-data-storage-mount-configuration)
9. [Setup the Module Configuration "Setup the Module Configuration"](installing-and-configuring-a-multi-server-columnstore-system-10x.md#setup-the-module-configuration)
10. [Performing Configuration Setup and MariaDB Columnstore Startup "Performing Configuration Setup and MariaDB Columnstore Startup"](installing-and-configuring-a-multi-server-columnstore-system-10x.md#performing-configuration-setup-and-mariadb-columnstore-startup)
...
Module. See [Local PM Query Mode](../../managing-columnstore-database-environment/configuring-columnstore-local-pm-query-mode.md) for additional information.
