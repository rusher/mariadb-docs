# Installing and Configuring a Single-Server ColumnStore
...
1. [MariaDB ColumnStore One Step Quick Installer Script, quick\_installer\_single\_server.sh "MariaDB ColumnStore One Step Quick Installer Script, quick\_installer\_single\_server.sh"](installing-and-configuring-mariadb-columnstore.md#mariadb-columnstore-one-step-quick-installer-script-quick_installer_single_serversh)
2. [Running quick\_installer\_single\_server.sh help as root user "Running quick\_installer\_single\_server.sh help as root user"](installing-and-configuring-mariadb-columnstore.md#running-quick_installer_single_serversh-help-as-root-user)
3. [Running quick\_installer\_single\_server.sh as root user "Running quick\_installer\_single\_server.sh as root user"](installing-and-configuring-mariadb-columnstore.md#running-quick_installer_single_serversh-as-root-user)
4. [Running quick\_installer\_single\_server.sh as non-root user "Running quick\_installer\_single\_server.sh as non-root user"](installing-and-configuring-mariadb-columnstore.md#running-quick_installer_single_serversh-as-non-root-user)
5. [MariaDB ColumnStore Post Install Script, postConfigure "MariaDB ColumnStore Post Install Script, postConfigure"](installing-and-configuring-mariadb-columnstore.md#mariadb-columnstore-post-install-script-postconfigure)
6. [Common Installation Examples "Common Installation Examples"](installing-and-configuring-mariadb-columnstore.md#common-installation-examples)
7. [Running postConfigure as root user: "Running postConfigure as root user:"](installing-and-configuring-mariadb-columnstore.md#running-postconfigure-as-root-user)
8. [Running postConfigure as non-root user: "Running postConfigure as non-root user:"](installing-and-configuring-mariadb-columnstore.md#running-postconfigure-as-non-root-user)
9. [Setup System Server Type Configuration "Setup System Server Type Configuration"](installing-and-configuring-mariadb-columnstore.md#setup-system-server-type-configuration)
10. [Setup High Availability Data Storage Mount Configuration "Setup High Availability Data Storage Mount Configuration"](installing-and-configuring-mariadb-columnstore.md#setup-high-availability-data-storage-mount-configuration)
11. [Performing Configuration Setup and MariaDB Columnstore Startup "Performing Configuration Setup and MariaDB Columnstore Startup"](installing-and-configuring-mariadb-columnstore.md#performing-configuration-setup-and-mariadb-columnstore-startup)
12. [MariaDB Columnstore Memory Configuration "MariaDB Columnstore Memory Configuration"](installing-and-configuring-mariadb-columnstore.md#mariadb-columnstore-memory-configuration)
