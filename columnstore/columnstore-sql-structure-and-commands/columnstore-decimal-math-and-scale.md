...
1. [Enable/Disable decimal to double math "Enable/Disable decimal to double math"](#enabledisable-decimal-to-double-math)
1. [ColumnStore decimal scale "ColumnStore decimal scale"](#columnstore-decimal-scale) 

  1. [Enable/disable decimal scale "Enable/disable decimal scale"](#enabledisable-decimal-scale)
  1. [Set decimal scale level "Set decimal scale level"](#set-decimal-scale-level)
