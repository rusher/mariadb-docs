...
Conditions must be declared after [local variables](declare-variable.md), but before [CURSORs](/en/programmatic-and-compound-statements-cursors/) and [HANDLERs](declare-handler.md).
...
codes, see [MariaDB Error Codes](/en/mariadb-error-codes/).