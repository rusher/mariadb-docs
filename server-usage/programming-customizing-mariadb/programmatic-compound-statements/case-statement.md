...
The text on this page describes the `CASE` statement for [stored programs](/kb/en/stored-programs-and-views/). See the [CASE OPERATOR](../../../reference/sql-statements-and-structure/sql-statements/built-in-functions/control-flow-functions/case-operator.md) for details on the CASE operator outside of [stored programs](/kb/en/stored-programs-and-views/).
