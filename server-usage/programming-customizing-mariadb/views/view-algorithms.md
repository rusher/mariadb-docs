...
The [CREATE VIEW](create-view.md) statement accepts an optional ALGORITHM clause, an extension to standard SQL for [Views](/en/views/).
...
* [HAVING](../../replication-cluster-multi-master/standard-replication/selectively-skipping-replication-of-binlog-events.md)
* [LIMIT](../../replication-cluster-multi-master/standard-replication/selectively-skipping-replication-of-binlog-events.md#limit)
* [GROUP BY](../../replication-cluster-multi-master/standard-replication/selectively-skipping-replication-of-binlog-events.md#group-by)
* [DISTINCT](../../replication-cluster-multi-master/standard-replication/selectively-skipping-replication-of-binlog-events.md#distinct)
...
* An aggregate function, such as [MAX()](../../../security/user-account-management/limiting-size-of-created-disk-temporary-files-and-tables/max_tmp_total_space_usage-system-variable.md), [MIN()](../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/joins-subqueries/minus.md), [SUM()](../../../reference/sql-statements-and-structure/sql-statements/built-in-functions/aggregate-functions/sum.md) or [COUNT()](../../../reference/sql-statements-and-structure/sql-statements/built-in-functions/aggregate-functions/count.md)
