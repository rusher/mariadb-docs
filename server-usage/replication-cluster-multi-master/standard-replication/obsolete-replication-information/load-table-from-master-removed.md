...
[MyISAM](../../../../clients-and-utilities/myisam-clients-and-utilities/myisamchk-table-information.md) and [ARCHIVE](/en/archive/) tables only. With mysqldump, you can create SQL dumps on the
...
connecting to the master server must have the `RELOAD` and
