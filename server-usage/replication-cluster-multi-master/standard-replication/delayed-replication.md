...
Delayed replication is enabled using the MASTER_DELAY option to [CHANGE MASTER](../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/replication-commands/change-master-to.md):
...
# Fields in [SHOW SLAVE STATUS](/kb/en/show-slave-status/) are associated with delayed replication
