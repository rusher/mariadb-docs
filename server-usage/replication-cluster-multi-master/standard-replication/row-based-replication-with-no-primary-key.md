...
MariaDB improves on row-based [replication](/en/standard-replication/) (see [binary log formats](../../../server-management/server-monitoring-logs/binary-log/binary-log-formats.md)) of tables which have no primary key
...
* Else, a choice is made among any normal indexes on the table (e.g. a
 [FULLTEXT](/en/full-text-indexes/) index is not considered).
...
Prior to [MariaDB 5.3](/en/what-is-mariadb-53/), the slave would always choose the first index without
...
replication to break in this case; this was also fixed in [MariaDB 5.3](/en/what-is-mariadb-53/).
