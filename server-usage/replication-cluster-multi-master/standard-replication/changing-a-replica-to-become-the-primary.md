...
[SHOW MASTER STATUS](/kb/en/show-master-status/) and `gtid_binlog_pos`, as
...
If you are using the [MariaDB MaxScale proxy](https://app.gitbook.com/s/0pSbu5DcMSW4KwAkUcmX/maxscale-troubleshooting), then you don't
...
* [CHANGE MASTER TO](../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/replication-commands/change-master-to.md) command
