...
[MariaDB replication](/kb/en/high-availability-performance-tuning-mariadb-replication/) and [MariaDB Galera Cluster](../galera-cluster-status-variables.md) can be used together. However, there are some things that have to be taken into account.

#

# Tutorials

If you want to use [MariaDB replication](/kb/en/high-availability-performance-tuning-mariadb-replication/) and [MariaDB Galera Cluster](../galera-cluster-status-variables.md) together, then the following tutorials may be useful:
