...
execution of `[SELECT](../../standard-replication/selectively-skipping-replication-of-binlog-events.md)` statements which examine too many rows, and
thus use too many resources. This is achieved through an extension of the
`[LIMIT](../../standard-replication/selectively-skipping-replication-of-binlog-events.md#limit)` clause —
...
* If a query is `[EXPLAIN](../../../../clients-and-utilities/explain-analyzer.md)`-ed.
