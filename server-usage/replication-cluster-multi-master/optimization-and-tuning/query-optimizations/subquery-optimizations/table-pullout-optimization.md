...
If one runs [EXPLAIN](../../../../../clients-and-utilities/explain-analyzer.md) for the above query in MySQL 5.1-5.6 or [MariaDB 5.1](/en/what-is-mariadb-51/)-5.2, they'll get this plan:
...
If one runs the same query in [MariaDB 5.3](/en/what-is-mariadb-53/), they will get this plan:
