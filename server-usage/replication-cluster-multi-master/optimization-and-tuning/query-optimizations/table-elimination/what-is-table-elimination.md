...
they are querying [highly-normalized](https://app.gitbook.com/s/iJPrPCGi329TSR8WIXJW/learning-and-training/training-and-tutorials/intermediate-mariadb-articles/database-theory/database-normalization/database-normalization-3rd-normal-form) data.
...
![actor-attrs](/en/what-is-table-elimination/+image/actor-attrs "actor-attrs")
