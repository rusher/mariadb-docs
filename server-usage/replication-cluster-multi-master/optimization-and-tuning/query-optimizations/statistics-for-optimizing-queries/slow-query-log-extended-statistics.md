...
* `All` (From [MariaDB 10.6.16](/kb/en/mariadb-10616-release-notes/))
...
* `Innodb` (From [MariaDB 10.6.15](/kb/en/mariadb-10615-release-notes/). Before that this option did nothing)

 * Kept for compatibility. Same as `engine`.
* `engine` (From [MariaDB 10.6.15](/kb/en/mariadb-10615-release-notes/))
...
* `Warnings` (From [MariaDB 10.6.16](/kb/en/mariadb-10616-release-notes/))
...
* `filesort_priority_queue` (from [MariaDB 10.3.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-3-series/mariadb-1032-release-notes)) 
...
* `not_using_index` (From [MariaDB 10.3.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-3-series/mariadb-1031-release-notes))
