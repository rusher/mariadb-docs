...
Compressions plugins were added in a [MariaDB 10.7.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-7-series/mariadb-1070-release-notes) preview release.

The various MariaDB storage engines, such as [InnoDB](../../../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/innodb-encryption/innodb-encryption-troubleshooting.md), [RocksDB](../../../../reference/storage-engines/myrocks/myrocks-and-replication.md), [Mroonga](../../../../reference/storage-engines/mroonga/mroonga-status-variables.md), can use different compression libraries.
