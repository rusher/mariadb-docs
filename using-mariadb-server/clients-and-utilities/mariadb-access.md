...
Prior to [MariaDB 10.5](https://mariadb.com/kb/en/what-is-mariadb-105/), the client used to be called `mysqlaccess`, and can still be accessed under this name, via a symlink in Linux, or an alternate binary in Windows.
