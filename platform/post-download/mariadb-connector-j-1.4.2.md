...
* [What's new in this release?](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/connectors/java/1.4/1.4.2)
* This release is Withdrawn maturity. Please see the [Release Notes](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/connectors/java/1.4/1.4.2) for details on why this release should not be used. Only Stable (GA) releases should be used in production.
