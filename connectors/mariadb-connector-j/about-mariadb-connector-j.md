...
* Description: If `useServerPrepStmts` is enabled, defined queries larger than this size (in characters) will not be cached.&#x20;
* Data Type: `integer`
* Default Value: `2048` (Note: Default was `256` in version 2.x)&#x20;
* Introduced: 1.3.0
