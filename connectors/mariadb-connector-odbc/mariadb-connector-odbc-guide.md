...
Or if the server has the [pam\_use\_cleartext\_plugin](https://app.gitbook.com/s/SsmexDFPv2xG2OTyO5yV/reference/plugins/authentication-plugins/authentication-with-pluggable-authentication-modules-pam/authentication-plugin-pam#pam_use_cleartext_plugin) system variable set, then you might see this error instead:
