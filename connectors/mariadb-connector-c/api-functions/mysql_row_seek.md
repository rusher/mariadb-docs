---
description: >-
  mysql_row_seek repositions the row cursor in a buffered MariaDB result set to
  an arbitrary offset, returning the previous row position as a
  MYSQL_ROW_OFFSET.
---
...
Positions the row cursor to an arbitrary row in a result set which was obtained by [mysql\_store\_result()](mysql_store_result.md).&#x20;
