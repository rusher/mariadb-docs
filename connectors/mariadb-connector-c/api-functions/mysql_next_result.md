...
Prepares next result set from a previous call to [mysql\_real\_query()](mysql_real_query.md) which can be retrieved by [mysql\_store\_result()](mysql_store_result.md) or [mysql\_use\_result()](mysql_use_result.md).&#x20;
