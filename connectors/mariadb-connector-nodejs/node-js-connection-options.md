...
| rowsAsArray    | Return resultsets as array, rather than a JSON object. This is a faster way to get results. For more information, see the [Promise](https://mariadb.com/kb/README#querysql-values---promise) and [Callback](https://mariadb.com/kb/en/callback-api#querysql-values-callback---emoitter) query implementations. | boolean | false       |
