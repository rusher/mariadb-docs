...
For information on how to use MariaDB Connector/R2DBC with the Spring Data Framework, refer to [Using Spring Data with MariaDB Connector/R2DBC](../using-the-spring-data-framework-with-mariadb-connector-r2dbc/).
