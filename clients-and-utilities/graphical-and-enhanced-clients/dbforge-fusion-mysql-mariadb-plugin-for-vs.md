...
![dbforge_fusion_for_mysql](/en/dbforge-fusion-mysql-mariadb-plugin-for-vs/+image/dbforge_fusion_for_mysql "dbforge_fusion_for_mysql") [dbForge Fusion](https://www.devart.com/dbforge/mysql/fusion/) is a powerful add-in for Visual Studio. It provides automatic and simple MariaDB database development and boosts data management capacity. With this tool integrated, it is easy to work with database development and administration tasks from Visual Studio.
...
![mysql-schema-compare-wizard](/en/dbforge-fusion-mysql-mariadb-plugin-for-vs/+image/mysql-schema-compare-wizard "mysql-schema-compare-wizard")
...
![generatedatacomparisonreport](/en/dbforge-fusion-mysql-mariadb-plugin-for-vs/+image/generatedatacomparisonreport "generatedatacomparisonreport")
...
| --- | --- |
| Version | Introduced |
| dbForge Fusion for MariaDB and MySQL 6.6 | [MariaDB 10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1011)-10.5 |
| dbForge Fusion for MariaDB and MySQL 6.1 | [MariaDB 10.0](/en/what-is-mariadb-100/), [MariaDB 5.5](/en/what-is-mariadb-55/) |