...
distributions are available at [mariadb.com/downloads/](https://mariadb.com/downloads/) or 
...
create a [bug report](http://mariadb.org/jira) if our project impedes this in
any way.

Instructions how to install the packages can be found
[here](/kb/en/installing-mariadb-binary-packages/).

#

# Distributions Which Include MariaDB

* Most distributions already include MariaDB. See [Distributions Which Include MariaDB](../../../server-management/getting-installing-and-upgrading-mariadb/binary-packages/distributions-which-include-mariadb.md).

#

# Pre-Release Binaries

Binaries from our [Buildbot](http://buildbot.askmonty.org) system (see also
the [Buildbot](https://app.gitbook.com/s/iJPrPCGi329TSR8WIXJW/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/tools/buildbot/buildbot-buildbot-database-schema) page), are available at
[http://hasky.askmonty.org/archive](http://hasky.askmonty.org/archive). They are not suitable for use in
...
For example, if you were interested in the bsd9-64 build of the [MariaDB 5.5](/kb/en/what-is-mariadb-55/)
tree, revision 3497, the `tarbuildnum` is listed in the "Build Properties"
table of the 
[Buildbot build report](http://buildbot.askmonty.org/buildbot/builders/bsd9-64/builds/337).
...
You can find all the source code at [https://github.com/MariaDB/server](https://github.com/MariaDB/server)
