...
![standard_packet](/en/0-packet/+image/standard_packet "standard_packet")
...
This is activated after the [handshake-response-packet](/en/1-connecting-connecting/#handshake-response-packet) when the client indicates [[1-connecting-connecting#capabilities|COMPRESS] capability with the server having this functionality too.
...
![compress_packet](/en/0-packet/+image/compress_packet "compress_packet")