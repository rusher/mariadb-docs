...
log. See [binlog_annotate_row_events](/en/replication-and-binary-log-server-system-variables/#binlog_annotate_row_events) for a detailed description of the variable.
...
See [replicate_annotate_row_events](/en/replication-and-binary-log-server-system-variables/#replicate_annotate_row_events) for a detailed description of the variable.

#

## mariadb-binlog Option: `--skip-annotate-row-events`

This option tells [mariadb-binlog](/en/about-mariadb-binlog/) to skip all `Annotate_row` events in its
...
* [Replication and Binary Log Server System Variables](/en/replication-and-binary-log-server-system-variables/)
