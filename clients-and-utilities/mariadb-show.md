...
| --- | --- |
| Option | Description |
| -c name, --character-sets-dir=name | Directory for [character set](/kb/en/data-types-character-sets-and-collations/) files. |
| -C, --compress | Use compression in server/client protocol if both support it. |
| --count | Show number of rows per table (may be slow for non-[MyISAM](myisam-clients-and-utilities/myisamchk-table-information.md) tables). |
| -
...
| [mariadb-show] | Options read by mariadb-show. Available starting with [MariaDB 10.4.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-104-series/mariadb-1046-release-notes). |
