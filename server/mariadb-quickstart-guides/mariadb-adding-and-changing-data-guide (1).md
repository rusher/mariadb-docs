...
* `mariadb-import` utility: A command-line tool that uses `LOAD DATA INFILE`. These are typically covered in guides focused on bulk data operations (e.g., "Bulk Data Importing Guide").
