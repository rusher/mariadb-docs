# data-in-transit-encryption-requiring-tls-on-mariadb-server
...
2. Determine which [system variables](../../../../ha-and-performance/optimization-and-tuning/system-variables/) and [options](../../../../server-management/getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) you need to configure.\
