...
If you aren't sure whether your server is linked with [OpenSSL](https://www.openssl.org/) or the bundled TLS library, then you can check the value of the `[have_openssl](/kb/en/ssl-system-variables/#have_openssl)` system variable. For example:
...
If you want to see what version of [OpenSSL](https://www.openssl.org/) your server is using, then you can check the value of the `[version_ssl_library](/kb/en/ssl-system-variables/#version_ssl_library)` system variable. For example:
...
MariaDB Server is dynamically linked with the system's [OpenSSL](https://www.openssl.org/) library in `[.rpm](/kb/en/rpm/)` packages.

#

## MariaDB Clients and Utilities

[MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/c++/mariadb-connector-cpp-1-0-release-notes/mariadb-connector-cpp-1-0-3-release-notes) has been [included with MariaDB Server](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/mariadb-connector-cpp/about-mariadb-connector-cpp#integration-with-mariadb-server), and the bundled and the [clients and utilities](/kb/en/clients-utilities/) are linked with it. On some platforms, [MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/c++/mariadb-connector-cpp-1-0-release-notes/mariadb-connector-cpp-1-0-3-release-notes) and these [clients and utilities](/kb/en/clients-utilities/) may use a different TLS library than the one used by MariaDB Server and [libmysqlclient](https://dev.mysql.com/doc/refman/5.5/en/c-api.html).

#

### MariaDB Clients and Utilities on Windows

MariaDB's [clients and utilities](/kb/en/clients-utilities/) and [MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/c++/mariadb-connector-cpp-1-0-release-notes/mariadb-connector-cpp-1-0-3-release-notes) are are dynamically linked with the system's [Schannel](https://docs.microsoft.com/en-us/windows/desktop/secauthn/secure-channel) libraries in [MSI](../../../server-management/getting-installing-and-upgrading-mariadb/binary-packages/installing-mariadb-msi-packages-on-windows.md) and [ZIP](../../../server-management/getting-installing-and-upgrading-mariadb/binary-packages/installing-mariadb-windows-zip-packages.md) packages on Windows. [libmysqlclient](https://dev.mysql.com/doc/refman/5.5/en/c-api.html) is still statically linked with the bundled [wolfSSL](https://www.wolfssl.com/products/wolfssl/) library.
<</product>>
...
MariaDB's [clients and utilities](/kb/en/clients-utilities/), [libmysqlclient](https://dev.mysql.com/doc/refman/5.5/en/c-api.html), and [MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/c++/mariadb-connector-cpp-1-0-release-notes/mariadb-connector-cpp-1-0-3-release-notes) are dynamically linked with the system's [OpenSSL](https://www.openssl.org/) library in `[.deb](../../../server-management/getting-installing-and-upgrading-mariadb/binary-packages/installing-mariadb-deb-files.md)` packages.
...
MariaDB's [clients and utilities](/kb/en/clients-utilities/), [libmysqlclient](https://dev.mysql.com/doc/refman/5.5/en/c-api.html), and [MariaDB Connector/C](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/c++/mariadb-connector-cpp-1-0-release-notes/mariadb-connector-cpp-1-0-3-release-notes) are dynamically linked with the system's [OpenSSL](https://www.openssl.org/) library in `[.rpm](/kb/en/rpm/)` packages.
