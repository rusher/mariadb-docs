...
Key rotation for the InnoDB [Redo Log](../../../../../reference/storage-engines/innodb/innodb-redo-log.md) is only supported in [MariaDB 10.4.0](broken-reference) and later. For more information, see [MDEV-12041](https://jira.mariadb.org/browse/MDEV-12041).
