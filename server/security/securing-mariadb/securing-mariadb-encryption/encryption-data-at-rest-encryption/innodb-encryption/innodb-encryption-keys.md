...
Key rotation for the InnoDB [Redo Log](../../../../../reference/storage-engines/innodb/innodb-redo-log.md) is only supported in [MariaDB 10.4.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/old-releases/release-notes-mariadb-10-4-series/mariadb-1040-release-notes) and later. For more information, see [MDEV-12041](https://jira.mariadb.org/browse/MDEV-12041).
