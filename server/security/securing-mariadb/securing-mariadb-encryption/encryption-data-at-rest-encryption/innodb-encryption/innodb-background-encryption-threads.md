...
InnoDB records the status of background encryption operations in the [INNODB_TABLESPACES_ENCRYPTION](information-schema-innodb_tablespaces_encryption) table in the [information_schema](../../../../../server-usage/programming-customizing-mariadb/views/information-schema-views-table.md) database.
