...
InnoDB records the status of background encryption operations in the [INNODB_TABLESPACES_ENCRYPTION](https://mariadb.com/kb/en/information-schema-innodb_tablespaces_encryption) table in the [information_schema](../../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/README.md) database.
