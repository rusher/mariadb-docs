...
To avoid this problem, OpenSSL developers decided that TLSv1.3 cipher suites should not be affected by the normal cipher-selecting API. This means that [ssl\_cipher](ssltls-system-variables.md#ssl_cipher) system variable has no effect on the TLSv1.3 cipher suites.
