...
This is not applicable to [InnoDB](../storage-engines/innodb/) tables, the default, which are ordered according to the clustered index, unless the primary key is defined on the specific columns.
