...
This statement declares a [cursor](./). Multiple cursors may be declared in a [stored program](../../stored-routines/), but each cursor in a given block must have a unique name.
