...
If a backup is a [partial backup](broken-reference), then Mariabackup will record that detail in the [xtrabackup\_info](files-created-by-mariabackup.md#xtrabackup_info) file.
