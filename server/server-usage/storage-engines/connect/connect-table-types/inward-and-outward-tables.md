...
[ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) produces the following warning, as a reminder:
...
When an [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) is issued, it just modifies the table definition\
...
Changing the table type with [ALTER](../../../../reference/sql-statements/data-definition/alter/) often makes no sense. But many suspicious\
...
data. However, it is often unsafe to do it with an [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) statement that\
...
for testing purposes or when the user does not have the [FILE](../../../../reference/sql-statements/account-management-sql-statements/grant.md#global-privileges) privilege.
...
TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) statement containing other changes that cannot be done "in-place", the\
