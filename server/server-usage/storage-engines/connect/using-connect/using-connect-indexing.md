...
INDEX statement or the [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) statement. In all cases, the index files are\
...
or the [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) statement, and this erases the index files.
...
instance, if indexes are in separate files, the primary index of the table\_dept.dat\_ of type DOS is a file named _dept\_PRIMARY.dnx_. This makes\
