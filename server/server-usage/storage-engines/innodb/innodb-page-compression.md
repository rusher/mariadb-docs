...
| --------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| [Innodb\_have\_lz4](innodb-status-variables.md#innodb_have_lz4)       | Whether InnoDB supports the [lz4](https://code.google.com/p/lz4/) compression algorithm.            |
| [Innodb\_have\_lzo](innodb-status-variables.md#innodb_have_lzo)       | Whether InnoDB supports the [lzo](https://www.oberhumer.com/opensource/lzo/) compression algorithm. |
| [Innodb\_have\_lzma](innodb-status-variables.md#innodb_have_lzma)     | Whether InnoDB supports the [lzma](https://tukaani.org/xz/) compression algorithm.                  |
| [Innodb\_have\_bzip2](innodb-status-variables.md#innodb_have_bzip2)   | Whether InnoDB supports the [bzip2](https://www.bzip.org/) compression algorithm.                   |
| [Innodb\_have\_snappy](innodb-status-variables.md#innodb_have_snappy) | Whether InnoDB supports the [snappy](https://google.github.io/snappy/) compression algorithm.       |
...
| Status Variable                                                                                                       | Description                     |
| --------------------------------------------------------------------------------------------------------------------- | ------------------------------- |
| [Innodb\_page\_compression\_saved](innodb-status-variables.md#innodb_page_compression_saved)                          | Bytes saved by compression      |
| [Innodb\_page\_compression\_trim\_sect512](innodb-status-variables.md#innodb_page_compression_trim_sect512)           | Number of 512 sectors trimmed   |
| [Innodb\_page\_compression\_trim\_sect1024](innodb-status-variables.md#innodb_page_compression_trim_sect1024)         | Number of 1024 sectors trimmed  |
| [Innodb\_page\_compression\_trim\_sect2048](innodb-status-variables.md#innodb_page_compression_trim_sect2048)         | Number of 2048 sectors trimmed  |
| [Innodb\_page\_compression\_trim\_sect4096](innodb-status-variables.md#innodb_page_compression_trim_sect4096)         | Number of 4096 sectors trimmed  |
| [Innodb\_page\_compression\_trim\_sect8192](innodb-status-variables.md#innodb_page_compression_trim_sect8192)         | Number of 8192 sectors trimmed  |
| [Innodb\_page\_compression\_trim\_sect16384](innodb-status-variables.md#innodb_page_compression_trim_sect16384)       | Number of 16384 sectors trimmed |
| [Innodb\_page\_compression\_trim\_sect32768](innodb-status-variables.md#innodb_page_compression_trim_sect32768)       | Number of 32768 sectors trimmed |
| [Innodb\_num\_pages\_page\_compressed](innodb-status-variables.md#innodb_num_pages_page_compressed)                   | Number of pages compressed      |
| [Innodb\_num\_page\_compressed\_trim\_op](innodb-status-variables.md#innodb_num_page_compressed_trim_op)              | Number of trim operations       |
| [Innodb\_num\_page\_compressed\_trim\_op\_saved](innodb-status-variables.md#innodb_num_page_compressed_trim_op_saved) | Number of trim operations saved |
| [Innodb\_num\_pages\_page\_decompressed](innodb-status-variables.md#innodb_num_pages_page_decompressed)               | Number of pages decompressed    |
| [Innodb\_num\_pages\_page\_compression\_error](innodb-status-variables.md#innodb_num_pages_page_compression_error)    | Number of compression errors    |
