...
The [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) statement supports two clauses that are used to implement online DDL:

* [ALGORITHM](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md#algorithm>) - This clause controls how the DDL operation is performed.
* [LOCK](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md#lock>) - This clause controls how much concurrency is allowed while the DDL operation is being performed.
...
InnoDB supports the [ALGORITHM](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md#algorithm>) clause.

The [ALGORITHM](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md#algorithm>) clause can be used to specify the _least efficient_ algorithm that the user is willing to accept. It is supported by the [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) and [CREATE INDEX](../../../../reference/sql-statements/data-definition/create/create-index.md) statements.
...
The `COPY` algorithm refers to the original [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) algorithm.
...
If an [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) operation supports the `INPLACE` algorithm, then it can be performed using optimizations by the underlying storage engine, but it may rebuilt.

If the `INPLACE` algorithm is specified with the [ALGORITHM](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md#algorithm>) clause or with the [alter\_algorithm](../../../../ha-and-performance/optimization-and-tuning/system-variables/server-system-variables.md#alter_algorithm) system variable and if the [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) operation does not support the `INPLACE` algorithm, then an error are raised:
...
If an [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) operation supports the `NOCOPY` algorithm, then it can be performed without rebuilding the clustered index.

If the `NOCOPY` algorithm is specified with the [ALGORITHM](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md#algorithm>) clause or with the [alter\_algorithm](../../../../ha-and-performance/optimization-and-tuning/system-variables/server-system-variables.md#alter_algorithm) system variable and if the [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) operation does not support the `NOCOPY` algorithm, then an error are raised:
...
If an [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) operation supports the `INSTANT` algorithm, then it can be performed without modifying any data files.

If the `INSTANT` algorithm is specified with the [ALGORITHM](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md#algorithm>) clause or with the [alter\_algorithm](../../../../ha-and-performance/optimization-and-tuning/system-variables/server-system-variables.md#alter_algorithm) system variable and if the [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) operation does not support the `INSTANT` algorithm, then an error are raised:
...
If the [LOCK](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md#lock>) clause is not explicitly set, then the operation uses `LOCK=DEFAULT`.

### Specifying an Alter Locking Strategy Using `ALTER ONLINE TABLE`

[ALTER ONLINE TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md#alter-online-table>) is equivalent to `LOCK=NONE`. Therefore, the [ALTER ONLINE TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md#alter-online-table>) statement can be used to ensure that your [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) operation allows all concurrent DML.
