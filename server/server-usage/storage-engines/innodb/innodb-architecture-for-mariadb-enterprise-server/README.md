...
| [Undo Log](../../../../reference/storage-engines/innodb/innodb-architecture-for-mariadb-enterprise-server/mariadb-enterprise-server-innodb-undo-log/) | Transaction log for MVCC.                                                                     |
