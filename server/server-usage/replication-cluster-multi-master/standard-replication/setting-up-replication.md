...
* Replicating from MySQL 5.5 to MariaDB should just work. When using a MariaDB as a replica, it may be necessary to set [binlog_checksum](replication-and-binary-log-system-variables.md) to NONE.
