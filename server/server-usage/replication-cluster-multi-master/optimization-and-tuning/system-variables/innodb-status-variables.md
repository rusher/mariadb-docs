...
Much of the [InnoDB](../../../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/innodb-encryption/innodb-encryption-troubleshooting.md) information here can also be seen with a [SHOW ENGINE INNODB STATUS](../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/show/show-engine-innodb-status.md) statement.
 ...
 * In [MariaDB 5.5](/kb/en/what-is-mariadb-55/), this status variable is present in XtraDB.
 * In [MariaDB 10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1011) and later, this status variable is not present.
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 5.5](/kb/en/what-is-mariadb-55/)
 ...
 * In [MariaDB 10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1011), [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102), [MariaDB 10.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-103), and [MariaDB 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-104), this status variable is not present. Use the `adaptive_hash_searches_btree` counter in the [information_schema.INNODB_METRICS](../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/information-schema-tables/information-schema-innodb-tables/information-schema-innodb_metrics-table.md) table instead.
 * From [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105), this status variable is present.
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 5.5](/kb/en/what-is-mariadb-55/), [MariaDB 10.5.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-105-series/mariadb-1050-release-notes)
* Removed: [MariaDB 10.0.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-100-series/mariadb-1000-release-notes)
...
* Description: Total number available InnoDB [undo logs](/kb/en/undo-log/). Differs from the [innodb_undo_logs](../../../../reference/storage-engines/innodb/innodb-system-variables.md#innodb_undo_logs) system variable, which specifies the number of active undo logs.
* Scope: Global
* Data Type: `numeric`
 ...
 * In [MariaDB 5.5](/kb/en/what-is-mariadb-55/), this status variable is present in XtraDB.
 * In [MariaDB 10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1011), [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102), [MariaDB 10.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-103), and [MariaDB 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-104), this status variable is not present.
 * In [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105), this status variable was reintroduced.
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 5.5](/kb/en/what-is-mariadb-55/) (XtraDB only), [MariaDB 10.5.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-105-series/mariadb-1050-release-notes)

#

### `Innodb_buffer_pool_bytes_data`

* Description: Number of bytes contained in the [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/), both dirty (modified) and clean (unmodified). See also [Innodb_buffer_pool_pages_data](#innodb_buffer_pool_pages_data), which can contain pages of different sizes in the case of compression.
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of dirty (modified) bytes contained in the [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/). See also [Innodb_buffer_pool_pages_dirty](#innodb_buffer_pool_pages_dirty), which can contain pages of different sizes in the case of compression.
* Scope: Global
* Data Type: `numeric`
...
* Scope: Global
* Data Type: `string`
* Introduced: [MariaDB 10.0.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-100-series/mariadb-1000-release-notes)
...
* Scope: Global
* Data Type: `boolean`
* Introduced: [MariaDB 10.3.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-3-series/mariadb-1035-release-notes)
...
* Description: Number of [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/) pages which contain data, both dirty (modified) and clean (unmodified). See also [Innodb_buffer_pool_bytes_data](#innodb_buffer_pool_bytes_data).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/) pages which contain dirty (modified) data. See also [Innodb_buffer_pool_bytes_dirty](innodb_buffer_pool_bytes_dirty).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/) pages which have been flushed.
* Scope: Global
* Data Type: `numeric`
 ...
 * In [MariaDB 5.5](/kb/en/what-is-mariadb-55/) and [MariaDB 10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1011), this status variable is present in XtraDB.
 * In [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102), [MariaDB 10.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-103), and [MariaDB 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-104), this status variable is not present.
 * In [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105), this status variable was reintroduced.
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 5.5](/kb/en/what-is-mariadb-55/) (XtraDB-only), [MariaDB 10.5.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-105-series/mariadb-1050-release-notes)
...
* Description: Number of free [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/) pages.
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/) pages set aside for internal use.
* Scope: Global
* Data Type: `numeric`
 ...
 * In [MariaDB 5.5](/kb/en/what-is-mariadb-55/) and [MariaDB 10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1011), this status variable is present for XtraDB.
 * In [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102), [MariaDB 10.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-103), and [MariaDB 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-104), this status variable is not present.
 * In [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105), this status variable was reintroduced.
* Scope: Global
* Data Type: `numeric`
...
* Description: Total number of [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/) pages.
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of pages read into the [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/) by the read-ahead background thread.
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of pages read into the [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/) by the read-ahead background thread that were evicted without having been accessed by queries.
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of requests to read from the [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of reads that could not be satisfied by the [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/) and had to be read from disk.
* Scope: Global
* Data Type: `numeric`
...
* Description: Progress of the dynamic [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/) resizing operation. See [Setting Innodb Buffer Pool Size Dynamically](setting-innodb-buffer-pool-size-dynamically.md).
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 10.2.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-102-series/mariadb-1022-release-notes)
...
* Description: Number of requests to write to the [InnoDB buffer pool](/kb/en/xtradbinnodb-memory-buffer/).
* Scope: Global
* Data Type: `numeric`
...
* Description: Checkpoint age target, as shown in the LOG section of the [SHOW ENGINE INNODB STATUS](../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/show/show-engine-innodb-status.md) output. XtraDB only. Removed in [MariaDB 10.0](/kb/en/what-is-mariadb-100/) and replaced with MySQL 5.6's flushing implementation.
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 5.5](/kb/en/what-is-mariadb-55/)
...
* Description: Number of InnoDB fsync (sync-to-disk) calls. fsync call frequency can be influenced by the [innodb_flush_method](/kb/en/xtradbinnodb-server-system-variables/#innodb_flush_method) configuration option.
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of pending InnoDB fsync (sync-to-disk) calls. fsync call frequency can be influenced by the [innodb_flush_method](/kb/en/xtradbinnodb-server-system-variables/#innodb_flush_method) configuration option.
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of pages written to the [InnoDB doublewrite buffer](/kb/en/xtradbinnodb-doublewrite-buffer/).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of writes to the [InnoDB doublewrite buffer](/kb/en/xtradbinnodb-doublewrite-buffer/).
* Scope: Global
* Data Type: `numeric`
...
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 10.1.1](/kb/en/mariadb-1011-release-notes/)
...
* Description: Number of entries in the XtraDB data dictionary cache. This Percona XtraDB variable was removed in MariaDB 10/XtraDB 5.6 as it was replaced with MySQL 5.6's [table_definition_cache](server-system-variables.md#table_definition_cache) implementation.
* Scope: Global
* Data Type: `numeric`
...
* Description: Was not present in [MariaDB 10.5.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-105-series/mariadb-1052-release-notes).
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 10.2.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-102-series/mariadb-1024-release-notes)

#

### `Innodb_encryption_rotation_estimated_iops`

* Description: See [Table and Tablespace Encryption](/kb/en/table-and-tablespace-encryption/).
* Scope: Global
* Data Type: `numeric`
* Removed: [MariaDB 10.1.3](/kb/en/mariadb-1013-release-notes/)
...
* Description: Whether the server has the bzip2 compression method available. See [InnoDB/XtraDB Page Compression](/kb/en/innodbxtradb-page-compression/).
* Scope: Global
* Data Type: `boolean`
* Introduced: [MariaDB 10.1.0](/kb/en/mariadb-1010-release-notes/)

#

### `Innodb_have_lz4`

* Description: Whether the server has the lz4 compression method available. See [InnoDB/XtraDB Page Compression](/kb/en/innodbxtradb-page-compression/).
* Scope: Global
* Data Type: `boolean`
* Introduced: [MariaDB 10.1.0](/kb/en/mariadb-1010-release-notes/)
...
* Description: Whether the server has the lzma compression method available. See [InnoDB/XtraDB Page Compression](/kb/en/innodbxtradb-page-compression/).
* Scope: Global
* Data Type: `boolean`
* Introduced: [MariaDB 10.1.0](/kb/en/mariadb-1010-release-notes/)
...
* Description: Whether the server has the lzo compression method available. See [InnoDB/XtraDB Page Compression](/kb/en/innodbxtradb-page-compression/).
* Scope: Global
* Data Type: `boolean`
* Introduced: [MariaDB 10.1.0](/kb/en/mariadb-1010-release-notes/)
...
* Description: Whether the server has the snappy compression method available. See [InnoDB/XtraDB Page Compression](/kb/en/innodbxtradb-page-compression/).
* Scope: Global
* Data Type: `boolean`
...
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 10.3.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-3-series/mariadb-1032-release-notes)
 ...
 * In [MariaDB 10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1011), this status variable is present in XtraDB.
 * In [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102), [MariaDB 10.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-103), and [MariaDB 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-104), this status variable is not present.
 * In [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105), this status variable was reintroduced.
* Scope: Global
* Data Type: `numeric`
 ...
 * In [MariaDB 5.5](/kb/en/what-is-mariadb-55/) and [MariaDB 10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1011), this status variable is present in XtraDB.
 * In [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102) and later, this status variable is not present.
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 5.5](/kb/en/what-is-mariadb-55/)
...
* Description: Number of pages page decrypted. See [Table and Tablespace Encryption](/kb/en/table-and-tablespace-encryption/).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of pages page encrypted. See [Table and Tablespace Encryption](/kb/en/table-and-tablespace-encryption/).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of page encryption errors. See [Table and Tablespace Encryption](/kb/en/table-and-tablespace-encryption/).
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 10.1.3](/kb/en/mariadb-1013-release-notes/)
...
* Data Type: `numeric`
* Introduced: [MariaDB 5.5](/kb/en/what-is-mariadb-55/)
* Removed: [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102)
...
* Scope:
* Data Type: `numeric`
* Introduced: [MariaDB 10.1.0](/kb/en/mariadb-1010-release-notes/), [MariaDB 10.0.15](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-100-series/mariadb-10015-release-notes) Fusion-io
...
* Scope:
* Data Type: `numeric`
* Introduced: [MariaDB 10.1.2](/kb/en/mariadb-1012-release-notes/), [MariaDB 10.0.15](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-100-series/mariadb-10015-release-notes) Fusion-io
* Removed: [MariaDB 10.2.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-102-series/mariadb-1024-release-notes)
...
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 5.5.32](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-55-series/mariadb-5532-release-notes)
* Removed: [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102)
...
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 5.5](/kb/en/what-is-mariadb-55/) / XtraDB 5.5.8-20
* Removed: [MariaDB 5.5](/kb/en/what-is-mariadb-55/) / XtraDB 5.5.10-20.1
...
* Data Type: `numeric`
* Introduced: [MariaDB 10.1.3](/kb/en/mariadb-1013-release-notes/)
* Removed: [MariaDB 10.5.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-105-series/mariadb-1052-release-notes)
...
* Description: Used to track the effectiveness of the Prefix Index Queries Optimization ([MDEV-6929](https://jira.mariadb.org/browse/MDEV-6929)). Removed in [MariaDB 10.10](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1010) as the optimization is now always enabled.
* Scope: Global
* Data Type: `numeric`
* Removed: [MariaDB 10.10](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1010)
...
* Scope: Global
* Data Type: `numeric`
* Removed: [MariaDB 10.10.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-10-series/mariadb-10100-release-notes)
...
* Scope: Global
* Data Type: `numeric`
* Introduced: [MariaDB 10.3.10](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-3-series/mariadb-10310-release-notes)
