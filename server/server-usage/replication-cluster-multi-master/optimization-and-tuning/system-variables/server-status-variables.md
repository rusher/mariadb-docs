...
* Description: Number of column permissions granted (rows in the [mysql.columns_priv table](/kb/en/mysqlcolumns_priv-table/)).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of database permissions granted (rows in the [mysql.db table](/kb/en/mysqldb-table/)).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of function permissions granted (rows in the [mysql.procs_priv table](/kb/en/mysqlprocs_priv-table/) with a routine type of `FUNCTION`).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of procedure permissions granted (rows in the [mysql.procs_priv table](/kb/en/mysqlprocs_priv-table/) with a routine type of `PROCEDURE`).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of proxy permissions granted (rows in the [mysql.proxies_priv table](/kb/en/mysqlproxies_priv-table/)).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of role permissions granted (rows in the [mysql.roles_mapping table](/kb/en/mysqlroles_mapping-table/)).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of roles (rows in the [mysql.user table](/kb/en/mysqluser-table/) where `is_role='Y'`).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of table permissions granted (rows in the [mysql.tables_priv table](mysql.tables_priv-table)).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of users (rows in the [mysql.user table](/kb/en/mysqluser-table/) where `is_role='N'`).
* Scope: Global
* Data Type: `numeric`
...
* Scope: Global, Session
* Data Type: `numeric`
* Removed: [MariaDB 10.7.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-7-series/mariadb-1070-release-notes)
...
* Scope: Global, Session
* Data Type: `numeric`
* Removed: [MariaDB 10.4.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-104-series/mariadb-1041-release-notes)
...
* Scope: Global, Session
* Data Type: `numeric`
* Removed: [MariaDB 10.4.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-104-series/mariadb-1042-release-notes)

#

### `Com_backup_table`

* Description: Removed in [MariaDB 5.5](/kb/en/what-is-mariadb-55/). In older versions, Com_backup_table contains the number of [BACKUP TABLE](/kb/en/backup-table-deprecated/) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [BINLOG](../../../../clients-and-utilities/server-client-software/client-libraries/clientserver-protocol/replication-protocol/binlog_checkpoint_event.md) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [USE](../../../../security/user-account-management/user-password-expiry.md) database_name commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [COMMIT](/kb/en/transactions-commit-statement/) commands executed. Differs from [Handler_commit](#handler_commit), which counts internal commit statements.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [compund](/kb/en/programmatic-and-compound-statements/) sql statements.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [CREATE FUNCTION](../../../programming-customizing-mariadb/user-defined-functions/create-function-udf.md) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [CREATE TABLE](../../../../reference/sql-statements-and-structure/sql-statements/data-definition/create/create-tablespace.md) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [CREATE TEMPORARY TABLE](../../../../reference/sql-statements-and-structure/sql-statements/data-definition/create/create-tablespace.md) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [DEALLOCATE](/kb/en/deallocate-drop-prepared-statement/) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [DO](../../../../server-management/getting-installing-and-upgrading-mariadb/downgrading-between-major-versions-of-mariadb.md) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [DROP FUNCTION](../../../programming-customizing-mariadb/user-defined-functions/drop-function-udf.md) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [INSERT](../../../programming-customizing-mariadb/views/inserting-and-updating-with-views.md) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [PURGE](/kb/en/sql-commands-purge-logs/) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [PURGE BEFORE](/kb/en/sql-commands-purge-logs/) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [REPLACE](../../../../clients-and-utilities/replace-utility.md) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [REPLACE](../../../../clients-and-utilities/replace-utility.md) ... [SELECT](../../standard-replication/selectively-skipping-replication-of-binlog-events.md) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Removed in [MariaDB 5.5](/kb/en/what-is-mariadb-55/). In older versions, Com_restore_table contains the number of [RESTORE TABLE](../../../../reference/sql-statements-and-structure/sql-statements/table-statements/obsolete-table-commands/restore-table-removed.md) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
* Removed: [MariaDB 5.5](/kb/en/what-is-mariadb-55/)
...
* Description: Number of [SELECT](../../standard-replication/selectively-skipping-replication-of-binlog-events.md) commands executed. Also includes queries that make use of the [query cache](../buffers-caches-and-threads/query-cache.md).
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [SET OPTION](../../standard-replication/setting-up-replication.md) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [SHOW CLIENT STATISTICS](/kb/en/show-client_statistics/) commands executed. Removed in [MariaDB 10.1.1](/kb/en/mariadb-1011-release-notes/) when that statement was replaced by the generic [SHOW information_schema_table](https://app.gitbook.com/s/iJPrPCGi329TSR8WIXJW/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/mariadb-internals-documentation/information-schema-plugins-show-and-flush-statements).
* Scope: Global, Session
* Data Type: `numeric`
* Removed: [MariaDB 10.1.1](/kb/en/mariadb-1011-release-notes/)
...
* Description: Number of generic [SHOW](../../../../security/user-account-management/catalogs/show-create-catalog.md) commands executed, such as [SHOW INDEX_STATISTICS](/kb/en/show-index_statistics/) and [SHOW TABLE_STATISTICS](/kb/en/show-table_statistics/)
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [SHOW INDEX_STATISTICS](/kb/en/show-index_statistics/) commands executed. Removed in [MariaDB 10.1.1](/kb/en/mariadb-1011-release-notes/) when that statement was replaced by the generic [SHOW information_schema_table](https://app.gitbook.com/s/iJPrPCGi329TSR8WIXJW/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/mariadb-internals-documentation/information-schema-plugins-show-and-flush-statements).
* Scope: Global, Session
* Data Type: `numeric`
* Removed: [MariaDB 10.1.1](/kb/en/mariadb-1011-release-notes/)
...
* Description: Number of [SHOW TABLE STATISTICS](/kb/en/show-table_statistics/) commands executed. Removed in [MariaDB 10.1.1](/kb/en/mariadb-1011-release-notes/) when that statement was replaced by the generic [SHOW information_schema_table](https://app.gitbook.com/s/iJPrPCGi329TSR8WIXJW/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/mariadb-internals-documentation/information-schema-plugins-show-and-flush-statements).
* Scope: Global, Session
* Data Type: `numeric`
* Removed: [MariaDB 10.1.1](/kb/en/mariadb-1011-release-notes/)
...
* Description: Number of [SHOW USER STATISTICS](/kb/en/show-user_statistics/) commands executed. Removed in [MariaDB 10.1.1](/kb/en/mariadb-1011-release-notes/) when that statement was replaced by the generic [SHOW information_schema_table](https://app.gitbook.com/s/iJPrPCGi329TSR8WIXJW/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/mariadb-internals-documentation/information-schema-plugins-show-and-flush-statements).
* Scope: Global, Session
* Data Type: `numeric`
* Removed: [MariaDB 10.1.1](/kb/en/mariadb-1011-release-notes/)
...
* Description: Number of [prepared statements](/kb/en/prepared-statements/) closed ([deallocated or dropped](/kb/en/deallocate-drop-prepared-statement/)).
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [prepared statements](/kb/en/prepared-statements/) [executed](../../../../reference/sql-statements-and-structure/sql-statements/prepared-statements/execute-statement.md).
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [prepared statements](/kb/en/prepared-statements/) fetched.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [prepared statements](/kb/en/prepared-statements/) [prepared](../../../../reference/sql-statements-and-structure/sql-statements/prepared-statements/prepare-statement.md).
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [prepared statements](/kb/en/prepared-statements/) reprepared.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [prepared statements](/kb/en/prepared-statements/) where the data of a prepared statement which was accumulated in chunks by sending long data has been reset.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [prepared statements](/kb/en/prepared-statements/) where the parameter data has been sent in chunks (long data).
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of [UNLOCK TABLES](/kb/en/transactions-lock/) commands executed.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of times a table created with [periods](../../../../reference/sql-statements-and-structure/sql-statements/data-definition/create/create-tablespace.md#periods) has been opened.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of requests to read the previous row from an index (in order). Mostly used with [ORDER BY DESC](../../standard-replication/selectively-skipping-replication-of-binlog-events.md#order-by).
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of requests to update a row in a table. Since [MariaDB 5.3](/kb/en/what-is-mariadb-53/), this no longer counts temporary tables - see [Handler_tmp_update](#handler_tmp_update).
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of requests to write a row to a table. Since [MariaDB 5.3](/kb/en/what-is-mariadb-53/), this no longer counts temporary tables - see [Handler_tmp_write](#handler_tmp_write).
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: When the Maria storage engine was renamed Aria, the Maria variables existing at the time were renamed at the same time. See [Aria Server Status Variables](/kb/en/aria-server-status-variables/).
...
* Scope: Session
* Data Type: `numeric`
* Introduced: [MariaDB 10.6.21](/kb/en/mariadb-10621-release-notes/)

#

### `Max_statement_time_exceeded`

* Description: Number of queries that exceeded the execution time specified by [max_statement_time](server-system-variables.md#max_statement_time). See [Aborting statements that take longer than a certain time to execute](/kb/en/aborting-statements-that-take-longer-than-a-certain-time-to-execute/).
* Data Type: `numeric`
...
* Scope: Global, Session
* Data Type: `numeric`
* Introduced: [MariaDB 11.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-115)
...
* Description: Number of shared libraries that the server has opened to load [plugins](../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/information-schema-tables/plugins-table-information-schema.md).
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of requests served by the [query cache](../buffers-caches-and-threads/query-cache.md). The global value can be flushed by `[FLUSH STATUS](../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/flush-commands/flush-tables-for-export.md)`.
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of queries ever cached in the [query cache](../buffers-caches-and-threads/query-cache.md). The global value can be flushed by `[FLUSH STATUS](../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/flush-commands/flush-tables-for-export.md)`.
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of queries that are uncacheable by the [query cache](../buffers-caches-and-threads/query-cache.md), or use SQL_NO_CACHE. The global value can be flushed by `[FLUSH STATUS](../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/flush-commands/flush-tables-for-export.md)`.
* Scope: Global
* Data Type: `numeric`
...
* Description: Number of statements executed by the server, excluding COM_PING and COM_STATISTICS. Differs from [Questions](#questions) in that it also counts statements executed within [stored programs](/kb/en/stored-programs-and-views/).
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of statements executed by the server, excluding COM_PING, COM_STATISTICS, COM_STMT_PREPARE, COM_STMT_CLOSE, and COM_STMT_RESET statements. Differs from [Queries](#queries) in that it doesn't count statements executed within [stored programs](/kb/en/stored-programs-and-views/).
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of queries which took longer than [long_query_time](server-system-variables.md#long_query_time) to run. The [slow query log](../query-optimizations/statistics-for-optimizing-queries/slow-query-log-extended-statistics.md) does not need to be active for this to be recorded.
* Scope: Global, Session
* Data Type: `numeric`
...
* Description: Number of times my_sync() has been called, or the number of times the server has had to force data to disk. Covers the [binary log](../../../programming-customizing-mariadb/stored-routines/binary-logging-of-stored-routines.md), .frm creation (if these
operations are configured to sync) and some storage engines ([Archive](/kb/en/archive/),
[CSV](../../../../reference/storage-engines/csv/csv-overview.md), [Aria](../../../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/aria-encryption/aria-enabling-encryption.md)), but not [XtraDB/InnoDB](../../../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/innodb-encryption/innodb-encryption-troubleshooting.md)).
* Scope: Global, Session
* Data Type: `numeric`
