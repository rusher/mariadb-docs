...
See also [https://docs.openssl.org/master/man3/SSL_CTX_set_verify/#notes](https://docs.openssl.org/master/man3/SSL_CTX_set_verify/#notes) for a description of the OpenSSL verify mode flags.
