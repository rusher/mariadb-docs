...
A segmented key cache is a collection of structures for regular [MyISAM](../../../../clients-and-utilities/myisam-clients-and-utilities/myisamchk-table-information.md)
...
[KEY_CACHES](../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/information-schema-tables/information-schema-key_caches-table.md) table in the [INFORMATION_SCHEMA](/en/information_schema/)
