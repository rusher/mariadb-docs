...
* Full-text indexes can be used only with [MyISAM](../../../../../ref/storage-engines/myisam-storage-engine/myisam-system-variables.md), [Aria](../../../../../ref/storage-engines/s3-storage-engine/aria_s3_copy.md), [InnoDB](../../../../../../general-resources/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/quality/innodb-upgrade-tests/README.md) and [Mroonga](../../../../../ref/storage-engines/mroonga/mroonga-user-defined-functions/mroonga_snippet_html.md) tables, and can be created only for [CHAR](../../../../../ref/sql-statements-and-structure/sql-statements/built-in-functions/secondary-functions/information-functions/charset.md), [VARCHAR](../../../../../ref/data-types/string-data-types/varchar.md), or [TEXT](../../../../../ref/data-types/string-data-types/text.md) columns.
...
* A FULLTEXT index definition can be given in the [CREATE TABLE](../../../../../ref/sql-statements-and-structure/vectors/create-table-with-vectors.md) statement when a
 table is created, or added later using [ALTER TABLE](../../../../../ref/sql-statements-and-structure/sql-statements/data-definition/alter/alter-tablespace.md) or [CREATE INDEX](../../../../../ref/sql-statements-and-structure/sql-statements/data-definition/create/create-index.md).
...
Full-text searching is performed using [MATCH() ... AGAINST](../../../../../ref/sql-statements-and-structure/sql-statements/built-in-functions/string-functions/match-against.md) syntax.
...
* For simpler searches of a substring in text columns, see the [LIKE](../../../../../ref/sql-statements-and-structure/sql-statements/built-in-functions/string-functions/like.md) operator.
