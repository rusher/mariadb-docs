...
| --- | --- |
| Storage Engine | Permitted Indexes |
| [Aria](../../../../reference/storage-engines/aria/README.md) | BTREE, RTREE |
| [MyISAM](../../../../reference/storage-engines/myisam-storage-engine/README.md) | BTREE, RTREE |
| [InnoDB](../../../../reference/storage-engines/innodb/README.md) | BTREE |
| [MEMORY/HEAP](../../../../reference/storage-engines/memory-storage-engine.md) | HASH, BTREE |



BTREE is generally the default index type. For [MEMORY](../../../../reference/storage-engines/memory-storage-engine.md) tables, HASH is the default. [TokuDB](../../../../reference/storage-engines/tokudb/README.md) uses a particular data structure called *fractal trees*, which is optimized for data that do not entirely fit memory.
