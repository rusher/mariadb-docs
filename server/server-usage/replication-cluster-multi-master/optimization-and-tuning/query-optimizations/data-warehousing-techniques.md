...
* [Normalization](https://app.gitbook.com/s/WCInJQ9cmGjq1lsTG91E/training-and-tutorials/intermediate-mariadb-articles/database-theory/database-normalization/).
...
"Sharding" is the splitting of data across multiple servers. (In contrast, [replication](../../README.md) and [Galera](/kb/en/galera/) have the same data on all servers, requiring all data to be written to all servers.)
