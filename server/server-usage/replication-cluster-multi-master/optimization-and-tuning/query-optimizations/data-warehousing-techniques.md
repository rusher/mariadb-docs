...
"Sharding" is the splitting of data across multiple servers. (In contrast, [replication](../../) and [Galera](../../galera-cluster/) have the same data on all servers, requiring all data to be written to all servers.)
