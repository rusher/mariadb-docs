...
![loosescan-satellites-ordered-r2](/en/loosescan-strategy/+image/loosescan-satellites-ordered-r2 "loosescan-satellites-ordered-r2")
...
![loosescan-diagram-no-where](/en/loosescan-strategy/+image/loosescan-diagram-no-where "loosescan-diagram-no-where")
