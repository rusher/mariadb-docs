...
`UCASE` is a synonym for [UPPER](../../../../ref/sql-statements-and-structure/sql-statements/built-in-functions/string-functions/upper.md) so is covered as well.
...
* An analog for [LCASE](../../../../ref/sql-statements-and-structure/sql-statements/built-in-functions/string-functions/lcase.md) is not possible. See [MDEV-31955](https://jira.mariadb.org/browse/MDEV-31955): Make optimizer handle LCASE(varchar_col)=... for details.
