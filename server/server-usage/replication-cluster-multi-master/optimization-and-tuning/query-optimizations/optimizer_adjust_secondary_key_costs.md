...
| disable_forced_index_in_group_by | [10.6.18](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-6-series/mariadb-10-6-18-release-notes) | Use a rule-based choice when deciding to use an index to resolve GROUP BY | The choice is now cost based |
