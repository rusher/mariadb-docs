...
[MariaDB's UUID function](../../../../reference/data-types/string-data-types/uuid-data-type.md).
...
It is tempting to declare the UUID [VARCHAR(36)](../../../../reference/data-types/string-data-types/varchar.md). And, since you probably are thinking globally, so you have [CHARACTER SET](/kb/en/character-sets/) utf8 (or utf8mb4). For utf8:
...
Now it will fit in 16 bytes: [BINARY(16)](../../../programming-customizing-mariadb/stored-routines/binary-logging-of-stored-routines.md)
...
Let's make [Stored Functions](/kb/en/stored-functions/) to do the messy work of the two actions:
