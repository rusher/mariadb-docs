...
MariaDB supports [Block Hash Join](../../../../ref/mariadb-internals/mariadb-internals-documentation-query-optimizer/block-based-join-algorithms.md#block-hash-join). It is not enabled by default, one needs to set it [join_cache_level](../system-variables/server-system-variables.md#join_cache_level) to 3 or a bigger value to enable it.
