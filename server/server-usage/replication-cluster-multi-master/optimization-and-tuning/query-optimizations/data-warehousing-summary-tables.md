...
* [binlog_format = ROW](../../standard-replication/replication-and-binary-log-system-variables.md)
* Use [binlog_ignore_db](../../standard-replication/replication-and-binary-log-system-variables.md) to avoid replicating staging -- necessitating putting it in a separate database.
