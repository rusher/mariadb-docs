 ...
 * `65536` (>= [MariaDB 10.2.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-102-series/mariadb-1024-release-notes))
 * `1000` (<= [MariaDB 10.2.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-102-series/mariadb-1023-release-notes), >= [MariaDB 10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1011))
 * `500` (<= [MariaDB 10.0](/kb/en/what-is-mariadb-100/))
* Range: `1` to `65536`
* Documentation: [Using the thread pool](thread-pool-in-mariadb-51-53.md).
...
* Data Type: `numeric`
* Default Value: `500`
* Range: `10` to `4294967295` (< [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105)), `1` to `4294967295` (>= [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105))
* Documentation: [Using the thread pool](thread-pool-in-mariadb-51-53.md).
