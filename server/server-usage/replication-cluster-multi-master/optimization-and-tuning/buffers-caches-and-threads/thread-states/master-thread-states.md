...
| --- | --- |
| Value | Description |
| Finished reading one binlog; switching to next binlog | After completing one [binary log](../../../../../server-management/server-monitoring-logs/binary-log/README.md), the next is being opened for sending to the slave. |
...
| Sending binlog event to slave | An event has been read from the [binary log](../../../../../server-management/server-monitoring-logs/binary-log/README.md), and is now being sent to the slave. |
