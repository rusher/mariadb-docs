...
This article documents thread states that are related to the connection thread that processes [INSERT DELAYED](../../../../../ref/sql-statements-and-structure/sql-statements/data-manipulation/inserting-loading-data/insert-delayed.md) statements.
