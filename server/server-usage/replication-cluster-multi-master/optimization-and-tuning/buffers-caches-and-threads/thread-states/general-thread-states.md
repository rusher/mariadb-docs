...
This article documents the major general thread states. More specific lists related to [delayed inserts](../../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/inserting-loading-data/insert-delayed.md), [replication](../../../README.md), the [query cache](../query-cache.md) and the [event scheduler](../../../../programming-customizing-mariadb/triggers-events/event-scheduler/events.md) are listed in:
...
| converting HEAP to Aria | Converting an internal [MEMORY](../../../../../reference/storage-engines/memory-storage-engine.md) temporary table into an on-disk [Aria](../../../../../reference/storage-engines/aria/README.md) temporary table. |
| converting HEAP to MyISAM | Converting an internal [MEMORY](../../../../../reference/storage-engines/memory-storage-engine.md) temporary table into an on-disk [MyISAM](../../../../../reference/storage-engines/myisam-storage-engine/README.md) temporary table. |
...
| Creating index | Processing an [ALTER TABLE ... ENABLE KEYS](../../../../../reference/sql-statements-and-structure/sql-statements/data-definition/alter/alter-table.md) for an [Aria](../../../../../reference/storage-engines/aria/README.md) or [MyISAM](../../../../../reference/storage-engines/myisam-storage-engine/README.md) table. |
| Creating sort index | Processing a [SELECT](../../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/select.md) statement resolved using an internal temporary table. |
...
| end | State before the final cleanup of an [ALTER TABLE](../../../../../reference/sql-statements-and-structure/sql-statements/data-definition/alter/alter-table.md), [CREATE VIEW](../../../../programming-customizing-mariadb/views/create-view.md), [DELETE](../../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/changing-deleting-data/delete.md), [INSERT](../../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/inserting-loading-data/insert.md), [SELECT](../../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/select.md), or [UPDATE](../../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/changing-deleting-data/update.md) statement. |
...
| filling schema table | A table in the [information_schema](../../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/README.md) database is being built. |
...
| Flushing tables | Executing a [FLUSH TABLES](../../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/flush-commands/flush.md) statement and waiting for other threads to close their tables. |
...
| logging slow query | Writing statement to the [slow query log](../../../../../server-management/server-monitoring-logs/slow-query-log/README.md). |
...
| removing tmp table | Removing an internal temporary table after processing a [SELECT](../../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/select.md) statement. |
...
| Saving state | New table state is being saved. For example, after, analyzing a [MyISAM](../../../../../reference/storage-engines/myisam-storage-engine/README.md) table, the key distributions, rowcount etc. are saved to the .MYI file. |
...
| Sending data | Sending data to the client as part of processing a [SELECT](../../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/select.md) statement or other statements that returns data like [INSERT ... RETURNING](../../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/inserting-loading-data/insertreturning.md) . Often the longest-occurring state as it also include all reading from tables and disk read activities. Where an aggregation or un-indexed filtering occurs there is significantly more rows read than what is sent to the client. |
...
| Sorting for group | Sorting as part of a [GROUP BY](../../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/select.md#group-by) |
| Sorting for order | Sorting as part of an [ORDER BY](../../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/select.md#order-by) |
| Sorting index | Sorting index pages as part of a table optimization operation. |
| Sorting result | Processing a [SELECT](../../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/select.md) statement using a non-temporary table. |
...
| System lock | Requesting or waiting for an external lock for a specific table. The [storage engine](../../../../../reference/storage-engines/README.md) determines what kind of external lock to use. For example, the [MyISAM](../../../../../reference/storage-engines/myisam-storage-engine/README.md) storage engine uses file-based locks. However, MyISAM's external locks are disabled by default, due to the default value of the [skip_external_locking](../../system-variables/server-system-variables.md#skip_external_locking) system variable. Transactional storage engines such as [InnoDB](../../../../../reference/storage-engines/innodb/README.md) also register the transaction or statement with MariaDB's [transaction coordinator](../../../../../server-management/server-monitoring-logs/transaction-coordinator-log/README.md) while in this thread state. See [MDEV-19391](https://jira.mariadb.org/browse/MDEV-19391) for more information about that. |
