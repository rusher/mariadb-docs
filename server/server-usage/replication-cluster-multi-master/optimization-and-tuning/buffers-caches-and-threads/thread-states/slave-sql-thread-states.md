...
| Waiting for worker threads to pause for global read lock | [FLUSH TABLES WITH READ LOCK](../../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/flush-commands/flush-tables-for-export.md) is waiting for worker threads to finish what they are doing. |
| Waiting while replication worker thread pool is busy | Happens in parallel replication during a [FLUSH TABLES WITH READ LOCK](../../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/flush-commands/flush-tables-for-export.md) or when changing number of parallel workers. |
