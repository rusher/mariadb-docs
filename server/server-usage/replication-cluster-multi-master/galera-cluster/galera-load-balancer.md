...
Galera Load Balancer is a simple Load Balancer specifically designed for [Galera Cluster](galera-use-cases.md). Like Galera, it only runs on Linux. Galera Load Balancer is developed and mantained by Codership. Documentation is available [on fromdual.com](http://www.fromdual.com/galera-load-balancer-documentation).
