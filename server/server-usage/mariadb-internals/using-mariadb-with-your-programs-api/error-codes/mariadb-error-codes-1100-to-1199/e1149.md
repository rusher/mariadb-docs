...
When creating [stored programs](../../../../stored-routines/) from the command-line, it is likely you will need to differentiate between the regular delimiter and a delimiter inside a [BEGIN END](../../../../../reference/sql-statements/programmatic-compound-statements/begin-end.md) block. See [Delimiters](../../../../../clients-and-utilities/mariadb-client/delimiters.md).
...
[Reserved words](../../../../../reference/sql-structure/sql-language-structure/reserved-words.md) cannot be used as [identifiers](../../../../../reference/sql-structure/sql-language-structure/identifier-names.md) unless they are quoted. For example:
...
The error was picked up after the `accessible` identifier, leading one to suspect that it's causing the problem. And indeed, it's a [reserved word](../../../../../reference/sql-structure/sql-language-structure/reserved-words.md). There are a number of possible solutions.
...
or [fully qualify](../../../../../reference/sql-structure/sql-language-structure/identifier-qualifiers.md) the identifier:
...
The error message directs one to the identifier `t`. Double quotes cannot be used to [quote identifiers](../../../../../reference/sql-structure/sql-language-structure/identifier-names.md#quote-character) unless ANSI\_MODE is set, which in this case it isn't:
