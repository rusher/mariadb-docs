...
The user is trying to access a table or a column from a table they do not have access to. See [GRANT](../../../../../reference/sql-statements/account-management-sql-statements/grant.md) for details on setting permissions.
