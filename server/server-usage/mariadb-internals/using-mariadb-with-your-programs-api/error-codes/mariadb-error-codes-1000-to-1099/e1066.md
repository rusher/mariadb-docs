...
For example, [HANDLER](../../../../../reference/sql-structure/nosql/handler/handler-commands.md) statements use unqualified table names, requiring the use of an alias in certain contexts. For example:
