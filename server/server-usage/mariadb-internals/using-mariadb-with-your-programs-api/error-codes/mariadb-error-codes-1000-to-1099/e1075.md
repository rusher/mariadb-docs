...
There can only be one [AUTO\_INCREMENT](../../../../../reference/data-types/auto_increment.md) column per table, and the column must be defined as a [key](../../../../../../en/getting-started-with-indexes/). Not adhering to either of these restrictions will result in this error. For example:
