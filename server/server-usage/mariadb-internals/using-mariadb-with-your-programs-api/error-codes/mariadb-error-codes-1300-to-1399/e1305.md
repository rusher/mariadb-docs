...
* The [stored procedure](../../../../stored-routines/stored-procedures/) or [stored function](../../../../stored-routines/stored-functions/) has not yet been created. See [CREATE PROCEDURE](../../../../stored-routines/stored-procedures/create-procedure.md) or [CREATE FUNCTION](../../../../../reference/sql-statements/data-definition/create/create-function.md). For example:
...
* There was a typo in the name. Check also that the case is correct. See [Identifier Case-sensitivity](../../../../../reference/sql-structure/sql-language-structure/identifier-case-sensitivity.md). For example:
...
Either change the default (current) database with the [USE statement](../../../../../reference/sql-statements/administrative-sql-statements/use-database.md), or specify the database in the call, for example:
