...
The user is trying to access a database/schema/object they do not have access to. The error shows which [GRANT](../../../../../reference/sql-statements/account-management-sql-statements/grant.md) is needed to access the resource.
