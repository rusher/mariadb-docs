...
There are alternative ways to add a new function: a native function, which requires modifying and compiling the server source code; a [function plugin](broken-reference); or a [stored function](../stored-routines/stored-functions/).
