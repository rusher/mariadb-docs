...
* The INSERT privilege for the mysql database is required to run [CREATE FUNCTION](create-function-udf.md), as a record will be added to the [mysql.func-table](../../reference/system-tables/the-mysql-database-tables/mysql-func-table.md).
* The DELETE privilege for the mysql database is required to run [DROP FUNCTION](drop-function-udf.md) as the corresponding record will be removed from the [mysql.func-table](../../reference/system-tables/the-mysql-database-tables/mysql-func-table.md).
