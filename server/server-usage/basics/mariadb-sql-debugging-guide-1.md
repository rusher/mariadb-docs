...
If the syntax error is shown near one of your identifiers, check if it appears on the [reserved word list](../../reference/sql-structure/sql-language-structure/reserved-words.md).
