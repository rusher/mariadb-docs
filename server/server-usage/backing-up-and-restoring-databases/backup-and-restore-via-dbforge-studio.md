...
![b1](../../.gitbook/assets/backup-and-restore-via-dbforge-studio/+image/b1.png)

On the **Backup content** page, select the objects to back up. Click **Next**.

![b2](../../.gitbook/assets/backup-and-restore-via-dbforge-studio/+image/b2.png)
...
![b3](../../.gitbook/assets/backup-and-restore-via-dbforge-studio/+image/b3.png)
...
![b4](../../.gitbook/assets/backup-and-restore-via-dbforge-studio/+image/b4.png)

After you have clicked **Backup**, dbForge Studio for MySQL starts to create a MariaDB backup.

![b5](../../.gitbook/assets/backup-and-restore-via-dbforge-studio/+image/b5.png)

When this is done, you will see the confirmation message. Click **Finish**.

![b6](../../.gitbook/assets/backup-and-restore-via-dbforge-studio/+image/b6.png)
...
![r1](../../.gitbook/assets/backup-and-restore-via-dbforge-studio/+image/r1.png)

When the process is complete, click **Finish**.

![r2](../../.gitbook/assets/backup-and-restore-via-dbforge-studio/+image/r2.png)
