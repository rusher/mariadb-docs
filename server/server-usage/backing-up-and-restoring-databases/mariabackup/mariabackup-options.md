...
If a backup is a [partial backup](partial-backup-and-restore-with-mariadb-backup.md), then mariadb-backup will record that detail in the [xtrabackup_info](files-created-by-mariadb-backup.md#xtrabackup_info) file.
...
* To create a [partial backup](partial-backup-and-restore-with-mariadb-backup.md), the [--include](#--include) option is used instead of the [--tables](#-tables) option.
* To create a [partial backup](partial-backup-and-restore-with-mariadb-backup.md), the [--databases](#--databases) option can still be used, but it's behavior changes slightly.
...
If a backup is a [partial backup](partial-backup-and-restore-with-mariadb-backup.md), then mariadb-backup will record that detail in the [xtrabackup\_info](files-created-by-mariadb-backup.md#xtrabackup_info) file.
