...
It is not generally possible, or supported, to prepare a backup in a different MariaDB version than the database version at the time when backup was taken. For example, if you backup [MariaDB 10.4](broken-reference), you should use mariabackup version 10.4, rather than e.g 10.5.
