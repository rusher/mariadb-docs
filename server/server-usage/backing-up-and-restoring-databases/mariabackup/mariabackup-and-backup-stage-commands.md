...
* Save the [Galera Cluster](https://github.com/mariadb-corporation/docs-server/blob/test/en/galera/README.md) state information to [xtrabackup_galera_info](files-created-by-mariadb-backup.md#xtrabackup_galera_info).
