...
A [trigger](triggers-and-implicit-locks.md) may reference multiple tables, and if a `[LOCK TABLES](../../../../ref/sql-statements-and-structure/sql-statements/transactions/lock-tables.md)` statement is used on one of the tables, other tables may at the same time also implicitly be locked due to the trigger.
