...
procedure](/en/stored-procedures/). More than one change may be specified in an `ALTER PROCEDURE`
statement. However, you cannot change the parameters or body of a
stored procedure using this statement. To make such changes, you must
drop and re-create the procedure using either [CREATE OR REPLACE PROCEDURE](create-procedure.md) (since [MariaDB 10.1.3](/en/mariadb-1013-release-notes/)) or [DROP PROCEDURE](drop-procedure.md) and [CREATE PROCEDURE](create-procedure.md) ([MariaDB 10.1.2](/en/mariadb-1012-release-notes/) and before).
