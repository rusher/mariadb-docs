...
A Stored Procedure is a routine invoked with a [CALL](../../../../ref/sql-statements-and-structure/sql-statements/stored-routine-statements/call.md) statement. It may have input parameters, output parameters and parameters that are both input parameters and output parameters.
...
To find which stored functions are running on the server, use [SHOW PROCEDURE STATUS](../../../../ref/sql-statements-and-structure/sql-statements/administrative-sql-statements/show/show-procedure-status.md).
...
To find out what the stored procedure does, use [SHOW CREATE PROCEDURE](../../../../ref/sql-statements-and-structure/sql-statements/administrative-sql-statements/show/show-create-procedure.md).
