...
Creating a custom aggregate function is done using the [CREATE FUNCTION](../../user-defined-functions/create-function-udf.md) statement with two main differences:
