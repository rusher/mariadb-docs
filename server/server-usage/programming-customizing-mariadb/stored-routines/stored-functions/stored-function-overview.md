...
Take a look at the [CREATE FUNCTION](../../user-defined-functions/create-function-udf.md) page for more details.

From [MariaDB 10.3.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-3-series/mariadb-1033-release-notes), it is also possible to create [stored aggregate functions](stored-aggregate-functions.md).
...
To drop a stored function, use the [DROP FUNCTION](../../user-defined-functions/drop-function-udf.md) statement.
...
* [DROP FUNCTION](../../user-defined-functions/drop-function-udf.md)
