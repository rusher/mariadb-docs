...
*x_remove()* was added in [MariaDB 10.4](../../../../release-notes/mariadb-community-server/what-is-mariadb-104.md) and is declared as follows (same as *x_add()*):
