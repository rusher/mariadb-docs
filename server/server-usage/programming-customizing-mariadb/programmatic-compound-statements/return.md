...
This statement is not used in [stored procedures](../stored-routines/stored-procedures/README.md), [triggers](../triggers-events/triggers/README.md), or [events](../triggers-events/event-scheduler/events.md). [LEAVE](leave.md) can be used instead.
