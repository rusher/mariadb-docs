...
The `RETURN` statement terminates execution of a [stored function](/kb/en/stored-functions/) and
...
This statement is not used in [stored procedures](/kb/en/stored-procedures/), [triggers](../triggers-events/triggers/triggers-and-implicit-locks.md), or [events](../triggers-events/event-scheduler/events.md). [LEAVE](leave.md) can be used instead.
