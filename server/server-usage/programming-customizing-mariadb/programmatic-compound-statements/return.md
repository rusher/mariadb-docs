...
The following example shows that `RETURN` can return the result of a [scalar subquery](../../../ref/sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/joins-subqueries/subqueries/subqueries-scalar-subqueries.md):
