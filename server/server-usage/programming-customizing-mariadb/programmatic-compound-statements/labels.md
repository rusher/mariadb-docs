...
[LEAVE](leave.md) and [ITERATE](iterate.md) statements can be used to exit or repeat a portion of code identified by a label. They must be in the same [Stored Routine](/en/stored-programs-and-views/), [Trigger](../triggers-events/triggers/triggers-and-implicit-locks.md) or [Event](../triggers-events/event-scheduler/events.md) which contains the target label.
