...
The [Information Schema](../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/README.md) `VIEWS` table contains information about [views](README.md). The `SHOW VIEW` [privilege](../../../reference/sql-statements-and-structure/sql-statements/account-management-sql-commands/grant.md) is required to view the table.
