...
become part of the view. A [SHOW CREATE VIEW](../../../ref/sql-statements-and-structure/sql-statements/administrative-sql-statements/show/show-create-view.md) shows that
...
will result in an error. [CHECK TABLE](../../../ref/sql-statements-and-structure/sql-statements/table-statements/check-table.md) helps in finding this kind
of problems.
...
* For valid identifiers to use as view names, see [Identifier Names](../../../ref/sql-statements-and-structure/sql-language-structure/identifier-names.md).
...
[MariaDB 10.6.1](../../../../release-notes/mariadb-community-server/release-notes-mariadb-10-6-series/mariadb-1061-release-notes.md) supports [Atomic DDL](../../../ref/sql-statements-and-structure/sql-statements/data-definition/atomic-ddl.md) and `CREATE VIEW` is atomic.
