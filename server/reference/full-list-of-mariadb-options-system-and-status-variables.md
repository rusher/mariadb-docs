...
| [aria\_block\_size](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [aria\_checkpoint\_interval](../server-usage/storage-engines/aria/aria-system-variables.md)|
| [aria\_checkpoint\_log\_activity](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [aria\_encrypt\_tables](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [aria\_force\_start\_after\_recovery\_failures](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [aria\_group\_commit](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [aria\_group\_commit\_interval](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [aria\_log\_dir\_path](../server-usage/storage-engines/aria/aria-system-variables.md)|
| [aria\_log\_file\_size](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [aria\_log\_purge\_type](../server-usage/storage-engines/aria/aria-system-variables.md)|
| [aria\_max\_sort\_file\_size](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [aria\_page\_checksum](../server-usage/storage-engines/aria/aria-system-variables.md)|
| [aria\_pagecache\_age\_threshold](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [Aria\_pagecache\_blocks\_not\_flushed](../server-usage/storage-engines/aria/aria-status-variables.md) |
| [Aria\_pagecache\_blocks\_unused](../server-usage/storage-engines/aria/aria-status-variables.md) |
| [Aria\_pagecache\_blocks\_used](../server-usage/storage-engines/aria/aria-status-variables.md) |
| [aria\_pagecache\_buffer\_size](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [aria\_pagecache\_division\_limit](../server-usage/storage-engines/aria/aria-system-variables.md)|
| [aria\_pagecache\_file\_hash\_size](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [Aria\_pagecache\_read\_requests](../server-usage/storage-engines/aria/aria-status-variables.md) |
| [Aria\_pagecache\_reads](../server-usage/storage-engines/aria/aria-status-variables.md)|
| [Aria\_pagecache\_write\_requests](../server-usage/storage-engines/aria/aria-status-variables.md)|
| [Aria\_pagecache\_writes](../server-usage/storage-engines/aria/aria-status-variables.md) |
| [aria\_recover](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [aria\_recover\_options](../server-usage/storage-engines/aria/aria-system-variables.md)|
| [aria\_repair\_threads](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [aria\_sort\_buffer\_size](../server-usage/storage-engines/aria/aria-system-variables.md)|
| [aria\_stats\_method](../server-usage/storage-engines/aria/aria-system-variables.md) |
| [aria\_sync\_log\_dir](../server-usage/storage-engines/aria/aria-system-variables.md)|
| [Aria\_transaction\_log\_syncs](../server-usage/storage-engines/aria/aria-status-variables.md) |
| [aria\_used\_for\_temp\_tables](../server-usage/storage-engines/aria/aria-system-variables.md) |
...
| [feedback\_send\_timeout](../../reference/plugins/other-plugins/feedback-plugin.md#feedback_send_timeout)|
| [feedback\_server\_uid](../../reference/plugins/other-plugins/feedback-plugin.md#feedback_server_uid)|
| [feedback\_url](../../reference/plugins/other-plugins/feedback-plugin.md#feedback_url) |
| [feedback\_user\_info](../../reference/plugins/other-plugins/feedback-plugin.md#feedback_user_info)|
...
| [handlersocket\_epoll](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_epoll) |
| [handlersocket\_plain\_secret](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_plain_secret)|
| [handlersocket\_plain\_secret\_wr](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_plain_secret_wr) |
| [handlersocket\_port](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_port) |
| [handlersocket\_port\_wr](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_port_wr)|
| [handlersocket\_rcvbuf](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_rcvbuf) |
| [handlersocket\_readsize](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_readsize) |
| [handlersocket\_sndbuf](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_sndbuf) |
| [handlersocket\_threads](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_threads) |
| [handlersocket\_threads\_wr](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_threads_wr)|
| [handlersocket\_timeout](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_timeout) |
| [handlersocket\_verbose](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_verbose) |
| [handlersocket\_wrlock\_timeout](../../reference/sql-structure/nosql/handlersocket/handlersocket-configuration-options.md#handlersocket_wrlock_timeout)|
...
| --[innodb-compression-pad-pct-max](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_compression_pad_pct_max), [innodb\_compression\_pad\_pct\_max](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_compression_pad_pct_max) |
...
| --[innodb-defragment-frequency](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_defragment_frequency), [innodb\_defragment\_frequency](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_defragment_frequency) |
| --[innodb-defragment-n-pages](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_defragment_n_pages), [innodb\_defragment\_n\_pages](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_defragment_n_pages)|
| --[innodb-defragment-stats-accuracy](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_defragment_stats_accuracy), [innodb\_defragment\_stats\_accuracy](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_defragment_stats_accuracy)|
| --[innodb-dict-size-limit](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_dict_size_limit), [innodb\_dict\_size\_limit](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_dict_size_limit)|
...
| --[innodb-disable-sort-file-cache](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_disable_sort_file_cache), [innodb\_disable\_sort\_file\_cache](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_disable_sort_file_cache) |
| [innodb\_disallow\_writes](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_disallow_writes) |
| --[innodb-doublewrite](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_doublewrite), [innodb\_doublewrite](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_doublewrite)|
| --[innodb-doublewrite-file](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_doublewrite_file), [innodb\_doublewrite\_file](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_doublewrite_file) |
| --[innodb\_empty-free-list-algorithm](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_empty_free_list_algorithm), [innodb\_empty\_free\_list\_algorithm](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_empty_free_list_algorithm)|
| --[innodb-enable-unsafe-group-commit](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_enable_unsafe_group_commit), [innodb\_enable\_unsafe\_group\_commit](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_enable_unsafe_group_commit) |
| --[innodb-encrypt-log](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_encrypt_log), [innodb\_encrypt\_log](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_encrypt_log) |
| --[innodb-encrypt-tables](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_encrypt_tables), [innodb\_encrypt\_tables](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_encrypt_tables) |
| --[innodb-encrypt-temporary-tables](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_encrypt_temporary_tables), [innodb\_encrypt\_temporary\_tables](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_encrypt_temporary_tables)|
...
| --[innodb-encryption-rotate-key-age](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_encryption_rotate_key_age), [innodb\_encryption\_rotate\_key\_age](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_encryption_rotate_key_age) |
...
| --[innodb-encryption-rotation-iops](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_encryption_rotation_iops), [innodb\_encryption\_rotation\_iops](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_encryption_rotation_iops)|
...
| --[innodb-encryption-threads](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_encryption_threads), [innodb\_encryption\_threads](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_encryption_threads) |
| --[innodb-extra-rsegments](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_extra_rsegments), [innodb\_extra\_rsegments](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_extra_rsegments) |
| --[innodb-extra-undoslots](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_extra_undoslots), [innodb\_extra\_undoslots](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_extra_undoslots) |
| --[innodb-fake-changes](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_fake_changes), [innodb\_fake\_changes](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_fake_changes) |
| --[innodb-fast-checksum](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_fast_checksum), [innodb\_fast\_checksum](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_fast_checksum) |
| --[innodb-fast-shutdown](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_fast_shutdown), [innodb\_fast\_shutdown](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_fast_shutdown) |
| --[innodb-fatal-semaphore-wait-threshold](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_fatal_semaphore_wait_threshold), [innodb\_fatal\_semaphore\_wait\_threshold](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_fatal_semaphore_wait_threshold) |
| --[innodb-file-format](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_file_format), [innodb\_file\_format](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_file_format) |
| --[innodb-file-format-check](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_file_format_check), [innodb\_file\_format\_check](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_file_format_check)|
| --[innodb-file-format-max](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_file_format_max), [innodb\_file\_format\_max](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_file_format_max)|
| --[innodb-file-io-threads](../server-management/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[innodb-file-per-table](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_file_per_table), [innodb\_file\_per\_table](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_file_per_table)|
| --[innodb-fill-factor](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_fill_factor), [innodb\_fill\_factor](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_fill_factor) |
| --[innodb-flush-log-at-timeout](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flush_log_at_timeout), [innodb\_flush\_log\_at\_timeout](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flush_log_at_timeout) |
| --[innodb-flush-log-at-trx-commit](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flush_log_at_trx_commit), [innodb\_flush\_log\_at\_trx\_commit](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flush_log_at_trx_commit)|
| --[innodb-flush-method](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flush_method), [innodb\_flush\_method](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flush_method) |
| --[innodb-flush-neighbor-pages](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flush_neighbor_pages), [innodb\_flush\_neighbor\_pages](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flush_neighbor_pages)|
| --[innodb-flush-neighbors](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flush_neighbors), [innodb\_flush\_neighbors](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flush_neighbors) |
| --[innodb-flush-sync](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flush_sync), [innodb\_flush\_sync](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flush_sync) |
| --[innodb-flushing-avg-loops](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flushing_avg_loops), [innodb\_flushing\_avg\_loops](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_flushing_avg_loops)|
| --[innodb-force-load-corrupted](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_force_load_corrupted), [innodb\_force\_load\_corrupted](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_force_load_corrupted)|
| --[innodb-force-primary-key](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_force_primary_key), [innodb\_force\_primary\_key](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_force_primary_key)|
| --[innodb-force-recovery](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_force_recovery), [innodb\_force\_recovery](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_force_recovery) |
| --[innodb-foreground-preflush](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_foreground_preflush), [innodb\_foreground\_preflush](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_foreground_preflush) |
| --[innodb-ft-aux-table](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_aux_table), [innodb\_ft\_aux\_table](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_aux_table)|
| --[innodb-ft-cache-size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_cache_size), [innodb\_ft\_cache\_size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_cache_size)|
| --[innodb-ft-enable-diag-print](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_enable_diag_print), [innodb\_ft\_enable\_diag\_print](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_enable_diag_print) |
| --[innodb-ft-enable-stopword](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_enable_stopword), [innodb\_ft\_enable\_stopword](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_enable_stopword)|
| --[innodb-ft-max-token-size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_max_token_size), [innodb\_ft\_max\_token\_size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_max_token_size) |
| --[innodb-ft-min-token-size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_min_token_size), [innodb\_ft\_min\_token\_size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_min_token_size) |
| --[innodb-ft-num-word-optimize](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_num_word_optimize), [innodb\_ft\_num\_word\_optimize](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_num_word_optimize) |
| --[innodb-ft-result-cache-limit](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_result_cache_limit), [innodb\_ft\_result\_cache\_limit](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_result_cache_limit) |
| --[innodb-ft-server-stopword-table](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_server_stopword_table), [innodb\_ft\_server\_stopword\_table](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_server_stopword_table) |
| --[innodb-ft-sort-pll-degree](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_sort_pll_degree), [innodb\_ft\_sort\_pll\_degree](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_sort_pll_degree) |
| --[innodb-ft-total-cache-size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_total_cache_size), [innodb\_ft\_total\_cache\_size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ft_total_cache_size) |
...
| --[innodb-ibuf-accel-rate](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ibuf_accel_rate), [innodb\_ibuf\_accel\_rate](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ibuf_accel_rate)|
| --[innodb-ibuf-active-contract](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ibuf_active_contract), [innodb\_ibuf\_active\_contract](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ibuf_active_contract)|
...
| --[innodb-ibuf-max-size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ibuf_max_size), [innodb\_ibuf\_max\_size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_ibuf_max_size)|
...
| --[innodb-max-bitmap-file-size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_bitmap_file_size), [innodb\_max\_bitmap\_file\_size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_bitmap_file_size) |
| --[innodb-max-changed-pages](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_changed_pages), [innodb\_max\_changed\_pages](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_changed_pages)|
| --[innodb-max-dirty-pages-pct](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_dirty_pages_pct), [innodb\_max\_dirty\_pages\_pct](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_dirty_pages_pct) |
| --[innodb-max-dirty-pages-pct-lwm](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_dirty_pages_pct_lwm), [innodb\_max\_dirty\_pages\_pct\_lwm](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_dirty_pages_pct_lwm)|
| --[innodb-max-purge-lag](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_purge_lag), [innodb\_max\_purge\_lag](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_purge_lag)|
| --[innodb-max-purge-lag-delay](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_purge_lag_delay), [innodb\_max\_purge\_lag\_delay](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_purge_lag_delay) |
| --[innodb-max-purge-lag-wait](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_purge_lag_wait), [innodb\_max\_purge\_lag\_wait](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_purge_lag_wait) |
...
| --[innodb-max-undo-log-size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_undo_log_size), [innodb\_max\_undo\_log\_size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_max_undo_log_size) |
...
| --[innodb-merge-sort-block-size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_merge_sort_block_size), [innodb\_merge\_sort\_block\_size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_merge_sort_block_size) |
| --[innodb-mirrored-log-groups](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_mirrored_log_groups), [innodb\_mirrored\_log\_groups](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_mirrored_log_groups)|
| --[innodb-monitor-disable](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_monitor_disable), [innodb\_monitor\_disable](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_monitor_disable) |
| --[innodb-monitor-enable](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_monitor_enable), [innodb\_monitor\_enable](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_monitor_enable) |
| --[innodb-monitor-reset](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_monitor_reset), [innodb\_monitor\_reset](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_monitor_reset) |
| --[innodb-monitor-reset-all](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_monitor_reset_all), [innodb\_monitor\_reset\_all](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_monitor_reset_all)|
| --[innodb-mtflush-threads](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_mtflush_threads), [innodb\_mtflush\_threads](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_mtflush_threads) |
...
| --[innodb-numa-interleave](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_numa_interleave), [innodb\_numa\_interleave](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_numa_interleave) |
| --[innodb-old-blocks-pct](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_old_blocks_pct), [innodb\_old\_blocks\_pct](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_old_blocks_pct)|
| --[innodb-old-blocks-time](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_old_blocks_time), [innodb\_old\_blocks\_time](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_old_blocks_time)|
...
| --[innodb-online-alter-log-max-size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_online_alter_log_max_size), [innodb\_online\_alter\_log\_max\_size](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_online_alter_log_max_size)|
...
| --[innodb-open-files](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_open_files), [innodb\_open\_files](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_open_files) |
| --[innodb-optimize-fulltext-only](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_optimize_fulltext_only), [innodb\_optimize\_fulltext\_only](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_optimize_fulltext_only)|
...
| --[innodb-page-cleaners](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_page_cleaners), [innodb\_page\_cleaners](../server-usage/storage-engines/innodb/innodb-system-variables.md#innodb_page_cleaners) |
...
| --[master-port](../server-management/starting-and-stopping-mariadb/mariadbd-options.md)|
| --[master-retry-count](../server-management/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-ssl](../server-management/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-ssl-ca](../server-management/starting-and-stopping-mariadb/mariadbd-options.md)|
| --[master-ssl-capath](../server-management/starting-and-stopping-mariadb/mariadbd-options.md)|
| --[master-ssl-cert](../server-management/starting-and-stopping-mariadb/mariadbd-options.md)|
...
| --[myisam-block-size](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md), [myisam\_block\_size](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md) |
| --[myisam-data-pointer-size](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md), [myisam\_data\_pointer\_size](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md)|
| --[myisam-max-extra-sort-file-size](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md), [myisam\_max\_extra\_sort\_file\_size](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md)|
| --[myisam-max-sort-file-size](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md), [myisam\_max\_sort\_file\_size](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md) |
| --[myisam-mmap-size](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md), [myisam\_mmap\_size](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md) |
| --[myisam-recover-options](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md), [myisam\_recover\_options](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md) |
| --[myisam-repair-threads](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md), [myisam\_repair\_threads](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md) |
| --[myisam-sort-buffer-size](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md), [myisam\_sort\_buffer\_size](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md)|
| --[myisam-stats-method](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md), [myisam\_stats\_method](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md) |
| --[myisam-use-mmap](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md), [myisam\_use\_mmap](../server-usage/storage-engines/myisam-storage-engine/myisam-system-variables.md) |
...
| --[performance-schema](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema), [performance\_schema](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema)|
| [Performance\_schema\_accounts\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_accounts_lost) |
| --[performance-schema-accounts-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_accounts_size), [performance\_schema\_accounts\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_accounts_size)|
| [Performance\_schema\_cond\_classes\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_cond_classes_lost)|
| [Performance\_schema\_cond\_instances\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_cond_instances_lost)|
...
| [Performance\_schema\_digest\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_digest_lost) |
| --[performance-schema-digests-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_digests_size), [performance\_schema\_digests\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_digests_size)|
| --[performance-schema-events-stages-history-long-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_stages_history_long_size), [performance\_schema\_events\_stages\_history\_long\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_stages_history_long_size) |
| --[performance-schema-events-stages-history-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_stages_history_size), [performance\_schema\_events\_stages\_history\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_stages_history_size)|
| --[performance-schema-events-statements-history-long-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_statements_history_long_size), [performance\_schema\_events\_statements\_history\_long\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_statements_history_long_size) |
| --[performance-schema-events-statements-history-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_statements_history_size), [performance\_schema\_events\_statements\_history\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_statements_history_size)|
| --[performance-schema-events-transactions-history-long-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_transactions_history_long_size), [performance\_schema\_events\_transactions\_history\_long\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_transactions_history_long_size) |
| --[performance-schema-events-transactions-history-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_transactions_history_size), [performance\_schema\_events\_transactions\_history\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_transactions_history_size)|
| --[performance-schema-events-waits-history-long-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_waits_history_long_size), [performance\_schema\_events\_waits\_history\_long\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_waits_history_long_size) |
| --[performance-schema-events-waits-history-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_waits_history_size), [performance\_schema\_events\_waits\_history\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_events_waits_history_size)|
| [Performance\_schema\_file\_classes\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_file_classes_lost)|
| [Performance\_schema\_file\_handles\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_file_handles_lost)|
| [Performance\_schema\_file\_instances\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_file_instances_lost)|
| [Performance\_schema\_hosts\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_accounts_lost)|
| --[performance-schema-hosts-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_hosts_size), [performance\_schema\_hosts\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_hosts_size)|
| [Performance\_schema\_locker\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_locker_lost) |
| [Performance\_schema\_index\_stat\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_index_stat_lost)|
| --[performance-schema-max-cond-classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_cond_classes), [performance\_schema\_max\_cond\_classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_cond_classes) |
| --[performance-schema-max-cond-instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_cond_instances), [performance\_schema\_max\_cond\_instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_cond_instances) |
| --[performance-schema-max-digest-length](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_digest_length), [performance\_schema\_max\_digest\_length](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_digest_length) |
| --[performance-schema-max-file-classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_file_classes), [performance\_schema\_max\_file\_classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_file_classes) |
| --[performance-schema-max-file-handles](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_file_handles), [performance\_schema\_max\_file\_handles](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_file_handles) |
| --[performance-schema-max-file-instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_file_instances), [performance\_schema\_max\_file\_instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_file_instances) |
| --[performance-schema-max-index-stat](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_index_stat), [performance\_schema\_max\_index\_stat](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_index_stat) |
| --[performance-schema-max-memory-classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_memory_classes), [performance\_schema\_max\_memory\_classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_memory_classes) |
| --[performance-schema-max-metadata-locks](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_metadata_locks), [performance\_schema\_max\_metadata\_locks](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_metadata_locks) |
| --[performance-schema-max-mutex-classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_mutex_classes), [performance\_schema\_max\_mutex\_classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_mutex_classes) |
| --[performance-schema-max-mutex-instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_mutex_instances), [performance\_schema\_max\_mutex\_instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_mutex_instances) |
| --[performance-schema-max-prepared-statement-instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_prepared_statement_instances), [performance\_schema\_max\_prepared\_statement\_instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_prepared_statement_instances)|
| --[performance-schema-max-program-instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_program_instances), [performance\_schema\_max\_program\_instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_program_instances) |
| --[performance-schema-max-sql-text-length](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_sql_text_length), [performance\_schema\_max\_sql\_text\_length](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_sql_text_length)|
| --[performance-schema-max-rwlock-classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_rwlock_classes), [performance\_schema\_max\_rwlock\_classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_rwlock_classes) |
| --[performance-schema-max-rwlock-instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_rwlock_instances), [performance\_schema\_max\_rwlock\_instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_rwlock_instances) |
| --[performance-schema-max-socket-classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_socket_classes), [performance\_schema\_max\_socket\_classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_socket_classes) |
| --[performance-schema-max-socket-instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_socket_instances), [performance\_schema\_max\_socket\_instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_socket_instances) |
| --[performance-schema-max-stage-classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_stage_classes), [performance\_schema\_max\_stage\_classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_stage_classes) |
| --[performance-schema-max-statement-classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_statement_classes), [performance\_schema\_max\_statement\_classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_statement_classes) |
| --[performance-schema-max-statement-stack](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_statement_stack), [performance\_schema\_max\_statement\_stack](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_statement_stack) |
| --[performance-schema-max-table-handles](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_table_handles), [performance\_schema\_max\_table\_handles](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_table_handles) |
| --[performance-schema-max-table-instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_table_instances), [performance\_schema\_max\_table\_instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_table_instances) |
| --[performance-schema-max-table-lock-stat](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_table_lock_stat), [performance\_schema\_max\_table\_lock\_stat](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_table_lock_stat)|
| --[performance-schema-max-thread-classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_thread_classes), [performance\_schema\_max\_thread\_classes](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_thread_classes) |
| --[performance-schema-max-thread-instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_thread_instances), [performance\_schema\_max\_thread\_instances](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_max_thread_instances) |
| [Performance\_schema\_memory\_classes\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_memory_classes_lost)|
| [Performance\_schema\_metadata\_lock\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_metadata_lock_lost)|
| [Performance\_schema\_mutex\_classes\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_mutex_classes_lost)|
| [Performance\_schema\_mutex\_instances\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_mutex_instances_lost)|
| [Performance\_schema\_nested\_statement\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_nested_statement_lost)|
| [Performance\_schema\_prepared\_statements\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_prepared_statements_lost)|
| [Performance\_schema\_program\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_program_lost) |
| [Performance\_schema\_rwlock\_classes\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_rwlock_classes_lost)|
| [Performance\_schema\_rwlock\_instances\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_rwlock_instances_lost)|
| [Performance\_schema\_session\_connect\_attrs\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_session_connect_attrs_lost) |
| [Performance\_schema\_socket\_classes\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_socket_classes_lost)|
| [Performance\_schema\_socket\_instances\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_socket_instances_lost)|
| [Performance\_schema\_stage\_classes\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_stage_classes_lost)|
| [Performance\_schema\_stage\_classes\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_stage_classes_lost)|
| [Performance\_schema\_statement\_classes\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_statement_classes_lost)|
| --[performance-schema-session-connect-attrs-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_session_connect_attrs_size), [performance\_schema\_session\_connect\_attrs\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_session_connect_attrs_size)|
| --[performance-schema-setup-actors-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_setup_actors_size), [performance\_schema\_setup\_actors\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_setup_actors_size) |
| --[performance-schema-setup-objects-size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_setup_objects_size), [performance\_schema\_setup\_objects\_size](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-system-variables.md#performance_schema_setup_objects_size) |
| [Performance\_schema\_table\_handles\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_table_handles_lost)|
| [Performance\_schema\_table\_instances\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_table_instances_lost)|
| [Performance\_schema\_table\_lock\_stat\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_table_lock_stat_lost) |
| [Performance\_schema\_thread\_classes\_lost](../../reference/sql-statements/administrative-sql-statements/system-tables/performance-schema/performance-schema-status-variables.md#performance_schema_thread_classes_lost)|
...
| [query\_response\_time\_range\_base](../../reference/plugins/other-plugins/query-response-time-plugin.md)|
...
| --[rocksdb-access-hint-on-compaction-start](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_access_hint_on_compaction_start), [rocksdb\_access\_hint\_on\_compaction\_start](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_access_hint_on_compaction_start)|
| --[rocksdb-advise-random-on-open](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_advise_random_on_open), [rocksdb\_advise\_random\_on\_open](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_advise_random_on_open) |
| --[rocksdb-allow-concurrent-memtable-write](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_allow_concurrent_memtable_write), [rocksdb\_allow\_concurrent\_memtable\_write](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_allow_concurrent_memtable_write) |
| --[rocksdb-allow-mmap-reads](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_allow_mmap_reads), [rocksdb\_allow\_mmap\_reads](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_allow_mmap_reads)|
| --[rocksdb-allow-mmap-writes](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_allow_mmap_writes), [rocksdb\_allow\_mmap\_writes](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_allow_mmap_writes)|
| --[rocksdb-allow-to-start-after-corruption](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_allow_to_start_after_corruption), [rocksdb\_allow\_to\_start\_after\_corruption](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_allow_to_start_after_corruption)|
| --[rocksdb-background-sync](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_background_sync), [rocksdb\_background\_sync](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_background_sync) |
| --[rocksdb\_base-background-compactions](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_base_background_compactions), [rocksdb\_base\_background\_compactions](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_base_background_compactions) |
| --[rocksdb-blind-delete-primary-key](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_blind_delete_primary_key), [rocksdb\_blind\_delete\_primary\_key](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_blind_delete_primary_key) |
| --[rocksdb-block-cache-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_block_cache_size), [rocksdb\_block\_cache\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_block_cache_size)|
| --[rocksdb\_block\_restart\_interval](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb-block-restart-interval), [rocksdb\_block\_restart\_interval](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_block_restart_interval) |
...
| --[rocksdb-block-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_block_size), [rocksdb\_block\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_block_size) |
| --[rocksdb-block-size-deviation](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_block_size_deviation), [rocksdb\_block\_size\_deviation](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_block_size_deviation)|
...
| --[rocksdb-bulk-load](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_bulk_load), [rocksdb\_bulk\_load](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_bulk_load) |
| --[rocksdb-bulk-load\_allow\_sk](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_bulk_load_allow_sk), [rocksdb\_bulk\_load\_allow\_sk](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_bulk_load_allow_sk) |
| --[rocksdb-bulk-load\_allow\_unsorted](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_bulk_load_allow_unsorted), [rocksdb\_bulk\_load\_allow\_unsorted](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_bulk_load_allow_unsorted) |
| --[rocksdb-bulk-load-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_bulk_load_size), [rocksdb\_bulk\_load\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_bulk_load_size)|
| --[rocksdb-bytes-per-sync](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_bytes_per_sync), [rocksdb\_bytes\_per\_sync](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_bytes_per_sync)|
...
| --[rocksdb-cache-dump](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_cache_dump), [rocksdb\_cache\_dump](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_cache_dump) |
| --[rocksdb-cache-high-pri-pool-ratio](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_cache_high_pri_pool_ratio), [rocksdb\_cache\_high\_pri\_pool\_ratio](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_cache_high_pri_pool_ratio)|
| --[rocksdb-cache-index-and-filter-blocks](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_cache_index_and_filter_blocks), [rocksdb\_cache\_index\_and\_filter\_blocks](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_cache_index_and_filter_blocks)|
| --[rocksdb-cache-index-and-filter-with-high-priority](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_cache_index_and_filter_with_high_priority), [rocksdb\_cache\_index\_and\_filter\_with\_high\_priority](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_cache_index_and_filter_with_high_priority)|
| --[rocksdb-checksums-pct](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_checksums_pct), [rocksdb\_checksums\_pct](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_checksums_pct) |
| --[rocksdb-collect-sst-properties](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_collect_sst_properties), [rocksdb\_collect\_sst\_properties](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_collect_sst_properties)|
| --[rocksdb-commit-in-the-middle](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_commit_in_the_middle), [rocksdb\_commit\_in\_the\_middle](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_commit_in_the_middle) |
| --[rocksdb-commit-time-batch-for-recovery](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_commit_time_batch_for_recovery), [rocksdb\_commit\_time\_batch\_for\_recovery](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_commit_time_batch_for_recovery)|
| --[rocksdb-compact-cf](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_compact_cf), [rocksdb\_compact\_cf](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_compact_cf) |
...
| --[rocksdb-compaction-readahead-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_compaction_readahead_size), [rocksdb\_compaction\_readahead\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_compaction_readahead_size)|
| --[rocksdb-compaction-sequential-deletes](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_compaction_sequential_deletes), [rocksdb\_compaction\_sequential\_deletes](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_compaction_sequential_deletes)|
| --[rocksdb-compaction-sequential-deletes-count-sd](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_compaction_sequential_deletes_count_sd), [rocksdb\_compaction\_sequential\_deletes\_count\_sd](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_compaction_sequential_deletes_count_sd)|
| --[rocksdb-concurrent-prepare](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_concurrent_prepare), [rocksdb\_concurrent\_prepare](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_concurrent_prepare) |
| --[rocksdb-compaction-sequential-deletes-file-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_compaction_sequential_deletes_file_size), [rocksdb\_compaction\_sequential\_deletes\_file\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_compaction_sequential_deletes_file_size)|
| --[rocksdb-compaction-sequential-deletes-window](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_compaction_sequential_deletes_window), [rocksdb\_compaction\_sequential\_deletes\_window](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_compaction_sequential_deletes_window) |
...
| --[rocksdb-create-checkpoint](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_create_checkpoint), [rocksdb\_create\_checkpoint](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_create_checkpoint) |
| --[rocksdb-create-if-missing](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_create_if_missing), [rocksdb\_create\_if\_missing](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_create_if_missing)|
| --[rocksdb-create-missing-column-families](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_create_missing_column_families), [rocksdb\_create\_missing\_column\_families](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_create_missing_column_families) |
| --[rocksdb-datadir](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_datadir), [rocksdb\_datadir](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_datadir)|
| --[rocksdb-db-write-buffer-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_db_write_buffer_size), [rocksdb\_db\_write\_buffer\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_db_write_buffer_size) |
| --[rocksdb-deadlock-detect](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_deadlock_detect), [rocksdb\_deadlock\_detect](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_deadlock_detect) |
| --[rocksdb-deadlock-detect-depth](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_deadlock_detect_depth), [rocksdb\_deadlock\_detect\_depth](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_deadlock_detect_depth)|
| --[rocksdb-debug-manual-compaction-delay](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_debug_manual_compaction_delay), [rocksdb\_debug\_manual\_compaction\_delay](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_debug_manual_compaction_delay) |
| --[rocksdb-debug-optimizer-no-zero-cardinality](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_debug_optimizer_no_zero_cardinality), [rocksdb\_debug\_optimizer\_no\_zero\_cardinality](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_debug_optimizer_no_zero_cardinality)|
| --[rocksdb-debug-ttl-ignore-pk](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_debug_ttl_ignore_pk), [rocksdb\_debug\_ttl\_ignore\_pk](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_debug_ttl_ignore_pk) |
| --[rocksdb-debug-ttl-read-filter-ts](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_debug_ttl_read_filter_ts), [rocksdb\_debug\_ttl\_read\_filter\_ts](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_debug_ttl_read_filter_ts)|
| --[rocksdb-debug-ttl-rec-ts](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_debug_ttl_rec_ts), [rocksdb\_debug\_ttl\_rec\_ts](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_debug_ttl_rec_ts) |
| --[rocksdb-debug-ttl-snapshot-ts](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_debug_ttl_snapshot_ts), [rocksdb\_debug\_ttl\_snapshot\_ts](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_debug_ttl_snapshot_ts) |
| --[rocksdb-default-cf-options](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_default_cf_options), [rocksdb\_default\_cf\_options](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_default_cf_options)|
| --[rocksdb-delayed-write-rate](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_delayed_write_rate), [rocksdb\_delayed\_write\_rate](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_delayed_write_rate)|
| --[rocksdb-delete-cf](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_delete_cf), [rocksdb\_delete\_cf](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_delete_cf) |
| --[rocksdb-delete-obsolete-files-period-micros](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_delete_obsolete_files_period_micros), [rocksdb\_delete\_obsolete\_files\_period\_micros](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_delete_obsolete_files_period_micros)|
| --[rocksdb-enable-2pc](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_2pc), [rocksdb\_enable\_2pc](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_2pc) |
| --[rocksdb-enable-bulk-load-api](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_bulk_load_api), [rocksdb\_enable\_bulk\_load\_api](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_bulk_load_api) |
| --[rocksdb-enable-insert-with-update-caching](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_insert_with_update_caching), [rocksdb\_enable\_insert\_with\_update\_caching](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_insert_with_update_caching)|
| --[rocksdb-enable-thread-tracking](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_thread_tracking), [rocksdb\_enable\_thread\_tracking](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_thread_tracking)|
| --[rocksdb-enable-ttl](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_ttl), [rocksdb\_enable\_ttl](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_ttl) |
| --[rocksdb-enable-ttl-read-filtering](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_ttl_read_filtering), [rocksdb\_enable\_ttl\_read\_filtering](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_ttl_read_filtering) |
| --[rocksdb-enable-write-thread-adaptive-yield](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_write_thread_adaptive_yield), [rocksdb\_enable\_write\_thread\_adaptive\_yield](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_enable_write_thread_adaptive_yield)|
| --[rocksdb-error-if-exists](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_error_if_exists), [rocksdb\_error\_if\_exists](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_error_if_exists)|
| --[rocksdb-error-on-suboptimal-collation](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_error_on_suboptimal_collation), [rocksdb\_on\_suboptimal\_collation](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_error_on_suboptimal_collation)|
| --[rocksdb-flush-log-at-trx-commit](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_flush_log_at_trx_commit), [rocksdb\_flush\_log\_at\_trx\_commit](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_flush_log_at_trx_commit)|
| --[rocksdb-flush-memtable-on-analyze](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_flush_memtable_on_analyze), [rocksdb\_flush\_memtable\_on\_analyze](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_flush_memtable_on_analyze) |
| [Rocksdb\_flush\_write\_bytes](../server-usage/storage-engines/myrocks/myrocks-status-variables.md#rocksdb_flush_write_bytes)|
| --[rocksdb-force-compute-memtable-stats](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_force_compute_memtable_stats), [rocksdb\_force\_compute\_memtable\_stats](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_force_compute_memtable_stats) |
| --[rocksdb-force-compute-memtable-stats-cachetime](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_force_compute_memtable_stats_cachetime), [rocksdb\_force\_compute\_memtable\_stats\_cachetime](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_force_compute_memtable_stats_cachetime)|
| --[rocksdb-force-flush-memtable-and-lzero-now](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_force_flush_memtable_and_lzero_now), [rocksdb\_force\_flush\_memtable\_and\_lzero\_now](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_force_flush_memtable_and_lzero_now) |
| --[rocksdb-force-flush-memtable-now](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_force_flush_memtable_now), [rocksdb\_force\_flush\_memtable\_now](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_force_flush_memtable_now) |
| --[rocksdb-force-index-records-in-range](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_force_index_records_in_range), [rocksdb\_force\_index\_records\_in\_range](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_force_index_records_in_range)|
...
| --[rocksdb-git-hash](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_git_hash), [rocksdb\_git\_hash](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_git_hash) |
| --[rocksdb-hash-index-allow-collision](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_hash_index_allow_collision), [rocksdb\_hash\_index\_allow\_collision](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_hash_index_allow_collision) |
| --[rocksdb-ignore-unknown-options](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_ignore_unknown_options), [rocksdb\_ignore\_unknown\_options](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_ignore_unknown_options)|
| --[rocksdb-index-type](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_index_type), [rocksdb\_index\_type](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_index_type) |
| --[rocksdb-info-log-level](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_info_log_level), [rocksdb\_info\_log\_level](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_info_log_level)|
| --[rocksdb-io-write-timeout](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_io_write_timeout), [rocksdb\_io\_write\_timeout](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_io_write_timeout)|
| --[rocksdb-is-fd-close-on-exec](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_is_fd_close_on_exec), [rocksdb\_is\_fd\_close\_on\_exec](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_is_fd_close_on_exec)|
| [Rocksdb\_iter\_bytes\_read](../server-usage/storage-engines/myrocks/myrocks-status-variables.md#rocksdb_iter_bytes_read)|
| --[rocksdb-keep-log-file-num](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_keep_log_file_num), [rocksdb\_keep\_log\_file\_num](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_keep_log_file_num) |
...
| --[rocksdb-large-prefix](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_large_prefix), [rocksdb\_large\_prefix](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_large_prefix) |
| --[rocksdb-lock-scanned-rows](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_lock_scanned_rows), [rocksdb\_lock\_scanned\_rows](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_lock_scanned_rows)|
| --[rocksdb-lock-wait-timeout](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_lock_wait_timeout), [rocksdb\_lock\_wait\_timeout](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_lock_wait_timeout)|
| --[rocksdb-log-dir](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_log_dir), [rocksdb\_log\_dir](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_log_dir) |
| --[rocksdb-log-file-time-to-roll](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_log_file_time_to_roll), [rocksdb\_log\_file\_time\_to\_roll](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_log_file_time_to_roll)|
| --[rocksdb-manifest-preallocation-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_manifest_preallocation_size), [rocksdb\_manifest\_preallocation\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_manifest_preallocation_size)|
| --[rocksdb-manual-compaction-threads](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_manual_compaction_threads), [rocksdb\_manual\_compaction\_threads](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_manual_compaction_threads)|
...
| --[rocksdb-manual-wal-flush](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_manual_wal_flush), [rocksdb\_manual\_wal\_flush](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_manual_wal_flush)|
| --[rocksdb-master-skip-tx-api](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_master_skip_tx_api), [rocksdb\_master\_skip\_tx\_api](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_master_skip_tx_api) |
| --[rocksdb-max-background-compactions](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_background_compactions), [rocksdb\_max\_background\_compactions](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_background_compactions)|
| --[rocksdb-max-latest-deadlocks](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_latest_deadlocks), [rocksdb\_max\_latest\_deadlocks](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_latest_deadlocks)|
| --[rocksdb-max-background-flushes](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_background_flushes), [rocksdb\_max\_background\_flushes](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_background_flushes)|
| --[rocksdb-max-background-jobs](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_background_jobs), [rocksdb\_max\_background\_jobs](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_background_jobs)|
| --[rocksdb-max-log-file-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_log_file_size), [rocksdb\_max\_log\_file\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_log_file_size) |
| --[rocksdb-max-manifest-file-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_manifest_file_size), [rocksdb\_max\_manifest\_file\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_manifest_file_size) |
| --[rocksdb-max-manual-compactions](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_manual_compactions), [rocksdb\_max\_manual\_compactions](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_manual_compactions)|
| --[rocksdb-max-open-files](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_open_files), [rocksdb\_max\_open\_files](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_open_files)|
| --[rocksdb-max-row-locks](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_row_locks), [rocksdb\_max\_row\_locks](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_row_locks)|
| --[rocksdb-max-subcompactions](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_subcompactions), [rocksdb\_max\_subcompactions](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_subcompactions) |
| --[rocksdb-max-total-wal-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_total_wal_size), [rocksdb\_max\_total\_wal\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_max_total_wal_size) |
...
| --[rocksdb-merge-buf-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_merge_buf_size), [rocksdb\_merge\_buf\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_merge_buf_size)|
| --[rocksdb-merge-combine-read-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_merge_combine_read_size), [rocksdb\_merge\_combine\_read\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_merge_combine_read_size) |
| --[rocksdb-merge-tmp-file-removal-delay-ms](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_merge_tmp_file_removal_delay_ms), [rocksdb\_merge\_tmp\_file\_removal\_delay\_ms](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_merge_tmp_file_removal_delay_ms) |
| --[rocksdb-new-table-reader-for-compaction-inputs](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_new_table_reader_for_compaction_inputs), [rocksdb\_new\_table\_reader\_for\_compaction\_inputs](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_new_table_reader_for_compaction_inputs) |
| --[rocksdb-no-block-cache](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_no_block_cache), [rocksdb\_no\_block\_cache](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_no_block_cache)|
...
| --[rocksdb-override-cf-options](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_override_cf_options), [rocksdb\_override\_cf\_options](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_override_cf_options)|
| --[rocksdb-paranoid-checks](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_paranoid_checks), [rocksdb\_paranoid\_checks](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_paranoid_checks) |
| --[rocksdb-pause-background-work](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_pause_background_work), [rocksdb\_pause\_background\_work](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_pause_background_work)|
| --[rocksdb-perf-context-level](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_perf_context_level), [rocksdb\_perf\_context\_level](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_perf_context_level)|
| --[rocksdb-persistent-cache-path](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_persistent_cache_path), [rocksdb\_persistent\_cache\_path](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_persistent_cache_path)|
| --[rocksdb-persistent-cache-size-mb](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_persistent_cache_size_mb), [rocksdb\_persistent\_cache\_size\_mb](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_persistent_cache_size_mb) |
| --[rocksdb-pin-l0-filter-and-index-blocks-in-cache](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_pin_l0_filter_and_index_blocks_in_cache), [rocksdb\_pin\_l0\_filter\_and\_index\_blocks\_in\_cache](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_pin_l0_filter_and_index_blocks_in_cache) |
| --[rocksdb-print-snapshot-conflict-queries](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_print_snapshot_conflict_queries), [rocksdb\_print\_snapshot\_conflict\_queries](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_print_snapshot_conflict_queries) |
...
| --[rocksdb-rate-limiter-bytes-per-sec](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_rate_limiter_bytes_per_sec), [rocksdb\_rate\_limiter\_bytes\_per\_sec](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_rate_limiter_bytes_per_sec)|
| --[rocksdb-read-free-rpl-tables](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_read_free_rpl_tables), [rocksdb\_read\_free\_rpl\_tables](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_read_free_rpl_tables) |
| --[rocksdb-records-in-range](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_records_in_range), [rocksdb\_records\_in\_range](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_records_in_range)|
| --[rocksdb-remove-mariabackup-checkpoint](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_remove_mariabackup_checkpoint), [rocksdb\_remove\_mariabackup\_checkpoint](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_remove_mariabackup_checkpoint)|
| --[rocksdb-reset-stats](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_reset_stats), [rocksdb\_reset\_stats](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_reset_stats) |
| --[rocksdb-rollback-on-timeout](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_rollback_on_timeout), [rocksdb\_rollback\_on\_timeout](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_rollback_on_timeout)|
...
| --[rocksdb-seconds-between-stat-computes](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_seconds_between_stat_computes), [rocksdb\_seconds\_between\_stat\_computes](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_seconds_between_stat_computes) |
| --[rocksdb-signal-drop-index-thread](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_signal_drop_index_thread), [rocksdb\_signal\_drop\_index\_thread](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_signal_drop_index_thread) |
| --[rocksdb-sim-cache-size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_sim_cache_size), [rocksdb\_sim\_cache\_size](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_sim_cache_size)|
| --[rocksdb-skip-bloom-filter-on-read](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_skip_bloom_filter_on_read), [rocksdb\_skip\_bloom\_filter\_on\_read](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_skip_bloom_filter_on_read)|
| --[rocksdb-skip-fill-cache](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_skip_fill_cache), [rocksdb\_skip\_fill\_cache](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_skip_fill_cache)|
| --[rocksdb-skip-unique-check-tables](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_skip_unique_check_tables), [rocksdb\_skip\_unique\_check\_tables](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_skip_unique_check_tables) |
...
| --[rocksdb-sst-mgr-rate-bytes-per-sec](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_sst_mgr_rate_bytes_per_sec), [rocksdb\_sst\_mgr\_rate\_bytes\_per\_sec](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_sst_mgr_rate_bytes_per_sec) |
...
| --[rocksdb-stats-dump-period-sec](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_stats_dump_period_sec), [rocksdb\_stats\_dump\_period\_sec](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_stats_dump_period_sec) |
| --[rocksdb-stats-level](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_stats_level), [rocksdb\_stats\_level](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_stats_level) |
| --[rocksdb-stats-recalc-rate](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_stats_recalc_rate), [rocksdb\_stats\_recalc\_rate](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_stats_recalc_rate)|
| --[rocksdb-store-row-debug-checksums](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_store_row_debug_checksums), [rocksdb\_store\_row\_debug\_checksums](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_store_row_debug_checksums) |
| --[rocksdb-strict-collation-check](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_strict_collation_check), [rocksdb\_strict\_collation\_check](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_strict_collation_check)|
| --[rocksdb-strict-collation-exceptions](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_strict_collation_exceptions), [rocksdb\_strict\_collation\_exceptions](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_strict_collation_exceptions)|
| --[rocksdb-supported-compression-types](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_supported_compression_types), [rocksdb\_supported\_compression\_types](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_supported_compression_types)|
...
| --[rocksdb-table-cache-numshardbits](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_table_cache_numshardbits), [rocksdb\_table\_cache\_numshardbits](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_table_cache_numshardbits)|
| --[rocksdb-table-stats-sampling-pct](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_table_stats_sampling_pct), [rocksdb\_table\_stats\_sampling\_pct](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_table_stats_sampling_pct) |
| --[rocksdb-tmpdir](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_tmpdir), [rocksdb\_tmpdir](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_tmpdir)|
| --[rocksdb-trace-sst-api](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_trace_sst_api), [rocksdb\_trace\_sst\_api](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_trace_sst_api)|
| --[rocksdb-two-write-queues](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_two_write_queues), [rocksdb\_two\_write\_queues](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_two_write_queues)|
| --[rocksdb-unsafe-for-binlog](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_unsafe_for_binlog), [rocksdb\_unsafe\_for\_binlog](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_unsafe_for_binlog)|
| --[rocksdb-update-cf-options](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_update_cf_options), [rocksdb\_update\_cf\_options](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_update_cf_options)|
| --[rocksdb-use-adaptive-mutex](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_use_adaptive_mutex), [rocksdb\_use\_adaptive\_mutex](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_use_adaptive_mutex)|
| --[rocksdb-use-clock-cache](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_use_clock_cache), [rocksdb\_use\_clock\_cache](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_use_clock_cache)|
| --[rocksdb-use-direct-io-for-flush-and-compaction](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_use_direct_io_for_flush_and_compaction), [rocksdb\_use\_direct\_io\_for\_flush\_and\_compaction](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_use_direct_io_for_flush_and_compaction)|
| --[rocksdb-use-direct-reads](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_use_direct_reads), [rocksdb\_use\_direct\_reads](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_use_direct_reads)|
| --[rocksdb-use-fsync](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_use_fsync), [rocksdb\_use\_fsync](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_use_fsync) |
| --[rocksdb-validate-tables](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_validate_tables), [rocksdb\_validate\_tables](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_validate_tables) |
| --[rocksdb-verify-row-debug-checksums](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_verify_row_debug_checksums), [rocksdb\_verify\_row\_debug\_checksums](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_verify_row_debug_checksums) |
| [Rocksdb\_wal\_bytes](../server-usage/storage-engines/myrocks/myrocks-status-variables.md#rocksdb_wal_bytes) |
| --[rocksdb-wal-bytes-per-sync](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_wal_bytes_per_sync), [rocksdb\_wal\_bytes\_per\_sync](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_wal_bytes_per_sync) |
| --[rocksdb-wal-dir](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_wal_dir), [rocksdb\_wal\_dir](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_wal_dir) |
| [Rocksdb\_wal\_group\_syncs](../server-usage/storage-engines/myrocks/myrocks-status-variables.md#rocksdb_wal_group_syncs)|
| --[rocksdb-wal-recovery-mode](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_wal_recovery_mode), [rocksdb\_wal\_recovery\_mode](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_wal_recovery_mode)|
| --[rocksdb-wal-size-limit-mb](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_wal_size_limit_mb), [rocksdb\_wal\_size\_limit\_mb](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_wal_size_limit_mb) |
| [Rocksdb\_wal\_synced](../server-usage/storage-engines/myrocks/myrocks-status-variables.md#rocksdb_wal_synced) |
| --[rocksdb-wal-ttl-seconds](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_wal_ttl_seconds), [rocksdb\_wal\_ttl\_seconds](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_wal_ttl_seconds)|
| --[rocksdb-whole-key-filtering](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_whole_key_filtering), [rocksdb\_whole\_key\_filtering](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_whole_key_filtering)|
| --[rocksdb-write-batch-max-bytes](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_write_batch_max_bytes), [rocksdb\_write\_batch\_max\_bytes](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_write_batch_max_bytes) |
| --[rocksdb-write-disable-wal](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_write_disable_wal), [rocksdb\_write\_disable\_wal](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_write_disable_wal)|
| --[rocksdb-write-ignore-missing-column-families](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_write_ignore_missing_column_families), [rocksdb\_write\_ignore\_missing\_column\_families](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_write_ignore_missing_column_families)|
| --[rocksdb-write-policy](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_write_policy), [rocksdb\_write\_policy](../server-usage/storage-engines/myrocks/myrocks-system-variables.md#rocksdb_write_policy) |
...
| [server\_audit\_events](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md) |
| [server\_audit\_excl\_users](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md)|
| [server\_audit\_file\_path](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md) |
| [Server\_audit\_last\_error](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-status-variables.md)|
| [server\_audit\_file\_rotate\_now](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md)|
| [server\_audit\_file\_rotate\_size](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md) |
| [server\_audit\_file\_rotations](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md)|
| [server\_audit\_incl\_users](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md)|
| [server\_audit\_loc\_info](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md)|
| [server\_audit\_logging](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md)|
| [server\_audit\_mode](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md) |
| [server\_audit\_output\_type](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md) |
| [server\_audit\_query\_limit](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md) |
| [server\_audit\_syslog\_facility](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md) |
| [server\_audit\_syslog\_ident](../../reference/plugins/mariadb-audit-plugin/mariadb-audit-plugin-options-and-system-variables.md)|
...
| [spider\_auto\_increment\_mode](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_bgs\_first\_read](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_bgs\_mode](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_bgs\_second\_read](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_bka\_engine](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_bka\_mode](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_block\_size](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_buffer\_size](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_bulk\_size](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_bulk\_update\_mode](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_bulk\_update\_size](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_casual\_read](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_conn\_recycle\_mode](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_conn\_recycle\_strict](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_conn\_wait\_timeout](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_connect\_error\_interval](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_connect\_mutex](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_connect\_retry\_count](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_connect\_retry\_interval](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_connect\_timeout](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_crd\_bg\_mode](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_crd\_interval](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_crd\_mode](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_crd\_sync](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_crd\_type](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_crd\_weight](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_delete\_all\_rows\_type](../server-usage/storage-engines/spider/spider-system-variables.md) |
...
| [spider\_direct\_dup\_insert](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_direct\_order\_limit](../server-usage/storage-engines/spider/spider-system-variables.md)|
...
| [spider\_dry\_access](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_error\_read\_mode](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_error\_write\_mode](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_first\_read](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_force\_commit](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_general\_log](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_ignore\_comments](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_index\_hint\_pushdown](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_init\_sql\_alloc\_size](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_internal\_limit](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_internal\_offset](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_internal\_optimize](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_internal\_optimize\_local](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_internal\_sql\_log\_off](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_internal\_unlock](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_internal\_xa](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_internal\_xa\_id\_type](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_internal\_xa\_snapshot](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_load\_crd\_at\_startup](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_load\_sts\_at\_startup](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_local\_lock\_table](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_lock\_exchange](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_log\_result\_error\_with\_sql](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_log\_result\_errors](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_low\_mem\_read](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_max\_connections](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_max\_order](../server-usage/storage-engines/spider/spider-system-variables.md)|
...
| [spider\_multi\_split\_read](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_net\_read\_timeout](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_net\_write\_timeout](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [Spider\_parallel\_search](../ha-and-performance/optimization-and-tuning/system-variables/spider-status-variables.md) |
| [spider\_ping\_interval\_at\_trx\_start](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_quick\_mode](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_quick\_page\_byte](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_quick\_page\_size](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_read\_only\_mode](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_remote\_access\_charset](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_remote\_autocommit](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_remote\_default\_database](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_remote\_sql\_log\_off](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_remote\_time\_zone](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_remote\_trx\_isolation](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_remote\_wait\_timeout](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_reset\_sql\_alloc](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_same\_server\_link](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_second\_read](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_select\_column\_mode](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_selupd\_lock\_mode](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_semi\_split\_read](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_semi\_split\_read\_limit](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_semi\_table\_lock](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_semi\_table\_lock\_connection](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_semi\_trx](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_semi\_trx\_isolation](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_skip\_default\_condition](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_skip\_parallel\_search](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_slave\_trx\_isolation](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_split\_read](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_store\_last\_crd](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_store\_last\_sts](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_strict\_group\_by](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_sts\_bg\_mode](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_sts\_interval](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_sts\_mode](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_sts\_sync](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_support\_xa](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_sync\_autocommit](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_sync\_sql\_mode](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_sync\_time\_zone](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_sync\_trx\_isolation](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_table\_crd\_thread\_count](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_table\_init\_error\_interval](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_table\_sts\_thread\_count](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_udf\_ct\_bulk\_insert\_interval](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_udf\_ct\_bulk\_insert\_rows](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_udf\_ds\_bulk\_insert\_rows](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_udf\_ds\_table\_loop\_mode](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_udf\_ds\_use\_real\_table](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_udf\_table\_lock\_mutex\_count](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_udf\_table\_mon\_mutex\_count](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_use\_all\_conns\_snapshot](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_use\_cond\_other\_than\_pk\_for\_update](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_use\_consistent\_snapshot](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_use\_default\_database](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_use\_flash\_logs](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_use\_handler](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_use\_pushdown\_udf](../server-usage/storage-engines/spider/spider-system-variables.md)|
| [spider\_use\_table\_charset](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_version](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_wait\_timeout](../server-usage/storage-engines/spider/spider-system-variables.md) |
| [spider\_xa\_register\_mode](../server-usage/storage-engines/spider/spider-system-variables.md)|
...
| [wsrep\_apply\_oooe](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/reference/galera-cluster-status-variables) |
| [wsrep\_apply\_oool](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/reference/galera-cluster-status-variables) |
...
| [wsrep\_cert\_deps\_distance](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/reference/galera-cluster-status-variables)|
