...
* [auto\_increment\_increment](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#auto_increment_increment)
* [auto\_increment\_offset](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#auto_increment_offset)
...
* [aws\_key\_management\_key\_spec](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin.md#aws_key_management_key_spec)
* [aws\_key\_management\_log\_level](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin.md#aws_key_management_log_level)
* [aws\_key\_management\_master\_key\_id](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin.md#aws_key_management_master_key_id)
* [aws\_key\_management\_mock](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin.md#aws_key_management_mock)
* [aws\_key\_management\_region](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin.md#aws_key_management_region)
* [aws\_key\_management\_request\_timeout](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin.md#aws_key_management_request_timeout)
* [aws\_key\_management\_rotate\_key](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin.md#aws_key_management_rotate_key)
...
* [Binlog\_bytes\_written](../ha-and-performance/standard-replication/replication-and-binary-log-status-variables.md#binlog_bytes_written)
...
* [binlog\_checksum](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#binlog_checksum)
...
* [Binlog\_commits](../ha-and-performance/standard-replication/replication-and-binary-log-status-variables.md#binlog_commits)
...
* \--[binlog-do-db](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#binlog-do-db), [binlog\_do\_db](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#binlog_do_db)
...
* [Binlog\_group\_commits](../ha-and-performance/standard-replication/replication-and-binary-log-status-variables.md#binlog_group_commits)
* [Binlog\_group\_commit\_trigger\_count](../ha-and-performance/standard-replication/replication-and-binary-log-status-variables.md#binlog_group_commit_trigger_count#binlog_group_commit_trigger_count)
* [Binlog\_group\_commit\_trigger\_lock\_wait](../ha-and-performance/standard-replication/replication-and-binary-log-status-variables.md#binlog_group_commit_trigger_lock_wait#binlog_group_commit_trigger_lock_wait)
...
* [binlog\_gtid\_index](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#binlog_gtid_index)
* [Binlog\_gtid\_index\_hit](../ha-and-performance/standard-replication/replication-and-binary-log-status-variables.md#binlog_gtid_index_hit#binlog_gtid_index_hit)
...
* \--[binlog-row-event-max-size](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#binlog-row-event-max-size), [binlog\_row\_event\_max\_size](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#binlog_row_event_max_size)
...
* [Binlog\_snapshot\_file](../ha-and-performance/standard-replication/replication-and-binary-log-status-variables.md#binlog_snapshot_file)
* [Binlog\_snapshot\_position](../ha-and-performance/standard-replication/replication-and-binary-log-status-variables.md#binlog_snapshot_position)
...
* [--debug-flush](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#debug-flush)
* [--debug-no-sync](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#debug-no-sync)
...
* [--debug-sync-timeout](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#debug-sync-timeout)
* \--[default-character-set](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#default-character-set)
* [default\_master\_connection](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#default_master_connection)
...
* \--[defaults-extra-file](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#defaults-extra-file)
* \--[defaults-file](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#defaults-file)
...
* \--[des-key-file](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#des-key-file)
...
* \--[disconnect-slave-event-count](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#disconnect-slave-event-count)
...
* -T, --[exit-info](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#exit-info)
...
* \--[external-locking](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#external-locking)
...
* [extra\_port](../ha-and-performance/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md#extra_port)
...
* [file\_key\_management\_encryption\_algorithm](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/file-key-management-encryption-plugin.md#file_key_management_encryption_algorithm)
* [file\_key\_management\_filekey](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/file-key-management-encryption-plugin.md#file_key_management_filekey)
* [file\_key\_management\_filename](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/file-key-management-encryption-plugin.md#file_key_management_filename)
* \--[flashback](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#flashback)
...
* \--[gdb](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#gdb)
...
* \--[getopt-prefix-matching](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#getopt-prefix-matching)
...
* [hashicorp-key-management-cache-timeout](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/hashicorp-key-management-plugin.md#hashicorp-key-management-cache-timeout)
...
* [hashicorp-key-management-vault-ca](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/hashicorp-key-management-plugin.md#hashicorp-key-management-vault-ca)
* [hashicorp-key-management-vault-url](../security/securing-mariadb/encryption/data-at-rest-encryption/key-management-and-encryption-plugins/hashicorp-key-management-plugin.md#hashicorp-key-management-vault-url)
...
* [have\_openssl](../security/securing-mariadb/encryption/data-in-transit-encryption/ssltls-system-variables.md)
...
* [have\_ssl](../security/securing-mariadb/encryption/data-in-transit-encryption/ssltls-system-variables.md)
* [have\_symlink](../ha-and-performance/optimization-and-tuning/system-variables/server-system-variables.md#have_symlink)
* \--[help](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#help)
...
* \--[innodb-cmp](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-cmp)
...
* \--[innodb-cmp-reset](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-cmp-reset)
* \--[innodb-cmpmem](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-cmpmem)
* \--[innodb-cmpmem-reset](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-cmpmem-reset)
...
* \--[innodb-file-io-threads](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-file-io-threads)
...
* \--[innodb-index-stats](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-index-stats)
...
* \--[innodb-lock-waits](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-lock-waits)
...
* \--[innodb-locks](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-locks)
...
* \--[innodb-rseg](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-rseg)
...
* \--[innodb-status-file](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-status-file)
...
* \--[innodb-sys-indexes](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-sys-indexes)
* \--[innodb-sys-stats](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-sys-stats)
* \--[innodb-sys-tables](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-sys-tables)
...
* \--[innodb-table-stats](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-table-stats)
...
* \--[innodb-trx](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#innodb-trx)
...
* \--[install](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#install)
* \--[install-manual](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#install-manual)
...
* \--[log-basename](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#log-basename)
...
* \--[log-bin-trust-routine-creators](../server-management/starting-and-stopping-mariadb/mariadbd-options.md#log-bin-trust-routine-creators)
...
* [replication\_connect\_retry](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_connect_retry)
* [replication\_retry\_count](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_retry_count)
* [replication\_heartbeat\_period](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_heartbeat_period)
* [replication\_ssl](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_ssl)
* [replication\_ssl\_ca](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_ssl_ca)
* [replication\_ssl\_capath](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_ssl_capath)
* [replication\_ssl\_cert](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_ssl_cert)
* [replication\_ssl\_key](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_ssl_key)
* [replication\_ssl\_cipher](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_ssl_cipher)
* [replication\_ssl\_crl](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_ssl_crl)
* [replication\_ssl\_crlpath](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_ssl_crlpath)
* [replication\_ssl\_verify\_server\_cert](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_ssl_verify_server_cert)
* [replication\_use\_gtid](../ha-and-performance/standard-replication/replication-and-binary-log-system-variables.md#replication_use_gtid)
...
* [ssl\_ca](../security/securing-mariadb/encryption/data-in-transit-encryption/ssltls-system-variables.md)
* [Ssl\_callback\_cache\_hits](../ha-and-performance/optimization-and-tuning/system-variables/ssltls-status-variables.md)
* [ssl\_capath](../security/securing-mariadb/encryption/data-in-transit-encryption/ssltls-system-variables.md)
* [ssl\_cert](../security/securing-mariadb/encryption/data-in-transit-encryption/ssltls-system-variables.md)
* [ssl\_cipher](../security/securing-mariadb/encryption/data-in-transit-encryption/ssltls-system-variables.md)
...
* [ssl\_crl](../security/securing-mariadb/encryption/data-in-transit-encryption/ssltls-system-variables.md)
* [ssl\_crlpath](../security/securing-mariadb/encryption/data-in-transit-encryption/ssltls-system-variables.md)
...
* [ssl\_key](../security/securing-mariadb/encryption/data-in-transit-encryption/ssltls-system-variables.md)
* [ssl\_passphrase](../security/securing-mariadb/encryption/data-in-transit-encryption/ssltls-system-variables.md#ssl_passphrase)
...
* [tls\_version](../security/securing-mariadb/encryption/data-in-transit-encryption/ssltls-system-variables.md#tls_version)
...
* [tokudb\_alter\_print\_error](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_alter_print_error)
* [tokudb\_analyze\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_analyze_time)
* [Tokudb\_basement\_deserialization\_fixed\_key](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basement_deserialization_fixed_key)
* [Tokudb\_basement\_deserialization\_variable\_key](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basement_deserialization_variable_key)
* [Tokudb\_basements\_decompressed\_for\_write](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_decompressed_for_write)
* [Tokudb\_basements\_decompressed\_prefetch](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_decompressed_prefetch)
* [Tokudb\_basements\_decompressed\_prelocked\_range](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_decompressed_prelocked_range)
* [Tokudb\_basements\_decompressed\_target\_query](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_decompressed_target_query)
* [Tokudb\_basements\_fetched\_for\_write](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_fetched_for_write)
* [Tokudb\_basements\_fetched\_for\_write\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_fetched_for_write_bytes)
* [Tokudb\_basements\_fetched\_for\_write\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_fetched_for_write_seconds)
* [Tokudb\_basements\_fetched\_prefetch](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_fetched_prefetch)
* [Tokudb\_basements\_fetched\_prefetch\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_fetched_prefetch_bytes)
* [Tokudb\_basements\_fetched\_prefetch\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_fetched_prefetch_seconds)
* [Tokudb\_basements\_fetched\_prelocked\_range](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_fetched_prelocked_range)
* [Tokudb\_basements\_fetched\_prelocked\_range\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_fetched_prelocked_range_bytes)
* [Tokudb\_basements\_fetched\_prelocked\_range\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_fetched_prelocked_range_seconds)
* [Tokudb\_basements\_fetched\_target\_query](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_fetched_target_query)
* [Tokudb\_basements\_fetched\_target\_query\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_fetched_target_query_bytes)
* [Tokudb\_basements\_fetched\_target\_query\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_basements_fetched_target_query_seconds)
* [Tokudb\_broadcase\_messages\_injected\_at\_root](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_broadcase_messages_injected_at_root)
* [Tokudb\_buffers\_decompressed\_prefetch](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_decompressed_prefetch)
* [Tokudb\_buffers\_decompressed\_for\_write](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_decompressed_for_write)
* [Tokudb\_buffers\_decompressed\_prelocked\_range](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_decompressed_prelocked_range)
* [Tokudb\_buffers\_decompressed\_target\_query](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_decompressed_target_query)
* [Tokudb\_buffers\_fetched\_for\_write](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_fetched_for_write)
* [Tokudb\_buffers\_fetched\_for\_write\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_fetched_for_write_bytes)
* [Tokudb\_buffers\_fetched\_for\_write\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_fetched_for_write_seconds)
* [Tokudb\_buffers\_fetched\_prefetch](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_fetched_prefetch)
* [Tokudb\_buffers\_fetched\_prefetch\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_fetched_prefetch_bytes)
* [Tokudb\_buffers\_fetched\_prefetch\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_fetched_prefetch_seconds)
* [Tokudb\_buffers\_fetched\_prelocked\_range](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_fetched_prelocked_range)
* [Tokudb\_buffers\_fetched\_prelocked\_range\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_fetched_prelocked_range_bytes)
* [Tokudb\_buffers\_fetched\_prelocked\_range\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_fetched_prelocked_range_seconds)
* [Tokudb\_buffers\_fetched\_target\_query](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_fetched_target_query)
* [Tokudb\_buffers\_fetched\_target\_query\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_fetched_target_query_bytes)
* [Tokudb\_buffers\_fetched\_target\_query\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_buffers_fetched_target_query_seconds)
* [tokudb\_bulk\_fetch](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_bulk_fetch)
* [tokudb\_cache\_size](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_cache_size)
* [Tokudb\_cachetable\_cleaner\_executions](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_cleaner_executions)
* [Tokudb\_cachetable\_cleaner\_iterations](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_cleaner_iterations)
* [Tokudb\_cachetable\_cleaner\_period](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_cleaner_period)
* [Tokudb\_cachetable\_evictions](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_evictions)
* [Tokudb\_cachetable\_long\_wait\_pressure\_count](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_long_wait_pressure_count)
* [Tokudb\_cachetable\_long\_wait\_pressure\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_long_wait_pressure_time)
* [Tokudb\_cachetable\_miss](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_miss)
* [Tokudb\_cachetable\_miss\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_miss_time)
* [Tokudb\_cachetable\_prefetches](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_prefetches)
* [Tokudb\_cachetable\_size\_cachepressure](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_size_cachepressure)
* [Tokudb\_cachetable\_size\_cloned](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_size_cloned)
* [Tokudb\_cachetable\_size\_current](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_size_current)
* [Tokudb\_cachetable\_size\_leaf](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_size_leaf)
* [Tokudb\_cachetable\_size\_limit](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_size_limit)
* [Tokudb\_cachetable\_size\_nonleaf](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_size_nonleaf)
* [Tokudb\_cachetable\_size\_rollback](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_size_rollback)
* [Tokudb\_cachetable\_size\_writing](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_size_writing)
* [Tokudb\_cachetable\_wait\_pressure\_count](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_wait_pressure_count)
* [Tokudb\_cachetable\_wait\_pressure\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cachetable_wait_pressure_time)
* [tokudb\_check\_jemalloc](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_check_jemalloc)
* [Tokudb\_checkpoint\_begin\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_checkpoint_begin_time)
* [Tokudb\_checkpoint\_duration](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_checkpoint_duration)
* [Tokudb\_checkpoint\_duration\_last](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_checkpoint_duration_last)
* [Tokudb\_checkpoint\_failed](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_checkpoint_failed)
* [Tokudb\_checkpoint\_last\_began](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_checkpoint_last_began)
* [Tokudb\_checkpoint\_last\_complete\_began](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_checkpoint_last_complete_began)
* [Tokudb\_checkpoint\_last\_complete\_ended](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_checkpoint_last_complete_ended)
* [tokudb\_checkpoint\_lock](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_checkoint_lock)
* [Tokudb\_checkpoint\_long\_begin\_count](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_checkpoint_long_begin_count)
* [Tokudb\_checkpoint\_long\_begin\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_checkpoint_long_begin_time)
* [tokudb\_checkpoint\_on\_flush\_logs](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_checkpoint_on_flush_logs)
* [Tokudb\_checkpoint\_period](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_checkpoint_period)
* [Tokudb\_checkpoint\_taken](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_checkpoint_taken)
* [tokudb\_checkpointing\_period](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_checkpointing_period)
* [tokudb\_cleaner\_iterations](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_cleaner_iterations)
* [tokudb\_cleaner\_period](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_cleaner_period)
* [tokudb\_commit\_sync](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_commit_sync)
* [tokudb\_create\_index\_online](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_create_index_online)
* [Tokudb\_cursor\_skip\_deleted\_leaf\_entry](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_cursor_skip_deleted_leaf_entry)
* [tokudb\_data\_dir](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_data_dir)
* [Tokudb\_db\_closes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_db_closes)
* [Tokudb\_db\_open\_current](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_db_open_current)
* [Tokudb\_db\_open\_max](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_db_open_max)
* [Tokudb\_db\_opens](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_db_opens)
* [tokudb\_debug](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_debug)
* [Tokudb\_descriptor\_set](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_descriptor_set)
* [Tokudb\_dictionary\_broadcast\_updates](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_dictionary_broadcast_updates)
* [Tokudb\_dictionary\_updates](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_dictionary_updates)
* [tokudb\_directio](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_directio)
* [tokudb\_disable\_hot\_alter](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_disable_hot_alter)
* [tokudb\_disable\_prefetching](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_disable_prefetching)
* [tokudb\_disable\_slow\_alter](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_disable_slow_alter)
* [tokudb\_empty\_scan](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_empty_scan)
* [Tokudb\_filesystem\_fsync\_num](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_filesystem_fsync_num)
* [Tokudb\_filesystem\_fsync\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_filesystem_fsync_time)
* [Tokudb\_filesystem\_long\_fsync\_num](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_filesystem_long_fsync_num)
* [Tokudb\_filesystem\_long\_fsync\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_filesystem_long_fsync_time)
* [Tokudb\_filesystem\_threads\_blocked\_by\_full\_disk](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_filesystem_threads_blocked_by_full_disk)
* [tokudb\_fs\_reserve\_percent](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_fs_reserve_percent)
* [tokudb\_fsync\_log\_period](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_fsync_log_period)
* [tokudb\_hide\_default\_row\_format](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_hide_default_row_format)
* [tokudb\_killed\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_killed_time)
* [tokudb\_last\_lock\_timeout](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_last_lock_timeout)
* [Tokudb\_leaf\_compression\_to\_memory\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_compression_to_memory_seconds)
* [Tokudb\_leaf\_decompression\_to\_memory\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_decompression_to_memory_seconds)
* [Tokudb\_leaf\_deserialization\_to\_memory\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_deserialization_to_memory_seconds)
* [Tokudb\_leaf\_node\_compression\_ratio](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_node_compression_ratio)
* [Tokudb\_leaf\_node\_full\_evictions](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_node_full_evictions)
* [Tokudb\_leaf\_node\_full\_evictions\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_node_full_evictions_bytes)
* [Tokudb\_leaf\_node\_partial\_evictions](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_node_partial_evictions)
* [Tokudb\_leaf\_node\_partial\_evictions\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_node_partial_evictions_bytes)
* [Tokudb\_leaf\_nodes\_created](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_nodes_created)
* [Tokudb\_leaf\_nodes\_destroyed](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_nodes_destroyed)
* [Tokudb\_leaf\_nodes\_flushed\_checkpoint](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_nodes_flushed_checkpoint)
* [Tokudb\_leaf\_nodes\_flushed\_checkpoint\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_nodes_flushed_checkpoint_bytes)
* [Tokudb\_leaf\_nodes\_flushed\_checkpoint\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_nodes_flushed_checkpoint_seconds)
* [Tokudb\_leaf\_nodes\_flushed\_checkpoint\_uncompressed\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_nodes_flushed_checkpoint_uncompressed_bytes)
* [Tokudb\_leaf\_nodes\_flushed\_not\_checkpoint](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_nodes_flushed_not_checkpoint)
* [Tokudb\_leaf\_nodes\_flushed\_not\_checkpoint\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_nodes_flushed_not_checkpoint_bytes)
* [Tokudb\_leaf\_nodes\_flushed\_not\_checkpoint\_secondss](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_nodes_flushed_not_checkpoint_seconds)
* [Tokudb\_leaf\_nodes\_flushed\_not\_checkpoint\_uncompressed\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_nodes_flushed_not_checkpoint_uncompressed_bytes)
* [Tokudb\_leaf\_serialization\_to\_memory\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_leaf_serialization_to_memory_seconds)
* [tokudb\_load\_save\_space](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_load_save_space)
* [tokudb\_loader\_memory\_size](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_loader_memory_size)
* [Tokudb\_loader\_num\_created](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_loader_num_created)
* [Tokudb\_loader\_num\_current](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_loader_num_current)
* [Tokudb\_loader\_num\_max](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_loader_num_max)
* [tokudb\_lock\_timeout](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_lock_timeout)
* [tokudb\_lock\_timeout\_debug](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_lock_timeout_debug)
* [Tokudb\_locktree\_escalation\_num](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_escalation_num)
* [Tokudb\_locktree\_escalation\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_escalation_seconds)
* [Tokudb\_locktree\_latest\_post\_escalation\_memory\_size](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_latest_post_escalation_memory_size)
* [Tokudb\_locktree\_long\_wait\_count](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_long_wait_count)
* [Tokudb\_locktree\_long\_wait\_escalation\_count](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_long_wait_escalation_count)
* [Tokudb\_locktree\_long\_wait\_escalation\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_long_wait_escalation_time)
* [Tokudb\_locktree\_long\_wait\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_long_wait_time)
* [Tokudb\_locktree\_memory\_size](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_memory_size)
* [Tokudb\_locktree\_memory\_size\_limit](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_memory_size_limit)
* [Tokudb\_locktree\_open\_current](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_open_current)
* [Tokudb\_locktree\_pending\_lock\_requests](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_pending_lock_requests)
* [Tokudb\_locktree\_sto\_eligible\_num](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_sto_eligible_num)
* [Tokudb\_locktree\_sto\_ended\_num](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_sto_ended_num)
* [Tokudb\_locktree\_sto\_ended\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_sto_ended_seconds)
* [Tokudb\_locktree\_timeout\_count](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_timeout_count)
* [Tokudb\_locktree\_wait\_count](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_wait_count)
* [Tokudb\_locktree\_wait\_escalation\_count](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_wait_escalation_count)
* [Tokudb\_locktree\_wait\_escalation\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_wait_escalation_time)
* [Tokudb\_locktree\_wait\_time](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_locktree_wait_time)
* [tokudb\_log\_dir](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md)
* [Tokudb\_logger\_wait\_long](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_logger_wait_long)
* [Tokudb\_logger\_writes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_logger_writes)
* [Tokudb\_logger\_writes\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_logger_writes_bytes)
* [Tokudb\_logger\_writes\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_logger_writes_seconds)
* [Tokudb\_logger\_writes\_uncompressed\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_logger_writes_uncompressed_bytes)
* [tokudb\_max\_lock\_memory](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_max_lock_memory)
* [Tokudb\_mem\_estimated\_maximum\_memory\_footprint](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_mem_estimated_maximum_memory_footprint)
* [Tokudb\_messages\_flushed\_from\_h1\_to\_leaves\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_messages_flushed_from_h1_to_leaves_bytes)
* [Tokudb\_messages\_ignored\_by\_leaf\_due\_to\_msn](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_messages_ignored_by_leaf_due_to_msn)
* [Tokudb\_messages\_in\_trees\_estimate\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_messages_in_trees_estimate_bytes)
* [Tokudb\_messages\_injected\_at\_root](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_messages_injected_at_root)
* [Tokudb\_messages\_injected\_at\_root\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_messages_injected_at_root_bytes)
* [Tokudb\_nonleaf\_compression\_to\_memory\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_compression_to_memory_seconds)
* [Tokudb\_nonleaf\_decompression\_to\_memory\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_decompression_to_memory_seconds)
* [Tokudb\_nonleaf\_deserialization\_to\_memory\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_deserialization_to_memory_seconds)
* [Tokudb\_nonleaf\_node\_compression\_ratio](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_node_compression_ratio)
* [Tokudb\_nonleaf\_node\_full\_evictions](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_node_full_evictions)
* [Tokudb\_nonleaf\_node\_full\_evictions\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_node_full_evictions_bytes)
* [Tokudb\_nonleaf\_node\_partial\_evictions](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_node_partial_evictions)
* [Tokudb\_nonleaf\_node\_partial\_evictions\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_node_partial_evictions_bytes)
* [Tokudb\_nonleaf\_nodes\_created](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_nodes_created)
* [Tokudb\_nonleaf\_nodes\_destroyed](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_nodes_destroyed)
* [Tokudb\_nonleaf\_nodes\_flushed\_to\_disk\_checkpoint](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_nodes_flushed_to_disk_checkpoint)
* [Tokudb\_nonleaf\_nodes\_flushed\_to\_disk\_checkpoint\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_nodes_flushed_to_disk_checkpoint_bytes)
* [Tokudb\_nonleaf\_nodes\_flushed\_to\_disk\_checkpoint\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_nodes_flushed_to_disk_checkpoint_seconds)
* [Tokudb\_nonleaf\_nodes\_flushed\_to\_disk\_checkpoint\_uncompressed\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_nodes_flushed_to_disk_checkpoint_uncompressed_bytes)
* [Tokudb\_nonleaf\_nodes\_flushed\_to\_disk\_not\_checkpoint](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_nodes_flushed_to_disk_not_checkpoint)
* [Tokudb\_nonleaf\_nodes\_flushed\_to\_disk\_not\_checkpoint\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_nodes_flushed_to_disk_not_checkpoint_bytes)
* [Tokudb\_nonleaf\_nodes\_flushed\_to\_disk\_not\_checkpoint\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_nodes_flushed_to_disk_not_checkpoint_seconds)
* [Tokudb\_nonleaf\_nodes\_flushed\_to\_disk\_not\_checkpoint\_uncompressed\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_nodes_flushed_to_disk_not_checkpoint_uncompressed_bytes)
* [Tokudb\_nonleaf\_serialization\_to\_memory\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_nonleaf_serialization_to_memory_seconds)
* [tokudb\_optimize\_index\_fraction](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_optimize_index_fraction)
* [tokudb\_optimize\_index\_name](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_optimize_index_name)
* [tokudb\_optimize\_throttle](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_optimize_throttle)
* [Tokudb\_overall\_node\_compression\_ratio](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_overall_node_compression_ratio)
* [Tokudb\_pivots\_fetched\_for\_query](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_pivots_fetched_for_query)
* [Tokudb\_pivots\_fetched\_for\_query\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_pivots_fetched_for_query_bytes)
* [Tokudb\_pivots\_fetched\_for\_query\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_pivots_fetched_for_query_seconds)
* [Tokudb\_pivots\_fetched\_for\_prefetch](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_pivots_fetched_for_prefetch)
* [Tokudb\_pivots\_fetched\_for\_prefetch\_bytes](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_pivots_fetched_for_prefetch_bytes)
* [Tokudb\_pivots\_fetched\_for\_prefetch\_seconds](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_pivots_fetched_for_prefetch_seconds)
* [Tokudb\_pivots\_fetched\_for\_write](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_pivots_fetched_for_write)
...
* [Tokudb\_promotion\_injections\_at\_depth\_2](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_promotion_injections_at_depth_2)
* [Tokudb\_promotion\_injections\_at\_depth\_3](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_promotion_injections_at_depth_3)
* [Tokudb\_promotion\_injections\_lower\_than\_depth\_3](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_promotion_injections_lower_than_depth_3)
* [Tokudb\_promotion\_leaf\_roots\_injected\_into](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_promotion_leaf_roots_injected_into)
* [Tokudb\_promotion\_roots\_split](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_promotion_roots_split)
* [Tokudb\_promotion\_stopped\_after\_locking\_child](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_promotion_stopped_after_locking_child)
* [Tokudb\_promotion\_stopped\_at\_height\_1](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_promotion_stopped_at_height_1)
* [Tokudb\_promotion\_stopped\_child\_locked\_or\_not\_in\_memory](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_promotion_stopped_child_locked_or_not_in_memory)
* [Tokudb\_promotion\_stopped\_child\_not\_fully\_in\_memory](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_promotion_stopped_child_not_fully_in_memory)
* [Tokudb\_promotion\_stopped\_nonempty\_buffer](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_promotion_stopped_nonempty_buffer)
* [tokudb\_read\_block\_size](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_read_block_size)
* [tokudb\_read\_buf\_size](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_read_buf_size)
* [tokudb\_read\_status\_frequency](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_read_status_frequency)
* [tokudb\_row\_format](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md#tokudb_row_format)
* [tokudb\_rpl\_check\_readonly](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md)
* [tokudb\_rpl\_lookup\_rows](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md)
* [tokudb\_rpl\_lookup\_rows\_delay](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md)
* [tokudb\_rpl\_unique\_checks](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md)
* [tokudb\_rpl\_unique\_checks\_delay](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md)
* [tokudb\_support\_xa](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md)
* [tokudb\_tmp\_dir](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md)
* [Tokudb\_txn\_aborts](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_txn_aborts)
* [Tokudb\_txn\_begin](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_txn_begin)
* [Tokudb\_txn\_begin\_read\_only](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_txn_begin_read_only)
* [Tokudb\_txn\_commits](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-status-variables.md#tokudb_txn_commits)
* [tokudb\_version](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md)
* [tokudb\_write\_status\_frequency](../server-usage/storage-engines/legacy-storage-engines/tokudb/tokudb-system-variables.md)
...
* [version\_ssl\_library](../security/securing-mariadb/encryption/data-in-transit-encryption/ssltls-system-variables.md)
...
* [wsrep\_applier\_thread\_count](https://app.gitbook.com/s/3VYeeVGUV4AMqrA3zwy7/reference/galera-cluster-status-variables#wsrep_applier_thread_count)
