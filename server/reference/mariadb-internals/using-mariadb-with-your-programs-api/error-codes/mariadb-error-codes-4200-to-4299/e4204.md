...
| --- | --- | --- | --- |
| Error Code | SQLSTATE | Error | Description |
| 4204 |  | ER_VECTOR_BINARY_FORMAT_INVALID | Invalid binary vector format. Must use IEEE standard float representation in little-endian format. Use VEC_FromText() to generate it. |
...
For example, the [VEC_ToText](../../../../sql-statements-and-structure/vectors/vector-functions/vec_totext.md) function expects a binary vector. If not given one, this error will result:
