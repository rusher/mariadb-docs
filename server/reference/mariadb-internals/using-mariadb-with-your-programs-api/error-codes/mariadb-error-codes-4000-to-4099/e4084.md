...
Prior to [MariaDB 11.5](../../../../../../release-notes/mariadb-community-server/what-is-mariadb-115.md), this defaulted to the maximum, BIGINT. From [MariaDB 11.5](../../../../../../release-notes/mariadb-community-server/what-is-mariadb-115.md), it can be BIGINT UNSIGNED
...
The underlying table is only updated with a new sequence value the first time the value is created, and then each time the [cache](../../../../sql-statements-and-structure/sequences/create-sequence.md#cache-nocache) expires. By default the cache is set to `<code>1000</code>`. For example:
