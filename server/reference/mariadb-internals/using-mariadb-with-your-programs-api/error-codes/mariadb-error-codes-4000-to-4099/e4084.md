...
In a [sequence](../../../../sql-statements-and-structure/sequences/README.md), once the MAXVALUE has been reached, and the [CYCLE](../../../../sql-statements-and-structure/sequences/create-sequence.md#cycle-nocycle) argument has not been used, further attempts to set the next value will fail:
...
Prior to [MariaDB 11.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/old-releases/release-notes-mariadb-11-5-rolling-releases/what-is-mariadb-115), this defaulted to the maximum, BIGINT. From [MariaDB 11.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/old-releases/release-notes-mariadb-11-5-rolling-releases/what-is-mariadb-115), it can be BIGINT UNSIGNED
...
The underlying table is only updated with a new sequence value the first time the value is created, and then each time the [cache](../../../../sql-statements-and-structure/sequences/create-sequence.md#cache-nocache) expires. By default the cache is set to `1000`. For example:
...
* [SHOW CREATE SEQUENCE](../../../../sql-statements-and-structure/sql-statements/administrative-sql-statements/show/show-create-sequence.md)
* [Information Schema SEQUENCES Table](../../../../sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/information-schema-tables/information-schema-sequences-table.md)
