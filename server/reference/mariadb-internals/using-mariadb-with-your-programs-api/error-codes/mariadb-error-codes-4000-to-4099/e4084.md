...
In a [sequence](../../../../sql-statements-and-structure/sequences/), once the MAXVALUE has been reached, and the [CYCLE](../../../../sql-statements-and-structure/sequences/create-sequence.md#cycle-nocycle) argument has not been used, further attempts to set the next value will fail:
