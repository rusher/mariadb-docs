...
The user is trying to access a database/schema they do not have access to. See [Troubleshooting Connection Issues](../../../../../../general-resources/learning-and-training/training-and-tutorials/basic-mariadb-articles/troubleshooting-connection-issues.md#access-to-the-server-but-not-to-a-database) for more, as well as [GRANT](../../../../sql-statements-and-structure/sql-statements/account-management-sql-commands/grant.md) for details on setting permissions.
