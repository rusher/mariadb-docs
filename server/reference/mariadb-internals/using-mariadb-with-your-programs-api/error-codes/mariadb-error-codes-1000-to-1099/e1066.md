...
For example, [HANDLER](../../../../sql-statements-and-structure/nosql/handler/handler-commands.md) statements use unqualified table names, requiring the use of an alias in certain contexts. For example:
