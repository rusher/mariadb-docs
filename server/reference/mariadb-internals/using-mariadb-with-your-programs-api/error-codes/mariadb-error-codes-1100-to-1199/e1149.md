...
The error message directs one to the identifier `t`. Double quotes cannot be used to [quote identifiers](../../../../sql-statements-and-structure/sql-language-structure/identifier-names.md#quote-character) unless ANSI\_MODE is set, which in this case it isn't:
...
[Oracle mode](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/compatibility-and-differences/sql_modeoracle) in particular has a large number of differences to the default [SQL\_MODE](../../../../../server-management/variables-and-modes/sql-mode.md), for example:
