...
* May need to set [innodb\_fatal\_semaphore\_wait\_threshold](../../storage-engines/innodb/innodb-system-variables.md#innodb_fatal_semaphore_wait_threshold) to be high enough?
