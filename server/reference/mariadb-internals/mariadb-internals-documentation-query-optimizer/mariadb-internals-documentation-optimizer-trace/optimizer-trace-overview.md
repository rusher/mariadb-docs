...
* [optimizer_trace=’enabled=on/off’](../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_trace)

  * Default value is off
* [optimizer_trace_max_mem_size](../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_trace_max_mem_size)= value
...
Each trace is stored as a string. It is extended (with realloc()) as the optimization progresses and appends data to it. The [optimizer_trace_max_mem_size](../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_trace_max_mem_size) variable sets a limit on the total amount of memory used by the current trace.
