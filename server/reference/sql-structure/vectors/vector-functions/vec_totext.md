...
`VEC_ToText` converts a binary vector into a json array of numbers (floats). Returns NULL and throws a warning [4201](../../../../server-usage/mariadb-internals/using-mariadb-with-your-programs-api/error-codes/mariadb-error-codes-4200-to-4299/e4201.md) if given an invalid vector.
...
* [Error 4201: Invalid binary vector format](../../../../server-usage/mariadb-internals/using-mariadb-with-your-programs-api/error-codes/mariadb-error-codes-4200-to-4299/e4201.md)
