...
MariaDB Vector was introduced in [MariaDB 11.7]({release-notes}/community-server/old-releases/11.7/what-is-mariadb-117), a rolling release, and is generally available from [MariaDB 11.8]({release-notes}/community-server/11.8/what-is-mariadb-118) onwards, the first long-term support (LTS) release to include it.
