...
{% hint style="warning" %}
Sequences should not be used with statement-based logging; see [this section for details](sequence-overview.md#statement-based-replication-limitation).
{% endhint %}
...
For [retrieving the last value](sequence-functions/previous-value-for-sequence_name.md) used by the current connection from a sequence use:
...
* [ALTER TABLE sequence RENAME TO sequence2](<../../sql-statements/data-definition/alter/alter-table/README (1).md>)
