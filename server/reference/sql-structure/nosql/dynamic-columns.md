...
a date. See the [Datatypes](dynamic-columns.md#Datatypes) section for further details. Note also [MDEV-597](https://jira.mariadb.org/browse/MDEV-597).
...
*
  ...
  * `as type` is optional. See [#datatypes](dynamic-columns.md#datatypes) section for a discussion about types.
...
example, when one is using prepared statements and runs`"select COLUMN_GET(...)"`, the prepared statement API requires the server\
...
See the [Datatypes](dynamic-columns.md#datatypes) section for more information about\
datatypes.
...
**Rationale:**\
Normally, one works with valid dynamic column blobs. Functions like`COLUMN_CREATE`, `COLUMN_ADD`, `COLUMN_DELETE` always return valid\
...
**Note:**\
It is possible that a truncation cut a Dynamic Column "clearly" so that COLUMN\_CHECK will not notice the corruption, but in any case of truncation a warning is issued during value storing.
...
MariaDB will report the maximum length of the resultset column to be`53,6870,911` (bytes or characters?) for [MariaDB 5.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-5-3-series/changes-improvements-in-mariadb-5-3)-10.0.0 and`16,777,216` for [MariaDB 10.0.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-10-0-series/mariadb-1001-release-notes)+. This may cause excessive memory usage in\
...
### [MariaDB 5.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-5-3-series/changes-improvements-in-mariadb-5-3) vs [MariaDB 10.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-10-0-series/changes-improvements-in-mariadb-10-0)

The dynamic columns feature was introduced into MariaDB in two steps:

1. [MariaDB 5.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-5-3-series/changes-improvements-in-mariadb-5-3) was the first version to support dynamic columns. Only numbers\
   could be used as column names in this version.
2. In [MariaDB 10.0.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-10-0-series/mariadb-1001-release-notes), column names can be either numbers or strings.\
