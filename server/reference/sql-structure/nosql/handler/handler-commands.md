...
* While each HANDLER READ command is atomic, if you do a scan in many steps, then some engines may give you [error 1020](../../../../server-usage/mariadb-internals/using-mariadb-with-your-programs-api/error-codes/mariadb-error-codes-1000-to-1099/e1020.md) if the table changed between the commands. Please refer to the [specific engine handler page](./) if this happens.

## Error Codes

* [Error 1031](../../../../server-usage/mariadb-internals/using-mariadb-with-your-programs-api/error-codes/mariadb-error-codes-1000-to-1099/e1031.md) (ER\_ILLEGAL\_HA) Table storage engine for 't1' doesn't have this option
...
* [Error 1020](../../../../server-usage/mariadb-internals/using-mariadb-with-your-programs-api/error-codes/mariadb-error-codes-1000-to-1099/e1020.md) (ER\_CHECKREAD) Record has changed since last read in table '...'
