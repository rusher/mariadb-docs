...
From [MariaDB 10.2.3]({release-notes}/community-server/old-releases/10.2/10.2.3):
...
From [MariaDB 10.2.3]({release-notes}/community-server/old-releases/10.2/10.2.3), `MBREQUALS` is a synonym for `Equals`.
