...
**MariaDB starting with** [**11.8**]({release-notes}/community-server/11.8/what-is-mariadb-118)

ST\_PointFromGeoHash was added in [MariaDB 11.8]({release-notes}/community-server/11.8/what-is-mariadb-118).
