...
#### MariaDB starting with [11.7.1](/en/mariadb-1171-release-notes/)
...
The VECTOR data type was added as part of the [vectors](/en/vectors/) feature, which permits MariaDB Server to perform as a relational vector database.
