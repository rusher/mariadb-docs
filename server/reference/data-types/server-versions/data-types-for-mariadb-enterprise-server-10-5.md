# data-types-for-mariadb-enterprise-server-10-5
...
| ---------------------------------------------------------------------------------------------------------------------------------------- | ------ | -------------------------------------------------------------------------------------------------------------------------------------------- |
| Data Type                                                                                                                                | Class  | Description                                                                                                                                  |
| [BINARY](https://github.com/mariadb-corporation/docs-server/blob/test/server/reference/data-types/server-versions/binary-type/README.md) | String | Fixed-length string for binary data with limit up to 255 bytes                                                                               |
...
| [CHAR BYTE](../string-data-types/char-byte.md)                                                                                           | String | See [BINARY](https://github.com/mariadb-corporation/docs-server/blob/test/server/reference/data-types/server-versions/binary-type/README.md) |
...
| [CHARACTER VARYING](https://github.com/mariadb-corporation/docs-server/blob/test/en/character-varying/README.md)                         | String | See [VARCHAR](../string-data-types/varchar.md)                                                                                               |
...
| [JSON](https://github.com/mariadb-corporation/docs-server/blob/test/server/reference/data-types/server-versions/json-type/README.md)     | String | An alias of LONGTEXT with a default json\_valid() CHECK (check added in MariaDB Community Server 10.4.3)                                     |
| [LONG](https://github.com/mariadb-corporation/docs-server/blob/test/en/long/README.md)                                                   | String | See [MEDIUMTEXT](../string-data-types/mediumtext.md)                                                                                         |
...
| [NVARCHAR](https://github.com/mariadb-corporation/docs-server/blob/test/en/nvarchar/README.md)                                           | String | See [NATIONAL VARCHAR](../string-data-types/national-varchar.md)                                                                             |
...
| [DATE (with time portion)](https://github.com/mariadb-corporation/docs-server/blob/test/server/reference/data-types/server-versions/date-with-time-portion/README.md) | SQL/PL    | See [DATETIME](../date-and-time-data-types/datetime.md)                                                        |
...
| [TIMESTAMP](https://github.com/mariadb-corporation/docs-server/blob/test/server/reference/data-types/server-versions/timestamp-type/README.md)                        | Date/Time | Accepts a datetime value consisting of year (1970-2038), month, day, hours, minutes, seconds, and microseconds |
