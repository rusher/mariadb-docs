...
Explicitly setting a timestamp with the [CURRENT\_TIMESTAMP](../../sql-statements-and-structure/sql-statements/built-in-functions/date-time-functions/current_timestamp.md) function:
