...
When MariaDB executes the [ALTER TABLE](<../../sql-statements/data-definition/alter/alter-table/README (1).md>) statement, it converts the data from the older temporal format to the newer one.
