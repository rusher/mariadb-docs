...
The UUID data type was added in [MariaDB 10.7](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-107).
...
The `UUID` data type is intended for the storage of 128-bit UUID (Universally Unique Identifier) data. See the [UUID function](uuid-data-type.md) page for more details on UUIDs themselves.
...
[String literals](../../sql-statements-and-structure/sql-language-structure/string-literals.md) of hexadecimal characters and [CHAR](../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/charset-narrowing-optimization.md)/[VARCHAR](varchar.md)/[TEXT](text.md) can be cast to the UUID data type. Likewise [hexadecimal literals](../../sql-statements-and-structure/sql-language-structure/hexadecimal-literals.md), [binary-literals](../../sql-statements-and-structure/sql-language-structure/binary-literals.md), and [BINARY](../../../server-usage/programming-customizing-mariadb/stored-routines/binary-logging-of-stored-routines.md)/[VARBINARY](varbinary.md)/[BLOB](blob.md) types can also be cast to UUID.
...
Generating and inserting via the [UUID function](uuid-data-type.md).
...
* [UUID function](uuid-data-type.md) for generating v1 UUIDs
* [UUID function](/kb/en/uuidv4/) for generating v4 UUIDs
* [UUID function](/kb/en/uuidv7/) for generating v7 UUIDs
