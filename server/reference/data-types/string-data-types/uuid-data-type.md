...
The `UUID` data type is intended for the storage of 128-bit UUID (Universally Unique Identifier) data. See the [UUID function](../../sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/uuid.md) page for more details on UUIDs themselves.
...
The data type will not accept a short UUID generated with the [UUID\_SHORT](../../sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/uuid_short.md) function, but will accept a value without the `-` character generated by the [SYS\_GUID](../../sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/sys_guid.md) function (or inserted directly). Hyphens can be partially omitted as well, or included after any group of two digits.
...
Generating and inserting via the [UUID function](../../sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/uuid.md).
...
The [UUID\_SHORT](../../sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/uuid_short.md) function does not generate valid full-length UUID:
...
Accepting a value without the `-` character, either directly or generated by the [SYS\_GUID](../../sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/sys_guid.md) function:
...
* [UUID function](../../sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/uuid.md) for generating v1 UUIDs
* [UUID function](../../sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/uuid_v4.md) for generating v4 UUIDs
* [UUID function](../../sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/uuid_v7.md) for generating v7 UUIDs
* [UUID\_SHORT function](../../sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/uuid_short.md)
* [SYS\_GUID](../../sql-statements/built-in-functions/secondary-functions/miscellaneous-functions/sys_guid.md) - UUID without the `-` character for Oracle compatibility
