...
Prior to [MariaDB 10.6](../../../../../release-notes/mariadb-community-server/what-is-mariadb-106.md), the utf8 [character set](README.md) (and related collation) was the default for the given variables:
...
From [MariaDB 10.6](../../../../../release-notes/mariadb-community-server/what-is-mariadb-106.md) to [MariaDB 11.7](../../../../../release-notes/mariadb-community-server/what-is-mariadb-117.md), the utf8 [character set](README.md) (and related collations) became an alias for utf8mb3 rather than the other way around. [MariaDB 11.4](../../../../../release-notes/mariadb-community-server/what-is-mariadb-114.md) added the [character_set_collations](../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#character_set_collations) variable, so the SELECT query is more specific in this example:
