...
The `LOCALES` plugin creates the [LOCALES](../../../../sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/information-schema-tables/information-schema-locales-table.md) table in the [INFORMATION_SCHEMA](../../../../../server-usage/programming-customizing-mariadb/views/information-schema-views-table.md) database. The plugin also adds the [SHOW LOCALES](../../../../sql-statements-and-structure/sql-statements/administrative-sql-statements/show/show-locales.md) statement.The table and statement can be queried to see all [locales](server-locale.md) that are compiled into the server.
