...
| ucs2     | UCS-2 Unicode               | <p>ucs2_general_ci (&#x3C;= MariaDB 11.4)<br>ucs2_uca1400_ai_ci (>=<a href="https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/11.5/what-is-mariadb-115">MariaDB 11.5</a>)</p>                                                                                                          | 2                                                                                    |
| ujis     | EUC-JP Japanese             | ujis\_japanese\_ci                                                                                                                                                                                                                                                                                                | 3                                                                                    |
| utf8     | UTF-8 Unicode               | utf8\_general\_ci                                                                                                                                                                                                                                                                                                 | 3/4 (see [OLD\_MODE](../../../../server-management/variables-and-modes/old_mode.md)) |
| utf16    | UTF-16 Unicode              | <p>utf16_general_ci (&#x3C;= <a href="https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/11.4/what-is-mariadb-114">MariaDB 11.4</a>)<br>utf16_uca1400_ai_ci (>=<a href="https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/11.5/what-is-mariadb-115">MariaDB 11.5</a>)</p> | 4                                                                                    |
| utf16le  | UTF-16LE Unicode            | utf16le\_general\_ci                                                                                                                                                                                                                                                                                              | 4                                                                                    |
| utf32    | UTF-32 Unicode              | utf32\_general\_ci (<= [MariaDB 11.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/11.4/what-is-mariadb-114)) utf32\_uca1400\_ai\_ci (>=[MariaDB 11.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/11.5/what-is-mariadb-115))                                 | 4                                                                                    |
| utf8mb3  | UTF-8 Unicode               | utf8mb3\_general\_ci (<= [MariaDB 11.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/11.4/what-is-mariadb-114)) utf8mb3\_uca1400\_ai\_ci (>=[MariaDB 11.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/11.5/what-is-mariadb-115))                             | 3                                                                                    |
| utf8mb4  | UTF-8 Unicode               | utf8mb4\_general\_ci (<= [MariaDB 11.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/11.4/what-is-mariadb-114)) utf8mb4\_uca1400\_ai\_ci (>=[MariaDB 11.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/11.5/what-is-mariadb-115))                             | 4                                                                                    |

{% hint style="warning" %}
Note that the [Mroonga Storage Engine](../../../../server-usage/storage-engines/mroonga/) only supports a limited number of character sets. See [Mroonga's available character sets](../../../../server-usage/storage-engines/mroonga/about-mroonga.md#available-character-sets).
{% endhint %}
...
:information\_source: The UCA-14.0.0 collations were added in [MariaDB 10.10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/10.10/10.10.1).
...
:information\_source: [MariaDB 10.10](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/10.10/what-is-mariadb-1010) added the accent insensitivity flag, and new collations are marked with '\_ai' or '\_as' in the name to indicate this, for example:
...
* [MariaDB 10.2.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/10.2/10.2.2) added 88 `NO PAD` collations.
