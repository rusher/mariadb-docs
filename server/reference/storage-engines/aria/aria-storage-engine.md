...
the [MyISAM](../myisam-storage-engine/README.md) table format. This should speed up some [GROUP BY](../../sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/group-by.md)
