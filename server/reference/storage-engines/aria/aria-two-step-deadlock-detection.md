...
The [Aria](../../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/aria-encryption/aria-enabling-encryption.md) storage engine can automatically detect and deal with deadlocks (see the [Wikipedia deadlocks article](http://en.wikipedia.org/wiki/Deadlock)).
...
* [deadlock_search_depth_long](/en/aria-server-system-variables/#deadlock_search_depth_long)
* [deadlock_search_depth_short](/en/aria-server-system-variables/#deadlock_search_depth_short)
* [deadlock_timeout_long](/en/aria-server-system-variables/#deadlock_timeout_long)
* [deadlock_timeout_short](/en/aria-server-system-variables/#deadlock_timeout_short)
