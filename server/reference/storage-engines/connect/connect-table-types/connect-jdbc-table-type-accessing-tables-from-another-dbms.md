...
1. The java wrapper class files are available on your system.
1. And of course, some JDBC drivers exist to be used with the matching DBMS.
...
1. Creating the Java Virtual Machine.
1. Establishing contact with the java wrapper class.
1. Connecting to the used JDBC driver.
