...
|   |   |
| --- | --- |
| 0 | Not a multiple table (the default). This can be used in an [ALTER TABLE](../../../sql-statements-and-structure/sql-statements/data-definition/alter/alter-tablespace.md) statement. |
...
[FIX](https://mariadb.com/kb/en/connect-dos-and-fix-table-typess),
