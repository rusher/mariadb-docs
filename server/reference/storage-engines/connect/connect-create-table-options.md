...
| HTTP | String | The HTTP of the client of REST queries. From [Connect 1.06.0010](../../../../connectors/mariadb-connector-nodejs/connector-nodejs-pipelining.md). |
...
| URI | String | The URI of a REST request.. From [Connect 1.06.0010](../../../../connectors/mariadb-connector-nodejs/connector-nodejs-pipelining.md). |
...
commands or by the “AS select statement” of the [CREATE TABLE](../../sql-statements-and-structure/vectors/create-table-with-vectors.md)
