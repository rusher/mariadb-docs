...
[CONNECT](../../../security/user-account-management/catalogs/connecting-to-a-server-configured-for-catalogs.md) supports only a restricted set of data types. However, ODBC, JDBC
...
| --- | --- | --- |
| Type name | Description | Used for |
| TYPE_STRING | Zero ended string | [char](../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/charset-narrowing-optimization.md), [varchar](../../data-types/string-data-types/varchar.md), [text](../../data-types/string-data-types/text.md) |
| TYPE_INT | 4 bytes integer | [int](../../../clients-and-utilities/server-client-software/client-libraries/clientserver-protocol/replication-protocol/intvar_event.md), [mediumint](../../data-types/data-types-numeric-data-types/mediumint.md), [integer](../../data-types/data-types-numeric-data-types/integer.md) |
...
| TYPE_DOUBLE | 8 bytes floating point | [double](../../data-types/data-types-numeric-data-types/double.md), [float](../../data-types/data-types-numeric-data-types/floating-point-accuracy.md), real |
| TYPE_DECIM | Numeric value | [decimal](../../data-types/data-types-numeric-data-types/decimal.md), numeric, number |
| TYPE_DATE | 4 bytes integer | [date](../../data-types/date-and-time-data-types/date.md), [datetime](../../data-types/date-and-time-data-types/datetime.md), [time](../../data-types/date-and-time-data-types/time.md), [timestamp](../../data-types/date-and-time-data-types/timestamp.md), [year](../../data-types/date-and-time-data-types/year-data-type.md) |

#

# TYPE_STRING

This type corresponds to what is generally known as [CHAR](../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/charset-narrowing-optimization.md) or [VARCHAR](../../data-types/string-data-types/varchar.md) by
...
CONNECT handles [null values](/en/null-values-in-mariadb/) for data sources able to produce nulls. Currently
this concerns mainly the [ODBC](/en/connect-table-types-odbc-table-type-accessing-tables-from-other-dbms/), [JDBC](/en/connect-jdbc-table-type-accessing-tables-from-other-dbms/), MONGO, [MYSQL](/en/connect-table-types-mysql-table-type-accessing-mysqlmariadb-tables/), [XML](connect-table-types/connect-table-types-data-files.md#xml-table-type), [JSON](connect-table-types/connect-json-table-type.md) and [INI](connect-table-types/connect-table-types-data-files.md#ini-table-type) table types. For INI, [JSON](connect-table-types/connect-json-table-type.md), MONGO or XML types, null values are returned when the key is missing in the section (INI) or when the corresponding node does not exist in a row (XML, JSON, MONGO).
...
CONNECT leaves the decision to you. When declaring a column in the [CREATE TABLE](../../sql-statements-and-structure/sql-statements/data-definition/create/create-tablespace.md)
...
| [char](../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/charset-narrowing-optimization.md), [varchar](../../data-types/string-data-types/varchar.md) | TYPE_STRING | Same length |
| [double](../../data-types/data-types-numeric-data-types/double.md), [float](../../data-types/data-types-numeric-data-types/floating-point-accuracy.md), real | TYPE_DOUBLE | 8 byte floating point |
...
1. [↑](#_ref-0) Here input and output are
 ...
 performed within [SELECT](../../../server-usage/replication-cluster-multi-master/standard-replication/selectively-skipping-replication-of-binlog-events.md) queries; output is performed in [UPDATE](../../sql-statements-and-structure/sql-statements/data-manipulation/changing-deleting-data/update.md) or [INSERT](../../../server-usage/programming-customizing-mariadb/views/inserting-and-updating-with-views.md)
 queries.