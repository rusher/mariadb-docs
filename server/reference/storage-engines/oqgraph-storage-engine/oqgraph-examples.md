...
Using the [GROUP\_CONCAT](../../sql-statements-and-structure/sql-statements/built-in-functions/aggregate-functions/group_concat.md) function can produce more readable results, for example:
