...
The limit for indexing column values depends on the [innodb_page_size](../innodb-system-variables.md#innodb_page_size) value:
...
InnoDB uses the Dynamic row format for new InnoDB tables by default, because the [innodb_default_row_format](../innodb-system-variables.md#innodb_default_row_format) system variable is dynamic by default.
...
6. Confirm that the table uses the Dynamic row format by querying the [information_schema.INNODB_SYS_TABLES](../../../sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/information-schema-tables/information-schema-innodb-tables/information-schema-innodb_sys_tables-table.md) table:
...
2. Search for InnoDB tables that do not use the Dynamic row format by querying the [information_schema.INNODB_SYS_TABLES](../../../sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/information-schema-tables/information-schema-innodb-tables/information-schema-innodb_sys_tables-table.md) table:
...
4. Confirm that the table uses the Dynamic row format by querying the [information_schema.INNODB_SYS_TABLES](../../../sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/information-schema-tables/information-schema-innodb-tables/information-schema-innodb_sys_tables-table.md) table again:
