...
However, more details about the error can be found by executing [SHOW WARNINGS](../../sql-statements/administrative-sql-statements/show/show-warnings.md).
