...
* If the table contains a hidden `FTS_DOC_ID` column due to a [FULLTEXT INDEX](../../../../ha-and-performance/optimization-and-tuning/optimization-and-indexes/full-text-indexes/), then instant [ALTER TABLE ... ADD COLUMN](../../../sql-statements-and-structure/sql-statements/data-definition/alter/alter-table.md#add-column) will not be possible.
...
* Instant [ALTER TABLE ... ADD COLUMN](../../../sql-statements-and-structure/sql-statements/data-definition/alter/alter-table.md#add-column) is not available for [ROW\_FORMAT=COMPRESSED](../innodb-row-formats/innodb-row-formats-overview.md).
