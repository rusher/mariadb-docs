...
InnoDB page compression can be enabled for individual tables by setting the [PAGE\_COMPRESSED](../../sql-statements-and-structure/sql-statements/data-definition/create/create-table.md#page_compressed) table option to `1`. For example:
...
The compression level for individual tables can also be configured by setting the [PAGE\_COMPRESSION\_LEVEL](../../sql-statements-and-structure/sql-statements/data-definition/create/create-table.md#page_compression_level) table option for the table. For example:
...
[Mariabackup](../../../server-management/backing-up-and-restoring-databases/mariabackup/) supports InnoDB page compression.
