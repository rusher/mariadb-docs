...
Until [MariaDB 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-4-series/what-is-mariadb-104), [system tables](../../sql-statements/administrative-sql-statements/system-tables/) used the MyISAM storage engine.
