...
These are possible future directions for [Cassandra Storage Engine](cassandra-storage-engine-issues.md). **This is mostly brainstorming, nobody has committed to implementing this**.
...
1. Data that's too big for SQL database (such as web views, or clicks) is 
...
1. joins betwen SQL and Cassandra's data *might* be more efficent due to Batched
