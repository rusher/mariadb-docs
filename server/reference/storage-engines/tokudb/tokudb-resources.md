...
Tokutek has a ` #tokutek` [IRC](/en/irc/) channel on [Freenode](http://freenode.net).
...
The [Where to find other MariaDB users and developers](/en/where-to-find-other-mariadb-users-and-developers/) page has many great MariaDB resources listed.