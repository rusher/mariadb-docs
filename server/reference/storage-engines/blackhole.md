...
`BEFORE` [triggers](../../server-usage/triggers-events/triggers/) for [INSERT](../sql-statements-and-structure/sql-statements/data-manipulation/inserting-loading-data/insert.md) statements are still activated.

[Triggers](../../server-usage/triggers-events/triggers/) for [UPDATE](../sql-statements-and-structure/sql-statements/data-manipulation/changing-deleting-data/update.md) and [DELETE](../sql-statements-and-structure/sql-statements/data-manipulation/changing-deleting-data/delete.md) statements are **not** activated.
...
If you convert an [InnoDB](innodb/) table which contains [virtual columns](../sql-statements-and-structure/sql-statements/data-definition/create/generated-columns.md) to `BLACKHOLE`, then it produces an error.
