...
| SphinxSE 2.0.4                                               | [MariaDB 5.5](broken-reference)                                                                                                                                                                                            |          |
| SphinxSE 0.99                                                | [MariaDB 5.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-2-series/changes-improvements-in-mariadb-5-2) and [MariaDB 5.3](broken-reference) |          |
