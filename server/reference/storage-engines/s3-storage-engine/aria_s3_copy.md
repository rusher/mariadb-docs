...
`aria_s3_copy` is a tool for copying an [Aria](../../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/aria-encryption/aria-enabling-encryption.md) table to and from [S3](s3-storage-engine-status-variables.md).
