...
* [s3\_block\_size](s3-storage-engine-system-variables.md#s3_block_size): Set to 4M as default. This is the default block size for a table, if not specified in [CREATE TABLE](../../sql-statements-and-structure/sql-statements/data-definition/create/create-table.md).
...
table stored in S3 will automatically be discovered when it's accessed with[SHOW TABLES](../../sql-statements-and-structure/sql-statements/administrative-sql-statements/show/show-tables.md), [SELECT](../../sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/select.md) or any other operation that\
...
Discovery of S3 tables is not done for tables in the [mysql databases](../../sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/the-mysql-database-tables/) to make mariadbd boot faster and more securely.
