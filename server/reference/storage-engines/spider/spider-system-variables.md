...
##### MariaDB starting with [10.5.22](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/release-notes-mariadb-10-5-series/mariadb-10-5-22-release-notes)
...
* Introduced: [MariaDB 10.5.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/release-notes-mariadb-10-5-series/mariadb-1054-release-notes)
...
* Description: How to log SQL statements with result errors.
  ...
  * `3` Log warning
  * `4` Log info (Added in [MariaDB 10.5.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/release-notes-mariadb-10-5-series/mariadb-1054-release-notes))
* Scope: Global
* Dynamic: Yes
* Data Type: `numeric`
* Default Value: `0`
...
* Description: 
Whether to encapsulate [FLUSH LOGS](flush-logs) and [UNLOCK TABLES](../../sql-statements-and-structure/sql-statements/transactions/lock-tables.md) statements when `START TRANSACTION WITH CONSISTENT` and `FLUSH TABLE WITH READ LOCK` statements are sent to the remote backend servers.

  * `0` : No encapsulation.
  * `1` : Encapsulates, only when the [spider_use_all_conns_snapshot](#spider_use_all_conns_snapshot) system variable i set to `1`.
  * `2` : 
Synchronizes the snapshot using a [LOCK TABLES](../../sql-statements-and-structure/sql-statements/transactions/lock-tables.md) statement and [flush|FLUSH TABLES]] at the XA transaction level. This is only effective when the [spider_use_all_cons_snapshot](#spider_use_all_cons_snapshot) system variable is set to `1`.
* Scope: Global, Session
* Dynamic: Yes
* Data Type: `numeric`
* Default Value: `0`
