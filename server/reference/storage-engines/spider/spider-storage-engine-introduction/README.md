...
The maturity can be confirmed by querying the [information\_schema.SPIDER\_WRAPPER\_PROTOCOLS](../information-schema-spider_wrapper_protocols-table.md) table.
