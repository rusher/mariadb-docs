...
When using Spider in the Sharded MariaDB Enterprise Spider topology, backup and restore operations can be performed using [MariaDB Backup](../../../../../../server-usage/backup-and-restore/mariabackup/) or [MariaDB Dump](../../../../../../clients-and-utilities/backup-restore-and-import-clients/mariadb-dump.md). These operations must be performed on the Spider Node as well as on each Data Node.
...
4. On each Data Node, perform the backup using [MariaDB Backup](../../../../../../server-usage/backup-and-restore/mariabackup/) .
...
5. On the Spider Node, after backing up each Data Node, perform a backup with [MariaDB Backup](../../../../../../server-usage/backup-and-restore/mariabackup/) .
...
[MariaDB Backup](../../../../../../server-usage/backup-and-restore/mariabackup/) can restore a Sharded MariaDB Enterprise Spider topology from a backup taken with MariaDB Backup.
