...
### Step 2a: Load the Spider Plugin ([MariaDB 10.4](broken-reference) and Later)

With [MariaDB 10.4](broken-reference) and later, the Spider storage engine can be loaded as a normal plugin, and Spider automatically creates its dependencies. There are two primary ways to load the plugin.
