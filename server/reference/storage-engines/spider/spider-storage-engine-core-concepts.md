...
![Spider3](/en/spider-storage-engine-core-concepts/+image/Spider3 "Spider3")
![Spider4](/en/spider-storage-engine-core-concepts/+image/Spider4 "Spider4")
...
![Spider1](/en/spider-storage-engine-core-concepts/+image/Spider1 "Spider1")
...
![Spider2](/en/spider-storage-engine-core-concepts/+image/Spider2 "Spider2")
...
Spider stores resultsets into memory, but [spider_quick_mode](/en/spider-server-system-variables/#spider_quick_mode)=3 stores resultsets into internal temporary tables if the resultsets are larger than quick_table_size.