...
* FB's branch provides the `rocksdb_git_hash` _status_ variable.
* MariaDB provides the `@@rocksdb_git_hash` _system_ variable.
...
* [Invisible columns](../../sql-statements/data-definition/create/invisible-columns.md) in [MariaDB 10.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-10-3-series/what-is-mariadb-103) are supported (as they are an SQL layer feature).
