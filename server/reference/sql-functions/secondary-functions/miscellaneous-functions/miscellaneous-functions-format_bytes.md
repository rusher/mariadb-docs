...
This function is similar to the [Sys Schema format\_bytes](../../../system-tables/sys-schema/sys-schema-stored-functions/sys_schema_format_bytes.md) function, except that function does not display exbibytes.
