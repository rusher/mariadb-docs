...
Returns a Universally Unique Identifier (UUID) version 7. To generate a version 1 UUID, see the [UUID](uuid.md) function. To generate a version 4 UUID, see [UUID\_v4](uuid_v4.md).
