...
{% hint style="info" %}
`ADD_MONTHS` is available from MariaDB 10.6.1.
{% endhint %}
...
_`months`_ can be positive or negative. If months is not a whole number, it is rounded to the nearest whole number (not truncated).
