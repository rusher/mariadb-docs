...
Returns the population standard deviation of _`expr`_. This is an extension to standard SQL. The standard SQL function [STDDEV\_POP()](stddev_pop.md) can be used instead.
...
`STD()` can be used as a [window function](../special-functions/window-functions/).
