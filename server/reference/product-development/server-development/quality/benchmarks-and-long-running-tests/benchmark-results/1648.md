...
[MariaDB 5.1]({release-notes}/community-server/old-releases/5.1/changes-improvements-in-mariadb-5-1) vs. 5.2-wl86 sysbench benchmark comparison in %
...
[MariaDB 5.1]({release-notes}/community-server/old-releases/5.1/changes-improvements-in-mariadb-5-1) revision was:
...
[MariaDB 5.2]({release-notes}/community-server/old-releases/5.2/changes-improvements-in-mariadb-5-2)-wl86 revision was:
