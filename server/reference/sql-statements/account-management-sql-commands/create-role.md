...
quoted, as explained in the [Identifier names](../../sql-statements-and-structure/sql-language-structure/identifier-names.md) page. Only\
...
For valid identifiers to use as role names, see [Identifier Names](../../sql-statements-and-structure/sql-language-structure/identifier-names.md).
