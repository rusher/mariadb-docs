...
The indentation used here in the `ELSE` clause is for purposes of clarity only, and is not otherwise significant. See [Delimiters in the mariadb client](../../../clients-and-utilities/mariadb-client/delimiters.md) for more on the use of the delimiter command.
