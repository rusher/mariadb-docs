...
* [LOOP in Oracle mode](https://github.com/mariadb-corporation/docs-server/blob/test/server/server-usage/programmatic-compound-statements/broken-reference/README.md)
* [ITERATE](iterate.md)
* [LEAVE](leave.md)
* [FOR Loops](for.md)
