...
* `ROW_COUNT` has the same value as the [ROW\_COUNT()](../../../sql-functions/secondary-functions/information-functions/row_count.md) function for the statement that produced the conditions.
