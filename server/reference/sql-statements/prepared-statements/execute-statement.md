...
`EXECUTE` with expression as parameters was introduced in [MariaDB 10.2.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-10-2-series/mariadb-1023-release-notes). Prior to that one could only use variables (@var\_name) as parameters.
