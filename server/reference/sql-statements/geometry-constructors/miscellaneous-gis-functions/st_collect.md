...
ST\_Collect was added in [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/release-notes-mariadb-11-8-series/what-is-mariadb-118).
...
* If all arguments are [Point](../point.md) values, the result is a [MultiPoint](../multipoint.md) value.
...
Multiple [Point](../point.md) geometries aggregated into a [MultiPoint](../multipoint.md) geometry:
