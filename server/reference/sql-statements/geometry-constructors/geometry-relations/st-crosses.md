...
Returns `1` if geometry _`g1`_ spatially crosses geometry _`g2`_. Returns `NULL` if `g1` is a [Polygon](../polygon.md) or a [MultiPolygon](../multipolygon.md), or if `g2` is a[Point](../point.md) or a [MultiPoint](../multipoint.md). Otherwise, returns `0`.
