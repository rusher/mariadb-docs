...
* `INSERT DELAYED` does not work if [skip-new](../../../../server-management/starting-and-stopping-mariadb/mariadbd-options.md#-skip-new) mode is active.
