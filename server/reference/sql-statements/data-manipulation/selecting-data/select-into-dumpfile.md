...
_file\_path_ can be an absolute path, or a relative path starting from the data directory. It can only be specified as a [string literal](../../../sql-statements-and-structure/sql-language-structure/string-literals.md), not as a variable. However, the statement can be dynamically composed and executed as a prepared statement to work around this limitation.
...
* [SELECT](select.md)
* [LOAD\_FILE()](../../built-in-functions/string-functions/load_file.md)
