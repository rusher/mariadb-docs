...
`CHECK TABLE` is also supported for partitioned tables. You can use [`ALTER TABLE ... CHECK PARTITION`](<../data-definition/alter/alter-table/README (1).md#check-partition>) to check one or more partitions.
