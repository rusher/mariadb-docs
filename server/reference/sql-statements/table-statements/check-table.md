...
`CHECK TABLE` checks a table or tables for errors. `CHECK TABLE` works for[Archive](../../../server-usage/storage-engines/archive/), [Aria](../../../server-usage/storage-engines/aria/), [CSV](../../../server-usage/storage-engines/csv/), [InnoDB](../../../server-usage/storage-engines/innodb/) and [MyISAM](../../../server-usage/storage-engines/myisam-storage-engine/) tables. For Aria and MyISAM tables, the\
