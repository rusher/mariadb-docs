...
Some shortcuts for this function are also available: [BIN()](../string-functions/bin.md), [OCT()](oct.md), [HEX()](../string-functions/hex.md), [UNHEX()](../string-functions/unhex.md). Also, MariaDB allows [binary](../../../sql-statements-and-structure/sql-language-structure/binary-literals.md) literal values and [hexadecimal](../../../sql-statements-and-structure/sql-language-structure/hexadecimal-literals.md) literal values.
