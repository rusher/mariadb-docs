...
LAST\_INSERT\_ID() is left undefined. For manual [ROLLBACK](../../../transactions/rollback.md), the value of\
...
* [Sequences](../../../../sql-statements-and-structure/sequences/) - an alternative to auto\_increment
