...
Returns a [dynamic columns](../../../../sql-statements-and-structure/nosql/dynamic-columns.md) blob that stores the specified columns with values.
...
a date. See [Dynamic Columns:Datatypes](../../../../sql-statements-and-structure/nosql/dynamic-columns.md#datatypes) for further details.
