...
Gets the value of a [dynamic column](../../../../sql-statements-and-structure/nosql/dynamic-columns.md) by its name. If no column with the given name exists, `NULL` will be returned.
...
See [Dynamic Columns:Datatypes](../../../../sql-statements-and-structure/nosql/dynamic-columns.md#datatypes) for more information about datatypes.
