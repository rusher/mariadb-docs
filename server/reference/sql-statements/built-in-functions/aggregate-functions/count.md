...
Returns a count of the number of non-NULL values of expr in the rows retrieved by a [SELECT](../../data-manipulation/selecting-data/select.md) statement. The result is a [BIGINT](../../../data-types/data-types-numeric-data-types/bigint.md) value. It is an [aggregate function](./), and so can be used with the [GROUP BY](../../data-manipulation/selecting-data/group-by.md) clause.
