...
* DDL are only needed to be blocked for a very short duration of the backup while [mariabackup](../../../../server-management/backing-up-and-restoring-databases/mariabackup/) is copying the tables affected by DDL during the initial part of the backup.
