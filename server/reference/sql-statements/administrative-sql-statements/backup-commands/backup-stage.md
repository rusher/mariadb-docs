...
* Blocks also start off a new [ALTER TABLE](<../../data-definition/alter/alter-table/README (1).md>) and the final rename phase of [ALTER TABLE](<../../data-definition/alter/alter-table/README (1).md>). Running ALTER TABLES are not blocked.
