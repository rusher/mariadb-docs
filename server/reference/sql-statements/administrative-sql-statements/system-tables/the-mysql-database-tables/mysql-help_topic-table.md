...
This table uses the [Aria](../../../../storage-engines/aria/) storage engine. Prior to [MariaDB 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-10-4-series/what-is-mariadb-104) it used the [MyISAM](../../../../storage-engines/myisam-storage-engine/) engine.
