...
The [Performance Schema](../README.md) `events_waits_summary_by_host_by_event_name` table contains wait events summarized by host and event name. It contains the following columns:
