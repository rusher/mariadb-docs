...
| EXTRA                           | Additional information about a column, for example whether the column is an [invisible column](../../../../data-definition/create/invisible-columns.md), or WITHOUT SYSTEM VERSIONING if the table is not a [system-versioned table](../../../../../sql-statements-and-structure/temporal-tables/system-versioned-tables.md). A MySQL and MariaDB extension.                                                                                                                  |
...
| IS\_SYSTEM\_TIME\_PERIOD\_START | From [MariaDB 11.4.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/release-notes-mariadb-11-4-series/mariadb-11-4-1-release-notes).                                                                                                                                                                                                                                                                                                  |
| IS\_SYSTEM\_TIME\_PERIOD\_END   | From [MariaDB 11.4.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/release-notes-mariadb-11-4-series/mariadb-11-4-1-release-notes).                                                                                                                                                                                                                                                                                                  |
...
In the results above, the two single quotes in `concat(''A'',''B'')` indicate an escaped single quote - see [string-literals](../../../../../sql-statements-and-structure/sql-language-structure/string-literals.md). Note that while [mariadb client](../../../../../../clients-and-utilities/mariadb-client/mariadb-command-line-client.md) appears to show the same default value for columns `s5` and `s6`, the first is a 4-character string "NULL", while the second is the SQL NULL value.
