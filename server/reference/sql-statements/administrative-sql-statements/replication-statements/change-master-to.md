...
{% tabs %}
{% tab title="Current" %}
This user account will need the [REPLICATION SLAVE/REPLICATIION_REPLICA](../../account-management-sql-statements/grant.md#replication-replica) privilege on the master.
{% endtab %}
