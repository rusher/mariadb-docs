...
The `SHOW CREATE PACKAGE` statement can be used when [Oracle SQL\_MODE](../../../../server-management/variables-and-modes/sql_mode.md) is set. It shows the `CREATE` statement that creates the given package specification.
