...
| DES\_KEY\_FILE                                          | Reloads the DES key file (Specified with the [--des-key-file startup option](../../../../server-management/getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| USER\_RESOURCES                                         | Resets all per hour [user resources](../../account-management-sql-commands/grant.md#setting-per-account-resources-limits). This enables clients that have exhausted their resources to connect again.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| USER\_STATISTICS                                        | Reset user statistics (see [SHOW USER\_STATISTICS](../show/show-user-statistics.md)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| USER\_VARIABLES                                         | Reset user variables (see [User-defined variables](../../../sql-statements-and-structure/sql-language-structure/user-defined-variables.md)).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
