...
`DO` is useful primarily with functions that have side effects, such as [RELEASE\_LOCK()](../../sql-functions/secondary-functions/miscellaneous-functions/release_lock.md).
