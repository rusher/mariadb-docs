...
Columns can be given an `INVISIBLE` attribute in a [CREATE TABLE](create-table.md) or [ALTER TABLE](<../alter/alter-table/README (1).md>) statement. These columns will then not be listed in the results of a [SELECT \*](../../data-manipulation/selecting-data/select.md) statement, nor do they need to be assigned a value in an [INSERT](../../data-manipulation/inserting-loading-data/insert.md) statement, unless INSERT explicitly mentions them by name.
