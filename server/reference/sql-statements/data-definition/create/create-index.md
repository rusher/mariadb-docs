...
The statement is mapped to an `ALTER TABLE` statement to create [indexes](../../../../server-usage/tables/mariadb-indexes-guide-1.md). See [ALTER TABLE](<../alter/alter-table/README (1).md>). `CREATE INDEX` cannot be used to create a [PRIMARY KEY](../../../../mariadb-quickstart-guides/mariadb-indexes-guide.md#primary-key); use `ALTER TABLE` instead.
...
See [ALTER TABLE: ALGORITHM](<../alter/alter-table/README (1).md#algorithm>) for more information.

## LOCK

See [ALTER TABLE: LOCK](<../alter/alter-table/README (1).md#lock>) for more information.
