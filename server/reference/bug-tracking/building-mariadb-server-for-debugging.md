...
(A more detailed explanation can be found [here](../../../general-resources/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/debugging-mariadb/how-to-produce-a-full-stack-trace-for-mariadbd.md).)
...
* Get the latest [MariaDB code from GitHub](../../../general-resources/company-and-community/contributing-participating/contributing-code.md).
...
ftp> quit
```
* To be able to follow the progress, create a bug report in [JIRA](../../../general-resources/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/tools/jira.md) about this. This should be easy to do based on the information you have in your README file.
...
* [How to produce a stack trace from a core file](../../../general-resources/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/debugging-mariadb/how-to-produce-a-full-stack-trace-for-mariadbd.md)
