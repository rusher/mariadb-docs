...
Some syntax may be valid in a particular [SQL\_MODE](../../../server-management/variables-and-modes/sql_mode.md), but not in others. There are too many to list here, but the [SQL\_MODE](../../../server-management/variables-and-modes/sql_mode.md) page provides a full list.\
For example:
