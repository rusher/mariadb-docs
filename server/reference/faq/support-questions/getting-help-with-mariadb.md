...
If you can't find help in the [MariaDB documentation](/kb/en/mariadb-documentation/), you can also subscribe to the [mailing lists](https://app.gitbook.com/s/iJPrPCGi329TSR8WIXJW/company-and-community/friends-of-mariadb/resources) or [Zulip](https://mariadb.zulipchat.com) to communicate with MariaDB users and developers.
...
You can report and check on bugs which apply to MariaDB in [JIRA](https://app.gitbook.com/s/iJPrPCGi329TSR8WIXJW/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/tools/jira).
