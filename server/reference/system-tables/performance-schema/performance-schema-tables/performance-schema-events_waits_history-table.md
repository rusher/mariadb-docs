---
description: >-
  This table records the ten most recent completed wait events per thread,
  useful for diagnosing recent latency issues.
---

# Performance Schema events\_waits\_history Table
...
[events\_waits\_current](performance-schema-events_waits_current-table.md) and [events\_waits\_history\_long](performance-schema-events_waits_history_long-table.md) are related tables.
