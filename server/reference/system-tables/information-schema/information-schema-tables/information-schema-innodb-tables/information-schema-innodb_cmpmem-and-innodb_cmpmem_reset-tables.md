---
description: >-
  These tables provide status statistics on compressed pages within the buffer
  pool, useful for analyzing compression efficiency.
---
...
| BUFFER\_POOL\_INSTANCE | Buffer Pool identifier. From [MariaDB 10.5.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/10.5/10.5.1) returns a value of 0, since multiple InnoDB buffer pool instances has been removed.                           |
