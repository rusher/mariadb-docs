...
It takes a _list_ to be modified and a _value_ to be dropped from the list, returning the resulting value. This can be used, for example, to remove a value from a system variable taking a comma-delimited list of options, such as [sql\_mode](../../../../server-management/variables-and-modes/sql_mode.md).
