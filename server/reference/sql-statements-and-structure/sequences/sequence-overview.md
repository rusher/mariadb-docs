...
* [DROP TABLE sequence_name](../sql-statements/data-definition/drop/drop-table.md). This is allowed mainly to get old tools like [mariadb-dump](../../../clients-and-utilities/backup-restore-and-import-clients/mariadb-dump.md) to work with sequence tables.
...
rollback (the [InnoDB](../../storage-engines/innodb/README.md), [Aria](../../storage-engines/aria/README.md) and [MySAM](../../storage-engines/myisam-storage-engine/README.md) engines support this), wrapped by a
...
per insert if the [binary log](../../../server-management/server-monitoring-logs/binary-log/README.md) is enabled).
