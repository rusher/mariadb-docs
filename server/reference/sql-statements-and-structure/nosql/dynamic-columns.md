...
`53,6870,911` (bytes or characters?) for [MariaDB 5.3](/en/what-is-mariadb-53/)-10.0.0 and
`16,777,216` for [MariaDB 10.0.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-100-series/mariadb-1001-release-notes)+. This may cause excessive memory usage in
...
## [MariaDB 5.3](/en/what-is-mariadb-53/) vs [MariaDB 10.0](/en/what-is-mariadb-100/)

The dynamic columns feature was introduced into MariaDB in two steps:
1. [MariaDB 5.3](/en/what-is-mariadb-53/) was the first version to support dynamic columns. Only numbers
 could be used as column names in this version.
1. In [MariaDB 10.0.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-100-series/mariadb-1001-release-notes), column names can be either numbers or strings.
 Also, the `COLUMN_JSON` and `COLUMN_CHECK` functions were added.

See also [Dynamic Columns in MariaDB 10](/en/dynamic-columns-in-mariadb-10/).
