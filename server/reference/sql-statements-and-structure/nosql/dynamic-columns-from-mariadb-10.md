...
[COLUMN\_CHECK](../../sql-statements/built-in-functions/special-functions/dynamic-columns-functions/column_check.md) is used to check a column's integrity. When it encounters an error\
