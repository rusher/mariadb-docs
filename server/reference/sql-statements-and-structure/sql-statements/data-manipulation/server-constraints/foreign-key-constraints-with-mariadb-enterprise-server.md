...
5. Re-enable foreign key constraint checks by setting the [foreign\_key\_checks](../../../../../ha-and-performance/optimization-and-tuning/system-variables/server-system-variables.md#foreign_key_checks) system variable with the [SET SESSION](set-session/) statement:
