...
3. If the database does not exist, then create the database for the table using the [CREATE DATABASE](https://mariadb.com/kb/en/%5B%5Bcreate-database) statement:
