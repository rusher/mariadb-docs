...
The data type, length and [character set and collation](/en/data-types-character-sets-and-collations/) are all taken from the result returned by the subquery. The result of a subquery can always be NULL, that is, no result returned. Even if the original value is defined as NOT NULL, this is disregarded.
