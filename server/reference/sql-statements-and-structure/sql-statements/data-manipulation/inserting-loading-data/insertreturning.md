...
INSERT ... RETURNING was added in [MariaDB 10.5.0](../../../../../../release-notes/mariadb-community-server/release-notes-mariadb-10-5-series/mariadb-1050-release-notes.md), and returns a resultset of the [inserted](../../built-in-functions/string-functions/insert-function.md) rows.
