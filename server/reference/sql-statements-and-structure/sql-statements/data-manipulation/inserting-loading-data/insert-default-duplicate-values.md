...
To handle duplicates you can use the [IGNORE](../../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/optimization-and-indexes/ignored-indexes.md) clause, [INSERT ON DUPLICATE KEY UPDATE](insert-on-duplicate-key-update.md) or the [REPLACE](../../../../../clients-and-utilities/replace-utility.md) statement. Note that the IGNORE and DELAYED options are ignored when you use [ON DUPLICATE KEY UPDATE](insert-on-duplicate-key-update.md).
