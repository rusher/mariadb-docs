...
The RETURNING clause was introduced in [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105).
...
See [HIGH_PRIORITY and LOW_PRIORITY](../changing-deleting-data/high_priority-and-low_priority.md).
...
* [REPLACE](../../../../../clients-and-utilities/replace-utility.md) Equivalent to DELETE + INSERT of conflicting row.
