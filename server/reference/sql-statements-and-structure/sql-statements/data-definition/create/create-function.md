...
Use the `CREATE FUNCTION` statement to create a new [stored function](../../../../../server-usage/programming-customizing-mariadb/stored-routines/stored-functions/README.md). You must have
