...
Columns can be given an `INVISIBLE` attribute in a [CREATE TABLE](create-tablespace.md) or [ALTER TABLE](../alter/alter-table.md) statement. These columns will then not be listed in the results of a [SELECT *](../../../../../server-usage/replication-cluster-multi-master/standard-replication/selectively-skipping-replication-of-binlog-events.md) statement, nor do they need to be assigned a value in an [INSERT](../../../../../server-usage/programming-customizing-mariadb/views/inserting-and-updating-with-views.md) statement, unless INSERT explicitly mentions them by name.
