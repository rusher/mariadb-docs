...
See [ALTER TABLE](../alter/alter-table.md). CREATE INDEX cannot be used to create a[PRIMARY KEY](../../../../../../kb/en/getting-started-with-indexes/#primary-key); use ALTER TABLE instead.
...
Note that KEY\_BLOCK\_SIZE is currently ignored in CREATE INDEX, although it is included in the output of [SHOW CREATE TABLE](../../administrative-sql-statements/show/show-create-table.md).
