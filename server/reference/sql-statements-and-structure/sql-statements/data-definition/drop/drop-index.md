...
To remove the primary key, `PRIMARY` must be specified as index\_name. Note that [the quotes](../../../sql-language-structure/identifier-qualifiers.md) are necessary, because `PRIMARY` is a keyword.
