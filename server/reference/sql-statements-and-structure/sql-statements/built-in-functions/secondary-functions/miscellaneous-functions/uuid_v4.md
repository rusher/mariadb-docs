...
Returns a Universally Unique Identifier (UUID) version 4. To generate a version 1 UUID, see the [UUID](../../../../../data-types/string-data-types/uuid-data-type.md) function. To generate a version 7 UUID, see [UUIDv7](/en/uuidv7/).
...
Statements using the UUID_v4() function are not [safe for statement-based replication](/en/unsafe-statements-for-replication/).
