...
Until [MariaDB 10.3.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/old-releases/release-notes-mariadb-10-3-series/mariadb-1031-release-notes), returns `MYSQL_TYPE_LONGLONG`, or [bigint(10)](../../../../../data-types/data-types-numeric-data-types/bigint.md), in all cases. From [MariaDB 10.3.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/old-releases/release-notes-mariadb-10-3-series/mariadb-1031-release-notes), returns `MYSQL_TYPE_LONG`, or [int(10)](../../../../../data-types/data-types-numeric-data-types/int.md), when the result would fit within 32-bits.
