...
#### MariaDB starting with [11.2.0](/en/mariadb-1120-release-notes/)

JSON_OBJECT_FILTER_KEYS was added in [MariaDB 11.2.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-11-2-series/mariadb-11-2-0-release-notes).
