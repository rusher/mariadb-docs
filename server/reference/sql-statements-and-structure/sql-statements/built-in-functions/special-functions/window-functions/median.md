...
It is a specific case of [PERCENTILE_CONT](percentile_cont.md), with an argument of 0.5 and the [ORDER BY](../../../data-manipulation/selecting-data/order-by.md) column the one in `<code>MEDIAN</code>`'s argument.
