...
#### MariaDB starting with [11.0.2](/en/mariadb-1102-release-notes/)

Introduced in [MariaDB 11.0.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-11-0-series/mariadb-11-0-2-release-notes)
...
This function is very similar to the [Sys Schema](../../administrative-sql-statements/system-tables/sys-schema/sys-schema-sys_config-table.md) [FORMAT_TIME](../../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/format_time.md) function, but with the following differences:
