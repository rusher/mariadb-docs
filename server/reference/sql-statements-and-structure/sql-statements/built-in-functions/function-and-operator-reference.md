...
| [=](../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/equality-propagation-optimization.md) | Equal | |
...
| [!](../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/not_null_range_scan-optimization.md) | Logical NOT | |
...
| [AREA](/en/area/) | Synonym for ST_AREA | |
| [AsBinary](/en/asbinary/) | Synonym for ST_AsBinary | |
...
| [AsText](/en/astext/) | Synonym for ST_AsText | |
| [AsWKB](../../geographic-geometric-features/wkb/aswkb.md) | Synonym for ST_AsBinary | |
| [AsWKT](/en/aswkt/) | Synonym for ST_AsText | |
...
| [BENCHMARK](../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/benchmarking.md) | Executes an expression repeatedly | |
| [BETWEEN AND](../../operators/comparison-operators/between-and.md) | True if expression between two values | |
| [BIN](../../../../clients-and-utilities/server-client-software/client-libraries/clientserver-protocol/replication-protocol/binlog_checkpoint_event.md) | Returns binary value | |
...
| [BOUNDARY](/en/boundary/) | Synonym for ST_BOUNDARY | |
...
| [CHARSET](../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/charset-narrowing-optimization.md) | Returns the character set | |
...
| [COLUMN_EXISTS](special-functions/dynamic-columns-functions/column_exists.md) | Checks is a column exists | |
...
| [COMPRESS](../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/optimization-and-tuning-compression/compression-plugins.md) | Returns a binary, compressed string | |
...
| [CONV](../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/subquery-optimizations/conversion-of-big-in-predicates-into-subqueries.md) | Converts numbers between different number bases | |
...
| [COS](../../../../clients-and-utilities/graphical-and-enhanced-clients/cost-effective-agentless-mariadb-database-performance-management.md) | Returns the cosine | |
...
| [CRC32C](numeric-functions/crc32c.md) | Computes a cyclic redundancy check value | [MariaDB 10.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-108) |
...
| [DATABASE](../../../../clients-and-utilities/graphical-and-enhanced-clients/database-workbench.md) | Current default database | |
...
| [DECODE](control-flow-functions/decode_oracle.md) | Decrypts a string encoded with ENCODE() | |
...
| [ENCRYPT](../../../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/encrypting-binary-logs.md) | Encrypts a string with Unix crypt() | |
| [ENDPOINT](/en/endpoint/) | Synonym for ST_ENDPOINT | |
| [ENVELOPE](/en/envelope/) | Synonym for ST_ENVELOPE | |
| [EQUALS](../../geographic-geometric-features/geometry-relations/equals.md) | Indicates whether two geometries are spatially equal | |
| [EXP](../../../../clients-and-utilities/explain-analyzer.md) | e raised to the power of the argument | |
| [EXPORT_SET](string-functions/export_set.md) | Returns an on string for every bit set, an off string for every bit not set | |
| [ExteriorRing](/en/exteriorring/) | Synonym for ST_ExteriorRing | |
| [EXTRACT](../../../bug-tracking/extracting-entries-from-the-binary-log.md) | Extracts a portion of the date | |
...
| [FORMAT](../../../../clients-and-utilities/server-client-software/client-libraries/clientserver-protocol/replication-protocol/format_description_event.md) | Formats a number | |
| [FORMAT_BYTES](secondary-functions/miscellaneous-functions/miscellaneous-functions-format_bytes.md) | Given a byte count, returns a string consisting of a value and the units in a human-readable format. | [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-118) |
| [FORMAT_PICO_TIME](date-time-functions/format_pico_time.md) | Given a time in picoseconds, returns a human-readable time value and unit indicator | [MariaDB 11.0.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-11-0-series/mariadb-11-0-2-release-notes) |
...
| [GeomCollFromText](/en/geomcollfromtext/) | Synonym for ST_GeomCollFromText | |
| [GeomCollFromWKB](/en/geomcollfromwkb/) | Synonym for ST_GeomCollFromWKB | |
| [GEOMETRYCOLLECTION](../../geographic-geometric-features/wkb/geometrycollectionfromwkb.md) | Constructs a WKB GeometryCollection | |
...
| [GeometryCollectionFromWKB](../../geographic-geometric-features/wkb/geometrycollectionfromwkb.md) | Synonym for ST_GeomCollFromWKB | |
...
| [GeomFromText](/en/geomfromtext/) | Synonym for ST_GeomFromText | |
| [GeomFromWKB](/en/geomfromwkb/) | Synonym for ST_GeomFromWKB | |
| [GeometryN](/en/geometryn/) | Synonym for ST_GeometryN | |
| [GeometryType](/en/geometrytype/) | Synonym for ST_GeometryType | |
...
| [IN](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/mariadb-releases/compatibility-differences/incompatibilities-and-feature-differences-between-mariadb-rolling-and-mysql) | True if expression equals any of the values in the list | |
...
| [InteriorRingN](/en/interiorringn/) | Synonym for ST_InteriorRingN | |
...
| [IS](../../operators/comparison-operators/is-not-null.md) | Tests whether a boolean is TRUE, FALSE, or UNKNOWN | |
| [IsClosed](../../geographic-geometric-features/geometry-properties/isclosed.md) | Synonym for ST_IsClosed | |
| [IsEmpty](/en/isempty/) | Synonym for ST_IsEmpty | |
| [IS_FREE_LOCK](secondary-functions/miscellaneous-functions/is_free_lock.md) | Checks whether lock is free to use | |
| [IS_IPV4](secondary-functions/miscellaneous-functions/is_ipv4_mapped.md) | Whether or not an expression is a valid IPv4 address | |
...
| [IS NOT](../../operators/comparison-operators/is-not-null.md) | Tests whether a boolean value is not TRUE, FALSE, or UNKNOWN | |
...
| [ISNULL](../../operators/comparison-operators/isnull.md) | Checks if an expression is NULL | |
...
| [JSON_ARRAY_INTERSECT](special-functions/json-functions/json_array_intersect.md) | | [MariaDB 11.2.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-11-2-series/mariadb-11-2-0-release-notes) |
...
| [JSON_EQUALS](special-functions/json-functions/json_equals.md) | Check for equality between JSON objects. | [MariaDB 10.7](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-107) |
...
| [JSON_KEY_VALUE](special-functions/json-functions/json_key_value.md) | Extracts key/value pairs from a JSON object | [MariaDB 11.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-112) |
...
| [JSON_MERGE](special-functions/json-functions/json_merge_preserve.md) | Merges the given JSON documents | |
| [JSON_MERGE_PATCH](special-functions/json-functions/json_merge_preserve.md) | RFC 7396-compliant merge of the given JSON documents | |
| [JSON_MERGE_PRESERVE](special-functions/json-functions/json_merge_preserve.md) | Synonym for [JSON_MERGE_PATCH](special-functions/json-functions/json_merge_preserve.md). | |
...
| [JSON_OBJECT_FILTER_KEYS](special-functions/json-functions/json_object_filter_keys.md) | | [MariaDB 11.2.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-11-2-series/mariadb-11-2-0-release-notes) |
| [JSON_OBJECT_TO_ARRAY](special-functions/json-functions/json_object_to_array.md) | | [MariaDB 11.2.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-11-2-series/mariadb-11-2-0-release-notes) |
| [JSON_OBJECTAGG](special-functions/json-functions/json_objectagg.md) | Returns a JSON object containing key-value pairs | |
| [JSON_OVERLAPS](special-functions/json-functions/json_overlaps.md) | Compares two json documents for overlaps | [MariaDB 10.9](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-109) |
...
| [JSON_SCHEMA_VALID](special-functions/json-functions/json_schema_valid.md) | Validates a JSON schema | [MariaDB 11.1.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-11-1-series/mariadb-11-1-0-release-notes) |
...
| [JSON_TABLE](special-functions/json-functions/json_table.md) | Returns a representation of a JSON document as a relational table | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
...
| [KDF](secondary-functions/encryption-hashing-and-compression-functions/kdf.md) | Key derivation function | [MariaDB 11.3.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-11-3-rolling-releases/mariadb-11-3-0-release-notes) |
...
| [LineFromText](/en/linefromtext/) | Synonym for ST_LineFromText | |
| [LineFromWKB](/en/linefromwkb/) | Synonym for ST_LineFromWKB | |
| [LINESTRING](../../geographic-geometric-features/wkb/linestringfromwkb.md) | Constructs a WKB LineString value from a number of WKB Point arguments | |
...
| [LOG](../../../../server-management/server-monitoring-logs/slow-query-log/log_slow_always_query_time-system-variable.md) | Returns the natural logarithm | |
...
| [MAX](../../../../security/user-account-management/limiting-size-of-created-disk-temporary-files-and-tables/max_tmp_total_space_usage-system-variable.md) | Returns the maximum value | |
...
| [MBRCoveredBy](../../geographic-geometric-features/mbr-minimum-bounding-rectangle/mbrcoveredby.md) | Whether one Minimum Bounding Rectangle is covered by another. | [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-118) |
...
| [MIN](../data-manipulation/selecting-data/joins-subqueries/minus.md) | Returns the minimum value | |
...
| [MOD](../../operators/arithmetic-operators/modulo-operator.md) | Modulo operation. Remainder of N divided by M | |
...
| [MULTILINESTRING](../../geographic-geometric-features/wkb/multilinestringfromwkb.md) | Constructs a MultiLineString value | |
...
| [MULTIPOINT](../../geographic-geometric-features/wkb/multipointfromwkb.md) | Constructs a WKB MultiPoint value | |
...
| [MULTIPOLYGON](../../geographic-geometric-features/wkb/multipolygonfromwkb.md) | Constructs a WKB MultiPolygon | |
| [MultiPolygonFromText](../../geographic-geometric-features/wkt/multipolygonfromtext.md) | Synonym for MPolyFromText | |
| [MultiPolygonFromWKB](../../geographic-geometric-features/wkb/multipolygonfromwkb.md) | Synonym for MPolyFromWKB | |
...
| [NumGeometries](/en/numgeometries/) | Synonym for ST_NumGeometries | |
| [NumInteriorRings](/en/numinteriorrings/) | Synonym for NumInteriorRings | |
| [NumPoints](/en/numpoints/) | Synonym for ST_NumPoints | |
| [OCT](string-functions/octet_length.md) | Returns octal value | |
...
| [ORD](../data-manipulation/selecting-data/order-by.md) | Return ASCII or character code | |
...
| [PI](../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/pivoting-in-mariadb.md) | Returns the value of π (pi) | |
| [POINT](../../geographic-geometric-features/point-properties/point-properties-y.md) | Constructs a WKB Point | |
| [PointFromText](/en/pointfromtext/) | Synonym for ST_PointFromText | |
| [PointFromWKB](/en/pointfromwkb/) | Synonym for PointFromWKB | |
| [PointN](/en/pointn/) | Synonym for PointN | |
| [PointOnSurface](../../geographic-geometric-features/geometry-constructors/pointonsurface.md) | Synonym for ST_PointOnSurface | |
| [POLYGON](../../geographic-geometric-features/wkb/polygonfromwkb.md) | Constructs a WKB Polygon value from a number of WKB LineString arguments | |
| [PolyFromText](/en/polyfromtext/) | Synonym for ST_PolyFromText | |
| [PolyFromWKB](/en/polyfromwkb/) | Synonym for ST_PolyFromWKB | |
...
| [RAND](../../../../clients-and-utilities/server-client-software/client-libraries/clientserver-protocol/replication-protocol/rand_event.md) | Random floating-point value | |
| [RANK](special-functions/window-functions/rank.md) | Rank of a given row with identical values receiving the same result | |
| [REGEXP](string-functions/regular-expressions-functions/regexp_replace.md) | Performs pattern matching | |
...
| [SHA2](../../../../clients-and-utilities/server-client-software/client-libraries/clientserver-protocol/1-connecting/sha256_password-plugin.md) | Calculates an SHA-2 checksum | |
| [SIGN](../../../../server-usage/programming-customizing-mariadb/programmatic-compound-statements/signal.md) | Returns 1, 0 or -1 | |
...
| [SPIDER_COPY_TABLES](../../../storage-engines/spider/spider-functions/spider_copy_tables.md) | Copy table data | |
...
| [SRID](/en/srid/) | Synonym for ST_SRID | |
...
| [ST_Collect](../../geographic-geometric-features/miscellaneous-gis-functions/st_collect.md) | Returns the aggregation of the distinct geometry arguments | [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-118) |
| [ST_CONTAINS](/en/st_contains/) | Whether one geometry is contained by another | |
...
| [ST_CROSSES](/en/st_crosses/) | Whether two geometries spatially cross | |
...
| [ST_DISTANCE](../../geographic-geometric-features/geometry-relations/st_distance_sphere.md) | The distance between two geometries | |
...
| [ST_EQUALS](/en/st_equals/) | Whether two geometries are spatoially equal | |
...
| [ST_GeoHash](../../geographic-geometric-features/miscellaneous-gis-functions/st_geohash.md) | Returns a geohash. | [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-118) |
...
| [ST_GeomFromText](../../geographic-geometric-features/wkt/st_geomfromtext.md) | Constructs a geometry value using its WKT and SRID | |
...
| [ST_INTERSECTS](/en/st_intersects/) | Whether two geometries spatially intersect | |
...
| [ST_IsValid](../../geographic-geometric-features/miscellaneous-gis-functions/st_isvalid.md) | Returns 1 if the argument is geometrically valid, 0 if not. | [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-118) |
| [ST_LatFromGeoHash](../../geographic-geometric-features/miscellaneous-gis-functions/st_latfromgeohash.md) | Returns a latitude from the given geohash. | [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-118) |
| [ST_LongFromGeoHash](../../geographic-geometric-features/miscellaneous-gis-functions/st_longfromgeohash.md) | Returns a longitude from the given geohash. | [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-118) |
...
| [ST_OVERLAPS](/en/st_overlaps/) | Whether two geometries overlap | |
| [ST_PointFromGeoHash](../../geographic-geometric-features/miscellaneous-gis-functions/st_pointfromgeohash.md) | Returns a point from the given geohash. | [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-118) |
...
| [ST_POINTONSURFACE](../../geographic-geometric-features/geometry-constructors/st_pointonsurface.md) | Returns a POINT guaranteed to intersect a surface | |
...
| [ST_Simplify](../../geographic-geometric-features/miscellaneous-gis-functions/st_simplify.md) | Applies the Ramer–Douglas–Peucker algorithm to provide generalized simplifications. | [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-118) |
...
| [ST_TOUCHES](/en/st_touches/) | Whether one geometry g1 spatially touches another | |
| [ST_UNION](../../geographic-geometric-features/geometry-constructors/st_union.md) | Union of two geometries | |
| [ST_Validate](../../geographic-geometric-features/miscellaneous-gis-functions/st_validate.md) | Whether a geometry is compliant with the WKB format and SRID syntax, and is geometrically valid. | [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-118) |
| [ST_WITHIN](/en/st_within/) | Whether one geometry is within another | |
...
| [STARTPOINT](/en/startpoint/) | Synonym for ST_StartPoint | |
...
| [SYS.EXTRACT_SCHEMA_FROM_FILE_NAME](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/extract_schema_from_file_name.md) | Given a file path, returns the schema (database) name | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.EXTRACT_TABLE_FROM_FILE_NAME](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/extract_table_from_file_name.md) | Given a file path, returns the table name | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.FORMAT_BYTES](/en/format_bytes/) | Returns a string consisting of a value and the units in a human-readable format | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.FORMAT_PATH](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/format_path.md) | Returns a modified path after replacing subpaths matching the values of various system variables with the variable name | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.FORMAT_STATEMENT](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/format_statement.md) | Returns a reduced length string | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.FORMAT_TIME](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/format_time.md) | Returns a human-readable time value and unit indicator | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.LIST_ADD](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/list_add.md) | Adds a value to a given list | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.LIST_DROP](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/list_drop.md) | Drops a value from a given list | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.PS_IS_ACCOUNT_ENABLED](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/ps_is_account_enabled.md) | Whether Performance Schema instrumentation for the given account is enabled | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.PS_IS_CONSUMER_ENABLED](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/ps_is_consumer_enabled.md) | Whether Performance Schema instrumentation for the given consumer is enabled | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.PS_IS_INSTRUMENT_DEFAULT_ENABLED](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/ps_is_instrument_default_enabled.md) | Whether a given Performance Schema instrument is enabled by default | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.PS_IS_INSTRUMENT_DEFAULT_TIMED](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/ps_is_instrument_default_timed.md) | Returns whether a given Performance Schema instrument is timed by default | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.PS_IS_THREAD_INSTRUMENTED](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/ps_is_thread_instrumented.md) | Returns whether or not Performance Schema instrumentation for the given connection_id is enabled | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.PS_THREAD_ACCOUNT](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/ps_thread_account.md) | Returns the account (username@hostname) associated with the given thread_id | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.PS_THREAD_ID](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/ps_thread_id.md) | Returns the thread_id associated with the given connection_id | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.PS_THREAD_STACK](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/ps_thread_stack.md) | Returns all statements, stages, and events within the Performance Schema for a given thread_id | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.PS_THREAD_TRX_INFO](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/ps_thread_trx_info.md) | Returns a JSON object with information about the thread specified by the given thread_id | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.QUOTE_IDENTIFIER](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/quote_identifier.md) | Quotes a string to produce a result that can be used as an identifier in an SQL statement | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.SYS_GET_CONFIG](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/sys_get_config.md) | Returns a configuration option value from the sys_config table | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.VERSION_MAJOR](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/version_major.md) | Returns the MariaDB Server major release version | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.VERSION_MINOR](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/version_minor.md) | Returns the MariaDB Server minor release version | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
| [SYS.VERSION_PATCH](../administrative-sql-statements/system-tables/sys-schema/sys-schema-stored-functions/version_patch.md) | Returns the MariaDB Server patch release version | [MariaDB 10.6](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-106) |
...
| [USER](../../../../security/user-account-management/user-password-expiry.md) | Current user/host | |
...
| [UUID](../../../data-types/string-data-types/uuid-data-type.md) | Returns a Universal Unique Identifier v1 | |
| [UUIDv4](/en/uuidv4/) | Returns a Universal Unique Identifier v4 | [MariaDB 11.7](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-117) |
| [UUIDv7](/en/uuidv7/) | Returns a Universal Unique Identifier v7 | [MariaDB 11.7](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-117) |
...
| [VEC_DISTANCE](../../vectors/vector-functions/vector-functions-vec_distance.md) | Calculates either a Euclidean or Cosine distance between two vectors. | [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-118) |
| [VEC_DISTANCE_COSINE](../../vectors/vector-functions/vec_distance_cosine.md) | Calculates a Cosine distance between two vectors. | [MariaDB 11.7](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-117) |
| [VEC_DISTANCE_EUCLIDEAN](../../vectors/vector-functions/vec_distance_euclidean.md) | Calculates a Euclidean (L2) distance between two points. | [MariaDB 11.7](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-117) |
| [VEC_FromText](../../vectors/vector-functions/vec_fromtext.md) | Converts a text representation of the vector to a vector. | [MariaDB 11.6.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-11-6-rolling-releases/mariadb-11-6-0-release-notes) Vector |
| [VEC_ToText](../../vectors/vector-functions/vec_totext.md) | Converts a binary vector into a json array of numbers (floats). | [MariaDB 11.6.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-11-6-rolling-releases/mariadb-11-6-0-release-notes) Vector |
| [VERSION](secondary-functions/information-functions/version.md) | MariaDB server version | |
| [WEEK](date-time-functions/weekday.md) | Returns the week number | |
...
| [X](../../../../clients-and-utilities/xtstat.md) | Synonym for ST_X | |
| [Y](../../../../server-management/getting-installing-and-upgrading-mariadb/binary-packages/rpm/yum.md) | Synonym for ST_Y | |
| [YEAR](../../../data-types/date-and-time-data-types/year-data-type.md) | Returns the year for the given date | |
