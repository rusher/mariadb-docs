...
Some shortcuts for this function are also available: [BIN()](../../../../../clients-and-utilities/server-client-software/client-libraries/clientserver-protocol/replication-protocol/binlog_checkpoint_event.md), [OCT()](../string-functions/octet_length.md), [HEX()](../string-functions/hex.md), [UNHEX()](../string-functions/unhex.md). Also, MariaDB allows [binary](../../../sql-language-structure/binary-literals.md) literal values and [hexadecimal](../../../sql-language-structure/hexadecimal-literals.md) literal values.
