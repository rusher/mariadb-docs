...
Dividing by zero returns `<code>NULL</code>`. If the `<code>ERROR_ON_DIVISION_BY_ZERO</code>` [SQL_MODE](../../../../../server-management/variables-and-modes/sql-mode.md) is used (the default since [MariaDB 10.2.4](../../../../../../release-notes/mariadb-community-server/release-notes-mariadb-10-2-series/mariadb-1024-release-notes.md)), a division by zero also produces a warning.
...
* [truncate()](../../table-statements/truncate-table.md)
