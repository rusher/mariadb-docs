...
The `CAST()` function takes a value of one [type](../../../../data-types/README.md) and produces a value of another type, similar to the [CONVERT()](convert.md) function.
...
In [MariaDB 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/old-releases/release-notes-mariadb-10-4-series/what-is-mariadb-104) and later, you can use the `CAST()` function with the `INTERVAL` keyword.


Until [MariaDB 5.5.31](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/old-releases/release-notes-mariadb-5-5-series/mariadb-5531-release-notes), `X'HHHH'`, the standard SQL syntax for binary string literals, erroneously worked in the same way as `0xHHHH`. In 5.5.31 it was intentionally changed to behave as a string in all contexts (and never as a number).
...
* [Supported data types](../../../../data-types/README.md)
