...
If `str` is a non-binary string ([CHAR](../../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/charset-narrowing-optimization.md), [VARCHAR](../../../../data-types/string-data-types/varchar.md) or [TEXT](../../../../data-types/string-data-types/text.md)), WEIGHT_STRING returns the string's collation weight. If `str` is a binary string ([BINARY](../../../../../server-usage/programming-customizing-mariadb/stored-routines/binary-logging-of-stored-routines.md), [VARBINARY](../../../../data-types/string-data-types/varbinary.md) or [BLOB](../../../../data-types/string-data-types/blob.md)), the return value is simply the input value, since the weight for each byte in a binary string is the byte value.
