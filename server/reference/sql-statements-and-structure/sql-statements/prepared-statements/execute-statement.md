...
`EXECUTE` with expression as parameters was introduced in [MariaDB 10.2.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-102-series/mariadb-1023-release-notes). Prior to that one could only use variables (@var_name) as parameters.
