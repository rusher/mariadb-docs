...
The `SHOW CHARACTER SET` statement shows all available [character sets](/kb/en/data-types-character-sets-and-collations/). The `LIKE` clause, if present on its own, indicates which character
