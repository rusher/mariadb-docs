...
Lists the [binary log](../../../../../server-usage/programming-customizing-mariadb/stored-routines/binary-logging-of-stored-routines.md) files on the server. This statement is used as part of the
procedure described in `[PURGE BINARY LOGS](/en/purge-logs/)`, that shows how to
