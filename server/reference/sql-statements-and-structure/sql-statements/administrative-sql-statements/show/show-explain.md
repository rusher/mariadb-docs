...
The `SHOW EXPLAIN` command allows one to get an [EXPLAIN](../../../../../clients-and-utilities/explain-analyzer.md) (that is, a
...
* [EXPLAIN ANALYZE](../../../../../clients-and-utilities/explain-analyzer.md), which will perform a query and outputs enhanced `EXPLAIN` results.
