...
This statement shows a `<code class="highlight fixed" style="white-space:pre-wrap">[CREATE TRIGGER](../../../../../server-usage/programming-customizing-mariadb/triggers-events/triggers/create-trigger.md)</code>`
...
The `<code>Created</code>` column was added in [MariaDB 10.2.3](../../../../../../release-notes/mariadb-community-server/release-notes-mariadb-10-2-series/mariadb-1023-release-notes.md) as part of introducing multiple trigger events per action.
