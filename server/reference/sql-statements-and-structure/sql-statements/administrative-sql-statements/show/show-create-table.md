...
Shows the [CREATE TABLE](../../data-definition/create/create-tablespace.md) statement that creates the given table. The statement requires the [SELECT privilege](../../../../../server-usage/replication-cluster-multi-master/standard-replication/selectively-skipping-replication-of-binlog-events.md) for the table. This statement also works with [views](/kb/en/views/) and [SEQUENCE](../../../sequences/create-sequence.md).

`SHOW CREATE TABLE` quotes table and
column names according to the value of the [sql_quote_show_create](../../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_quote_show_create) server system variable.
...
MariaDB permits [TEXT](../../../../data-types/string-data-types/text.md) and [BLOB](../../../../data-types/string-data-types/blob.md) data types to be assigned a [DEFAULT](../../data-definition/create/create-tablespace.md#default) value. As a result, `SHOW CREATE TABLE` will append a `DEFAULT NULL` to nullable TEXT or BLOB fields if no specific default is provided.

Numbers are no longer quoted in the `DEFAULT` clause in `SHOW CREATE` statement. Prior to [MariaDB 10.2.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-102-series/mariadb-1022-release-notes), MariaDB quoted numbers.
...
Unquoted numeric DEFAULTs, from [MariaDB 10.2.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-102-series/mariadb-1022-release-notes):
...
Quoted numeric DEFAULTs, until [MariaDB 10.2.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-102-series/mariadb-1021-release-notes):
...
[SQL_MODE](../../../../../server-management/variables-and-modes/sql-mode.md) impacting the output:
