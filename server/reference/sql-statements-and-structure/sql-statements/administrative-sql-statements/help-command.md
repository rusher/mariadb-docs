...
The help is provided with the MariaDB server and makes use of four help tables found in the `mysql` database: [help_relation](/en/mysqlhelp_relation-table/), [help_topic](/en/mysqlhelp_topic-table/), [help_category](/en/mysqlhelp_category-table/) and [help_keyword](/en/mysqlhelp_keyword-table/). These tables are populated by the [mariadb-install-db](../../../../clients-and-utilities/mariadb-install-db.md) or `fill_help_table.sql` scripts.