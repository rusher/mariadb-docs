...
The `<code>status_by_account</code>` table contains status variable information by user. The table does not collect statistics for `<code>Com_xxx</code>` variables.
