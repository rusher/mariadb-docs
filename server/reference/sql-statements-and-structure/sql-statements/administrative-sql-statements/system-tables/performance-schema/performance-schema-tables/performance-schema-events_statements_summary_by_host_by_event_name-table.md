...
The [Performance Schema](../performance-schema-status-variables.md) events_statements_summary_by_host_by_event_name table contains statement events summarized by host and event name. It contains the following columns:
