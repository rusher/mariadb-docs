...
You can [TRUNCATE](../../../../table-statements/truncate-table.md) the table, which will reset all counters to zero. The table is also truncated if the [table_io_waits_summary_by_table](performance-schema-table_io_waits_summary_by_table-table.md) table is truncated.
