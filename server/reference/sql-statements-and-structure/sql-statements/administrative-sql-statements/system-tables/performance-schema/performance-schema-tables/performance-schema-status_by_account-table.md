...
The `<code>status_by_account</code>` table was added in [MariaDB 10.5.2](../../../../../../../../release-notes/mariadb-community-server/release-notes-mariadb-10-5-series/mariadb-1052-release-notes.md).


The `<code>status_by_account</code>` table contains status variable information by user/host account. The table does not collect statistics for `<code>Com_xxx</code>` variables.
