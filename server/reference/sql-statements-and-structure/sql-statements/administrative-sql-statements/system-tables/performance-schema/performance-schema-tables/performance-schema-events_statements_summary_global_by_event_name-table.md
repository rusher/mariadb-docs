...
The [Performance Schema](performance-schema-table_handles-table.md) `events_statements_summary_global_by_event_name` table contains statement events summarized by event name. It contains the following columns:
