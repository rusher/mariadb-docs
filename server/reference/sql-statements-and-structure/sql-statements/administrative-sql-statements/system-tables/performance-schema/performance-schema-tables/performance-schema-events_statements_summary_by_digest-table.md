...
The [Performance Schema](../performance-schema-status-variables.md) `events_statements_summary_by_digest` table records statement events summarized by schema and digest. It contains the following columns:
