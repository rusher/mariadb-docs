...
The [Performance Schema](performance-schema-table_handles-table.md) `<code>events_waits_summary_by_account_by_event_name</code>` table contains wait events summarized by account and event name. It contains the following columns:
