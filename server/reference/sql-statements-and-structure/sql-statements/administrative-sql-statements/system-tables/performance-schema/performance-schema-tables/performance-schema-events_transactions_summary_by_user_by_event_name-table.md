...
The events_transactions_summary_by_user_by_event_name table was introduced in [MariaDB 10.5.2](../../../../../../../../release-notes/mariadb-community-server/release-notes-mariadb-10-5-series/mariadb-1052-release-notes.md).


The `<code>events_transactions_summary_by_user_by_event_name</code>` table contains information on transaction events aggregated by user and event name.
