...
The [Performance Schema](performance-schema-table_handles-table.md) `<code>file_summary_by_instance</code>` table contains file events summarized by instance. It contains the following columns:
