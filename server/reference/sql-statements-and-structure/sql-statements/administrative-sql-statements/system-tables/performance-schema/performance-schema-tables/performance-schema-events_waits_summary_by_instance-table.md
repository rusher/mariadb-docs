...
The [Performance Schema](../performance-schema-status-variables.md) `events_waits_summary_by_instance` table contains wait events summarized by instance. It contains the following columns:
