...
The [Performance Schema](performance-schema-table_handles-table.md) `<code>events_waits_summary_by_instance</code>` table contains wait events summarized by instance. It contains the following columns:
