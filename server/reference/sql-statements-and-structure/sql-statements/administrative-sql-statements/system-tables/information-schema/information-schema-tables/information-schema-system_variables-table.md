...
| GLOBAL_VALUE_PATH | Which config file the variable got its value from. NULL if not set in any config file. Added in [MariaDB 10.5.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/release-notes-mariadb-10-5-series/mariadb-1050-release-notes). |
