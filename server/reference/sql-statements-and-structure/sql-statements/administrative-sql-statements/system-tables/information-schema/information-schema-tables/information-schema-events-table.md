...
The [Information Schema](/en/information_schema/) `EVENTS` table stores information about [Events](/en/stored-programs-and-views-events/) on the server.
...
| DATABASE_COLLATION | Database [collation](/en/data-types-character-sets-and-collations/) with which the event is linked. |
