...
| N_COLS | int(11) unsigned (>= [MariaDB 10.5](../../../../../../../../../release-notes/mariadb-community-server/what-is-mariadb-105.md)) int(11) (<= [MariaDB 10.4](../../../../../../../../../release-notes/mariadb-community-server/what-is-mariadb-104.md)) | NO |  | 0 | Number of columns in the table. The count includes two or three hidden InnoDB system columns, appended to the end of the column list: DB_ROW_ID (if there is no primary key or unique index on NOT NULL columns), DB_TRX_ID, DB_ROLL_PTR. |
| SPACE | int(11) unsigned (>= [MariaDB 10.5](../../../../../../../../../release-notes/mariadb-community-server/what-is-mariadb-105.md)) int(11) (<= [MariaDB 10.4](../../../../../../../../../release-notes/mariadb-community-server/what-is-mariadb-104.md)) | NO |  | 0 | Tablespace identifier where the index resides. 0 represents the InnoDB system tablespace, while any other value represents a table created in file-per-table mode (see the [innodb_file_per_table](../../../../../../../storage-engines/innodb/innodb-system-variables.md#innodb_file_per_table) system variable). Remains unchanged after a [TRUNCATE TABLE](../../../../../table-statements/truncate-table.md) statement. |
| FILE_FORMAT | varchar(10) | YES |  | NULL | [InnoDB file format](../../../../../../../storage-engines/innodb/innodb-file-format.md) (Antelope or Barracuda). Removed in [MariaDB 10.3](../../../../../../../../../release-notes/mariadb-community-server/what-is-mariadb-103.md). |
| ROW_FORMAT | enum('Redundant', 'Compact', 'Compressed', 'Dynamic') (>= [MariaDB 10.5](../../../../../../../../../release-notes/mariadb-community-server/what-is-mariadb-105.md))varchar(12) (<= [MariaDB 10.4](../../../../../../../../../release-notes/mariadb-community-server/what-is-mariadb-104.md)) | YES |  | NULL | [InnoDB storage format](../../../../../../../storage-engines/innodb/innodb-row-formats/innodb-row-formats-overview.md) (Compact, Redundant, Dynamic, or Compressed). |
| ZIP_PAGE_SIZE | int(11) unsigned | NO |  | 0 | For Compressed tables, the zipped page size. |
| SPACE_TYPE | enum('Single','System') (>= [MariaDB 10.5](../../../../../../../../../release-notes/mariadb-community-server/what-is-mariadb-105.md))varchar(10) (<= [MariaDB 10.4](../../../../../../../../../release-notes/mariadb-community-server/what-is-mariadb-104.md)) | YES |  | NULL |  |
...
| 12 13 | Normally 00, but 11 for "no-rollback tables" ([MariaDB 10.3](../../../../../../../../../release-notes/mariadb-community-server/what-is-mariadb-103.md) CREATE SEQUENCE). In [MariaDB 10.1](../../../../../../../../../release-notes/mariadb-community-server/what-is-mariadb-1010.md), these bits could be 01 or 10 for ATOMIC_WRITES=ON or ATOMIC_WRITES=OFF. |
