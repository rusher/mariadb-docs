...
The [Information Schema](/en/information_schema/) `PLUGINS` table contains information about [server plugins](/en/mariadb-plugins/).
...
This table provides a subset of the Information Schema [information_schema.ALL_PLUGINS](/en/information-schema-all_plugins-table/) table, which contains all available plugins, installed or not.
...
The equivalent [SELECT](../../../../../../../server-usage/replication-cluster-multi-master/standard-replication/selectively-skipping-replication-of-binlog-events.md) query would be:
...
Other [SELECT](../../../../../../../server-usage/replication-cluster-multi-master/standard-replication/selectively-skipping-replication-of-binlog-events.md) queries can be used to see additional information. For example:
