...
The [Information Schema](/en/information_schema/) `METADATA_LOCK_INFO` table is created by the [metadata_lock_info](/en/metadata_lock_info/) plugin. It shows active [metadata locks](../../../../transactions/metadata-locking.md) and user locks (the locks acquired with [GET_LOCK](../../../../built-in-functions/secondary-functions/miscellaneous-functions/get_lock.md)).
