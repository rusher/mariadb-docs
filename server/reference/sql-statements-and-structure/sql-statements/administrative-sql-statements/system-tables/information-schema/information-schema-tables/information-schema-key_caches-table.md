...
The [Information Schema](../README.md) `KEY_CACHES` table shows statistics about the [segmented key cache](../../../../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/segmented-key-cache.md),.
