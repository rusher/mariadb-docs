...
The [Information Schema](/en/information_schema/) `ROUTINES` table stores information about [stored procedures](/en/stored-procedures/) and [stored functions](/en/stored-functions/).
...
| DATA_TYPE | The return value's [data type](/en/data-types/) (for stored functions). |
...
| CHARACTER_SET_CLIENT | The [character set](/en/data-types-character-sets-and-collations/) used by the client that created the routine. |
| COLLATION_CONNECTION | The [collation](/en/data-types-character-sets-and-collations/) (and character set) used by the connection that created the routine. |
| DATABASE_COLLATION | The default [collation](/en/data-types-character-sets-and-collations/) (and character set) for the database, at the time the routine was created. |
