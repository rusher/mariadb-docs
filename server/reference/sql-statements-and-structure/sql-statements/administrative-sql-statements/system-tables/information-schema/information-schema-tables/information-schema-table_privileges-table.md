...
The [Information Schema](../../../../../../mariadb-internals/information-schema-plugins-show-and-flush-statements.md) `<code>TABLE_PRIVILEGES</code>` table contains table privilege information derived from the [mysql.tables_priv](../../the-mysql-database-tables/mysql-tables_priv-table.md) grant table.
