...
The `<code>OPTIMIZE TABLE</code>` statement has no effect, because the [innodb_optimize_fulltext_only](innodb-server-system-variables#innodb_optimize_fulltext_only) variable wasn't set:
