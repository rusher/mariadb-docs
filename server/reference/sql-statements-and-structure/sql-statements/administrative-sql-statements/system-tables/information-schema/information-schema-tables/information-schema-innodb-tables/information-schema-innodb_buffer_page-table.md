...
The [Information Schema](/en/information_schema/) `INNODB_BUFFER_PAGE` table contains information about pages in the [buffer pool](../../../../../../../storage-engines/innodb/innodb-buffer-pool.md).
...
* [innodb_buffer_stats_by_schema and x$innodb_buffer_stats_by_schema Sys Schema Views](/en/sys-schema-views-innodb_buffer_stats_by_schema-and-xinnodb_buffer_stats_by_/)