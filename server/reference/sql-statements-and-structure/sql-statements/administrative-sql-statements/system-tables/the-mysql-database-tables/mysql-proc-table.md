...
The `mysql.proc` table contains information about [stored procedures](/en/stored-procedures/) and [stored functions](/en/stored-functions/). It contains similar information to that stored in the [INFORMATION SCHEMA.ROUTINES](../information-schema/information-schema-tables/information-schema-routines-table.md) table.
...
| character_set_client | char(32) | YES | | NULL | The [character set](/en/data-types-character-sets-and-collations/) used by the client that created the routine. |
| collation_connection | char(32) | YES | | NULL | The [collation](/en/data-types-character-sets-and-collations/) (and character set) used by the connection that created the routine. |
| db_collation | char(32) | YES | | NULL | The default [collation](/en/data-types-character-sets-and-collations/) (and character set) for the database, at the time the routine was created. |
...
* [Stored Procedure Internals](https://app.gitbook.com/s/iJPrPCGi329TSR8WIXJW/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/mariadb-internals-documentation/mariadb-source-code-internals/stored-procedure-internals)
