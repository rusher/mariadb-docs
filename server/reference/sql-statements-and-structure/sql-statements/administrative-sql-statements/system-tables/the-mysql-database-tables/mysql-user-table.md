...
| Password | longtext | NO |  |  | Hashed password, generated by the [PASSWORD()](../../../../../plugins/password-validation-plugins/password-reuse-check-plugin.md) function. |
...
| Create_priv | enum('N','Y') | NO |  | N | Can [CREATE DATABASE's](../../../data-definition/create/create-database.md) or [CREATE TABLE's](../../../../vectors/create-table-with-vectors.md). |
