...
| Create_priv | enum('N','Y') | NO |  | N | Can [CREATE TABLEs](../../../../data-definition/create/create-table.md). |
| Drop_priv | enum('N','Y') | NO |  | N | Can [DROP DATABASEs](../../../../data-definition/drop/drop-database.md) or [DROP TABLEs](../../../../data-definition/drop/drop-table.md). |
