...
The `mysql.slow_log` table stores the contents of the [Slow Query Log](../../../../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/statistics-for-optimizing-queries/slow-query-log-extended-statistics.md) if slow logging is active and the output is being written to table (see [Writing logs into tables](../../../../../../server-management/server-monitoring-logs/writing-logs-into-tables.md)).
...
| rows_affected | int(11) | NO | | NULL | Number of rows affected by an [UPDATE](../../../data-manipulation/changing-deleting-data/update.md) or [DELETE](../../../data-manipulation/changing-deleting-data/delete.md) (from [MariaDB 10.1.2](/en/mariadb-1012-release-notes/)) |
