...
The `mysql.procs_priv` table contains information about [stored procedure](/en/stored-procedures/) and [stored function](/en/stored-functions/) privileges. See [CREATE PROCEDURE](../../../../../../server-usage/programming-customizing-mariadb/stored-routines/stored-procedures/create-procedure.md) and [CREATE FUNCTION](../../../../../../server-usage/programming-customizing-mariadb/user-defined-functions/create-function-udf.md) on creating these.
...
| Routine_type | enum('FUNCTION','PROCEDURE', 'PACKAGE', 'PACKAGE BODY') | NO | PRI | NULL | Whether the routine is a [stored procedure](/en/stored-procedures/), [stored function](/en/stored-functions/), [package](../../../data-definition/create/create-package-body.md) or [package body](../../../data-definition/create/create-package-body.md). |
