...
| Column\_priv | set('Select', 'Insert', 'Update', 'References') | NO   |     |                    | The privilege type. See [Column Privileges](../../../account-management-sql-commands/grant.md#column-privileges) for details. |
