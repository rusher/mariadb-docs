...
The mysql.password_reuse_check_history Table is installed as part of the [password_reuse_check plugin](/en/password_reuse_check-plugin/), available from [MariaDB 10.7.0](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-7-series/mariadb-1070-release-notes).
