...
This table, along with the related [mysql.innodb_index_stats](/en/mysqlinnodb_index_stats/) table, can be manually updated in order to force or test differing query optimization plans. After updating, [FLUSH TABLE innodb_table_stats](../../flush-commands/flush-tables-for-export.md) is required to load the changes.
...
* [mysql.innodb_index_stats](/en/mysqlinnodb_index_stats/)
