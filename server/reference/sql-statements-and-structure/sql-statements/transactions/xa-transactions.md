...
In MariaDB, XA transactions can only be used with storage engines that support them. At least [InnoDB](../../../storage-engines/innodb/README.md), [TokuDB](../../../storage-engines/tokudb/README.md), [SPIDER](../../../storage-engines/spider/README.md) and [MyRocks](../../../storage-engines/myrocks/README.md) support them. XA transactions are always supported.
...
XA transactions are an overloaded term in MariaDB. If a [storage engine](../../../storage-engines/README.md) is XA-capable, it can mean one or both of these:


* It supports MariaDB's internal two-phase commit API. This is transparent to the user. Sometimes this is called "internal XA", since MariaDB's internal [transaction coordinator log](../../../../server-management/server-monitoring-logs/transaction-coordinator-log/README.md) can handle coordinating these transactions.
...
If the [binary log](../../../../server-management/server-monitoring-logs/binary-log/README.md) is enabled on a server, then the server will use the binary log-based transaction coordinator log. Otherwise, it will use the memory-mapped file-based transaction coordinator log.


See [Transaction Coordinator Log](../../../../server-management/server-monitoring-logs/transaction-coordinator-log/README.md) for more information.
...
##### MariaDB until [10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-5-series/what-is-mariadb-105)
...
From [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-10-5-series/what-is-mariadb-105), `XA PREPARE`
