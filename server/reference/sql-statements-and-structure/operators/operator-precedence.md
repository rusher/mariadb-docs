...
* `[!](../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/not_null_range_scan-optimization.md)`
...
* `[*](../sql-statements/built-in-functions/numeric-functions/multiplication-operator.md)`, `[/](../sql-statements/built-in-functions/numeric-functions/division-operator.md)`, `[DIV](../sql-statements/built-in-functions/numeric-functions/div.md)`, `[%](arithmetic-operators/modulo-operator.md)`, `[MOD](arithmetic-operators/modulo-operator.md)`
...
* `[LIKE](../sql-statements/built-in-functions/string-functions/like.md)`, `[REGEXP](../sql-statements/built-in-functions/string-functions/regular-expressions-functions/regexp_replace.md)`, `[IN](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/mariadb-releases/compatibility-differences/incompatibilities-and-feature-differences-between-mariadb-rolling-and-mysql)`
* `[BETWEEN](comparison-operators/between-and.md)`
* `[=](../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/equality-propagation-optimization.md)` (comparison), `[<=>](comparison-operators/null-safe-equal.md)`, `[>=](comparison-operators/greater-than-or-equal.md)`, `[>](comparison-operators/greater-than-or-equal.md)`, `[<=](comparison-operators/less-than-or-equal.md)`, `[<](comparison-operators/less-than.md)`, `[<>](comparison-operators/not-equal.md)`, `[!=](comparison-operators/not-equal.md)`, `[IS](comparison-operators/is-not-null.md)`
* `[NOT](../../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/not_null_range_scan-optimization.md)`
* `[&&](logical-operators/and.md)`, `[AND](logical-operators/and.md)`
* `[XOR](logical-operators/xor.md)`
* `[||](../../../server-management/getting-installing-and-upgrading-mariadb/binary-packages/automated-mariadb-deployment-and-administration/orchestrator-overview.md)` (logical or), `[OR](../../../server-management/getting-installing-and-upgrading-mariadb/binary-packages/automated-mariadb-deployment-and-administration/orchestrator-overview.md)`
