...
Constructs a [WKB](../wkb/wkb-polyfromwkb.md) MultiPolygon value from a set of WKB [Polygon](polygon.md) arguments. If any argument is not a WKB Polygon, the return value is `<code>NULL</code>`.
