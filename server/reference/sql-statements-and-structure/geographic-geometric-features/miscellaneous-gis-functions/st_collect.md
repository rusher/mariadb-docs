...
ST_Collect was added in [MariaDB 11.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-118).
...
* If all arguments are [Point](../point-properties/point-properties-y.md) values, the result is a [MultiPoint](../wkb/multipointfromwkb.md) value.
...
Multiple [Point](../point-properties/point-properties-y.md) geometries aggregated into a [MultiPoint](../wkb/multipointfromwkb.md) geometry:
