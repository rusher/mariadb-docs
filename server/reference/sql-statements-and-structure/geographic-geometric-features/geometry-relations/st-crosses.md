...
Returns `1` if geometry *`g1`* spatially crosses geometry *`g2`*. Returns `NULL` if `g1` is a [Polygon](../wkb/polygonfromwkb.md) or a [MultiPolygon](../wkb/multipolygonfromwkb.md), or if `g2` is a
