...
Alphabetical list of all [mariadbd Options](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md), [Server System Variables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md) and [Server Status Variables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md). The convention used is that variable names are listed with '_' and options with '-'.
...
| --- |
| Name |
| [-a (--ansii)](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md#-a-ansi) |
| [--abort-slave-event-count](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md#-abort-slave-event-count) |
...
| [Aborted_connects_preauth](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#aborted_connects) |
| [Access_denied_errors](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#access_denied_errors) |
| [Acl_column_grants](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#acl_column_grants) |
| [Acl_database_grants](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#acl_database_grants) |
| [Acl_function_grants](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#acl_function_grants) |
| [Acl_package_body_grants](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#acl_package_body_grants) |
| [Acl_package_spec_grants](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#acl_package_spec_grants) |
| [Acl_procedure_grants](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#acl_procedure_grants) |
| [Acl_proxy_users](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#acl_proxy_users) |
| [Acl_role_grants](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#acl_role_grants) |
| [Acl_roles](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#acl_roles) |
| [Acl_table_grants](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#acl_table_grants) |
| [Acl_users](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#acl_users) |
| --[allow-suspicious-udfs](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md#-allow-suspicious-udfs), [allow_suspicious_udfs](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#allow_suspicious_udfs) |
...
| [automatic_sp_privileges](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#automatic_sp_privileges) |
| [aws_key_management_key_spec](../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin-setup-guide.md#aws_key_management_key_spec) |
| [aws_key_management_log_level](../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin-setup-guide.md#aws_key_management_log_level) |
| [aws_key_management_master_key_id](../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin-setup-guide.md#aws_key_management_master_key_id) |
| [aws_key_management_mock](../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin-setup-guide.md#aws_key_management_mock) |
| [aws_key_management_region](../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin-setup-guide.md#aws_key_management_region) |
| [aws_key_management_request_timeout](../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin-setup-guide.md#aws_key_management_request_timeout) |
| [aws_key_management_rotate_key](../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/key-management-and-encryption-plugins/aws-key-management-encryption-plugin-setup-guide.md#aws_key_management_rotate_key) |
| [back_log](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#back_log) |
| -b, [basedir](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#basedir) |
| [big_tables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#big_tables) |
| [bind_address](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#bind_address) |
| [binlog_alter_two_phase](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md#binlog_alter_two_phase) |
| [binlog_annotate_row_events](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Binlog_bytes_written](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Binlog_cache_disk_use](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [binlog_cache_size](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Binlog_cache_use](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [binlog_checksum](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [binlog_commit_wait_count](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [binlog_commit_wait_usec](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Binlog_commits](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [binlog_direct_non_transactional_updates](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Binlog_disk_use](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md#binlog_disk_use) |
| --[binlog-do-db](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md#-binlog-do-db), [binlog_do_db](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [binlog_expire_logs_seconds](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [binlog_file_cache_size](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [binlog_format](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Binlog_group_commits](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Binlog_group_commit_trigger_count](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md#binlog_group_commit_trigger_count) |
| [Binlog_group_commit_trigger_lock_wait](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md#binlog_group_commit_trigger_lock_wait) |
| [Binlog_group_commit_trigger_timeout](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md#binlog_group_commit_trigger_timeout) |
| [binlog_gtid_index](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Binlog_gtid_index_hit](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md#binlog_gtid_index_hit) |
| [Binlog_gtid_index_miss](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md#binlog_gtid_index_miss) |
| [binlog_gtid_index_page_size](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [binlog_gtid_index_span_min](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[binlog-ignore-db](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md#-binlog-ignore-db), [binlog_ignore_db](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [binlog_large_commit_threshold](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md#binlog_large_commit_threshold) |
| [binlog_legacy_event_pos](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md#binlog_legacy_event_pos) |
| [binlog_optimize_thread_scheduling](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [binlog_row_image](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[binlog-row-event-max-size](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md#-binlog-row-event-max-size), [binlog_row_event_max_size](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [binlog_row_metadata](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Binlog_snapshot_file](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Binlog_snapshot_position](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [binlog_space_limit](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md#binlog_space_limit) |
| [Binlog_stmt_cache_disk_use](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Binlog_stmt_cache_use](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [binlog_stmt_cache_size](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [block_encryption_mode](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#block_encryption_mode) |
| --[bootstrap](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md#-bootstrap) |
| [bulk_insert_buffer_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#bulk_insert_buffer_size) |
...
| [character_set_connection](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#character_set_connection) |
| [character_set_database](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#character_set_database) |
| [character_set_filesystem](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#character_set_filesystem) |
| [character_set_results](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#character_set_results) |
| -C, [character_set_server](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#character_set_server) |
| [character_set_system](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#character_set_system) |
| [character_sets_dir](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#character_sets_dir) |
| [check_constraint_checks](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#check_constraint_checks) |
| -r, --[chroot](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md#-chroot) |
| [collation_connection](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#collation_connection) |
| [collation_database](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#collation_database) |
| [collation_server](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#collation_server) |
| [Column_compressions](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/optimization-and-tuning-compression/storage-engine-independent-column-compression.md#column_compressions) |
| [column_compression_threshold](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/optimization-and-tuning-compression/storage-engine-independent-column-compression.md#column_compression_threshold) |
| [column_compression_zlib_level](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/optimization-and-tuning-compression/storage-engine-independent-column-compression.md#column_compression_zlib_level) |
| [column_compression_zlib_strategy](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/optimization-and-tuning-compression/storage-engine-independent-column-compression.md#column_compression_zlib_strategy) |
| [column_compression_zlib_wrap](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/optimization-and-tuning-compression/storage-engine-independent-column-compression.md#column_compression_zlib_wrap) |
| [Column_decompressions](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/optimization-and-tuning-compression/storage-engine-independent-column-compression.md#column_compressions) |
| [Com_admin_commands](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_admin_commands) |
| [Com_alter_db](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_alter_db) |
| [Com_alter_db_upgrade](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_alter_db_upgrade) |
| [Com_alter_event](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_alter_event) |
| [Com_alter_function](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_alter_function) |
| [Com_alter_procedure](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_alter_procedure) |
| [Com_alter_sequence](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_alter_sequence) |
| [Com_alter_server](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_alter_server) |
| [Com_alter_table](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_alter_table) |
| [Com_alter_tablespace](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_alter_tablespace) |
| [Com_alter_user](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_alter_user) |
| [Com_analyze](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_analyze) |
| [Com_assign_to_keycache](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_assign_to_keycache) |
| [Com_backup](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_backup) |
| [Com_backup_lock](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_backup_lock) |
| [Com_backup_table](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_backup_table) |
| [Com_begin](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_begin) |
| [Com_binlog](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_binlog) |
| [Com_call_procedure](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_call_procedure) |
| [Com_change_db](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_change_db) |
| [Com_change_master](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Com_check](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_check) |
| [Com_checksum](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_checksum) |
| [Com_commit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_commit) |
| [Com_compound_sql](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_compound_sql) |
| [Com_create_db](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_db) |
| [Com_create_event](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_event) |
| [Com_create_function](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_function) |
| [Com_create_index](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_index) |
| [Com_create_package](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_package) |
| [Com_create_package_body](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_package_body) |
| [Com_create_procedure](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_procedure) |
| [Com_create_role](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_role) |
| [Com_create_sequence](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_sequence) |
| [Com_create_server](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_server) |
| [Com_create_table](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_table) |
| [Com_create_temporary_table](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_temporary_table) |
| [Com_create_trigger](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_trigger) |
| [Com_create_udf](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_udf) |
| [Com_create_user](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_user) |
| [Com_create_view](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_create_view) |
| [Com_dealloc_sql](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_dealloc_sql) |
| [Com_delete](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_delete) |
| [Com_delete_multi](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_delete_multi) |
| [Com_do](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_do) |
| [Com_drop_db](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_db) |
| [Com_drop_event](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_event) |
| [Com_drop_function](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_function) |
| [Com_drop_index](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_index) |
| [Com_drop_package](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_package) |
| [Com_drop_package_body](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_package_body) |
| [Com_drop_procedure](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_procedure) |
| [Com_drop_role](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_role) |
| [Com_drop_sequence](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_sequence) |
| [Com_drop_server](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_server) |
| [Com_drop_table](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_table) |
| [Com_drop_temporary_table](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_temporary_table) |
| [Com_drop_trigger](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_trigger) |
| [Com_drop_user](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_user) |
| [Com_drop_user](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_user) |
| [Com_drop_view](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_drop_view) |
| [Com_empty_query](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_empty_query) |
| [Com_execute_immediate](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_execute_immediate) |
| [Com_execute_sql](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_execute_sql) |
| [Com_flush](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_flush) |
| [Com_get_diagnostics](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_get_diagnostics) |
| [Com_grant](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_grant) |
| [Com_grant_role](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_grant_role) |
| [Com_ha_close](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_ha_close) |
| [Com_ha_open](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_ha_open) |
| [Com_ha_read](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_ha_read) |
| [Com_help](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_help) |
| [Com_insert](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_insert) |
| [Com_insert_select](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_insert_select) |
| [Com_install_plugin](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_install_plugin) |
| [Com_kill](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_kill) |
| [Com_load](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_load) |
| [Com_load_master_data](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_load_master_data) |
| [Com_load_master_table](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_load_master_table) |
| [Com_lock_tables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_lock_tables) |
| [Com_multi](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_multi) |
| [Com_optimize](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_optimize) |
| [Com_preload_keys](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_preload_keys) |
| [Com_prepare_sql](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_prepare_sql) |
| [Com_purge](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_purge) |
| [Com_purge_before_date](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_purge_before_date) |
| [Com_release_savepoint](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_release_savepoint) |
| [Com_rename_table](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_rename_table) |
| [Com_rename_user](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_rename_user) |
| [Com_repair](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_repair) |
| [Com_replace](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_replace) |
| [Com_replace_select](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_replace_select) |
| [Com_reset](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_reset) |
| [Com_resignal](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_resignal) |
| [Com_restore_table](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_restore_table) |
| [Com_revoke](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_revoke) |
| [Com_revoke_all](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_revoke_all) |
| [Com_revoke_grant](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_revoke_grant) |
| [Com_rollback](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_rollback) |
| [Com_rollback_to_savepoint](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_rollback_to_savepoint) |
| [Com_savepoint](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_savepoint) |
| [Com_select](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_select) |
| [Com_set_option](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_set_option) |
| [Com_show_authors](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_authors) |
| [Com_show_binlog_events](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_binlog_events) |
| [Com_show_binlogs](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_binlogs) |
| [Com_show_charsets](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_charsets) |
| [Com_show_client_statistics](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_client_statistics) |
| [Com_show_collations](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_collations) |
| [Com_show_column_types](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_column_types) |
| [Com_show_contributors](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_contributors) |
| [Com_show_create_db](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_create_db) |
| [Com_show_create_event](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_create_event) |
| [Com_show_create_func](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_create_func) |
| [Com_show_create_package](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_create_package) |
| [Com_show_create_package_body](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_create_package_body) |
| [Com_show_create_proc](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_create_proc) |
| [Com_show_create_table](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_create_table) |
| [Com_show_create_trigger](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_create_trigger) |
| [Com_show_create_user](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_create_user) |
| [Com_show_databases](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_databases) |
| [Com_show_engine_logs](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_engine_logs) |
| [Com_show_engine_mutex](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_engine_mutex) |
| [Com_show_engine_status](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_engine_status) |
| [Com_show_events](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_events) |
| [Com_show_errors](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_errors) |
| [Com_show_explain](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_explain) |
| [Com_show_fields](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_fields) |
| [Com_show_function_status](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_function_status) |
| [Com_show_generic](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_generic) |
| [Com_show_grants](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_grants) |
| [Com_show_keys](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_keys) |
| [Com_show_index_statistics](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_index_statistics) |
| [Com_show_binlog_status](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Com_show_master_status](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Com_show_new_master](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Com_show_open_tables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_open_tables) |
| [Com_show_package_status](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_package_status) |
| [Com_show_package_body_status](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_package_body_status) |
| [Com_show_plugins](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_plugins) |
| [Com_show_privileges](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_privileges) |
| [Com_show_procedure_status](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_procedure_status) |
| [Com_show_processlist](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_processlist) |
| [Com_show_profile](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_profile) |
| [Com_show_profiles](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_profiles) |
| [Com_show_relaylog_events](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_relaylog_events) |
| [Com_show_slave_hosts](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Com_show_slave_status](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Com_show_status](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_status) |
| [Com_show_storage_engines](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_storage_engines) |
| [Com_show_table_statistics](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_table_statistics) |
| [Com_show_table_status](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_table_status) |
| [Com_show_tables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_tables) |
| [Com_show_triggers](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_triggers) |
| [Com_show_user_statistics](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_user_statistics) |
| [Com_show_variable](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_variable) |
| [Com_show_warnings](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_show_warnings) |
| [Com_shutdown](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_shutdown) |
| [Com_signal](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_signal) |
| [Com_slave_start](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Com_slave_stop](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Com_start_all_slaves](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Com_start_slave](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Com_stop_all_slaves](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Com_stop_slave](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Com_stmt_close](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_stmt_close) |
| [Com_stmt_execute](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_stmt_execute) |
| [Com_stmt_fetch](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_stmt_fetch) |
| [Com_stmt_prepare](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_stmt_prepare) |
| [Com_stmt_reprepare](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_stmt_reprepare) |
| [Com_stmt_reset](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_stmt_reset) |
| [Com_stmt_send_long_data](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_stmt_send_long_data) |
| [Com_truncate](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_truncate) |
| [Com_uninstall_plugin](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_uninstall_plugin) |
| [Com_unlock_tables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_unlock_tables) |
| [Com_update](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_update) |
| [Com_update_multi](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_update_multi) |
| [Com_xa_commit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_xa_commit) |
| [Com_xa_end](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_xa_end) |
| [Com_xa_prepare](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_xa_prepare) |
| [Com_xa_recover](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_xa_recover) |
| [Com_xa_rollback](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_xa_rollback) |
| [Com_xa_start](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#com_xa_start) |
...
| [Connections](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#connections) |
...
| [--debug-crc-break](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [--debug-flush](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [--debug-no-sync](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [debug_no_thread_alarm](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#debug_no_thread_alarm) |
| [debug_sync](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#debug_sync) |
| [--debug-sync-timeout](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[default-character-set](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [default_master_connection](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [default_password_lifetime](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#default_password_lifetime) |
| [default_regex_flags](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#default_regex_flags) |
| [default_storage_engine](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#default_storage_engine) |
| [default_table_type](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#default_table_type) |
| [default_tmp_storage_engine](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#default_tmp_storage_engine) |
...
| [default_week_format](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#default_week_format) |
| --[defaults-extra-file](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[defaults-file](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [delay_key_write](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#delay_key_write) |
...
| [delayed_insert_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#delayed_insert_limit) |
| [Delayed_insert_threads](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#delayed_insert_threads) |
| [delayed_insert_timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#delayed_insert_timeout) |
| [delayed_queue_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#delayed_queue_size) |
...
| [Delete_scan](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#delete_scan) |
...
| [encrypt_tmp_disk_tables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#encrypt_tmp_disk_tables) |
| [encrypt_tmp_files](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#encrypt_tmp_files) |
| [encryption_algorithm](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#encryption_algorithm) |
| [enforce_storage_engine](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#enforce_storage_engine) |
| [engine_condition_pushdown](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#engine_condition_pushdown) |
| [eq_range_index_dive_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#eq_range_index_dive_limit) |
| [error_count](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#error_count) |
| [event_scheduler](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#event_scheduler) |
| [Executed_events](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#executed_events) |
| [Executed_triggers](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#executed_triggers) |
| -T, --[exit-info](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [expensive_subquery_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#expensive_subquery_limit) |
...
| [explicit_defaults_for_timestamp](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#explicit_defaults_for_timestamp) |
| --[external-locking](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [external_user](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#external_user) |
| [extra_max_connections](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [extra_port](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [Feature_application_time_periods](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#feature_application_time_periods) |
...
| [Feature_custom_aggregate_functions](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#feature_custom_aggregate_functions) |
...
| [Feature_dynamic_columns](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#feature_dynamic_columns) |
| [Feature_fulltext](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#feature_fulltext) |
| [Feature_gis](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#feature_gis) |
| [Feature_insert_returning](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#feature_insert_returning) |
| [Feature_invisible_columns](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#feature_invisible_columns) |
| [Feature_json](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#feature_json) |
| [Feature_locale](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#feature_locale) |
| [Feature_subquery](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#feature_subquery) |
| [Feature_timezone](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#feature_timezone) |
...
| --[flashback](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
...
| [Flush_commands](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#flush_commands) |
| [flush_time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#flush_time) |
| [foreign_key_checks](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#foreign_key_checks) |
| [ft_boolean_syntax](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#ft_boolean_syntax) |
| [ft_max_word_len](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#ft_max_word_len) |
| [ft_min_word_len](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#ft_min_word_len) |
| [ft_query_expansion_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#ft_query_expansion_limit) |
| [ft_stopword_file](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#ft_stopword_file) |
| --[gdb](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [general_log](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#general_log) |
...
| [gtid_current_pos](../../server-usage/replication-cluster-multi-master/standard-replication/gtid.md) |
| [gtid_domain_id](../../server-usage/replication-cluster-multi-master/standard-replication/gtid.md) |
| [gtid_ignore_duplicates](../../server-usage/replication-cluster-multi-master/standard-replication/gtid.md) |
| [gtid_pos_auto_engines](../../server-usage/replication-cluster-multi-master/standard-replication/gtid.md#gtid_pos_auto_engines) |
| [gtid_seq_no](../../server-usage/replication-cluster-multi-master/standard-replication/gtid.md) |
| [gtid_slave_pos](../../server-usage/replication-cluster-multi-master/standard-replication/gtid.md) |
| [gtid_strict_mode](../../server-usage/replication-cluster-multi-master/standard-replication/gtid.md) |
| -h, [datadir](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#datadir) |
| [Handler_commit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_commit) |
| [Handler_delete](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_delete) |
| [Handler_discover](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_discover) |
| [Handler_external_lock](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_external_lock) |
| [Handler_icp_attempts](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_icp_attempts) |
| [Handler_icp_match](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_icp_match) |
| [Handler_mrr_init](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_mrr_init) |
| [Handler_mrr_key_refills](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_mrr_key_refills) |
| [Handler_mrr_rowid_refills](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_mrr_rowid_refills) |
| [Handler_prepare](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_prepare) |
| [Handler_read_first](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_read_first) |
| [Handler_read_key](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_read_key) |
| [Handler_read_last](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_read_last) |
| [Handler_read_next](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_read_next) |
| [Handler_read_prev](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_read_prev) |
| [Handler_read_retry](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_read_retry) |
| [Handler_read_rnd](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_read_rnd) |
| [Handler_read_rnd_deleted](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_read_rnd_deleted) |
| [Handler_read_rnd_next](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_read_rnd_next) |
| [Handler_rollback](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_rollback) |
| [Handler_savepoint](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_savepoint) |
| [Handler_savepoint_rollback](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_savepoint_rollback) |
| [Handler_tmp_delete](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_tmp_delete) |
| [Handler_tmp_update](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#handler_tmp_update) |
...
| [have_compress](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#have_compress) |
| [have_crypt](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#have_crypt) |
...
| [have_profiling](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#have_profiling) |
| [have_query_cache](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#have_query_cache) |
| [have_rtree_keys](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#have_rtree_keys) |
| [have_ssl](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md) |
| [have_symlink](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#have_symlink) |
| --[help](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [histogram_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#histogram_size) |
| [histogram_type](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#histogram_type) |
| [host_cache_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#host_cache_size) |
| [hostname](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#hostname) |
| [identity](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#identity) |
| [idle_readonly_transaction_timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#idle_readonly_transaction_timeout) |
...
| [init_file](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#init_file) |
...
| [Innodb_async_reads_total_enqueues](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_async_reads_total_enqueues) |
| [Innodb_async_reads_total_count](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_async_reads_total_count) |
| [Innodb_async_reads_wait_slot_sec](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_async_reads_wait_slot_sec) |
...
| [Innodb_buffer_pool_pages_flushed](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_buffer_pool_pages_flushed) |
| [Innodb_buffer_pool_pages_LRU_flushed](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_buffer_pool_pages_lru_flushed) |
| [Innodb_buffer_pool_pages_LRU_freed](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_buffer_pool_pages_lru_freed) |
| [Innodb_buffer_pool_pages_free](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_buffer_pool_pages_free) |
| [Innodb_buffer_pool_pages_made_not_young](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_buffer_pool_pages_made_not_young) |
| [Innodb_buffer_pool_pages_made_young](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_buffer_pool_pages_made_young) |
...
| [Innodb_data_read](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_data_read) |
| [Innodb_data_reads](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_data_reads) |
| [Innodb_data_writes](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_data_writes) |
...
| [Innodb_encryption_n_rowlog_blocks_encrypted](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_encryption_n_rowlog_blocks_encrypted) |
...
| [Innodb_have_lzma](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_have_lzma) |
| [Innodb_have_lzo](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_have_lzo) |
...
| [Innodb_master_thread_1_second_loops](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_master_thread_1_second_loops) |
| [Innodb_master_thread_10_second_loops](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_master_thread_10_second_loops) |
| [Innodb_master_thread_active_loops](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_master_thread_active_loops) |
| [Innodb_master_thread_background_loops](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_master_thread_background_loops) |
...
| [Innodb_num_index_pages_written](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_num_index_pages_written) |
| [Innodb_num_non_index_pages_written](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_num_non_index_pages_written) |
| [Innodb_num_open_files](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_num_open_files) |
| [Innodb_num_page_compressed_trim_op](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_num_page_compressed_trim_op) |
| [Innodb_num_page_compressed_trim_op_saved](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_num_page_compressed_trim_op_saved) |
| [Innodb_num_pages_encrypted](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_num_pages_encrypted) |
| [Innodb_num_pages_page_compressed](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_num_pages_page_compressed) |
| [Innodb_num_pages_page_compression_error](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_num_pages_page_compression_error) |
...
| [Innodb_page_compression_trim_sect2048](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_page_compression_trim_sect2048) |
| [Innodb_page_compression_trim_sect4096](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_page_compression_trim_sect4096) |
...
| [Innodb_row_lock_time_avg](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_row_lock_time_avg) |
| [Innodb_row_lock_time_max](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_row_lock_time_max) |
| [Innodb_row_lock_waits](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_row_lock_waits) |
| [Innodb_rows_deleted](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_rows_deleted) |
| [Innodb_rows_inserted](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_rows_inserted) |
| [Innodb_rows_read](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_rows_read) |
| [Innodb_rows_updated](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_rows_updated) |
| --[innodb-rseg](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
...
| [Innodb_system_rows_deleted](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/innodb-status-variables.md#innodb_system_rows_deleted) |
...
| --[insert_id](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#insert_id) |
| --[install](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[install-manual](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [interactive_timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#interactive_timeout) |
| [join_buffer_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#join_buffer_size) |
| [join_buffer_space_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#join_buffer_space_limit) |
| [join_cache_level](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#join_cache_level) |
| [keep_files_on_create](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#keep_files_on_create) |
| [Key_blocks_not_flushed](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#key_blocks_not_flushed) |
...
| [Key_writes](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#key_writes) |
| -L, [language](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#language) |
| [large_files_support](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#large_files_support) |
| [large_page_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#large_page_size) |
| [large_pages](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#large_pages) |
| [last_gtid](../../server-usage/replication-cluster-multi-master/standard-replication/gtid.md#last_gtid) |
| [last_insert_id](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#last_insert_id) |
| [Last_query_cost](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#last_query_cost) |
| [lc_messages](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#lc_messages) |
| [lc_messages_dir](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#lc_messages_dir) |
| [lc_time_names](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#lc_time_names) |
...
| [license](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#license) |
| [local_infile](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#local_infile) |
| [lock_wait_timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#lock_wait_timeout) |
| [locked_in_memory](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#locked_in_memory) |
| -l, [log](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log) |
| --[log-basename](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [log_bin](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [log_bin_basename](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [log_bin_compress](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [log_bin_compress_min_len](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [log_bin_index](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [log_bin_trust_function_creators](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[log-bin-trust-routine-creators](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[log-ddl-recovery](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [log_disabled_statements](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_disabled_statements) |
| [log_error](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_error) |
| -0, --[log-long-format](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [log_output](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_output) |
| [log_queries_not_using_indexes](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_queries_not_using_indexes) |
| --[log-short-format](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [log_slave_updates](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [log_slow_admin_statements](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_slow_admin_statements) |
| [log_slow_always_query_time](../server-monitoring-logs/slow-query-log/log_slow_always_query_time-system-variable.md) |
| [log_slow_disabled_statements](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_slow_disabled_statements) |
| --[log-slow-file](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [log_slow_filter](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_slow_filter) |
| [log_slow_min_examined_row_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_slow_min_examined_row_limit) |
| [log_slow_queries](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_slow_queries) |
| [log_slow_query](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_slow_query) |
| [log_slow_query_file](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_slow_query_file) |
| [log_slow_query_time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_slow_query_time) |
| [log_slow_rate_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_slow_rate_limit) |
| [log_slow_slave_statements](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[log-slow-time](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [log_slow_verbosity](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_slow_verbosity) |
| --[log-tc](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [log_tc_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_tc_size) |
| -W, --[log-warnings](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_warnings), [log_warnings](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_warnings) |
| [long_query_time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#long_query_time) |
| --[log-isam](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [low_priority_updates](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#low_priority_updates) |
| [lower_case_file_system](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#lower_case_file_system) |
| [lower_case_table_names](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#lower_case_table_names) |
| --[master-connect-retry](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [Master_gtid_wait_count](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md#master_gtid_wait_count) |
| [Master_gtid_wait_time](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md#master_gtid_wait_time) |
| [Master_gtid_wait_timeouts](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md#master_gtid_wait_timeouts) |
| --[master-host](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-info-file](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-password](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-port](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-retry-count](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-ssl](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-ssl-ca](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-ssl-capath](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-ssl-cert](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-ssl-cipher](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-ssl-key](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[master-user](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [master_verify_checksum](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [max_allowed_packet](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_allowed_packet) |
| --[max-binlog-dump-events](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [max_binlog_cache_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_binlog_cache_size) |
| [max_binlog_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_binlog_size) |
| [max_binlog_stmt_cache_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_binlog_stmt_cache_size) |
| --[max-binlog-total-size](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [max_binlog_total_size](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[max-connect-errors](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_connect_errors), [max_connect_errors](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_connect_errors) |
| --[max-connections](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_connections), [max_connections](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_connections) |
| --[max-delayed-threads](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_delayed_threads), [max_delayed_threads](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_delayed_threads) |
| --[max-digest-length](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_digest_length), [max_digest_length](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_digest_length) |
| --[max-error-count](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_error_count), [max_error_count](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_error_count) |
| --[max-heap-table-size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_heap_table_size), [max_heap_table_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_heap_table_size) |
| [max_insert_delayed_threads](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_insert_delayed_threads) |
| [max_join_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_join_size) |
| [max_length_for_sort_data](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_length_for_sort_data) |
| [max_long_data_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_long_data_size) |
| [max_prepared_stmt_count](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_prepared_stmt_count) |
...
| [max_recursive_iterations](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_recursive_iterations) |
| [max_relay_log_size](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [max_rowid_filter_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_rowid_filter_size) |
| [max_seeks_for_key](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_seeks_for_key) |
| [max_session_mem_used](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_session_mem_used) |
| --[max-sort-length](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_sort_length), [max_sort_length](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_sort_length) |
| --[max-sp-recursion-depth](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_sp_recursion_depth), [max_sp_recursion_depth](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_sp_recursion_depth) |
| --[max-statement-time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_statement_time), [max_statement_time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_statement_time) |
| [Max_statement_time_exceeded](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#max_statement_time_exceeded) |
| [max_tmp_session_space_usage](../../security/user-account-management/limiting-size-of-created-disk-temporary-files-and-tables/max_tmp_session_space_usage-system-variable.md) |
...
| [max_tmp_tables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_tmp_tables) |
| [max_tmp_total_space_usage](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_tmp_total_space_usage) |
| [Max_used_connections_time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#max_used_connections_time) |
...
| [max_user_connections](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_user_connections) |
| [max_write_lock_count](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#max_write_lock_count) |
| --[memlock](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [Memory_used](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#memory_used) |
...
| --[net-buffer-length](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#net_buffer_length), [net_buffer_length](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#net_buffer_length) |
| --[net-read-timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#net_read_timeout), [net_read_timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#net_read_timeout) |
| --[net-retry-count](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#net_retry_count), [net_retry_count](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#net_retry_count) |
| --[net-write-timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#net_write_timeout), [net_write_timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#net_write_timeout) |
| [Not_flushed_delayed_rows](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#not_flushed_delayed_rows) |
| --[new](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[old](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#old), [old](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#old) |
| --[old-alter-table](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#old_alter_table), [old_alter_table](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#old_alter_table) |
| --[old-mode](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#old_mode), [old_mode](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#old_mode) |
| --[old-passwords](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#old_passwords), [old_passwords](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#old_passwords) |
| --[old-style-user-limits](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[one-thread](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [Open_files](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#open_files) |
| --[open-files-limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#open_files_limit), [open_files_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#open_files_limit) |
| [Open_streams](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#open_streams) |
| [Open_table_definitions](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#open_table_definitions) |
| [Open_tables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#open_tables) |
| [Opened_files](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#opened_files) |
...
| [Opened_table_definitions](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#opened_table_definitions) |
| [Opened_tables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#opened_tables) |
| [Opened_views](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#opened_views) |
| [optimizer_adjust_secondary_key_costs](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/optimizer_adjust_secondary_key_costs.md) |
| [optimizer_extra_pruning_depth](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_extra_pruning_depth) |
| [optimizer_join_limit_pref_ratio](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_join_limit_pref_ratio) |
| [optimizer_max_sel_arg_weight](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_max_sel_arg_weight) |
| [optimizer_max_sel_args](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_max_sel_args) |
| [optimizer_prune_level](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_prune_level) |
| [optimizer_search_depth](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_search_depth) |
| [optimizer_selectivity_sampling_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_selectivity_sampling_limit) |
| [optimizer_switch](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_switch) |
| [optimizer_trace](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_trace) |
| [optimizer_trace_max_mem_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_trace_max_mem_size) |
| [optimizer_use_condition_selectivity](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#optimizer_use_condition_selectivity) |
| [oqgraph_allow_create_integer_latch](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/oqgraph-system-and-status-variables.md#oqgraph_allow_create_integer_latch) |
...
| [--performance-schema-consumer-events-statements-current](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [--performance-schema-consumer-events-statements-history](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [--performance-schema-consumer-events-statements-history-long](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [--performance-schema-consumer-events-waits-current](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [--performance-schema-consumer-events-waits-history](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [--performance-schema-consumer-events-waits-history-long](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
...
| --[plugin-dir](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#plugin_dir), [plugin_dir](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#plugin_dir) |
| --[plugin-maturity](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#plugin_maturity), [plugin_maturity](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#plugin_maturity) |
| -P, --[port](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#port), [port](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#port) |
| --[port-open-timeout](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [preload_buffer_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#preload_buffer_size) |
| [Prepared_stmt_count](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#prepared_stmt_count) |
| [profiling](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#profiling) |
| [profiling_history_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#profiling_history_size) |
| [progress_report_time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#progress_report_time) |
| [protocol_version](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#protocol_version) |
...
| [proxy_user](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#proxy_user) |
| [pseudo_slave_mode](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#pseudo_slave_mode) |
...
| [Qcache_free_blocks](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#qcache_free_blocks) |
| [Qcache_free_memory](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#qcache_free_memory) |
...
| [Qcache_queries_in_cache](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#qcache_queries_in_cache) |
...
| [query_cache_strip_comments](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#query_cache_strip_comments) |
...
| [rand_seed2](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#rand_seed2) |
| [range_alloc_block_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#range_alloc_block_size) |
...
| [read_binlog_speed_limit](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [read_only](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#read_only) |
| [read_rnd_buffer_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#read_rnd_buffer_size) |
| --[record-buffer](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[redirect-url](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#redirect_url), [redirect_url](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#redirect_url) |
| [relay_log](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [relay_log_basename](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[relay-log-index](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [relay_log_index](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[relay-log-info-file](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [relay_log_info_file](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[relay-log-purge](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [relay_log_purge](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[relay-log-recovery](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [relay_log_recovery](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[relay-log-space-limit](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [relay_log_space_limit](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[remove](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[replicate-annotate-row-events](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [replicate_annotate_row_events](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[replicate-do-db](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [replicate_do_db](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[replicate-do-table](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [replicate_do_table](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[replicate-events-marked-for-skip](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [replicate_events_marked_for_skip](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[replicate-ignore-db](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [replicate_ignore_db](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[replicate-ignore-table](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [replicate_ignore_table](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[replicate-rewrite-db](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [replicate_rewrite_db](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[replicate-same-server-id](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[replicate-wild-do-table](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [replicate_wild_do_table](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[replicate-wild-ignore-table](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [replicate_wild_ignore_table](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[report-host](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [report_host](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[report-password](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [report_password](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
...
| [Rows_sent](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#rows_sent) |
| [Rows_tmp_read](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#rows_tmp_read) |
| --[rpl-recovery-rank](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#rpl_recovery_rank), [rpl_recovery_rank](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#rpl_recovery_rank) |
| [Rpl_semi_sync_master_clients](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_clients) |
| [rpl-semi-sync-master-enabled](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_enabled) [rpl_semi_sync_master_enabled](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_enabled) |
| [Rpl_semi_sync_master_net_avg_wait_time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_net_avg_wait_time) |
| [Rpl_semi_sync_master_net_wait_time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_net_wait_time) |
| [Rpl_semi_sync_master_net_waits](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_net_waits) |
...
| [Rpl_semi_sync_master_status](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_status) |
...
| [rpl-semi-sync-master-timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_timeout), [rpl_semi_sync_master_timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_timeout) |
| [rpl-semi-sync-master-trace-level](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_trace_level) , [rpl_semi_sync_master_trace_level](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_trace_level) |
| [Rpl_semi_sync_master_tx_avg_wait_time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_tx_avg_wait_time) |
| [Rpl_semi_sync_master_tx_wait_time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_tx_wait_time) |
| [Rpl_semi_sync_master_tx_waits](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_tx_waits) |
| [rpl-semi-sync-master-wait-no-slave](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_wait_no_slave), [rpl_semi_sync_master_wait_no_slave](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_wait_no_slave) |
| [rpl-semi-sync-master-wait-point](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_wait_point), [rpl_semi_sync_master_wait_point](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_wait_point) |
...
| [Rpl_semi_sync_master_wait_sessions](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_master_wait_sessions) |
...
| [rpl-semi-sync-slave-delay-master](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_slave_delay_master), [rpl_semi_sync_slave_delay_master](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_slave_delay_master) |
| [rpl-semi-sync-slave-enabled](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_slave_enabled), [rpl_semi_sync_slave_enabled](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_slave_enabled) |
| [rpl-semi-sync-slave-kill-conn-timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_slave_kill_conn_timeout), [rpl_semi_sync_slave_kill_conn_timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_slave_kill_conn_timeout) |
| [Rpl_semi_sync_slave_status](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_slave_status) |
| [rpl-semi-sync-slave-trace-level](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_slave_trace_level), [rpl_semi_sync_slave_trace_level](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/semisynchronous-replication-plugin-status-variables.md#rpl_semi_sync_slave_trace_level) |
...
| --[safemalloc-mem-limit](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[secure-auth](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#secure_auth), [secure_auth](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#secure_auth) |
| --[secure-file-priv](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#secure_file_priv), [secure_file_priv](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#secure_file_priv) |
| --[secure-timestamp](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#secure_timestamp), [secure_timestamp](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#secure_timestamp) |
| [Select_full_join](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#select_full_join) |
| [Select_full_range_join](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#select_full_range_join) |
...
| [session_track_state_change](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#session_track_state_change) |
| [session_track_system_variables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#session_track_system_variables) |
| [session_track_transaction_info](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#session_track_transaction_info) |
| -O, --[set-variable](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [shared_memory](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#shared_memory) |
| [shared_memory_base_name](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#shared_memory_base_name) |
...
| --[skip-new](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[skip-networking](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#skip_networking), [skip_networking](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#skip_networking) |
| [skip_parallel_replication](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[skip-partition](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [skip_replication](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[skip-show-database](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#skip_show_database), [skip_show_database](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#skip_show_database) |
| --[skip-slave-start](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[skip-ssl](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[skip-stack-trace](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[skip-symbolic-links](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[skip-symlink](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[skip-thread-priority](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [slave_abort_blocking_timeout](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md#slave_abort_blocking_timeout) |
| [slave_compressed_protocol](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [slave_connections_needed_for_purge](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Slave_connections](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [slave_ddl_exec_mode](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [slave_domain_parallel_threads](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [slave_exec_mode](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Slave_heartbeat_period](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [slave_load_tmpdir](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [slave_max_allowed_packet](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [slave_max_statement_time](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
...
| [Slave_open_temp_tables](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [slave_parallel_max_queued](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [slave_parallel_mode](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [slave_parallel_threads](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [slave_parallel_workers](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Slave_received_heartbeats](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Slave_retried_transactions](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [slave_run_triggers_for_rbr](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md), [slave-run-triggers-for-rbr](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Slave_running](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [slave_skip_errors](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Slave_skipped_errors](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [slave_sql_verify_checksum](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [slave_transaction_retries](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
...
| [slave_type_conversions](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [Slaves_connected](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Slaves_running](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
...
| [Slow_queries](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#slow_queries) |
| [slow_query_log](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#slow_query_log) |
| [slow_query_log_file](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#slow_query_log_file) |
| --[slow-start-timeout](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
...
| [sort_buffer_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sort_buffer_size) |
| [Sort_merge_passes](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#sort_merge_passes) |
| [Sort_priority_queue_sorts](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#sort_priority_queue_sorts) |
| [Sort_range](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#sort_range) |
| [Sort_rows](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#sort_rows) |
| [Sort_scan](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#sort_scan) |
| [Sphinx_error](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sphinx-status-variables.md#sphinx_error) |
| [Sphinx_time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sphinx-status-variables.md#sphinx_time) |
| [Sphinx_total](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sphinx-status-variables.md#sphinx_total) |
...
| [sql_big_tables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_big_tables) |
| [sql_buffer_result](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_buffer_result) |
| --[sql-bin-update-same](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[sql-error-log-filename](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options.md#sql_error_log_filename), [sql_error_log_filename](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options.md#sql_error_log_filename) |
| --[sql-error-log-rate](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options.md#sql_error_log_rate), [sql_error_log_rate](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options.md#sql_error_log_rate) |
| --[sql-error-log-rotate](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options.md#sql_error_log_rotate), [sql_error_log_rotate](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options.md#sql_error_log_rotate) |
| --[sql-error-log-rotations](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options.md#sql_error_log_rotations), [sql_error_log_rotations](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options.md#sql_error_log_rotations) |
| --[sql-error-log-size-limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options.md#sql_error_log_size_limit), [sql_error_log_size_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options.md#sql_error_log_size_limit) |
| --[sql-error-log-warnings](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options.md#sql_error_log_warnings), [sql_error_log_warnings](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/sql-error-log-system-variables-and-options.md#sql_error_log_warnings) |
| --[sql-if-exists](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_if_exists), [sql_if_exists](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_if_exists) |
| [sql_log_bin](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [sql_log_off](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_log_off) |
| [sql_log_update](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_log_update) |
| [sql_low_priority_updates](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_low_priority_updates) |
| [sql_max_join_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_max_join_size) |
| --[sql-mode](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_mode), [sql_mode](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_mode) |
| [sql_notes](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_notes) |
| [sql_quote_show_create](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_quote_show_create) |
| --[sql-safe-updates](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_safe_updates), [sql_safe_updates](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_safe_updates) |
| [sql_select_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_select_limit) |
| [sql_slave_skip_counter](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [sql_warnings](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sql_warnings) |
| --[ssl](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [Ssl_accept_renegotiates](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_accepts](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| --[ssl-ca](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md), [ssl_ca](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md) |
| [Ssl_callback_cache_hits](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| --[ssl-capath](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md), [ssl_capath](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md) |
| --[ssl-cert](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md), [ssl_cert](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md) |
| --[ssl-cipher](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md), [ssl_cipher](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md) |
| [Ssl_cipher](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_cipher_list](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_client_connects](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_connect_renegotiates](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| --[ssl-crl](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md), [ssl_crl](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md) |
| --[ssl-crlpath](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md), [ssl_crlpath](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md) |
| [Ssl_ctx_verify_depth](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_ctx_verify_mode](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_default_timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_finished_accepts](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_finished_connects](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| --[ssl-key](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md), [ssl_key](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md) |
| [Ssl_server_not_after](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_server_not_before](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_session_cache_hits](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_session_cache_misses](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_session_cache_mode](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_session_cache_overflows](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_session_cache_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_session_cache_timeouts](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_sessions_reused](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_used_session_cache_entries](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_verify_depth](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| [Ssl_verify_mode](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/ssltls-status-variables.md) |
| --[standard-compliant-cte](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#standard_compliant_cte), [standard_compliant_cte](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#standard_compliant_cte) |
| --[stack-trace](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[standalone](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [storage_engine](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#storage_engine) |
| --[stored-program-cache](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#stored_program_cache), [stored_program_cache](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#stored_program_cache) |
| --[strict-password-validation](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#strict_password_validation), [strict_password_validation](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#strict_password_validation) |
...
| -s, --[symbolic-links](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [sync_binlog](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [sync_frm](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#sync_frm) |
| [sync_master_info](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [sync_relay_log](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| [sync_relay_log_info](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-system-variables.md) |
| --[sync-sys](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [Syncs](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#syncs) |
...
| [table_open_cache](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#table_open_cache) |
| [Table_open_cache_active_instances](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#table_open_cache_active_instances) |
| [Table_open_cache_hits](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#table_open_cache_hits) |
| [table_open_cache_instances](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#table_open_cache_instances) |
| [Table_open_cache_misses](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#table_open_cache_misses) |
| [Table_open_cache_overflows](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#table_open_cache_overflows) |
| [table_type](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#table_type) |
| --[tc-heuristic-recover](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
...
| [Tc_log_page_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#tc_log_page_size) |
...
| [tcp_keepalive_interval](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#tcp_keepalive_interval) |
| [tcp_keepalive_probes](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#tcp_keepalive_probes) |
| [tcp_keepalive_time](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#tcp_keepalive_time) |
| --[tcp-nodelay](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#tcp_nodelay), [tcp_nodelay](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#tcp_nodelay) |
| --[temp-pool](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[test-expect-abort](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[test-ignore-wrong-options](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --thread-alarm |
| [thread_cache_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#thread_cache_size) |
| [thread_concurrency](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#thread_concurrency) |
| [thread_handling](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [thread_pool_dedicated_listener](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [thread_pool_exact_stats](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [thread_pool_idle_timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [thread_pool_max_threads](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [thread_pool_min_threads](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [thread_pool_oversubscribe](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [thread_pool_prio_kickup_timer](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [thread_pool_priority](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [thread_pool_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [thread_pool_stall_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [Threadpool_idle_threads](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [Threadpool_threads](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/buffers-caches-and-threads/thread-pool/thread-pool-system-status-variables.md) |
| [thread_stack](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#thread_stack) |
| [Threads_cached](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#threads_cached) |
| [Threads_connected](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#threads_connected) |
| [Threads_created](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#threads_created) |
| [Threads_running](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#threads_running) |
| [timed_mutexes](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#timed_mutexes) |
| [timestamp](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#timestamp) |
...
| [time_zone](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#time_zone) |
| [tls_version](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md#tls_version) |
| [tmp_disk_table_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#tmp_disk_table_size) |
| [tmp_memory_table_size](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#tmp_memory_table_size) |
...
| [Transactions_gtid_foreign_engine](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [Transactions_multi_engine](../../server-usage/replication-cluster-multi-master/standard-replication/replication-and-binary-log-status-variables.md) |
| [tx_isolation](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#tx_isolation) |
| [tx_read_only](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#tx_read_only) |
| -u, --[user](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [unique_checks](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#unique_checks) |
| --[updatable-views-with-limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#updatable_views_with_limit), [updatable_views_with_limit](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#updatable_views_with_limit) |
| [Update_scan](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#update_scan) |
| [Uptime](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#uptime) |
| [Uptime_since_flush_status](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-status-variables.md#uptime_since_flush_status) |
| -u, --[user](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| --[use-stat-tables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#use_stat_tables), [use_stat_tables](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#use_stat_tables) |
| --[userstat](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/statistics-for-optimizing-queries/user-statistics.md#userstat), [userstat](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/query-optimizations/statistics-for-optimizing-queries/user-statistics.md#userstat) |
| -v, --[verbose](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| -V, [version](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#version) |
| [version_comment](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#version_comment) |
| [version_compile_machine](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#version_compile_machine) |
| [version_compile_os](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#version_compile_os) |
| [version_malloc_library](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#version_malloc_library) |
| [version_source_revision](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#version_source_revision) |
| [version_ssl_library](../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/ssltls-system-variables.md) |
| -W, [log_warnings](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#log_warnings) |
| [wait_timeout](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#wait_timeout) |
| [warning_count](../../server-usage/replication-cluster-multi-master/optimization-and-tuning/system-variables/server-system-variables.md#warning_count) |
| [wsrep](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_allowlist](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_allowlist) |
| [wsrep_applier_thread_count](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_apply_oooe](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_apply_oool](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_auto_increment_control](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_auto_increment_control) |
| [wsrep_causal_reads](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_causal_reads) |
| [wsrep_cert_deps_distance](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_certification_rules](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_certification_rules) |
| [wsrep_certify_nonPK](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_certify_nonpk) |
| [wsrep_cluster_address](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_cluster_address) |
| [wsrep_cluster_capabilities](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_cluster_conf_id](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_cluster_name](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_cluster_name) |
| [wsrep_cluster_size](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_cluster_state_uuid](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_cluster_status](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_connected](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_convert_LOCK_to_trx](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_convert_lock_to_trx) |
| [wsrep_data_home_dir](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_data_home_dir) |
| [wsrep_dbug_option](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_dbug_option) |
| [wsrep_debug](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_debug) |
| [wsrep_desync](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_desync) |
| [wsrep_dirty_reads](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_dirty_reads) |
| [wsrep_drupal_282555_workaround](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_drupal_282555_workaround) |
| [wsrep_flow_control_paused](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_flow_control_recv](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_flow_control_sent](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_gtid_domain_id](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_gtid_domain_id) |
| [wsrep_gtid_mode](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_gtid_mode) |
| [wsrep_gtid_seq_no](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_gtid_seq_no) |
| [wsrep_forced_binlog_format](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_forced_binlog_format) |
| [wsrep_ignore_apply_errors](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_ignore_apply_errors) |
| [wsrep_last_committed](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_load_data_splitting](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_load_data_splitting) |
| [wsrep_local_bf_aborts](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_local_cert_failures](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_local_commits](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_local_index](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_local_recv_queue](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_local_recv_queue_avg](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_local_replays](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_local_send_queue](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_local_send_queue_avg](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_local_state](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_local_state_comment](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_local_state_uuid](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_log_conflicts](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_log_conflicts) |
| [wsrep_max_ws_rows](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_max_ws_rows) |
| [wsrep_max_ws_size](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_max_ws_size) |
| [wsrep_mode](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_mode) |
| [wsrep_mysql_replication_bundle](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_mysql_replication_bundle) |
| --[wsrep-new-cluster](../getting-installing-and-upgrading-mariadb/starting-and-stopping-mariadb/mariadbd-options.md) |
| [wsrep_node_address](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_node_address) |
| [wsrep_node_incoming_address](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_node_incoming_address) |
| [wsrep_node_name](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_node_name) |
| [wsrep_notify_cmd](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_notify_cmd) |
| [wsrep_on](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_on) |
| [wsrep_OSU_method](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_osu_method) |
| [wsrep_protocol_version](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_provider_name](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_patch_version](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_patch_version) |
| [wsrep_provider](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_provider) |
| [wsrep_provider_options](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_provider_options) |
| [wsrep_provider_vendor](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_provider_version](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_ready](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_received](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_received_bytes](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_recover](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_recover) |
| [wsrep_reject_queries](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_reject_queries) |
| [wsrep_replicate_myisam](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_replicate_myisam) |
| [wsrep_replicated](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_replicated_bytes](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_retry_autocommit](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_retry_autocommit) |
| [wsrep_rollbacker_thread_count](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-status-variables.md) |
| [wsrep_slave_FK_checks](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_slave_fk_checks) |
| [wsrep_slave_threads](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_slave_threads) |
| [wsrep_slave_UK_checks](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_slave_uk_checks) |
| [wsrep_sr_store](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_sr_store_auth) |
| [wsrep_sst_auth](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_sst_auth) |
| [wsrep_sst_donor](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_sst_donor) |
| [wsrep_sst_donor_rejects_queries](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_sst_donor_rejects_queries) |
| [wsrep_sst_method](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_sst_method) |
| [wsrep_sst_receive_address](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_sst_receive_address) |
| [wsrep_start_position](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_start_position) |
| [wsrep_status_file](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_status_file) |
| [wsrep_strict_ddl](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_strict_ddl) |
| [wsrep_sync_wait](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_sync_wait) |
| [wsrep-trx-fragment-size](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_trx_fragment_size) |
| [wsrep-trx-fragment-unit](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_trx_fragment_unit) |
| [wsrep_thread_count](../../server-usage/replication-cluster-multi-master/galera-cluster/galera-cluster-system-variables.md#wsrep_thread_count) |
