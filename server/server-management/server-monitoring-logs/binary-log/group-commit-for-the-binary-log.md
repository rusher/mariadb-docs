...
`<code>transactions/group commit</code>` = (`<code>Binlog_commits</code>` (*snapshot2*) - `<code>Binlog_commits</code>` (*snapshot1*))/(`<code>Binlog_group_commits</code>` (*snapshot2*) - `<code>Binlog_group_commits</code>` (*snapshot1*))
...
`<code>transactions/group commit</code>` = (220 - 120) / (145 - 120) = 100 / 25 = 4 `<code>transactions/group commit</code>`
