...
* [ALTER TABLE](<../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) of a table using a storage engine that stores data remotely, such as the [S3 storage engine](../../../server-usage/storage-engines/s3-storage-engine/), to another storage engine.
