...
* when the logs are flushed, with [FLUSH LOGS](../../../ref/sql-statements-and-structure/sql-statements/administrative-sql-statements/flush-commands/flush-tables-for-export.md) or [mariadb-admin flush-logs](../../../clients-and-utilities/mariadb-admin.md).
...
Relay logs are also removed by the [CHANGE MASTER](../../../ref/sql-statements-and-structure/sql-statements/administrative-sql-statements/replication-statements/change-master-to.md) statement unless a [relay log option](../../../ref/sql-statements-and-structure/sql-statements/administrative-sql-statements/replication-statements/change-master-to.md#relay_log_options) is used.


One can also flush the logs with the [FLUSH RELAY LOGS](../../../ref/sql-statements-and-structure/sql-statements/administrative-sql-statements/flush-commands/flush-tables-for-export.md) commands.
...
* [FLUSH RELAY LOGS](../../../ref/sql-statements-and-structure/sql-statements/administrative-sql-statements/flush-commands/flush-tables-for-export.md)
