...
* #1: Don't use [PARTITIONing](README.md) until you know how and why it will help.
...
* It is OK to have an [AUTO_INCREMENT](../../ref/storage-engines/innodb/auto_increment-handling-in-innodb.md) as the first part of a compound key, or in a non-UNIQUE index.
...
* For [AUTO_INCREMENT](../../ref/storage-engines/innodb/auto_increment-handling-in-innodb.md) to work (in any table), it must be the first field in some index. Period. There are no other requirements on indexing it.
...
* [MyISAM](../../ref/storage-engines/myisam-storage-engine/myisam-system-variables.md), before version 5.6.6, would lock all partitions before pruning!
