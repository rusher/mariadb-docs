...
Note that, if the [innodb\_file\_per\_table](../../reference/storage-engines/innodb/innodb-system-variables.md) server system variable is set to 0 at the time of the table creation, all partitions will be stored in the system tablespace.
