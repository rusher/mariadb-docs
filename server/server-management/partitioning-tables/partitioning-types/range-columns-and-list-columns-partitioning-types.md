...
* Columns can be of any [integer](../../../clients-and-utilities/server-client-software/client-libraries/clientserver-protocol/replication-protocol/intvar_event.md), [string](/kb/en/string-data-types/), [DATE](../../../reference/data-types/date-and-time-data-types/date.md), and [DATETIME](../../../reference/data-types/date-and-time-data-types/datetime.md) types.
...
The last part of a [CREATE TABLE](../../../reference/sql-statements-and-structure/sql-statements/data-definition/create/create-tablespace.md) statement can be definition of the new table's partitions. In the case of RANGE COLUMNS partitioning, the syntax is the following:
