...
The last part of a [CREATE TABLE](../../../ref/sql-statements-and-structure/vectors/create-table-with-vectors.md) statement can be the definition of the new table's partitions. In the case of LIST partitioning, the syntax is the following:
