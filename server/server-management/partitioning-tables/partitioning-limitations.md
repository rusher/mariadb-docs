...
* All partitions must use the same storage engine. For a workaround, see [Using CONNECT - Partitioning and Sharding](../../server-usage/storage-engines/connect/using-connect/using-connect-partitioning-and-sharding.md).
