...
| PATH                 | Path to directories that hold executable programs (such as the [mariadb client](../../clients-and-utilities/mariadb-client/), [mariadb-admin](../../clients-and-utilities/mariadb-admin.md)), so that these can be run from any location. |
