...
See also [How to match API version for php5_mysql and mariadb client](https://mariadb.com/kb/en/1079).
...
1. Switch to using the
 [mysqlnd driver](https://dev.mysql.com/downloads/connector/php-mysqlnd/) in
 PHP (Recommended solution).
1. Run with a lower [error reporting level](https://php.net/error-reporting):
```
