...
| MariaDB-backup-debuginfo         | Debuginfo for [mariadb-backup](../../../../../server-usage/backing-up-and-restoring-databases/mariadb-backup/)                                                                                                                                                         |
...
| MariaDB-server-compat            | Symbolic links from old MySQL server executable names to MariaDB, like mysqld -> mariadbd or mysql\_install\_db -> mariadb-install-db. Good to have if you are using MySQL tool names in your scripts.                                                                 |
