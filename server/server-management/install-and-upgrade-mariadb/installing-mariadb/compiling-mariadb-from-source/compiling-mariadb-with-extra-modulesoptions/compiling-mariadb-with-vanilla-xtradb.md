...
The process is applicable to [MariaDB 5.3.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-3-series/mariadb-534-release-notes) and XtraDB from Percona Server 5.1.61.
