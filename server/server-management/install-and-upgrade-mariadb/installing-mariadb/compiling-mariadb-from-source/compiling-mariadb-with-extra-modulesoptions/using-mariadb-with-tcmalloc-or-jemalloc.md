...
To build [MariaDB 5.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/5.5/changes-improvements-in-mariadb-5-5) with `TCMalloc`, you need to use the following command
...
* [Debugging a running server on Linux](/broken/spaces/WCInJQ9cmGjq1lsTG91E/pages/KggZ6kWNn0qD0bBBw1kX)
