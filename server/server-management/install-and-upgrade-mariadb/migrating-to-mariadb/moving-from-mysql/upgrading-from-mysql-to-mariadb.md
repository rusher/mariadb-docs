...
For [all practical purposes](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/comparison/mariadb-vs-mysql-compatibility), you can view MariaDB as an upgrade of MySQL:

* Before upgrading, please [check if there are any known incompatibilities](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/comparison/mariadb-vs-mysql-compatibility) between your MySQL release and the MariaDB release you want to move to.
...
* There are some configuration options that differ. See [System Variable Differences between MariaDB and MySQL](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/comparison/system-variable-differences-mariadb-vs-mysql).
...
* MariaDB does not have the audit\_log\_plugin. Rather, MariaDB uses the server\_audit plugin, which takes different options.
...
* MariaDB has a lot of [new features](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/comparison/mariadb-vs-mysql-features) that you should know about.
