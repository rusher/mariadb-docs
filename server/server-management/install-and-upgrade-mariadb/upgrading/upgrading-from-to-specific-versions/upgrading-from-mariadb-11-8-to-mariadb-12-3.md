...
description: >-
  ...
  procedure, removed options, and replication caveats.
---
...
| Option                                                                                                                              | Reason                                                                                                                                                                                                                                                                                                                                                    |
| ----------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [big\_tables](../../../../ha-and-performance/optimization-and-tuning/system-variables/server-system-variables.md)                   | Deprecated in MariaDB 10.5.0 and removed in MariaDB 12.0. No longer needed, as the server handles large result sets automatically.                                                                                                                                                                                                                        |
| [storage\_engine](../../../../ha-and-performance/optimization-and-tuning/system-variables/server-system-variables.md)               | Deprecated alias for `default_storage_engine` since MariaDB 5.5, and removed in MariaDB 12.0. Use [default\_storage\_engine](../../../../ha-and-performance/optimization-and-tuning/system-variables/server-system-variables.md) instead.                                                                                                                 |
| [large\_page\_size](../../../../ha-and-performance/optimization-and-tuning/system-variables/server-system-variables.md)             | Read-only variable deprecated in MariaDB 10.5.3 and removed in MariaDB 12.0.                                                                                                                                                                                                                                                                              |
