...
* If you don't have a primary-replica setup, then [take a backup](../../../server-usage/backup-and-restore/mariabackup/), [shutdown MariaDB](../../../clients-and-utilities/legacy-clients-and-utilities/mysqladmin.md) and do the upgrade.
