...
has created some Debian "squeeze" 6.0.4 based, live iso images with [MariaDB 5.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-2-series/changes-improvements-in-mariadb-5-2)\
or 5.3 pre-installed on them and some Debian "squeeze" 6.0.5 based, live iso images with [MariaDB 5.5](broken-reference) pre-installed on them.
...
1. [MariaDB 5.3](broken-reference) Live iso images (text) for i386, amd64 or multi architectures.
...
1. [MariaDB 5.3](broken-reference) Live iso images with LXDE for i386, amd64 or multi architectures.
...
1. [MariaDB 5.3](broken-reference) Live iso images with Gnome for i386, amd64 or multi architectures.
...
1. [MariaDB 5.5](broken-reference) Live images
...
1. [MariaDB 5.5](broken-reference) Live images demonstration video
...
1. Depending on the image [MariaDB 5.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-2-series/changes-improvements-in-mariadb-5-2) or 5.3 server is installed. There is no\
