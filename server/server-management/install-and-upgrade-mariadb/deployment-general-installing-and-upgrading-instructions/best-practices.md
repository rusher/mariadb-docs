...
Additionally, MariaDB Enterprise Server follows an enterprise lifecycle, that provides a [predictable release schedule](../../../server-usage/faq/mariadb-software-questions/what-is-mariadbs-release-policy-and-schedule.md).
