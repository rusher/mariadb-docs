...
| MariaDB-backup-debuginfo         | Debuginfo for [Mariabackup](../../../backing-up-and-restoring-databases/mariabackup/)                                                                                                                                                                            |
...
| MariaDB-connect-engine           | The [CONNECT](../../../../reference/storage-engines/connect/) storage engine.                                                                                                                                                                                    |
| MariaDB-connect-engine-debuginfo | Debuginfo for the [CONNECT](../../../../reference/storage-engines/connect/) storage engine.                                                                                                                                                                      |
...
| MariaDB-rocksdb-engine           | The [MyRocks](../../../../reference/storage-engines/myrocks/) storage engine.                                                                                                                                                                                    |
| MariaDB-rocksdb-engine-debuginfo | Debuginfo for the [MyRocks](../../../../reference/storage-engines/myrocks/) storage engine.                                                                                                                                                                      |
...
| MariaDB-tokudb-engine            | The [TokuDB](../../../../reference/storage-engines/tokudb/) storage engine.                                                                                                                                                                                      |
| MariaDB-tokudb-engine-debuginfo  | Debuginfo for the [TokuDB](../../../../reference/storage-engines/tokudb/) storage engine.                                                                                                                                                                        |
