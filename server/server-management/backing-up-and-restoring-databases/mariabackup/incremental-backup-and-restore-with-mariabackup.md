...
Running this command brings the base full backup, that is, `/var/mariadb/backup`, into sync with the changes contained in the [InnoDB redo log](../../../server-usage/storage-engines/innodb/innodb-redo-log.md) collected while the backup was taken.
