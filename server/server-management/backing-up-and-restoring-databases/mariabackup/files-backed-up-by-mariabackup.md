...
* [InnoDB system tablespace](../../../server-usage/storage-engines/innodb/innodb-tablespaces/innodb-system-tablespaces.md)
...
* [Binary logs](../../server-monitoring-logs/binary-log/)
