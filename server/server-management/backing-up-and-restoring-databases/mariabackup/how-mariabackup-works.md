...
* This is needed to record all changes done while the backup is running. (The redo log logically is a single circular file, split into [innodb_log_files_in_group](/en/xtradbinnodb-server-system-variables/#innodb_log_files_in_group) files.)
