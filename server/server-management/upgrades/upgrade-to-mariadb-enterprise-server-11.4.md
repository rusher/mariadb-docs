...
These instructions detail the **upgrade** from a previous version of **MariaDB Enterprise Server** to **MariaDB Enterprise Server 11.4** on a range of [supported Operating Systems](https://mariadb.com/docs/server/deploy/compatibility/).
...
See [What's New in MariaDB Enterprise Server 11.4](https://mariadb.com/docs/server/whats-new/mariadb-enterprise-server-11-4/).
...
1.  Connect to the server using MariaDB Client using the `root@localhost` user account.
    ...
    MariaDB Client is called [mariadb](https://mariadb.com/docs/server/ref/es11.4/cli/mariadb/) (ES10.4 and later):
