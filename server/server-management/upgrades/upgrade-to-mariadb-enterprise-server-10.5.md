...
See [What's New in MariaDB Enterprise Server 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/enterprise-server/10-5/whats-new-in-mariadb-enterprise-server-10-5.md).
