...
1. [Configure a MariaDB repository.](repo/#configure-mariadb-repository)
1. Set up a repository mirroring tool, for example:
  ...
  * For APT: `debmirror`, available at: [Setup#Debian_Repository_Mirroring_Tools](https://wiki.debian.org/DebianRepository/Setup#Debian_Repository_Mirroring_Tools)
