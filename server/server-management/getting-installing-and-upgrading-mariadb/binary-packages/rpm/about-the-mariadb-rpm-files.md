...
| MariaDB-cracklib-password-check | The [cracklib_password_check](../../../../ref/plugins/password-validation-plugins/cracklib-password-check-plugin.md) password validation plugin. |
| MariaDB-cracklib-password-check | Debuginfo for the [cracklib_password_check](../../../../ref/plugins/password-validation-plugins/cracklib-password-check-plugin.md) password validation plugin. |
...
| MariaDB-gssapi-server | The [gssapi](../../../../ref/plugins/authentication-plugins/authentication-plugin-gssapi.md) authentication plugin. |
| MariaDB-gssapi-server-debuginfo | Debuginfo for the [gssapi](../../../../ref/plugins/authentication-plugins/authentication-plugin-gssapi.md) authentication plugin. |
| MariaDB-rocksdb-engine | The [MyRocks](../../../../ref/storage-engines/myrocks/myrocks-in-mariadb-102-vs-mariadb-103.md) storage engine. |
| MariaDB-rocksdb-engine-debuginfo | Debuginfo for the [MyRocks](../../../../ref/storage-engines/myrocks/myrocks-in-mariadb-102-vs-mariadb-103.md) storage engine. |
...
| MariaDB-tokudb-engine | The [TokuDB](../../../../ref/storage-engines/tokudb/tokudb-resources.md) storage engine. |
| MariaDB-tokudb-engine-debuginfo | Debuginfo for the [TokuDB](../../../../ref/storage-engines/tokudb/tokudb-resources.md) storage engine. |
