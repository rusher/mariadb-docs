...
To install [Mariabackup](../../backing-up-and-restoring-databases/mariabackup/README.md), first you would have to update the package cache by executing the following command:
...
For example, to install the [MariaDB 10.6.21](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/release-notes-mariadb-10-6-series/mariadb-10-6-21-release-notes) `.deb` packages on Ubuntu 18.04 LTS (Bionic), you could execute the following:
...
| mariadb-plugin-connect | The [CONNECT](../../../reference/storage-engines/connect/README.md) storage engine. |
...
| mariadb-plugin-rocksdb | The [MyRocks](../../../reference/storage-engines/myrocks/README.md) storage engine. |
| mariadb-plugin-spider | The [SPIDER](../../../reference/storage-engines/spider/README.md) storage engine. |
| mariadb-plugin-tokudb | The [TokuDB](../../../reference/storage-engines/tokudb/README.md) storage engine. |
