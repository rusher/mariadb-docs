...
To find out the steps to install MariaDB on your system of choice, see the [Getting, Installing, and Upgrading MariaDB](/kb/en/getting-installing-and-upgrading-mariadb/) section.
...
For more information, see [Using Vagrant and Ansible](https://docs.ansible.com/ansible/2.3/guide_vagrant.html) in the Ansible documentation. For an introduction to Ansible for MariaDB users, see [Ansible and MariaDB](/kb/en/ansible-and-mariadb/).
