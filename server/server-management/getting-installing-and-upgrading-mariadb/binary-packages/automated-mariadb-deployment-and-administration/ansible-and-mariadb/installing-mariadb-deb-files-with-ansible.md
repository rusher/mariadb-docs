...
This page refers to the operations described in [Installing MariaDB .deb Files](https://mariadb.com/kb/en/installing-mariadb-deb-files/). Refer to that page for a complete list and explanation of the tasks that should be performed.

Here we discuss how to automate such tasks using Ansible. For example, here we show how to install a package or how to import a GPG key; but for an updated list of the necessary packages and for the keyserver to use, you should refer to [Installing MariaDB .deb Files](https://mariadb.com/kb/en/installing-mariadb-deb-files/).
