...
`<code> Start the container with server options</code>`
...
One can specify custom [configuration files](../../../configuring-mariadb-with-option-files.md) through the **/etc/mysql/conf.d** volume during container startup.
