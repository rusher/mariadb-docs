...
* Advanced HA with [MaxScale](https://github.com/mariadb-operator/mariadb-operator/tree/main/docs/MAXSCALE): a sophisticated database proxy, router, and load balancer for MariaDB.
