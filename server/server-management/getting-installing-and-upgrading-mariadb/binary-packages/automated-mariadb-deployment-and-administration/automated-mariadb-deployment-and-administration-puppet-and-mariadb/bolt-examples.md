...
This page shows some examples of what we can do with Bolt to administer a set of MariaDB servers. Bolt is a tool that is part of the [Puppet](/en/automated-mariadb-deployment-and-administration-puppet-and-mariadb/) ecosystem.
