...
This page includes details for upgrading from [MariaDB 11.2](../../../../release-notes/mariadb-community-server/what-is-mariadb-112.md) to [MariaDB 11.3](../../../../release-notes/mariadb-community-server/what-is-mariadb-113.md). Note that [MariaDB 11.2](../../../../release-notes/mariadb-community-server/what-is-mariadb-112.md) is a [short-term release](https://mariadb.org/about/#maintenance-policy), only maintained for one year. [MariaDB 11.3](../../../../release-notes/mariadb-community-server/what-is-mariadb-113.md) is a [rolling release](https://mariadb.org/about/#maintenance-policy), after 11.3.2 one should upgrade to 11.4.2.
...
1. Modify the repository configuration, so the system's package manager installs [MariaDB 11.3](../../../../release-notes/mariadb-community-server/what-is-mariadb-113.md). For example,
