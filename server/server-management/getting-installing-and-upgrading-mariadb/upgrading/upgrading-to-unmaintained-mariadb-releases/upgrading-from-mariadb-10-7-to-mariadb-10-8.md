...
For MariaDB Galera Cluster, see [Upgrading from MariaDB 10.7 to MariaDB 10.8 with Galera Cluster](upgrading-from-mariadb-107-to-mariadb-108-with-galera-cluster) instead.
...
1. Modify the repository configuration, so the system's package manager installs [MariaDB 10.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-108). For example,
...
| [spider_semi_table_lock](/en/spider-server-system-variables/#spider_semi_table_lock) | 1 | 0 |
...
You might consider using the following major new features in [MariaDB 10.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-108):

* Stored procedures already have support for the [IN, OUT and INOUT](../../../../server-usage/programming-customizing-mariadb/stored-routines/stored-procedures/create-procedure.md#inoutinout) parameter qualifiers. Added as well for [stored functions](../../../../server-usage/programming-customizing-mariadb/user-defined-functions/create-function-udf.md#in-out-inout-in-out) and (IN only) [cursors](../../../../server-usage/programming-customizing-mariadb/programmatic-compound-statements/programmatic-compound-statements-cursors/declare-cursor.md#in) ([MDEV-10654](https://jira.mariadb.org/browse/MDEV-10654)).
* Individual columns in the [index](/en/optimization-and-indexes/) can now be explicitly sorted in the ascending or descending order. This can be useful for optimizing certain [ORDER BY](../../../../reference/sql-statements-and-structure/sql-statements/data-manipulation/selecting-data/order-by.md) cases ([MDEV-13756](https://jira.mariadb.org/browse/MDEV-13756), [MDEV-26938](https://jira.mariadb.org/browse/MDEV-26938), [MDEV-26939](https://jira.mariadb.org/browse/MDEV-26939), [MDEV-26996](https://jira.mariadb.org/browse/MDEV-26996)).
...
* [The features in MariaDB 10.8](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-108)
...
* [Upgrading from MariaDB 10.6 to MariaDB 10.7](/en/upgrading-from-mariadb-106-to-mariadb-107/)
* [Upgrading from MariaDB 10.5 to MariaDB 10.6](/en/upgrading-from-mariadb-105-to-mariadb-106/)
* [Upgrading from MariaDB 10.4 to MariaDB 10.5](/en/upgrading-from-mariadb-104-to-mariadb-105/)