...
This page includes details for upgrading from [MariaDB 11.0](../../../../../release-notes/mariadb-community-server/what-is-mariadb-110.md) to [MariaDB 11.1](../../../../../release-notes/mariadb-community-server/what-is-mariadb-111.md). Note that [MariaDB 11.0](../../../../../release-notes/mariadb-community-server/what-is-mariadb-110.md) and [MariaDB 11.1](../../../../../release-notes/mariadb-community-server/what-is-mariadb-111.md) are both [short-term releases](https://mariadb.org/about/#maintenance-policy), only maintained for one year.
...
1. Modify the repository configuration, so the system's package manager installs [MariaDB 11.1](../../../../../release-notes/mariadb-community-server/what-is-mariadb-111.md). For example,
