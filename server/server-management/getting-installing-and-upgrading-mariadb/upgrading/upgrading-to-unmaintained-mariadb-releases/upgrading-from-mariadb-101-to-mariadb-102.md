...
Starting with [MariaDB 10.2](../../../../../release-notes/mariadb-community-server/what-is-mariadb-102.md), when the user specifies the `--ssl` option with a [client or utility](/kb/en/clients-utilities/), the [client or utility](/kb/en/clients-utilities/) will not [verify the server certificate](../../../../security/securing-mariadb/securing-mariadb-encryption/data-in-transit-encryption/secure-connections-overview.md#server-certificate-verification) by default. In order to verify the server certificate, the user must specify the `--ssl-verify-server-cert` option to the [client or utility](/kb/en/clients-utilities/). For more information, see the [list of options](../../../../clients-and-utilities/mariadb-client/mysql-command-line-client.md#options) for the `[mysql](../../../../clients-and-utilities/mariadb-client/mysql-command-line-client.md)` client.
