...
See [What's New in MariaDB Enterprise Server 10.4](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-enterprise-server-release-notes/mariadb-enterprise-server-10-4/whats-new-in-mariadb-enterprise-server-10-4).
