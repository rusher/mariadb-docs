...
When [System-Versioned temporal data tables](../../../reference/sql-statements-and-structure/temporal-tables/README.md) are in use, downgrade operations will generally require migration of data between servers or restore from a backup made pre-upgrade.
...
Additionally, MariaDB Enterprise Server follows an enterprise lifecycle, that provides a [predictable release schedule](../../../reference/faq/mariadb-software-questions/what-is-mariadbs-release-policy-and-schedule.md).
