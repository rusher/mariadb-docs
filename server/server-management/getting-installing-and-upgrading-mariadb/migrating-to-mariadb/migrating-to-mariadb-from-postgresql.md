...
MariaDB's [CONNECT](../../../reference/storage-engines/connect/) storage engine can be used to migrate from PostgreSQL to MariaDB. There are two primary ways that this can be done.
