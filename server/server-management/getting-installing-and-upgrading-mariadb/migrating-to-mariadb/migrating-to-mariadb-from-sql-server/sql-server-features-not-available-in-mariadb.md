...
* [Cursors](/kb/en/programmatic-compound-statements-cursors/) advanced features.
...
* Native data masking
* PolyBase (however, [MariaDB 10.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-105) supports accessing Amazon S3 via the [S3 storage engine](../../../../reference/storage-engines/s3-storage-engine/s3-storage-engine-status-variables.md) and several DBMSs via [CONNECT](../../../../security/user-account-management/catalogs/connecting-to-a-server-configured-for-catalogs.md))
* R and Python services
* ColumnStore indexes. MariaDB has a storage engine called [ColumnStore](https://app.gitbook.com/s/rBEU9juWLfTDcdwF3Q14/mariadb-columnstore-23-10-release-notes/mariadb-columnstore-23-10-2-release-notes), but this is a completely different feature.
