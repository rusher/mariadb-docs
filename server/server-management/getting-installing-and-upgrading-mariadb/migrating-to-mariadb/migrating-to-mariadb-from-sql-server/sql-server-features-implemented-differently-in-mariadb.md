...
* The list of supported [data types](../../../../reference/data-types/README.md) is different.
...
* Query store. MariaDB allows query performance analysis using the [slow log](../../../server-monitoring-logs/slow-query-log/README.md) and [performance_schema](../../../../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/performance-schema/README.md). Some open source or commercial 3rd party tools read that information to produce statistics and make it easy to identify slow queries.
...
* Linked servers. MariaDB supports storage engines to read from, and write to, remote tables. When using the [CONNECT](../../../../reference/storage-engines/connect/README.md) engine, those tables could be in different DBMSs, including SQL Server.
