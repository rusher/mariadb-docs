...
For [all practical purposes](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/mariadb-releases/compatibility-differences/mariadb-vs-mysql-compatibility), you can view MariaDB as an upgrade of MySQL:

* Before upgrading, please [check if there are any known incompatibilities](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/mariadb-releases/compatibility-differences/mariadb-vs-mysql-compatibility) between your MySQL release and the MariaDB release you want to move to.
* In particular, note that the [JSON type](../../../../reference/data-types/string-data-types/json-data-type.md) in MariaDB is a LONGTEXT, while in MySQL it's a binary type. See [Making MariaDB understand MySQL JSON](https://mariadb.org/making-mariadb-understand-mysql-json/).
...
* Within the same base version (for example MySQL 5.5 -> [MariaDB 5.5](/kb/en/what-is-mariadb-55/), MySQL 5.6 -> [MariaDB 10.0](/kb/en/what-is-mariadb-100/) and MySQL 5.7 -> [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102)) you can in most cases just uninstall MySQL and install MariaDB and you are good to go. There is no need to dump and restore databases. As with any upgrade, we recommend making a backup of your data beforehand.
...
* [MDEV-9804](https://jira.mariadb.org/browse/MDEV-9804)
...
* There are some configuration options that differ. See [System Variable Differences between MariaDB and MySQL](/kb/en/system-variable-differences-between-mariadb-and-mysql/).
...
All the options in your original MySQL [my.cnf file](/kb/en/mysqld-configuration-files-and-groups/) should work fine for MariaDB.
...
* MariaDB has LGPL versions of the [C connector](/kb/en/client-library-for-c/) and [Java Client](https://app.gitbook.com/s/CjGYMsT2MVP4nd3IyW2L/java/changelogs/mariadb-connector-j-11-changelogs/mariadb-java-client-113-changelog). If you are shipping an application that supports MariaDB or MySQL, you should consider using these!
* You should consider trying out the [MyRocks storage engine](../../../../reference/storage-engines/myrocks/myrocks-and-replication.md) or some of the other [new storage engines](/kb/en/mariadb-storage-engines/) that MariaDB provides.

#

# See Also

* MariaDB has a lot of [new features](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/mariadb-releases/compatibility-differences/mariadb-vs-mysql-features) that you should know about.
* [MariaDB versus MySQL - Compatibility](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/mariadb-releases/compatibility-differences/mariadb-vs-mysql-compatibility)
* [Migrating to MariaDB](../migrating-to-mariadb-from-postgresql.md)
* You can find general upgrading informations on the [MariaDB installation page](/kb/en/getting-installing-and-upgrading-mariadb/).
