...
1. In some cases, Fusion-io devices allow for atomic writes, which allows the server to safely disable the [doublewrite buffer](../../../../ref/storage-engines/innodb/innodb-doublewrite-buffer.md).
