...
# Enabling Atomic Writes from [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102)

When starting, [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102) and beyond automatically detects if any of the supported SSD cards are used.
...
# Enabling Atomic Writes in [MariaDB 5.5](/kb/en/what-is-mariadb-55/) to [MariaDB 10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1011)
...
## About innodb_use_atomic_writes (in [MariaDB 5.5](/kb/en/what-is-mariadb-55/) to [MariaDB 10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1011))
...
![Atomic write support flow inside InnoDB](/kb/en/atomic-write-support/+image/atomic_support_internals "Atomic write support flow inside InnoDB")
...
* [Fusion-io devices with the NVMFS file system](fusion-io/fusion-io-introduction.md#atomic-writes) . [MariaDB 5.5](/kb/en/what-is-mariadb-55/) and above.
* [Shannon SSD](http://www.shannon-sys.com). [MariaDB 10.2](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-102) and above.