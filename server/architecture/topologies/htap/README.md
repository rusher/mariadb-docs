...
Customers can obtain support by [submitting a support case](https://github.com/mariadb-corporation/docs-server/blob/test/server/architecture/topologies/htap/broken-reference/README.md).
...
If you have any questions about using specific S3-compatible object storage with MariaDB Enterprise ColumnStore, [contact us](https://github.com/mariadb-corporation/docs-server/blob/test/server/architecture/topologies/htap/broken-reference/README.md).
