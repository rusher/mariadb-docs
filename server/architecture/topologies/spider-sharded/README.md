...
Customers can obtain support by [submitting a support case](https://github.com/mariadb-corporation/docs-server/blob/test/server/architecture/topologies/spider-sharded/broken-reference/README.md).
...
<figure><img src="../../../.gitbook/assets/es-spider-sharded-mariadb-topology-no-title.png" alt=""><figcaption></figcaption></figure>
...
In alignment to the [enterprise lifecycle](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/enterprise-server/enterprise-server-lifecycle), the Spider Sharded topology with MariaDB Enterprise Server is provided for:
