...
For additional information, see "[Spider Sharded Topology](../../../reference/storage-engines/spider/spider-storage-engine-introduction/mariadb-enterprise-spider-operations/sharded-mariadb-enterprise-spider-topology-operations/)".
...
In alignment to the [enterprise lifecycle](../../../enterprise-server-lifecycle.md), the Spider Sharded topology with MariaDB Enterprise Server is provided for:
