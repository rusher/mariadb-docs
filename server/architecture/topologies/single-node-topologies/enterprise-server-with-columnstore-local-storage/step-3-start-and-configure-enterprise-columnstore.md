...
1. On the Enterprise ColumnStore node, create the user account with the [CREATE USER](../../../../reference/sql-statements/account-management-sql-statements/create-user.md) statement:
