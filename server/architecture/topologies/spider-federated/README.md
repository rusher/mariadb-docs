...
In alignment to the [enterprise lifecycle](../../../server-management/enterprise-server-lifecycle.md), the Spider Federated topology with MariaDB Enterprise Server is provided for:
