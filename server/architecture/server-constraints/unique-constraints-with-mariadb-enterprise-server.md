...
5. Alter the table using the [ALTER TABLE](<../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) statement and specify the new unique index with the `ADD UNIQUE INDEX()` clause:
...
2. Alter the table using the [ALTER TABLE](<../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) statement and specify the `DROP INDEX` clause:
...
3. Alter the table using the [ALTER TABLE](<../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) statement and specify the unique index with the `ADD UNIQUE INDEX()` clause:
