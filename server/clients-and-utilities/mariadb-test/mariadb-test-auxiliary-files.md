...
combinations of combinations from both files. In [MariaDB 5.5](broken-reference), for example,`rpl_init.inc` adds combinations for row/statement/mixed, and`have_innodb.inc` adds combinations for innodb/xtradb. Thus any replication\
