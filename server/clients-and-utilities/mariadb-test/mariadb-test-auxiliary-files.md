...
a *template* of it. It will be converted later to an actual `my.cnf`. If a
...
combinations of combinations from both files. In [MariaDB 5.5](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/release-notes-mariadb-5-5-series/changes-improvements-in-mariadb-5-5), for example,
...
`mariadb-test`. See the *unit* suite for a working example of
...
1. `rty/r/foo,aa,bb.rdiff`
1. `qwe/r/foo,aa,bb.result`
1. `qwe/r/foo,aa,bb.rdiff`
1. `rty/r/foo,aa.result`
1. `rty/r/foo,aa.rdiff`
1. `qwe/r/foo,aa.result`
1. `qwe/r/foo,aa.rdiff`
1. `rty/r/foo,bb.result`
1. `rty/r/foo,bb.rdiff`
1. `qwe/r/foo,bb.result`
1. `qwe/r/foo,bb.rdiff`
1. `rty/r/foo.result`
1. `rty/r/foo.rdiff`
1. `qwe/r/foo.result`
