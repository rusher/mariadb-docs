...
| --stop-file=file | If this file is detected, [mariadb-test](README.md) will not start new tests until the file is removed (also MTR_STOP_FILE environment variable). |
...
| --default-myisam | Set default storage engine to [MyISAM](../../reference/storage-engines/myisam-storage-engine/README.md) for non-innodb tests. This is needed after switching default storage engine to [InnoDB](../../reference/storage-engines/innodb/README.md). |
