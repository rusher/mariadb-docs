...
`aria_chk` is used to check, repair, optimize, sort and get information about [Aria](https://github.com/mariadb-corporation/docs-server/blob/test/server/reference/storage-engines/aria/README.md) tables.
