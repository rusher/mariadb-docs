...
| -h, --datadir             | Path for control file (and logs if --logdir not used). From [MariaDB 10.5.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/mariadb-10-5-series/mariadb-1053-release-notes) |
| -#, --debug\[=name]       | Output debug log. Often this is 'd:t:o,filename'.                                                                                                                                                                               |
| -?, --help                | Display help and exit.                                                                                                                                                                                                          |
| -f, --force               | Force packing of table even if it gets bigger or if tempfile exists.                                                                                                                                                            |
| --ignore-control-file     | Ignore the control file. From [MariaDB 10.5.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/mariadb-10-5-series/mariadb-1053-release-notes).                              |
| -j, --join=name           | Join all given tables into 'new\_table\_name'. All tables MUST have identical layouts.                                                                                                                                          |
| --require-control-file    | Abort if cannot find control file. From [MariaDB 10.5.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/old-releases/mariadb-10-5-series/mariadb-1053-release-notes).                    |
