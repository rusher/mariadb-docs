...
**aria_read_log** is a tool for displaying and applying log records from an [Aria](../../security/securing-mariadb/securing-mariadb-encryption/encryption-data-at-rest-encryption/aria-encryption/aria-enabling-encryption.md) [transaction log](../../reference/storage-engines/aria/aria-storage-engine.md#aria-log-files).
...
The following variables can be set while passed as commandline options to aria_read_log, or set in the `[aria_read_log]` section in your [my.cnf](/en/configuring-mariadb-with-mycnf/) file.
...
| -l, --print-log-control-file | Print the content of the aria_log_control_file. From [MariaDB 10.4.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/release-notes-mariadb-104-series/mariadb-1041-release-notes). |
| -o, --start-from-lsn=
