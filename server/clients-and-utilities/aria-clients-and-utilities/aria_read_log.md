...
| -l, --print-log-control-file | Print the content of the aria\_log\_control\_file. From [MariaDB 10.4.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/community-server/old-releases/release-notes-mariadb-10-4-series/mariadb-1041-release-notes). |
