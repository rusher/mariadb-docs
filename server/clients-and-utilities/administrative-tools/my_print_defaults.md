...
| --mariadbd                       | Read the same set of groups that the [mariadbd](https://github.com/mariadb-corporation/docs-server/blob/test/server/clients-and-utilities/server-management/starting-and-stopping-mariadb/mariadbd-options.md) binary does. From [MariaDB 10.11.3](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server-release-notes/mariadb-10-11-series/mariadb-10-11-3-release-notes). |
| --mysqld                         | Read the same set of groups that the [mysqld](https://github.com/mariadb-corporation/docs-server/blob/test/server/clients-and-utilities/server-management/starting-and-stopping-mariadb/mariadbd-options.md) binary does.                                                                                                                                                                     |
...
[mariadb-check](https://github.com/mariadb-corporation/docs-server/blob/test/server/clients-and-utilities/administrative-tools/mariadb-check.md) reads from the \[mariadb-check] and \[client] sections, so the following would display the mariadb-check options.
