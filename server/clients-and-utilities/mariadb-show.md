...
\| -i, --status | Shows a lot of extra information about each table. See the [INFORMATION\_SCHEMA.TABLES](../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/information-schema-tables/information-schema-tables-table.md) table for more details on the returned information. |\
