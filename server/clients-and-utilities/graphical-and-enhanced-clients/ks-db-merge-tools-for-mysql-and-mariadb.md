...
![tabs-home](/en/ks-db-merge-tools-for-mysql-and-mariadb/+image/tabs-home "tabs-home")
...
![tabs-object-list](/en/ks-db-merge-tools-for-mysql-and-mariadb/+image/tabs-object-list "tabs-object-list")
...
![tabs-data-diff](/en/ks-db-merge-tools-for-mysql-and-mariadb/+image/tabs-data-diff "tabs-data-diff")
...
![tabs-text-diff](/en/ks-db-merge-tools-for-mysql-and-mariadb/+image/tabs-text-diff "tabs-text-diff")
...
![tabs-table-structure-diff](/en/ks-db-merge-tools-for-mysql-and-mariadb/+image/tabs-table-structure-diff "tabs-table-structure-diff")
...
![tabs-batch-data-diff](/en/ks-db-merge-tools-for-mysql-and-mariadb/+image/tabs-batch-data-diff "tabs-batch-data-diff")
...
![tabs-query-result-diff](/en/ks-db-merge-tools-for-mysql-and-mariadb/+image/tabs-query-result-diff "tabs-query-result-diff")
...
![automation-scripting](/en/ks-db-merge-tools-for-mysql-and-mariadb/+image/automation-scripting "automation-scripting")