...
* Create a template file for the [ODBC driver](https://mariadb.com/kb/en/creating-a-data-source-with-mariadb-connectorodbc/#configuring-mariadb-connectorodbc-as-a-unixodbc-driver-on-linux). A sample “MariaDB_odbc_driver_template.ini” could be:
...
* Create a template file for the [Data Source Name (DSN)](https://mariadb.com/kb/en/creating-a-data-source-with-mariadb-connectorodbc/#configuring-a-dsn-with-unixodbc-on-linux). A sample “MariaDB_odbc_data_source_template.ini” could be:
...
* Verify successful installation also using the [isql](https://mariadb.com/kb/en/creating-a-data-source-with-mariadb-connectorodbc/#verifying-a-dsn-configuration-with-unixodbc-on-linux) utility, for example:
...
![librebase_4](/en/libreoffice-base/+image/librebase_4 "librebase_4")

It opens the following window:

![librebase_5](/en/libreoffice-base/+image/librebase_5 "librebase_5")
...
![librebase_6](/en/libreoffice-base/+image/librebase_6 "librebase_6")

Double clicking on the table opens a new window with the data displayed to inspect:

![librebase_7](/en/libreoffice-base/+image/librebase_7 "librebase_7")
...
![librebase_8](/en/libreoffice-base/+image/librebase_8 "librebase_8")
