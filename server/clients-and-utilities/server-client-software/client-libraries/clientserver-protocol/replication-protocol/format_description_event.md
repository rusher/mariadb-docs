...
This is a descriptor event that is written to the beginning of a [binary log](../../../../../server-management/server-monitoring-logs/binary-log/) file, at position 4 (after the 4 magic number bytes)
