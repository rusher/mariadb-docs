...
Binary log events, or binlog events, are information about data modification made to a MariaDB server instance stored in the [binary log](../../../../../server-usage/programming-customizing-mariadb/stored-routines/binary-logging-of-stored-routines.md) files.
...
## Example [MariaDB 10.1](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-community-server/what-is-mariadb-1011) Binlog File (Hexdump -C $file_name)
...
## Example From [mysqlbinlog](/en/mysqlbinlog/)
