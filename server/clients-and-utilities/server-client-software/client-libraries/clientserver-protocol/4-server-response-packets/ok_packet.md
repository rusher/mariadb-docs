...
| SERVER\_QUERY\_NO\_GOOD\_INDEX\_USED   | 16    | Set if [EXPLAIN](../../../../../reference/sql-statements/administrative-sql-statements/analyze-and-explain-statements/explain.md) would've shown Range checked for each record |
