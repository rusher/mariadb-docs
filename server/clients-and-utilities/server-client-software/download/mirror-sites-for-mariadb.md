...
download site at [https://mariadb.org/download](https://mariadb.org/download). If you would like to
...
1. The mirror should update itself, preferably every 6 hours, but at the very least, twice a day. (See
 [Updating Notes](/kb/en/mirroring-mariadb/#updating-notes)
...
See the
[rsync documentation](http://www.samba.org/ftp/rsync/rsync.html) for details
...
[Oregon State University Open Source Lab](http://osuosl.org) (at
...
server is available via the web at [https://archive.mariadb.org](https://archive.mariadb.org) and via rsync at:
