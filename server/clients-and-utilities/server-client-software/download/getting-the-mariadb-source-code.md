...
The MariaDB source is hosted on GitHub: [https://github.com/MariaDB/server](https://github.com/MariaDB/server). You can get a copy with:
...
[http://downloads.mariadb.org](http://downloads.mariadb.org).
...
See the [Using git](https://app.gitbook.com/s/iJPrPCGi329TSR8WIXJW/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/tools/using-git-with-mariadb/using-git) page for instructions on how to use git to check out the source code and switch between the various branches.
...
the [MariaDB](https://app.gitbook.com/s/aEnK0ZXmUbJzqQrTjFyb/mariadb-release-criteria) source code repository with the full revision history. If you
want a tarball of the source without the revision history, see the
[MariaDB download page](http://mariadb.org/download).
...
[https://code.launchpad.net/maria](https://code.launchpad.net/maria).

#

## Prerequisites

You need [Bazaar](http://bazaar-vcs.org) for revision control.
...
For a complete list, go to [Launchpad](http://launchpad.net/~maria-captains/) and choose ['Code'](https://code.launchpad.net/~maria-captains) from the top menu on the page.
...
then the version of bzr you are using is too old. Using [version 1.12](http://bazaar-vcs.org/Download) or higher will fix this error.
...
You need [Bazaar](http://bazaar-vcs.org) to work with the repository.
...
repositories on our build machines in [buildbot](https://app.gitbook.com/s/iJPrPCGi329TSR8WIXJW/learning-and-training/training-and-tutorials/advanced-mariadb-articles/development-articles/tools/buildbot/buildbot-buildbot-database-schema). 
...
```
Check out packaging sources (only for [MariaDB 5.3](/en/what-is-mariadb-53/) and below):
