...
Instructions how to install the packages can be found [here](../../../server-management/getting-installing-and-upgrading-mariadb/binary-packages/). See the [Includes MariaDB](https://app.gitbook.com/s/WCInJQ9cmGjq1lsTG91E/) documentation page for a list of which Linux distributions that include MariaDB.
