...
* [RHEL and RPM distros](../../../server-management/install-and-upgrade-mariadb/binary-packages/rpm/yum.md#pinning-the-mariadb-repository-to-a-specific-minor-release)
* [Debian/Ubuntu based distos](../../../server-management/install-and-upgrade-mariadb/binary-packages/installing-mariadb-deb-files.md#pinning-the-mariadb-repository-to-a-specific-minor-release)
