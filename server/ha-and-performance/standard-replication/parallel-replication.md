...
Minimal mode of in-order parallel replication \_only\_allows the commit step of transactions to be applied in parallel; all other steps are applied serially.
