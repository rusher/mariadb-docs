...
* dynamically redirect from the primary to one of the replicas
  * same as above, but use [INFORMATION\_SCHEMA.PROCESSLIST](../reference/sql-statements-and-structure/sql-statements/administrative-sql-statements/system-tables/information-schema/information-schema-tables/information-schema-processlist-table.md) to get the list of active replicas.
