...
By default, an index is not ignored. One can mark existing index as ignored (or not ignored) with an [ALTER TABLE](<../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) statement:
