...
* A FULLTEXT index definition can be given in the [CREATE TABLE](../../../../reference/sql-statements/data-definition/create/create-table.md) statement when a\
  table is created, or added later using [ALTER TABLE](<../../../../reference/sql-statements/data-definition/alter/alter-table/README (1).md>) or [CREATE INDEX](../../../../reference/sql-statements/data-definition/create/create-index.md).
