...
The basic terminology ("Fact Table", "[Normalization](https://app.gitbook.com/s/WCInJQ9cmGjq1lsTG91E/database-theory/database-normalization)", etc) is covered in that document.
